...
- pages/ Contains the pages that are edited by the Designer Tool. Encoded in Space/Scraps
- timelines/ Stores diffs of pages generated by Designer tool. Encoded in Space.
