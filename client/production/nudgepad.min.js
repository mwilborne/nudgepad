...
Git.addOrigin=function(){var a=prompt("Enter origin URI");if(!a)return!1;Git.exec("git remote add origin "+a,function(){Alerts.success("Origin Updated")})};Git.cloneRepo=function(){var a=prompt("Enter clone URI","https://github.com/");if(!a)return!1;Git.exec("git clone "+a+" temp; mv temp/* .; mv temp/.git .; rm -rf temp",function(){Alerts.success("Cloned")})};
Git.commit=function(){var a=$("#GitCommitMessage").val();Git.exec('git commit -am "'+a+'"',function(){Alerts.success("Commit Received")});$("#GitCommitMessage").val("")};Git.deployKey=function(){expressfs.exists("nudgepad/deploy.key.pub",function(a){a?expressfs.readFile("nudgepad/deploy.key.pub",function(a){a=$('<pre id="PreviewBoxWhiteBox" style="text-align: left;">'+a+"</pre>");PreviewBox.open(a)}):Git.generateKey()})};
Git.exec=function(a,d){var c=$("#GitStatus");c.html("");$.post("nudgepad.exec",{command:a},function(a){c.append(a+"\n");d&&d()}).fail(function(a,d){c.append("ERROR\n");c.append(a.responseText+"\n")})};Git.generateKey=function(){Git.exec('ssh-keygen -t rsa -N "" -f '+(Explorer.paths.nudgepad+"deploy.key"),function(){Alerts.success("Git SSH key created");Git.status()})};
Git.init=function(){expressfs.writeFile(".gitignore",Git.gitignore,function(){Git.exec("git init",function(){Alerts.success("Git init OK");Git.status()})})};Git.install=function(){expressfs.writeFile(".gitignore",Git.gitignore,function(){Git.exec('git init; git add .; git commit -am "initial commit"; git checkout -b nudgepad;',function(){Alerts.success("Git setup OK")})})};Git.pull=function(){Git.exec("ssh-agent bash -c 'ssh-add /nudgepad/projects/"+document.location.hostname+"/nudgepad/deploy.key; git pull'")};
Git.push=function(){var a="ssh-agent bash -c 'ssh-add /nudgepad/projects/"+document.location.hostname+"/nudgepad/deploy.key; git push -u origin master'";console.log(a);Git.exec(a)};Git.setOrigin=function(){var a=prompt("Enter origin URI");if(!a)return!1;Git.exec("git remote set-url origin "+a,function(){Alerts.success("Origin Updated")})};Git.status=function(){Git.exec("git status")};Git.setup=function(){Git.exec("ssh-keyscan -t rsa1,rsa,dsa github.com >> /home/"+document.location.hostname+"/.ssh/known_hosts")};
Git.on("ready",Git.status);var Home=new Tool("Home");
