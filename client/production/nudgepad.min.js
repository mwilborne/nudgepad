...
(d.style.display=""),""===d.style.display&&C(d)&&(f[g]=k._data(d,"olddisplay",R(d.nodeName)))):f[g]||(e=C(d),(c&&"none"!==c||!e)&&k._data(d,"olddisplay",e?c:k.css(d,"display"))));for(g=0;h>g;g++)d=a[g],d.style&&(b&&"none"!==d.style.display&&""!==d.style.display||(d.style.display=b?f[g]||"":"none"));return a}function G(a,b,d){return(a=Ob.exec(b))?Math.max(0,a[1]-(d||0))+(a[2]||"px"):b}function y(a,b,d,c,e){b=d===(c?"border":"content")?4:"width"===b?1:0;for(var f=0;4>b;b+=2)"margin"===d&&(f+=k.css(a,
d+Da[b],!0,e)),c?("content"===d&&(f-=k.css(a,"padding"+Da[b],!0,e)),"margin"!==d&&(f-=k.css(a,"border"+Da[b]+"Width",!0,e))):(f+=k.css(a,"padding"+Da[b],!0,e),"padding"!==d&&(f+=k.css(a,"border"+Da[b]+"Width",!0,e)));return f}function Q(a,b,d){var c=!0,e="width"===b?a.offsetWidth:a.offsetHeight,f=Ea(a),g=k.support.boxSizing&&"border-box"===k.css(a,"boxSizing",!1,f);if(0>=e||null==e){if(e=Fa(a,b,f),(0>e||null==e)&&(e=a.style[b]),cb.test(e))return e;c=g&&(k.support.boxSizingReliable||e===a.style[b]);
e=parseFloat(e)||0}return e+y(a,b,d||(g?"border":"content"),c,f)+"px"}function R(a){var b=I,d=xb[a];return d||(d=V(a,b),"none"!==d&&d||(Ra=(Ra||k("<iframe frameborder='0' width='0' height='0'/>").css("cssText","display:block !important")).appendTo(b.documentElement),b=(Ra[0].contentWindow||Ra[0].contentDocument).document,b.write("<!doctype html><html><body>"),b.close(),d=V(a,b),Ra.detach()),xb[a]=d),d}function V(a,b){var d=k(b.createElement(a)).appendTo(b.body),c=k.css(d[0],"display");return d.remove(),
c}function ha(a,b,d,c){var e;if(k.isArray(b))k.each(b,function(b,e){d||Pb.test(a)?c(a,e):ha(a+"["+("object"==typeof e?b:"")+"]",e,d,c)});else if(d||"object"!==k.type(b))c(a,b);else for(e in b)ha(a+"["+e+"]",b[e],d,c)}function O(a){return function(b,d){"string"!=typeof b&&(d=b,b="*");var c,e=0,f=b.toLowerCase().match(Y)||[];if(k.isFunction(d))for(;c=f[e++];)"+"===c[0]?(c=c.slice(1)||"*",(a[c]=a[c]||[]).unshift(d)):(a[c]=a[c]||[]).push(d)}}function U(a,b,c,e){function f(l){var n;return g[l]=!0,k.each(a[l]||
[],function(a,B){var k=B(b,c,e);return"string"!=typeof k||h||g[k]?h?!(n=k):d:(b.dataTypes.unshift(k),f(k),!1)}),n}var g={},h=a===mb;return f(b.dataTypes[0])||!g["*"]&&f("*")}function L(a,b){var c,e,f=k.ajaxSettings.flatOptions||{};for(e in b)b[e]!==d&&((f[e]?a:c||(c={}))[e]=b[e]);return c&&k.extend(!0,a,c),a}function W(){try{return new a.XMLHttpRequest}catch(b){}}function T(){return setTimeout(function(){Ka=d}),Ka=k.now()}function q(a,b,d){for(var c,e=(Sa[b]||[]).concat(Sa["*"]),f=0,k=e.length;k>
f;f++)if(c=e[f].call(d,b,a))return c}function H(a,b,d){var c,e=0,f=db.length,g=k.Deferred().always(function(){delete h.elem}),h=function(){if(c)return!1;for(var b=Ka||T(),b=Math.max(0,l.startTime+l.duration-b),d=1-(b/l.duration||0),e=0,f=l.tweens.length;f>e;e++)l.tweens[e].run(d);return g.notifyWith(a,[l,d,b]),1>d&&f?b:(g.resolveWith(a,[l]),!1)},l=g.promise({elem:a,props:k.extend({},b),opts:k.extend(!0,{specialEasing:{}},d),originalProperties:b,originalOptions:d,startTime:Ka||T(),duration:d.duration,
tweens:[],createTween:function(b,d){var c=k.Tween(a,l.opts,b,d,l.opts.specialEasing[b]||l.opts.easing);return l.tweens.push(c),c},stop:function(b){var d=0,e=b?l.tweens.length:0;if(c)return this;for(c=!0;e>d;d++)l.tweens[d].run(1);return b?g.resolveWith(a,[l,b]):g.rejectWith(a,[l,b]),this}});d=l.props;for(v(d,l.opts.specialEasing);f>e;e++)if(b=db[e].call(l,a,d,l.opts))return b;return k.map(d,q,l),k.isFunction(l.opts.start)&&l.opts.start.call(a,l),k.fx.timer(k.extend(h,{elem:a,anim:l,queue:l.opts.queue})),
l.progress(l.opts.progress).done(l.opts.done,l.opts.complete).fail(l.opts.fail).always(l.opts.always)}function v(a,b){var d,c,e,f,g;for(d in a)if(c=k.camelCase(d),e=b[c],f=a[d],k.isArray(f)&&(e=f[1],f=a[d]=f[0]),d!==c&&(a[c]=f,delete a[d]),g=k.cssHooks[c],g&&"expand"in g)for(d in f=g.expand(f),delete a[c],f)d in a||(a[d]=f[d],b[d]=e);else b[c]=e}function F(a,b,d,c,e){return new F.prototype.init(a,b,d,c,e)}function E(a,b){var d,c={height:a},e=0;for(b=b?1:0;4>e;e+=2-b)d=Da[e],c["margin"+d]=c["padding"+
...
b);for(b in a);return b===d||pa.call(a,b)},isEmptyObject:function(a){for(var b in a)return!1;return!0},error:function(a){throw Error(a);},parseHTML:function(a,b,d){if(!a||"string"!=typeof a)return null;"boolean"==typeof b&&(d=b,b=!1);b=b||I;var c=eb.exec(a);d=!d&&[];return c?[b.createElement(c[1])]:(c=k.buildFragment([a],b,d),d&&k(d).remove(),k.merge([],c.childNodes))},parseJSON:function(b){return a.JSON&&a.JSON.parse?a.JSON.parse(b):null===b?b:"string"==typeof b&&(b=k.trim(b),b&&ra.test(b.replace(S,
...
function(a){return null==a?"":(a+"").replace(Ta,"")},makeArray:function(a,b){var d=b||[];return null!=a&&(c(Object(a))?k.merge(d,"string"==typeof a?[a]:a):ea.call(d,a)),d},inArray:function(a,b,d){var c;if(b){if(X)return X.call(b,a,d);c=b.length;for(d=d?0>d?Math.max(0,c+d):d:0;c>d;d++)if(d in b&&b[d]===a)return d}return-1},merge:function(a,b){var c=b.length,e=a.length,f=0;if("number"==typeof c)for(;c>f;f++)a[e++]=b[f];else for(;b[f]!==d;)a[e++]=b[f++];return a.length=e,a},grep:function(a,b,d){var c,
e=[],f=0,k=a.length;for(d=!!d;k>f;f++)c=!!b(a[f],f),d!==c&&e.push(a[f]);return e},map:function(a,b,d){var e,f=0,k=a.length,g=[];if(c(a))for(;k>f;f++)e=b(a[f],f,d),null!=e&&(g[g.length]=e);else for(f in a)e=b(a[f],f,d),null!=e&&(g[g.length]=e);return va.apply([],g)},guid:1,proxy:function(a,b){var c,e,f;return"string"==typeof b&&(f=a[b],b=a,a=f),k.isFunction(a)?(c=z.call(arguments,2),e=function(){return a.apply(b||this,c.concat(z.call(arguments)))},e.guid=a.guid=a.guid||k.guid++,e):d},access:function(a,
...
k.ready.promise=function(b){if(!aa)if(aa=k.Deferred(),"complete"===I.readyState)setTimeout(k.ready);else if(I.addEventListener)I.addEventListener("DOMContentLoaded",ka,!1),a.addEventListener("load",ka,!1);else{I.attachEvent("onreadystatechange",ka);a.attachEvent("onload",ka);var d=!1;try{d=null==a.frameElement&&I.documentElement}catch(c){}d&&d.doScroll&&function xa(){if(!k.isReady){try{d.doScroll("left")}catch(a){return setTimeout(xa,50)}Wa();k.ready()}}()}return aa.promise(b)};k.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),
function(a,b){ja["[object "+b+"]"]=b.toLowerCase()});ba=k(I);(function(a,b){function d(a,b,c,e){var B,f,g,k,l;if((b?b.ownerDocument||b:da)!==F&&ba(b),b=b||F,c=c||[],!a||"string"!=typeof a)return c;if(1!==(k=b.nodeType)&&9!==k)return[];if(I&&!e){if(B=ra.exec(a))if(g=B[1])if(9===k){if(f=b.getElementById(g),!f||!f.parentNode)return c;if(f.id===g)return c.push(f),c}else{if(b.ownerDocument&&(f=b.ownerDocument.getElementById(g))&&ca(b,f)&&f.id===g)return c.push(f),c}else{if(B[2])return Y.apply(c,b.getElementsByTagName(a)),
c;if((g=B[3])&&x.getElementsByClassName&&b.getElementsByClassName)return Y.apply(c,b.getElementsByClassName(g)),c}if(x.qsa&&(!C||!C.test(a))){if(f=B=O,g=b,l=9===k&&a,1===k&&"object"!==b.nodeName.toLowerCase()){k=m(a);(B=b.getAttribute("id"))?f=B.replace(ta,"\\$&"):b.setAttribute("id",f);f="[id='"+f+"'] ";for(g=k.length;g--;)k[g]=f+p(k[g]);g=ea.test(a)&&b.parentNode||b;l=k.join(",")}if(l)try{return Y.apply(c,g.querySelectorAll(l)),c}catch(h){}finally{B||b.removeAttribute("id")}}}var P;a:{a=a.replace(T,
"$1");var na,n;f=m(a);if(!e&&1===f.length){if(P=f[0]=f[0].slice(0),2<P.length&&"ID"===(na=P[0]).type&&x.getById&&9===b.nodeType&&I&&v.relative[P[1].type]){if(b=(v.find.ID(na.matches[0].replace(fa,ga),b)||[])[0],!b){P=c;break a}a=a.slice(P.shift().value.length)}for(k=Ha.needsContext.test(a)?0:P.length;k--&&(na=P[k],!v.relative[B=na.type]);)if((n=v.find[B])&&(e=n(na.matches[0].replace(fa,ga),ea.test(P[0].type)&&b.parentNode||b))){if(P.splice(k,1),a=e.length&&p(P),!a){P=(Y.apply(c,e),c);break a}break}}P=
(w(a,f)(e,b,!I,c,ea.test(a)),c)}return P}function c(){function a(d,c){return b.push(d+=" ")>v.cacheLength&&delete a[b.shift()],a[d]=c}var b=[];return a}function e(a){return a[O]=!0,a}function f(a){var b=F.createElement("div");try{return!!a(b)}catch(d){return!1}finally{b.parentNode&&b.parentNode.removeChild(b)}}function g(a,b){for(var d=a.split("|"),c=a.length;c--;)v.attrHandle[d[c]]=b}function l(a,b){var d=b&&a,c=d&&1===a.nodeType&&1===b.nodeType&&(~b.sourceIndex||oa)-(~a.sourceIndex||oa);if(c)return c;
if(d)for(;d=d.nextSibling;)if(d===b)return-1;return a?1:-1}function h(a){return function(b){return"input"===b.nodeName.toLowerCase()&&b.type===a}}function n(a){return function(b){var d=b.nodeName.toLowerCase();return("input"===d||"button"===d)&&b.type===a}}function q(a){return e(function(b){return b=+b,e(function(d,c){for(var e,B=a([],d.length,b),f=B.length;f--;)d[e=B[f]]&&(d[e]=!(c[e]=d[e]))})})}function z(){}function m(a,b){var c,e,B,f,g,k,l;if(g=ma[a+" "])return b?0:g.slice(0);g=a;k=[];for(l=v.preFilter;g;){c&&
!(e=S.exec(g))||(e&&(g=g.slice(e[0].length)||g),k.push(B=[]));c=!1;(e=wa.exec(g))&&(c=e.shift(),B.push({value:c,type:e[0].replace(T," ")}),g=g.slice(c.length));for(f in v.filter)!(e=Ha[f].exec(g))||l[f]&&!(e=l[f](e))||(c=e.shift(),B.push({value:c,type:f,matches:e}),g=g.slice(c.length));if(!c)break}return b?g.length:g?d.error(a):ma(a,k).slice(0)}function p(a){for(var b=0,d=a.length,c="";d>b;b++)c+=a[b].value;return c}function J(a,b,d){var c=b.dir,e=d&&"parentNode"===c,B=N++;return b.first?function(b,
d,B){for(;b=b[c];)if(1===b.nodeType||e)return a(b,d,B)}:function(b,d,f){var g,k,l,h=R+" "+B;if(f)for(;b=b[c];){if((1===b.nodeType||e)&&a(b,d,f))return!0}else for(;b=b[c];)if(1===b.nodeType||e)if(l=b[O]||(b[O]={}),(k=l[c])&&k[0]===h){if(!0===(g=k[1])||g===X)return!0===g}else if(k=l[c]=[h],k[1]=a(b,d,f)||X,!0===k[1])return!0}}function u(a){return 1<a.length?function(b,d,c){for(var e=a.length;e--;)if(!a[e](b,d,c))return!1;return!0}:a[0]}function aa(a,b,d,c,e){for(var B,f=[],g=0,k=a.length,l=null!=b;k>
g;g++)(B=a[g])&&(!d||d(B,c,e))&&(f.push(B),l&&b.push(g));return f}function D(a,b,c,B,f,g){return B&&!B[O]&&(B=D(B)),f&&!f[O]&&(f=D(f,g)),e(function(e,g,k,l){var h,P,n=[],q=[],ua=g.length,z;if(!(z=e)){z=b||"*";for(var m=k.nodeType?[k]:k,xa=[],p=0,J=m.length;J>p;p++)d(z,m[p],xa);z=xa}z=!a||!e&&b?z:aa(z,n,a,k,l);m=c?f||(e?a:ua||B)?[]:g:z;if(c&&c(z,m,k,l),B)for(h=aa(m,q),B(h,[],k,l),k=h.length;k--;)(P=h[k])&&(m[q[k]]=!(z[q[k]]=P));if(e){if(f||a){if(f){h=[];for(k=m.length;k--;)(P=m[k])&&h.push(z[k]=P);
f(null,m=[],h,l)}for(k=m.length;k--;)(P=m[k])&&-1<(h=f?ia.call(e,P):n[k])&&(e[h]=!(g[h]=P))}}else m=aa(m===g?m.splice(ua,m.length):m),f?f(null,g,m,l):Y.apply(g,m)})}function E(a){var b,d,c,e=a.length,B=v.relative[a[0].type];d=B||v.relative[" "];for(var f=B?1:0,g=J(function(a){return a===b},d,!0),k=J(function(a){return-1<ia.call(b,a)},d,!0),l=[function(a,d,c){return!B&&(c||d!==y)||((b=d).nodeType?g(a,d,c):k(a,d,c))}];e>f;f++)if(d=v.relative[a[f].type])l=[J(u(l),d)];else{if(d=v.filter[a[f].type].apply(null,
a[f].matches),d[O]){for(c=++f;e>c&&!v.relative[a[c].type];c++);return D(1<f&&u(l),1<f&&p(a.slice(0,f-1).concat({value:" "===a[f-2].type?"*":""})).replace(T,"$1"),d,c>f&&E(a.slice(f,c)),e>c&&E(a=a.slice(c)),e>c&&p(a))}l.push(d)}return u(l)}function t(a,b){var c=0,B=0<b.length,f=0<a.length,g=function(e,g,k,l,h){var P,n,q=[],ua=0,z="0",m=e&&[],xa=null!=h,p=y,J=e||f&&v.find.TAG("*",h&&g.parentNode||g),u=R+=null==p?1:Math.random()||0.1;for(xa&&(y=g!==F&&g,X=c);null!=(h=J[z]);z++){if(f&&h){for(P=0;n=a[P++];)if(n(h,
g,k)){l.push(h);break}xa&&(R=u,X=++c)}B&&((h=!n&&h)&&ua--,e&&m.push(h))}if(ua+=z,B&&z!==ua){for(P=0;n=b[P++];)n(m,q,g,k);if(e){if(0<ua)for(;z--;)m[z]||q[z]||(q[z]=kb.call(l));q=aa(q)}Y.apply(l,q);xa&&!e&&0<q.length&&1<ua+b.length&&d.uniqueSort(l)}return xa&&(R=u,y=p),m};return B?e(g):g}var r,x,X,v,H,s,w,y,A,ba,F,Z,I,C,G,K,ca,O="sizzle"+-new Date,da=a.document,R=0,N=0,M=c(),ma=c(),pa=c(),L=!1,V=function(a,b){return a===b?(L=!0,0):0},Q=typeof b,oa=-2147483648,qa={}.hasOwnProperty,U=[],kb=U.pop,ha=U.push,
Y=U.push,W=U.slice,ia=U.indexOf||function(a){for(var b=0,d=this.length;d>b;b++)if(this[b]===a)return b;return-1},ja="(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w#"),ib="\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)[\\x20\\t\\r\\n\\f]*(?:([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|("+ja+")|)|)[\\x20\\t\\r\\n\\f]*\\]",Ja=":((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|"+ib.replace(3,8)+")*)|.*)\\)|)",T=/^[\x20\t\r\n\f]+|((?:^|[^\\])(?:\\.)*)[\x20\t\r\n\f]+$/g,
...
ga=function(a,b,d){a="0x"+b-65536;return a!==a||d?b:0>a?String.fromCharCode(a+65536):String.fromCharCode(55296|a>>10,56320|1023&a)};try{Y.apply(U=W.call(da.childNodes),da.childNodes),U[da.childNodes.length].nodeType}catch(Ta){Y={apply:U.length?function(a,b){ha.apply(a,W.call(b))}:function(a,b){for(var d=a.length,c=0;a[d++]=b[c++];);a.length=d-1}}}s=d.isXML=function(a){return(a=a&&(a.ownerDocument||a).documentElement)?"HTML"!==a.nodeName:!1};x=d.support={};ba=d.setDocument=function(a){var d=a?a.ownerDocument||
a:da;a=d.defaultView;return d!==F&&9===d.nodeType&&d.documentElement?(F=d,Z=d.documentElement,I=!s(d),a&&a.attachEvent&&a!==a.top&&a.attachEvent("onbeforeunload",function(){ba()}),x.attributes=f(function(a){return a.className="i",!a.getAttribute("className")}),x.getElementsByTagName=f(function(a){return a.appendChild(d.createComment("")),!a.getElementsByTagName("*").length}),x.getElementsByClassName=f(function(a){return a.innerHTML="<div class='a'></div><div class='a i'></div>",a.firstChild.className=
"i",2===a.getElementsByClassName("i").length}),x.getById=f(function(a){return Z.appendChild(a).id=O,!d.getElementsByName||!d.getElementsByName(O).length}),x.getById?(v.find.ID=function(a,b){if(typeof b.getElementById!==Q&&I){var d=b.getElementById(a);return d&&d.parentNode?[d]:[]}},v.filter.ID=function(a){var b=a.replace(fa,ga);return function(a){return a.getAttribute("id")===b}}):(delete v.find.ID,v.filter.ID=function(a){var b=a.replace(fa,ga);return function(a){return(a=typeof a.getAttributeNode!==
Q&&a.getAttributeNode("id"))&&a.value===b}}),v.find.TAG=x.getElementsByTagName?function(a,d){return typeof d.getElementsByTagName!==Q?d.getElementsByTagName(a):b}:function(a,b){var d,c=[],e=0,B=b.getElementsByTagName(a);if("*"===a){for(;d=B[e++];)1===d.nodeType&&c.push(d);return c}return B},v.find.CLASS=x.getElementsByClassName&&function(a,d){return typeof d.getElementsByClassName!==Q&&I?d.getElementsByClassName(a):b},G=[],C=[],(x.qsa=ka.test(d.querySelectorAll))&&(f(function(a){a.innerHTML="<select><option selected=''></option></select>";
...
!(d.contains?d.contains(c):a.compareDocumentPosition&&16&a.compareDocumentPosition(c)))}:function(a,b){if(b)for(;b=b.parentNode;)if(b===a)return!0;return!1},V=Z.compareDocumentPosition?function(a,b){if(a===b)return L=!0,0;var c=b.compareDocumentPosition&&a.compareDocumentPosition&&a.compareDocumentPosition(b);return c?1&c||!x.sortDetached&&b.compareDocumentPosition(a)===c?a===d||ca(da,a)?-1:b===d||ca(da,b)?1:A?ia.call(A,a)-ia.call(A,b):0:4&c?-1:1:a.compareDocumentPosition?-1:1}:function(a,b){var c,
e=0;c=a.parentNode;var B=b.parentNode,f=[a],g=[b];if(a===b)return L=!0,0;if(!c||!B)return a===d?-1:b===d?1:c?-1:B?1:A?ia.call(A,a)-ia.call(A,b):0;if(c===B)return l(a,b);for(c=a;c=c.parentNode;)f.unshift(c);for(c=b;c=c.parentNode;)g.unshift(c);for(;f[e]===g[e];)e++;return e?l(f[e],g[e]):f[e]===da?-1:g[e]===da?1:0},d):F};d.matches=function(a,b){return d(a,null,null,b)};d.matchesSelector=function(a,b){if((a.ownerDocument||a)!==F&&ba(a),b=b.replace(la,"='$1']"),x.matchesSelector&&I&&!(G&&G.test(b)||C&&
C.test(b)))try{var c=K.call(a,b);if(c||x.disconnectedMatch||a.document&&11!==a.document.nodeType)return c}catch(e){}return 0<d(b,F,null,[a]).length};d.contains=function(a,b){return(a.ownerDocument||a)!==F&&ba(a),ca(a,b)};d.attr=function(a,d){(a.ownerDocument||a)!==F&&ba(a);var c=v.attrHandle[d.toLowerCase()],c=c&&qa.call(v.attrHandle,d.toLowerCase())?c(a,d,!I):b;return c===b?x.attributes||!I?a.getAttribute(d):(c=a.getAttributeNode(d))&&c.specified?c.value:null:c};d.error=function(a){throw Error("Syntax error, unrecognized expression: "+
a);};d.uniqueSort=function(a){var b,d=[],c=0,e=0;if(L=!x.detectDuplicates,A=!x.sortStable&&a.slice(0),a.sort(V),L){for(;b=a[e++];)b===a[e]&&(c=d.push(e));for(;c--;)a.splice(d[c],1)}return a};H=d.getText=function(a){var b,d="",c=0;if(b=a.nodeType)if(1===b||9===b||11===b){if("string"==typeof a.textContent)return a.textContent;for(a=a.firstChild;a;a=a.nextSibling)d+=H(a)}else{if(3===b||4===b)return a.nodeValue}else for(;b=a[c];c++)d+=H(b);return d};v=d.selectors={cacheLength:50,createPseudo:e,match:Ha,
...
typeof a.className&&a.className||typeof a.getAttribute!==Q&&a.getAttribute("class")||"")})},ATTR:function(a,b,c){return function(e){e=d.attr(e,a);return null==e?"!="===b:b?(e+="","="===b?e===c:"!="===b?e!==c:"^="===b?c&&0===e.indexOf(c):"*="===b?c&&-1<e.indexOf(c):"$="===b?c&&e.slice(-c.length)===c:"~="===b?-1<(" "+e+" ").indexOf(c):"|="===b?e===c||e.slice(0,c.length+1)===c+"-":!1):!0}},CHILD:function(a,b,d,c,e){var B="nth"!==a.slice(0,3),f="last"!==a.slice(-4),g="of-type"===b;return 1===c&&0===e?
function(a){return!!a.parentNode}:function(b,d,k){var l,h,P,na,n;d=B!==f?"nextSibling":"previousSibling";var q=b.parentNode,ua=g&&b.nodeName.toLowerCase();k=!k&&!g;if(q){if(B){for(;d;){for(h=b;h=h[d];)if(g?h.nodeName.toLowerCase()===ua:1===h.nodeType)return!1;n=d="only"===a&&!n&&"nextSibling"}return!0}if(n=[f?q.firstChild:q.lastChild],f&&k)for(k=q[O]||(q[O]={}),l=k[a]||[],na=l[0]===R&&l[1],P=l[0]===R&&l[2],h=na&&q.childNodes[na];h=++na&&h&&h[d]||(P=na=0)||n.pop();){if(1===h.nodeType&&++P&&h===b){k[a]=
[R,na,P];break}}else if(k&&(l=(b[O]||(b[O]={}))[a])&&l[0]===R)P=l[1];else for(;(h=++na&&h&&h[d]||(P=na=0)||n.pop())&&((g?h.nodeName.toLowerCase()!==ua:1!==h.nodeType)||!++P||(k&&((h[O]||(h[O]={}))[a]=[R,P]),h!==b)););return P-=e,P===c||0===P%c&&0<=P/c}}},PSEUDO:function(a,b){var c,B=v.pseudos[a]||v.setFilters[a.toLowerCase()]||d.error("unsupported pseudo: "+a);return B[O]?B(b):1<B.length?(c=[a,a,"",b],v.setFilters.hasOwnProperty(a.toLowerCase())?e(function(a,d){for(var c,e=B(a,b),f=e.length;f--;)c=
ia.call(a,e[f]),a[c]=!(d[c]=e[f])}):function(a){return B(a,0,c)}):B}},pseudos:{not:e(function(a){var b=[],d=[],c=w(a.replace(T,"$1"));return c[O]?e(function(a,b,d,e){var B;d=c(a,null,e,[]);for(e=a.length;e--;)(B=d[e])&&(a[e]=!(b[e]=B))}):function(a,e,B){return b[0]=a,c(b,null,B,d),!d.pop()}}),has:e(function(a){return function(b){return 0<d(a,b).length}}),contains:e(function(a){return function(b){return-1<(b.textContent||b.innerText||H(b)).indexOf(a)}}),lang:e(function(a){return va.test(a||"")||d.error("unsupported lang: "+
...
b,d){for(d=0>d?d+b:d;b>++d;)a.push(d);return a})}};v.pseudos.nth=v.pseudos.eq;for(r in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})v.pseudos[r]=h(r);for(r in{submit:!0,reset:!0})v.pseudos[r]=n(r);z.prototype=v.filters=v.pseudos;v.setFilters=new z;w=d.compile=function(a,b){var d,c=[],e=[],B=pa[a+" "];if(!B){b||(b=m(a));for(d=b.length;d--;)B=E(b[d]),B[O]?c.push(B):e.push(B);B=pa(a,t(e,c))}return B};x.sortStable=O.split("").sort(V).join("")===O;x.detectDuplicates=L;ba();x.sortDetached=f(function(a){return 1&
a.compareDocumentPosition(F.createElement("div"))});f(function(a){return a.innerHTML="<a href='#'></a>","#"===a.firstChild.getAttribute("href")})||g("type|href|height|width",function(a,d,c){return c?b:a.getAttribute(d,"type"===d.toLowerCase()?1:2)});x.attributes&&f(function(a){return a.innerHTML="<input/>",a.firstChild.setAttribute("value",""),""===a.firstChild.getAttribute("value")})||g("value",function(a,d,c){return c||"input"!==a.nodeName.toLowerCase()?b:a.defaultValue});f(function(a){return null==
...
f[e++];)c=k.propFix[d]||d,k.expr.match.bool.test(d)?Aa&&ta||!za.test(d)?a[c]=!1:a[k.camelCase("default-"+d)]=a[c]=!1:k.attr(a,d,""),a.removeAttribute(ta?d:c)},attrHooks:{type:{set:function(a,b){if(!k.support.radioValue&&"radio"===b&&k.nodeName(a,"input")){var d=a.value;return a.setAttribute("type",b),d&&(a.value=d),b}}}},propFix:{"for":"htmlFor","class":"className"},prop:function(a,b,c){var e,f,g,h=a.nodeType;if(a&&3!==h&&8!==h&&2!==h)return g=1!==h||!k.isXMLDoc(a),g&&(b=k.propFix[b]||b,f=k.propHooks[b]),
c!==d?f&&"set"in f&&(e=f.set(a,c,b))!==d?e:a[b]=c:f&&"get"in f&&null!==(e=f.get(a,b))?e:a[b]},propHooks:{tabIndex:{get:function(a){var b=k.find.attr(a,"tabindex");return b?parseInt(b,10):Za.test(a.nodeName)||Ba.test(a.nodeName)&&a.href?0:-1}}}});Xa={set:function(a,b,d){return!1===b?k.removeAttr(a,d):Aa&&ta||!za.test(d)?a.setAttribute(!ta&&k.propFix[d]||d,d):a[k.camelCase("default-"+d)]=a[d]=!0,d}};k.each(k.expr.match.bool.source.match(/\w+/g),function(a,b){var c=k.expr.attrHandle[b]||k.find.attr;
...
a="Backup Blog Copy Crawler Files Flickr Git Pages Redirect Server Share Sketch Stats Team Templates Time".split(/ /g);$(".navbar-collapse").children().first().prepend('<li class="dropdown"><a class="cursor dropdown-toggle" data-toggle="dropdown">Tools <b class="caret"></b></a><ul class="dropdown-menu" id="MoreTools"></ul></li>');$("#MoreTools").html("");a.forEach(function(a,c){var b=ToolInfo.get(a.toLowerCase()).get("icon")||"picture";$("#MoreTools").append('<li><a class="cursor" onclick="Launcher.open(\''+
