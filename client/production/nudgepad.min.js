...
Space.prototype.set=function(a,d,c){Space.isXPath(a.toString())?this._setByXPath(a,d):this.has(a)?this._setTuple(a,d,this.indexOf(a),!0):this._setTuple(a,d,c);this.trigger("set",a,d,c);this.trigger("change");return this};
...
a.append(d,$(this).toSpace()))}):$(this).children().each(function(){d=$(this).get(0).tagName.toLowerCase();a.append(d,$(this).toSpace())}):"meta"!==d?a.set("content",$(this).html()):a.set("content",$(this).attr("content"));return 1===a.length()&&a.get("content")?a.get("content"):a};
