...
e=parseFloat(e)||0}return e+y(a,b,c||(g?"border":"content"),d,f)+"px"}function U(a){var b=I,c=xb[a];return c||(c=V(a,b),"none"!==c&&c||(Ra=(Ra||k("<iframe frameborder='0' width='0' height='0'/>").css("cssText","display:block !important")).appendTo(b.documentElement),b=(Ra[0].contentWindow||Ra[0].contentDocument).document,b.write("<!doctype html><html><body>"),b.close(),c=V(a,b),Ra.detach()),xb[a]=c),c}function V(a,b){var c=k(b.createElement(a)).appendTo(b.body),d=k.css(c[0],"display");return c.remove(),
...
function(a,b){ha["[object "+b+"]"]=b.toLowerCase()});aa=k(I);(function(a,b){function c(a,b,d,e){var A,f,g,k,l;if((b?b.ownerDocument||b:da)!==D&&H(b),b=b||D,d=d||[],!a||"string"!=typeof a)return d;if(1!==(k=b.nodeType)&&9!==k)return[];if(I&&!e){if(A=ra.exec(a))if(g=A[1])if(9===k){if(f=b.getElementById(g),!f||!f.parentNode)return d;if(f.id===g)return d.push(f),d}else{if(b.ownerDocument&&(f=b.ownerDocument.getElementById(g))&&J(b,f)&&f.id===g)return d.push(f),d}else{if(A[2])return ba.apply(d,b.getElementsByTagName(a)),
d;if((g=A[3])&&r.getElementsByClassName&&b.getElementsByClassName)return ba.apply(d,b.getElementsByClassName(g)),d}if(r.qsa&&(!C||!C.test(a))){if(f=A=P,g=b,l=9===k&&a,1===k&&"object"!==b.nodeName.toLowerCase()){k=m(a);(A=b.getAttribute("id"))?f=A.replace(ta,"\\$&"):b.setAttribute("id",f);f="[id='"+f+"'] ";for(g=k.length;g--;)k[g]=f+E(k[g]);g=ea.test(a)&&b.parentNode||b;l=k.join(",")}if(l)try{return ba.apply(d,g.querySelectorAll(l)),d}catch(h){}finally{A||b.removeAttribute("id")}}}var Q;a:{a=a.replace(X,
...
if(c)for(;c=c.nextSibling;)if(c===b)return-1;return a?1:-1}function h(a){return function(b){return"input"===b.nodeName.toLowerCase()&&b.type===a}}function n(a){return function(b){var c=b.nodeName.toLowerCase();return("input"===c||"button"===c)&&b.type===a}}function q(a){return e(function(b){return b=+b,e(function(c,d){for(var e,A=a([],c.length,b),f=A.length;f--;)c[e=A[f]]&&(c[e]=!(d[e]=c[e]))})})}function z(){}function m(a,b){var d,e,A,f,g,k,l;if(g=ma[a+" "])return b?0:g.slice(0);g=a;k=[];for(l=w.preFilter;g;){d&&
!(e=T.exec(g))||(e&&(g=g.slice(e[0].length)||g),k.push(A=[]));d=!1;(e=wa.exec(g))&&(d=e.shift(),A.push({value:d,type:e[0].replace(X," ")}),g=g.slice(d.length));for(f in w.filter)!(e=Ha[f].exec(g))||l[f]&&!(e=l[f](e))||(d=e.shift(),A.push({value:d,type:f,matches:e}),g=g.slice(d.length));if(!d)break}return b?g.length:g?c.error(a):ma(a,k).slice(0)}function E(a){for(var b=0,c=a.length,d="";c>b;b++)d+=a[b].value;return d}function p(a,b,c){var d=b.dir,e=c&&"parentNode"===d,A=N++;return b.first?function(b,
c,A){for(;b=b[d];)if(1===b.nodeType||e)return a(b,c,A)}:function(b,c,f){var g,k,l,h=U+" "+A;if(f)for(;b=b[d];){if((1===b.nodeType||e)&&a(b,c,f))return!0}else for(;b=b[d];)if(1===b.nodeType||e)if(l=b[P]||(b[P]={}),(k=l[d])&&k[0]===h){if(!0===(g=k[1])||g===t)return!0===g}else if(k=l[d]=[h],k[1]=a(b,c,f)||t,!0===k[1])return!0}}function u(a){return 1<a.length?function(b,c,d){for(var e=a.length;e--;)if(!a[e](b,c,d))return!1;return!0}:a[0]}function O(a,b,c,d,e){for(var A,f=[],g=0,k=a.length,l=null!=b;k>
g;g++)(A=a[g])&&(!c||c(A,d,e))&&(f.push(A),l&&b.push(g));return f}function K(a,b,d,A,f,g){return A&&!A[P]&&(A=K(A)),f&&!f[P]&&(f=K(f,g)),e(function(e,g,k,l){var h,Q,n=[],q=[],ua=g.length,z;if(!(z=e)){z=b||"*";for(var m=k.nodeType?[k]:k,Ca=[],E=0,p=m.length;p>E;E++)c(z,m[E],Ca);z=Ca}z=!a||!e&&b?z:O(z,n,a,k,l);m=d?f||(e?a:ua||A)?[]:g:z;if(d&&d(z,m,k,l),A)for(h=O(m,q),A(h,[],k,l),k=h.length;k--;)(Q=h[k])&&(m[q[k]]=!(z[q[k]]=Q));if(e){if(f||a){if(f){h=[];for(k=m.length;k--;)(Q=m[k])&&h.push(z[k]=Q);f(null,
m=[],h,l)}for(k=m.length;k--;)(Q=m[k])&&-1<(h=f?W.call(e,Q):n[k])&&(e[h]=!(g[h]=Q))}}else m=O(m===g?m.splice(ua,m.length):m),f?f(null,g,m,l):ba.apply(g,m)})}function F(a){var b,c,d,e=a.length,A=w.relative[a[0].type];c=A||w.relative[" "];for(var f=A?1:0,g=p(function(a){return a===b},c,!0),k=p(function(a){return-1<W.call(b,a)},c,!0),l=[function(a,c,d){return!A&&(d||c!==aa)||((b=c).nodeType?g(a,c,d):k(a,c,d))}];e>f;f++)if(c=w.relative[a[f].type])l=[p(u(l),c)];else{if(c=w.filter[a[f].type].apply(null,
a[f].matches),c[P]){for(d=++f;e>d&&!w.relative[a[d].type];d++);return K(1<f&&u(l),1<f&&E(a.slice(0,f-1).concat({value:" "===a[f-2].type?"*":""})).replace(X,"$1"),c,d>f&&F(a.slice(f,d)),e>d&&F(a=a.slice(d)),e>d&&E(a))}l.push(c)}return u(l)}function x(a,b){var d=0,A=0<b.length,f=0<a.length,g=function(e,g,k,l,h){var Q,n,q=[],ua=0,z="0",m=e&&[],E=null!=h,Ca=aa,p=e||f&&w.find.TAG("*",h&&g.parentNode||g),u=U+=null==Ca?1:Math.random()||0.1;for(E&&(aa=g!==D&&g,t=d);null!=(h=p[z]);z++){if(f&&h){for(Q=0;n=
a[Q++];)if(n(h,g,k)){l.push(h);break}E&&(U=u,t=++d)}A&&((h=!n&&h)&&ua--,e&&m.push(h))}if(ua+=z,A&&z!==ua){for(Q=0;n=b[Q++];)n(m,q,g,k);if(e){if(0<ua)for(;z--;)m[z]||q[z]||(q[z]=ca.call(l));q=O(q)}ba.apply(l,q);E&&!e&&0<q.length&&1<ua+b.length&&c.uniqueSort(l)}return E&&(U=u,aa=Ca),m};return A?e(g):g}var B,r,t,w,Y,s,v,aa,y,H,D,R,I,C,la,G,J,P="sizzle"+-new Date,da=a.document,U=0,N=0,L=d(),ma=d(),pa=d(),V=!1,M=function(a,b){return a===b?(V=!0,0):0},ja=typeof b,S=-2147483648,qa={}.hasOwnProperty,Z=[],
...
ga=function(a,b,c){a="0x"+b-65536;return a!==a||c?b:0>a?String.fromCharCode(a+65536):String.fromCharCode(55296|a>>10,56320|1023&a)};try{ba.apply(Z=oa.call(da.childNodes),da.childNodes),Z[da.childNodes.length].nodeType}catch(Ta){ba={apply:Z.length?function(a,b){kb.apply(a,oa.call(b))}:function(a,b){for(var c=a.length,d=0;a[c++]=b[d++];);a.length=c-1}}}s=c.isXML=function(a){return(a=a&&(a.ownerDocument||a).documentElement)?"HTML"!==a.nodeName:!1};r=c.support={};H=c.setDocument=function(a){var c=a?a.ownerDocument||
a:da;a=c.defaultView;return c!==D&&9===c.nodeType&&c.documentElement?(D=c,R=c.documentElement,I=!s(c),a&&a.attachEvent&&a!==a.top&&a.attachEvent("onbeforeunload",function(){H()}),r.attributes=f(function(a){return a.className="i",!a.getAttribute("className")}),r.getElementsByTagName=f(function(a){return a.appendChild(c.createComment("")),!a.getElementsByTagName("*").length}),r.getElementsByClassName=f(function(a){return a.innerHTML="<div class='a'></div><div class='a i'></div>",a.firstChild.className=
"i",2===a.getElementsByClassName("i").length}),r.getById=f(function(a){return R.appendChild(a).id=P,!c.getElementsByName||!c.getElementsByName(P).length}),r.getById?(w.find.ID=function(a,b){if(typeof b.getElementById!==ja&&I){var c=b.getElementById(a);return c&&c.parentNode?[c]:[]}},w.filter.ID=function(a){var b=a.replace(fa,ga);return function(a){return a.getAttribute("id")===b}}):(delete w.find.ID,w.filter.ID=function(a){var b=a.replace(fa,ga);return function(a){return(a=typeof a.getAttributeNode!==
ja&&a.getAttributeNode("id"))&&a.value===b}}),w.find.TAG=r.getElementsByTagName?function(a,c){return typeof c.getElementsByTagName!==ja?c.getElementsByTagName(a):b}:function(a,b){var c,d=[],e=0,A=b.getElementsByTagName(a);if("*"===a){for(;c=A[e++];)1===c.nodeType&&d.push(c);return d}return A},w.find.CLASS=r.getElementsByClassName&&function(a,c){return typeof c.getElementsByClassName!==ja&&I?c.getElementsByClassName(a):b},la=[],C=[],(r.qsa=ia.test(c.querySelectorAll))&&(f(function(a){a.innerHTML="<select><option selected=''></option></select>";
...
!(c.contains?c.contains(d):a.compareDocumentPosition&&16&a.compareDocumentPosition(d)))}:function(a,b){if(b)for(;b=b.parentNode;)if(b===a)return!0;return!1},M=R.compareDocumentPosition?function(a,b){if(a===b)return V=!0,0;var d=b.compareDocumentPosition&&a.compareDocumentPosition&&a.compareDocumentPosition(b);return d?1&d||!r.sortDetached&&b.compareDocumentPosition(a)===d?a===c||J(da,a)?-1:b===c||J(da,b)?1:y?W.call(y,a)-W.call(y,b):0:4&d?-1:1:a.compareDocumentPosition?-1:1}:function(a,b){var d,e=
0;d=a.parentNode;var A=b.parentNode,f=[a],g=[b];if(a===b)return V=!0,0;if(!d||!A)return a===c?-1:b===c?1:d?-1:A?1:y?W.call(y,a)-W.call(y,b):0;if(d===A)return l(a,b);for(d=a;d=d.parentNode;)f.unshift(d);for(d=b;d=d.parentNode;)g.unshift(d);for(;f[e]===g[e];)e++;return e?l(f[e],g[e]):f[e]===da?-1:g[e]===da?1:0},c):D};c.matches=function(a,b){return c(a,null,null,b)};c.matchesSelector=function(a,b){if((a.ownerDocument||a)!==D&&H(a),b=b.replace(ka,"='$1']"),r.matchesSelector&&I&&!(la&&la.test(b)||C&&C.test(b)))try{var d=
G.call(a,b);if(d||r.disconnectedMatch||a.document&&11!==a.document.nodeType)return d}catch(e){}return 0<c(b,D,null,[a]).length};c.contains=function(a,b){return(a.ownerDocument||a)!==D&&H(a),J(a,b)};c.attr=function(a,c){(a.ownerDocument||a)!==D&&H(a);var d=w.attrHandle[c.toLowerCase()],d=d&&qa.call(w.attrHandle,c.toLowerCase())?d(a,c,!I):b;return d===b?r.attributes||!I?a.getAttribute(c):(d=a.getAttributeNode(c))&&d.specified?d.value:null:d};c.error=function(a){throw Error("Syntax error, unrecognized expression: "+
a);};c.uniqueSort=function(a){var b,c=[],d=0,e=0;if(V=!r.detectDuplicates,y=!r.sortStable&&a.slice(0),a.sort(M),V){for(;b=a[e++];)b===a[e]&&(d=c.push(e));for(;d--;)a.splice(c[d],1)}return a};Y=c.getText=function(a){var b,c="",d=0;if(b=a.nodeType)if(1===b||9===b||11===b){if("string"==typeof a.textContent)return a.textContent;for(a=a.firstChild;a;a=a.nextSibling)c+=Y(a)}else{if(3===b||4===b)return a.nodeValue}else for(;b=a[d];d++)c+=Y(b);return c};w=c.selectors={cacheLength:50,createPseudo:e,match:Ha,
...
e?function(a){return!!a.parentNode}:function(b,c,k){var l,h,Q,na,n;c=A!==f?"nextSibling":"previousSibling";var q=b.parentNode,ua=g&&b.nodeName.toLowerCase();k=!k&&!g;if(q){if(A){for(;c;){for(h=b;h=h[c];)if(g?h.nodeName.toLowerCase()===ua:1===h.nodeType)return!1;n=c="only"===a&&!n&&"nextSibling"}return!0}if(n=[f?q.firstChild:q.lastChild],f&&k)for(k=q[P]||(q[P]={}),l=k[a]||[],na=l[0]===U&&l[1],Q=l[0]===U&&l[2],h=na&&q.childNodes[na];h=++na&&h&&h[c]||(Q=na=0)||n.pop();){if(1===h.nodeType&&++Q&&h===b){k[a]=
[U,na,Q];break}}else if(k&&(l=(b[P]||(b[P]={}))[a])&&l[0]===U)Q=l[1];else for(;(h=++na&&h&&h[c]||(Q=na=0)||n.pop())&&((g?h.nodeName.toLowerCase()!==ua:1!==h.nodeType)||!++Q||(k&&((h[P]||(h[P]={}))[a]=[U,Q]),h!==b)););return Q-=e,Q===d||0===Q%d&&0<=Q/d}}},PSEUDO:function(a,b){var d,A=w.pseudos[a]||w.setFilters[a.toLowerCase()]||c.error("unsupported pseudo: "+a);return A[P]?A(b):1<A.length?(d=[a,a,"",b],w.setFilters.hasOwnProperty(a.toLowerCase())?e(function(a,c){for(var d,e=A(a,b),f=e.length;f--;)d=
...
b,c){for(c=0>c?c+b:c;b>++c;)a.push(c);return a})}};w.pseudos.nth=w.pseudos.eq;for(B in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})w.pseudos[B]=h(B);for(B in{submit:!0,reset:!0})w.pseudos[B]=n(B);z.prototype=w.filters=w.pseudos;w.setFilters=new z;v=c.compile=function(a,b){var c,d=[],e=[],A=pa[a+" "];if(!A){b||(b=m(a));for(c=b.length;c--;)A=F(b[c]),A[P]?d.push(A):e.push(A);A=pa(a,x(e,d))}return A};r.sortStable=P.split("").sort(M).join("")===P;r.detectDuplicates=V;H();r.sortDetached=f(function(a){return 1&
a.compareDocumentPosition(D.createElement("div"))});f(function(a){return a.innerHTML="<a href='#'></a>","#"===a.firstChild.getAttribute("href")})||g("type|href|height|width",function(a,c,d){return d?b:a.getAttribute(c,"type"===c.toLowerCase()?1:2)});r.attributes&&f(function(a){return a.innerHTML="<input/>",a.firstChild.setAttribute("value",""),""===a.firstChild.getAttribute("value")})||g("value",function(a,c,d){return d||"input"!==a.nodeName.toLowerCase()?b:a.defaultValue});f(function(a){return null==
...
a="text",c.match(/\.([^\.]+)$/)&&(a=c.match(/\.([^\.]+)$/)[1],"js"===a&&(a="javascript")),TextPrompt.editor=ace.edit("AcePrompt"),TextPrompt.editor.setTheme("ace/theme/monokai"),TextPrompt.editor.setShowPrintMargin(!1),TextPrompt.editor.getSession().setMode("ace/mode/"+a),TextPrompt.editor.setValue(d),TextPrompt.editor.getSession().setUseWrapMode(!0),TextPrompt.editor.getSession().setUseSoftTabs(!0),TextPrompt.editor.getSession().setTabSize(2),TextPrompt.editor.focus(),TextPrompt.editor.clearSelection()):
($("#TextPromptTextarea").on("tap mousedown click slide slidestart slideend mouseup",function(a){a.stopPropagation()}),$("#TextPromptTextarea").css("height",a+"px"),$("#TextPromptTextarea").val(d).focus())},useAce:function(){return TextPrompt.ace},value:function(a){return a?TextPrompt.useAce()?TextPrompt.editor.setValue(a):$("#TextPromptTextarea").val(a):TextPrompt.useAce()?TextPrompt.editor.getValue():$("#TextPromptTextarea").val()}},Backup=new Tool("Backup");
Backup.on("ready",function(){$("#BackupDownload").attr("href","/nudgepad.backup/"+document.location.host+".zip")});var Blog=new Tool("Blog");Blog.set("posts",new Space);Blog.active={};Blog.active.filename=null;Blog.active.advanced=function(){var a=Blog.get("posts "+Blog.active.filename);TextPrompt.open("Advanced",a.toString(),Blog.active.filename,function(d){a.clear();a.patch(d);a.save();Blog.active.open(Blog.active.filename)})};
...
Blog.Post.prototype.save=function(){expressfs.writeFile("nudgepad/posts/"+this._filename,this.toString(),function(){Alerts.success("Saved")})};Blog.Post.prototype.trash=function(){expressfs.unlink("nudgepad/posts/"+this._filename,function(){Alerts.success("Deleted")});Blog.delete("posts "+this._filename)};var Clone=new Tool("Clone");Clone.set("path","");
Clone.cloneIt=function(){$("#CloneError").html("");var a=$("#CloneServer").val(),d=$("#CloneDomain").val();$.post("http://"+a+"/isDomainAvailable",{domain:d},function(a){if("no"===a)return $("#CloneError").html("Domain taken"),!1;nudgepad.status.get("hostname")==$("#CloneServer").val()?Clone.quickClone():Clone.cloneProject()})};Clone.import=function(){TextPrompt.open("Import a Project to this project","","import.space",function(a){$.post("/nudgepad.import",{space:a},function(a){Alerts.success("Imported files.")})})};
Clone.on("ready",function(){$("#CloneDomain").val(document.location.host+"2");$("#CloneServer").val(nudgepad.status.get("hostname"))});Clone.on("once",function(){expressfs.readFile("nudgepad/sharecode.txt",function(a){a?Clone.code=a:Clone.install()})});
...
Labs.renderMenu=function(){$("#OpenTool #LabsContainer").html("");var a="Backup Blog Clone Crawler Fiddle Files Flickr Forms Git Pages Redirect Server Share Sketch SQLite Stats Team Templates Time".split(/ /g),d="rgb(26,134,214) rgb(36,65,112) rgb(231,189,44) rgb(171,193,199) rgb(224,54,52) rgb(71,41,54)".split(" "),c='<div class="row">',b;for(b in a){var e=window[a[b]];0<b&&0===b%3&&(c+='</div><div class="row">');var e=e.get("name"),f=ToolInfo.get(e.toLowerCase()),c=c+Labs.toButton(e,f.get("description"),
...
var SQLite=new Tool("SQLite");SQLite.install=function(){$.get("/nudgepad/tools/sqlite/sqlite-server.js.txt?t="+(new Date).getTime(),{},function(a){expressfs.writeFile("nudgepad/packages/sqlite-server.js",a,function(){Alerts.success("Installed SQLite. Please restart server.")})})};var Stats=new Tool("Stats");Stats.htmlPages=[];Stats.hits={};
Stats.compute=function(){Stats.hits={};expressfs.readFile("nudgepad/requests.log.txt",function(a){a.split(/\n/g).forEach(function(a,c){var b=a.split(/ /g);if(!b[1])return!0;"/"===b[1]&&(b[1]="/index.html");var e=b[1].substr(1);Stats.hits[e]?Stats.hits[e].push(b[0]):Stats.hits[e]=[b[0]]});Stats.trigger("pages")})};Stats.downloadPages=function(){Stats.htmlPages=[];expressfs.readdir("",function(a,d){d.forEach(function(a,b){a.match(/\.html$/)&&Stats.htmlPages.push(a)})})};Stats.on("once",Stats.downloadPages);
