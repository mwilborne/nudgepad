...
Home.renderMenu=function(){$("#OpenTool #HomeContainer").html("");var a="Templates Pages Files Team Server Git".split(" "),d="rgb(26,134,214) rgb(36,65,112) rgb(231,189,44) rgb(171,193,199) rgb(224,54,52) rgb(71,41,54)".split(" "),c='<div class="row">',b;for(b in a){var e=window[a[b]];0<b&&0===b%3&&(c+='</div><div class="row">');var e=e.get("name"),g=ToolInfo.get(e.toLowerCase()),c=c+Home.toButton(e,g.get("description"),d[b?b%d.length:0],g.get("icon")||"picture")}0!==(b+1)%3&&(c+="</div>");$("#OpenTool #HomeContainer").append(c);
