...
b)return!1;return!0}function l(){return!0}function n(){return!1}function t(){try{return I.activeElement}catch(a){}}function r(a,b){do a=a[b];while(a&&1!==a.nodeType);return a}function s(a,b,d){if(k.isFunction(b))return k.grep(a,function(a,B){return!!b.call(a,B,a)!==d});if(b.nodeType)return k.grep(a,function(a){return a===b!==d});if("string"==typeof b){if(kb.test(b))return k.filter(b,a,d);b=k.filter(b,a)}return k.grep(a,function(a){return 0<=k.inArray(a,b)!==d})}function p(a){var b=Ja.split("|");a=
a.createDocumentFragment();if(a.createElement)for(;b.length;)a.createElement(b.pop());return a}function x(a,b){return k.nodeName(a,"table")&&k.nodeName(1===b.nodeType?b:b.firstChild,"tr")?a.getElementsByTagName("tbody")[0]||a.appendChild(a.ownerDocument.createElement("tbody")):a}function w(a){return a.type=(null!==k.find.attr(a,"type"))+"/"+a.type,a}function A(a){var b=Nb.exec(a.type);return b?a.type=b[1]:a.removeAttribute("type"),a}function K(a,b){for(var d,c=0;null!=(d=a[c]);c++)k._data(d,"globalEval",
!b||k._data(b[c],"globalEval"))}function J(a,b){if(1===b.nodeType&&k.hasData(a)){var d,c,e;c=k._data(a);var f=k._data(b,c),g=c.events;if(g)for(d in delete f.handle,f.events={},g)for(c=0,e=g[d].length;e>c;c++)k.event.add(b,d,g[d][c]);f.data&&(f.data=k.extend({},f.data))}}function D(a,b){var c,e,f=0,g=typeof a.getElementsByTagName!==ca?a.getElementsByTagName(b||"*"):typeof a.querySelectorAll!==ca?a.querySelectorAll(b||"*"):d;if(!g)for(g=[],c=a.childNodes||a;null!=(e=c[f]);f++)!b||k.nodeName(e,b)?g.push(e):
k.merge(g,D(e,b));return b===d||b&&k.nodeName(a,b)?k.merge([a],g):g}function M(a){lb.test(a.type)&&(a.defaultChecked=a.checked)}function m(a,b){if(b in a)return b;for(var d=b.charAt(0).toUpperCase()+b.slice(1),c=b,e=wb.length;e--;)if(b=wb[e]+d,b in a)return b;return c}function C(a,b){return a=b||a,"none"===k.css(a,"display")||!k.contains(a.ownerDocument,a)}function N(a,b){for(var d,c,e,f=[],g=0,h=a.length;h>g;g++)c=a[g],c.style&&(f[g]=k._data(c,"olddisplay"),d=c.style.display,b?(f[g]||"none"!==d||
(c.style.display=""),""===c.style.display&&C(c)&&(f[g]=k._data(c,"olddisplay",R(c.nodeName)))):f[g]||(e=C(c),(d&&"none"!==d||!e)&&k._data(c,"olddisplay",e?d:k.css(c,"display"))));for(g=0;h>g;g++)c=a[g],c.style&&(b&&"none"!==c.style.display&&""!==c.style.display||(c.style.display=b?f[g]||"":"none"));return a}function G(a,b,c){return(a=Ob.exec(b))?Math.max(0,a[1]-(c||0))+(a[2]||"px"):b}function y(a,b,c,d,e){b=c===(d?"border":"content")?4:"width"===b?1:0;for(var f=0;4>b;b+=2)"margin"===c&&(f+=k.css(a,
...
e=[],f=0,g=a.length;for(c=!!c;g>f;f++)d=!!b(a[f],f),c!==d&&e.push(a[f]);return e},map:function(a,b,d){var e,f=0,g=a.length,k=[];if(c(a))for(;g>f;f++)e=b(a[f],f,d),null!=e&&(k[k.length]=e);else for(f in a)e=b(a[f],f,d),null!=e&&(k[k.length]=e);return va.apply([],k)},guid:1,proxy:function(a,b){var c,e,f;return"string"==typeof b&&(f=a[b],b=a,a=f),k.isFunction(a)?(c=z.call(arguments,2),e=function(){return a.apply(b||this,c.concat(z.call(arguments)))},e.guid=a.guid=a.guid||k.guid++,e):d},access:function(a,
...
Space.prototype.set=function(a,d,c){Space.isXPath(a.toString())?this._setByXPath(a,d):"number"===typeof c?this._setTuple(a,d,c,!0):this.has(a)?this._setTuple(a,d,this.indexOf(a),!0):this._setTuple(a,d,c);this.trigger("set",a,d,c);this.trigger("change");return this};
...
function(a){Project.trigger("uploadComplete",a)})});$(document).on("ready",function(){if("content"in document.createElement("template"))return!0;$("template.Tool").each(function(){window[$(this).attr("id")].html=this.innerHTML;$(this).replaceWith("")})});
...
Blog.Post.prototype.save=function(){expressfs.writeFile("nudgepad/posts/"+this._filename,this.toString(),function(){Alerts.success("Saved")})};Blog.Post.prototype.trash=function(){expressfs.unlink("nudgepad/posts/"+this._filename,function(){Alerts.success("Deleted")});Blog.delete("posts "+this._filename)};var Builder=new Tool("Builder");Builder.refresh=function(){$("#BuilderStage").html(Builder.page.toHtml(Builder.filter));$("#BuilderSource").val(Builder.page.toString())};
...
$(this).html(Builder.page.toHtml(Builder.filter))}});$("#BuilderSource").on("keyup",function(){Builder.page.reload($("#BuilderSource").val()).loadScraps();$("#BuilderStage").html(Builder.page.toHtml(Builder.filter))});$("#BuilderStage").on("click","*",function(a){$(this).is("a")&&a.preventDefault();if($(this).find(".Scrap").length||!$(this).hasClass("Scrap")||!$(this).text().length)return!0;$(this).attr("contenteditable",!0);$(this).focus();a=$(this).attr("data-index");Builder.page.reload($("#BuilderSource").val()).loadScraps();
var d=Builder.page.getByIndex(a);$(this).on("keyup",function(){var a=$(this).html();d.set("content",a);$("#BuilderSource").val(Builder.page.toString());Builder.page.trigger("reload")});$(this).on("blur",function(){$(this).removeAttr("contenteditable");var a=$(this).html();d.set("content",a);$("#BuilderSource").val(Builder.page.toString());Builder.page.trigger("reload")})});Builder.page.on("reload",function(){store.set("page",this.toString())})});
Builder.publish=function(){var a=prompt("Enter a filename","new.html");if(!a)return!1;expressfs.writeFileAndOpen(a,Builder.page.toHtml())};var Clone=new Tool("Clone");Clone.set("path","");Clone.import=function(){TextPrompt.open("Import a Project to this project","","import.space",function(a){$.post("/nudgepad.import",{space:a},function(a){Alerts.success("Imported files.")})})};Clone.on("ready",function(){$("#CloneDomain").val("copyof"+document.location.host);$("#CloneServer").val(Project.get("hostname"))});
Clone.on("once",function(){expressfs.readFile("nudgepad/sharecode.txt",function(a){a?Clone.code=a:Clone.install()})});
...
Clone.quickClone=function(){var a=$("#CloneDomain").val(),d=Project.get("hostname");$("<form>",{action:"http://"+d+"/create",target:"_blank",method:"post"}).append($("<input>",{name:"domain",value:a,type:"hidden"})).append($("<input>",{name:"dir",value:"/nudgepad/projects/"+document.location.host,type:"hidden"})).append($("<input>",{name:"timestamp",value:(new Date).getTime(),type:"hidden"})).append($("<input>",{name:"sharecode",value:Clone.code,type:"hidden"})).append($("<input>",{name:"email",value:Cookie.email,
...
Files.newFile=function(){var a=prompt("Enter the filename");if(!a)return!1;var d=Files.get("path")?Files.get("path")+" ":"";expressfs.create((d+a).replace(/ /g,"/"),"",Files.refresh)};Files.newFolder=function(){var a=prompt("Enter the folder name");if(!a)return!1;var d=Files.get("path")?Files.get("path")+" ":"";expressfs.mkdir((d+a).replace(/ /g,"/"),Files.refresh)};
...
Flickr.search=function(a){Flickr.query=a||"";a="http://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=caf160db8d568920296a366f58cb3a0c&text="+a+"&format=json&nojsoncallback=1";$("#photos").html('<center><img src="/nudgepad/public/images/spinner.gif"></center>');$.getJSON(a,function(a){a=(new Space(a)).get("photos photo");$("#photos").html("");console.log(a.toString());var c=0;a.each(function(a,d){c++;var g="http://farm"+d.get("farm")+".staticflickr.com/"+d.get("server")+"/"+d.get("id")+
"_"+d.get("secret")+"_n.jpg",f="http://farm"+d.get("farm")+".staticflickr.com/"+d.get("server")+"/"+d.get("id")+"_"+d.get("secret")+"_b.jpg";$("#photos").append('<img class="cursor" src="'+g+'" onclick="Flickr.download(\''+f+"')\"></a>");if(30<c)return!1})}).fail(function(){Alerts.error("Please try again");$("#photos").html("")})};Flickr.on("ready",function(){});var Git=new Tool("Git");Git.gitignore="nudgepad/";
...
Git.cloneRepo=function(){var a=prompt("Enter clone URI","https://github.com/");if(!a)return!1;Git.exec("git clone "+a+" temp; mv temp/* .; mv temp/.git .; rm -rf temp",function(){Alerts.success("Cloned")})};Git.checkout=function(){Git.exec("git checkout -b nudgepad",function(){Alerts.success("Switched to NudgePad branch")})};Git.commit=function(){var a=prompt("Enter your message");if(!a)return!1;Git.exec('git commit -am "'+a+'"',function(){Alerts.success("Commit Received")})};
...
Git.fixKey=function(){Git.exec("ssh-keyscan -t rsa1,rsa,dsa github.com >> /home/"+document.location.hostname+"/.ssh/known_hosts")};Git.generateKey=function(){Git.exec('ssh-keygen -t rsa -N "" -f '+(Explorer.paths.nudgepad+"deploy.key"),function(){Alerts.success("Git SSH key created");Git.status();expressfs.readFile("nudgepad/deploy.key.pub",function(a){a=$('<textarea readonly="readonly" id="PreviewBoxWhiteBox" style="text-align: left;">'+a+"</textarea>");PreviewBox.open(a)})})};
Git.init=function(){expressfs.writeFile(".gitignore",Git.gitignore,function(){Git.exec("git init",function(){Alerts.success("Git init OK");Git.status()})})};Git.install=function(){if(!confirm("This will run git init and start your repo."))return!1;expressfs.writeFile(".gitignore",Git.gitignore,function(){Git.exec('git init; git add .; git commit -am "initial commit"; git checkout -b nudgepad;',function(){Alerts.success("Git setup OK")})})};
Git.pull=function(){Git.exec("ssh-agent bash -c 'ssh-add /nudgepad/projects/"+document.location.hostname+"/nudgepad/deploy.key; git pull'")};Git.push=function(){var a="ssh-agent bash -c 'ssh-add /nudgepad/projects/"+document.location.hostname+"/nudgepad/deploy.key; git push -u origin master'";console.log(a);Git.exec(a)};Git.setOrigin=function(){var a=prompt("Enter origin URI");if(!a)return!1;Git.exec("git remote set-url origin "+a,function(){Alerts.success("Origin Updated")})};
Git.squash=function(){var a=prompt("Enter your message");if(!a)return!1;Git.exec('git checkout master; git squash nudgepad "'+a+'"; git checkout -b nudgepad')};Git.status=function(){Git.exec("git status")};Git.on("ready",Git.status);var Home=new Tool("Home");
...
Home.on("ready",function(){Home.renderMenu();$(window).on("resize",Home.heights)});Home.on("close",function(){$(window).off("resize",Home.heights)});var Labs=new Tool("Labs");
Labs.renderMenu=function(){$("#OpenTool #LabsContainer").html("");var a="Backup Blog Builder Clone Crawler Fiddle Files Flickr Git Pages Redirect Server Share Sketch Stats Team Templates Time".split(/ /g),d="rgb(26,134,214) rgb(36,65,112) rgb(231,189,44) rgb(171,193,199) rgb(224,54,52) rgb(71,41,54)".split(" "),c='<div class="row">',b;for(b in a){var e=window[a[b]];0<b&&0===b%3&&(c+='</div><div class="row">');var e=e.get("name"),g=ToolInfo.get(e.toLowerCase()),c=c+Labs.toButton(e,g.get("description"),
d[b?b%d.length:0],g.get("icon")||"picture")}0!==(b+1)%3&&(c+="</div>");$("#OpenTool #LabsContainer").append(c);Labs.heights()};Labs.heights=function(){var a=0;$(".jumbotron").css("height","auto");$(".jumbotron").each(function(){$(this).height()>a&&(a=$(this).height())}).height(a)};
...
Pages.editor.editHtml=function(){var a=html_beautify(Pages.editor.openPage().toHtml(),{"indent-size":2,"indent-char":" ","indent-inner-html":!0});TextPrompt.open("",a,Pages.editor.filename,function(a){Pages.editor.pages.set(Pages.editor.filename,new Scraps.Page($.htmlToScraps(a)));Pages.editor.open(Pages.editor.filename)})};
Pages.editor.editScraps=function(){TextPrompt.open("",Pages.editor.openPage().toString(),Pages.editor.filename.replace("html","space"),function(a){Pages.editor.pages.set(Pages.editor.filename,new Scraps.Page(a));Pages.editor.open(Pages.editor.filename)})};Pages.editor.open=function(a){Pages.editor.filename=a;if(!Pages.editor.pages.get(Pages.editor.filename))return!0;$("#PagesFilename").html(a);Pages.editor.render();console.log(a)};Pages.editor.openPage=function(){return Pages.editor.pages.get(Pages.editor.filename)};
Pages.editor.publish=function(){var a=html_beautify(Pages.editor.openPage().toHtml(),{"indent-size":2,"indent-char":" ","indent-inner-html":!0});expressfs.writeFileAndOpen(Pages.editor.filename,a)};
