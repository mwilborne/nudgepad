...
(d.style.display=""),""===d.style.display&&C(d)&&(g[f]=k._data(d,"olddisplay",U(d.nodeName)))):g[f]||(e=C(d),(c&&"none"!==c||!e)&&k._data(d,"olddisplay",e?c:k.css(d,"display"))));for(f=0;h>f;f++)d=a[f],d.style&&(b&&"none"!==d.style.display&&""!==d.style.display||(d.style.display=b?g[f]||"":"none"));return a}function G(a,b,d){return(a=Ob.exec(b))?Math.max(0,a[1]-(d||0))+(a[2]||"px"):b}function x(a,b,d,c,e){b=d===(c?"border":"content")?4:"width"===b?1:0;for(var f=0;4>b;b+=2)"margin"===d&&(f+=k.css(a,
...
e=parseFloat(e)||0}return e+x(a,b,d||(g?"border":"content"),c,f)+"px"}function U(a){var b=I,d=xb[a];return d||(d=V(a,b),"none"!==d&&d||(Ra=(Ra||k("<iframe frameborder='0' width='0' height='0'/>").css("cssText","display:block !important")).appendTo(b.documentElement),b=(Ra[0].contentWindow||Ra[0].contentDocument).document,b.write("<!doctype html><html><body>"),b.close(),d=V(a,b),Ra.detach()),xb[a]=d),d}function V(a,b){var d=k(b.createElement(a)).appendTo(b.body),c=k.css(d[0],"display");return d.remove(),
...
b,c,e,f,g,h){var l=0,n=a.length,r=null==c;if("object"===k.type(c))for(l in f=!0,c)k.access(a,b,l,c[l],!0,g,h);else if(e!==d&&(f=!0,k.isFunction(e)||(h=!0),r&&(h?(b.call(a,e),b=null):(r=b,b=function(a,b,d){return r.call(k(a),d)})),b))for(;n>l;l++)b(a[l],c,h?e:e.call(a[l],l,b(a[l],c)));return f?a:r?b.call(a):n?b(a[0],c):g},now:function(){return(new Date).getTime()},swap:function(a,b,d,c){var e,f={};for(e in b)f[e]=a.style[e],a.style[e]=b[e];d=d.apply(a,c||[]);for(e in b)a.style[e]=f[e];return d}});
...
c;if((g=A[3])&&q.getElementsByClassName&&b.getElementsByClassName)return ba.apply(c,b.getElementsByClassName(g)),c}if(q.qsa&&(!C||!C.test(a))){if(f=A=P,g=b,h=9===k&&a,1===k&&"object"!==b.nodeName.toLowerCase()){k=m(a);(A=b.getAttribute("id"))?f=A.replace(ta,"\\$&"):b.setAttribute("id",f);f="[id='"+f+"'] ";for(g=k.length;g--;)k[g]=f+E(k[g]);g=ea.test(a)&&b.parentNode||b;h=k.join(",")}if(h)try{return ba.apply(c,g.querySelectorAll(h)),c}catch(l){}finally{A||b.removeAttribute("id")}}}var Q;a:{a=a.replace(X,
...
if(d)for(;d=d.nextSibling;)if(d===b)return-1;return a?1:-1}function l(a){return function(b){return"input"===b.nodeName.toLowerCase()&&b.type===a}}function n(a){return function(b){var d=b.nodeName.toLowerCase();return("input"===d||"button"===d)&&b.type===a}}function r(a){return e(function(b){return b=+b,e(function(d,c){for(var e,A=a([],d.length,b),f=A.length;f--;)d[e=A[f]]&&(d[e]=!(c[e]=d[e]))})})}function y(){}function m(a,b){var c,e,A,f,g,k,h;if(g=ma[a+" "])return b?0:g.slice(0);g=a;k=[];for(h=w.preFilter;g;){c&&
...
a[f].matches),d[P]){for(c=++f;e>c&&!w.relative[a[c].type];c++);return K(1<f&&u(h),1<f&&E(a.slice(0,f-1).concat({value:" "===a[f-2].type?"*":""})).replace(X,"$1"),d,c>f&&F(a.slice(f,c)),e>c&&F(a=a.slice(c)),e>c&&E(a))}h.push(d)}return u(h)}function z(a,b){var c=0,A=0<b.length,f=0<a.length,g=function(e,g,k,h,l){var Q,n,r=[],ua=0,y="0",m=e&&[],E=null!=l,Ca=aa,p=e||f&&w.find.TAG("*",l&&g.parentNode||g),u=U+=null==Ca?1:Math.random()||0.1;for(E&&(aa=g!==D&&g,t=c);null!=(l=p[y]);y++){if(f&&l){for(Q=0;n=
a[Q++];)if(n(l,g,k)){h.push(l);break}E&&(U=u,t=++c)}A&&((l=!n&&l)&&ua--,e&&m.push(l))}if(ua+=y,A&&y!==ua){for(Q=0;n=b[Q++];)n(m,r,g,k);if(e){if(0<ua)for(;y--;)m[y]||r[y]||(r[y]=ca.call(h));r=O(r)}ba.apply(h,r);E&&!e&&0<r.length&&1<ua+b.length&&d.uniqueSort(h)}return E&&(U=u,aa=Ca),m};return A?e(g):g}var B,q,t,w,Y,s,v,aa,x,H,D,R,I,C,la,G,J,P="sizzle"+-new Date,da=a.document,U=0,N=0,L=c(),ma=c(),pa=c(),V=!1,M=function(a,b){return a===b?(V=!0,0):0},ja=typeof b,S=-2147483648,qa={}.hasOwnProperty,Z=[],
...
ga=function(a,b,d){a="0x"+b-65536;return a!==a||d?b:0>a?String.fromCharCode(a+65536):String.fromCharCode(55296|a>>10,56320|1023&a)};try{ba.apply(Z=oa.call(da.childNodes),da.childNodes),Z[da.childNodes.length].nodeType}catch(Ta){ba={apply:Z.length?function(a,b){kb.apply(a,oa.call(b))}:function(a,b){for(var d=a.length,c=0;a[d++]=b[c++];);a.length=d-1}}}s=d.isXML=function(a){return(a=a&&(a.ownerDocument||a).documentElement)?"HTML"!==a.nodeName:!1};q=d.support={};H=d.setDocument=function(a){var d=a?a.ownerDocument||
a:da;a=d.defaultView;return d!==D&&9===d.nodeType&&d.documentElement?(D=d,R=d.documentElement,I=!s(d),a&&a.attachEvent&&a!==a.top&&a.attachEvent("onbeforeunload",function(){H()}),q.attributes=f(function(a){return a.className="i",!a.getAttribute("className")}),q.getElementsByTagName=f(function(a){return a.appendChild(d.createComment("")),!a.getElementsByTagName("*").length}),q.getElementsByClassName=f(function(a){return a.innerHTML="<div class='a'></div><div class='a i'></div>",a.firstChild.className=
"i",2===a.getElementsByClassName("i").length}),q.getById=f(function(a){return R.appendChild(a).id=P,!d.getElementsByName||!d.getElementsByName(P).length}),q.getById?(w.find.ID=function(a,b){if(typeof b.getElementById!==ja&&I){var d=b.getElementById(a);return d&&d.parentNode?[d]:[]}},w.filter.ID=function(a){var b=a.replace(fa,ga);return function(a){return a.getAttribute("id")===b}}):(delete w.find.ID,w.filter.ID=function(a){var b=a.replace(fa,ga);return function(a){return(a=typeof a.getAttributeNode!==
ja&&a.getAttributeNode("id"))&&a.value===b}}),w.find.TAG=q.getElementsByTagName?function(a,d){return typeof d.getElementsByTagName!==ja?d.getElementsByTagName(a):b}:function(a,b){var d,c=[],e=0,A=b.getElementsByTagName(a);if("*"===a){for(;d=A[e++];)1===d.nodeType&&c.push(d);return c}return A},w.find.CLASS=q.getElementsByClassName&&function(a,d){return typeof d.getElementsByClassName!==ja&&I?d.getElementsByClassName(a):b},la=[],C=[],(q.qsa=ia.test(d.querySelectorAll))&&(f(function(a){a.innerHTML="<select><option selected=''></option></select>";
...
e?function(a){return!!a.parentNode}:function(b,d,k){var h,l,Q,na,n;d=A!==f?"nextSibling":"previousSibling";var r=b.parentNode,ua=g&&b.nodeName.toLowerCase();k=!k&&!g;if(r){if(A){for(;d;){for(l=b;l=l[d];)if(g?l.nodeName.toLowerCase()===ua:1===l.nodeType)return!1;n=d="only"===a&&!n&&"nextSibling"}return!0}if(n=[f?r.firstChild:r.lastChild],f&&k)for(k=r[P]||(r[P]={}),h=k[a]||[],na=h[0]===U&&h[1],Q=h[0]===U&&h[2],l=na&&r.childNodes[na];l=++na&&l&&l[d]||(Q=na=0)||n.pop();){if(1===l.nodeType&&++Q&&l===b){k[a]=
...
return"input"===b&&"button"===a.type||"button"===b},text:function(a){var b;return"input"===a.nodeName.toLowerCase()&&"text"===a.type&&(null==(b=a.getAttribute("type"))||b.toLowerCase()===a.type)},first:r(function(){return[0]}),last:r(function(a,b){return[b-1]}),eq:r(function(a,b,d){return[0>d?d+b:d]}),even:r(function(a,b){for(var d=0;b>d;d+=2)a.push(d);return a}),odd:r(function(a,b){for(var d=1;b>d;d+=2)a.push(d);return a}),lt:r(function(a,b,d){for(b=0>d?d+b:d;0<=--b;)a.push(b);return a}),gt:r(function(a,
b,d){for(d=0>d?d+b:d;b>++d;)a.push(d);return a})}};w.pseudos.nth=w.pseudos.eq;for(B in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})w.pseudos[B]=l(B);for(B in{submit:!0,reset:!0})w.pseudos[B]=n(B);y.prototype=w.filters=w.pseudos;w.setFilters=new y;v=d.compile=function(a,b){var d,c=[],e=[],A=pa[a+" "];if(!A){b||(b=m(a));for(d=b.length;d--;)A=F(b[d]),A[P]?c.push(A):e.push(A);A=pa(a,z(e,c))}return A};q.sortStable=P.split("").sort(M).join("")===P;q.detectDuplicates=V;H();q.sortDetached=f(function(a){return 1&
a.compareDocumentPosition(D.createElement("div"))});f(function(a){return a.innerHTML="<a href='#'></a>","#"===a.firstChild.getAttribute("href")})||g("type|href|height|width",function(a,d,c){return c?b:a.getAttribute(d,"type"===d.toLowerCase()?1:2)});q.attributes&&f(function(a){return a.innerHTML="<input/>",a.firstChild.setAttribute("value",""),""===a.firstChild.getAttribute("value")})||g("value",function(a,d,c){return c||"input"!==a.nodeName.toLowerCase()?b:a.defaultValue});f(function(a){return null==
...
g,l,h,n=[],r=!a.once&&[],y=function(b){e=a.memory&&b;f=!0;l=h||0;h=0;g=n.length;for(c=!0;n&&g>l;l++)if(!1===n[l].apply(b[0],b[1])&&a.stopOnFalse){e=!1;break}c=!1;n&&(r?r.length&&y(r.shift()):e?n=[]:m.disable())},m={add:function(){if(n){var b=n.length;(function Qb(b){k.each(b,function(b,d){var c=k.type(d);"function"===c?a.unique&&m.has(d)||n.push(d):d&&d.length&&"string"!==c&&Qb(d)})})(arguments);c?g=n.length:e&&(h=b,y(e))}return this},remove:function(){return n&&k.each(arguments,function(a,b){for(var d;-1<
