...
f,c.toString()),c);c++})};c.prototype.toHtml=function(a){a=a||{};var c="";a.wrap&&(c+="<!doctype html>\n<html>");this.each(function(d,f){c+="\n  "+f.toHtml(a.filter)});a.wrap&&(c+="\n</html>\n");return c};Scraps.Element=a;Scraps.Scrap=d;Scraps.Page=c})();"undefined"!==typeof exports&&(module.exports=Scraps);
...
var Launcher={locked:null,open:function(a,d){if(Launcher.locked)return window[Launcher.locked].open();if(window[a])window[a].open();else return!1;if(d||nudgepad.isTesting)return null;history.pushState(a,"Nudgepad - "+a,"/nudgepad?tool="+a)},openToolFromQueryString:function(){var a=ParseQueryString().tool||"Files";Launcher.open(a,!0)}},Popup={hide:function(a){if(1!==a.which)return!0;$(".nudgepadPopup").hide();$("body").off("mouseup touchend",Popup.hide);Popup.isOpen=!1;return!0},isOpen:!1,open:function(a){$(a).addClass("nudgepadPopup").show();
...
Pages.editor.duplicate=function(){var a=prompt("Enter a name for the file",Pages.editor.filename);if(!a)return!0;var d=Pages.editor.openPage();expressfs.writeFile(a,d.toHtml({wrap:!0}));Pages.editor.pages.set(a,new Scraps.Page(d.toString()));Pages.editor.open(a);Pages.refresh()};
...
Pages.editor.editHtml=function(){var a=html_beautify(Pages.editor.openPage().toHtml({wrap:!0}),{"indent-size":2,"indent-char":" ","indent-inner-html":!0});TextPrompt.open("",a,Pages.editor.filename,function(a){Pages.editor.pages.set(Pages.editor.filename,new Scraps.Page($.htmlToScraps(a)));Pages.editor.open(Pages.editor.filename)})};
