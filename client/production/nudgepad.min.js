...
Clone.on("ready",function(){$("#CloneDomain").val(document.location.host);$("#CloneServer").val(nudgepad.status.get("hostname"))});Clone.on("once",function(){expressfs.readFile("nudgepad/sharecode.txt",function(a){a?Clone.code=a:Clone.install()})});
