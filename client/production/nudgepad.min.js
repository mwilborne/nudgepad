...
for(var p=Array(16),t=Array(16),w=0;16>w;w++)p[w]=s[w]^909522486,t[w]=s[w]^1549556828;c=e(p.concat(f(c)),512+c.length*d);c=e(t.concat(c),768);return g(c)},sha256config:function(a){d=parseInt(a)||8}});a.fn.sha256=function(b){a.sha256config(b);b=h(a(this).val());b=a.sha256(b);a.sha256config(8);return b}})(jQuery);function Space(a){this._pairs=[];this.events={};this._load(a);return this}Space.version="0.6.0";Space.arrayDelete=function(a,d){return a.slice(0,d).concat(a.slice(d+1))};Space.isXPath=function(a){return a.match(/ /)};
Space.pathBranch=function(a){a=a.split(/ /g);if(2>a.length)return"";a.pop();return a.join(" ")};Space.pathLeaf=function(a){var d=a.split(/ /g);return 2>d.length?a:d[d.length-1]};Space.strRepeat=function(a,d){for(var c="",b=0;b<d;b++)c+=a;return c};Space.union=function(){var a=Space.unionSingle(arguments[0],arguments[1]),d;for(d in arguments)if(1!==d&&(a=Space.unionSingle(a,arguments[d]),!a.length()))break;return a};
Space.unionSingle=function(a,d){var c=new Space;if(!(d instanceof Space))return c;a.each(function(a,e){e instanceof Space&&(d._getValueByType(a)&&d._getValueByType(a)instanceof Space)&&c._setPair(a,Space.unionSingle(e,d._getValueByType(a)));e===d._getValueByType(a)&&c._setPair(a,e)});return c};Space.prototype.append=function(a,d){this._setPair(a,d);this.trigger("append",a,d);this.trigger("change");return this};Space.prototype._clear=function(){this._pairs=[];return this};
...
Space.prototype.diff=function(a){var d=new Space;a instanceof Space||(a=new Space(a));this.each(function(b,c){var f=a._getValueByType(b);if("undefined"===typeof f)return d._setPair(b,""),!0;if(typeof this._getValueByType(b)!==typeof f)return"object"===typeof f?d._setPair(b,new Space(f)):this._getValueByType(b)!=f&&d._setPair(b,f),!0;if("object"!==typeof this._getValueByType(b))return this._getValueByType(b)!=f&&d._setPair(b,f),!0;f=this._getValueByType(b).diff(f);f.length()&&d._setPair(b,f)});var c=
this;a.each(function(b,e){if(c.has(b))return!0;if("object"!==typeof e)return d._setPair(b,e),!0;e instanceof Space?d._setPair(b,new Space(e)):d._setPair(b,new Space(a))});return d};
Space.prototype.diffOrder=function(a){a instanceof Space||(a=new Space(a));var d=new Space,c=this;a.each(function(a,e){if(!(e instanceof Space&&c._getValueByType(a)instanceof Space))return!0;var f=c._getValueByType(a).diffOrder(e);if(f.isEmpty())return!0;d._setPair(a,f)});if(a.tableOfContents()===this.tableOfContents())return d;a.each(function(a,c){d.has(a)||d._setPair(a,new Space)});return d};
...
Space.prototype._getValueByType=function(a){var d;this._pairs.forEach(function(c,b){if(c[0]===a)return d=c[1],!1});return d};Space.prototype._getTypeByIndex=function(a){0>a&&(a=this.length()+a);return this.getTypes()[a]};Space.prototype.getTypes=function(){var a=[];this._pairs.forEach(function(d,c){a.push(d[0])});return a};
Space.prototype._getValueByString=function(a){if(a){if(!a.match(/ /))return this._getValueByType(a);a=a.split(/ /g);var d=a.shift();if(this.has(d)&&this._getValueByType(d)instanceof Space)return this._getValueByType(d).get(a.join(" "))}};
Space.prototype._getValueBySpace=function(a){var d=new Space,c=this;a.each(function(b,e){var f=c._getValueByType(b);if("undefined"===typeof f)return!0;if(!(a._getValueByType(b)instanceof Space&&a._getValueByType(b).length()))return d._setPair(b,f),!0;if(!(f instanceof Space))return!0;d._setPair(b,f._getValueBySpace(a._getValueByType(b)))});return d};
...
Space.prototype.getTokensConcise=function(){return this.getTokens().replace(/[^\w\s]|(.)(?=\1)/gi,"")};Space.prototype.has=function(a){return void 0!==this._getValueByType(a)};Space.prototype.__height=function(){return this.toString().match(/\n/g).length};Space.prototype.indexOf=function(a){return this.getTypes().indexOf(a)};Space.prototype.insert=function(a,d,c){this._setPair(a,d,c);return this};Space.prototype.isEmpty=function(){return 0===this.length()};
Space.prototype.isASet=function(){var a=!0,d={};this.each(function(c,b){if(d[c])return a=!1;d[c]=!0;if(b instanceof Space)return b.isASet()?!0:a=!1});return a};Space.prototype._typeCount=function(){var a=this.length();this.each(function(d,c){c instanceof Space&&(a+=c._typeCount())});return a};Space.prototype.length=function(){return this.getTypes().length};
...
Space.prototype._patch=function(a){a instanceof Space||(a=new Space(a));var d=this;a.each(function(a,b){if("string"===typeof b)return""===b?d._delete(a):d._setPair(a,b),!0;if("number"===typeof b)return d._setPair(a,b),!0;if(b instanceof Space&&!b.length())return d._delete(a),!0;if(d._getValueByType(a)instanceof Space)return d._getValueByType(a)._patch(b),!0;d._setPair(a,new Space(b))});return this};Space.prototype.patch=function(a){this._patch(a);this.trigger("patch",a);this.trigger("change");return this};
Space.prototype._patchOrder=function(a){a instanceof Space||(a=new Space(a));var d=this,c=this.clone();d._clear();a.each(function(a,e){d._setPair(a,c.get(a));e instanceof Space&&(e.length()&&c._getValueByType(a)instanceof Space)&&d._getValueByType(a)._patchOrder(e)});return this};Space.prototype.patchOrder=function(a){this._patchOrder(a);this.trigger("patchOrder",a);this.trigger("change");return this};
Space.prototype.pop=function(){if(!this.length())return null;var a=new Space,d=this._getTypeByIndex(-1),c=this._getValueByType(d);a.set(d,c);this._delete(d);return a};Space.prototype.prepend=function(a,d){return this._setPair(a,d,0)};Space.prototype.prev=function(a){a=this.indexOf(a)-1;return this._getTypeByIndex(a)};Space.prototype.push=function(a){for(var d=this.length();this.get(d.toString());)d++;this._setPair(d.toString(),a);return this};
Space.prototype._rename=function(a,d){var c=this.indexOf(a);this._setPair(d,this._getValueByType(a),c,!0);return this};Space.prototype.reload=function(a){this._pairs=[];this._load(a);this.trigger("reload");return this};Space.prototype.rename=function(a,d){this._rename(a,d);a!==d&&this.trigger("rename",a,d);this.trigger("change");return this};
Space.prototype.set=function(a,d,c){a=a.toString();Space.isXPath(a)?this._setByXPath(a,d):this.has(a)?this._setPair(a,d,this.indexOf(a),!0):this._setPair(a,d,c);this.trigger("set",a,d,c);this.trigger("change");return this};Space.prototype.setByIndexPath=function(a,d){if(!Space.isXPath(a)){var c=parseFloat(a);this.update(c,this._getTypeByIndex(c),d);return this}c=Space.pathBranch(a);c=this.getByIndexPath(c);if(!c)return this;var b=parseFloat(Space.pathLeaf(a));c.update(b,c._getTypeByIndex(b),d);return this};
Space.prototype._setByXPath=function(a,d){if(!a)return null;for(var c=a.toString().split(/ /g),b=this,e,f,g=0;g<c.length;g++){e=c[g];if(!(b._getValueByType(e)instanceof Space)){var h;h=g===c.length-1?d:new Space;b.has(e)?(f=b.indexOf(e),b._setPair(e,h,f,!0)):b._setPair(e,h)}b=b.get(e)}return this};Space.prototype._setPair=function(a,d,c,b){a=a.toString();void 0===c?this._pairs.push([a,d]):b?this._pairs.splice(c,1,[a,d]):this._pairs.splice(c,0,[a,d])};
Space.prototype.shift=function(){if(!this.length())return null;var a=this._getTypeByIndex(0),d=new Space;d.set(a,this.get(a));this._delete(a);return d};Space.prototype.sort=function(a){this._pairs=this._pairs.sort(a);return this};Space.prototype.tableOfContents=function(){return this.getTypes().join(" ")};
...
Files.renderExplorer=function(){var a=Files.get("files");if(!a)return!1;Files.dir&&(a=a.get(Files.dir));if(!a)return!1;var d='<table id="FilesExplorer">',d=d+'<tr class="FilesExplorerHeader"><td>Filename</td><td></td><td></td><td></td><td></td><td>Size</td><td>Age</td></tr>',c=Files.dir?Files.dir+" ":"",b=_.filter(a.getTypes(),function(b){return!a.get(b).get("timeSinceLastChange")}).sort(),e=_.filter(a.getTypes(),function(b){return a.get(b).get("timeSinceLastChange")}).sort();b.concat(e).forEach(function(b){if(!store.get("FilesShowHidden")&&
