...
b)return!1;return!0}function h(){return!0}function n(){return!1}function s(){try{return I.activeElement}catch(a){}}function t(a,b){do a=a[b];while(a&&1!==a.nodeType);return a}function r(a,b,d){if(k.isFunction(b))return k.grep(a,function(a,A){return!!b.call(a,A,a)!==d});if(b.nodeType)return k.grep(a,function(a){return a===b!==d});if("string"==typeof b){if(kb.test(b))return k.filter(b,a,d);b=k.filter(b,a)}return k.grep(a,function(a){return 0<=k.inArray(a,b)!==d})}function p(a){var b=Ja.split("|");a=
a.createDocumentFragment();if(a.createElement)for(;b.length;)a.createElement(b.pop());return a}function w(a,b){return k.nodeName(a,"table")&&k.nodeName(1===b.nodeType?b:b.firstChild,"tr")?a.getElementsByTagName("tbody")[0]||a.appendChild(a.ownerDocument.createElement("tbody")):a}function v(a){return a.type=(null!==k.find.attr(a,"type"))+"/"+a.type,a}function D(a){var b=Nb.exec(a.type);return b?a.type=b[1]:a.removeAttribute("type"),a}function K(a,b){for(var d,c=0;null!=(d=a[c]);c++)k._data(d,"globalEval",
!b||k._data(b[c],"globalEval"))}function O(a,b){if(1===b.nodeType&&k.hasData(a)){var d,c,e;c=k._data(a);var f=k._data(b,c),g=c.events;if(g)for(d in delete f.handle,f.events={},g)for(c=0,e=g[d].length;e>c;c++)k.event.add(b,d,g[d][c]);f.data&&(f.data=k.extend({},f.data))}}function B(a,b){var c,e,f=0,g=typeof a.getElementsByTagName!==R?a.getElementsByTagName(b||"*"):typeof a.querySelectorAll!==R?a.querySelectorAll(b||"*"):d;if(!g)for(g=[],c=a.childNodes||a;null!=(e=c[f]);f++)!b||k.nodeName(e,b)?g.push(e):
...
b);for(b in a);return b===d||oa.call(a,b)},isEmptyObject:function(a){for(var b in a)return!1;return!0},error:function(a){throw Error(a);},parseHTML:function(a,b,d){if(!a||"string"!=typeof a)return null;"boolean"==typeof b&&(d=b,b=!1);b=b||I;var c=eb.exec(a);d=!d&&[];return c?[b.createElement(c[1])]:(c=k.buildFragment([a],b,d),d&&k(d).remove(),k.merge([],c.childNodes))},parseJSON:function(b){return a.JSON&&a.JSON.parse?a.JSON.parse(b):null===b?b:"string"==typeof b&&(b=k.trim(b),b&&qa.test(b.replace(T,
...
function(a,b){ha["[object "+b+"]"]=b.toLowerCase()});aa=k(I);(function(a,b){function d(a,b,c,e){var A,f,g,k,l;if((b?b.ownerDocument||b:da)!==D&&H(b),b=b||D,c=c||[],!a||"string"!=typeof a)return c;if(1!==(k=b.nodeType)&&9!==k)return[];if(I&&!e){if(A=qa.exec(a))if(g=A[1])if(9===k){if(f=b.getElementById(g),!f||!f.parentNode)return c;if(f.id===g)return c.push(f),c}else{if(b.ownerDocument&&(f=b.ownerDocument.getElementById(g))&&K(b,f)&&f.id===g)return c.push(f),c}else{if(A[2])return ba.apply(c,b.getElementsByTagName(a)),
c;if((g=A[3])&&s.getElementsByClassName&&b.getElementsByClassName)return ba.apply(c,b.getElementsByClassName(g)),c}if(s.qsa&&(!C||!C.test(a))){if(f=A=P,g=b,l=9===k&&a,1===k&&"object"!==b.nodeName.toLowerCase()){k=m(a);(A=b.getAttribute("id"))?f=A.replace(sa,"\\$&"):b.setAttribute("id",f);f="[id='"+f+"'] ";for(g=k.length;g--;)k[g]=f+E(k[g]);g=ea.test(a)&&b.parentNode||b;l=k.join(",")}if(l)try{return ba.apply(c,g.querySelectorAll(l)),c}catch(h){}finally{A||b.removeAttribute("id")}}}var Q;a:{a=a.replace(X,
"$1");var ua,n;f=m(a);if(!e&&1===f.length){if(Q=f[0]=f[0].slice(0),2<Q.length&&"ID"===(ua=Q[0]).type&&s.getById&&9===b.nodeType&&I&&w.relative[Q[1].type]){if(b=(w.find.ID(ua.matches[0].replace(fa,ga),b)||[])[0],!b){Q=c;break a}a=a.slice(Q.shift().value.length)}for(k=Ha.needsContext.test(a)?0:Q.length;k--&&(ua=Q[k],!w.relative[A=ua.type]);)if((n=w.find[A])&&(e=n(ua.matches[0].replace(fa,ga),ea.test(Q[0].type)&&b.parentNode||b))){if(Q.splice(k,1),a=e.length&&E(Q),!a){Q=(ba.apply(c,e),c);break a}break}}Q=
...
if(d)for(;d=d.nextSibling;)if(d===b)return-1;return a?1:-1}function h(a){return function(b){return"input"===b.nodeName.toLowerCase()&&b.type===a}}function n(a){return function(b){var d=b.nodeName.toLowerCase();return("input"===d||"button"===d)&&b.type===a}}function q(a){return e(function(b){return b=+b,e(function(d,c){for(var e,A=a([],d.length,b),f=A.length;f--;)d[e=A[f]]&&(d[e]=!(c[e]=d[e]))})})}function z(){}function m(a,b){var c,e,A,f,g,k,l;if(g=ma[a+" "])return b?0:g.slice(0);g=a;k=[];for(l=w.preFilter;g;){c&&
!(e=T.exec(g))||(e&&(g=g.slice(e[0].length)||g),k.push(A=[]));c=!1;(e=wa.exec(g))&&(c=e.shift(),A.push({value:c,type:e[0].replace(X," ")}),g=g.slice(c.length));for(f in w.filter)!(e=Ha[f].exec(g))||l[f]&&!(e=l[f](e))||(c=e.shift(),A.push({value:c,type:f,matches:e}),g=g.slice(c.length));if(!c)break}return b?g.length:g?d.error(a):ma(a,k).slice(0)}function E(a){for(var b=0,d=a.length,c="";d>b;b++)c+=a[b].value;return c}function p(a,b,d){var c=b.dir,e=d&&"parentNode"===c,A=N++;return b.first?function(b,
d,A){for(;b=b[c];)if(1===b.nodeType||e)return a(b,d,A)}:function(b,d,f){var g,k,l,h=U+" "+A;if(f)for(;b=b[c];){if((1===b.nodeType||e)&&a(b,d,f))return!0}else for(;b=b[c];)if(1===b.nodeType||e)if(l=b[P]||(b[P]={}),(k=l[c])&&k[0]===h){if(!0===(g=k[1])||g===t)return!0===g}else if(k=l[c]=[h],k[1]=a(b,d,f)||t,!0===k[1])return!0}}function u(a){return 1<a.length?function(b,d,c){for(var e=a.length;e--;)if(!a[e](b,d,c))return!1;return!0}:a[0]}function O(a,b,d,c,e){for(var A,f=[],g=0,k=a.length,l=null!=b;k>
g;g++)(A=a[g])&&(!d||d(A,c,e))&&(f.push(A),l&&b.push(g));return f}function F(a,b,c,A,f,g){return A&&!A[P]&&(A=F(A)),f&&!f[P]&&(f=F(f,g)),e(function(e,g,k,l){var h,Q,n=[],q=[],ta=g.length,z;if(!(z=e)){z=b||"*";for(var m=k.nodeType?[k]:k,Ca=[],E=0,p=m.length;p>E;E++)d(z,m[E],Ca);z=Ca}z=!a||!e&&b?z:O(z,n,a,k,l);m=c?f||(e?a:ta||A)?[]:g:z;if(c&&c(z,m,k,l),A)for(h=O(m,q),A(h,[],k,l),k=h.length;k--;)(Q=h[k])&&(m[q[k]]=!(z[q[k]]=Q));if(e){if(f||a){if(f){h=[];for(k=m.length;k--;)(Q=m[k])&&h.push(z[k]=Q);f(null,
m=[],h,l)}for(k=m.length;k--;)(Q=m[k])&&-1<(h=f?W.call(e,Q):n[k])&&(e[h]=!(g[h]=Q))}}else m=O(m===g?m.splice(ta,m.length):m),f?f(null,g,m,l):ba.apply(g,m)})}function J(a){var b,d,c,e=a.length,A=w.relative[a[0].type];d=A||w.relative[" "];for(var f=A?1:0,g=p(function(a){return a===b},d,!0),k=p(function(a){return-1<W.call(b,a)},d,!0),l=[function(a,d,c){return!A&&(c||d!==aa)||((b=d).nodeType?g(a,d,c):k(a,d,c))}];e>f;f++)if(d=w.relative[a[f].type])l=[p(u(l),d)];else{if(d=w.filter[a[f].type].apply(null,
a[f].matches),d[P]){for(c=++f;e>c&&!w.relative[a[c].type];c++);return F(1<f&&u(l),1<f&&E(a.slice(0,f-1).concat({value:" "===a[f-2].type?"*":""})).replace(X,"$1"),d,c>f&&J(a.slice(f,c)),e>c&&J(a=a.slice(c)),e>c&&E(a))}l.push(d)}return u(l)}function x(a,b){var c=0,A=0<b.length,f=0<a.length,g=function(e,g,k,l,h){var Q,n,q=[],ta=0,z="0",m=e&&[],E=null!=h,Ca=aa,p=e||f&&w.find.TAG("*",h&&g.parentNode||g),u=U+=null==Ca?1:Math.random()||0.1;for(E&&(aa=g!==D&&g,t=c);null!=(h=p[z]);z++){if(f&&h){for(Q=0;n=
a[Q++];)if(n(h,g,k)){l.push(h);break}E&&(U=u,t=++c)}A&&((h=!n&&h)&&ta--,e&&m.push(h))}if(ta+=z,A&&z!==ta){for(Q=0;n=b[Q++];)n(m,q,g,k);if(e){if(0<ta)for(;z--;)m[z]||q[z]||(q[z]=ca.call(l));q=O(q)}ba.apply(l,q);E&&!e&&0<q.length&&1<ta+b.length&&d.uniqueSort(l)}return E&&(U=u,aa=Ca),m};return A?e(g):g}var B,s,t,w,Y,r,v,aa,y,H,D,R,I,C,la,G,K,P="sizzle"+-new Date,da=a.document,U=0,N=0,L=c(),ma=c(),oa=c(),V=!1,M=function(a,b){return a===b?(V=!0,0):0},ja=typeof b,S=-2147483648,pa={}.hasOwnProperty,Z=[],
...
ga=function(a,b,d){a="0x"+b-65536;return a!==a||d?b:0>a?String.fromCharCode(a+65536):String.fromCharCode(55296|a>>10,56320|1023&a)};try{ba.apply(Z=na.call(da.childNodes),da.childNodes),Z[da.childNodes.length].nodeType}catch(Ta){ba={apply:Z.length?function(a,b){kb.apply(a,na.call(b))}:function(a,b){for(var d=a.length,c=0;a[d++]=b[c++];);a.length=d-1}}}r=d.isXML=function(a){return(a=a&&(a.ownerDocument||a).documentElement)?"HTML"!==a.nodeName:!1};s=d.support={};H=d.setDocument=function(a){var d=a?a.ownerDocument||
a:da;a=d.defaultView;return d!==D&&9===d.nodeType&&d.documentElement?(D=d,R=d.documentElement,I=!r(d),a&&a.attachEvent&&a!==a.top&&a.attachEvent("onbeforeunload",function(){H()}),s.attributes=f(function(a){return a.className="i",!a.getAttribute("className")}),s.getElementsByTagName=f(function(a){return a.appendChild(d.createComment("")),!a.getElementsByTagName("*").length}),s.getElementsByClassName=f(function(a){return a.innerHTML="<div class='a'></div><div class='a i'></div>",a.firstChild.className=
...
C.push(":enabled",":disabled");a.querySelectorAll("*,:x");C.push(",.*:")})),(s.matchesSelector=ia.test(G=R.webkitMatchesSelector||R.mozMatchesSelector||R.oMatchesSelector||R.msMatchesSelector))&&f(function(a){s.disconnectedMatch=G.call(a,"div");G.call(a,"[s!='']:x");la.push("!=",Ja)}),C=C.length&&RegExp(C.join("|")),la=la.length&&RegExp(la.join("|")),K=ia.test(R.contains)||R.compareDocumentPosition?function(a,b){var d=9===a.nodeType?a.documentElement:a,c=b&&b.parentNode;return a===c||!(!c||1!==c.nodeType||
...
0;c=a.parentNode;var A=b.parentNode,f=[a],g=[b];if(a===b)return V=!0,0;if(!c||!A)return a===d?-1:b===d?1:c?-1:A?1:y?W.call(y,a)-W.call(y,b):0;if(c===A)return l(a,b);for(c=a;c=c.parentNode;)f.unshift(c);for(c=b;c=c.parentNode;)g.unshift(c);for(;f[e]===g[e];)e++;return e?l(f[e],g[e]):f[e]===da?-1:g[e]===da?1:0},d):D};d.matches=function(a,b){return d(a,null,null,b)};d.matchesSelector=function(a,b){if((a.ownerDocument||a)!==D&&H(a),b=b.replace(ka,"='$1']"),s.matchesSelector&&I&&!(la&&la.test(b)||C&&C.test(b)))try{var c=
G.call(a,b);if(c||s.disconnectedMatch||a.document&&11!==a.document.nodeType)return c}catch(e){}return 0<d(b,D,null,[a]).length};d.contains=function(a,b){return(a.ownerDocument||a)!==D&&H(a),K(a,b)};d.attr=function(a,d){(a.ownerDocument||a)!==D&&H(a);var c=w.attrHandle[d.toLowerCase()],c=c&&pa.call(w.attrHandle,d.toLowerCase())?c(a,d,!I):b;return c===b?s.attributes||!I?a.getAttribute(d):(c=a.getAttributeNode(d))&&c.specified?c.value:null:c};d.error=function(a){throw Error("Syntax error, unrecognized expression: "+
...
b,d){for(d=0>d?d+b:d;b>++d;)a.push(d);return a})}};w.pseudos.nth=w.pseudos.eq;for(B in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})w.pseudos[B]=h(B);for(B in{submit:!0,reset:!0})w.pseudos[B]=n(B);z.prototype=w.filters=w.pseudos;w.setFilters=new z;v=d.compile=function(a,b){var d,c=[],e=[],A=oa[a+" "];if(!A){b||(b=m(a));for(d=b.length;d--;)A=J(b[d]),A[P]?c.push(A):e.push(A);A=oa(a,x(e,c))}return A};s.sortStable=P.split("").sort(M).join("")===P;s.detectDuplicates=V;H();s.sortDetached=f(function(a){return 1&
...
tr:[2,"<table><tbody>","</tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],_default:k.support.htmlSerialize?[0,"",""]:[1,"X<div>","</div>"]},qb=p(I).appendChild(I.createElement("div"));ra.optgroup=ra.option;ra.tbody=ra.tfoot=ra.colgroup=ra.caption=ra.thead;ra.th=ra.td;k.fn.extend({text:function(a){return k.access(this,function(a){return a===d?k.text(this):this.empty().append((this[0]&&this[0].ownerDocument||I).createTextNode(a))},
...
"script"),0<d.length&&K(d,!l&&B(a,"script")),f},buildFragment:function(a,b,c,d){for(var e,f,g,h,l,n,q,z=a.length,m=p(b),E=[],u=0;z>u;u++)if(f=a[u],f||0===f)if("object"===k.type(f))k.merge(E,f.nodeType?[f]:f);else if(Rb.test(f)){h=h||m.appendChild(b.createElement("div"));l=(Ab.exec(f)||["",""])[1].toLowerCase();q=ra[l]||ra._default;h.innerHTML=q[1]+f.replace(zb,"<$1></$2>")+q[2];for(e=q[0];e--;)h=h.lastChild;if(!k.support.leadingWhitespace&&pb.test(f)&&E.push(b.createTextNode(pb.exec(f)[0])),!k.support.tbody)for(e=
...
json:"responseJSON"},converters:{"* text":String,"text html":!0,"text json":k.parseJSON,"text xml":k.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(a,b){return b?M(M(a,k.ajaxSettings),b):M(k.ajaxSettings,a)},ajaxPrefilter:P(Jb),ajaxTransport:P(mb),ajax:function(a,b){function c(a,b,e,f){var z,A,F,J,w=b;if(2!==B){B=2;l&&clearTimeout(l);q=d;h=f||"";x.readyState=0<a?4:0;f=200<=a&&300>a||304===a;if(e){F=m;for(var t=x,Y,r,aa,v,D=F.contents,y=F.dataTypes;"*"===y[0];)y.shift(),r===d&&(r=F.mimeType||
t.getResponseHeader("Content-Type"));if(r)for(v in D)if(D[v]&&D[v].test(r)){y.unshift(v);break}if(y[0]in e)aa=y[0];else{for(v in e){if(!y[0]||F.converters[v+" "+y[0]]){aa=v;break}Y||(Y=v)}aa=aa||Y}F=aa?(aa!==y[0]&&y.unshift(aa),e[aa]):d}var H;a:{e=m;Y=F;r=x;aa=f;var R,I,C;F={};t=e.dataTypes.slice();if(t[1])for(R in e.converters)F[R.toLowerCase()]=e.converters[R];for(v=t.shift();v;)if(e.responseFields[v]&&(r[e.responseFields[v]]=Y),!C&&aa&&e.dataFilter&&(Y=e.dataFilter(Y,e.dataType)),C=v,v=t.shift())if("*"===
v)v=C;else if("*"!==C&&C!==v){if(R=F[C+" "+v]||F["* "+v],!R)for(H in F)if(I=H.split(" "),I[1]===v&&(R=F[C+" "+I[0]]||F["* "+I[0]])){!0===R?R=F[H]:!0!==F[H]&&(v=I[0],t.unshift(I[1]));break}if(!0!==R)if(R&&e["throws"])Y=R(Y);else try{Y=R(Y)}catch(la){H={state:"parsererror",error:R?la:"No conversion from "+C+" to "+v};break a}}H={state:"success",data:Y}}F=H;f?(m.ifModified&&(J=x.getResponseHeader("Last-Modified"),J&&(k.lastModified[g]=J),J=x.getResponseHeader("etag"),J&&(k.etag[g]=J)),204===a||"HEAD"===
m.type?w="nocontent":304===a?w="notmodified":(w=F.state,z=F.data,A=F.error,f=!A)):(A=w,(a||!w)&&(w="error",0>a&&(a=0)));x.status=a;x.statusText=(b||w)+"";f?u.resolveWith(E,[z,w,x]):u.rejectWith(E,[x,w,A]);x.statusCode(s);s=d;n&&p.trigger(f?"ajaxSuccess":"ajaxError",[x,m,f?z:A]);O.fireWith(E,[x,w]);n&&(p.trigger("ajaxComplete",[x,m]),--k.active||k.event.trigger("ajaxStop"))}}"object"==typeof a&&(b=a,a=d);b=b||{};var e,f,g,h,l,n,q,z,m=k.ajaxSetup({},b),E=m.context||m,p=m.context&&(E.nodeType||E.jquery)?
k(E):k.event,u=k.Deferred(),O=k.Callbacks("once memory"),s=m.statusCode||{},F={},J={},B=0,w="canceled",x={readyState:0,getResponseHeader:function(a){var b;if(2===B){if(!z)for(z={};b=dc.exec(h);)z[b[1].toLowerCase()]=b[2];b=z[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===B?h:null},setRequestHeader:function(a,b){var c=a.toLowerCase();return B||(a=J[c]=J[c]||a,F[a]=b),this},overrideMimeType:function(a){return B||(m.mimeType=a),this},statusCode:function(a){var b;
...
complete:1})x[f](m[f]);if(q=ca(mb,m,b,x)){x.readyState=1;n&&p.trigger("ajaxSend",[x,m]);m.async&&0<m.timeout&&(l=setTimeout(function(){x.abort("timeout")},m.timeout));try{B=1,q.send(F,c)}catch(t){if(!(2>B))throw t;c(-1,t)}}else c(-1,"No Transport");return x},getJSON:function(a,b,c){return k.get(a,b,c,"json")},getScript:function(a,b){return k.get(a,d,b,"script")}});k.each(["get","post"],function(a,b){k[b]=function(a,c,e,f){return k.isFunction(c)&&(f=f||e,e=c,c=d),k.ajax({url:a,type:b,dataType:f,data:c,
...
k.each(["toggle","show","hide"],function(a,b){var c=k.fn[b];k.fn[b]=function(a,d,e){return null==a||"boolean"==typeof a?c.apply(this,arguments):this.animate(F(b,!0),a,d,e)}});k.fn.extend({fadeTo:function(a,b,c,d){return this.filter(C).css("opacity",0).show().end().animate({opacity:b},a,c,d)},animate:function(a,b,c,d){var e=k.isEmptyObject(a),f=k.speed(b,c,d);b=function(){var b=J(this,k.extend({},a),f);(e||k._data(this,"finish"))&&b.stop(!0)};return b.finish=b,e||!1===f.queue?this.each(b):this.queue(f.queue,
...
c=k._data(this),d=c[a+"queue"];b=c[a+"queueHooks"];var e=k.timers,f=d?d.length:0;c.finish=!0;k.queue(this,a,[]);b&&b.stop&&b.stop.call(this,!0);for(b=e.length;b--;)e[b].elem===this&&e[b].queue===a&&(e[b].anim.stop(!0),e.splice(b,1));for(b=0;f>b;b++)d[b]&&d[b].finish&&d[b].finish.call(this);delete c.finish})}});k.each({slideDown:F("show"),slideUp:F("hide"),slideToggle:F("toggle"),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(a,b){k.fn[a]=function(a,c,d){return this.animate(b,
...
function(d){if(!d||!d.of)return p.apply(this,arguments);d=a.extend({},d);var e,r,K,O,B,L,m=a(d.of),C=a.position.getWithinInfo(d.within),N=a.position.getScrollInfo(C),G=(d.collision||"flip").split(" "),y={};return L=b(m),m[0].preventDefault&&(d.at="left top"),r=L.width,K=L.height,O=L.offset,B=a.extend({},O),a.each(["my","at"],function(){var a,b,c=(d[this]||"").split(" ");1===c.length&&(c=h.test(c[0])?c.concat(["center"]):n.test(c[0])?["center"].concat(c):["center","center"]);c[0]=h.test(c[0])?c[0]:
"center";c[1]=n.test(c[1])?c[1]:"center";a=s.exec(c[0]);b=s.exec(c[1]);y[this]=[a?a[0]:0,b?b[0]:0];d[this]=[t.exec(c[0])[0],t.exec(c[1])[0]]}),1===G.length&&(G[1]=G[0]),"right"===d.at[0]?B.left+=r:"center"===d.at[0]&&(B.left+=r/2),"bottom"===d.at[1]?B.top+=K:"center"===d.at[1]&&(B.top+=K/2),e=c(y.at,r,K),B.left+=e[0],B.top+=e[1],this.each(function(){var b,h,n=a(this),p=n.outerWidth(),s=n.outerHeight(),t=parseInt(a.css(this,"marginLeft"),10)||0,L=parseInt(a.css(this,"marginTop"),10)||0,W=p+t+(parseInt(a.css(this,
"marginRight"),10)||0)+N.width,X=s+L+(parseInt(a.css(this,"marginBottom"),10)||0)+N.height,q=a.extend({},B),J=c(y.my,n.outerWidth(),n.outerHeight());"right"===d.my[0]?q.left-=p:"center"===d.my[0]&&(q.left-=p/2);"bottom"===d.my[1]?q.top-=s:"center"===d.my[1]&&(q.top-=s/2);q.left+=J[0];q.top+=J[1];a.support.offsetFractions||(q.left=l(q.left),q.top=l(q.top));b={marginLeft:t,marginTop:L};a.each(["left","top"],function(c,f){a.ui.position[G[c]]&&a.ui.position[G[c]][f](q,{targetWidth:r,targetHeight:K,elemWidth:p,
elemHeight:s,collisionPosition:b,collisionWidth:W,collisionHeight:X,offset:[e[0]+J[0],e[1]+J[1]],my:d.my,at:d.at,within:C,elem:n})});d.using&&(h=function(a){var b=O.left-q.left,c=b+r-p,e=O.top-q.top,h=e+K-s,l={target:{element:m,left:O.left,top:O.top,width:r,height:K},element:{element:n,left:q.left,top:q.top,width:p,height:s},horizontal:0>c?"left":0<b?"right":"center",vertical:0>h?"top":0<e?"bottom":"middle"};p>r&&r>f(b+c)&&(l.horizontal="center");s>K&&K>f(e+h)&&(l.vertical="middle");l.important=g(f(b),
...
d.extend({},r,a);c.callbacks={move:n(c.move,b),change:n(c.change,b),show:n(c.show,b),hide:n(c.hide,b),beforeShow:n(c.beforeShow,b)};return c}function g(g,l){function n(){T.toggleClass("sp-flat",u);T.toggleClass("sp-input-disabled",!F.showInput);T.toggleClass("sp-alpha-enabled",F.showAlpha);T.toggleClass("sp-buttons-disabled",!F.showButtons||u);T.toggleClass("sp-palette-disabled",!F.showPalette);T.toggleClass("sp-palette-only",F.showPaletteOnly);T.toggleClass("sp-initial-disabled",!F.showInitial);
T.addClass(F.className);x()}function m(b){if(E&&(b=tinycolor(b).toRgbString(),-1===d.inArray(b,ba)&&ba.push(b),aa&&a.localStorage))try{a.localStorage[aa]=ba.join(";")}catch(c){}}function r(){var a=[],b=ba,c={},d;if(F.showPalette){for(var e=0;e<wa.length;e++)for(var f=0;f<wa[e].length;f++)d=tinycolor(wa[e][f]).toRgbString(),c[d]=!0;for(e=0;e<b.length;e++)d=tinycolor(b[e]).toRgbString(),c.hasOwnProperty(d)||(a.push(b[e]),c[d]=!0)}return a.reverse().slice(0,F.maxSelectionSize)}function N(){var a=M(),
c=d.map(wa,function(c,d){return b(c,a,"sp-palette-row sp-palette-row-"+d)});ba&&c.push(b(r(),a,"sp-palette-row sp-palette-row-selection"));bb.html(c.join(""))}function G(){if(F.showInitial){var a=fa,c=M();xa.html(b([a,c],c,"sp-palette-row-initial"))}}function y(){0!==na&&0!==ja&&0!==ka||x();T.addClass(Ta)}function S(){T.removeClass(Ta)}function U(){var a=tinycolor(ga.val());a.ok?ca(a):ga.addClass("sp-validation-error")}function V(){ma?P():Z()}function Z(){if(ma)x();else if(!1!==da.beforeShow(M())){for(var b=
0;b<p.length;b++)p[b]&&p[b].hide();ma=!0;d(La).bind("click.spectrum",P);d(a).bind("resize.spectrum",I);Aa.addClass("sp-active");T.show();F.showPalette&&N();x();X();fa=M();G();da.show(fa)}}function P(b){b&&"click"==b.type&&2==b.button||(!ma||u)||(ma=!1,d(La).unbind("click.spectrum",P),d(a).unbind("resize.spectrum",I),Aa.removeClass("sp-active"),T.hide(),tinycolor.equals(M(),fa)||(hb&&"cancel"!==b?J(!0):ca(fa,!0)),da.hide(M()))}function ca(a,b){if(!tinycolor.equals(a,M())){var c=tinycolor(a),d=c.toHsv();
...
if(F.showAlpha){d=b.toRgb();d.a=0;var d=tinycolor(d).toRgbString(),e="linear-gradient(left, "+d+", "+c+")";w?ia.css("filter",tinycolor(d).toFilter({gradientType:1},c)):(ia.css("background","-webkit-"+e),ia.css("background","-moz-"+e),ia.css("background","-ms-"+e),ia.css("background",e))}F.showInput&&(1>pa&&("hex"===a||"name"===a)&&(a="rgb"),ga.val(b.toString(a)));F.showPalette&&N();G()}function q(){var a=la*ja,b=na-oa*na,a=Math.max(-ha,Math.min(ja-ha,a-ha)),b=Math.max(-ha,Math.min(na-ha,b-ha));fb.css({top:b,
left:a});Qa.css({left:pa*va-ea/2});gb.css({top:Y*ka-z})}function J(a){var b=M();Ya&&qa.val(b.toString(Oa)).change();var c=!tinycolor.equals(b,fa);fa=b;m(b);a&&c&&da.change(b)}function x(){ja=Ma.width();na=Ma.height();ha=fb.height();Va.width();ka=Va.height();z=gb.height();va=Wa.width();ea=Qa.width();u||T.offset(f(T,ya));q()}function H(){P();Ua=!0;qa.attr("disabled",!0);ya.addClass("sp-disabled")}var F=e(l,g),u=F.flat,E=F.showSelectionPalette,aa=F.localStorageKey,R=F.theme,da=F.callbacks,I=t(x,10),
ma=!1,ja=0,na=0,ha=0,ka=0,va=0,ea=0,z=0,Y=0,la=0,oa=0,pa=1,k=F.palette.slice(0),wa=d.isArray(k[0])?k:[k],ba=F.selectionPalette.slice(0),Ta="sp-dragging",La=g.ownerDocument,eb=La.body,qa=d(g),Ua=!1,T=d(K,La).addClass(R),Ma=T.find(".sp-color"),fb=T.find(".sp-dragger"),Va=T.find(".sp-hue"),gb=T.find(".sp-slider"),ia=T.find(".sp-alpha-inner"),Wa=T.find(".sp-alpha"),Qa=T.find(".sp-alpha-handle"),ga=T.find(".sp-input"),bb=T.find(".sp-palette"),xa=T.find(".sp-initial"),Xa=T.find(".sp-cancel"),Na=T.find(".sp-choose"),
Ya=qa.is("input"),Za=Ya&&!u,Aa=Za?d(D).addClass(R):d([]),ya=Za?Aa:qa,sa=Aa.find(".sp-preview-inner"),za=F.color||Ya&&qa.val(),fa=!1,$a=F.preferredFormat,Oa=$a,hb=!F.showButtons||F.clickoutFiresChange;(function(){function b(a){a.data&&a.data.ignore?(ca(d(this).data("color")),W()):(ca(d(this).data("color")),J(!0),W(),P());return!1}w&&T.find("*:not(input)").attr("unselectable","on");n();Za&&qa.hide().after(Aa);u?qa.after(T).hide():d(eb).append(T.hide());if(aa&&a.localStorage){try{var c=a.localStorage[aa].split(",#");
1<c.length&&(delete a.localStorage[aa],d.each(c,function(a,b){m(b)}))}catch(e){}try{ba=a.localStorage[aa].split(";")}catch(f){}}ya.bind("click.spectrum touchstart.spectrum",function(a){Ua||V();a.stopPropagation();d(a.target).is("input")||a.preventDefault()});(qa.is(":disabled")||!0===F.disabled)&&H();T.click(h);ga.change(U);ga.bind("paste",function(){setTimeout(U,1)});ga.keydown(function(a){13==a.keyCode&&U()});Xa.text(F.cancelText);Xa.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();
P("cancel")});Na.text(F.chooseText);Na.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();ga.hasClass("sp-validation-error")||(J(!0),P())});s(Wa,function(a,b,c){pa=a/va;c.shiftKey&&(pa=Math.round(10*pa)/10);W()});s(Va,function(a,b){Y=parseFloat(b/ka);W()},y,S);s(Ma,function(a,b){la=parseFloat(a/ja);oa=parseFloat((na-b)/na);W()},y,S);za?(ca(za),X(),Oa=$a||tinycolor(za).format,m(za)):X();u&&Z();c=w?"mousedown.spectrum":"click.spectrum touchstart.spectrum";bb.delegate(".sp-thumb-el",
c,b);xa.delegate(".sp-thumb-el:nth-child(1)",c,{ignore:!0},b)})();var Ga={show:Z,hide:P,toggle:V,reflow:x,option:function(a,b){if(a===c)return d.extend({},F);if(b===c)return F[a];F[a]=b;n()},enable:function(){Ua=!1;qa.attr("disabled",!1);ya.removeClass("sp-disabled")},disable:H,set:function(a){ca(a);J()},get:M,destroy:function(){qa.show();ya.unbind("click.spectrum touchstart.spectrum");T.remove();Aa.remove();p[Ga.id]=null},container:T};Ga.id=p.push(Ga)-1;return Ga}function f(a,b){var c=a.outerWidth(),
...
{};d.spectrum.localization={};d.spectrum.palettes={};d.fn.spectrum.processNativeColorInputs=function(){var a=d("<input type='color' value='!' />")[0];"color"===a.type&&"!"!=a.value||d("input[type=color]").spectrum({preferredFormat:"hex6"})};(function(a){function b(a,e){if("object"==typeof a&&a.hasOwnProperty("_tc_id"))return a;var h=c(a),n=h.r,p=h.g,J=h.b,t=q(h.a);return{ok:h.ok,format:h.format,_tc_id:s++,alpha:t,toHsv:function(){var a=f(n,p,J);return{h:a.h,s:a.s,v:a.v,a:t}},toHsvString:function(){var a=
f(n,p,J),b=r(360*a.h),c=r(100*a.s),a=r(100*a.v);return 1==t?"hsv("+b+", "+c+"%, "+a+"%)":"hsva("+b+", "+c+"%, "+a+"%, "+t+")"},toHsl:function(){var a=d(n,p,J);return{h:a.h,s:a.s,l:a.l,a:t}},toHslString:function(){var a=d(n,p,J),b=r(360*a.h),c=r(100*a.s),a=r(100*a.l);return 1==t?"hsl("+b+", "+c+"%, "+a+"%)":"hsla("+b+", "+c+"%, "+a+"%, "+t+")"},toHex:function(){return g(n,p,J)},toHexString:function(a){return"#"+g(n,p,J,a)},toRgb:function(){return{r:r(n),g:r(p),b:r(J),a:t}},toRgbString:function(){return 1==
t?"rgb("+r(n)+", "+r(p)+", "+r(J)+")":"rgba("+r(n)+", "+r(p)+", "+r(J)+", "+t+")"},toName:function(){return x[g(n,p,J)]||!1},toFilter:function(a,c){var d=g(n,p,J,!0),e=d,f=Math.round(255*q(t)).toString(16),h=f,m=a&&a.gradientType?"GradientType = 1, ":"";c&&(h=b(c),e=h.toHex(),h=Math.round(255*q(h.alpha)).toString(16));return"progid:DXImageTransform.Microsoft.gradient("+m+"startColorstr=#"+l(f)+d+",endColorstr=#"+l(h)+e+")"},toString:function(a){a=a||this.format;var b=!1;"rgb"===a&&(b=this.toRgbString());
"hex"===a&&(b=this.toHexString());"hex6"===a&&(b=this.toHexString(!0));"name"===a&&(b=this.toName());"hsl"===a&&(b=this.toHslString());"hsv"===a&&(b=this.toHsvString());return b||this.toHexString(!0)}}}function c(a){var b={r:0,g:0,b:0},d=1,f=!1,g=!1;if("string"==typeof a)a:{a=a.replace(n,"").replace(p,"").toLowerCase();var l=!1;if(J[a])a=J[a],l=!0;else if("transparent"==a){a={r:0,g:0,b:0,a:0};break a}var q;a=(q=H.rgb.exec(a))?{r:q[1],g:q[2],b:q[3]}:(q=H.rgba.exec(a))?{r:q[1],g:q[2],b:q[3],a:q[4]}:
...
springgreen:"00ff7f",steelblue:"4682b4",tan:"d2b48c",teal:"008080",thistle:"d8bfd8",tomato:"ff6347",turquoise:"40e0d0",violet:"ee82ee",wheat:"f5deb3",white:"fff",whitesmoke:"f5f5f5",yellow:"ff0",yellowgreen:"9acd32"},x=b.hexNames=function(a){var b={},c;for(c in a)a.hasOwnProperty(c)&&(b[a[c]]=c);return b}(J),H={rgb:RegExp("rgb[\\s|\\(]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))\\s*\\)?"),rgba:RegExp("rgba[\\s|\\(]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))\\s*\\)?"),
...
y(function(a,b){m.has(a,b)?a[b]++:a[b]=1});m.sortedIndex=function(a,b,c,d){c=null==c?m.identity:G(c);b=c.call(d,b);for(var e=0,f=a.length;f>e;){var g=e+f>>>1;c.call(d,a[g])<b?e=g+1:f=g}return e};m.toArray=function(a){return a?m.isArray(a)?f.call(a):a.length===+a.length?m.map(a,m.identity):m.values(a):[]};m.size=function(a){return null==a?0:a.length===+a.length?a.length:m.keys(a).length};m.first=m.head=m.take=function(a,b,c){return null==a?void 0:null==b||c?a[0]:f.call(a,0,b)};m.initial=function(a,
...
(d=G.createElement("style"),d.setAttribute("type","text/css"),d.setAttribute("media",c),x=e.appendChild(d),u.ie&&(u.win&&typeof G.styleSheets!=B&&0<G.styleSheets.length)&&(x=G.styleSheets[G.styleSheets.length-1]),H=c),u.ie&&u.win?x&&typeof x.addRule==L&&x.addRule(a,b):x&&typeof G.createTextNode!=B&&x.appendChild(G.createTextNode(a+" {"+b+"}")))}}function K(a,b){if(F){var c=b?"visible":"hidden";q&&p(a)?p(a).style.visibility=c:D("#"+a,"visibility:"+c)}}function O(a){return null!=/[\\\"<>\.;]/.exec(a)&&
typeof encodeURIComponent!=B?encodeURIComponent(a):a}var B="undefined",L="object",m="application/x-shockwave-flash",C="SWFObjectExprInst",N=window,G=document,y=navigator,S=!1,U=[function(){S?e():g()}],V=[],Z=[],P=[],ca,M,W,X,q=!1,J=!1,x,H,F=!0,u=function(){var a=typeof G.getElementById!=B&&typeof G.getElementsByTagName!=B&&typeof G.createElement!=B,b=y.userAgent.toLowerCase(),c=y.platform.toLowerCase(),d=c?/win/.test(c):/win/.test(b),c=c?/mac/.test(c):/mac/.test(b),b=/webkit/.test(b)?parseFloat(b.replace(/^.*webkit\/(\d+(\.\d+)?).*$/,
...
d[b].call(e,a):d[b];return f}}function w(a,b){function c(b){return a.lang().longDateFormat(b)||b}for(var d=5;d--&&W.test(b);)b=b.replace(W,c);return ha[b]||(ha[b]=p(b)),ha[b](a)}function v(a,b){switch(a){case "DDDD":return J;case "YYYY":return x;case "YYYYY":return H;case "S":case "SS":case "SSS":case "DDD":return q;case "MMM":case "MMMM":case "dd":case "ddd":case "dddd":return F;case "a":case "A":return r(b._l)._meridiemParse;case "X":return aa;case "Z":case "ZZ":return u;case "T":return E;case "MM":case "DD":case "YY":case "HH":case "hh":case "mm":case "ss":case "M":case "D":case "d":case "H":case "h":case "m":case "s":return X;
default:return RegExp(a.replace("\\",""))}}function D(a){a=((u.exec(a)||[])[0]+"").match(I)||["-",0,0];var b=+(60*a[1])+~~a[2];return"+"===a[0]?-b:b}function K(a){var b,c=[];if(!a._d){for(b=0;7>b;b++)a._a[b]=c[b]=null==a._a[b]?2===b?1:0:a._a[b];c[3]+=~~((a._tzm||0)/60);c[4]+=~~((a._tzm||0)%60);b=new Date(0);a._useUTC?(b.setUTCFullYear(c[0],c[1],c[2]),b.setUTCHours(c[3],c[4],c[5],c[6])):(b.setFullYear(c[0],c[1],c[2]),b.setHours(c[3],c[4],c[5],c[6]));a._d=b}}function O(a){var b,c,d=a._f.match(M),e=
...
function(){return this._data[a]}}function G(a,b){y.duration.fn["as"+a]=function(){return+this/b}}for(var y,S,U=Math.round,V={},Z="undefined"!=typeof module&&module.exports,P=/^\/?Date\((\-?\d+)/i,ca=/(\-)?(\d*)?\.?(\d+)\:(\d+)\:(\d+)\.?(\d{3})?/,M=/(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|SS?S?|X|zz?|ZZ?|.)/g,W=/(\[[^\[]*\])|(\\)?(LT|LL?L?L?|l{1,4})/g,X=/\d\d?/,q=/\d{1,3}/,J=/\d{3}/,x=/\d{1,4}/,H=/[+\-]?\d{1,6}/,
F=/[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i,u=/Z|[\+\-]\d\d:?\d\d/i,E=/T/i,aa=/[\+\-]?\d+(\.\d{1,3})?/,R=/^\s*\d{4}-\d\d-\d\d((T| )(\d\d(:\d\d(:\d\d(\.\d\d?\d?)?)?)?)?([\+\-]\d\d:?\d\d)?)?/,da=[["HH:mm:ss.S",/(T| )\d\d:\d\d:\d\d\.\d{1,3}/],["HH:mm:ss",/(T| )\d\d:\d\d:\d\d/],["HH:mm",/(T| )\d\d:\d\d/],["HH",/(T| )\d\d/]],I=/([\+\-]|\d\d)/gi,ma=["Date","Hours","Minutes","Seconds","Milliseconds"],ja={Milliseconds:1,Seconds:1E3,
...
338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298],f=[1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225],g=Array(64),l,w,v,D,K,O,B,L,m,C,N,G;a[d>>5]|=128<<24-d%
32;a[(d+64>>9<<4)+15]=d;for(m=0;m<a.length;m+=16){l=f[0];w=f[1];v=f[2];D=f[3];K=f[4];O=f[5];B=f[6];L=f[7];for(C=0;64>C;C++)g[C]=16>C?a[C+m]:c(c(c(b(g[C-2],17)^b(g[C-2],19)^g[C-2]>>>10,g[C-7]),b(g[C-15],7)^b(g[C-15],18)^g[C-15]>>>3),g[C-16]),N=c(c(c(c(L,b(K,6)^b(K,11)^b(K,25)),K&O^~K&B),e[C]),g[C]),G=c(b(l,2)^b(l,13)^b(l,22),l&w^l&v^w&v),L=B,B=O,O=K,K=c(D,N),D=v,v=w,w=l,l=c(N,G);f[0]=c(l,f[0]);f[1]=c(w,f[1]);f[2]=c(v,f[2]);f[3]=c(D,f[3]);f[4]=c(K,f[4]);f[5]=c(O,f[5]);f[6]=c(B,f[6]);f[7]=c(L,f[7])}return f},
...
J&&(J=[J]);F&&!H&&(H=d([F]));if(m=/Google TV/.exec(H))H=m[0];/\bSimulator\b/i.test(c)&&(H=(H?H+" ":"")+"Simulator");if(/^iP/.test(H))x||(x="Safari"),u="iOS"+((m=/ OS ([\d_]+)/i.exec(c))?" "+m[1].replace(/_/g,"."):"");else if("Konqueror"==x&&!/buntu/i.test(u))u="Kubuntu";else if(F&&"Google"!=F&&/Chrome|Vita/.test(x+";"+H))x="Android Browser",u=/Android/.test(u)?u:"Android";else if(!x||(m=!/\bMinefield\b/i.test(c)&&/Firefox|Safari/.exec(x)))x&&(!H&&/[\/,]|^[^(]+?\)/.test(c.slice(c.indexOf(m+"/")+8)))&&
(x=null),(m=H||F||u)&&(H||F||/Android|Symbian OS|Tablet OS|webOS/.test(u))&&(x=/[a-z]+(?: Hat)?/i.exec(/Android/.test(u)?u:m)+" Browser");q||(q=f(["(?:Cloud9|CriOS|CrMo|Opera ?Mini|Raven|Silk(?!/[\\d.]+$))","Version",h(x),"(?:Firefox|Minefield|NetFront)"]));if("iCab"==J&&3<parseFloat(q))J=["WebKit"];else if(m=/Opera/.test(x)&&"Presto"||/\b(?:Midori|Nook|Safari)\b/i.test(c)&&"WebKit"||!J&&/\bMSIE\b/i.test(c)&&(/^Mac/.test(u)?"Tasman":"Trident"))J=[m];if(X){if(l(a,"global"))if(K&&(m=K.lang.System,p=
...
v.test(x)?(/IE/.test(m)&&"Mac OS"==u&&(u=null),m="identify"+m):(m="mask"+m,x=G?b(G.replace(/([a-z])([A-Z])/g,"$1 $2")):"Opera",/IE/.test(m)&&(u=null),X||(q=null)),J=["Presto"],M.push(m)):x+=" Mobile";if(m=(/\bAppleWebKit\/([\d.]+\+?)/i.exec(c)||0)[1]){m=[parseFloat(m.replace(/\.(\d)$/,".0$1")),m];if("Safari"==x&&"+"==m[1].slice(-1))x="WebKit Nightly",W="alpha",q=m[1].slice(0,-1);else if(q==m[1]||q==(/\bSafari\/([\d.]+\+?)/i.exec(c)||0)[1])q=null;m=[m[0],(/\bChrome\/([\d.]+)/i.exec(c)||0)[1]];!X||
/internal|\n/i.test(D.toString())&&!m[1]?(J[1]="like Safari",m=(m=m[0],400>m?1:500>m?2:526>m?3:533>m?4:534>m?"4+":535>m?5:"5")):(J[1]="like Chrome",m=m[1]||(m=m[0],530>m?1:532>m?2:532.05>m?3:533>m?4:534.03>m?5:534.07>m?6:534.1>m?7:534.13>m?8:534.16>m?9:534.24>m?10:534.3>m?11:535.01>m?12:535.02>m?"13+":535.07>m?15:535.11>m?16:535.19>m?17:536.05>m?18:536.1>m?19:537.01>m?20:"21"));J[1]+=" "+(m+="number"==typeof m?".x":/[.+]/.test(m)?"":"+");"Safari"==x&&(!q||45<parseInt(q))&&(q=m)}"Opera"==x&&(m=/(?:zbov|zvav)$/.exec(u))?
(x+=" ",M.unshift("desktop mode"),"zvav"==m?(x+="Mini",q=null):x+="Mobile"):"Safari"==x&&/Chrome/.exec(J[1])&&(M.unshift("desktop mode"),x="Chrome Mobile",q=null,/Mac OS X/.test(u)?(F="Apple",u="iOS 4.3+"):u=null);q&&(0==q.indexOf(m=/[\d.]+$/.exec(u))&&-1<c.indexOf("/"+m+"-"))&&(u=s(u.replace(m,"")));J&&!/Avant|Nook/.test(x)&&(/Browser|Lunascape|Maxthon/.test(x)||/^(?:Adobe|Arora|Midori|Phantom|Rekonq|Rock|Sleipnir|Web)/.test(x)&&J[1])&&(m=J[J.length-1])&&M.push(m);M.length&&(M=["("+M.join("; ")+
")"]);F&&(H&&0>H.indexOf(F))&&M.push("on "+F);H&&M.push((/^on /.test(M[M.length-1])?"":"on ")+H);u&&(m=/ ([\d.+]+)$/.exec(u),u={architecture:32,family:m?u.replace(m[0],""):u,version:m?m[1]:null,toString:function(){var a=this.version;return this.family+(a?" "+a:"")+(64==this.architecture?" 64-bit":"")}});(m=/\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(p))&&!/\bi686\b/i.test(p)&&(u&&(u.architecture=64,u.family=u.family.replace(RegExp(" *"+m),"")),x&&(/WOW64/i.test(c)||X&&/\w(?:86|32)$/.test(C.cpuClass||
C.platform))&&M.unshift("32-bit"));c||(c=null);return{version:x&&q&&(M.unshift(q),q),name:x&&(M.unshift(x),x),os:u?(x&&!(u==String(u).split(" ")[0]&&(u==x.split(" ")[0]||H))&&M.push(H?"("+u+")":"on "+u),u):{architecture:null,family:null,version:null,toString:function(){return"null"}},description:M.length?M.join(" "):c,layout:J&&J[0],manufacturer:F,prerelease:W,product:H,ua:c,parse:t,toString:function(){return this.description||""}}}var r=a,p="object"==typeof exports&&exports,w="object"==typeof global&&
global&&(global==global.global?a=global:global),v=/Opera/,D={}.toString,K=/Java/.test(g(a.java))&&a.java,O=K?"a":"\u03b1",B=K?"b":"\u03b2",L=a.document||{},m={}.hasOwnProperty,C=a.navigator||{},N=a.operamini||a.opera,G=v.test(G=g(N))?G:N=null,y=this,S=C.userAgent||"";"function"==typeof define&&"object"==typeof define.amd&&define.amd?define(function(){return t()}):p?e(t(),function(a,b){p[b]=a}):a.platform=t()})(this);
...
Insight.Database.prototype.close=function(){this.clear();$(".Insight").html("");$(".InsightPlane").hide();store.remove("InsightDatabase")};Insight.Database.prototype.edit=function(){var a=this;TextPrompt.open("Edit Settings",this.settings.toString(),"settings.space",function(d){a.settings.reload(d);a.save();a.render();a.insight()})};Insight.Database.prototype.getPath=function(a){return"nudgepad/insight/"+(a?a:this.name)};
