...
!b||k._data(b[d],"globalEval"))}function J(a,b){if(1===b.nodeType&&k.hasData(a)){var c,d,e;d=k._data(a);var g=k._data(b,d),f=d.events;if(f)for(c in delete g.handle,g.events={},f)for(d=0,e=f[c].length;e>d;d++)k.event.add(b,c,f[c][d]);g.data&&(g.data=k.extend({},g.data))}}function D(a,b){var c,e,g=0,f=typeof a.getElementsByTagName!==ca?a.getElementsByTagName(b||"*"):typeof a.querySelectorAll!==ca?a.querySelectorAll(b||"*"):d;if(!f)for(f=[],c=a.childNodes||a;null!=(e=c[g]);g++)!b||k.nodeName(e,b)?f.push(e):
k.merge(f,D(e,b));return b===d||b&&k.nodeName(a,b)?k.merge([a],f):f}function M(a){lb.test(a.type)&&(a.defaultChecked=a.checked)}function m(a,b){if(b in a)return b;for(var c=b.charAt(0).toUpperCase()+b.slice(1),d=b,e=wb.length;e--;)if(b=wb[e]+c,b in a)return b;return d}function C(a,b){return a=b||a,"none"===k.css(a,"display")||!k.contains(a.ownerDocument,a)}function N(a,b){for(var c,d,e,g=[],f=0,h=a.length;h>f;f++)d=a[f],d.style&&(g[f]=k._data(d,"olddisplay"),c=d.style.display,b?(g[f]||"none"!==c||
(d.style.display=""),""===d.style.display&&C(d)&&(g[f]=k._data(d,"olddisplay",R(d.nodeName)))):g[f]||(e=C(d),(c&&"none"!==c||!e)&&k._data(d,"olddisplay",e?c:k.css(d,"display"))));for(f=0;h>f;f++)d=a[f],d.style&&(b&&"none"!==d.style.display&&""!==d.style.display||(d.style.display=b?g[f]||"":"none"));return a}function G(a,b,c){return(a=Ob.exec(b))?Math.max(0,a[1]-(c||0))+(a[2]||"px"):b}function y(a,b,c,d,e){b=c===(d?"border":"content")?4:"width"===b?1:0;for(var f=0;4>b;b+=2)"margin"===c&&(f+=k.css(a,
...
(l.size.width=l.parentData.width-c,b&&(l.size.height=l.size.width/l.aspectRatio));d+l.size.height>=l.parentData.height&&(l.size.height=l.parentData.height-d,b&&(l.size.width=l.size.height*l.aspectRatio))},stop:function(){var b=a(this).data("ui-resizable"),c=b.options,d=b.containerOffset,g=b.containerPosition,h=b.containerElement,l=a(b.helper),n=l.offset(),t=l.outerWidth()-b.sizeDiff.width,l=l.outerHeight()-b.sizeDiff.height;b._helper&&!c.animate&&/relative/.test(h.css("position"))&&a(this).css({left:n.left-
g.left-d.left,width:t,height:l});b._helper&&!c.animate&&/static/.test(h.css("position"))&&a(this).css({left:n.left-g.left-d.left,width:t,height:l})}});a.ui.plugin.add("resizable","alsoResize",{start:function(){var b=a(this).data("ui-resizable").options,c=function(b){a(b).each(function(){var b=a(this);b.data("ui-resizable-alsoresize",{width:parseInt(b.width(),10),height:parseInt(b.height(),10),left:parseInt(b.css("left"),10),top:parseInt(b.css("top"),10)})})};"object"!=typeof b.alsoResize||b.alsoResize.parentNode?
...
["width","height"]:["width","height","top","left"];a.each(h,function(a,b){var c=(f[b]||0)+(n[b]||0);c&&0<=c&&(g[b]=c||null)});b.css(g)})};"object"!=typeof g.alsoResize||g.alsoResize.nodeType?t(g.alsoResize):a.each(g.alsoResize,function(a,b){t(a,b)})},stop:function(){a(this).removeData("resizable-alsoresize")}});a.ui.plugin.add("resizable","ghost",{start:function(){var b=a(this).data("ui-resizable"),c=b.options,d=b.size;b.ghost=b.originalElement.clone();b.ghost.css({opacity:0.25,display:"block",position:"relative",
height:d.height,width:d.width,margin:0,left:0,top:0}).addClass("ui-resizable-ghost").addClass("string"==typeof c.ghost?c.ghost:"");b.ghost.appendTo(b.helper)},resize:function(){var b=a(this).data("ui-resizable");b.ghost&&b.ghost.css({position:"relative",height:b.size.height,width:b.size.width})},stop:function(){var b=a(this).data("ui-resizable");b.ghost&&b.helper&&b.helper.get(0).removeChild(b.ghost.get(0))}});a.ui.plugin.add("resizable","grid",{resize:function(){var b=a(this).data("ui-resizable"),
c=b.options,d=b.size,g=b.originalSize,h=b.originalPosition,l=b.axis,n="number"==typeof c.grid?[c.grid,c.grid]:c.grid,t=n[0]||1,r=n[1]||1,s=Math.round((d.width-g.width)/t)*t,d=Math.round((d.height-g.height)/r)*r,p=g.width+s,g=g.height+d,x=c.maxWidth&&p>c.maxWidth,w=c.maxHeight&&g>c.maxHeight,A=c.minWidth&&c.minWidth>p,K=c.minHeight&&c.minHeight>g;c.grid=n;A&&(p+=t);K&&(g+=r);x&&(p-=t);w&&(g-=r);/^(se|s|e)$/.test(l)?(b.size.width=p,b.size.height=g):/^(ne)$/.test(l)?(b.size.width=p,b.size.height=g,b.position.top=
...
!1):void 0}))},_mouseDrag:function(d){if(this.dragged=!0,!this.options.disabled){var c,b=this,e=this.options,f=this.opos[0],g=this.opos[1],h=d.pageX,l=d.pageY;return f>h&&(c=h,h=f,f=c),g>l&&(c=l,l=g,g=c),this.helper.css({left:f,top:g,width:h-f,height:l-g}),this.selectees.each(function(){var c=a.data(this,"selectable-item"),t=!1;c&&c.element!==b.element[0]&&("touch"===e.tolerance?t=!(c.left>h||f>c.right||c.top>l||g>c.bottom):"fit"===e.tolerance&&(t=c.left>f&&h>c.right&&c.top>g&&l>c.bottom),t?(c.selected&&
...
g=f+this.helperProportions.height,h=a.left,l=h+a.width,n=a.top,t=n+a.height,r=this.offset.click.top,s=this.offset.click.left,s="y"===this.options.axis||b+s>h&&l>b+s,r=("x"===this.options.axis||f+r>n&&t>f+r)&&s;return"pointer"===this.options.tolerance||this.options.forcePointerForContainers||"pointer"!==this.options.tolerance&&this.helperProportions[this.floating?"width":"height"]>a[this.floating?"width":"height"]?r:b+this.helperProportions.width/2>h&&l>d-this.helperProportions.width/2&&f+this.helperProportions.height/
2>n&&t>g-this.helperProportions.height/2},_intersectsWithPointer:function(a){var b="y"===this.options.axis||this.positionAbs.left+this.offset.click.left>a.left&&a.left+a.width>this.positionAbs.left+this.offset.click.left;a=("x"===this.options.axis||this.positionAbs.top+this.offset.click.top>a.top&&a.top+a.height>this.positionAbs.top+this.offset.click.top)&&b;var b=this._getDragVerticalDirection(),d=this._getDragHorizontalDirection();return a?this.floating?d&&"right"===d||"down"===b?2:1:b&&("down"===
...
f=null;g=(r=e.floating||d(this.currentItem))?"left":"top";h=r?"width":"height";l=this.positionAbs[g]+this.offset.click[g];for(e=this.items.length-1;0<=e;e--)a.contains(this.containers[s].element[0],this.items[e].item[0])&&this.items[e].item[0]!==this.currentItem[0]&&(!r||this.positionAbs.top+this.offset.click.top>this.items[e].top&&this.items[e].top+this.items[e].height>this.positionAbs.top+this.offset.click.top)&&(n=this.items[e].item.offset()[g],t=!1,Math.abs(n-l)>Math.abs(n+this.items[e][h]-l)&&
(t=!0,n+=this.items[e][h]),b>Math.abs(n-l)&&(b=Math.abs(n-l),f=this.items[e],this.direction=t?"up":"down"));(f||this.options.dropOnEmpty)&&this.currentContainer!==this.containers[s]&&(f?this._rearrange(c,f,null,!0):this._rearrange(c,null,this.containers[s].element,!0),this._trigger("change",c,this._uiHash()),this.containers[s]._trigger("change",c,this._uiHash(this)),this.currentContainer=this.containers[s],this.options.placeholder.update(this.currentContainer,this.placeholder),this.containers[s]._trigger("over",
...
g=!f}}d.pop();return g}var d=this,c=d._,b={},e=Array.prototype,f=Object.prototype,g=e.slice,h=e.unshift,l=f.toString,n=f.hasOwnProperty,t=e.forEach,r=e.map,s=e.reduce,p=e.reduceRight,x=e.filter,w=e.every,A=e.some,K=e.indexOf,J=e.lastIndexOf,f=Array.isArray,D=Object.keys,M=Function.prototype.bind,m=function(a){return new L(a)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=m),exports._=m):d._=m;m.VERSION="1.3.3";var C=m.each=m.forEach=function(a,
...
return c};m.sortedIndex=function(a,b,c){c||(c=m.identity);for(var d=0,e=a.length;d<e;){var f=d+e>>1;c(a[f])<c(b)?d=f+1:e=f}return d};m.toArray=function(a){return a?m.isArray(a)||m.isArguments(a)?g.call(a):a.toArray&&m.isFunction(a.toArray)?a.toArray():m.values(a):[]};m.size=function(a){return m.isArray(a)?a.length:m.keys(a).length};m.first=m.head=m.take=function(a,b,c){return null==b||c?a[0]:g.call(a,0,b)};m.initial=function(a,b,c){return g.call(a,0,a.length-(null==b||c?1:b))};m.last=function(a,b,
c){return null==b||c?a[a.length-1]:g.call(a,Math.max(a.length-b,0))};m.rest=m.tail=function(a,b,c){return g.call(a,null==b||c?1:b)};m.compact=function(a){return m.filter(a,function(a){return!!a})};m.flatten=function(a,b){return m.reduce(a,function(a,c){if(m.isArray(c))return a.concat(b?c:m.flatten(c));a[a.length]=c;return a},[])};m.without=function(a){return m.difference(a,g.call(arguments,1))};m.uniq=m.unique=function(a,b,c){c=c?m.map(a,c):a;var d=[];3>a.length&&(b=!0);m.reduce(c,function(c,e,f){(b?
m.last(c)===e&&c.length:m.include(c,e))||(c.push(e),d.push(a[f]));return c},[]);return d};m.union=function(){return m.uniq(m.flatten(arguments,!0))};m.intersection=m.intersect=function(a){var b=g.call(arguments,1);return m.filter(m.uniq(a),function(a){return m.every(b,function(b){return 0<=m.indexOf(b,a)})})};m.difference=function(a){var b=m.flatten(g.call(arguments,1),!0);return m.filter(a,function(a){return!m.include(b,a)})};m.zip=function(){for(var a=g.call(arguments),b=m.max(m.pluck(a,"length")),
...
Math.max(Math.ceil((b-a)/c),0),e=0,f=Array(d);e<d;)f[e++]=a,a+=c;return f};var G=function(){};m.bind=function(a,b){var c,d;if(a.bind===M&&M)return M.apply(a,g.call(arguments,1));if(!m.isFunction(a))throw new TypeError;d=g.call(arguments,2);return c=function(){if(!(this instanceof c))return a.apply(b,d.concat(g.call(arguments)));G.prototype=a.prototype;var e=new G,f=a.apply(e,d.concat(g.call(arguments)));return Object(f)===f?f:e}};m.bindAll=function(a){var b=g.call(arguments,1);0==b.length&&(b=m.functions(a));
...
0;return l.test(a)?'"'+a.replace(l,function(a){var b=r[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function f(a,c){var d,g,h,l,r=n,M,m=c[a];m instanceof Date&&(m=isFinite(a.valueOf())?a.getUTCFullYear()+"-"+b(a.getUTCMonth()+1)+"-"+b(a.getUTCDate())+"T"+b(a.getUTCHours())+":"+b(a.getUTCMinutes())+":"+b(a.getUTCSeconds())+"Z":null);"function"===typeof s&&(m=s.call(c,a,m));switch(typeof m){case "string":return e(m);case "number":return isFinite(m)?
String(m):"null";case "boolean":case "null":return String(m);case "object":if(!m)return"null";n+=t;M=[];if("[object Array]"===Object.prototype.toString.apply(m)){l=m.length;for(d=0;d<l;d+=1)M[d]=f(d,m)||"null";h=0===M.length?"[]":n?"[\n"+n+M.join(",\n"+n)+"\n"+r+"]":"["+M.join(",")+"]";n=r;return h}if(s&&"object"===typeof s)for(l=s.length,d=0;d<l;d+=1)"string"===typeof s[d]&&(g=s[d],(h=f(g,m))&&M.push(e(g)+(n?": ":":")+h));else for(g in m)Object.prototype.hasOwnProperty.call(m,g)&&(h=f(g,m))&&M.push(e(g)+
(n?": ":":")+h);h=0===M.length?"{}":n?"{\n"+n+M.join(",\n"+n)+"\n"+r+"}":"{"+M.join(",")+"}";n=r;return h}}if(c&&c.parse)return a.JSON={parse:c.parse,stringify:c.stringify};var g=a.JSON={},h=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,l=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,n,t,r={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},
s;g.stringify=function(a,b,c){var d;t=n="";if("number"===typeof c)for(d=0;d<c;d+=1)t+=" ";else"string"===typeof c&&(t=c);if((s=b)&&"function"!==typeof b&&("object"!==typeof b||"number"!==typeof b.length))throw Error("JSON.stringify");return f("",{"":a})};g.parse=function(a,b){function c(a,d){var e,f,g=a[d];if(g&&"object"===typeof g)for(e in g)Object.prototype.hasOwnProperty.call(g,e)&&(f=c(g,e),void 0!==f?g[e]=f:delete g[e]);return b.call(a,d,g)}var d;a=String(a);h.lastIndex=0;h.test(a)&&(a=a.replace(h,
...
f=b.reasons=["transport not supported","client not handshaken","unauthorized"],g=b.advice=["reconnect"],h=c.JSON,l=c.util.indexOf;b.encodePacket=function(a){var b=l(e,a.type),c=a.id||"",d=a.endpoint||"",n=a.ack,w=null;switch(a.type){case "error":var A=a.reason?l(f,a.reason):"";a=a.advice?l(g,a.advice):"";if(""!==A||""!==a)w=A+(""!==a?"+"+a:"");break;case "message":""!==a.data&&(w=a.data);break;case "event":w={name:a.name};a.args&&a.args.length&&(w.args=a.args);w=h.stringify(w);break;case "json":w=
...
{type:e[b[1]],endpoint:b[4]||""};c&&(d.id=c,d.ack=b[3]?"data":!0);switch(d.type){case "error":b=a.split("+");d.reason=f[b[0]]||"";d.advice=g[b[1]]||"";break;case "message":d.data=a||"";break;case "event":try{var l=h.parse(a);d.name=l.name;d.args=l.args}catch(w){}d.args=d.args||[];break;case "json":try{d.data=h.parse(a)}catch(A){}break;case "connect":d.qs=a||"";break;case "ack":if(b=a.match(/^([0-9]+)(\+)?(.*)/))if(d.ackId=b[1],d.args=[],b[3])try{d.args=b[3]?h.parse(b[3]):[]}catch(K){}}return d};b.decodePayload=
...
b)});return this};b.prototype.send=function(){var a=this,b=arguments;WebSocket.__addTask(function(){c.Transport.websocket.prototype.send.apply(a,b)});return this};b.prototype.close=function(){WebSocket.__tasks.length=0;c.Transport.websocket.prototype.close.call(this);return this};b.prototype.ready=function(a,d){function g(){var c=a.options,g=c["flash policy port"],t=["http"+(c.secure?"s":"")+":/",c.host+":"+c.port,c.resource,"static/flashsocket","WebSocketMain"+(a.isXDomain()?"Insecure":"")+".swf"];
b.loaded||("undefined"===typeof WEB_SOCKET_SWF_LOCATION&&(WEB_SOCKET_SWF_LOCATION=t.join("/")),843!==g&&WebSocket.loadFlashPolicyFile("xmlsocket://"+c.host+":"+g),WebSocket.__initialize(),b.loaded=!0);d.call(h)}var h=this;if(document.body)return g();c.util.load(g)};b.check=function(){return"undefined"!=typeof WebSocket&&"__initialize"in WebSocket&&a?10<=a.getFlashPlayerVersion().major:!1};b.xdomainCheck=function(){return!0};"undefined"!=typeof window&&(WEB_SOCKET_DISABLE_AUTO_INITIALIZATION=!0);c.transports.push("flashsocket")})("undefined"!=
...
c=null;f()})()}else f()}function f(){var a=V.length;if(0<a)for(var b=0;b<a;b++){var c=V[b].id,d=V[b].callbackFn,e={success:!1,id:c};if(0<u.pv[0]){var f=p(c);if(f)if(!w(V[b].swfVersion)||u.wk&&312>u.wk)if(V[b].expressInstall&&h()){e={};e.data=V[b].expressInstall;e.width=f.getAttribute("width")||"0";e.height=f.getAttribute("height")||"0";f.getAttribute("class")&&(e.styleclass=f.getAttribute("class"));f.getAttribute("align")&&(e.align=f.getAttribute("align"));for(var m={},f=f.getElementsByTagName("param"),
r=f.length,t=0;t<r;t++)"movie"!=f[t].getAttribute("name").toLowerCase()&&(m[f[t].getAttribute("name")]=f[t].getAttribute("value"));l(e,m,c,d)}else n(f),d&&d(e);else K(c,!0),d&&(e.success=!0,e.ref=g(c),d(e))}else K(c,!0),d&&((c=g(c))&&typeof c.SetVariable!=D&&(e.success=!0,e.ref=c),d(e))}}function g(a){var b=null;(a=p(a))&&"OBJECT"==a.nodeName&&(typeof a.SetVariable!=D?b=a:(a=a.getElementsByTagName(M)[0])&&(b=a));return b}function h(){return!H&&w("6.0.65")&&(u.win||u.mac)&&!(u.wk&&312>u.wk)}function l(a,
...
typeof encodeURIComponent!=D?encodeURIComponent(a):a}var D="undefined",M="object",m="application/x-shockwave-flash",C="SWFObjectExprInst",N=window,G=document,y=navigator,Q=!1,R=[function(){Q?e():f()}],V=[],ha=[],O=[],U,L,W,T,q=!1,H=!1,v,F,E=!0,u=function(){var a=typeof G.getElementById!=D&&typeof G.getElementsByTagName!=D&&typeof G.createElement!=D,b=y.userAgent.toLowerCase(),c=y.platform.toLowerCase(),d=c?/win/.test(c):/win/.test(b),c=c?/mac/.test(c):/mac/.test(b),b=/webkit/.test(b)?parseFloat(b.replace(/^.*webkit\/(\d+(\.\d+)?).*$/,
...
"https":"http"};e.check=function(a,d){try{var e=c.util.request(d),f=b.XDomainRequest&&e instanceof XDomainRequest,t=a&&a.options&&a.options.secure?"https:":"http:",r=b.location&&t!=b.location.protocol;if(e&&(!f||!r))return!0}catch(s){}return!1};e.xdomainCheck=function(a){return e.check(a,!0)}})("undefined"!=typeof io?io.Transport:module.exports,"undefined"!=typeof io?io:module.parent.exports,this);(function(a,c){function b(a){c.Transport.XHR.apply(this,arguments)}a.htmlfile=b;c.util.inherit(b,c.Transport.XHR);
...
7),year:d.year()}}function m(b){var c=b._i,d=b._f;if(null===c||""===c)b=null;else{"string"==typeof c&&(b._i=c=s().preparse(c));if(y.isMoment(c))b=g({},c),b._d=new Date(+c._d);else if(d)if("[object Array]"===Object.prototype.toString.call(d)){var c=b,f,h,k,l=99;for(k=0;k<c._f.length;k++)f=g({},c),f._f=c._f[k],J(f),d=new e(f),f=t(f._a,d.toArray()),d._il&&(f+=d._il.length),l>f&&(l=f,h=d);g(c,h)}else J(b);else if(h=b,c=h._i,d=O.exec(c),c===a)h._d=new Date;else if(d)h._d=new Date(+d[1]);else if("string"==
...
c};a.prototype.html=function(a){this.content+=a};a.prototype.toHtml=function(){if(this.draft)return"";var a="<"+this.tag,c;for(c in this.attrs)this.attrs.hasOwnProperty(c)&&(a+=" "+c+'="'+this.attrs[c]+'"');"meta"===this.tag?a+=' content="'+this.content+'">':(a+=">"+this.content,a+="</"+this.tag+">");return a};d.prototype=new Space;d.prototype.clone=function(a){return new d(a,this)};d.prototype.loadChildren=function(){var a=this,c=-1;this.each(function(f,g){c++;var h=(this.index?this.index+" ":"")+
c.toString();if(!Scraps.isTag(f,g))return!0;g instanceof Space?a.set(f,new d(f,g,null,h),c):a.set(f,new d(f,"",g,h),c)})};d.prototype.setChildren=function(a){var c=this;this.each(function(d,g){Scraps.isTag(d,g)&&c.div.html(g.toHtml(a))});return this};d.prototype.setContent=function(){this.get("content")&&this.div.html(this.get("content"));var a=this.get("styles");if(a&&a instanceof Space){var c=this.div;a.each(function(a,b){c.html(Scraps.styleToCss(a,b.toObject()))})}return this};d.prototype.setHandlers=
...
(v=null),(m=F||E||u)&&(F||E||/Android|Symbian OS|Tablet OS|webOS/.test(u))&&(v=/[a-z]+(?: Hat)?/i.exec(/Android/.test(u)?u:m)+" Browser");q||(q=g(["(?:Cloud9|CriOS|CrMo|Opera ?Mini|Raven|Silk(?!/[\\d.]+$))","Version",l(v),"(?:Firefox|Minefield|NetFront)"]));if("iCab"==H&&3<parseFloat(q))H=["WebKit"];else if(m=/Opera/.test(v)&&"Presto"||/\b(?:Midori|Nook|Safari)\b/i.test(c)&&"WebKit"||!H&&/\bMSIE\b/i.test(c)&&(/^Mac/.test(u)?"Tasman":"Trident"))H=[m];if(T){if(h(a,"global"))if(K&&(m=K.lang.System,p=
m.getProperty("os.arch"),u=u||m.getProperty("os.name")+" "+m.getProperty("os.version")),"object"==typeof exports&&exports)if(y==s&&"object"==typeof system&&(m=[system])[0]){u||(u=m[0].os||null);try{m[1]=require("ringo/engine").version,q=m[1].join("."),v="RingoJS"}catch(aa){m[0].global==x&&(v="Narwhal")}}else"object"==typeof process&&(m=process)&&(v="Node.js",p=m.arch,u=m.platform,q=/[\d.]+/.exec(m.version)[0]);else"Environment"==f(a.environment)&&(v="Rhino");else"ScriptBridgingProxyObject"==f(m=a.runtime)?
(v="Adobe AIR",u=m.flash.system.Capabilities.os):"RuntimeObject"==f(m=a.phantom)?(v="PhantomJS",q=(m=m.version||null)&&m.major+"."+m.minor+"."+m.patch):"number"==typeof M.documentMode&&(m=/\bTrident\/(\d+)/i.exec(c))&&(q=[q,M.documentMode],(m=+m[1]+4)!=q[1]&&(L.push("IE "+q[1]+" mode"),H[1]="",q[1]=m),q="IE"==v?String(q[1].toFixed(1)):q[0]);u=u&&b(u)}q&&(m=/(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(q)||/(?:alpha|beta)(?: ?\d)?/i.exec(c+";"+(T&&C.appMinorVersion))||/\bMinefield\b/i.test(c)&&"a")&&
...
global&&(global==global.global?a=global:global),w=/Opera/,A={}.toString,K=/Java/.test(f(a.java))&&a.java,J=K?"a":"\u03b1",D=K?"b":"\u03b2",M=a.document||{},m={}.hasOwnProperty,C=a.navigator||{},N=a.operamini||a.opera,G=w.test(G=f(N))?G:N=null,y=this,Q=C.userAgent||"";"function"==typeof define&&"object"==typeof define.amd&&define.amd?define(function(){return r()}):p?e(r(),function(a,b){p[b]=a}):a.platform=r()})(this);
...
if(c){c=c[0];if(!l(/^:\s*/))return f("property missing ':'");var d=l(/^((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^\)]*?\)|[^};])+)/);if(!d)return f("property missing value");a=a({type:"declaration",property:c,value:d[0].trim()});l(/^[;\s]*/);return a}}function p(){var a=[];if(!g())return f("missing '{'");n(a);for(var b;b=s();)a.push(b),n(a);return l(/^}/)?a:f("missing '}'")}function x(){for(var a,c=[],d=b();a=l(/^(from|to|\d+%|\.\d+%|\d+\.\d+%)\s*/);)c.push(a[1]),l(/^,\s*/);if(c.length)return d({type:"keyframe",
values:c,declarations:p()})}function w(){var a=b(),c=l(/^@([-\w]+)?keyframes */);if(c){var d=c[1],c=l(/^([-\w]+)\s*/);if(!c)return f("@keyframes missing name");c=c[1];if(!g())return f("@keyframes missing '{'");for(var e,h=n();e=x();)h.push(e),h=h.concat(n());return l(/^}/)?a({type:"keyframes",name:c,vendor:d,keyframes:h}):f("@keyframes missing '}'")}}function A(){var a=b(),c=l(/^@supports *([^{]+)/);if(c){c=c[1].trim();if(!g())return f("@supports missing '{'");var d=n().concat(h());return l(/^}/)?
a({type:"supports",supports:c,rules:d}):f("@supports missing '}'")}}function K(){var a=b(),c=l(/^@media *([^{]+)/);if(c){c=c[1].trim();if(!g())return f("@media missing '{'");var d=n().concat(h());return l(/^}/)?a({type:"media",media:c,rules:d}):f("@media missing '}'")}}function J(){var a=b();if(l(/^@page */)){var c=r()||[];if(!g())return f("@page missing '{'");for(var d=n(),e;e=s();)d.push(e),d=d.concat(n());return l(/^}/)?a({type:"page",selectors:c,declarations:d}):f("@page missing '}'")}}function D(){var a=
b(),c=l(/^@([-\w]+)?document *([^{]+)/);if(c){var d=(c[1]||"").trim(),c=c[2].trim();if(!g())return f("@document missing '{'");var e=n().concat(h());return l(/^}/)?a({type:"document",document:c,vendor:d,rules:e}):f("@document missing '}'")}}function M(a){var c=b(),d=l(RegExp("^@"+a+" *([^;\\n]+);"));if(d){var e={type:a};e[a]=d[1].trim();return c(e)}}function m(){var a=b(),c=r();if(c)return n(),a({type:"rule",selectors:c,declarations:p()})}d=d||{};var C=1,N=1;return{type:"stylesheet",stylesheet:{rules:h()}}},
...
h.current_mode="TAG";break;case "TK_STYLE":case "TK_SCRIPT":if(""!==h.token_text){h.print_newline(!1,h.output);a=h.token_text;var w;n=1;"TK_SCRIPT"===h.token_type?w="function"===typeof d&&d:"TK_STYLE"===h.token_type&&(w="function"===typeof g&&g);"keep"===c.indent_scripts?n=0:"separate"===c.indent_scripts&&(n=-h.indent_level);l=h.get_full_indent(n);w?a=w(a.replace(/^\s*/,l),c):(t=a.match(/^\s*/)[0].match(/[^\n\r]*$/)[0].split(h.indent_string).length-1,n=h.get_full_indent(n-t),a=a.replace(/^\s*/,l).replace(/\r\n|\r|\n/g,
...
Labs.renderMenu=function(){$("#OpenTool #LabsContainer").html("");var a="Backup Blog Builder Clone Crawler Files Flickr Git Pages Redirect Server Share Sketch Stats Team Templates Time".split(/ /g),d="rgb(26,134,214) rgb(36,65,112) rgb(231,189,44) rgb(171,193,199) rgb(224,54,52) rgb(71,41,54)".split(" "),c='<div class="row">',b;for(b in a){var e=window[a[b]];0<b&&0===b%3&&(c+='</div><div class="row">');var e=e.get("name"),f=ToolInfo.get(e.toLowerCase()),c=c+Labs.toButton(e,f.get("description"),d[b?
b%d.length:0],f.get("icon")||"picture")}0!==(b+1)%3&&(c+="</div>");$("#OpenTool #LabsContainer").append(c);Labs.heights()};Labs.heights=function(){var a=0;$(".jumbotron").css("height","auto");$(".jumbotron").each(function(){$(this).height()>a&&(a=$(this).height())}).height(a)};
...
$.fn.getElementsByLine=function(a,d,c,b){var e=[];$(this).each(function(){var f=$(this),g,h,l,n;g=f.offset().left;h=f.offset().left+f.outerWidth();l=f.offset().top;n=f.offset().top+f.outerHeight();isRectangleIntersectedByLine(g,l,h,n,a,d,c,b)&&e.push(f)});return e};var Pages=new Tool("Pages");Pages.editor={};Pages.editor.filename="index.html";Pages.editor.pages=new Space;
