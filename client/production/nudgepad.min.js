...
b);for(b in a);return b===d||pa.call(a,b)},isEmptyObject:function(a){for(var b in a)return!1;return!0},error:function(a){throw Error(a);},parseHTML:function(a,b,d){if(!a||"string"!=typeof a)return null;"boolean"==typeof b&&(d=b,b=!1);b=b||H;var c=eb.exec(a);d=!d&&[];return c?[b.createElement(c[1])]:(c=k.buildFragment([a],b,d),d&&k(d).remove(),k.merge([],c.childNodes))},parseJSON:function(b){return a.JSON&&a.JSON.parse?a.JSON.parse(b):null===b?b:"string"==typeof b&&(b=k.trim(b),b&&ra.test(b.replace(T,
...
function(a,b){ha["[object "+b+"]"]=b.toLowerCase()});aa=k(H);(function(a,b){function d(a,b,c,e){var z,f,g,k,h;if((b?b.ownerDocument||b:da)!==D&&G(b),b=b||D,c=c||[],!a||"string"!=typeof a)return c;if(1!==(k=b.nodeType)&&9!==k)return[];if(H&&!e){if(z=ra.exec(a))if(g=z[1])if(9===k){if(f=b.getElementById(g),!f||!f.parentNode)return c;if(f.id===g)return c.push(f),c}else{if(b.ownerDocument&&(f=b.ownerDocument.getElementById(g))&&K(b,f)&&f.id===g)return c.push(f),c}else{if(z[2])return ba.apply(c,b.getElementsByTagName(a)),
c;if((g=z[3])&&s.getElementsByClassName&&b.getElementsByClassName)return ba.apply(c,b.getElementsByClassName(g)),c}if(s.qsa&&(!C||!C.test(a))){if(f=z=P,g=b,h=9===k&&a,1===k&&"object"!==b.nodeName.toLowerCase()){k=m(a);(z=b.getAttribute("id"))?f=z.replace(ta,"\\$&"):b.setAttribute("id",f);f="[id='"+f+"'] ";for(g=k.length;g--;)k[g]=f+E(k[g]);g=ea.test(a)&&b.parentNode||b;h=k.join(",")}if(h)try{return ba.apply(c,g.querySelectorAll(h)),c}catch(l){}finally{z||b.removeAttribute("id")}}}var Q;a:{a=a.replace(X,
"$1");var na,n;f=m(a);if(!e&&1===f.length){if(Q=f[0]=f[0].slice(0),2<Q.length&&"ID"===(na=Q[0]).type&&s.getById&&9===b.nodeType&&H&&w.relative[Q[1].type]){if(b=(w.find.ID(na.matches[0].replace(fa,ga),b)||[])[0],!b){Q=c;break a}a=a.slice(Q.shift().value.length)}for(k=Ha.needsContext.test(a)?0:Q.length;k--&&(na=Q[k],!w.relative[z=na.type]);)if((n=w.find[z])&&(e=n(na.matches[0].replace(fa,ga),ea.test(Q[0].type)&&b.parentNode||b))){if(Q.splice(k,1),a=e.length&&E(Q),!a){Q=(ba.apply(c,e),c);break a}break}}Q=
...
if(d)for(;d=d.nextSibling;)if(d===b)return-1;return a?1:-1}function l(a){return function(b){return"input"===b.nodeName.toLowerCase()&&b.type===a}}function n(a){return function(b){var d=b.nodeName.toLowerCase();return("input"===d||"button"===d)&&b.type===a}}function q(a){return e(function(b){return b=+b,e(function(d,c){for(var e,z=a([],d.length,b),f=z.length;f--;)d[e=z[f]]&&(d[e]=!(c[e]=d[e]))})})}function A(){}function m(a,b){var c,e,z,f,g,k,h;if(g=ma[a+" "])return b?0:g.slice(0);g=a;k=[];for(h=w.preFilter;g;){c&&
!(e=T.exec(g))||(e&&(g=g.slice(e[0].length)||g),k.push(z=[]));c=!1;(e=wa.exec(g))&&(c=e.shift(),z.push({value:c,type:e[0].replace(X," ")}),g=g.slice(c.length));for(f in w.filter)!(e=Ha[f].exec(g))||h[f]&&!(e=h[f](e))||(c=e.shift(),z.push({value:c,type:f,matches:e}),g=g.slice(c.length));if(!c)break}return b?g.length:g?d.error(a):ma(a,k).slice(0)}function E(a){for(var b=0,d=a.length,c="";d>b;b++)c+=a[b].value;return c}function p(a,b,d){var c=b.dir,e=d&&"parentNode"===c,z=N++;return b.first?function(b,
d,z){for(;b=b[c];)if(1===b.nodeType||e)return a(b,d,z)}:function(b,d,f){var g,k,h,l=U+" "+z;if(f)for(;b=b[c];){if((1===b.nodeType||e)&&a(b,d,f))return!0}else for(;b=b[c];)if(1===b.nodeType||e)if(h=b[P]||(b[P]={}),(k=h[c])&&k[0]===l){if(!0===(g=k[1])||g===t)return!0===g}else if(k=h[c]=[l],k[1]=a(b,d,f)||t,!0===k[1])return!0}}function u(a){return 1<a.length?function(b,d,c){for(var e=a.length;e--;)if(!a[e](b,d,c))return!1;return!0}:a[0]}function O(a,b,d,c,e){for(var z,f=[],g=0,k=a.length,h=null!=b;k>
g;g++)(z=a[g])&&(!d||d(z,c,e))&&(f.push(z),h&&b.push(g));return f}function J(a,b,c,z,f,g){return z&&!z[P]&&(z=J(z)),f&&!f[P]&&(f=J(f,g)),e(function(e,g,k,h){var l,Q,n=[],q=[],ua=g.length,A;if(!(A=e)){A=b||"*";for(var m=k.nodeType?[k]:k,Ca=[],E=0,p=m.length;p>E;E++)d(A,m[E],Ca);A=Ca}A=!a||!e&&b?A:O(A,n,a,k,h);m=c?f||(e?a:ua||z)?[]:g:A;if(c&&c(A,m,k,h),z)for(l=O(m,q),z(l,[],k,h),k=l.length;k--;)(Q=l[k])&&(m[q[k]]=!(A[q[k]]=Q));if(e){if(f||a){if(f){l=[];for(k=m.length;k--;)(Q=m[k])&&l.push(A[k]=Q);f(null,
m=[],l,h)}for(k=m.length;k--;)(Q=m[k])&&-1<(l=f?W.call(e,Q):n[k])&&(e[l]=!(g[l]=Q))}}else m=O(m===g?m.splice(ua,m.length):m),f?f(null,g,m,h):ba.apply(g,m)})}function I(a){var b,d,c,e=a.length,z=w.relative[a[0].type];d=z||w.relative[" "];for(var f=z?1:0,g=p(function(a){return a===b},d,!0),k=p(function(a){return-1<W.call(b,a)},d,!0),h=[function(a,d,c){return!z&&(c||d!==aa)||((b=d).nodeType?g(a,d,c):k(a,d,c))}];e>f;f++)if(d=w.relative[a[f].type])h=[p(u(h),d)];else{if(d=w.filter[a[f].type].apply(null,
a[f].matches),d[P]){for(c=++f;e>c&&!w.relative[a[c].type];c++);return J(1<f&&u(h),1<f&&E(a.slice(0,f-1).concat({value:" "===a[f-2].type?"*":""})).replace(X,"$1"),d,c>f&&I(a.slice(f,c)),e>c&&I(a=a.slice(c)),e>c&&E(a))}h.push(d)}return u(h)}function x(a,b){var c=0,z=0<b.length,f=0<a.length,g=function(e,g,k,h,l){var Q,n,q=[],ua=0,A="0",m=e&&[],E=null!=l,Ca=aa,p=e||f&&w.find.TAG("*",l&&g.parentNode||g),u=U+=null==Ca?1:Math.random()||0.1;for(E&&(aa=g!==D&&g,t=c);null!=(l=p[A]);A++){if(f&&l){for(Q=0;n=
a[Q++];)if(n(l,g,k)){h.push(l);break}E&&(U=u,t=++c)}z&&((l=!n&&l)&&ua--,e&&m.push(l))}if(ua+=A,z&&A!==ua){for(Q=0;n=b[Q++];)n(m,q,g,k);if(e){if(0<ua)for(;A--;)m[A]||q[A]||(q[A]=ca.call(h));q=O(q)}ba.apply(h,q);E&&!e&&0<q.length&&1<ua+b.length&&d.uniqueSort(h)}return E&&(U=u,aa=Ca),m};return z?e(g):g}var B,s,t,w,Y,r,v,aa,y,G,D,R,H,C,la,F,K,P="sizzle"+-new Date,da=a.document,U=0,N=0,L=c(),ma=c(),pa=c(),V=!1,M=function(a,b){return a===b?(V=!0,0):0},ja=typeof b,S=-2147483648,qa={}.hasOwnProperty,Z=[],
...
ga=function(a,b,d){a="0x"+b-65536;return a!==a||d?b:0>a?String.fromCharCode(a+65536):String.fromCharCode(55296|a>>10,56320|1023&a)};try{ba.apply(Z=oa.call(da.childNodes),da.childNodes),Z[da.childNodes.length].nodeType}catch(Ta){ba={apply:Z.length?function(a,b){kb.apply(a,oa.call(b))}:function(a,b){for(var d=a.length,c=0;a[d++]=b[c++];);a.length=d-1}}}r=d.isXML=function(a){return(a=a&&(a.ownerDocument||a).documentElement)?"HTML"!==a.nodeName:!1};s=d.support={};G=d.setDocument=function(a){var d=a?a.ownerDocument||
...
e?function(a){return!!a.parentNode}:function(b,d,k){var h,l,Q,na,n;d=z!==f?"nextSibling":"previousSibling";var q=b.parentNode,ua=g&&b.nodeName.toLowerCase();k=!k&&!g;if(q){if(z){for(;d;){for(l=b;l=l[d];)if(g?l.nodeName.toLowerCase()===ua:1===l.nodeType)return!1;n=d="only"===a&&!n&&"nextSibling"}return!0}if(n=[f?q.firstChild:q.lastChild],f&&k)for(k=q[P]||(q[P]={}),h=k[a]||[],na=h[0]===U&&h[1],Q=h[0]===U&&h[2],l=na&&q.childNodes[na];l=++na&&l&&l[d]||(Q=na=0)||n.pop();){if(1===l.nodeType&&++Q&&l===b){k[a]=
[U,na,Q];break}}else if(k&&(h=(b[P]||(b[P]={}))[a])&&h[0]===U)Q=h[1];else for(;(l=++na&&l&&l[d]||(Q=na=0)||n.pop())&&((g?l.nodeName.toLowerCase()!==ua:1!==l.nodeType)||!++Q||(k&&((l[P]||(l[P]={}))[a]=[U,Q]),l!==b)););return Q-=e,Q===c||0===Q%c&&0<=Q/c}}},PSEUDO:function(a,b){var c,z=w.pseudos[a]||w.setFilters[a.toLowerCase()]||d.error("unsupported pseudo: "+a);return z[P]?z(b):1<z.length?(c=[a,a,"",b],w.setFilters.hasOwnProperty(a.toLowerCase())?e(function(a,d){for(var c,e=z(a,b),f=e.length;f--;)c=
...
b,d){for(d=0>d?d+b:d;b>++d;)a.push(d);return a})}};w.pseudos.nth=w.pseudos.eq;for(B in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})w.pseudos[B]=l(B);for(B in{submit:!0,reset:!0})w.pseudos[B]=n(B);A.prototype=w.filters=w.pseudos;w.setFilters=new A;v=d.compile=function(a,b){var d,c=[],e=[],z=pa[a+" "];if(!z){b||(b=m(a));for(d=b.length;d--;)z=I(b[d]),z[P]?c.push(z):e.push(z);z=pa(a,x(e,c))}return z};s.sortStable=P.split("").sort(M).join("")===P;s.detectDuplicates=V;G();s.sortDetached=f(function(a){return 1&
