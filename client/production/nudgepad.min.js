...
b)return!1;return!0}function l(){return!0}function n(){return!1}function q(){try{return I.activeElement}catch(a){}}function t(a,b){do a=a[b];while(a&&1!==a.nodeType);return a}function s(a,b,d){if(k.isFunction(b))return k.grep(a,function(a,A){return!!b.call(a,A,a)!==d});if(b.nodeType)return k.grep(a,function(a){return a===b!==d});if("string"==typeof b){if(kb.test(b))return k.filter(b,a,d);b=k.filter(b,a)}return k.grep(a,function(a){return 0<=k.inArray(a,b)!==d})}function p(a){var b=Ja.split("|");a=
a.createDocumentFragment();if(a.createElement)for(;b.length;)a.createElement(b.pop());return a}function w(a,b){return k.nodeName(a,"table")&&k.nodeName(1===b.nodeType?b:b.firstChild,"tr")?a.getElementsByTagName("tbody")[0]||a.appendChild(a.ownerDocument.createElement("tbody")):a}function v(a){return a.type=(null!==k.find.attr(a,"type"))+"/"+a.type,a}function D(a){var b=Nb.exec(a.type);return b?a.type=b[1]:a.removeAttribute("type"),a}function J(a,b){for(var d,c=0;null!=(d=a[c]);c++)k._data(d,"globalEval",
...
e=parseFloat(e)||0}return e+x(a,b,c||(g?"border":"content"),d,f)+"px"}function U(a){var b=I,c=xb[a];return c||(c=V(a,b),"none"!==c&&c||(Ra=(Ra||k("<iframe frameborder='0' width='0' height='0'/>").css("cssText","display:block !important")).appendTo(b.documentElement),b=(Ra[0].contentWindow||Ra[0].contentDocument).document,b.write("<!doctype html><html><body>"),b.close(),c=V(a,b),Ra.detach()),xb[a]=c),c}function V(a,b){var c=k(b.createElement(a)).appendTo(b.body),d=k.css(c[0],"display");return c.remove(),
...
b);for(b in a);return b===d||pa.call(a,b)},isEmptyObject:function(a){for(var b in a)return!1;return!0},error:function(a){throw Error(a);},parseHTML:function(a,b,c){if(!a||"string"!=typeof a)return null;"boolean"==typeof b&&(c=b,b=!1);b=b||I;var d=eb.exec(a);c=!c&&[];return d?[b.createElement(d[1])]:(d=k.buildFragment([a],b,c),c&&k(c).remove(),k.merge([],d.childNodes))},parseJSON:function(b){return a.JSON&&a.JSON.parse?a.JSON.parse(b):null===b?b:"string"==typeof b&&(b=k.trim(b),b&&ra.test(b.replace(T,
...
e=[],f=0,g=a.length;for(c=!!c;g>f;f++)d=!!b(a[f],f),c!==d&&e.push(a[f]);return e},map:function(a,b,d){var e,f=0,g=a.length,k=[];if(c(a))for(;g>f;f++)e=b(a[f],f,d),null!=e&&(k[k.length]=e);else for(f in a)e=b(a[f],f,d),null!=e&&(k[k.length]=e);return va.apply([],k)},guid:1,proxy:function(a,b){var c,e,f;return"string"==typeof b&&(f=a[b],b=a,a=f),k.isFunction(a)?(c=y.call(arguments,2),e=function(){return a.apply(b||this,c.concat(y.call(arguments)))},e.guid=a.guid=a.guid||k.guid++,e):d},access:function(a,
b,c,e,f,g,h){var l=0,n=a.length,r=null==c;if("object"===k.type(c))for(l in f=!0,c)k.access(a,b,l,c[l],!0,g,h);else if(e!==d&&(f=!0,k.isFunction(e)||(h=!0),r&&(h?(b.call(a,e),b=null):(r=b,b=function(a,b,c){return r.call(k(a),c)})),b))for(;n>l;l++)b(a[l],c,h?e:e.call(a[l],l,b(a[l],c)));return f?a:r?b.call(a):n?b(a[0],c):g},now:function(){return(new Date).getTime()},swap:function(a,b,c,d){var e,f={};for(e in b)f[e]=a.style[e],a.style[e]=b[e];c=c.apply(a,d||[]);for(e in b)a.style[e]=f[e];return c}});
k.ready.promise=function(b){if(!E)if(E=k.Deferred(),"complete"===I.readyState)setTimeout(k.ready);else if(I.addEventListener)I.addEventListener("DOMContentLoaded",ia,!1),a.addEventListener("load",ia,!1);else{I.attachEvent("onreadystatechange",ia);a.attachEvent("onload",ia);var c=!1;try{c=null==a.frameElement&&I.documentElement}catch(d){}c&&c.doScroll&&function Ca(){if(!k.isReady){try{c.doScroll("left")}catch(a){return setTimeout(Ca,50)}Wa();k.ready()}}()}return E.promise(b)};k.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),
function(a,b){ha["[object "+b+"]"]=b.toLowerCase()});aa=k(I);(function(a,b){function c(a,b,d,e){var A,f,g,k,h;if((b?b.ownerDocument||b:da)!==D&&H(b),b=b||D,d=d||[],!a||"string"!=typeof a)return d;if(1!==(k=b.nodeType)&&9!==k)return[];if(I&&!e){if(A=ra.exec(a))if(g=A[1])if(9===k){if(f=b.getElementById(g),!f||!f.parentNode)return d;if(f.id===g)return d.push(f),d}else{if(b.ownerDocument&&(f=b.ownerDocument.getElementById(g))&&J(b,f)&&f.id===g)return d.push(f),d}else{if(A[2])return ba.apply(d,b.getElementsByTagName(a)),
d;if((g=A[3])&&q.getElementsByClassName&&b.getElementsByClassName)return ba.apply(d,b.getElementsByClassName(g)),d}if(q.qsa&&(!C||!C.test(a))){if(f=A=P,g=b,h=9===k&&a,1===k&&"object"!==b.nodeName.toLowerCase()){k=m(a);(A=b.getAttribute("id"))?f=A.replace(ta,"\\$&"):b.setAttribute("id",f);f="[id='"+f+"'] ";for(g=k.length;g--;)k[g]=f+E(k[g]);g=ea.test(a)&&b.parentNode||b;h=k.join(",")}if(h)try{return ba.apply(d,g.querySelectorAll(h)),d}catch(l){}finally{A||b.removeAttribute("id")}}}var Q;a:{a=a.replace(X,
"$1");var na,n;f=m(a);if(!e&&1===f.length){if(Q=f[0]=f[0].slice(0),2<Q.length&&"ID"===(na=Q[0]).type&&q.getById&&9===b.nodeType&&I&&w.relative[Q[1].type]){if(b=(w.find.ID(na.matches[0].replace(fa,ga),b)||[])[0],!b){Q=d;break a}a=a.slice(Q.shift().value.length)}for(k=Ha.needsContext.test(a)?0:Q.length;k--&&(na=Q[k],!w.relative[A=na.type]);)if((n=w.find[A])&&(e=n(na.matches[0].replace(fa,ga),ea.test(Q[0].type)&&b.parentNode||b))){if(Q.splice(k,1),a=e.length&&E(Q),!a){Q=(ba.apply(d,e),d);break a}break}}Q=
(v(a,f)(e,b,!I,d,ea.test(a)),d)}return Q}function d(){function a(c,d){return b.push(c+=" ")>w.cacheLength&&delete a[b.shift()],a[c]=d}var b=[];return a}function e(a){return a[P]=!0,a}function f(a){var b=D.createElement("div");try{return!!a(b)}catch(c){return!1}finally{b.parentNode&&b.parentNode.removeChild(b)}}function g(a,b){for(var c=a.split("|"),d=a.length;d--;)w.attrHandle[c[d]]=b}function h(a,b){var c=b&&a,d=c&&1===a.nodeType&&1===b.nodeType&&(~b.sourceIndex||S)-(~a.sourceIndex||S);if(d)return d;
if(c)for(;c=c.nextSibling;)if(c===b)return-1;return a?1:-1}function l(a){return function(b){return"input"===b.nodeName.toLowerCase()&&b.type===a}}function n(a){return function(b){var c=b.nodeName.toLowerCase();return("input"===c||"button"===c)&&b.type===a}}function r(a){return e(function(b){return b=+b,e(function(c,d){for(var e,A=a([],c.length,b),f=A.length;f--;)c[e=A[f]]&&(c[e]=!(d[e]=c[e]))})})}function y(){}function m(a,b){var d,e,A,f,g,k,h;if(g=ma[a+" "])return b?0:g.slice(0);g=a;k=[];for(h=w.preFilter;g;){d&&
!(e=T.exec(g))||(e&&(g=g.slice(e[0].length)||g),k.push(A=[]));d=!1;(e=wa.exec(g))&&(d=e.shift(),A.push({value:d,type:e[0].replace(X," ")}),g=g.slice(d.length));for(f in w.filter)!(e=Ha[f].exec(g))||h[f]&&!(e=h[f](e))||(d=e.shift(),A.push({value:d,type:f,matches:e}),g=g.slice(d.length));if(!d)break}return b?g.length:g?c.error(a):ma(a,k).slice(0)}function E(a){for(var b=0,c=a.length,d="";c>b;b++)d+=a[b].value;return d}function p(a,b,c){var d=b.dir,e=c&&"parentNode"===d,A=N++;return b.first?function(b,
c,A){for(;b=b[d];)if(1===b.nodeType||e)return a(b,c,A)}:function(b,c,f){var g,k,h,l=U+" "+A;if(f)for(;b=b[d];){if((1===b.nodeType||e)&&a(b,c,f))return!0}else for(;b=b[d];)if(1===b.nodeType||e)if(h=b[P]||(b[P]={}),(k=h[d])&&k[0]===l){if(!0===(g=k[1])||g===t)return!0===g}else if(k=h[d]=[l],k[1]=a(b,c,f)||t,!0===k[1])return!0}}function u(a){return 1<a.length?function(b,c,d){for(var e=a.length;e--;)if(!a[e](b,c,d))return!1;return!0}:a[0]}function O(a,b,c,d,e){for(var A,f=[],g=0,k=a.length,h=null!=b;k>
g;g++)(A=a[g])&&(!c||c(A,d,e))&&(f.push(A),h&&b.push(g));return f}function K(a,b,d,A,f,g){return A&&!A[P]&&(A=K(A)),f&&!f[P]&&(f=K(f,g)),e(function(e,g,k,h){var l,Q,n=[],r=[],ua=g.length,y;if(!(y=e)){y=b||"*";for(var m=k.nodeType?[k]:k,Ca=[],E=0,p=m.length;p>E;E++)c(y,m[E],Ca);y=Ca}y=!a||!e&&b?y:O(y,n,a,k,h);m=d?f||(e?a:ua||A)?[]:g:y;if(d&&d(y,m,k,h),A)for(l=O(m,r),A(l,[],k,h),k=l.length;k--;)(Q=l[k])&&(m[r[k]]=!(y[r[k]]=Q));if(e){if(f||a){if(f){l=[];for(k=m.length;k--;)(Q=m[k])&&l.push(y[k]=Q);f(null,
m=[],l,h)}for(k=m.length;k--;)(Q=m[k])&&-1<(l=f?W.call(e,Q):n[k])&&(e[l]=!(g[l]=Q))}}else m=O(m===g?m.splice(ua,m.length):m),f?f(null,g,m,h):ba.apply(g,m)})}function F(a){var b,c,d,e=a.length,A=w.relative[a[0].type];c=A||w.relative[" "];for(var f=A?1:0,g=p(function(a){return a===b},c,!0),k=p(function(a){return-1<W.call(b,a)},c,!0),h=[function(a,c,d){return!A&&(d||c!==aa)||((b=c).nodeType?g(a,c,d):k(a,c,d))}];e>f;f++)if(c=w.relative[a[f].type])h=[p(u(h),c)];else{if(c=w.filter[a[f].type].apply(null,
a[f].matches),c[P]){for(d=++f;e>d&&!w.relative[a[d].type];d++);return K(1<f&&u(h),1<f&&E(a.slice(0,f-1).concat({value:" "===a[f-2].type?"*":""})).replace(X,"$1"),c,d>f&&F(a.slice(f,d)),e>d&&F(a=a.slice(d)),e>d&&E(a))}h.push(c)}return u(h)}function z(a,b){var d=0,A=0<b.length,f=0<a.length,g=function(e,g,k,h,l){var Q,n,r=[],ua=0,y="0",m=e&&[],E=null!=l,Ca=aa,p=e||f&&w.find.TAG("*",l&&g.parentNode||g),u=U+=null==Ca?1:Math.random()||0.1;for(E&&(aa=g!==D&&g,t=d);null!=(l=p[y]);y++){if(f&&l){for(Q=0;n=
a[Q++];)if(n(l,g,k)){h.push(l);break}E&&(U=u,t=++d)}A&&((l=!n&&l)&&ua--,e&&m.push(l))}if(ua+=y,A&&y!==ua){for(Q=0;n=b[Q++];)n(m,r,g,k);if(e){if(0<ua)for(;y--;)m[y]||r[y]||(r[y]=ca.call(h));r=O(r)}ba.apply(h,r);E&&!e&&0<r.length&&1<ua+b.length&&c.uniqueSort(h)}return E&&(U=u,aa=Ca),m};return A?e(g):g}var B,q,t,w,Y,s,v,aa,x,H,D,R,I,C,la,G,J,P="sizzle"+-new Date,da=a.document,U=0,N=0,L=d(),ma=d(),pa=d(),V=!1,M=function(a,b){return a===b?(V=!0,0):0},ja=typeof b,S=-2147483648,qa={}.hasOwnProperty,Z=[],
...
ga=function(a,b,c){a="0x"+b-65536;return a!==a||c?b:0>a?String.fromCharCode(a+65536):String.fromCharCode(55296|a>>10,56320|1023&a)};try{ba.apply(Z=oa.call(da.childNodes),da.childNodes),Z[da.childNodes.length].nodeType}catch(Ta){ba={apply:Z.length?function(a,b){kb.apply(a,oa.call(b))}:function(a,b){for(var c=a.length,d=0;a[c++]=b[d++];);a.length=c-1}}}s=c.isXML=function(a){return(a=a&&(a.ownerDocument||a).documentElement)?"HTML"!==a.nodeName:!1};q=c.support={};H=c.setDocument=function(a){var c=a?a.ownerDocument||
a:da;a=c.defaultView;return c!==D&&9===c.nodeType&&c.documentElement?(D=c,R=c.documentElement,I=!s(c),a&&a.attachEvent&&a!==a.top&&a.attachEvent("onbeforeunload",function(){H()}),q.attributes=f(function(a){return a.className="i",!a.getAttribute("className")}),q.getElementsByTagName=f(function(a){return a.appendChild(c.createComment("")),!a.getElementsByTagName("*").length}),q.getElementsByClassName=f(function(a){return a.innerHTML="<div class='a'></div><div class='a i'></div>",a.firstChild.className=
"i",2===a.getElementsByClassName("i").length}),q.getById=f(function(a){return R.appendChild(a).id=P,!c.getElementsByName||!c.getElementsByName(P).length}),q.getById?(w.find.ID=function(a,b){if(typeof b.getElementById!==ja&&I){var c=b.getElementById(a);return c&&c.parentNode?[c]:[]}},w.filter.ID=function(a){var b=a.replace(fa,ga);return function(a){return a.getAttribute("id")===b}}):(delete w.find.ID,w.filter.ID=function(a){var b=a.replace(fa,ga);return function(a){return(a=typeof a.getAttributeNode!==
ja&&a.getAttributeNode("id"))&&a.value===b}}),w.find.TAG=q.getElementsByTagName?function(a,c){return typeof c.getElementsByTagName!==ja?c.getElementsByTagName(a):b}:function(a,b){var c,d=[],e=0,A=b.getElementsByTagName(a);if("*"===a){for(;c=A[e++];)1===c.nodeType&&d.push(c);return d}return A},w.find.CLASS=q.getElementsByClassName&&function(a,c){return typeof c.getElementsByClassName!==ja&&I?c.getElementsByClassName(a):b},la=[],C=[],(q.qsa=ia.test(c.querySelectorAll))&&(f(function(a){a.innerHTML="<select><option selected=''></option></select>";
...
C.push(":enabled",":disabled");a.querySelectorAll("*,:x");C.push(",.*:")})),(q.matchesSelector=ia.test(G=R.webkitMatchesSelector||R.mozMatchesSelector||R.oMatchesSelector||R.msMatchesSelector))&&f(function(a){q.disconnectedMatch=G.call(a,"div");G.call(a,"[s!='']:x");la.push("!=",Ja)}),C=C.length&&RegExp(C.join("|")),la=la.length&&RegExp(la.join("|")),J=ia.test(R.contains)||R.compareDocumentPosition?function(a,b){var c=9===a.nodeType?a.documentElement:a,d=b&&b.parentNode;return a===d||!(!d||1!==d.nodeType||
!(c.contains?c.contains(d):a.compareDocumentPosition&&16&a.compareDocumentPosition(d)))}:function(a,b){if(b)for(;b=b.parentNode;)if(b===a)return!0;return!1},M=R.compareDocumentPosition?function(a,b){if(a===b)return V=!0,0;var d=b.compareDocumentPosition&&a.compareDocumentPosition&&a.compareDocumentPosition(b);return d?1&d||!q.sortDetached&&b.compareDocumentPosition(a)===d?a===c||J(da,a)?-1:b===c||J(da,b)?1:x?W.call(x,a)-W.call(x,b):0:4&d?-1:1:a.compareDocumentPosition?-1:1}:function(a,b){var d,e=
0;d=a.parentNode;var A=b.parentNode,f=[a],g=[b];if(a===b)return V=!0,0;if(!d||!A)return a===c?-1:b===c?1:d?-1:A?1:x?W.call(x,a)-W.call(x,b):0;if(d===A)return h(a,b);for(d=a;d=d.parentNode;)f.unshift(d);for(d=b;d=d.parentNode;)g.unshift(d);for(;f[e]===g[e];)e++;return e?h(f[e],g[e]):f[e]===da?-1:g[e]===da?1:0},c):D};c.matches=function(a,b){return c(a,null,null,b)};c.matchesSelector=function(a,b){if((a.ownerDocument||a)!==D&&H(a),b=b.replace(ka,"='$1']"),q.matchesSelector&&I&&!(la&&la.test(b)||C&&C.test(b)))try{var d=
G.call(a,b);if(d||q.disconnectedMatch||a.document&&11!==a.document.nodeType)return d}catch(e){}return 0<c(b,D,null,[a]).length};c.contains=function(a,b){return(a.ownerDocument||a)!==D&&H(a),J(a,b)};c.attr=function(a,c){(a.ownerDocument||a)!==D&&H(a);var d=w.attrHandle[c.toLowerCase()],d=d&&qa.call(w.attrHandle,c.toLowerCase())?d(a,c,!I):b;return d===b?q.attributes||!I?a.getAttribute(c):(d=a.getAttributeNode(c))&&d.specified?d.value:null:d};c.error=function(a){throw Error("Syntax error, unrecognized expression: "+
a);};c.uniqueSort=function(a){var b,c=[],d=0,e=0;if(V=!q.detectDuplicates,x=!q.sortStable&&a.slice(0),a.sort(M),V){for(;b=a[e++];)b===a[e]&&(d=c.push(e));for(;d--;)a.splice(c[d],1)}return a};Y=c.getText=function(a){var b,c="",d=0;if(b=a.nodeType)if(1===b||9===b||11===b){if("string"==typeof a.textContent)return a.textContent;for(a=a.firstChild;a;a=a.nextSibling)c+=Y(a)}else{if(3===b||4===b)return a.nodeValue}else for(;b=a[d];d++)c+=Y(b);return c};w=c.selectors={cacheLength:50,createPseudo:e,match:Ha,
...
typeof a.className&&a.className||typeof a.getAttribute!==ja&&a.getAttribute("class")||"")})},ATTR:function(a,b,d){return function(e){e=c.attr(e,a);return null==e?"!="===b:b?(e+="","="===b?e===d:"!="===b?e!==d:"^="===b?d&&0===e.indexOf(d):"*="===b?d&&-1<e.indexOf(d):"$="===b?d&&e.slice(-d.length)===d:"~="===b?-1<(" "+e+" ").indexOf(d):"|="===b?e===d||e.slice(0,d.length+1)===d+"-":!1):!0}},CHILD:function(a,b,c,d,e){var A="nth"!==a.slice(0,3),f="last"!==a.slice(-4),g="of-type"===b;return 1===d&&0===
e?function(a){return!!a.parentNode}:function(b,c,k){var h,l,Q,na,n;c=A!==f?"nextSibling":"previousSibling";var r=b.parentNode,ua=g&&b.nodeName.toLowerCase();k=!k&&!g;if(r){if(A){for(;c;){for(l=b;l=l[c];)if(g?l.nodeName.toLowerCase()===ua:1===l.nodeType)return!1;n=c="only"===a&&!n&&"nextSibling"}return!0}if(n=[f?r.firstChild:r.lastChild],f&&k)for(k=r[P]||(r[P]={}),h=k[a]||[],na=h[0]===U&&h[1],Q=h[0]===U&&h[2],l=na&&r.childNodes[na];l=++na&&l&&l[c]||(Q=na=0)||n.pop();){if(1===l.nodeType&&++Q&&l===b){k[a]=
[U,na,Q];break}}else if(k&&(h=(b[P]||(b[P]={}))[a])&&h[0]===U)Q=h[1];else for(;(l=++na&&l&&l[c]||(Q=na=0)||n.pop())&&((g?l.nodeName.toLowerCase()!==ua:1!==l.nodeType)||!++Q||(k&&((l[P]||(l[P]={}))[a]=[U,Q]),l!==b)););return Q-=e,Q===d||0===Q%d&&0<=Q/d}}},PSEUDO:function(a,b){var d,A=w.pseudos[a]||w.setFilters[a.toLowerCase()]||c.error("unsupported pseudo: "+a);return A[P]?A(b):1<A.length?(d=[a,a,"",b],w.setFilters.hasOwnProperty(a.toLowerCase())?e(function(a,c){for(var d,e=A(a,b),f=e.length;f--;)d=
W.call(a,e[f]),a[d]=!(c[d]=e[f])}):function(a){return A(a,0,d)}):A}},pseudos:{not:e(function(a){var b=[],c=[],d=v(a.replace(X,"$1"));return d[P]?e(function(a,b,c,e){var A;c=d(a,null,e,[]);for(e=a.length;e--;)(A=c[e])&&(a[e]=!(b[e]=A))}):function(a,e,A){return b[0]=a,d(b,null,A,c),!c.pop()}}),has:e(function(a){return function(b){return 0<c(a,b).length}}),contains:e(function(a){return function(b){return-1<(b.textContent||b.innerText||Y(b)).indexOf(a)}}),lang:e(function(a){return va.test(a||"")||c.error("unsupported lang: "+
...
return"input"===b&&"button"===a.type||"button"===b},text:function(a){var b;return"input"===a.nodeName.toLowerCase()&&"text"===a.type&&(null==(b=a.getAttribute("type"))||b.toLowerCase()===a.type)},first:r(function(){return[0]}),last:r(function(a,b){return[b-1]}),eq:r(function(a,b,c){return[0>c?c+b:c]}),even:r(function(a,b){for(var c=0;b>c;c+=2)a.push(c);return a}),odd:r(function(a,b){for(var c=1;b>c;c+=2)a.push(c);return a}),lt:r(function(a,b,c){for(b=0>c?c+b:c;0<=--b;)a.push(b);return a}),gt:r(function(a,
b,c){for(c=0>c?c+b:c;b>++c;)a.push(c);return a})}};w.pseudos.nth=w.pseudos.eq;for(B in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})w.pseudos[B]=l(B);for(B in{submit:!0,reset:!0})w.pseudos[B]=n(B);y.prototype=w.filters=w.pseudos;w.setFilters=new y;v=c.compile=function(a,b){var c,d=[],e=[],A=pa[a+" "];if(!A){b||(b=m(a));for(c=b.length;c--;)A=F(b[c]),A[P]?d.push(A):e.push(A);A=pa(a,z(e,d))}return A};q.sortStable=P.split("").sort(M).join("")===P;q.detectDuplicates=V;H();q.sortDetached=f(function(a){return 1&
a.compareDocumentPosition(D.createElement("div"))});f(function(a){return a.innerHTML="<a href='#'></a>","#"===a.firstChild.getAttribute("href")})||g("type|href|height|width",function(a,c,d){return d?b:a.getAttribute(c,"type"===c.toLowerCase()?1:2)});q.attributes&&f(function(a){return a.innerHTML="<input/>",a.firstChild.setAttribute("value",""),""===a.firstChild.getAttribute("value")})||g("value",function(a,c,d){return d||"input"!==a.nodeName.toLowerCase()?b:a.defaultValue});f(function(a){return null==
...
g,l,h,n=[],r=!a.once&&[],y=function(b){e=a.memory&&b;f=!0;l=h||0;h=0;g=n.length;for(c=!0;n&&g>l;l++)if(!1===n[l].apply(b[0],b[1])&&a.stopOnFalse){e=!1;break}c=!1;n&&(r?r.length&&y(r.shift()):e?n=[]:m.disable())},m={add:function(){if(n){var b=n.length;(function Qb(b){k.each(b,function(b,c){var d=k.type(c);"function"===d?a.unique&&m.has(c)||n.push(c):c&&c.length&&"string"!==d&&Qb(c)})})(arguments);c?g=n.length:e&&(h=b,y(e))}return this},remove:function(){return n&&k.each(arguments,function(a,b){for(var d;-1<
(d=k.inArray(b,n,d));)n.splice(d,1),c&&(g>=d&&g--,l>=d&&l--)}),this},has:function(a){return a?-1<k.inArray(a,n):!(!n||!n.length)},empty:function(){return n=[],g=0,this},disable:function(){return n=r=e=d,this},disabled:function(){return!n},lock:function(){return r=d,e||m.disable(),this},locked:function(){return!r},fireWith:function(a,b){return!n||f&&!r||(b=b||[],b=[a,b.slice?b.slice():b],c?r.push(b):y(b)),this},fire:function(){return m.fireWith(this,arguments),this},fired:function(){return!!f}};return m};
k.extend({Deferred:function(a){var b=[["resolve","done",k.Callbacks("once memory"),"resolved"],["reject","fail",k.Callbacks("once memory"),"rejected"],["notify","progress",k.Callbacks("memory")]],c="pending",d={state:function(){return c},always:function(){return e.done(arguments).fail(arguments),this},then:function(){var a=arguments;return k.Deferred(function(c){k.each(b,function(b,A){var f=A[0],g=k.isFunction(a[b])&&a[b];e[A[1]](function(){var a=g&&g.apply(this,arguments);a&&k.isFunction(a.promise)?
a.promise().done(c.resolve).fail(c.reject).progress(c.notify):c[f+"With"](this===d?c.promise():this,g?[a]:arguments)})});a=null}).promise()},promise:function(a){return null!=a?k.extend(a,d):d}},e={};return d.pipe=d.then,k.each(b,function(a,A){var f=A[2],g=A[3];d[A[1]]=f.add;g&&f.add(function(){c=g},b[1^a][2].disable,b[2][2].lock);e[A[0]]=function(){return e[A[0]+"With"](this===e?d:this,arguments),this};e[A[0]+"With"]=f.fireWith}),d.promise(e),a&&a.call(e,e),e},when:function(a){var b=0,c=y.call(arguments),
d=c.length,e=1!==d||a&&k.isFunction(a.promise)?d:0,f=1===e?a:k.Deferred(),g=function(a,b,c){return function(d){b[a]=this;c[a]=1<arguments.length?y.call(arguments):d;c===l?f.notifyWith(b,c):--e||f.resolveWith(b,c)}},l,h,n;if(1<d)for(l=Array(d),h=Array(d),n=Array(d);d>b;b++)c[b]&&k.isFunction(c[b].promise)?c[b].promise().done(g(b,n,c)).fail(f.reject).progress(g(b,h,l)):--e;return e||f.resolveWith(n,c),f.promise()}});k.support=function(b){var c,d,e,f,g,l,h=I.createElement("div");if(h.setAttribute("className",
...
add:function(a,b,c,e,f){var g,h,l,n,r,y,m,E,p,u;if(l=k._data(a)){c.handler&&(n=c,c=n.handler,f=n.selector);c.guid||(c.guid=k.guid++);(h=l.events)||(h=l.events={});(y=l.handle)||(y=l.handle=function(a){return typeof k===R||a&&k.event.triggered===a.type?d:k.event.dispatch.apply(y.elem,arguments)},y.elem=a);b=(b||"").match(ba)||[""];for(l=b.length;l--;)g=Ga.exec(b[l])||[],p=u=g[1],g=(g[2]||"").split(".").sort(),p&&(r=k.event.special[p]||{},p=(f?r.delegateType:r.bindType)||p,r=k.event.special[p]||{},
m=k.extend({type:p,origType:u,data:e,handler:c,guid:c.guid,selector:f,needsContext:f&&k.expr.match.needsContext.test(f),namespace:g.join(".")},n),(E=h[p])||(E=h[p]=[],E.delegateCount=0,r.setup&&!1!==r.setup.call(a,e,g,y)||(a.addEventListener?a.addEventListener(p,y,!1):a.attachEvent&&a.attachEvent("on"+p,y))),r.add&&(r.add.call(a,m),m.handler.guid||(m.handler.guid=c.guid)),f?E.splice(E.delegateCount++,0,m):E.push(m),k.event.global[p]=!0);a=null}},remove:function(a,b,c,d,e){var f,g,h,l,n,r,y,m,E,p,
u,O=k.hasData(a)&&k._data(a);if(O&&(r=O.events)){b=(b||"").match(ba)||[""];for(n=b.length;n--;)if(h=Ga.exec(b[n])||[],E=u=h[1],p=(h[2]||"").split(".").sort(),E){y=k.event.special[E]||{};E=(d?y.delegateType:y.bindType)||E;m=r[E]||[];h=h[2]&&RegExp("(^|\\.)"+p.join("\\.(?:.*\\.|)")+"(\\.|$)");for(l=f=m.length;f--;)g=m[f],!e&&u!==g.origType||c&&c.guid!==g.guid||h&&!h.test(g.namespace)||d&&d!==g.selector&&("**"!==d||!g.selector)||(m.splice(f,1),g.selector&&m.delegateCount--,y.remove&&y.remove.call(a,
g));l&&!m.length&&(y.teardown&&!1!==y.teardown.call(a,p,O.handle)||k.removeEvent(a,E,O.handle),delete r[E])}else for(E in r)k.event.remove(a,E+b[n],c,d,!0);k.isEmptyObject(r)&&(delete O.handle,k._removeData(a,"events"))}},trigger:function(b,c,e,f){var g,h,l,n,r,y,m=[e||I],E=pa.call(b,"type")?b.type:b;y=pa.call(b,"namespace")?b.namespace.split("."):[];if(l=g=e=e||I,3!==e.nodeType&&8!==e.nodeType&&!hb.test(E+k.event.triggered)&&(0<=E.indexOf(".")&&(y=E.split("."),E=y.shift(),y.sort()),h=0>E.indexOf(":")&&
"on"+E,b=b[k.expando]?b:new k.Event(E,"object"==typeof b&&b),b.isTrigger=f?2:3,b.namespace=y.join("."),b.namespace_re=b.namespace?RegExp("(^|\\.)"+y.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,b.result=d,b.target||(b.target=e),c=null==c?[b]:k.makeArray(c,[b]),r=k.event.special[E]||{},f||!r.trigger||!1!==r.trigger.apply(e,c))){if(!f&&!r.noBubble&&!k.isWindow(e)){n=r.delegateType||E;for(hb.test(n+E)||(l=l.parentNode);l;l=l.parentNode)m.push(l),g=l;g===(e.ownerDocument||I)&&m.push(g.defaultView||g.parentWindow||
a)}for(y=0;(l=m[y++])&&!b.isPropagationStopped();)b.type=1<y?n:r.bindType||E,(g=(k._data(l,"events")||{})[b.type]&&k._data(l,"handle"))&&g.apply(l,c),(g=h&&l[h])&&k.acceptData(l)&&g.apply&&!1===g.apply(l,c)&&b.preventDefault();if(b.type=E,!f&&!b.isDefaultPrevented()&&(!r._default||!1===r._default.apply(m.pop(),c))&&k.acceptData(e)&&h&&e[E]&&!k.isWindow(e)){(g=e[h])&&(e[h]=null);k.event.triggered=E;try{e[E]()}catch(p){}k.event.triggered=d;g&&(e[h]=g)}return b.result}},dispatch:function(a){a=k.event.fix(a);
var b,c,e,f,g,h=[],l=y.call(arguments);b=(k._data(this,"events")||{})[a.type]||[];var n=k.event.special[a.type]||{};if(l[0]=a,a.delegateTarget=this,!n.preDispatch||!1!==n.preDispatch.call(this,a)){h=k.event.handlers.call(this,a,b);for(b=0;(f=h[b++])&&!a.isPropagationStopped();)for(a.currentTarget=f.elem,g=0;(e=f.handlers[g++])&&!a.isImmediatePropagationStopped();)a.namespace_re&&!a.namespace_re.test(e.namespace)||(a.handleObj=e,a.data=e.data,c=((k.event.special[e.origType]||{}).handle||e.handler).apply(f.elem,
...
f.clientLeft||c&&c.clientLeft||0),a.pageY=b.clientY+(f&&f.scrollTop||c&&c.scrollTop||0)-(f&&f.clientTop||c&&c.clientTop||0)),!a.relatedTarget&&k&&(a.relatedTarget=k===a.target?b.toElement:k),a.which||g===d||(a.which=1&g?1:2&g?3:4&g?2:0),a}},special:{load:{noBubble:!0},focus:{trigger:function(){if(this!==q()&&this.focus)try{return this.focus(),!1}catch(a){}},delegateType:"focusin"},blur:{trigger:function(){return this===q()&&this.blur?(this.blur(),!1):d},delegateType:"focusout"},click:{trigger:function(){return k.nodeName(this,
...
!1)),b.innerHTML=a);b=0}catch(f){}}b&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(){var a=k.map(this,function(a){return[a.nextSibling,a.parentNode]}),b=0;return this.domManip(arguments,function(c){var d=a[b++],e=a[b++];e&&(d&&d.parentNode!==e&&(d=this.nextSibling),k(this).remove(),e.insertBefore(c,d))},!0),b?this:this.remove()},detach:function(a){return this.remove(a,!0)},domManip:function(a,b,c){a=va.apply([],a);var d,e,f,g,h=0,l=this.length,n=this,r=l-1,y=a[0],m=k.isFunction(y);
if(m||!(1>=l||"string"!=typeof y||k.support.checkClone)&&Tb.test(y))return this.each(function(d){var e=n.eq(d);m&&(a[0]=y.call(this,d,e.html()));e.domManip(a,b,c)});if(l&&(g=k.buildFragment(a,this[0].ownerDocument,!1,!c&&this),d=g.firstChild,1===g.childNodes.length&&(g=d),d)){f=k.map(B(g,"script"),v);for(e=f.length;l>h;h++)d=g,h!==r&&(d=k.clone(d,!0,!0),e&&k.merge(f,B(d,"script"))),b.call(this[h],d,h);if(e)for(g=f[f.length-1].ownerDocument,k.map(f,D),h=0;e>h;h++)d=f[h],Cb.test(d.type||"")&&!k._data(d,
...
a);if(k.support.html5Clone||k.isXMLDoc(a)||!yb.test("<"+a.nodeName+">")?f=a.cloneNode(!0):(qb.innerHTML=a.outerHTML,qb.removeChild(f=qb.firstChild)),!(k.support.noCloneEvent&&k.support.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||k.isXMLDoc(a)))for(d=B(f),h=B(a),g=0;null!=(e=h[g]);++g)if(d[g]){var n=d[g],r=void 0,y=void 0,m=void 0;if(1===n.nodeType){if(r=n.nodeName.toLowerCase(),!k.support.noCloneEvent&&n[k.expando]){m=k._data(n);for(y in m.events)k.removeEvent(n,y,m.handle);n.removeAttribute(k.expando)}"script"===
r&&n.text!==e.text?(v(n).text=e.text,D(n)):"object"===r?(n.parentNode&&(n.outerHTML=e.outerHTML),k.support.html5Clone&&e.innerHTML&&!k.trim(n.innerHTML)&&(n.innerHTML=e.innerHTML)):"input"===r&&lb.test(e.type)?(n.defaultChecked=n.checked=e.checked,n.value!==e.value&&(n.value=e.value)):"option"===r?n.defaultSelected=n.selected=e.defaultSelected:("input"===r||"textarea"===r)&&(n.defaultValue=e.defaultValue)}}if(b)if(c)for(h=h||B(a),d=d||B(f),g=0;null!=(e=h[g]);g++)O(e,d[g]);else O(a,f);return d=B(f,
"script"),0<d.length&&J(d,!l&&B(a,"script")),f},buildFragment:function(a,b,c,d){for(var e,f,g,h,l,n,r,y=a.length,m=p(b),E=[],u=0;y>u;u++)if(f=a[u],f||0===f)if("object"===k.type(f))k.merge(E,f.nodeType?[f]:f);else if(Rb.test(f)){h=h||m.appendChild(b.createElement("div"));l=(Ab.exec(f)||["",""])[1].toLowerCase();r=sa[l]||sa._default;h.innerHTML=r[1]+f.replace(zb,"<$1></$2>")+r[2];for(e=r[0];e--;)h=h.lastChild;if(!k.support.leadingWhitespace&&pb.test(f)&&E.push(b.createTextNode(pb.exec(f)[0])),!k.support.tbody)for(e=
(f="table"!==l||Bb.test(f)?"<table>"!==r[1]||Bb.test(f)?0:h:h.firstChild)&&f.childNodes.length;e--;)k.nodeName(n=f.childNodes[e],"tbody")&&!n.childNodes.length&&f.removeChild(n);k.merge(E,h.childNodes);for(h.textContent="";h.firstChild;)h.removeChild(h.firstChild);h=m.lastChild}else E.push(b.createTextNode(f));h&&m.removeChild(h);k.support.appendChecked||k.grep(B(E,"input"),L);for(u=0;f=E[u++];)if((!d||-1===k.inArray(f,d))&&(g=k.contains(f.ownerDocument,f),h=B(m.appendChild(f),"script"),g&&J(h),c))for(e=
0;f=h[e++];)Cb.test(f.type||"")&&c.push(f);return m},cleanData:function(a,b){for(var c,d,e,f,g=0,h=k.expando,l=k.cache,n=k.support.deleteExpando,r=k.event.special;null!=(c=a[g]);g++)if((b||k.acceptData(c))&&(e=c[h],f=e&&l[e])){if(f.events)for(d in f.events)r[d]?k.event.remove(c,d):k.removeEvent(c,d,f.handle);l[e]&&(delete l[e],n?delete c[h]:typeof c.removeAttribute!==R?c.removeAttribute(h):c[h]=null,ka.push(e))}},_evalUrl:function(a){return k.ajax({url:a,type:"GET",dataType:"script",async:!1,global:!1,
...
json:"responseJSON"},converters:{"* text":String,"text html":!0,"text json":k.parseJSON,"text xml":k.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(a,b){return b?M(M(a,k.ajaxSettings),b):M(k.ajaxSettings,a)},ajaxPrefilter:P(Jb),ajaxTransport:P(mb),ajax:function(a,b){function c(a,b,e,f){var y,A,F,B,z=b;if(2!==w){w=2;l&&clearTimeout(l);r=d;h=f||"";q.readyState=0<a?4:0;f=200<=a&&300>a||304===a;if(e){F=m;for(var t=q,Y,s,aa,v,D=F.contents,x=F.dataTypes;"*"===x[0];)x.shift(),s===d&&(s=F.mimeType||
t.getResponseHeader("Content-Type"));if(s)for(v in D)if(D[v]&&D[v].test(s)){x.unshift(v);break}if(x[0]in e)aa=x[0];else{for(v in e){if(!x[0]||F.converters[v+" "+x[0]]){aa=v;break}Y||(Y=v)}aa=aa||Y}F=aa?(aa!==x[0]&&x.unshift(aa),e[aa]):d}var H;a:{e=m;Y=F;s=q;aa=f;var R,I,C;F={};t=e.dataTypes.slice();if(t[1])for(R in e.converters)F[R.toLowerCase()]=e.converters[R];for(v=t.shift();v;)if(e.responseFields[v]&&(s[e.responseFields[v]]=Y),!C&&aa&&e.dataFilter&&(Y=e.dataFilter(Y,e.dataType)),C=v,v=t.shift())if("*"===
v)v=C;else if("*"!==C&&C!==v){if(R=F[C+" "+v]||F["* "+v],!R)for(H in F)if(I=H.split(" "),I[1]===v&&(R=F[C+" "+I[0]]||F["* "+I[0]])){!0===R?R=F[H]:!0!==F[H]&&(v=I[0],t.unshift(I[1]));break}if(!0!==R)if(R&&e["throws"])Y=R(Y);else try{Y=R(Y)}catch(la){H={state:"parsererror",error:R?la:"No conversion from "+C+" to "+v};break a}}H={state:"success",data:Y}}F=H;f?(m.ifModified&&(B=q.getResponseHeader("Last-Modified"),B&&(k.lastModified[g]=B),B=q.getResponseHeader("etag"),B&&(k.etag[g]=B)),204===a||"HEAD"===
m.type?z="nocontent":304===a?z="notmodified":(z=F.state,y=F.data,A=F.error,f=!A)):(A=z,(a||!z)&&(z="error",0>a&&(a=0)));q.status=a;q.statusText=(b||z)+"";f?u.resolveWith(E,[y,z,q]):u.rejectWith(E,[q,z,A]);q.statusCode(K);K=d;n&&p.trigger(f?"ajaxSuccess":"ajaxError",[q,m,f?y:A]);O.fireWith(E,[q,z]);n&&(p.trigger("ajaxComplete",[q,m]),--k.active||k.event.trigger("ajaxStop"))}}"object"==typeof a&&(b=a,a=d);b=b||{};var e,f,g,h,l,n,r,y,m=k.ajaxSetup({},b),E=m.context||m,p=m.context&&(E.nodeType||E.jquery)?
k(E):k.event,u=k.Deferred(),O=k.Callbacks("once memory"),K=m.statusCode||{},F={},B={},w=0,z="canceled",q={readyState:0,getResponseHeader:function(a){var b;if(2===w){if(!y)for(y={};b=dc.exec(h);)y[b[1].toLowerCase()]=b[2];b=y[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===w?h:null},setRequestHeader:function(a,b){var c=a.toLowerCase();return w||(a=B[c]=B[c]||a,F[a]=b),this},overrideMimeType:function(a){return w||(m.mimeType=a),this},statusCode:function(a){var b;
if(a)if(2>w)for(b in a)K[b]=[K[b],a[b]];else q.always(a[q.status]);return this},abort:function(a){a=a||z;return r&&r.abort(a),c(0,a),this}};if(u.promise(q).complete=O.add,q.success=q.done,q.error=q.fail,m.url=((a||m.url||Ba)+"").replace(cc,"").replace(fc,Ia[1]+"//"),m.type=b.method||b.type||m.method||m.type,m.dataTypes=k.trim(m.dataType||"*").toLowerCase().match(ba)||[""],null==m.crossDomain&&(e=Hb.exec(m.url.toLowerCase()),m.crossDomain=!(!e||e[1]===Ia[1]&&e[2]===Ia[2]&&(e[3]||("http:"===e[1]?"80":
"443"))===(Ia[3]||("http:"===Ia[1]?"80":"443")))),m.data&&m.processData&&"string"!=typeof m.data&&(m.data=k.param(m.data,m.traditional)),ca(Jb,m,b,q),2===w)return q;(n=m.global)&&0===k.active++&&k.event.trigger("ajaxStart");m.type=m.type.toUpperCase();m.hasContent=!ec.test(m.type);g=m.url;m.hasContent||(m.data&&(g=m.url+=(tb.test(g)?"&":"?")+m.data,delete m.data),!1===m.cache&&(m.url=Gb.test(g)?g.replace(Gb,"$1_="+sb++):g+(tb.test(g)?"&":"?")+"_="+sb++));m.ifModified&&(k.lastModified[g]&&q.setRequestHeader("If-Modified-Since",
k.lastModified[g]),k.etag[g]&&q.setRequestHeader("If-None-Match",k.etag[g]));(m.data&&m.hasContent&&!1!==m.contentType||b.contentType)&&q.setRequestHeader("Content-Type",m.contentType);q.setRequestHeader("Accept",m.dataTypes[0]&&m.accepts[m.dataTypes[0]]?m.accepts[m.dataTypes[0]]+("*"!==m.dataTypes[0]?", "+Kb+"; q=0.01":""):m.accepts["*"]);for(f in m.headers)q.setRequestHeader(f,m.headers[f]);if(m.beforeSend&&(!1===m.beforeSend.call(E,q,m)||2===w))return q.abort();z="abort";for(f in{success:1,error:1,
complete:1})q[f](m[f]);if(r=ca(mb,m,b,q)){q.readyState=1;n&&p.trigger("ajaxSend",[q,m]);m.async&&0<m.timeout&&(l=setTimeout(function(){q.abort("timeout")},m.timeout));try{w=1,r.send(F,c)}catch(t){if(!(2>w))throw t;c(-1,t)}}else c(-1,"No Transport");return q},getJSON:function(a,b,c){return k.get(a,b,c,"json")},getScript:function(a,b){return k.get(a,d,b,"script")}});k.each(["get","post"],function(a,b){k[b]=function(a,c,e,f){return k.isFunction(c)&&(f=f||e,e=c,c=d),k.ajax({url:a,type:b,dataType:f,data:c,
...
k.support.cors){var c;return{send:function(e,f){var g,h,l=b.xhr();if(b.username?l.open(b.type,b.url,b.async,b.username,b.password):l.open(b.type,b.url,b.async),b.xhrFields)for(h in b.xhrFields)l[h]=b.xhrFields[h];b.mimeType&&l.overrideMimeType&&l.overrideMimeType(b.mimeType);b.crossDomain||e["X-Requested-With"]||(e["X-Requested-With"]="XMLHttpRequest");try{for(h in e)l.setRequestHeader(h,e[h])}catch(n){}l.send(b.hasContent&&b.data||null);c=function(a,e){var h,n,r,m;try{if(c&&(e||4===l.readyState))if(c=
d,g&&(l.onreadystatechange=k.noop,vb&&delete Pa[g]),e)4!==l.readyState&&l.abort();else{m={};h=l.status;n=l.getAllResponseHeaders();"string"==typeof l.responseText&&(m.text=l.responseText);try{r=l.statusText}catch(y){r=""}h||!b.isLocal||b.crossDomain?1223===h&&(h=204):h=m.text?200:404}}catch(E){e||f(-1,E)}m&&f(h,r,m,n)};b.async?4===l.readyState?setTimeout(c):(g=++gc,vb&&(Pa||(Pa={},k(a).unload(vb)),Pa[g]=c),l.onreadystatechange=c):c()},abort:function(){c&&c(d,!0)}}}});var Ka,jb,hc=/^(?:toggle|show|hide)$/,
Mb=RegExp("^(?:([+-])=|)("+wa+")([a-z%]*)$","i"),ic=/queueHooks$/,db=[function(a,b,c){var d,e,f,g,h,l=this,n={},m=a.style,y=a.nodeType&&C(a),E=k._data(a,"fxshow");c.queue||(g=k._queueHooks(a,"fx"),null==g.unqueued&&(g.unqueued=0,h=g.empty.fire,g.empty.fire=function(){g.unqueued||h()}),g.unqueued++,l.always(function(){l.always(function(){g.unqueued--;k.queue(a,"fx").length||g.empty.fire()})}));1===a.nodeType&&("height"in b||"width"in b)&&(c.overflow=[m.overflow,m.overflowX,m.overflowY],"inline"===
k.css(a,"display")&&"none"===k.css(a,"float")&&(k.support.inlineBlockNeedsLayout&&"inline"!==U(a.nodeName)?m.zoom=1:m.display="inline-block"));c.overflow&&(m.overflow="hidden",k.support.shrinkWrapBlocks||l.always(function(){m.overflow=c.overflow[0];m.overflowX=c.overflow[1];m.overflowY=c.overflow[2]}));for(d in b)(e=b[d],hc.exec(e))&&(delete b[d],f=f||"toggle"===e,e!==(y?"hide":"show"))&&(n[d]=E&&E[d]||k.style(a,d));if(!k.isEmptyObject(n))for(d in E?"hidden"in E&&(y=E.hidden):E=k._data(a,"fxshow",
{}),f&&(E.hidden=!y),y?k(a).show():l.done(function(){k(a).hide()}),l.done(function(){var b;k._removeData(a,"fxshow");for(b in n)k.style(a,b,n[b])}),n)b=r(y?E[d]:0,d,l),d in E||(E[d]=b.start,y&&(b.end=b.start,b.start="width"===d||"height"===d?1:0))}],Sa={"*":[function(a,b){var c=this.createTween(a,b),d=c.cur(),e=Mb.exec(b),f=e&&e[3]||(k.cssNumber[a]?"":"px"),g=(k.cssNumber[a]||"px"!==f&&+d)&&Mb.exec(k.css(c.elem,a)),h=1,l=20;if(g&&g[3]!==f){f=f||g[3];e=e||[];g=+d||1;do h=h||".5",g/=h,k.style(c.elem,
...
0)}):e};k.offset={setOffset:function(a,b,c){var d=k.css(a,"position");"static"===d&&(a.style.position="relative");var e=k(a),f=e.offset(),g=k.css(a,"top"),h=k.css(a,"left"),l={},n={},r,m;("absolute"===d||"fixed"===d)&&-1<k.inArray("auto",[g,h])?(n=e.position(),r=n.top,m=n.left):(r=parseFloat(g)||0,m=parseFloat(h)||0);k.isFunction(b)&&(b=b.call(a,c,f));null!=b.top&&(l.top=b.top-f.top+r);null!=b.left&&(l.left=b.left-f.left+m);"using"in b?b.using.call(a,l):e.css(l)}};k.fn.extend({position:function(){if(this[0]){var a,
...
q=c.toLowerCase(),t={innerWidth:a.fn.innerWidth,innerHeight:a.fn.innerHeight,outerWidth:a.fn.outerWidth,outerHeight:a.fn.outerHeight};a.fn["inner"+c]=function(b){return b===d?t["inner"+c].call(this):this.each(function(){a(this).css(q,e(this,b)+"px")})};a.fn["outer"+c]=function(b,d){return"number"!=typeof b?t["outer"+c].call(this,b):this.each(function(){a(this).css(q,e(this,b,!0,d)+"px")})}});a.fn.addBack||(a.fn.addBack=function(a){return this.add(null==a?this.prevObject:this.prevObject.filter(a))});
...
(function(a,d){var c=0,b=Array.prototype.slice,e=a.cleanData;a.cleanData=function(b){for(var c,d=0;null!=(c=b[d]);d++)try{a(c).triggerHandler("remove")}catch(l){}e(b)};a.widget=function(b,c,e){var l,n,q,t,s={},p=b.split(".")[0];b=b.split(".")[1];l=p+"-"+b;e||(e=c,c=a.Widget);a.expr[":"][l.toLowerCase()]=function(b){return!!a.data(b,l)};a[p]=a[p]||{};n=a[p][b];q=a[p][b]=function(a,b){return this._createWidget?(arguments.length&&this._createWidget(a,b),d):new q(a,b)};a.extend(q,n,{version:e.version,
_proto:a.extend({},e),_childConstructors:[]});t=new c;t.options=a.widget.extend({},t.options);a.each(e,function(b,e){return a.isFunction(e)?(s[b]=function(){var a=function(){return c.prototype[b].apply(this,arguments)},d=function(a){return c.prototype[b].apply(this,a)};return function(){var b,c=this._super,f=this._superApply;return this._super=a,this._superApply=d,b=e.apply(this,arguments),this._super=c,this._superApply=f,b}}(),d):(s[b]=e,d)});q.prototype=a.widget.extend(t,{widgetEventPrefix:n?t.widgetEventPrefix:
b},s,{constructor:q,namespace:p,widgetName:b,widgetFullName:l});n?(a.each(n._childConstructors,function(b,c){var d=c.prototype;a.widget(d.namespace+"."+d.widgetName,q,c._proto)}),delete n._childConstructors):c._childConstructors.push(q);a.widget.bridge(b,q)};a.widget.extend=function(c){for(var e,h,l=b.call(arguments,1),n=0,q=l.length;q>n;n++)for(e in l[n])h=l[n][e],l[n].hasOwnProperty(e)&&h!==d&&(c[e]=a.isPlainObject(h)?a.isPlainObject(c[e])?a.widget.extend({},c[e],h):a.widget.extend({},h):h);return c};
a.widget.bridge=function(c,e){var h=e.prototype.widgetFullName||c;a.fn[c]=function(l){var n="string"==typeof l,q=b.call(arguments,1),t=this;return l=!n&&q.length?a.widget.extend.apply(null,[l].concat(q)):l,n?this.each(function(){var b,e=a.data(this,h);return e?a.isFunction(e[l])&&"_"!==l.charAt(0)?(b=e[l].apply(e,q),b!==e&&b!==d?(t=b&&b.jquery?t.pushStack(b.get()):b,!1):d):a.error("no such method '"+l+"' for "+c+" widget instance"):a.error("cannot call methods on "+c+" prior to initialization; attempted to call method '"+
...
this.element.unbind(this.eventNamespace).removeData(this.widgetName).removeData(this.widgetFullName).removeData(a.camelCase(this.widgetFullName));this.widget().unbind(this.eventNamespace).removeAttr("aria-disabled").removeClass(this.widgetFullName+"-disabled ui-state-disabled");this.bindings.unbind(this.eventNamespace);this.hoverable.removeClass("ui-state-hover");this.focusable.removeClass("ui-state-focus")},_destroy:a.noop,widget:function(){return this.element},option:function(b,c){var e,l,n,q=b;
if(0===arguments.length)return a.widget.extend({},this.options);if("string"==typeof b)if(q={},e=b.split("."),b=e.shift(),e.length){l=q[b]=a.widget.extend({},this.options[b]);for(n=0;e.length-1>n;n++)l[e[n]]=l[e[n]]||{},l=l[e[n]];if(b=e.pop(),c===d)return l[b]===d?null:l[b];l[b]=c}else{if(c===d)return this.options[b]===d?null:this.options[b];q[b]=c}return this._setOptions(q),this},_setOptions:function(a){for(var b in a)this._setOption(b,a[b]);return this},_setOption:function(a,b){return this.options[a]=
...
function(d){if(!d||!d.of)return p.apply(this,arguments);d=a.extend({},d);var e,s,J,O,B,L,m=a(d.of),C=a.position.getWithinInfo(d.within),N=a.position.getScrollInfo(C),G=(d.collision||"flip").split(" "),x={};return L=b(m),m[0].preventDefault&&(d.at="left top"),s=L.width,J=L.height,O=L.offset,B=a.extend({},O),a.each(["my","at"],function(){var a,b,c=(d[this]||"").split(" ");1===c.length&&(c=l.test(c[0])?c.concat(["center"]):n.test(c[0])?["center"].concat(c):["center","center"]);c[0]=l.test(c[0])?c[0]:
"center";c[1]=n.test(c[1])?c[1]:"center";a=q.exec(c[0]);b=q.exec(c[1]);x[this]=[a?a[0]:0,b?b[0]:0];d[this]=[t.exec(c[0])[0],t.exec(c[1])[0]]}),1===G.length&&(G[1]=G[0]),"right"===d.at[0]?B.left+=s:"center"===d.at[0]&&(B.left+=s/2),"bottom"===d.at[1]?B.top+=J:"center"===d.at[1]&&(B.top+=J/2),e=c(x.at,s,J),B.left+=e[0],B.top+=e[1],this.each(function(){var b,l,n=a(this),p=n.outerWidth(),q=n.outerHeight(),t=parseInt(a.css(this,"marginLeft"),10)||0,L=parseInt(a.css(this,"marginTop"),10)||0,W=p+t+(parseInt(a.css(this,
"marginRight"),10)||0)+N.width,X=q+L+(parseInt(a.css(this,"marginBottom"),10)||0)+N.height,r=a.extend({},B),F=c(x.my,n.outerWidth(),n.outerHeight());"right"===d.my[0]?r.left-=p:"center"===d.my[0]&&(r.left-=p/2);"bottom"===d.my[1]?r.top-=q:"center"===d.my[1]&&(r.top-=q/2);r.left+=F[0];r.top+=F[1];a.support.offsetFractions||(r.left=h(r.left),r.top=h(r.top));b={marginLeft:t,marginTop:L};a.each(["left","top"],function(c,f){a.ui.position[G[c]]&&a.ui.position[G[c]][f](r,{targetWidth:s,targetHeight:J,elemWidth:p,
elemHeight:q,collisionPosition:b,collisionWidth:W,collisionHeight:X,offset:[e[0]+F[0],e[1]+F[1]],my:d.my,at:d.at,within:C,elem:n})});d.using&&(l=function(a){var b=O.left-r.left,c=b+s-p,e=O.top-r.top,h=e+J-q,l={target:{element:m,left:O.left,top:O.top,width:s,height:J},element:{element:n,left:r.left,top:r.top,width:p,height:q},horizontal:0>c?"left":0<b?"right":"center",vertical:0>h?"top":0<e?"bottom":"middle"};p>s&&s>g(b+c)&&(l.horizontal="center");q>J&&J>g(e+h)&&(l.vertical="middle");l.important=f(g(b),
g(c))>f(g(e),g(h))?"horizontal":"vertical";d.using.call(this,a,l)});n.offset(a.extend(r,{using:l}))})};a.ui.position={fit:{left:function(a,b){var c,d=b.within,e=d.isWindow?d.scrollLeft:d.offset.left,d=d.width,g=a.left-b.collisionPosition.marginLeft,h=e-g,l=g+b.collisionWidth-d-e;b.collisionWidth>d?0<h&&0>=l?(c=a.left+h+b.collisionWidth-d-e,a.left+=h-c):a.left=0<l&&0>=h?e:h>l?e+d-b.collisionWidth:e:0<h?a.left+=h:0<l?a.left-=l:a.left=f(a.left-g,a.left)},top:function(a,b){var c,d=b.within,d=d.isWindow?
...
"right"===b.my[0]?b.elemWidth:0,q="left"===b.at[0]?b.targetWidth:"right"===b.at[0]?-b.targetWidth:0,t=-2*b.offset[0];0>n?(c=a.left+p+q+t+b.collisionWidth-h-f,(0>c||g(n)>c)&&(a.left+=p+q+t)):0<l&&(d=a.left-b.collisionPosition.marginLeft+p+q+t-e,(0<d||l>g(d))&&(a.left+=p+q+t))},top:function(a,b){var c,d,e=b.within,f=e.offset.top+e.scrollTop,h=e.height,e=e.isWindow?e.scrollTop:e.offset.top,l=a.top-b.collisionPosition.marginTop,n=l-e,l=l+b.collisionHeight-h-e,p="top"===b.my[1]?-b.elemHeight:"bottom"===
b.my[1]?b.elemHeight:0,q="top"===b.at[1]?b.targetHeight:"bottom"===b.at[1]?-b.targetHeight:0,t=-2*b.offset[1];0>n?(d=a.top+p+q+t+b.collisionHeight-h-f,a.top+p+q+t>n&&(0>d||g(n)>d)&&(a.top+=p+q+t)):0<l&&(c=a.top-b.collisionPosition.marginTop+p+q+t-e,a.top+p+q+t>l&&(0<c||l>g(c))&&(a.top+=p+q+t))}},flipfit:{left:function(){a.ui.position.flip.left.apply(this,arguments);a.ui.position.fit.left.apply(this,arguments)},top:function(){a.ui.position.flip.top.apply(this,arguments);a.ui.position.fit.top.apply(this,
...
top:c.top,left:c.left})})},drag:function(d,c){var b,e,f,g,h,l,n,q,t,s,p=a(this).data("ui-draggable"),w=p.options,v=w.snapTolerance,D=c.offset.left,J=D+p.helperProportions.width,O=c.offset.top,B=O+p.helperProportions.height;for(t=p.snapElements.length-1;0<=t;t--)h=p.snapElements[t].left,l=h+p.snapElements[t].width,n=p.snapElements[t].top,q=n+p.snapElements[t].height,h-v>J||D>l+v||n-v>B||O>q+v||!a.contains(p.snapElements[t].item.ownerDocument,p.snapElements[t].item)?(p.snapElements[t].snapping&&p.options.snap.release&&
p.options.snap.release.call(p.element,d,a.extend(p._uiHash(),{snapItem:p.snapElements[t].item})),p.snapElements[t].snapping=!1):("inner"!==w.snapMode&&(b=v>=Math.abs(n-B),e=v>=Math.abs(q-O),f=v>=Math.abs(h-J),g=v>=Math.abs(l-D),b&&(c.position.top=p._convertPositionTo("relative",{top:n-p.helperProportions.height,left:0}).top-p.margins.top),e&&(c.position.top=p._convertPositionTo("relative",{top:q,left:0}).top-p.margins.top),f&&(c.position.left=p._convertPositionTo("relative",{top:0,left:h-p.helperProportions.width}).left-
p.margins.left),g&&(c.position.left=p._convertPositionTo("relative",{top:0,left:l}).left-p.margins.left)),s=b||e||f||g,"outer"!==w.snapMode&&(b=v>=Math.abs(n-O),e=v>=Math.abs(q-B),f=v>=Math.abs(h-D),g=v>=Math.abs(l-J),b&&(c.position.top=p._convertPositionTo("relative",{top:n,left:0}).top-p.margins.top),e&&(c.position.top=p._convertPositionTo("relative",{top:q-p.helperProportions.height,left:0}).top-p.margins.top),f&&(c.position.left=p._convertPositionTo("relative",{top:0,left:h}).left-p.margins.left),
...
this._vBoundaries,f=this.axis,g=c(a.width)&&d.maxWidth&&d.maxWidth<a.width,h=c(a.height)&&d.maxHeight&&d.maxHeight<a.height,l=c(a.width)&&d.minWidth&&d.minWidth>a.width,n=c(a.height)&&d.minHeight&&d.minHeight>a.height,q=this.originalPosition.left+this.originalSize.width,t=this.position.top+this.size.height,s=/sw|nw|w/.test(f),f=/nw|ne|n/.test(f);return l&&(a.width=d.minWidth),n&&(a.height=d.minHeight),g&&(a.width=d.maxWidth),h&&(a.height=d.maxHeight),l&&s&&(a.left=q-d.minWidth),g&&s&&(a.left=q-d.maxWidth),
...
10)};g&&g.length&&a(g[0]).css({width:d.width,height:d.height});c._updateCache(d);c._propagate("resize",b)}})}});a.ui.plugin.add("resizable","containment",{start:function(){var b,c,f,g,h,l,n,q=a(this).data("ui-resizable"),t=q.element,s=q.options.containment;(t=s instanceof a?s.get(0):/parent/.test(s)?t.parent().get(0):s)&&(q.containerElement=a(t),/document/.test(s)||s===document?(q.containerOffset={left:0,top:0},q.containerPosition={left:0,top:0},q.parentData={element:a(document),left:0,top:0,width:a(document).width(),
height:a(document).height()||document.body.parentNode.scrollHeight}):(b=a(t),c=[],a(["Top","Right","Left","Bottom"]).each(function(a,f){c[a]=d(b.css("padding"+f))}),q.containerOffset=b.offset(),q.containerPosition=b.position(),q.containerSize={height:b.innerHeight()-c[3],width:b.innerWidth()-c[1]},f=q.containerOffset,g=q.containerSize.height,h=q.containerSize.width,l=a.ui.hasScroll(t,"left")?t.scrollWidth:h,n=a.ui.hasScroll(t)?t.scrollHeight:g,q.parentData={element:t,left:f.left,top:f.top,width:l,
...
(l.size.width=l.parentData.width-c,b&&(l.size.height=l.size.width/l.aspectRatio));d+l.size.height>=l.parentData.height&&(l.size.height=l.parentData.height-d,b&&(l.size.width=l.size.height*l.aspectRatio))},stop:function(){var b=a(this).data("ui-resizable"),c=b.options,d=b.containerOffset,g=b.containerPosition,h=b.containerElement,l=a(b.helper),n=l.offset(),q=l.outerWidth()-b.sizeDiff.width,l=l.outerHeight()-b.sizeDiff.height;b._helper&&!c.animate&&/relative/.test(h.css("position"))&&a(this).css({left:n.left-
g.left-d.left,width:q,height:l});b._helper&&!c.animate&&/static/.test(h.css("position"))&&a(this).css({left:n.left-g.left-d.left,width:q,height:l})}});a.ui.plugin.add("resizable","alsoResize",{start:function(){var b=a(this).data("ui-resizable").options,c=function(b){a(b).each(function(){var b=a(this);b.data("ui-resizable-alsoresize",{width:parseInt(b.width(),10),height:parseInt(b.height(),10),left:parseInt(b.css("left"),10),top:parseInt(b.css("top"),10)})})};"object"!=typeof b.alsoResize||b.alsoResize.parentNode?
c(b.alsoResize):b.alsoResize.length?(b.alsoResize=b.alsoResize[0],c(b.alsoResize)):a.each(b.alsoResize,function(a){c(a)})},resize:function(b,c){var d=a(this).data("ui-resizable"),g=d.options,h=d.originalSize,l=d.originalPosition,n={height:d.size.height-h.height||0,width:d.size.width-h.width||0,top:d.position.top-l.top||0,left:d.position.left-l.left||0},q=function(b,d){a(b).each(function(){var b=a(this),f=a(this).data("ui-resizable-alsoresize"),g={},h=d&&d.length?d:b.parents(c.originalElement[0]).length?
...
c=b.options,d=b.size,g=b.originalSize,h=b.originalPosition,l=b.axis,n="number"==typeof c.grid?[c.grid,c.grid]:c.grid,q=n[0]||1,t=n[1]||1,s=Math.round((d.width-g.width)/q)*q,d=Math.round((d.height-g.height)/t)*t,p=g.width+s,g=g.height+d,w=c.maxWidth&&p>c.maxWidth,v=c.maxHeight&&g>c.maxHeight,D=c.minWidth&&c.minWidth>p,J=c.minHeight&&c.minHeight>g;c.grid=n;D&&(p+=q);J&&(g+=t);w&&(p-=q);v&&(g-=t);/^(se|s|e)$/.test(l)?(b.size.width=p,b.size.height=g):/^(ne)$/.test(l)?(b.size.width=p,b.size.height=g,b.position.top=
...
!1):void 0}))},_mouseDrag:function(d){if(this.dragged=!0,!this.options.disabled){var c,b=this,e=this.options,f=this.opos[0],g=this.opos[1],h=d.pageX,l=d.pageY;return f>h&&(c=h,h=f,f=c),g>l&&(c=l,l=g,g=c),this.helper.css({left:f,top:g,width:h-f,height:l-g}),this.selectees.each(function(){var c=a.data(this,"selectable-item"),q=!1;c&&c.element!==b.element[0]&&("touch"===e.tolerance?q=!(c.left>h||f>c.right||c.top>l||g>c.bottom):"fit"===e.tolerance&&(q=c.left>f&&h>c.right&&c.top>g&&l>c.bottom),q?(c.selected&&
...
g=f+this.helperProportions.height,h=a.left,l=h+a.width,n=a.top,q=n+a.height,t=this.offset.click.top,s=this.offset.click.left,s="y"===this.options.axis||b+s>h&&l>b+s,t=("x"===this.options.axis||f+t>n&&q>f+t)&&s;return"pointer"===this.options.tolerance||this.options.forcePointerForContainers||"pointer"!==this.options.tolerance&&this.helperProportions[this.floating?"width":"height"]>a[this.floating?"width":"height"]?t:b+this.helperProportions.width/2>h&&l>d-this.helperProportions.width/2&&f+this.helperProportions.height/
2>n&&q>g-this.helperProportions.height/2},_intersectsWithPointer:function(a){var b="y"===this.options.axis||this.positionAbs.left+this.offset.click.left>a.left&&a.left+a.width>this.positionAbs.left+this.offset.click.left;a=("x"===this.options.axis||this.positionAbs.top+this.offset.click.top>a.top&&a.top+a.height>this.positionAbs.top+this.offset.click.top)&&b;var b=this._getDragVerticalDirection(),d=this._getDragHorizontalDirection();return a?this.floating?d&&"right"===d||"down"===b?2:1:b&&("down"===
...
f=null;g=(t=e.floating||d(this.currentItem))?"left":"top";h=t?"width":"height";l=this.positionAbs[g]+this.offset.click[g];for(e=this.items.length-1;0<=e;e--)a.contains(this.containers[s].element[0],this.items[e].item[0])&&this.items[e].item[0]!==this.currentItem[0]&&(!t||this.positionAbs.top+this.offset.click.top>this.items[e].top&&this.items[e].top+this.items[e].height>this.positionAbs.top+this.offset.click.top)&&(n=this.items[e].item.offset()[g],q=!1,Math.abs(n-l)>Math.abs(n+this.items[e][h]-l)&&
(q=!0,n+=this.items[e][h]),b>Math.abs(n-l)&&(b=Math.abs(n-l),f=this.items[e],this.direction=q?"up":"down"));(f||this.options.dropOnEmpty)&&this.currentContainer!==this.containers[s]&&(f?this._rearrange(c,f,null,!0):this._rearrange(c,null,this.containers[s].element,!0),this._trigger("change",c,this._uiHash()),this.containers[s]._trigger("change",c,this._uiHash(this)),this.currentContainer=this.containers[s],this.options.placeholder.update(this.currentContainer,this.placeholder),this.containers[s]._trigger("over",
...
T.addClass(K.className);z()}function m(b){if(E&&(b=tinycolor(b).toRgbString(),-1===d.inArray(b,ba)&&ba.push(b),aa&&a.localStorage))try{a.localStorage[aa]=ba.join(";")}catch(c){}}function s(){var a=[],b=ba,c={},d;if(K.showPalette){for(var e=0;e<wa.length;e++)for(var f=0;f<wa[e].length;f++)d=tinycolor(wa[e][f]).toRgbString(),c[d]=!0;for(e=0;e<b.length;e++)d=tinycolor(b[e]).toRgbString(),c.hasOwnProperty(d)||(a.push(b[e]),c[d]=!0)}return a.reverse().slice(0,K.maxSelectionSize)}function N(){var a=M(),
c=d.map(wa,function(c,d){return b(c,a,"sp-palette-row sp-palette-row-"+d)});ba&&c.push(b(s(),a,"sp-palette-row sp-palette-row-selection"));bb.html(c.join(""))}function G(){if(K.showInitial){var a=fa,c=M();xa.html(b([a,c],c,"sp-palette-row-initial"))}}function x(){0!==oa&&0!==ja&&0!==ka||z();T.addClass(Ta)}function S(){T.removeClass(Ta)}function U(){var a=tinycolor(ga.val());a.ok?ca(a):ga.addClass("sp-validation-error")}function V(){ma?P():Z()}function Z(){if(ma)z();else if(!1!==da.beforeShow(M())){for(var b=
0;b<p.length;b++)p[b]&&p[b].hide();ma=!0;d(La).bind("click.spectrum",P);d(a).bind("resize.spectrum",I);Aa.addClass("sp-active");T.show();K.showPalette&&N();z();X();fa=M();G();da.show(fa)}}function P(b){b&&"click"==b.type&&2==b.button||(!ma||u)||(ma=!1,d(La).unbind("click.spectrum",P),d(a).unbind("resize.spectrum",I),Aa.removeClass("sp-active"),T.hide(),tinycolor.equals(M(),fa)||(hb&&"cancel"!==b?F(!0):ca(fa,!0)),da.hide(M()))}function ca(a,b){if(!tinycolor.equals(a,M())){var c=tinycolor(a),d=c.toHsv();
Y=d.h;la=d.s;pa=d.v;qa=d.a;X();b||(Oa=$a||c.format)}}function M(){return tinycolor.fromRatio({h:Y,s:la,v:pa,a:Math.round(100*qa)/100})}function W(){X();da.move(M())}function X(){ga.removeClass("sp-validation-error");r();var a=tinycolor({h:Y,s:"1.0",v:"1.0"});Ma.css("background-color",a.toHexString());a=Oa;1>qa&&("hex"===a||"name"===a)&&(a="rgb");var b=M(),c=b.toHexString(),d=b.toRgbString();v||1===b.alpha?ta.css("background-color",d):(ta.css("background-color","transparent"),ta.css("filter",b.toFilter()));
if(K.showAlpha){d=b.toRgb();d.a=0;var d=tinycolor(d).toRgbString(),e="linear-gradient(left, "+d+", "+c+")";w?ia.css("filter",tinycolor(d).toFilter({gradientType:1},c)):(ia.css("background","-webkit-"+e),ia.css("background","-moz-"+e),ia.css("background","-ms-"+e),ia.css("background",e))}K.showInput&&(1>qa&&("hex"===a||"name"===a)&&(a="rgb"),ga.val(b.toString(a)));K.showPalette&&N();G()}function r(){var a=la*ja,b=oa-pa*oa,a=Math.max(-ha,Math.min(ja-ha,a-ha)),b=Math.max(-ha,Math.min(oa-ha,b-ha));fb.css({top:b,
left:a});Qa.css({left:qa*va-ea/2});gb.css({top:Y*ka-y})}function F(a){var b=M();Ya&&ra.val(b.toString(Oa)).change();var c=!tinycolor.equals(b,fa);fa=b;m(b);a&&c&&da.change(b)}function z(){ja=Ma.width();oa=Ma.height();ha=fb.height();Va.width();ka=Va.height();y=gb.height();va=Wa.width();ea=Qa.width();u||T.offset(g(T,ya));r()}function H(){P();Ua=!0;ra.attr("disabled",!0);ya.addClass("sp-disabled")}var K=e(h,f),u=K.flat,E=K.showSelectionPalette,aa=K.localStorageKey,R=K.theme,da=K.callbacks,I=t(z,10),
ma=!1,ja=0,oa=0,ha=0,ka=0,va=0,ea=0,y=0,Y=0,la=0,pa=0,qa=1,k=K.palette.slice(0),wa=d.isArray(k[0])?k:[k],ba=K.selectionPalette.slice(0),Ta="sp-dragging",La=f.ownerDocument,eb=La.body,ra=d(f),Ua=!1,T=d(J,La).addClass(R),Ma=T.find(".sp-color"),fb=T.find(".sp-dragger"),Va=T.find(".sp-hue"),gb=T.find(".sp-slider"),ia=T.find(".sp-alpha-inner"),Wa=T.find(".sp-alpha"),Qa=T.find(".sp-alpha-handle"),ga=T.find(".sp-input"),bb=T.find(".sp-palette"),xa=T.find(".sp-initial"),Xa=T.find(".sp-cancel"),Na=T.find(".sp-choose"),
...
P("cancel")});Na.text(K.chooseText);Na.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();ga.hasClass("sp-validation-error")||(F(!0),P())});q(Wa,function(a,b,c){qa=a/va;c.shiftKey&&(qa=Math.round(10*qa)/10);W()});q(Va,function(a,b){Y=parseFloat(b/ka);W()},x,S);q(Ma,function(a,b){la=parseFloat(a/ja);pa=parseFloat((oa-b)/oa);W()},x,S);za?(ca(za),X(),Oa=$a||tinycolor(za).format,m(za)):X();u&&Z();c=w?"mousedown.spectrum":"click.spectrum touchstart.spectrum";bb.delegate(".sp-thumb-el",
c,b);xa.delegate(".sp-thumb-el:nth-child(1)",c,{ignore:!0},b)})();var Ga={show:Z,hide:P,toggle:V,reflow:z,option:function(a,b){if(a===c)return d.extend({},K);if(b===c)return K[a];K[a]=b;n()},enable:function(){Ua=!1;ra.attr("disabled",!1);ya.removeClass("sp-disabled")},disable:H,set:function(a){ca(a);F()},get:M,destroy:function(){ra.show();ya.unbind("click.spectrum touchstart.spectrum");T.remove();Aa.remove();p[Ga.id]=null},container:T};Ga.id=p.push(Ga)-1;return Ga}function g(a,b){var c=a.outerWidth(),
e=a.outerHeight(),f=b.outerHeight(),g=a[0].ownerDocument,h=g.documentElement,l=h.clientWidth+d(g).scrollLeft(),g=h.clientHeight+d(g).scrollTop(),h=b.offset();h.top+=f;h.left-=Math.min(h.left,h.left+c>l&&l>c?Math.abs(h.left+c-l):0);h.top-=Math.min(h.top,h.top+e>g&&g>e?Math.abs(e+f-0):0);return h}function h(){}function l(a){a.stopPropagation()}function n(a,b){var c=Array.prototype.slice,d=c.call(arguments,2);return function(){return a.apply(b,d.concat(c.call(arguments)))}}function q(b,c,e,f){function g(a){a.stopPropagation&&
a.stopPropagation();a.preventDefault&&a.preventDefault();a.returnValue=!1}function h(a){if(p){if(w&&9>document.documentMode&&!a.button)return l();var d=a.originalEvent.touches,e=d?d[0].pageY:a.pageY,d=Math.max(0,Math.min((d?d[0].pageX:a.pageX)-q.left,s)),e=Math.max(0,Math.min(e-q.top,t));D&&g(a);c.apply(b,[d,e,a])}}function l(){p&&(d(n).unbind(v),d(n.body).removeClass("sp-dragging"),f.apply(b,arguments));p=!1}c=c||function(){};e=e||function(){};f=f||function(){};var n=b.ownerDocument||document,p=
!1,q={},t=0,s=0,D="ontouchstart"in a,v={};v.selectstart=g;v.dragstart=g;v[D?"touchmove":"mousemove"]=h;v[D?"touchend":"mouseup"]=l;d(b).bind(D?"touchstart":"mousedown",function(a){(a.which?3==a.which:2==a.button)||p||!1===e.apply(b,arguments)||(p=!0,t=d(b).height(),s=d(b).width(),q=d(b).offset(),d(n).bind(v),d(n.body).addClass("sp-dragging"),D||h(a),g(a))})}function t(a,b,c){var d;return function(){var e=this,f=arguments,g=function(){d=null;a.apply(e,f)};c&&clearTimeout(d);if(c||!d)d=setTimeout(g,
...
t?"rgb("+s(n)+", "+s(p)+", "+s(F)+")":"rgba("+s(n)+", "+s(p)+", "+s(F)+", "+t+")"},toName:function(){return z[g(n,p,F)]||!1},toFilter:function(a,c){var d=g(n,p,F,!0),e=d,f=Math.round(255*r(t)).toString(16),h=f,m=a&&a.gradientType?"GradientType = 1, ":"";c&&(h=b(c),e=h.toHex(),h=Math.round(255*r(h.alpha)).toString(16));return"progid:DXImageTransform.Microsoft.gradient("+m+"startColorstr=#"+l(f)+d+",endColorstr=#"+l(h)+e+")"},toString:function(a){a=a||this.format;var b=!1;"rgb"===a&&(b=this.toRgbString());
"hex"===a&&(b=this.toHexString());"hex6"===a&&(b=this.toHexString(!0));"name"===a&&(b=this.toName());"hsl"===a&&(b=this.toHslString());"hsv"===a&&(b=this.toHsvString());return b||this.toHexString(!0)}}}function c(a){var b={r:0,g:0,b:0},d=1,f=!1,g=!1;if("string"==typeof a)a:{a=a.replace(n,"").replace(p,"").toLowerCase();var l=!1;if(F[a])a=F[a],l=!0;else if("transparent"==a){a={r:0,g:0,b:0,a:0};break a}var r;a=(r=H.rgb.exec(a))?{r:r[1],g:r[2],b:r[3]}:(r=H.rgba.exec(a))?{r:r[1],g:r[2],b:r[3],a:r[4]}:
(r=H.hsl.exec(a))?{h:r[1],s:r[2],l:r[3]}:(r=H.hsla.exec(a))?{h:r[1],s:r[2],l:r[3],a:r[4]}:(r=H.hsv.exec(a))?{h:r[1],s:r[2],v:r[3]}:(r=H.hex6.exec(a))?{r:parseInt(r[1],16),g:parseInt(r[2],16),b:parseInt(r[3],16),format:l?"name":"hex"}:(r=H.hex3.exec(a))?{r:parseInt(r[1]+""+r[1],16),g:parseInt(r[2]+""+r[2],16),b:parseInt(r[3]+""+r[3],16),format:l?"name":"hex"}:!1}if("object"==typeof a){if(a.hasOwnProperty("r")&&a.hasOwnProperty("g")&&a.hasOwnProperty("b"))b={r:255*h(a.r,255),g:255*h(a.g,255),b:255*
h(a.b,255)},f=!0,g="rgb";else if(a.hasOwnProperty("h")&&a.hasOwnProperty("s")&&a.hasOwnProperty("v")){var g=a.h,l=a.s,b=a.v,g=6*h(g,360),l=h(l,100),b=h(b,100),f=t.floor(g),m=g-f,g=b*(1-l);r=b*(1-m*l);l=b*(1-(1-m)*l);f%=6;b={r:255*[b,r,g,g,l,b][f],g:255*[l,b,b,r,g,g][f],b:255*[g,g,l,b,b,r][f]};f=!0;g="hsv"}else a.hasOwnProperty("h")&&(a.hasOwnProperty("s")&&a.hasOwnProperty("l"))&&(b=e(a.h,a.s,a.l),f=!0,g="hsl");a.hasOwnProperty("a")&&(d=a.a)}b.r=D(255,w(b.r,0));b.g=D(255,w(b.g,0));b.b=D(255,w(b.b,
0));1>b.r&&(b.r=s(b.r));1>b.g&&(b.g=s(b.g));1>b.b&&(b.b=s(b.b));return{ok:f,format:a&&a.format||g,r:b.r,g:b.g,b:b.b,a:d}}function d(a,b,c){a=h(a,255);b=h(b,255);c=h(c,255);var e=w(a,b,c),f=D(a,b,c),g,l=(e+f)/2;if(e==f)g=f=0;else{var r=e-f,f=0.5<l?r/(2-e-f):r/(e+f);switch(e){case a:g=(b-c)/r+(b<c?6:0);break;case b:g=(c-a)/r+2;break;case c:g=(a-b)/r+4}g/=6}return{h:g,s:f,l:l}}function e(a,b,c){function d(a,b,c){0>c&&(c+=1);1<c&&(c-=1);return c<1/6?a+6*(b-a)*c:0.5>c?b:c<2/3?a+6*(b-a)*(2/3-c):a}a=h(a,
...
a[1].charAt(0)!=a[1].charAt(1)||a[2].charAt(0)!=a[2].charAt(1)?a.join(""):a[0].charAt(0)+a[1].charAt(0)+a[2].charAt(0)}function h(a,b){"string"==typeof a&&(-1!=a.indexOf(".")&&1===r(a))&&(a="100%");var c="string"===typeof a&&-1!=a.indexOf("%");a=D(b,w(0,r(a)));c&&(a*=b/100);return 1E-6>t.abs(a-b)?1:1<=a?a%b/r(b):a}function l(a){return 1==a.length?"0"+a:""+a}var n=/^[\s,#]+/,p=/\s+$/,q=0,t=Math,s=t.round,D=t.min,w=t.max,v=t.random,r=a.parseFloat;b.fromRatio=function(a){if("object"==typeof a)for(var c in a)1===
...
springgreen:"00ff7f",steelblue:"4682b4",tan:"d2b48c",teal:"008080",thistle:"d8bfd8",tomato:"ff6347",turquoise:"40e0d0",violet:"ee82ee",wheat:"f5deb3",white:"fff",whitesmoke:"f5f5f5",yellow:"ff0",yellowgreen:"9acd32"},z=b.hexNames=function(a){var b={},c;for(c in a)a.hasOwnProperty(c)&&(b[a[c]]=c);return b}(F),H={rgb:RegExp("rgb[\\s|\\(]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))\\s*\\)?"),rgba:RegExp("rgba[\\s|\\(]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))\\s*\\)?"),
...
return c};var w,v;n.exec=n;var D,J;q.options=q.setOptions=function(a){J=a;t(a);return q};q.setOptions({gfm:!0,pedantic:!1,sanitize:!1,highlight:null});q.parser=function(a,b){t(b);return e(a)};q.lexer=function(a,b){t(b);return s.lexer(a)};q.parse=q;"undefined"!==typeof module?module.exports=q:this.marked=q}).call(function(){return this||("undefined"!==typeof window?window:global)}());
...
":"+e.port,e.resource,c.protocol,c.util.query(this.options.query,"t="+ +new Date)].join("/");if(this.isXDomain()&&!c.util.ua.hasCORS){var q=document.getElementsByTagName("script")[0],t=document.createElement("script");t.src=e+"&jsonp="+c.j.length;q.parentNode.insertBefore(t,q);c.j.push(function(a){b(a);t.parentNode.removeChild(t)})}else{var s=c.util.request();s.open("GET",e,!0);this.isXDomain()&&(s.withCredentials=!0);s.onreadystatechange=function(){if(4==s.readyState)if(s.onreadystatechange=f,200==
...
b)});return this};b.prototype.send=function(){var a=this,b=arguments;WebSocket.__addTask(function(){c.Transport.websocket.prototype.send.apply(a,b)});return this};b.prototype.close=function(){WebSocket.__tasks.length=0;c.Transport.websocket.prototype.close.call(this);return this};b.prototype.ready=function(a,d){function g(){var c=a.options,g=c["flash policy port"],q=["http"+(c.secure?"s":"")+":/",c.host+":"+c.port,c.resource,"static/flashsocket","WebSocketMain"+(a.isXDomain()?"Insecure":"")+".swf"];
b.loaded||("undefined"===typeof WEB_SOCKET_SWF_LOCATION&&(WEB_SOCKET_SWF_LOCATION=q.join("/")),843!==g&&WebSocket.loadFlashPolicyFile("xmlsocket://"+c.host+":"+g),WebSocket.__initialize(),b.loaded=!0);d.call(h)}var h=this;if(document.body)return g();c.util.load(g)};b.check=function(){return"undefined"!=typeof WebSocket&&"__initialize"in WebSocket&&a?10<=a.getFlashPlayerVersion().major:!1};b.xdomainCheck=function(){return!0};"undefined"!=typeof window&&(WEB_SOCKET_DISABLE_AUTO_INITIALIZATION=!0);c.transports.push("flashsocket")})("undefined"!=
typeof io?io.Transport:module.exports,"undefined"!=typeof io?io:module.parent.exports);if("undefined"!=typeof window)var a=function(){function d(){if(!r){try{var a=G.getElementsByTagName("body")[0].appendChild(G.createElement("span"));a.parentNode.removeChild(a)}catch(b){return}r=!0;for(var a=U.length,c=0;c<a;c++)U[c]()}}function c(a){r?a():U[U.length]=a}function b(a){if(typeof N.addEventListener!=B)N.addEventListener("load",a,!1);else if(typeof G.addEventListener!=B)G.addEventListener("load",a,!1);
...
10)}()):b.parentNode.removeChild(b))}function p(a){var b=null;try{b=G.getElementById(a)}catch(c){}return b}function w(a,b,c){a.attachEvent(b,c);P[P.length]=[a,b,c]}function v(a){var b=u.pv;a=a.split(".");a[0]=parseInt(a[0],10);a[1]=parseInt(a[1],10)||0;a[2]=parseInt(a[2],10)||0;return b[0]>a[0]||b[0]==a[0]&&b[1]>a[1]||b[0]==a[0]&&b[1]==a[1]&&b[2]>=a[2]?!0:!1}function D(a,b,c,d){if(!u.ie||!u.mac){var e=G.getElementsByTagName("head")[0];e&&(c=c&&"string"==typeof c?c:"screen",d&&(H=z=null),z&&H==c||
(d=G.createElement("style"),d.setAttribute("type","text/css"),d.setAttribute("media",c),z=e.appendChild(d),u.ie&&(u.win&&typeof G.styleSheets!=B&&0<G.styleSheets.length)&&(z=G.styleSheets[G.styleSheets.length-1]),H=c),u.ie&&u.win?z&&typeof z.addRule==L&&z.addRule(a,b):z&&typeof G.createTextNode!=B&&z.appendChild(G.createTextNode(a+" {"+b+"}")))}}function J(a,b){if(K){var c=b?"visible":"hidden";r&&p(a)?p(a).style.visibility=c:D("#"+a,"visibility:"+c)}}function O(a){return null!=/[\\\"<>\.;]/.exec(a)&&
typeof encodeURIComponent!=B?encodeURIComponent(a):a}var B="undefined",L="object",m="application/x-shockwave-flash",C="SWFObjectExprInst",N=window,G=document,x=navigator,S=!1,U=[function(){S?e():f()}],V=[],Z=[],P=[],ca,M,W,X,r=!1,F=!1,z,H,K=!0,u=function(){var a=typeof G.getElementById!=B&&typeof G.getElementsByTagName!=B&&typeof G.createElement!=B,b=x.userAgent.toLowerCase(),c=x.platform.toLowerCase(),d=c?/win/.test(c):/win/.test(b),c=c?/mac/.test(c):/mac/.test(b),b=/webkit/.test(b)?parseFloat(b.replace(/^.*webkit\/(\d+(\.\d+)?).*$/,
"$1")):!1,e=!+"\v1",f=[0,0,0],g=null;if(typeof x.plugins!=B&&typeof x.plugins["Shockwave Flash"]==L)!(g=x.plugins["Shockwave Flash"].description)||typeof x.mimeTypes!=B&&x.mimeTypes[m]&&!x.mimeTypes[m].enabledPlugin||(S=!0,e=!1,g=g.replace(/^.*\s+(\S+\s+\S+$)/,"$1"),f[0]=parseInt(g.replace(/^(.*)\..*$/,"$1"),10),f[1]=parseInt(g.replace(/^.*\.(.*)\s.*$/,"$1"),10),f[2]=/[a-zA-Z]/.test(g)?parseInt(g.replace(/^.*[a-zA-Z]+(.*)$/,"$1"),10):0);else if(typeof N[["Active"].concat("Object").join("X")]!=B)try{var h=
new (window[["Active"].concat("Object").join("X")])("ShockwaveFlash.ShockwaveFlash");h&&(g=h.GetVariable("$version"))&&(e=!0,g=g.split(" ")[1].split(","),f=[parseInt(g[0],10),parseInt(g[1],10),parseInt(g[2],10)])}catch(l){}return{w3:a,pv:f,wk:b,ie:e,win:d,mac:c}}();(function(){u.w3&&((typeof G.readyState!=B&&"complete"==G.readyState||typeof G.readyState==B&&(G.getElementsByTagName("body")[0]||G.body))&&d(),r||(typeof G.addEventListener!=B&&G.addEventListener("DOMContentLoaded",d,!1),u.ie&&u.win&&
(G.attachEvent("onreadystatechange",function(){"complete"==G.readyState&&(G.detachEvent("onreadystatechange",arguments.callee),d())}),N==top&&function(){if(!r){try{G.documentElement.doScroll("left")}catch(a){setTimeout(arguments.callee,0);return}d()}}()),u.wk&&function(){r||(/loaded|complete/.test(G.readyState)?d():setTimeout(arguments.callee,0))}(),b(d)))})();(function(){u.ie&&u.win&&window.attachEvent("onunload",function(){for(var b=P.length,c=0;c<b;c++)P[c][0].detachEvent(P[c][1],P[c][2]);b=Z.length;
for(c=0;c<b;c++)s(Z[c]);for(var d in u)u[d]=null;u=null;for(var e in a)a[e]=null;a=null})})();return{registerObject:function(a,b,c,d){if(u.w3&&a&&b){var e={};e.id=a;e.swfVersion=b;e.expressInstall=c;e.callbackFn=d;V[V.length]=e;J(a,!1)}else d&&d({success:!1,id:a})},getObjectById:function(a){if(u.w3)return g(a)},embedSWF:function(a,b,d,e,f,g,n,m,q,p){var r={success:!1,id:b};u.w3&&!(u.wk&&312>u.wk)&&a&&b&&d&&e&&f?(J(b,!1),c(function(){d+="";e+="";var c={};if(q&&typeof q===L)for(var y in q)c[y]=q[y];
c.data=a;c.width=d;c.height=e;y={};if(m&&typeof m===L)for(var Y in m)y[Y]=m[Y];if(n&&typeof n===L)for(var s in n)y.flashvars=typeof y.flashvars!=B?y.flashvars+("&"+s+"="+n[s]):s+"="+n[s];if(v(f))Y=t(c,y,b),c.id==b&&J(b,!0),r.success=!0,r.ref=Y;else{if(g&&h()){c.data=g;l(c,y,b,p);return}J(b,!0)}p&&p(r)})):p&&p(r)},switchOffAutoHideShow:function(){K=!1},ua:u,getFlashPlayerVersion:function(){return{major:u.pv[0],minor:u.pv[1],release:u.pv[2]}},hasFlashPlayerVersion:v,createSWF:function(a,b,c){if(u.w3)return t(a,
...
"https":"http"};e.check=function(a,d){try{var e=c.util.request(d),f=b.XDomainRequest&&e instanceof XDomainRequest,q=a&&a.options&&a.options.secure?"https:":"http:",t=b.location&&q!=b.location.protocol;if(e&&(!f||!t))return!0}catch(s){}return!1};e.xdomainCheck=function(a){return e.check(a,!0)}})("undefined"!=typeof io?io.Transport:module.exports,"undefined"!=typeof io?io:module.parent.exports,this);(function(a,c){function b(a){c.Transport.XHR.apply(this,arguments)}a.htmlfile=b;c.util.inherit(b,c.Transport.XHR);
...
~~c;break;case "m":case "mm":h[4]=~~c;break;case "s":case "ss":h[5]=~~c;break;case "S":case "SS":case "SSS":h[6]=~~(1E3*("0."+c));break;case "X":f._d=new Date(1E3*parseFloat(c));break;case "Z":case "ZZ":f._useUTC=!0,f._tzm=D(c)}null==c&&(f._isValid=!1)}e&&(a._il=e);a._isPm&&12>a._a[3]&&(a._a[3]+=12);!1===a._isPm&&12===a._a[3]&&(a._a[3]=0);J(a)}function B(a,b,c,d,e){return e.relativeTime(b||1,!!c,a,d)}function L(a,b,c){var d;b=c-b;c-=a.day();return c>b&&(c-=7),b-7>c&&(c+=7),d=x(a).add("d",c),{week:Math.ceil(d.dayOfYear()/
7),year:d.year()}}function m(b){var c=b._i,d=b._f;if(null===c||""===c)b=null;else{"string"==typeof c&&(b._i=c=s().preparse(c));if(x.isMoment(c))b=g({},c),b._d=new Date(+c._d);else if(d)if("[object Array]"===Object.prototype.toString.call(d)){var c=b,f,h,k,l=99;for(k=0;k<c._f.length;k++)f=g({},c),f._f=c._f[k],O(f),d=new e(f),f=q(f._a,d.toArray()),d._il&&(f+=d._il.length),l>f&&(l=f,h=d);g(c,h)}else O(b);else if(h=b,c=h._i,d=P.exec(c),c===a)h._d=new Date;else if(d)h._d=new Date(+d[1]);else if("string"==
typeof c)if(c=h._i,d=R.exec(c)){h._f="YYYY-MM-DD"+(d[2]||" ");for(d=0;4>d;d++)if(da[d][1].exec(c)){h._f+=da[d][0];break}u.exec(c)&&(h._f+=" Z");O(h)}else h._d=new Date(c);else"[object Array]"===Object.prototype.toString.call(c)?(h._a=c.slice(0),J(h)):h._d=c instanceof Date?new Date(+c):new Date(c);b=new e(b)}return b}function C(a,b){x.fn[a]=x.fn[a+"s"]=function(a){var c=this._isUTC?"UTC":"";return null!=a?(this._d["set"+c+b](a),x.updateOffset(this),this):this._d["get"+c+b]()}}function N(a){x.duration.fn[a]=
function(){return this._data[a]}}function G(a,b){x.duration.fn["as"+a]=function(){return+this/b}}for(var x,S,U=Math.round,V={},Z="undefined"!=typeof module&&module.exports,P=/^\/?Date\((\-?\d+)/i,ca=/(\-)?(\d*)?\.?(\d+)\:(\d+)\:(\d+)\.?(\d{3})?/,M=/(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|SS?S?|X|zz?|ZZ?|.)/g,W=/(\[[^\[]*\])|(\\)?(LT|LL?L?L?|l{1,4})/g,X=/\d\d?/,r=/\d{1,3}/,F=/\d{3}/,z=/\d{1,4}/,H=/[+\-]?\d{1,6}/,
...
a)},_ordinal:"%d",preparse:function(a){return a},postformat:function(a){return a},week:function(a){return L(a,this._week.dow,this._week.doy).week},_week:{dow:0,doy:6}};x=function(a,b,c){return m({_i:a,_f:b,_l:c,_isUTC:!1})};x.utc=function(a,b,c){return m({_useUTC:!0,_isUTC:!0,_l:c,_i:a,_f:b})};x.unix=function(a){return x(1E3*a)};x.duration=function(a,b){var c,d,e=x.isDuration(a),g="number"==typeof a,h=e?a._input:g?{}:a,l=ca.exec(a);return g?b?h[b]=a:h.milliseconds=a:l&&(c="-"===l[1]?-1:1,h={y:0,d:~~l[2]*
c,h:~~l[3]*c,m:~~l[4]*c,s:~~l[5]*c,ms:~~l[6]*c}),d=new f(h),e&&a.hasOwnProperty("_lang")&&(d._lang=a._lang),d};x.version="2.1.0";x.defaultFormat="YYYY-MM-DDTHH:mm:ssZ";x.updateOffset=function(){};x.lang=function(a,c){return a?(c?(c.abbr=a,V[a]||(V[a]=new b),V[a].set(c)):V[a]||s(a),x.duration.fn._lang=x.fn._lang=s(a),void 0):x.fn._lang._abbr};x.langData=function(a){return a&&a._lang&&a._lang._abbr&&(a=a._lang._abbr),s(a)};x.isMoment=function(a){return a instanceof e};x.isDuration=function(a){return a instanceof
f};x.fn=e.prototype={clone:function(){return x(this)},valueOf:function(){return+this._d+6E4*(this._offset||0)},unix:function(){return Math.floor(+this/1E3)},toString:function(){return this.format("ddd MMM DD YYYY HH:mm:ss [GMT]ZZ")},toDate:function(){return this._offset?new Date(+this):this._d},toISOString:function(){return w(x(this).utc(),"YYYY-MM-DD[T]HH:mm:ss.SSS[Z]")},toArray:function(){return[this.year(),this.month(),this.date(),this.hours(),this.minutes(),this.seconds(),this.milliseconds()]},
isValid:function(){return null==this._isValid&&(this._isValid=this._a?!q(this._a,(this._isUTC?x.utc(this._a):x(this._a)).toArray()):!isNaN(this._d.getTime())),!!this._isValid},utc:function(){return this.zone(0)},local:function(){return this.zone(0),this._isUTC=!1,this},format:function(a){a=w(this,a||x.defaultFormat);return this.lang().postformat(a)},add:function(a,b){var c;return c="string"==typeof a?x.duration(+b,a):x.duration(a,b),n(this,c,1),this},subtract:function(a,b){var c;return c="string"==
...
typeof a&&(a=D(a)),16>Math.abs(a)&&(a*=60),this._offset=a,this._isUTC=!0,b!==a&&n(this,x.duration(b-a,"m"),1,!0),this)},zoneAbbr:function(){return this._isUTC?"UTC":""},zoneName:function(){return this._isUTC?"Coordinated Universal Time":""},daysInMonth:function(){return x.utc([this.year(),this.month()+1,0]).date()},dayOfYear:function(a){var b=U((x(this).startOf("day")-x(this).startOf("year"))/864E5)+1;return null==a?b:this.add("d",a-b)},weekYear:function(a){var b=L(this,this.lang()._week.dow,this.lang()._week.doy).year;
...
"s"]()},lang:x.fn.lang};for(S in ja)ja.hasOwnProperty(S)&&(G(S,ja[S]),N(S.toLowerCase()));G("Weeks",6048E5);x.duration.fn.asMonths=function(){return(+this-31536E6*this.years())/2592E6+12*this.years()};x.lang("en",{ordinal:function(a){var b=a%10;return a+(1===~~(a%100/10)?"th":1===b?"st":2===b?"nd":3===b?"rd":"th")}});Z&&(module.exports=x);"undefined"==typeof ender&&(this.moment=x);"function"==typeof define&&define.amd&&define("moment",[],function(){return x})}.call(this);
...
for(var p=Array(16),t=Array(16),w=0;16>w;w++)p[w]=s[w]^909522486,t[w]=s[w]^1549556828;c=e(p.concat(f(c)),512+c.length*d);c=e(t.concat(c),768);return g(c)},sha256config:function(a){d=parseInt(a)||8}});a.fn.sha256=function(b){a.sha256config(b);b=h(a(this).val());b=a.sha256(b);a.sha256config(8);return b}})(jQuery);function Space(a){this._tuples=[];this.events={};this._load(a);return this}Space.version="0.5.1";Space.arrayDelete=function(a,d){return a.slice(0,d).concat(a.slice(d+1))};Space.isXPath=function(a){return a.match(/ /)};
...
Space.prototype.set=function(a,d,c){Space.isXPath(a.toString())?this._setByXPath(a,d):this.has(a)?this._setTuple(a,d,this.indexOf(a),!0):this._setTuple(a,d,c);this.trigger("set",a,d,c);this.trigger("change");return this};Space.prototype._setByXPath=function(a,d){if(!a)return null;for(var c=a.toString().split(/ /g),b=this,e,f,g=0;g<c.length;g++){e=c[g];if(!(b._getValueByKey(e)instanceof Space)){var h;h=g===c.length-1?d:new Space;b.has(e)?(f=b.indexOf(e),b._setTuple(e,h,f,!0)):b._setTuple(e,h)}b=b.get(e)}return this};
Space.prototype._setTuple=function(a,d,c,b){void 0===c?this._tuples.push([a,d]):b?this._tuples.splice(c,1,[a,d]):this._tuples.splice(c,0,[a,d])};Space.prototype.shift=function(){if(!this.length())return null;var a=this._getKeyByIndex(0),d=new Space;d.set(a,this.get(a));this._delete(a);return d};Space.prototype.sort=function(a){this._tuples=this._tuples.sort(a);return this};Space.prototype.tableOfContents=function(){return this.getKeys().join(" ")};
...
"i").exec(c)||0)[1]||null})}c||(c=S);var m,p=c,M=[],W=null,X=c==S,r=X&&N&&"function"==typeof N.version&&N.version(),F=function(a){return n(a,function(a,b){return a||RegExp("\\b"+(b.pattern||l(b))+"\\b","i").exec(c)&&(b.label||b)})}([{label:"WebKit",pattern:"AppleWebKit"},"iCab","Presto","NetFront","Tasman","Trident","KHTML","Gecko"]),z=function(a){return n(a,function(a,b){return a||RegExp("\\b"+(b.pattern||l(b))+"\\b","i").exec(c)&&(b.label||b)})}(["Adobe AIR","Arora","Avant Browser","Camino","Epiphany",
...
F&&(F=[F]);K&&!H&&(H=d([K]));if(m=/Google TV/.exec(H))H=m[0];/\bSimulator\b/i.test(c)&&(H=(H?H+" ":"")+"Simulator");if(/^iP/.test(H))z||(z="Safari"),u="iOS"+((m=/ OS ([\d_]+)/i.exec(c))?" "+m[1].replace(/_/g,"."):"");else if("Konqueror"==z&&!/buntu/i.test(u))u="Kubuntu";else if(K&&"Google"!=K&&/Chrome|Vita/.test(z+";"+H))z="Android Browser",u=/Android/.test(u)?u:"Android";else if(!z||(m=!/\bMinefield\b/i.test(c)&&/Firefox|Safari/.exec(z)))z&&(!H&&/[\/,]|^[^(]+?\)/.test(c.slice(c.indexOf(m+"/")+8)))&&
(z=null),(m=H||K||u)&&(H||K||/Android|Symbian OS|Tablet OS|webOS/.test(u))&&(z=/[a-z]+(?: Hat)?/i.exec(/Android/.test(u)?u:m)+" Browser");r||(r=g(["(?:Cloud9|CriOS|CrMo|Opera ?Mini|Raven|Silk(?!/[\\d.]+$))","Version",l(z),"(?:Firefox|Minefield|NetFront)"]));if("iCab"==F&&3<parseFloat(r))F=["WebKit"];else if(m=/Opera/.test(z)&&"Presto"||/\b(?:Midori|Nook|Safari)\b/i.test(c)&&"WebKit"||!F&&/\bMSIE\b/i.test(c)&&(/^Mac/.test(u)?"Tasman":"Trident"))F=[m];if(X){if(h(a,"global"))if(J&&(m=J.lang.System,p=
m.getProperty("os.arch"),u=u||m.getProperty("os.name")+" "+m.getProperty("os.version")),"object"==typeof exports&&exports)if(x==s&&"object"==typeof system&&(m=[system])[0]){u||(u=m[0].os||null);try{m[1]=require("ringo/engine").version,r=m[1].join("."),z="RingoJS"}catch(E){m[0].global==w&&(z="Narwhal")}}else"object"==typeof process&&(m=process)&&(z="Node.js",p=m.arch,u=m.platform,r=/[\d.]+/.exec(m.version)[0]);else"Environment"==f(a.environment)&&(z="Rhino");else"ScriptBridgingProxyObject"==f(m=a.runtime)?
(z="Adobe AIR",u=m.flash.system.Capabilities.os):"RuntimeObject"==f(m=a.phantom)?(z="PhantomJS",r=(m=m.version||null)&&m.major+"."+m.minor+"."+m.patch):"number"==typeof L.documentMode&&(m=/\bTrident\/(\d+)/i.exec(c))&&(r=[r,L.documentMode],(m=+m[1]+4)!=r[1]&&(M.push("IE "+r[1]+" mode"),F[1]="",r[1]=m),r="IE"==z?String(r[1].toFixed(1)):r[0]);u=u&&b(u)}r&&(m=/(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(r)||/(?:alpha|beta)(?: ?\d)?/i.exec(c+";"+(X&&C.appMinorVersion))||/\bMinefield\b/i.test(c)&&"a")&&
(W=/b/i.test(m)?"beta":"alpha",r=r.replace(RegExp(m+"\\+?$"),"")+("beta"==W?B:O)+(/\d+\+?/.exec(m)||""));"Fennec"==z?z="Firefox Mobile":"Maxthon"==z&&r?r=r.replace(/\.[\d.]+/,".x"):"Silk"==z?(/Mobi/i.test(c)||(u="Android",M.unshift("desktop mode")),/Accelerated *= *true/i.test(c)&&M.unshift("accelerated")):"IE"==z&&(m=(/; *(?:XBLWP|ZuneWP)(\d+)/i.exec(c)||0)[1])?(z+=" Mobile",u="Windows Phone OS "+m+".x",M.unshift("desktop mode")):"IE"!=z&&(!z||H||/Browser|Mobi/.test(z))||"Windows CE"!=u&&!/Mobi/i.test(c)?
"IE"==z&&X&&"object"==typeof external&&!external?M.unshift("platform preview"):/BlackBerry/.test(H)&&(m=(RegExp(H.replace(/ +/g," *")+"/([.\\d]+)","i").exec(c)||0)[1]||r)?(u="Device Software "+m,r=null):this!=e&&((X&&N||/Opera/.test(z)&&/\b(?:MSIE|Firefox)\b/i.test(c)||"Firefox"==z&&/OS X (?:\d+\.){2,}/.test(u)||"IE"==z&&(u&&!/^Win/.test(u)&&5.5<r||/Windows XP/.test(u)&&8<r||8==r&&!/Trident/.test(c)))&&!v.test(m=t.call(e,c.replace(v,"")+";"))&&m.name)&&(m="ing as "+m.name+((m=m.version)?" "+m:""),
v.test(z)?(/IE/.test(m)&&"Mac OS"==u&&(u=null),m="identify"+m):(m="mask"+m,z=G?b(G.replace(/([a-z])([A-Z])/g,"$1 $2")):"Opera",/IE/.test(m)&&(u=null),X||(r=null)),F=["Presto"],M.push(m)):z+=" Mobile";if(m=(/\bAppleWebKit\/([\d.]+\+?)/i.exec(c)||0)[1]){m=[parseFloat(m.replace(/\.(\d)$/,".0$1")),m];if("Safari"==z&&"+"==m[1].slice(-1))z="WebKit Nightly",W="alpha",r=m[1].slice(0,-1);else if(r==m[1]||r==(/\bSafari\/([\d.]+\+?)/i.exec(c)||0)[1])r=null;m=[m[0],(/\bChrome\/([\d.]+)/i.exec(c)||0)[1]];!X||
/internal|\n/i.test(D.toString())&&!m[1]?(F[1]="like Safari",m=(m=m[0],400>m?1:500>m?2:526>m?3:533>m?4:534>m?"4+":535>m?5:"5")):(F[1]="like Chrome",m=m[1]||(m=m[0],530>m?1:532>m?2:532.05>m?3:533>m?4:534.03>m?5:534.07>m?6:534.1>m?7:534.13>m?8:534.16>m?9:534.24>m?10:534.3>m?11:535.01>m?12:535.02>m?"13+":535.07>m?15:535.11>m?16:535.19>m?17:536.05>m?18:536.1>m?19:537.01>m?20:"21"));F[1]+=" "+(m+="number"==typeof m?".x":/[.+]/.test(m)?"":"+");"Safari"==z&&(!r||45<parseInt(r))&&(r=m)}"Opera"==z&&(m=/(?:zbov|zvav)$/.exec(u))?
(z+=" ",M.unshift("desktop mode"),"zvav"==m?(z+="Mini",r=null):z+="Mobile"):"Safari"==z&&/Chrome/.exec(F[1])&&(M.unshift("desktop mode"),z="Chrome Mobile",r=null,/Mac OS X/.test(u)?(K="Apple",u="iOS 4.3+"):u=null);r&&(0==r.indexOf(m=/[\d.]+$/.exec(u))&&-1<c.indexOf("/"+m+"-"))&&(u=q(u.replace(m,"")));F&&!/Avant|Nook/.test(z)&&(/Browser|Lunascape|Maxthon/.test(z)||/^(?:Adobe|Arora|Midori|Phantom|Rekonq|Rock|Sleipnir|Web)/.test(z)&&F[1])&&(m=F[F.length-1])&&M.push(m);M.length&&(M=["("+M.join("; ")+
")"]);K&&(H&&0>H.indexOf(K))&&M.push("on "+K);H&&M.push((/^on /.test(M[M.length-1])?"":"on ")+H);u&&(m=/ ([\d.+]+)$/.exec(u),u={architecture:32,family:m?u.replace(m[0],""):u,version:m?m[1]:null,toString:function(){var a=this.version;return this.family+(a?" "+a:"")+(64==this.architecture?" 64-bit":"")}});(m=/\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(p))&&!/\bi686\b/i.test(p)&&(u&&(u.architecture=64,u.family=u.family.replace(RegExp(" *"+m),"")),z&&(/WOW64/i.test(c)||X&&/\w(?:86|32)$/.test(C.cpuClass||
C.platform))&&M.unshift("32-bit"));c||(c=null);return{version:z&&r&&(M.unshift(r),r),name:z&&(M.unshift(z),z),os:u?(z&&!(u==String(u).split(" ")[0]&&(u==z.split(" ")[0]||H))&&M.push(H?"("+u+")":"on "+u),u):{architecture:null,family:null,version:null,toString:function(){return"null"}},description:M.length?M.join(" "):c,layout:F&&F[0],manufacturer:K,prerelease:W,product:H,ua:c,parse:t,toString:function(){return this.description||""}}}var s=a,p="object"==typeof exports&&exports,w="object"==typeof global&&
global&&(global==global.global?a=global:global),v=/Opera/,D={}.toString,J=/Java/.test(f(a.java))&&a.java,O=J?"a":"\u03b1",B=J?"b":"\u03b2",L=a.document||{},m={}.hasOwnProperty,C=a.navigator||{},N=a.operamini||a.opera,G=v.test(G=f(N))?G:N=null,x=this,S=C.userAgent||"";"function"==typeof define&&"object"==typeof define.amd&&define.amd?define(function(){return t()}):p?e(t(),function(a,b){p[b]=a}):a.platform=t()})(this);
...
L("namespace")||B()||O())||m());)c.push(b),n(c);return c}function l(b){if(b=b.exec(a)){var d=b[0];c(d);a=a.slice(d.length);return b}}function n(a){var b;for(a=a||[];b=q();)a.push(b);return a}function q(){var d=b();if("/"==a[0]&&"*"==a[1]){for(var e=2;null!=a[e]&&("*"!=a[e]||"/"!=a[e+1]);)++e;var e=e+2,f=a.slice(2,e-2);N+=2;c(f);a=a.slice(e);N+=2;return d({type:"comment",comment:f})}}function t(){var a=l(/^([^{]+)/);if(a)return a[0].trim().split(/\s*,\s*/)}function s(){var a=b(),c=l(/^(\*?[-\w]+)\s*/);
...
(function(){function a(a,c,d,g){var h,l,n,q,t,s,p,w;c=c||{};void 0===c.wrap_line_length&&void 0!==c.max_char&&(c.wrap_line_length=c.max_char);l=parseInt(c.indent_size||4,10);n=c.indent_char||" ";t=c.brace_style||"collapse";q=0===c.wrap_line_length?32786:parseInt(c.wrap_line_length||250,10);s=c.unformatted||"a span bdo em strong dfn code samp kbd var cite abbr acronym q sub sup tt i b big small u s strike font ins del pre address dt h1 h2 h3 h4 h5 h6".split(" ");w=(p=c.preserve_newlines||!0,parseInt(c.max_preserve_newlines||
...
function(){this.indent_level++};this.unindent=function(){0<this.indent_level&&this.indent_level--}};return this};for(h.printer(a,n,l,q,t);;){a=h.get_token();h.token_text=a[0];h.token_type=a[1];if("TK_EOF"===h.token_type)break;switch(h.token_type){case "TK_TAG_START":h.print_newline(!1,h.output);h.print_token(h.token_text);h.indent_content&&(h.indent(),h.indent_content=!1);h.current_mode="CONTENT";break;case "TK_TAG_STYLE":case "TK_TAG_SCRIPT":h.print_newline(!1,h.output);h.print_token(h.token_text);
...
Insight.Record.prototype.render=function(){$("#"+this.id).remove();var a=$('<i class="icon-location-arrow"></i>'),d=$('<div class="InsightRecord"></div>');a.css("font-size","14px");a.css("-webkit-transform","rotate(80deg)");a.css("transform","rotate(80deg)");d.append(a);(a=this.get("value name"))&&d.append("<label>"+a+"</label>");d.attr("id",this.id);var a=this.get("meta x"),c=this.get("meta y");d.css({top:c+"px",left:a+"px"});$(".InsightPlane").append(d);Insight.dragIt(d);return this};
Insight.Record.prototype.save=function(a){expressfs.writeFile("nudgepad/insight/"+this.database+"/"+this.id+".space",this.toString(),a)};Insight.Database=function(a){this.name=a;return this};Insight.Database.prototype=new Space;Insight.Database.prototype.create=function(a){expressfs.mkdir(this.getPath(),a)};Insight.Database.prototype.getPath=function(a){return"nudgepad/insight/"+(a?a:this.name)};
Insight.Database.prototype.open=function(){var a=this;expressfs.downloadDirectory(this.getPath(),"space",function(d){a.reload(d);$(".InsightPlane").html("");a.each(function(a,b,d){a=a.replace(/\.space/,"");b=new Insight.Record(a,this.name,b);this.update(d,a,b);b.render()});$(".InsightPlane").show();$("#InsightDatabase").html(a.name);store.set("InsightDatabase",a.name)})};Insight.Database.prototype.rename=function(a){expressfs.rename(this.getPath(),this.getPath(a),function(){Insight.menu.open(a)})};
Insight.Database.prototype.trash=function(a){expressfs.unlink("nudgepad/insight/"+this.name+"/"+a+".space",function(){$("#"+a).fadeOut("fast",function(){$(this).remove()})})};
Insight.Database.prototype.updateY=function(a){$(".InsightRecord").addClass("InsightRecordAnimate");var d=$(".InsightPlane").height()-20,c,b;this.each(function(d,e,h){d=parseFloat(e.get("value "+a));"undefined"===typeof c&&(c=d);"undefined"===typeof b&&(b=d);c>d&&(c=d);b<d&&(b=d)});var e=b-c;console.log(b);this.each(function(b,g,h){b=g.element();g=g.get("value "+a);g=Math.round((parseFloat(g)-c)/e*d);console.log(g);g=d-g;b.css("top",g)});setTimeout("$('.InsightRecord').removeClass('InsightRecordAnimate')",
1E3)};
Insight.Database.prototype.updateX=function(a){console.log("moving");$(".InsightRecord").addClass("InsightRecordAnimate");var d=$(".InsightPlane").width()-20,c,b;this.each(function(d,e,h){d=parseFloat(e.get("value "+a));"undefined"===typeof c&&(c=d);"undefined"===typeof b&&(b=d);c>d&&(c=d);b<d&&(b=d)});var e=b-c;console.log(b);this.each(function(b,g,h){b=g.element();g=g.get("value "+a);g=Math.round((parseFloat(g)-c)/e*d);console.log(g);b.css("left",g)});setTimeout("$('.InsightRecord').removeClass('InsightRecordAnimate')",1E3)};
Insight.drop={};Insight.drop.traverseFileTree=function(a,d){d=d||"";a.isFile?a.file(function(a){console.log("File:",d+a.name);Insight.drop.processFile(d,a)}):a.isDirectory&&a.createReader().readEntries(function(c){for(var b=0;b<c.length;b++)Insight.drop.traverseFileTree(c[b],d+a.name+"/")})};
Insight.drop.processFile=function(a,d){if(0==d.type.indexOf("text")||d.name.match(/\.space/)){var c=new FileReader;c.onload=function(a){var c=new Space(a.target.result);a=new Space;a.set("meta x",Insight.drop.event.offsetX+_.random(-300,300));a.set("meta y",Insight.drop.event.offsetY+_.random(-300,300));a.set("value",c);c.get("meta x")&&a.reload(c.toString());c=(new Date).getTime().toString();a=new Insight.Record(c,Insight.database,a);Insight.base.set(c,a);a.render();a.save()};c.onerror=function(a){console.log("error: %s",
a)};c.readAsText(d)}};Insight.drop.ondrop=function(a){a.preventDefault();Insight.drop.event=a;a=a.dataTransfer.items;for(var d=0;d<a.length;d++){var c=a[d].webkitGetAsEntry();c&&Insight.drop.traverseFileTree(c)}};Insight.drop.ondragover=function(a){a.preventDefault()};Insight.on("close",function(){window.removeEventListener("dragover",Insight.drop.ondragover);window.removeEventListener("drop",Insight.drop.ondrop)});
...
function(a){var b=this._canvas.getBoundingClientRect();return new c(a.clientX-b.left,a.clientY-b.top)};d.prototype._addPoint=function(a){var c,d,h,l,n=this.points;n.push(a);2<n.length&&(3===n.length&&n.unshift(n[0]),l=this._calculateCurveControlPoints(n[0],n[1],n[2]),c=l.c2,l=this._calculateCurveControlPoints(n[1],n[2],n[3]),d=l.c1,h=new b(n[1],c,d,n[2]),this._addCurve(h),n.shift())};d.prototype._calculateCurveControlPoints=function(a,b,d){var h=a.x-b.x,l=a.y-b.y,n=b.x-d.x,q=b.y-d.y,t=(a.x+b.x)/2;
a=(a.y+b.y)/2;var s=(b.x+d.x)/2;d=(b.y+d.y)/2;h=Math.sqrt(h*h+l*l);n=Math.sqrt(n*n+q*q);q=n/(h+n);n=b.x-(s+(t-s)*q);b=b.y-(d+(a-d)*q);return{c1:new c(t+n,a+b),c2:new c(s+n,d+b)}};d.prototype._addCurve=function(a){var b,c;b=a.endPoint.velocityFrom(a.startPoint);b=this.velocityFilterWeight*b+(1-this.velocityFilterWeight)*this._lastVelocity;c=this._strokeWidth(b);this._drawCurve(a,this._lastWidth,c);this._lastVelocity=b;this._lastWidth=c};d.prototype._drawPoint=function(a,b,c){var d=this._ctx;d.moveTo(a,
b);d.arc(a,b,c,0,2*Math.PI,!1);this._isEmpty=!1};d.prototype._drawCurve=function(a,b,c){var d,l,n,q,t,s,p,w,v=this._ctx,D=c-b;c=Math.floor(a.length());v.beginPath();for(l=0;c>l;l++)d=l/c,n=d*d,q=n*d,t=1-d,s=t*t,p=s*t,w=p*a.startPoint.x,w+=3*s*d*a.control1.x,w+=3*t*n*a.control2.x,w+=q*a.endPoint.x,p*=a.startPoint.y,p+=3*s*d*a.control1.y,p+=3*t*n*a.control2.y,p+=q*a.endPoint.y,d=b+q*D,this._drawPoint(w,p,d);v.closePath();v.fill()};d.prototype._strokeWidth=function(a){return Math.max(this.maxWidth/(a+
1),this.minWidth)};var c=function(a,b,c){this.x=a;this.y=b;this.time=c||(new Date).getTime()};c.prototype.velocityFrom=function(a){return this.distanceTo(a)/(this.time-a.time)};c.prototype.distanceTo=function(a){return Math.sqrt(Math.pow(this.x-a.x,2)+Math.pow(this.y-a.y,2))};var b=function(a,b,c,d){this.startPoint=a;this.control1=b;this.control2=c;this.endPoint=d};return b.prototype.length=function(){var a,b,c,d,l,n,q,t=0;for(a=0;10>=a;a++)b=a/10,c=this._point(b,this.startPoint.x,this.control1.x,
this.control2.x,this.endPoint.x),b=this._point(b,this.startPoint.y,this.control1.y,this.control2.y,this.endPoint.y),0<a&&(n=c-d,q=b-l,t+=Math.sqrt(n*n+q*q)),d=c,l=b;return t},b.prototype._point=function(a,b,c,d,l){return b*(1-a)*(1-a)*(1-a)+3*c*(1-a)*(1-a)*a+3*d*(1-a)*a*a+l*a*a*a},d}(document),Sketch=new Tool("Sketch");
