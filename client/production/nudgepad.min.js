...
!b||k._data(b[c],"globalEval"))}function O(a,b){if(1===b.nodeType&&k.hasData(a)){var d,c,e;c=k._data(a);var g=k._data(b,c),f=c.events;if(f)for(d in delete g.handle,g.events={},f)for(c=0,e=f[d].length;e>c;c++)k.event.add(b,d,f[d][c]);g.data&&(g.data=k.extend({},g.data))}}function B(a,b){var c,e,g=0,f=typeof a.getElementsByTagName!==R?a.getElementsByTagName(b||"*"):typeof a.querySelectorAll!==R?a.querySelectorAll(b||"*"):d;if(!f)for(f=[],c=a.childNodes||a;null!=(e=c[g]);g++)!b||k.nodeName(e,b)?f.push(e):
k.merge(f,B(e,b));return b===d||b&&k.nodeName(a,b)?k.merge([a],f):f}function L(a){lb.test(a.type)&&(a.defaultChecked=a.checked)}function m(a,b){if(b in a)return b;for(var d=b.charAt(0).toUpperCase()+b.slice(1),c=b,e=wb.length;e--;)if(b=wb[e]+d,b in a)return b;return c}function C(a,b){return a=b||a,"none"===k.css(a,"display")||!k.contains(a.ownerDocument,a)}function N(a,b){for(var d,c,e,g=[],f=0,h=a.length;h>f;f++)c=a[f],c.style&&(g[f]=k._data(c,"olddisplay"),d=c.style.display,b?(g[f]||"none"!==d||
(c.style.display=""),""===c.style.display&&C(c)&&(g[f]=k._data(c,"olddisplay",U(c.nodeName)))):g[f]||(e=C(c),(d&&"none"!==d||!e)&&k._data(c,"olddisplay",e?d:k.css(c,"display"))));for(f=0;h>f;f++)c=a[f],c.style&&(b&&"none"!==c.style.display&&""!==c.style.display||(c.style.display=b?g[f]||"":"none"));return a}function F(a,b,c){return(a=Ob.exec(b))?Math.max(0,a[1]-(c||0))+(a[2]||"px"):b}function y(a,b,c,d,e){b=c===(d?"border":"content")?4:"width"===b?1:0;for(var f=0;4>b;b+=2)"margin"===c&&(f+=k.css(a,
c+Da[b],!0,e)),d?("content"===c&&(f-=k.css(a,"padding"+Da[b],!0,e)),"margin"!==c&&(f-=k.css(a,"border"+Da[b]+"Width",!0,e))):(f+=k.css(a,"padding"+Da[b],!0,e),"padding"!==c&&(f+=k.css(a,"border"+Da[b]+"Width",!0,e)));return f}function S(a,b,c){var d=!0,e="width"===b?a.offsetWidth:a.offsetHeight,f=Ea(a),g=k.support.boxSizing&&"border-box"===k.css(a,"boxSizing",!1,f);if(0>=e||null==e){if(e=Fa(a,b,f),(0>e||null==e)&&(e=a.style[b]),cb.test(e))return e;d=g&&(k.support.boxSizingReliable||e===a.style[b]);
e=parseFloat(e)||0}return e+y(a,b,c||(g?"border":"content"),d,f)+"px"}function U(a){var b=H,c=xb[a];return c||(c=V(a,b),"none"!==c&&c||(Ra=(Ra||k("<iframe frameborder='0' width='0' height='0'/>").css("cssText","display:block !important")).appendTo(b.documentElement),b=(Ra[0].contentWindow||Ra[0].contentDocument).document,b.write("<!doctype html><html><body>"),b.close(),c=V(a,b),Ra.detach()),xb[a]=c),c}function V(a,b){var c=k(b.createElement(a)).appendTo(b.body),d=k.css(c[0],"display");return c.remove(),
d}function Z(a,b,c,d){var e;if(k.isArray(b))k.each(b,function(b,e){c||Pb.test(a)?d(a,e):Z(a+"["+("object"==typeof e?b:"")+"]",e,c,d)});else if(c||"object"!==k.type(b))d(a,b);else for(e in b)Z(a+"["+e+"]",b[e],c,d)}function P(a){return function(b,c){"string"!=typeof b&&(c=b,b="*");var d,e=0,f=b.toLowerCase().match(ba)||[];if(k.isFunction(c))for(;d=f[e++];)"+"===d[0]?(d=d.slice(1)||"*",(a[d]=a[d]||[]).unshift(c)):(a[d]=a[d]||[]).push(c)}}function ca(a,b,c,e){function f(l){var n;return g[l]=!0,k.each(a[l]||
[],function(a,z){var k=z(b,c,e);return"string"!=typeof k||h||g[k]?h?!(n=k):d:(b.dataTypes.unshift(k),f(k),!1)}),n}var g={},h=a===mb;return f(b.dataTypes[0])||!g["*"]&&f("*")}function M(a,b){var c,e,f=k.ajaxSettings.flatOptions||{};for(e in b)b[e]!==d&&((f[e]?a:c||(c={}))[e]=b[e]);return c&&k.extend(!0,a,c),a}function W(){try{return new a.XMLHttpRequest}catch(b){}}function X(){return setTimeout(function(){Ka=d}),Ka=k.now()}function q(a,b,c){for(var d,e=(Sa[b]||[]).concat(Sa["*"]),f=0,g=e.length;g>
f;f++)if(d=e[f].call(c,b,a))return d}function I(a,b,c){var d,e=0,f=db.length,g=k.Deferred().always(function(){delete h.elem}),h=function(){if(d)return!1;for(var b=Ka||X(),b=Math.max(0,l.startTime+l.duration-b),c=1-(b/l.duration||0),e=0,f=l.tweens.length;f>e;e++)l.tweens[e].run(c);return g.notifyWith(a,[l,c,b]),1>c&&f?b:(g.resolveWith(a,[l]),!1)},l=g.promise({elem:a,props:k.extend({},b),opts:k.extend(!0,{specialEasing:{}},c),originalProperties:b,originalOptions:c,startTime:Ka||X(),duration:c.duration,
tweens:[],createTween:function(b,c){var d=k.Tween(a,l.opts,b,c,l.opts.specialEasing[b]||l.opts.easing);return l.tweens.push(d),d},stop:function(b){var c=0,e=b?l.tweens.length:0;if(d)return this;for(d=!0;e>c;c++)l.tweens[c].run(1);return b?g.resolveWith(a,[l,b]):g.rejectWith(a,[l,b]),this}});c=l.props;for(x(c,l.opts.specialEasing);f>e;e++)if(b=db[e].call(l,a,c,l.opts))return b;return k.map(c,q,l),k.isFunction(l.opts.start)&&l.opts.start.call(a,l),k.fx.timer(k.extend(h,{elem:a,anim:l,queue:l.opts.queue})),
...
b);for(b in a);return b===d||pa.call(a,b)},isEmptyObject:function(a){for(var b in a)return!1;return!0},error:function(a){throw Error(a);},parseHTML:function(a,b,c){if(!a||"string"!=typeof a)return null;"boolean"==typeof b&&(c=b,b=!1);b=b||H;var d=eb.exec(a);c=!c&&[];return d?[b.createElement(d[1])]:(d=k.buildFragment([a],b,c),c&&k(c).remove(),k.merge([],d.childNodes))},parseJSON:function(b){return a.JSON&&a.JSON.parse?a.JSON.parse(b):null===b?b:"string"==typeof b&&(b=k.trim(b),b&&ra.test(b.replace(T,
...
b,c,e,f,g,h){var l=0,n=a.length,q=null==c;if("object"===k.type(c))for(l in f=!0,c)k.access(a,b,l,c[l],!0,g,h);else if(e!==d&&(f=!0,k.isFunction(e)||(h=!0),q&&(h?(b.call(a,e),b=null):(q=b,b=function(a,b,c){return q.call(k(a),c)})),b))for(;n>l;l++)b(a[l],c,h?e:e.call(a[l],l,b(a[l],c)));return f?a:q?b.call(a):n?b(a[0],c):g},now:function(){return(new Date).getTime()},swap:function(a,b,c,d){var e,f={};for(e in b)f[e]=a.style[e],a.style[e]=b[e];c=c.apply(a,d||[]);for(e in b)a.style[e]=f[e];return c}});
k.ready.promise=function(b){if(!E)if(E=k.Deferred(),"complete"===H.readyState)setTimeout(k.ready);else if(H.addEventListener)H.addEventListener("DOMContentLoaded",ia,!1),a.addEventListener("load",ia,!1);else{H.attachEvent("onreadystatechange",ia);a.attachEvent("onload",ia);var c=!1;try{c=null==a.frameElement&&H.documentElement}catch(d){}c&&c.doScroll&&function Ca(){if(!k.isReady){try{c.doScroll("left")}catch(a){return setTimeout(Ca,50)}Wa();k.ready()}}()}return E.promise(b)};k.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),
function(a,b){ha["[object "+b+"]"]=b.toLowerCase()});aa=k(H);(function(a,b){function c(a,b,d,e){var z,f,g,k,h;if((b?b.ownerDocument||b:da)!==D&&G(b),b=b||D,d=d||[],!a||"string"!=typeof a)return d;if(1!==(k=b.nodeType)&&9!==k)return[];if(H&&!e){if(z=ra.exec(a))if(g=z[1])if(9===k){if(f=b.getElementById(g),!f||!f.parentNode)return d;if(f.id===g)return d.push(f),d}else{if(b.ownerDocument&&(f=b.ownerDocument.getElementById(g))&&K(b,f)&&f.id===g)return d.push(f),d}else{if(z[2])return ba.apply(d,b.getElementsByTagName(a)),
d;if((g=z[3])&&s.getElementsByClassName&&b.getElementsByClassName)return ba.apply(d,b.getElementsByClassName(g)),d}if(s.qsa&&(!C||!C.test(a))){if(f=z=P,g=b,h=9===k&&a,1===k&&"object"!==b.nodeName.toLowerCase()){k=m(a);(z=b.getAttribute("id"))?f=z.replace(ta,"\\$&"):b.setAttribute("id",f);f="[id='"+f+"'] ";for(g=k.length;g--;)k[g]=f+E(k[g]);g=ea.test(a)&&b.parentNode||b;h=k.join(",")}if(h)try{return ba.apply(d,g.querySelectorAll(h)),d}catch(l){}finally{z||b.removeAttribute("id")}}}var Q;a:{a=a.replace(X,
"$1");var na,n;f=m(a);if(!e&&1===f.length){if(Q=f[0]=f[0].slice(0),2<Q.length&&"ID"===(na=Q[0]).type&&s.getById&&9===b.nodeType&&H&&w.relative[Q[1].type]){if(b=(w.find.ID(na.matches[0].replace(fa,ga),b)||[])[0],!b){Q=d;break a}a=a.slice(Q.shift().value.length)}for(k=Ha.needsContext.test(a)?0:Q.length;k--&&(na=Q[k],!w.relative[z=na.type]);)if((n=w.find[z])&&(e=n(na.matches[0].replace(fa,ga),ea.test(Q[0].type)&&b.parentNode||b))){if(Q.splice(k,1),a=e.length&&E(Q),!a){Q=(ba.apply(d,e),d);break a}break}}Q=
(v(a,f)(e,b,!H,d,ea.test(a)),d)}return Q}function d(){function a(c,d){return b.push(c+=" ")>w.cacheLength&&delete a[b.shift()],a[c]=d}var b=[];return a}function e(a){return a[P]=!0,a}function f(a){var b=D.createElement("div");try{return!!a(b)}catch(c){return!1}finally{b.parentNode&&b.parentNode.removeChild(b)}}function g(a,b){for(var c=a.split("|"),d=a.length;d--;)w.attrHandle[c[d]]=b}function h(a,b){var c=b&&a,d=c&&1===a.nodeType&&1===b.nodeType&&(~b.sourceIndex||S)-(~a.sourceIndex||S);if(d)return d;
if(c)for(;c=c.nextSibling;)if(c===b)return-1;return a?1:-1}function l(a){return function(b){return"input"===b.nodeName.toLowerCase()&&b.type===a}}function n(a){return function(b){var c=b.nodeName.toLowerCase();return("input"===c||"button"===c)&&b.type===a}}function q(a){return e(function(b){return b=+b,e(function(c,d){for(var e,z=a([],c.length,b),f=z.length;f--;)c[e=z[f]]&&(c[e]=!(d[e]=c[e]))})})}function A(){}function m(a,b){var d,e,z,f,g,k,h;if(g=ma[a+" "])return b?0:g.slice(0);g=a;k=[];for(h=w.preFilter;g;){d&&
!(e=T.exec(g))||(e&&(g=g.slice(e[0].length)||g),k.push(z=[]));d=!1;(e=wa.exec(g))&&(d=e.shift(),z.push({value:d,type:e[0].replace(X," ")}),g=g.slice(d.length));for(f in w.filter)!(e=Ha[f].exec(g))||h[f]&&!(e=h[f](e))||(d=e.shift(),z.push({value:d,type:f,matches:e}),g=g.slice(d.length));if(!d)break}return b?g.length:g?c.error(a):ma(a,k).slice(0)}function E(a){for(var b=0,c=a.length,d="";c>b;b++)d+=a[b].value;return d}function p(a,b,c){var d=b.dir,e=c&&"parentNode"===d,z=N++;return b.first?function(b,
c,z){for(;b=b[d];)if(1===b.nodeType||e)return a(b,c,z)}:function(b,c,f){var g,k,h,l=U+" "+z;if(f)for(;b=b[d];){if((1===b.nodeType||e)&&a(b,c,f))return!0}else for(;b=b[d];)if(1===b.nodeType||e)if(h=b[P]||(b[P]={}),(k=h[d])&&k[0]===l){if(!0===(g=k[1])||g===t)return!0===g}else if(k=h[d]=[l],k[1]=a(b,c,f)||t,!0===k[1])return!0}}function u(a){return 1<a.length?function(b,c,d){for(var e=a.length;e--;)if(!a[e](b,c,d))return!1;return!0}:a[0]}function O(a,b,c,d,e){for(var z,f=[],g=0,k=a.length,h=null!=b;k>
g;g++)(z=a[g])&&(!c||c(z,d,e))&&(f.push(z),h&&b.push(g));return f}function J(a,b,d,z,f,g){return z&&!z[P]&&(z=J(z)),f&&!f[P]&&(f=J(f,g)),e(function(e,g,k,h){var l,Q,n=[],q=[],ua=g.length,A;if(!(A=e)){A=b||"*";for(var m=k.nodeType?[k]:k,Ca=[],E=0,p=m.length;p>E;E++)c(A,m[E],Ca);A=Ca}A=!a||!e&&b?A:O(A,n,a,k,h);m=d?f||(e?a:ua||z)?[]:g:A;if(d&&d(A,m,k,h),z)for(l=O(m,q),z(l,[],k,h),k=l.length;k--;)(Q=l[k])&&(m[q[k]]=!(A[q[k]]=Q));if(e){if(f||a){if(f){l=[];for(k=m.length;k--;)(Q=m[k])&&l.push(A[k]=Q);f(null,
m=[],l,h)}for(k=m.length;k--;)(Q=m[k])&&-1<(l=f?W.call(e,Q):n[k])&&(e[l]=!(g[l]=Q))}}else m=O(m===g?m.splice(ua,m.length):m),f?f(null,g,m,h):ba.apply(g,m)})}function I(a){var b,c,d,e=a.length,z=w.relative[a[0].type];c=z||w.relative[" "];for(var f=z?1:0,g=p(function(a){return a===b},c,!0),k=p(function(a){return-1<W.call(b,a)},c,!0),h=[function(a,c,d){return!z&&(d||c!==aa)||((b=c).nodeType?g(a,c,d):k(a,c,d))}];e>f;f++)if(c=w.relative[a[f].type])h=[p(u(h),c)];else{if(c=w.filter[a[f].type].apply(null,
a[f].matches),c[P]){for(d=++f;e>d&&!w.relative[a[d].type];d++);return J(1<f&&u(h),1<f&&E(a.slice(0,f-1).concat({value:" "===a[f-2].type?"*":""})).replace(X,"$1"),c,d>f&&I(a.slice(f,d)),e>d&&I(a=a.slice(d)),e>d&&E(a))}h.push(c)}return u(h)}function x(a,b){var d=0,z=0<b.length,f=0<a.length,g=function(e,g,k,h,l){var Q,n,q=[],ua=0,A="0",m=e&&[],E=null!=l,Ca=aa,p=e||f&&w.find.TAG("*",l&&g.parentNode||g),u=U+=null==Ca?1:Math.random()||0.1;for(E&&(aa=g!==D&&g,t=d);null!=(l=p[A]);A++){if(f&&l){for(Q=0;n=
a[Q++];)if(n(l,g,k)){h.push(l);break}E&&(U=u,t=++d)}z&&((l=!n&&l)&&ua--,e&&m.push(l))}if(ua+=A,z&&A!==ua){for(Q=0;n=b[Q++];)n(m,q,g,k);if(e){if(0<ua)for(;A--;)m[A]||q[A]||(q[A]=ca.call(h));q=O(q)}ba.apply(h,q);E&&!e&&0<q.length&&1<ua+b.length&&c.uniqueSort(h)}return E&&(U=u,aa=Ca),m};return z?e(g):g}var B,s,t,w,Y,r,v,aa,y,G,D,R,H,C,la,F,K,P="sizzle"+-new Date,da=a.document,U=0,N=0,L=d(),ma=d(),pa=d(),V=!1,M=function(a,b){return a===b?(V=!0,0):0},ja=typeof b,S=-2147483648,qa={}.hasOwnProperty,Z=[],
ca=Z.pop,kb=Z.push,ba=Z.push,oa=Z.slice,W=Z.indexOf||function(a){for(var b=0,c=this.length;c>b;b++)if(this[b]===a)return b;return-1},ha="(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w#"),ib="\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)[\\x20\\t\\r\\n\\f]*(?:([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|("+ha+")|)|)[\\x20\\t\\r\\n\\f]*\\]",Ja=":((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|"+ib.replace(3,8)+")*)|.*)\\)|)",
...
ga=function(a,b,c){a="0x"+b-65536;return a!==a||c?b:0>a?String.fromCharCode(a+65536):String.fromCharCode(55296|a>>10,56320|1023&a)};try{ba.apply(Z=oa.call(da.childNodes),da.childNodes),Z[da.childNodes.length].nodeType}catch(Ta){ba={apply:Z.length?function(a,b){kb.apply(a,oa.call(b))}:function(a,b){for(var c=a.length,d=0;a[c++]=b[d++];);a.length=c-1}}}r=c.isXML=function(a){return(a=a&&(a.ownerDocument||a).documentElement)?"HTML"!==a.nodeName:!1};s=c.support={};G=c.setDocument=function(a){var c=a?a.ownerDocument||
a:da;a=c.defaultView;return c!==D&&9===c.nodeType&&c.documentElement?(D=c,R=c.documentElement,H=!r(c),a&&a.attachEvent&&a!==a.top&&a.attachEvent("onbeforeunload",function(){G()}),s.attributes=f(function(a){return a.className="i",!a.getAttribute("className")}),s.getElementsByTagName=f(function(a){return a.appendChild(c.createComment("")),!a.getElementsByTagName("*").length}),s.getElementsByClassName=f(function(a){return a.innerHTML="<div class='a'></div><div class='a i'></div>",a.firstChild.className=
"i",2===a.getElementsByClassName("i").length}),s.getById=f(function(a){return R.appendChild(a).id=P,!c.getElementsByName||!c.getElementsByName(P).length}),s.getById?(w.find.ID=function(a,b){if(typeof b.getElementById!==ja&&H){var c=b.getElementById(a);return c&&c.parentNode?[c]:[]}},w.filter.ID=function(a){var b=a.replace(fa,ga);return function(a){return a.getAttribute("id")===b}}):(delete w.find.ID,w.filter.ID=function(a){var b=a.replace(fa,ga);return function(a){return(a=typeof a.getAttributeNode!==
ja&&a.getAttributeNode("id"))&&a.value===b}}),w.find.TAG=s.getElementsByTagName?function(a,c){return typeof c.getElementsByTagName!==ja?c.getElementsByTagName(a):b}:function(a,b){var c,d=[],e=0,z=b.getElementsByTagName(a);if("*"===a){for(;c=z[e++];)1===c.nodeType&&d.push(c);return d}return z},w.find.CLASS=s.getElementsByClassName&&function(a,c){return typeof c.getElementsByClassName!==ja&&H?c.getElementsByClassName(a):b},la=[],C=[],(s.qsa=ia.test(c.querySelectorAll))&&(f(function(a){a.innerHTML="<select><option selected=''></option></select>";
...
!(c.contains?c.contains(d):a.compareDocumentPosition&&16&a.compareDocumentPosition(d)))}:function(a,b){if(b)for(;b=b.parentNode;)if(b===a)return!0;return!1},M=R.compareDocumentPosition?function(a,b){if(a===b)return V=!0,0;var d=b.compareDocumentPosition&&a.compareDocumentPosition&&a.compareDocumentPosition(b);return d?1&d||!s.sortDetached&&b.compareDocumentPosition(a)===d?a===c||K(da,a)?-1:b===c||K(da,b)?1:y?W.call(y,a)-W.call(y,b):0:4&d?-1:1:a.compareDocumentPosition?-1:1}:function(a,b){var d,e=
0;d=a.parentNode;var z=b.parentNode,f=[a],g=[b];if(a===b)return V=!0,0;if(!d||!z)return a===c?-1:b===c?1:d?-1:z?1:y?W.call(y,a)-W.call(y,b):0;if(d===z)return h(a,b);for(d=a;d=d.parentNode;)f.unshift(d);for(d=b;d=d.parentNode;)g.unshift(d);for(;f[e]===g[e];)e++;return e?h(f[e],g[e]):f[e]===da?-1:g[e]===da?1:0},c):D};c.matches=function(a,b){return c(a,null,null,b)};c.matchesSelector=function(a,b){if((a.ownerDocument||a)!==D&&G(a),b=b.replace(ka,"='$1']"),s.matchesSelector&&H&&!(la&&la.test(b)||C&&C.test(b)))try{var d=
F.call(a,b);if(d||s.disconnectedMatch||a.document&&11!==a.document.nodeType)return d}catch(e){}return 0<c(b,D,null,[a]).length};c.contains=function(a,b){return(a.ownerDocument||a)!==D&&G(a),K(a,b)};c.attr=function(a,c){(a.ownerDocument||a)!==D&&G(a);var d=w.attrHandle[c.toLowerCase()],d=d&&qa.call(w.attrHandle,c.toLowerCase())?d(a,c,!H):b;return d===b?s.attributes||!H?a.getAttribute(c):(d=a.getAttributeNode(c))&&d.specified?d.value:null:d};c.error=function(a){throw Error("Syntax error, unrecognized expression: "+
a);};c.uniqueSort=function(a){var b,c=[],d=0,e=0;if(V=!s.detectDuplicates,y=!s.sortStable&&a.slice(0),a.sort(M),V){for(;b=a[e++];)b===a[e]&&(d=c.push(e));for(;d--;)a.splice(c[d],1)}return a};Y=c.getText=function(a){var b,c="",d=0;if(b=a.nodeType)if(1===b||9===b||11===b){if("string"==typeof a.textContent)return a.textContent;for(a=a.firstChild;a;a=a.nextSibling)c+=Y(a)}else{if(3===b||4===b)return a.nodeValue}else for(;b=a[d];d++)c+=Y(b);return c};w=c.selectors={cacheLength:50,createPseudo:e,match:Ha,
...
typeof a.className&&a.className||typeof a.getAttribute!==ja&&a.getAttribute("class")||"")})},ATTR:function(a,b,d){return function(e){e=c.attr(e,a);return null==e?"!="===b:b?(e+="","="===b?e===d:"!="===b?e!==d:"^="===b?d&&0===e.indexOf(d):"*="===b?d&&-1<e.indexOf(d):"$="===b?d&&e.slice(-d.length)===d:"~="===b?-1<(" "+e+" ").indexOf(d):"|="===b?e===d||e.slice(0,d.length+1)===d+"-":!1):!0}},CHILD:function(a,b,c,d,e){var z="nth"!==a.slice(0,3),f="last"!==a.slice(-4),g="of-type"===b;return 1===d&&0===
e?function(a){return!!a.parentNode}:function(b,c,k){var h,l,Q,na,n;c=z!==f?"nextSibling":"previousSibling";var q=b.parentNode,ua=g&&b.nodeName.toLowerCase();k=!k&&!g;if(q){if(z){for(;c;){for(l=b;l=l[c];)if(g?l.nodeName.toLowerCase()===ua:1===l.nodeType)return!1;n=c="only"===a&&!n&&"nextSibling"}return!0}if(n=[f?q.firstChild:q.lastChild],f&&k)for(k=q[P]||(q[P]={}),h=k[a]||[],na=h[0]===U&&h[1],Q=h[0]===U&&h[2],l=na&&q.childNodes[na];l=++na&&l&&l[c]||(Q=na=0)||n.pop();){if(1===l.nodeType&&++Q&&l===b){k[a]=
[U,na,Q];break}}else if(k&&(h=(b[P]||(b[P]={}))[a])&&h[0]===U)Q=h[1];else for(;(l=++na&&l&&l[c]||(Q=na=0)||n.pop())&&((g?l.nodeName.toLowerCase()!==ua:1!==l.nodeType)||!++Q||(k&&((l[P]||(l[P]={}))[a]=[U,Q]),l!==b)););return Q-=e,Q===d||0===Q%d&&0<=Q/d}}},PSEUDO:function(a,b){var d,z=w.pseudos[a]||w.setFilters[a.toLowerCase()]||c.error("unsupported pseudo: "+a);return z[P]?z(b):1<z.length?(d=[a,a,"",b],w.setFilters.hasOwnProperty(a.toLowerCase())?e(function(a,c){for(var d,e=z(a,b),f=e.length;f--;)d=
W.call(a,e[f]),a[d]=!(c[d]=e[f])}):function(a){return z(a,0,d)}):z}},pseudos:{not:e(function(a){var b=[],c=[],d=v(a.replace(X,"$1"));return d[P]?e(function(a,b,c,e){var z;c=d(a,null,e,[]);for(e=a.length;e--;)(z=c[e])&&(a[e]=!(b[e]=z))}):function(a,e,z){return b[0]=a,d(b,null,z,c),!c.pop()}}),has:e(function(a){return function(b){return 0<c(a,b).length}}),contains:e(function(a){return function(b){return-1<(b.textContent||b.innerText||Y(b)).indexOf(a)}}),lang:e(function(a){return va.test(a||"")||c.error("unsupported lang: "+
a),a=a.replace(fa,ga).toLowerCase(),function(b){var c;do if(c=H?b.lang:b.getAttribute("xml:lang")||b.getAttribute("lang"))return c=c.toLowerCase(),c===a||0===c.indexOf(a+"-");while((b=b.parentNode)&&1===b.nodeType);return!1}}),target:function(b){var c=a.location&&a.location.hash;return c&&c.slice(1)===b.id},root:function(a){return a===R},focus:function(a){return a===D.activeElement&&(!D.hasFocus||D.hasFocus())&&!!(a.type||a.href||~a.tabIndex)},enabled:function(a){return!1===a.disabled},disabled:function(a){return!0===
...
b,c){for(c=0>c?c+b:c;b>++c;)a.push(c);return a})}};w.pseudos.nth=w.pseudos.eq;for(B in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})w.pseudos[B]=l(B);for(B in{submit:!0,reset:!0})w.pseudos[B]=n(B);A.prototype=w.filters=w.pseudos;w.setFilters=new A;v=c.compile=function(a,b){var c,d=[],e=[],z=pa[a+" "];if(!z){b||(b=m(a));for(c=b.length;c--;)z=I(b[c]),z[P]?d.push(z):e.push(z);z=pa(a,x(e,d))}return z};s.sortStable=P.split("").sort(M).join("")===P;s.detectDuplicates=V;G();s.sortDetached=f(function(a){return 1&
a.compareDocumentPosition(D.createElement("div"))});f(function(a){return a.innerHTML="<a href='#'></a>","#"===a.firstChild.getAttribute("href")})||g("type|href|height|width",function(a,c,d){return d?b:a.getAttribute(c,"type"===c.toLowerCase()?1:2)});s.attributes&&f(function(a){return a.innerHTML="<input/>",a.firstChild.setAttribute("value",""),""===a.firstChild.getAttribute("value")})||g("value",function(a,c,d){return d||"input"!==a.nodeName.toLowerCase()?b:a.defaultValue});f(function(a){return null==
...
g,l,h,n=[],q=!a.once&&[],A=function(b){e=a.memory&&b;f=!0;l=h||0;h=0;g=n.length;for(c=!0;n&&g>l;l++)if(!1===n[l].apply(b[0],b[1])&&a.stopOnFalse){e=!1;break}c=!1;n&&(q?q.length&&A(q.shift()):e?n=[]:m.disable())},m={add:function(){if(n){var b=n.length;(function Qb(b){k.each(b,function(b,c){var d=k.type(c);"function"===d?a.unique&&m.has(c)||n.push(c):c&&c.length&&"string"!==d&&Qb(c)})})(arguments);c?g=n.length:e&&(h=b,A(e))}return this},remove:function(){return n&&k.each(arguments,function(a,b){for(var d;-1<
...
k.extend({Deferred:function(a){var b=[["resolve","done",k.Callbacks("once memory"),"resolved"],["reject","fail",k.Callbacks("once memory"),"rejected"],["notify","progress",k.Callbacks("memory")]],c="pending",d={state:function(){return c},always:function(){return e.done(arguments).fail(arguments),this},then:function(){var a=arguments;return k.Deferred(function(c){k.each(b,function(b,z){var f=z[0],g=k.isFunction(a[b])&&a[b];e[z[1]](function(){var a=g&&g.apply(this,arguments);a&&k.isFunction(a.promise)?
a.promise().done(c.resolve).fail(c.reject).progress(c.notify):c[f+"With"](this===d?c.promise():this,g?[a]:arguments)})});a=null}).promise()},promise:function(a){return null!=a?k.extend(a,d):d}},e={};return d.pipe=d.then,k.each(b,function(a,z){var f=z[2],g=z[3];d[z[1]]=f.add;g&&f.add(function(){c=g},b[1^a][2].disable,b[2][2].lock);e[z[0]]=function(){return e[z[0]+"With"](this===e?d:this,arguments),this};e[z[0]+"With"]=f.fireWith}),d.promise(e),a&&a.call(e,e),e},when:function(a){var b=0,c=A.call(arguments),
d=c.length,e=1!==d||a&&k.isFunction(a.promise)?d:0,f=1===e?a:k.Deferred(),g=function(a,b,c){return function(d){b[a]=this;c[a]=1<arguments.length?A.call(arguments):d;c===l?f.notifyWith(b,c):--e||f.resolveWith(b,c)}},l,h,n;if(1<d)for(l=Array(d),h=Array(d),n=Array(d);d>b;b++)c[b]&&k.isFunction(c[b].promise)?c[b].promise().done(g(b,n,c)).fail(f.reject).progress(g(b,h,l)):--e;return e||f.resolveWith(n,c),f.promise()}});k.support=function(b){var c,d,e,f,g,l,h=H.createElement("div");if(h.setAttribute("className",
"t"),h.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",c=h.getElementsByTagName("*")||[],d=h.getElementsByTagName("a")[0],!d||!d.style||!c.length)return b;e=H.createElement("select");f=e.appendChild(H.createElement("option"));c=h.getElementsByTagName("input")[0];d.style.cssText="top:1px;float:left;opacity:.5";b.getSetAttribute="t"!==h.className;b.leadingWhitespace=3===h.firstChild.nodeType;b.tbody=!h.getElementsByTagName("tbody").length;b.htmlSerialize=!!h.getElementsByTagName("link").length;
b.style=/top/.test(d.getAttribute("style"));b.hrefNormalized="/a"===d.getAttribute("href");b.opacity=/^0.5/.test(d.style.opacity);b.cssFloat=!!d.style.cssFloat;b.checkOn=!!c.value;b.optSelected=f.selected;b.enctype=!!H.createElement("form").enctype;b.html5Clone="<:nav></:nav>"!==H.createElement("nav").cloneNode(!0).outerHTML;b.inlineBlockNeedsLayout=!1;b.shrinkWrapBlocks=!1;b.pixelPosition=!1;b.deleteExpando=!0;b.noCloneEvent=!0;b.reliableMarginRight=!0;b.boxSizingReliable=!0;c.checked=!0;b.noCloneChecked=
c.cloneNode(!0).checked;e.disabled=!0;b.optDisabled=!f.disabled;try{delete h.test}catch(n){b.deleteExpando=!1}c=H.createElement("input");c.setAttribute("value","");b.input=""===c.getAttribute("value");c.value="t";c.setAttribute("type","radio");b.radioValue="t"===c.value;c.setAttribute("checked","t");c.setAttribute("name","t");d=H.createDocumentFragment();d.appendChild(c);b.appendChecked=c.checked;b.checkClone=d.cloneNode(!0).cloneNode(!0).lastChild.checked;h.attachEvent&&(h.attachEvent("onclick",
function(){b.noCloneEvent=!1}),h.cloneNode(!0).click());for(l in{submit:!0,change:!0,focusin:!0})h.setAttribute(d="on"+l,"t"),b[l+"Bubbles"]=d in a||!1===h.attributes[d].expando;h.style.backgroundClip="content-box";h.cloneNode(!0).style.backgroundClip="";b.clearCloneStyle="content-box"===h.style.backgroundClip;for(l in k(b))break;return b.ownLast="0"!==l,k(function(){var c,d,e,f=H.getElementsByTagName("body")[0];f&&(c=H.createElement("div"),c.style.cssText="border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px",
...
typeof a&&a;if(k.isFunction(a))return this.each(function(b){k(this).addClass(a.call(this,b,this.className))});if(b)for(b=(a||"").match(ba)||[];h>g;g++)if(c=this[g],d=1===c.nodeType&&(c.className?(" "+c.className+" ").replace(Na," "):" ")){for(f=0;e=b[f++];)0>d.indexOf(" "+e+" ")&&(d+=e+" ");c.className=k.trim(d)}return this},removeClass:function(a){var b,c,d,e,f,g=0,h=this.length;b=0===arguments.length||"string"==typeof a&&a;if(k.isFunction(a))return this.each(function(b){k(this).removeClass(a.call(this,
b,this.className))});if(b)for(b=(a||"").match(ba)||[];h>g;g++)if(c=this[g],d=1===c.nodeType&&(c.className?(" "+c.className+" ").replace(Na," "):"")){for(f=0;e=b[f++];)for(;0<=d.indexOf(" "+e+" ");)d=d.replace(" "+e+" "," ");c.className=a?k.trim(d):""}return this},toggleClass:function(a,b){var c=typeof a;return"boolean"==typeof b&&"string"===c?b?this.addClass(a):this.removeClass(a):k.isFunction(a)?this.each(function(c){k(this).toggleClass(a.call(this,c,this.className,b),b)}):this.each(function(){if("string"===
c)for(var b,d=0,e=k(this),f=a.match(ba)||[];b=f[d++];)e.hasClass(b)?e.removeClass(b):e.addClass(b);else(c===R||"boolean"===c)&&(this.className&&k._data(this,"__className__",this.className),this.className=this.className||!1===a?"":k._data(this,"__className__")||"")})},hasClass:function(a){a=" "+a+" ";for(var b=0,c=this.length;c>b;b++)if(1===this[b].nodeType&&0<=(" "+this[b].className+" ").replace(Na," ").indexOf(a))return!0;return!1},val:function(a){var b,c,e,f=this[0];if(arguments.length)return e=
...
m=k.extend({type:p,origType:u,data:e,handler:c,guid:c.guid,selector:f,needsContext:f&&k.expr.match.needsContext.test(f),namespace:g.join(".")},n),(E=h[p])||(E=h[p]=[],E.delegateCount=0,q.setup&&!1!==q.setup.call(a,e,g,A)||(a.addEventListener?a.addEventListener(p,A,!1):a.attachEvent&&a.attachEvent("on"+p,A))),q.add&&(q.add.call(a,m),m.handler.guid||(m.handler.guid=c.guid)),f?E.splice(E.delegateCount++,0,m):E.push(m),k.event.global[p]=!0);a=null}},remove:function(a,b,c,d,e){var f,g,h,l,n,q,A,m,E,p,
u,O=k.hasData(a)&&k._data(a);if(O&&(q=O.events)){b=(b||"").match(ba)||[""];for(n=b.length;n--;)if(h=Ga.exec(b[n])||[],E=u=h[1],p=(h[2]||"").split(".").sort(),E){A=k.event.special[E]||{};E=(d?A.delegateType:A.bindType)||E;m=q[E]||[];h=h[2]&&RegExp("(^|\\.)"+p.join("\\.(?:.*\\.|)")+"(\\.|$)");for(l=f=m.length;f--;)g=m[f],!e&&u!==g.origType||c&&c.guid!==g.guid||h&&!h.test(g.namespace)||d&&d!==g.selector&&("**"!==d||!g.selector)||(m.splice(f,1),g.selector&&m.delegateCount--,A.remove&&A.remove.call(a,
g));l&&!m.length&&(A.teardown&&!1!==A.teardown.call(a,p,O.handle)||k.removeEvent(a,E,O.handle),delete q[E])}else for(E in q)k.event.remove(a,E+b[n],c,d,!0);k.isEmptyObject(q)&&(delete O.handle,k._removeData(a,"events"))}},trigger:function(b,c,e,f){var g,h,l,n,q,A,m=[e||H],E=pa.call(b,"type")?b.type:b;A=pa.call(b,"namespace")?b.namespace.split("."):[];if(l=g=e=e||H,3!==e.nodeType&&8!==e.nodeType&&!hb.test(E+k.event.triggered)&&(0<=E.indexOf(".")&&(A=E.split("."),E=A.shift(),A.sort()),h=0>E.indexOf(":")&&
...
tr:[2,"<table><tbody>","</tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],_default:k.support.htmlSerialize?[0,"",""]:[1,"X<div>","</div>"]},qb=p(H).appendChild(H.createElement("div"));sa.optgroup=sa.option;sa.tbody=sa.tfoot=sa.colgroup=sa.caption=sa.thead;sa.th=sa.td;k.fn.extend({text:function(a){return k.access(this,function(a){return a===d?k.text(this):this.empty().append((this[0]&&this[0].ownerDocument||H).createTextNode(a))},
...
"script"),0<d.length&&K(d,!l&&B(a,"script")),f},buildFragment:function(a,b,c,d){for(var e,f,g,h,l,n,q,A=a.length,m=p(b),E=[],u=0;A>u;u++)if(f=a[u],f||0===f)if("object"===k.type(f))k.merge(E,f.nodeType?[f]:f);else if(Rb.test(f)){h=h||m.appendChild(b.createElement("div"));l=(Ab.exec(f)||["",""])[1].toLowerCase();q=sa[l]||sa._default;h.innerHTML=q[1]+f.replace(zb,"<$1></$2>")+q[2];for(e=q[0];e--;)h=h.lastChild;if(!k.support.leadingWhitespace&&pb.test(f)&&E.push(b.createTextNode(pb.exec(f)[0])),!k.support.tbody)for(e=
...
b},r,{constructor:s,namespace:p,widgetName:b,widgetFullName:l});n?(a.each(n._childConstructors,function(b,c){var d=c.prototype;a.widget(d.namespace+"."+d.widgetName,s,c._proto)}),delete n._childConstructors):c._childConstructors.push(s);a.widget.bridge(b,s)};a.widget.extend=function(c){for(var e,h,l=b.call(arguments,1),n=0,s=l.length;s>n;n++)for(e in l[n])h=l[n][e],l[n].hasOwnProperty(e)&&h!==d&&(c[e]=a.isPlainObject(h)?a.isPlainObject(c[e])?a.widget.extend({},c[e],h):a.widget.extend({},h):h);return c};
a.widget.bridge=function(c,e){var h=e.prototype.widgetFullName||c;a.fn[c]=function(l){var n="string"==typeof l,s=b.call(arguments,1),t=this;return l=!n&&s.length?a.widget.extend.apply(null,[l].concat(s)):l,n?this.each(function(){var b,e=a.data(this,h);return e?a.isFunction(e[l])&&"_"!==l.charAt(0)?(b=e[l].apply(e,s),b!==e&&b!==d?(t=b&&b.jquery?t.pushStack(b.get()):b,!1):d):a.error("no such method '"+l+"' for "+c+" widget instance"):a.error("cannot call methods on "+c+" prior to initialization; attempted to call method '"+
...
h){function r(){return b||!0!==n.options.disabled&&!a(this).hasClass("ui-state-disabled")?("string"==typeof h?n[h]:h).apply(n,arguments):d}"string"!=typeof h&&(r.guid=h.guid=h.guid||r.guid||a.guid++);var p=e.match(/^(\w+)\s*(.*)$/),w=p[1]+n.eventNamespace;(p=p[2])?l.delegate(p,w,r):c.bind(w,r)})},_off:function(a,b){b=(b||"").split(" ").join(this.eventNamespace+" ")+this.eventNamespace;a.unbind(b).undelegate(b)},_delay:function(a,b){var c=this;return setTimeout(function(){return("string"==typeof a?
...
"center";c[1]=n.test(c[1])?c[1]:"center";a=s.exec(c[0]);b=s.exec(c[1]);y[this]=[a?a[0]:0,b?b[0]:0];d[this]=[t.exec(c[0])[0],t.exec(c[1])[0]]}),1===F.length&&(F[1]=F[0]),"right"===d.at[0]?B.left+=r:"center"===d.at[0]&&(B.left+=r/2),"bottom"===d.at[1]?B.top+=K:"center"===d.at[1]&&(B.top+=K/2),e=c(y.at,r,K),B.left+=e[0],B.top+=e[1],this.each(function(){var b,l,n=a(this),p=n.outerWidth(),s=n.outerHeight(),t=parseInt(a.css(this,"marginLeft"),10)||0,L=parseInt(a.css(this,"marginTop"),10)||0,W=p+t+(parseInt(a.css(this,
"marginRight"),10)||0)+N.width,X=s+L+(parseInt(a.css(this,"marginBottom"),10)||0)+N.height,q=a.extend({},B),I=c(y.my,n.outerWidth(),n.outerHeight());"right"===d.my[0]?q.left-=p:"center"===d.my[0]&&(q.left-=p/2);"bottom"===d.my[1]?q.top-=s:"center"===d.my[1]&&(q.top-=s/2);q.left+=I[0];q.top+=I[1];a.support.offsetFractions||(q.left=h(q.left),q.top=h(q.top));b={marginLeft:t,marginTop:L};a.each(["left","top"],function(c,f){a.ui.position[F[c]]&&a.ui.position[F[c]][f](q,{targetWidth:r,targetHeight:K,elemWidth:p,
elemHeight:s,collisionPosition:b,collisionWidth:W,collisionHeight:X,offset:[e[0]+I[0],e[1]+I[1]],my:d.my,at:d.at,within:C,elem:n})});d.using&&(l=function(a){var b=O.left-q.left,c=b+r-p,e=O.top-q.top,h=e+K-s,l={target:{element:m,left:O.left,top:O.top,width:r,height:K},element:{element:n,left:q.left,top:q.top,width:p,height:s},horizontal:0>c?"left":0<b?"right":"center",vertical:0>h?"top":0<e?"bottom":"middle"};p>r&&r>g(b+c)&&(l.horizontal="center");s>K&&K>g(e+h)&&(l.vertical="middle");l.important=f(g(b),
...
"right"===b.my[0]?b.elemWidth:0,s="left"===b.at[0]?b.targetWidth:"right"===b.at[0]?-b.targetWidth:0,t=-2*b.offset[0];0>n?(c=a.left+p+s+t+b.collisionWidth-h-f,(0>c||g(n)>c)&&(a.left+=p+s+t)):0<l&&(d=a.left-b.collisionPosition.marginLeft+p+s+t-e,(0<d||l>g(d))&&(a.left+=p+s+t))},top:function(a,b){var c,d,e=b.within,f=e.offset.top+e.scrollTop,h=e.height,e=e.isWindow?e.scrollTop:e.offset.top,l=a.top-b.collisionPosition.marginTop,n=l-e,l=l+b.collisionHeight-h-e,p="top"===b.my[1]?-b.elemHeight:"bottom"===
b.my[1]?b.elemHeight:0,s="top"===b.at[1]?b.targetHeight:"bottom"===b.at[1]?-b.targetHeight:0,t=-2*b.offset[1];0>n?(d=a.top+p+s+t+b.collisionHeight-h-f,a.top+p+s+t>n&&(0>d||g(n)>d)&&(a.top+=p+s+t)):0<l&&(c=a.top-b.collisionPosition.marginTop+p+s+t-e,a.top+p+s+t>l&&(0<c||l>g(c))&&(a.top+=p+s+t))}},flipfit:{left:function(){a.ui.position.flip.left.apply(this,arguments);a.ui.position.fit.left.apply(this,arguments)},top:function(){a.ui.position.flip.top.apply(this,arguments);a.ui.position.fit.top.apply(this,
...
top:c.top,left:c.left})})},drag:function(d,c){var b,e,f,g,h,l,n,s,t,r,p=a(this).data("ui-draggable"),w=p.options,v=w.snapTolerance,D=c.offset.left,K=D+p.helperProportions.width,O=c.offset.top,B=O+p.helperProportions.height;for(t=p.snapElements.length-1;0<=t;t--)h=p.snapElements[t].left,l=h+p.snapElements[t].width,n=p.snapElements[t].top,s=n+p.snapElements[t].height,h-v>K||D>l+v||n-v>B||O>s+v||!a.contains(p.snapElements[t].item.ownerDocument,p.snapElements[t].item)?(p.snapElements[t].snapping&&p.options.snap.release&&
p.options.snap.release.call(p.element,d,a.extend(p._uiHash(),{snapItem:p.snapElements[t].item})),p.snapElements[t].snapping=!1):("inner"!==w.snapMode&&(b=v>=Math.abs(n-B),e=v>=Math.abs(s-O),f=v>=Math.abs(h-K),g=v>=Math.abs(l-D),b&&(c.position.top=p._convertPositionTo("relative",{top:n-p.helperProportions.height,left:0}).top-p.margins.top),e&&(c.position.top=p._convertPositionTo("relative",{top:s,left:0}).top-p.margins.top),f&&(c.position.left=p._convertPositionTo("relative",{top:0,left:h-p.helperProportions.width}).left-
p.margins.left),g&&(c.position.left=p._convertPositionTo("relative",{top:0,left:l}).left-p.margins.left)),r=b||e||f||g,"outer"!==w.snapMode&&(b=v>=Math.abs(n-O),e=v>=Math.abs(s-B),f=v>=Math.abs(h-D),g=v>=Math.abs(l-K),b&&(c.position.top=p._convertPositionTo("relative",{top:n,left:0}).top-p.margins.top),e&&(c.position.top=p._convertPositionTo("relative",{top:s-p.helperProportions.height,left:0}).top-p.margins.top),f&&(c.position.left=p._convertPositionTo("relative",{top:0,left:h}).left-p.margins.left),
g&&(c.position.left=p._convertPositionTo("relative",{top:0,left:l-p.helperProportions.width}).left-p.margins.left)),!p.snapElements[t].snapping&&(b||e||f||g||r)&&p.options.snap.snap&&p.options.snap.snap.call(p.element,d,a.extend(p._uiHash(),{snapItem:p.snapElements[t].item})),p.snapElements[t].snapping=b||e||f||g||r)}});a.ui.plugin.add("draggable","stack",{start:function(){var d,c=this.data("ui-draggable").options,c=a.makeArray(a(c.stack)).sort(function(b,c){return(parseInt(a(b).css("zIndex"),10)||
...
n.height()},this.originalMousePosition={left:b.pageX,top:b.pageY},this.aspectRatio="number"==typeof h.aspectRatio?h.aspectRatio:this.originalSize.width/this.originalSize.height||1,g=a(".ui-resizable-"+this.axis).css("cursor"),a("body").css("cursor","auto"===g?this.axis+"-resize":g),n.addClass("ui-resizable-resizing"),this._propagate("start",b),!0},_mouseDrag:function(b){var c,d=this.helper,g={},h=this.originalMousePosition,l=this.position.top,n=this.position.left,s=this.size.width,t=this.size.height,
r=b.pageX-h.left||0,h=b.pageY-h.top||0,p=this._change[this.axis];return p?(c=p.apply(this,[b,r,h]),this._updateVirtualBoundaries(b.shiftKey),(this._aspectRatio||b.shiftKey)&&(c=this._updateRatio(c,b)),c=this._respectSize(c,b),this._updateCache(c),this._propagate("resize",b),this.position.top!==l&&(g.top=this.position.top+"px"),this.position.left!==n&&(g.left=this.position.left+"px"),this.size.width!==s&&(g.width=this.size.width+"px"),this.size.height!==t&&(g.height=this.size.height+"px"),d.css(g),
!this._helper&&this._proportionallyResizeElements.length&&this._proportionallyResize(),a.isEmptyObject(g)||this._trigger("resize",b,this.ui()),!1):!1},_mouseStop:function(b){this.resizing=!1;var c,d,g,h,l,n,s,t=this.options;return this._helper&&(c=this._proportionallyResizeElements,d=c.length&&/textarea/i.test(c[0].nodeName),g=d&&a.ui.hasScroll(c[0],"left")?0:this.sizeDiff.height,h=d?0:this.sizeDiff.width,l={width:this.helper.width()-h,height:this.helper.height()-g},n=parseInt(this.element.css("left"),
10)+(this.position.left-this.originalPosition.left)||null,s=parseInt(this.element.css("top"),10)+(this.position.top-this.originalPosition.top)||null,t.animate||this.element.css(a.extend(l,{top:s,left:n})),this.helper.height(this.size.height),this.helper.width(this.size.width),this._helper&&!t.animate&&this._proportionallyResize()),a("body").css("cursor","auto"),this.element.removeClass("ui-resizable-resizing"),this._propagate("stop",b),this._helper&&this.helper.remove(),!1},_updateVirtualBoundaries:function(a){var d,
...
this._vBoundaries,f=this.axis,g=c(a.width)&&d.maxWidth&&d.maxWidth<a.width,h=c(a.height)&&d.maxHeight&&d.maxHeight<a.height,l=c(a.width)&&d.minWidth&&d.minWidth>a.width,n=c(a.height)&&d.minHeight&&d.minHeight>a.height,s=this.originalPosition.left+this.originalSize.width,t=this.position.top+this.size.height,r=/sw|nw|w/.test(f),f=/nw|ne|n/.test(f);return l&&(a.width=d.minWidth),n&&(a.height=d.minHeight),g&&(a.width=d.maxWidth),h&&(a.height=d.maxHeight),l&&r&&(a.left=s-d.minWidth),g&&r&&(a.left=s-d.maxWidth),
...
10)};g&&g.length&&a(g[0]).css({width:d.width,height:d.height});c._updateCache(d);c._propagate("resize",b)}})}});a.ui.plugin.add("resizable","containment",{start:function(){var b,c,f,g,h,l,n,s=a(this).data("ui-resizable"),t=s.element,r=s.options.containment;(t=r instanceof a?r.get(0):/parent/.test(r)?t.parent().get(0):r)&&(s.containerElement=a(t),/document/.test(r)||r===document?(s.containerOffset={left:0,top:0},s.containerPosition={left:0,top:0},s.parentData={element:a(document),left:0,top:0,width:a(document).width(),
height:a(document).height()||document.body.parentNode.scrollHeight}):(b=a(t),c=[],a(["Top","Right","Left","Bottom"]).each(function(a,f){c[a]=d(b.css("padding"+f))}),s.containerOffset=b.offset(),s.containerPosition=b.position(),s.containerSize={height:b.innerHeight()-c[3],width:b.innerWidth()-c[1]},f=s.containerOffset,g=s.containerSize.height,h=s.containerSize.width,l=a.ui.hasScroll(t,"left")?t.scrollWidth:h,n=a.ui.hasScroll(t)?t.scrollHeight:g,s.parentData={element:t,left:f.left,top:f.top,width:l,
...
(l.size.width=l.parentData.width-c,b&&(l.size.height=l.size.width/l.aspectRatio));d+l.size.height>=l.parentData.height&&(l.size.height=l.parentData.height-d,b&&(l.size.width=l.size.height*l.aspectRatio))},stop:function(){var b=a(this).data("ui-resizable"),c=b.options,d=b.containerOffset,g=b.containerPosition,h=b.containerElement,l=a(b.helper),n=l.offset(),s=l.outerWidth()-b.sizeDiff.width,l=l.outerHeight()-b.sizeDiff.height;b._helper&&!c.animate&&/relative/.test(h.css("position"))&&a(this).css({left:n.left-
g.left-d.left,width:s,height:l});b._helper&&!c.animate&&/static/.test(h.css("position"))&&a(this).css({left:n.left-g.left-d.left,width:s,height:l})}});a.ui.plugin.add("resizable","alsoResize",{start:function(){var b=a(this).data("ui-resizable").options,c=function(b){a(b).each(function(){var b=a(this);b.data("ui-resizable-alsoresize",{width:parseInt(b.width(),10),height:parseInt(b.height(),10),left:parseInt(b.css("left"),10),top:parseInt(b.css("top"),10)})})};"object"!=typeof b.alsoResize||b.alsoResize.parentNode?
c(b.alsoResize):b.alsoResize.length?(b.alsoResize=b.alsoResize[0],c(b.alsoResize)):a.each(b.alsoResize,function(a){c(a)})},resize:function(b,c){var d=a(this).data("ui-resizable"),g=d.options,h=d.originalSize,l=d.originalPosition,n={height:d.size.height-h.height||0,width:d.size.width-h.width||0,top:d.position.top-l.top||0,left:d.position.left-l.left||0},s=function(b,d){a(b).each(function(){var b=a(this),f=a(this).data("ui-resizable-alsoresize"),g={},h=d&&d.length?d:b.parents(c.originalElement[0]).length?
["width","height"]:["width","height","top","left"];a.each(h,function(a,b){var c=(f[b]||0)+(n[b]||0);c&&0<=c&&(g[b]=c||null)});b.css(g)})};"object"!=typeof g.alsoResize||g.alsoResize.nodeType?s(g.alsoResize):a.each(g.alsoResize,function(a,b){s(a,b)})},stop:function(){a(this).removeData("resizable-alsoresize")}});a.ui.plugin.add("resizable","ghost",{start:function(){var b=a(this).data("ui-resizable"),c=b.options,d=b.size;b.ghost=b.originalElement.clone();b.ghost.css({opacity:0.25,display:"block",position:"relative",
height:d.height,width:d.width,margin:0,left:0,top:0}).addClass("ui-resizable-ghost").addClass("string"==typeof c.ghost?c.ghost:"");b.ghost.appendTo(b.helper)},resize:function(){var b=a(this).data("ui-resizable");b.ghost&&b.ghost.css({position:"relative",height:b.size.height,width:b.size.width})},stop:function(){var b=a(this).data("ui-resizable");b.ghost&&b.helper&&b.helper.get(0).removeChild(b.ghost.get(0))}});a.ui.plugin.add("resizable","grid",{resize:function(){var b=a(this).data("ui-resizable"),
c=b.options,d=b.size,g=b.originalSize,h=b.originalPosition,l=b.axis,n="number"==typeof c.grid?[c.grid,c.grid]:c.grid,s=n[0]||1,t=n[1]||1,r=Math.round((d.width-g.width)/s)*s,d=Math.round((d.height-g.height)/t)*t,p=g.width+r,g=g.height+d,w=c.maxWidth&&p>c.maxWidth,v=c.maxHeight&&g>c.maxHeight,D=c.minWidth&&c.minWidth>p,K=c.minHeight&&c.minHeight>g;c.grid=n;D&&(p+=s);K&&(g+=t);w&&(p-=s);v&&(g-=t);/^(se|s|e)$/.test(l)?(b.size.width=p,b.size.height=g):/^(ne)$/.test(l)?(b.size.width=p,b.size.height=g,b.position.top=
h.top-d):/^(sw)$/.test(l)?(b.size.width=p,b.size.height=g,b.position.left=h.left-r):(b.size.width=p,b.size.height=g,b.position.top=h.top-d,b.position.left=h.left-r)}})})(jQuery);
...
!1):void 0}))},_mouseDrag:function(d){if(this.dragged=!0,!this.options.disabled){var c,b=this,e=this.options,f=this.opos[0],g=this.opos[1],h=d.pageX,l=d.pageY;return f>h&&(c=h,h=f,f=c),g>l&&(c=l,l=g,g=c),this.helper.css({left:f,top:g,width:h-f,height:l-g}),this.selectees.each(function(){var c=a.data(this,"selectable-item"),s=!1;c&&c.element!==b.element[0]&&("touch"===e.tolerance?s=!(c.left>h||f>c.right||c.top>l||g>c.bottom):"fit"===e.tolerance&&(s=c.left>f&&h>c.right&&c.top>g&&l>c.bottom),s?(c.selected&&
...
g=f+this.helperProportions.height,h=a.left,l=h+a.width,n=a.top,s=n+a.height,t=this.offset.click.top,r=this.offset.click.left,r="y"===this.options.axis||b+r>h&&l>b+r,t=("x"===this.options.axis||f+t>n&&s>f+t)&&r;return"pointer"===this.options.tolerance||this.options.forcePointerForContainers||"pointer"!==this.options.tolerance&&this.helperProportions[this.floating?"width":"height"]>a[this.floating?"width":"height"]?t:b+this.helperProportions.width/2>h&&l>d-this.helperProportions.width/2&&f+this.helperProportions.height/
2>n&&s>g-this.helperProportions.height/2},_intersectsWithPointer:function(a){var b="y"===this.options.axis||this.positionAbs.left+this.offset.click.left>a.left&&a.left+a.width>this.positionAbs.left+this.offset.click.left;a=("x"===this.options.axis||this.positionAbs.top+this.offset.click.top>a.top&&a.top+a.height>this.positionAbs.top+this.offset.click.top)&&b;var b=this._getDragVerticalDirection(),d=this._getDragHorizontalDirection();return a?this.floating?d&&"right"===d||"down"===b?2:1:b&&("down"===
...
f=null;g=(t=e.floating||d(this.currentItem))?"left":"top";h=t?"width":"height";l=this.positionAbs[g]+this.offset.click[g];for(e=this.items.length-1;0<=e;e--)a.contains(this.containers[r].element[0],this.items[e].item[0])&&this.items[e].item[0]!==this.currentItem[0]&&(!t||this.positionAbs.top+this.offset.click.top>this.items[e].top&&this.items[e].top+this.items[e].height>this.positionAbs.top+this.offset.click.top)&&(n=this.items[e].item.offset()[g],s=!1,Math.abs(n-l)>Math.abs(n+this.items[e][h]-l)&&
(s=!0,n+=this.items[e][h]),b>Math.abs(n-l)&&(b=Math.abs(n-l),f=this.items[e],this.direction=s?"up":"down"));(f||this.options.dropOnEmpty)&&this.currentContainer!==this.containers[r]&&(f?this._rearrange(c,f,null,!0):this._rearrange(c,null,this.containers[r].element,!0),this._trigger("change",c,this._uiHash()),this.containers[r]._trigger("change",c,this._uiHash(this)),this.currentContainer=this.containers[r],this.options.placeholder.update(this.currentContainer,this.placeholder),this.containers[r]._trigger("over",
...
if(J.showAlpha){d=b.toRgb();d.a=0;var d=tinycolor(d).toRgbString(),e="linear-gradient(left, "+d+", "+c+")";w?ia.css("filter",tinycolor(d).toFilter({gradientType:1},c)):(ia.css("background","-webkit-"+e),ia.css("background","-moz-"+e),ia.css("background","-ms-"+e),ia.css("background",e))}J.showInput&&(1>qa&&("hex"===a||"name"===a)&&(a="rgb"),ga.val(b.toString(a)));J.showPalette&&N();F()}function q(){var a=la*ja,b=oa-pa*oa,a=Math.max(-ha,Math.min(ja-ha,a-ha)),b=Math.max(-ha,Math.min(oa-ha,b-ha));fb.css({top:b,
left:a});Qa.css({left:qa*va-ea/2});gb.css({top:Y*ka-A})}function I(a){var b=M();Ya&&ra.val(b.toString(Oa)).change();var c=!tinycolor.equals(b,fa);fa=b;m(b);a&&c&&da.change(b)}function x(){ja=Ma.width();oa=Ma.height();ha=fb.height();Va.width();ka=Va.height();A=gb.height();va=Wa.width();ea=Qa.width();u||T.offset(g(T,ya));q()}function G(){P();Ua=!0;ra.attr("disabled",!0);ya.addClass("sp-disabled")}var J=e(h,f),u=J.flat,E=J.showSelectionPalette,aa=J.localStorageKey,R=J.theme,da=J.callbacks,H=t(x,10),
ma=!1,ja=0,oa=0,ha=0,ka=0,va=0,ea=0,A=0,Y=0,la=0,pa=0,qa=1,k=J.palette.slice(0),wa=d.isArray(k[0])?k:[k],ba=J.selectionPalette.slice(0),Ta="sp-dragging",La=f.ownerDocument,eb=La.body,ra=d(f),Ua=!1,T=d(K,La).addClass(R),Ma=T.find(".sp-color"),fb=T.find(".sp-dragger"),Va=T.find(".sp-hue"),gb=T.find(".sp-slider"),ia=T.find(".sp-alpha-inner"),Wa=T.find(".sp-alpha"),Qa=T.find(".sp-alpha-handle"),ga=T.find(".sp-input"),bb=T.find(".sp-palette"),xa=T.find(".sp-initial"),Xa=T.find(".sp-cancel"),Na=T.find(".sp-choose"),
Ya=ra.is("input"),Za=Ya&&!u,Aa=Za?d(D).addClass(R):d([]),ya=Za?Aa:ra,ta=Aa.find(".sp-preview-inner"),za=J.color||Ya&&ra.val(),fa=!1,$a=J.preferredFormat,Oa=$a,hb=!J.showButtons||J.clickoutFiresChange;(function(){function b(a){a.data&&a.data.ignore?(ca(d(this).data("color")),W()):(ca(d(this).data("color")),I(!0),W(),P());return!1}w&&T.find("*:not(input)").attr("unselectable","on");n();Za&&ra.hide().after(Aa);u?ra.after(T).hide():d(eb).append(T.hide());if(aa&&a.localStorage){try{var c=a.localStorage[aa].split(",#");
1<c.length&&(delete a.localStorage[aa],d.each(c,function(a,b){m(b)}))}catch(e){}try{ba=a.localStorage[aa].split(";")}catch(f){}}ya.bind("click.spectrum touchstart.spectrum",function(a){Ua||V();a.stopPropagation();d(a.target).is("input")||a.preventDefault()});(ra.is(":disabled")||!0===J.disabled)&&G();T.click(l);ga.change(U);ga.bind("paste",function(){setTimeout(U,1)});ga.keydown(function(a){13==a.keyCode&&U()});Xa.text(J.cancelText);Xa.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();
P("cancel")});Na.text(J.chooseText);Na.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();ga.hasClass("sp-validation-error")||(I(!0),P())});s(Wa,function(a,b,c){qa=a/va;c.shiftKey&&(qa=Math.round(10*qa)/10);W()});s(Va,function(a,b){Y=parseFloat(b/ka);W()},y,S);s(Ma,function(a,b){la=parseFloat(a/ja);pa=parseFloat((oa-b)/oa);W()},y,S);za?(ca(za),X(),Oa=$a||tinycolor(za).format,m(za)):X();u&&Z();c=w?"mousedown.spectrum":"click.spectrum touchstart.spectrum";bb.delegate(".sp-thumb-el",
c,b);xa.delegate(".sp-thumb-el:nth-child(1)",c,{ignore:!0},b)})();var Ga={show:Z,hide:P,toggle:V,reflow:x,option:function(a,b){if(a===c)return d.extend({},J);if(b===c)return J[a];J[a]=b;n()},enable:function(){Ua=!1;ra.attr("disabled",!1);ya.removeClass("sp-disabled")},disable:G,set:function(a){ca(a);I()},get:M,destroy:function(){ra.show();ya.unbind("click.spectrum touchstart.spectrum");T.remove();Aa.remove();p[Ga.id]=null},container:T};Ga.id=p.push(Ga)-1;return Ga}function g(a,b){var c=a.outerWidth(),
...
0));1>b.r&&(b.r=r(b.r));1>b.g&&(b.g=r(b.g));1>b.b&&(b.b=r(b.b));return{ok:f,format:a&&a.format||g,r:b.r,g:b.g,b:b.b,a:d}}function d(a,b,c){a=h(a,255);b=h(b,255);c=h(c,255);var e=w(a,b,c),f=D(a,b,c),g,l=(e+f)/2;if(e==f)g=f=0;else{var q=e-f,f=0.5<l?q/(2-e-f):q/(e+f);switch(e){case a:g=(b-c)/q+(b<c?6:0);break;case b:g=(c-a)/q+2;break;case c:g=(a-b)/q+4}g/=6}return{h:g,s:f,l:l}}function e(a,b,c){function d(a,b,c){0>c&&(c+=1);1<c&&(c-=1);return c<1/6?a+6*(b-a)*c:0.5>c?b:c<2/3?a+6*(b-a)*(2/3-c):a}a=h(a,
...
y(function(a,b){m.has(a,b)?a[b]++:a[b]=1});m.sortedIndex=function(a,b,c,d){c=null==c?m.identity:F(c);b=c.call(d,b);for(var e=0,f=a.length;f>e;){var g=e+f>>>1;c.call(d,a[g])<b?e=g+1:f=g}return e};m.toArray=function(a){return a?m.isArray(a)?g.call(a):a.length===+a.length?m.map(a,m.identity):m.values(a):[]};m.size=function(a){return null==a?0:a.length===+a.length?a.length:m.keys(a).length};m.first=m.head=m.take=function(a,b,c){return null==a?void 0:null==b||c?a[0]:g.call(a,0,b)};m.initial=function(a,
...
/\x3c!--[^\0]*?--\x3e/)("closed",/<(tag)[^\0]+?<\/\1>/)("closing",/<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g,h())();r.paragraph=function(){var a=r.paragraph.source,b=[];(function m(a){a=r[a]?r[a].source:a;b.push(a.replace(/(^|[^\[])\^/g,"$1"));return m})("hr")("heading")("lheading")("blockquote")("<"+h())("def");return RegExp(a.replace("body",b.join("|")))}();r.normal={fences:r.fences,paragraph:r.paragraph};r.gfm={fences:/^ *(```|~~~) *(\w+)? *\n([^\0]+?)\s*\1 *(?:\n+|$)/,paragraph:/^/};r.gfm.paragraph=
...
String(m):"null";case "boolean":case "null":return String(m);case "object":if(!m)return"null";n+=s;L=[];if("[object Array]"===Object.prototype.toString.apply(m)){l=m.length;for(d=0;d<l;d+=1)L[d]=f(d,m)||"null";h=0===L.length?"[]":n?"[\n"+n+L.join(",\n"+n)+"\n"+t+"]":"["+L.join(",")+"]";n=t;return h}if(r&&"object"===typeof r)for(l=r.length,d=0;d<l;d+=1)"string"===typeof r[d]&&(g=r[d],(h=f(g,m))&&L.push(e(g)+(n?": ":":")+h));else for(g in m)Object.prototype.hasOwnProperty.call(m,g)&&(h=f(g,m))&&L.push(e(g)+
(n?": ":":")+h);h=0===L.length?"{}":n?"{\n"+n+L.join(",\n"+n)+"\n"+t+"}":"{"+L.join(",")+"}";n=t;return h}}if(c&&c.parse)return a.JSON={parse:c.parse,stringify:c.stringify};var g=a.JSON={},h=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,l=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,n,s,t={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},
r;g.stringify=function(a,b,c){var d;s=n="";if("number"===typeof c)for(d=0;d<c;d+=1)s+=" ";else"string"===typeof c&&(s=c);if((r=b)&&"function"!==typeof b&&("object"!==typeof b||"number"!==typeof b.length))throw Error("JSON.stringify");return f("",{"":a})};g.parse=function(a,b){function c(a,d){var e,f,g=a[d];if(g&&"object"===typeof g)for(e in g)Object.prototype.hasOwnProperty.call(g,e)&&(f=c(g,e),void 0!==f?g[e]=f:delete g[e]);return b.call(a,d,g)}var d;a=String(a);h.lastIndex=0;h.test(a)&&(a=a.replace(h,
...
t=f.length,s=0;s<t;s++)"movie"!=f[s].getAttribute("name").toLowerCase()&&(m[f[s].getAttribute("name")]=f[s].getAttribute("value"));l(e,m,c,d)}else n(f),d&&d(e);else K(c,!0),d&&(e.success=!0,e.ref=g(c),d(e))}else K(c,!0),d&&((c=g(c))&&typeof c.SetVariable!=B&&(e.success=!0,e.ref=c),d(e))}}function g(a){var b=null;(a=p(a))&&"OBJECT"==a.nodeName&&(typeof a.SetVariable!=B?b=a:(a=a.getElementsByTagName(L)[0])&&(b=a));return b}function h(){return!I&&v("6.0.65")&&(u.win||u.mac)&&!(u.wk&&312>u.wk)}function l(a,
...
typeof encodeURIComponent!=B?encodeURIComponent(a):a}var B="undefined",L="object",m="application/x-shockwave-flash",C="SWFObjectExprInst",N=window,F=document,y=navigator,S=!1,U=[function(){S?e():f()}],V=[],Z=[],P=[],ca,M,W,X,q=!1,I=!1,x,G,J=!0,u=function(){var a=typeof F.getElementById!=B&&typeof F.getElementsByTagName!=B&&typeof F.createElement!=B,b=y.userAgent.toLowerCase(),c=y.platform.toLowerCase(),d=c?/win/.test(c):/win/.test(b),c=c?/mac/.test(c):/mac/.test(b),b=/webkit/.test(b)?parseFloat(b.replace(/^.*webkit\/(\d+(\.\d+)?).*$/,
...
for(c=0;c<b;c++)r(Z[c]);for(var d in u)u[d]=null;u=null;for(var e in a)a[e]=null;a=null})})();return{registerObject:function(a,b,c,d){if(u.w3&&a&&b){var e={};e.id=a;e.swfVersion=b;e.expressInstall=c;e.callbackFn=d;V[V.length]=e;K(a,!1)}else d&&d({success:!1,id:a})},getObjectById:function(a){if(u.w3)return g(a)},embedSWF:function(a,b,d,e,f,g,n,m,s,p){var r={success:!1,id:b};u.w3&&!(u.wk&&312>u.wk)&&a&&b&&d&&e&&f?(K(b,!1),c(function(){d+="";e+="";var c={};if(s&&typeof s===L)for(var A in s)c[A]=s[A];
c.data=a;c.width=d;c.height=e;A={};if(m&&typeof m===L)for(var Y in m)A[Y]=m[Y];if(n&&typeof n===L)for(var q in n)A.flashvars=typeof A.flashvars!=B?A.flashvars+("&"+q+"="+n[q]):q+"="+n[q];if(v(f))Y=t(c,A,b),c.id==b&&K(b,!0),r.success=!0,r.ref=Y;else{if(g&&h()){c.data=g;l(c,A,b,p);return}K(b,!0)}p&&p(r)})):p&&p(r)},switchOffAutoHideShow:function(){J=!1},ua:u,getFlashPlayerVersion:function(){return{major:u.pv[0],minor:u.pv[1],release:u.pv[2]}},hasFlashPlayerVersion:v,createSWF:function(a,b,c){if(u.w3)return t(a,
...
"https":"http"};e.check=function(a,d){try{var e=c.util.request(d),f=b.XDomainRequest&&e instanceof XDomainRequest,s=a&&a.options&&a.options.secure?"https:":"http:",t=b.location&&s!=b.location.protocol;if(e&&(!f||!t))return!0}catch(r){}return!1};e.xdomainCheck=function(a){return e.check(a,!0)}})("undefined"!=typeof io?io.Transport:module.exports,"undefined"!=typeof io?io:module.parent.exports,this);(function(a,c){function b(a){c.Transport.XHR.apply(this,arguments)}a.htmlfile=b;c.util.inherit(b,c.Transport.XHR);
...
7),year:d.year()}}function m(b){var c=b._i,d=b._f;if(null===c||""===c)b=null;else{"string"==typeof c&&(b._i=c=r().preparse(c));if(y.isMoment(c))b=g({},c),b._d=new Date(+c._d);else if(d)if("[object Array]"===Object.prototype.toString.call(d)){var c=b,f,h,k,l=99;for(k=0;k<c._f.length;k++)f=g({},c),f._f=c._f[k],O(f),d=new e(f),f=s(f._a,d.toArray()),d._il&&(f+=d._il.length),l>f&&(l=f,h=d);g(c,h)}else O(b);else if(h=b,c=h._i,d=P.exec(c),c===a)h._d=new Date;else if(d)h._d=new Date(+d[1]);else if("string"==
...
338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298],f=[1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225],g=Array(64),h,w,v,D,K,O,B,L,m,C,N,F;a[d>>5]|=128<<24-d%
32;a[(d+64>>9<<4)+15]=d;for(m=0;m<a.length;m+=16){h=f[0];w=f[1];v=f[2];D=f[3];K=f[4];O=f[5];B=f[6];L=f[7];for(C=0;64>C;C++)g[C]=16>C?a[C+m]:c(c(c(b(g[C-2],17)^b(g[C-2],19)^g[C-2]>>>10,g[C-7]),b(g[C-15],7)^b(g[C-15],18)^g[C-15]>>>3),g[C-16]),N=c(c(c(c(L,b(K,6)^b(K,11)^b(K,25)),K&O^~K&B),e[C]),g[C]),F=c(b(h,2)^b(h,13)^b(h,22),h&w^h&v^w&v),L=B,B=O,O=K,K=c(D,N),D=v,v=w,w=h,h=c(N,F);f[0]=c(h,f[0]);f[1]=c(w,f[1]);f[2]=c(v,f[2]);f[3]=c(D,f[3]);f[4]=c(K,f[4]);f[5]=c(O,f[5]);f[6]=c(B,f[6]);f[7]=c(L,f[7])}return f},
f=function(a){for(var b=[],c=(1<<d)-1,e=0;e<a.length*d;e+=d)b[e>>5]|=(a.charCodeAt(e/d)&c)<<24-e%32;return b},g=function(a){for(var b="",c=0;c<4*a.length;c++)b+="0123456789abcdef".charAt(a[c>>2]>>8*(3-c%4)+4&15)+"0123456789abcdef".charAt(a[c>>2]>>8*(3-c%4)&15);return b},h=function(b){return b="object"==typeof b?a(b).val():b.toString()};a.extend({sha256:function(a){a=h(a);return g(e(f(a),a.length*d))},sha256hmac:function(a,b){a=h(a);b=h(b);var c,t=a;c=b;var r=f(t);16<r.length&&(r=e(r,t.length*d));
for(var p=Array(16),t=Array(16),w=0;16>w;w++)p[w]=r[w]^909522486,t[w]=r[w]^1549556828;c=e(p.concat(f(c)),512+c.length*d);c=e(t.concat(c),768);return g(c)},sha256config:function(a){d=parseInt(a)||8}});a.fn.sha256=function(b){a.sha256config(b);b=h(a(this).val());b=a.sha256(b);a.sha256config(8);return b}})(jQuery);function Space(a){this._pairs=[];this.events={};this._load(a);return this}Space.version="0.5.4";Space.arrayDelete=function(a,d){return a.slice(0,d).concat(a.slice(d+1))};Space.isXPath=function(a){return a.match(/ /)};
...
Space.prototype.diff=function(a){var d=new Space;a instanceof Space||(a=new Space(a));this.each(function(b,c){var f=a._getValueByKey(b);if("undefined"===typeof f)return d._setPair(b,""),!0;if(typeof this._getValueByKey(b)!==typeof f)return"object"===typeof f?d._setPair(b,new Space(f)):this._getValueByKey(b)!=f&&d._setPair(b,f),!0;if("object"!==typeof this._getValueByKey(b))return this._getValueByKey(b)!=f&&d._setPair(b,f),!0;f=this._getValueByKey(b).diff(f);f.length()&&d._setPair(b,f)});var c=this;
...
Space.prototype._getValueBySpace=function(a){var d=new Space,c=this;a.each(function(b,e){var f=c._getValueByKey(b);if("undefined"===typeof f)return!0;if(!(a._getValueByKey(b)instanceof Space&&a._getValueByKey(b).length()))return d._setPair(b,f),!0;if(!(f instanceof Space))return!0;d._setPair(b,f._getValueBySpace(a._getValueByKey(b)))});return d};
...
(function(a){function d(a){a=String(a);return a.charAt(0).toUpperCase()+a.slice(1)}function c(a,b){var c=-1,d=a.length;if(d==d>>>0)for(;++c<d;)b(a[c],c,a);else e(a,b)}function b(a){a=s(a);return/^(?:webOS|i(?:OS|P))/.test(a)?a:d(a)}function e(a,b){for(var c in a)g(a,c)&&b(a[c],c,a)}function f(a){return null==a?d(a):D.call(a).slice(8,-1)}function g(){g=function(a,b){var c=null!=a&&(a.constructor||Object).prototype;return!!c&&b in Object(a)&&!(b in c&&a[b]===c[b])};"Function"==f(m)?g=function(a,b){return null!=
...
(x=null),(m=G||J||u)&&(G||J||/Android|Symbian OS|Tablet OS|webOS/.test(u))&&(x=/[a-z]+(?: Hat)?/i.exec(/Android/.test(u)?u:m)+" Browser");q||(q=g(["(?:Cloud9|CriOS|CrMo|Opera ?Mini|Raven|Silk(?!/[\\d.]+$))","Version",l(x),"(?:Firefox|Minefield|NetFront)"]));if("iCab"==I&&3<parseFloat(q))I=["WebKit"];else if(m=/Opera/.test(x)&&"Presto"||/\b(?:Midori|Nook|Safari)\b/i.test(c)&&"WebKit"||!I&&/\bMSIE\b/i.test(c)&&(/^Mac/.test(u)?"Tasman":"Trident"))I=[m];if(X){if(h(a,"global"))if(K&&(m=K.lang.System,p=
m.getProperty("os.arch"),u=u||m.getProperty("os.name")+" "+m.getProperty("os.version")),"object"==typeof exports&&exports)if(y==r&&"object"==typeof system&&(m=[system])[0]){u||(u=m[0].os||null);try{m[1]=require("ringo/engine").version,q=m[1].join("."),x="RingoJS"}catch(E){m[0].global==w&&(x="Narwhal")}}else"object"==typeof process&&(m=process)&&(x="Node.js",p=m.arch,u=m.platform,q=/[\d.]+/.exec(m.version)[0]);else"Environment"==f(a.environment)&&(x="Rhino");else"ScriptBridgingProxyObject"==f(m=a.runtime)?
...
global&&(global==global.global?a=global:global),v=/Opera/,D={}.toString,K=/Java/.test(f(a.java))&&a.java,O=K?"a":"\u03b1",B=K?"b":"\u03b2",L=a.document||{},m={}.hasOwnProperty,C=a.navigator||{},N=a.operamini||a.opera,F=v.test(F=f(N))?F:N=null,y=this,S=C.userAgent||"";"function"==typeof define&&"object"==typeof define.amd&&define.amd?define(function(){return t()}):p?e(t(),function(a,b){p[b]=a}):a.platform=t()})(this);
...
a({type:"supports",supports:c,rules:d}):f("@supports missing '}'")}}function K(){var a=b(),c=l(/^@media *([^{]+)/);if(c){c=c[1].trim();if(!g())return f("@media missing '{'");var d=n().concat(h());return l(/^}/)?a({type:"media",media:c,rules:d}):f("@media missing '}'")}}function O(){var a=b();if(l(/^@page */)){var c=t()||[];if(!g())return f("@page missing '{'");for(var d=n(),e;e=r();)d.push(e),d=d.concat(n());return l(/^}/)?a({type:"page",selectors:c,declarations:d}):f("@page missing '}'")}}function B(){var a=
...
(function(){function a(a,c,d,g){var h,l,n,s,t,r,p,w;c=c||{};void 0===c.wrap_line_length&&void 0!==c.max_char&&(c.wrap_line_length=c.max_char);l=parseInt(c.indent_size||4,10);n=c.indent_char||" ";t=c.brace_style||"collapse";s=0===c.wrap_line_length?32786:parseInt(c.wrap_line_length||250,10);r=c.unformatted||"a span bdo em strong dfn code samp kbd var cite abbr acronym q sub sup tt i b big small u s strike font ins del pre address dt h1 h2 h3 h4 h5 h6".split(" ");w=(p=c.preserve_newlines||!0,parseInt(c.max_preserve_newlines||
...
"</table>",f='<li><a class="cursor" onclick="Files.openPath(\'\')">'+document.location.host+"</a></li>";if(c){var g="";c.split(/ /g).forEach(function(a,b){f+='<li><a class="cursor" onclick="Files.openPath(\''+g+a+"')\">"+a+"</a></li>";g+=a+" "})}$("#FilesExplorerPath").html(f);$("#FilesExplorerHolder").html(d)};Files.refresh=function(){expressfs.dirStats("",function(a){Files.set("files",new Space(a));Files.renderExplorer()})};
...
Forms.menu.create=function(){expressfs.createUntitled("","html",$("#FormsTemplate").text(),function(a){Forms.menu.open(a)})};Forms.filter=function(){"script"===this.div.tag&&(this.div.draft=!0);this.div.attr("data-index",this.index);this.div.addClass("Scrap")};Forms.menu.open=function(a){console.log("opening %s",a);Forms.form=new Forms.Form(a);Forms.form.open()};Forms.menu.openPrompt=function(){var a=prompt("Enter a filename");if(!a)return!1;Forms.menu.open(a)};
Forms.menu.updateMenu=function(a){a=new Space(a);$(".openPage").remove();a.each(function(a,c){if(!a.match(/\.html?$/i))return!0;$("#FormsFileMenu").append('<li><a class="cursor openPage" onclick="Forms.menu.open(\''+a+"')\">"+a+"</a></li>")})};Forms.on("close",function(){Forms.dirWatcher&&Forms.dirWatcher.unwatch()});
...
expressfs.readdir("",function(a,d){var c="";d.forEach(function(a,d){c+=a+"\n"});Forms.menu.updateMenu(c)});Forms.dirWatcher=socketfs.watch("",function(a){Forms.menu.updateMenu(a.content)});store.get("FormsFilename")&&Forms.menu.open(store.get("FormsFilename"))});Forms.Form=function(a){this.filename=a;this.page=new Scraps.Page};Forms.Form.prototype=new Space;
Forms.Form.prototype.open=function(a){var d=this;expressfs.readFile(this.filename,function(a){d.page=new Scraps.Page($.htmlToScraps(a));d.render();store.set("FormsFilename",d.filename)})};Forms.Form.prototype.publish=function(a){var d=html_beautify(this.page.toHtml({wrap:!0}),{"indent-size":2,"indent-char":" ","indent-inner-html":!0});expressfs.writeFileAndOpen(this.filename,d,a)};
Forms.Form.prototype.render=function(a){$("#FormsStage").html(this.page.toHtml({filter:Forms.filter,wrap:!0}));$("#FormsSource").val(this.page.toConciseString());$("#FormsEditor").show()};Forms.Form.prototype.save=function(a){var d=html_beautify(this.page.toHtml({wrap:!0}),{"indent-size":2,"indent-char":" ","indent-inner-html":!0});expressfs.writeFile(this.filename,d,a)};var Git=new Tool("Git");Git.gitignore="nudgepad/";
...
Home.on("ready",function(){Home.renderMenu();$(window).on("resize",Home.heights)});Home.on("close",function(){$(window).off("resize",Home.heights)});var Insight=new Tool("Insight");Insight.menu={};Insight.database;Insight.log=function(a,d){d||(d=10);return Math.log(a)/Math.log(d)};Insight.menu.create=function(){expressfs.createUntitledDir("nudgepad/insight",function(a){Insight.menu.open(a)})};
Insight.menu.delete=function(){if(!confirm("Are you sure you want to delete the Database "+Insight.database+"?"))return!1;Insight.base.close();expressfs.rmdir("nudgepad/insight/"+Insight.database)};Insight.menu.open=function(a){Insight.database=a;Insight.base=new Insight.Database(a);Insight.base.open()};
Insight.menu.publish=function(){var a=$(".InsightPlane").html();$.get("/nudgepad/tools/insight/template.html?t="+(new Date).getTime(),function(d){d=d.replace("TITLE",Insight.database);d=d.replace("BODY",a);var c=Insight.database+".html";expressfs.writeFile(c,d,function(a){window.open(c,"published")})})};
...
a.remove()});var f=this;d.val(this.toString());d.focus();d.on("change",function(){var b=d.val();a.remove();if((new Space(b)).toString()===f.toString())return!0;f.reload(new Space(b));f.save();f.render();Insight.base.insight()})};Insight.Record.prototype.element=function(){return $("#"+this.id)};Insight.dragIt=function(a){a.draggable({stop:function(){var a=$(this).attr("id"),c=$(this),a=Insight.base.get(a);a.y=c.position().top;a.x=c.position().left},start:function(){$(".InsightEditor").remove()}})};
...
Insight.Database.prototype.editSource=function(){var a=this;TextPrompt.open("Edit Source",this.toString(),Insight.database+".space",function(d){a.diff(d).each(function(c,b){if(b)if(a.get(c))a.get(c).patch(b).save();else{var d=new Insight.Record(c,a.name,b);a.set(c,d);d.render();d.save()}else a.trash(c)});a.insight()})};Insight.Database.prototype.getPath=function(a){return"nudgepad/insight/"+(a?a:this.name)};
Insight.Database.prototype.insightAxis=function(a,d,c,b,e){var f=this.getByIndex(0),g=parseFloat(f.get(d)),h=parseFloat(f.get(d));this.each(function(a,b,c){a=parseFloat(b.get(d));g>a&&(g=a);h<a&&(h=a)});e&&(h=Insight.log(h),g=Insight.log(g));var l=h-g;this.each(function(f,h,n){f=h.element();h=parseFloat(h.get(d));e&&(h=Insight.log(h));h=Math.round((h-g)/l*a);"Y"===b&&(h=a-h);f.css(c,h)});$("#InsightMax"+b).html(h).show();$("#InsightMin"+b).html(g).show();var n=$("<select onchange=\"Insight.base.settings.set('"+
b.toLowerCase()+"',$(this).val()); Insight.base.save();Insight.base.insight()\" onblur=\"Insight.base.settings.set('"+b.toLowerCase()+"',$(this).val()); Insight.base.save();Insight.base.insight()\"></select>");f.getKeys().forEach(function(a,b){var c=$('<option value="'+a+'">'+a+"</option>");d===a&&c.attr("selected","true");n.append(c)});$("#InsightLabel"+b).html("");$("#InsightLabel"+b).append(n);$("#InsightLabel"+b).show()};
Insight.Database.prototype.insight=function(){var a=this.settings,d=this.getByIndex(0);if(!d)return!1;a.get("y")||a.set("y",d.getByIndex(0));a.get("x")||a.set("x",d.getByIndex(0));$(".InsightRecord").addClass("InsightRecordAnimate");this.insightAxis($(".InsightPlane").height()-20,a.get("y"),"top","Y",a.get("logY"));this.insightAxis($(".InsightPlane").width()-100,a.get("x"),"left","X",a.get("logX"));setTimeout("$('.InsightRecord').removeClass('InsightRecordAnimate')",1E3);$("#InsightCount").html("Showing "+
this.length()+" records").show()};
...
Labs.renderMenu=function(){$("#OpenTool #LabsContainer").html("");var a="Backup Blog Clone Crawler Fiddle Files Flickr Forms Git Pages Redirect Server Share Sketch Stats Team Templates Time".split(/ /g),d="rgb(26,134,214) rgb(36,65,112) rgb(231,189,44) rgb(171,193,199) rgb(224,54,52) rgb(71,41,54)".split(" "),c='<div class="row">',b;for(b in a){var e=window[a[b]];0<b&&0===b%3&&(c+='</div><div class="row">');var e=e.get("name"),f=ToolInfo.get(e.toLowerCase()),c=c+Labs.toButton(e,f.get("description"),
...
$.fn.getElementsByLine=function(a,d,c,b){var e=[];$(this).each(function(){var f=$(this),g,h,l,n;g=f.offset().left;h=f.offset().left+f.outerWidth();l=f.offset().top;n=f.offset().top+f.outerHeight();isRectangleIntersectedByLine(g,l,h,n,a,d,c,b)&&e.push(f)});return e};var Pages=new Tool("Pages");Pages.editor={};Pages.editor.create=function(){expressfs.createUntitled("","html","",function(a){Pages.editor.open(a)})};
...
function(a){var b=this._canvas.getBoundingClientRect();return new c(a.clientX-b.left,a.clientY-b.top)};d.prototype._addPoint=function(a){var c,d,h,l,n=this.points;n.push(a);2<n.length&&(3===n.length&&n.unshift(n[0]),l=this._calculateCurveControlPoints(n[0],n[1],n[2]),c=l.c2,l=this._calculateCurveControlPoints(n[1],n[2],n[3]),d=l.c1,h=new b(n[1],c,d,n[2]),this._addCurve(h),n.shift())};d.prototype._calculateCurveControlPoints=function(a,b,d){var h=a.x-b.x,l=a.y-b.y,n=b.x-d.x,s=b.y-d.y,t=(a.x+b.x)/2;
a=(a.y+b.y)/2;var r=(b.x+d.x)/2;d=(b.y+d.y)/2;h=Math.sqrt(h*h+l*l);n=Math.sqrt(n*n+s*s);s=n/(h+n);n=b.x-(r+(t-r)*s);b=b.y-(d+(a-d)*s);return{c1:new c(t+n,a+b),c2:new c(r+n,d+b)}};d.prototype._addCurve=function(a){var b,c;b=a.endPoint.velocityFrom(a.startPoint);b=this.velocityFilterWeight*b+(1-this.velocityFilterWeight)*this._lastVelocity;c=this._strokeWidth(b);this._drawCurve(a,this._lastWidth,c);this._lastVelocity=b;this._lastWidth=c};d.prototype._drawPoint=function(a,b,c){var d=this._ctx;d.moveTo(a,
b);d.arc(a,b,c,0,2*Math.PI,!1);this._isEmpty=!1};d.prototype._drawCurve=function(a,b,c){var d,l,n,s,t,r,p,w,v=this._ctx,D=c-b;c=Math.floor(a.length());v.beginPath();for(l=0;c>l;l++)d=l/c,n=d*d,s=n*d,t=1-d,r=t*t,p=r*t,w=p*a.startPoint.x,w+=3*r*d*a.control1.x,w+=3*t*n*a.control2.x,w+=s*a.endPoint.x,p*=a.startPoint.y,p+=3*r*d*a.control1.y,p+=3*t*n*a.control2.y,p+=s*a.endPoint.y,d=b+s*D,this._drawPoint(w,p,d);v.closePath();v.fill()};d.prototype._strokeWidth=function(a){return Math.max(this.maxWidth/(a+
1),this.minWidth)};var c=function(a,b,c){this.x=a;this.y=b;this.time=c||(new Date).getTime()};c.prototype.velocityFrom=function(a){return this.distanceTo(a)/(this.time-a.time)};c.prototype.distanceTo=function(a){return Math.sqrt(Math.pow(this.x-a.x,2)+Math.pow(this.y-a.y,2))};var b=function(a,b,c,d){this.startPoint=a;this.control1=b;this.control2=c;this.endPoint=d};return b.prototype.length=function(){var a,b,c,d,l,n,s,t=0;for(a=0;10>=a;a++)b=a/10,c=this._point(b,this.startPoint.x,this.control1.x,
this.control2.x,this.endPoint.x),b=this._point(b,this.startPoint.y,this.control1.y,this.control2.y,this.endPoint.y),0<a&&(n=c-d,s=b-l,t+=Math.sqrt(n*n+s*s)),d=c,l=b;return t},b.prototype._point=function(a,b,c,d,l){return b*(1-a)*(1-a)*(1-a)+3*c*(1-a)*(1-a)*a+3*d*(1-a)*a*a+l*a*a*a},d}(document),Sketch=new Tool("Sketch");
