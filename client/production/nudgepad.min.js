...
for(var p=Array(16),r=Array(16),x=0;16>x;x++)p[x]=s[x]^909522486,r[x]=s[x]^1549556828;c=e(p.concat(f(c)),512+c.length*d);c=e(r.concat(c),768);return g(c)},sha256config:function(a){d=parseInt(a)||8}});a.fn.sha256=function(b){a.sha256config(b);b=h(a(this).val());b=a.sha256(b);a.sha256config(8);return b}})(jQuery);function Space(a){this._tuples=[];this.events={};this._load(a);return this}Space.version="0.5.1";Space.arrayDelete=function(a,d){return a.slice(0,d).concat(a.slice(d+1))};Space.isXPath=function(a){return a.match(/ /)};
...
this.toString())})});Builder.publish=function(){var a=prompt("Enter a filename","new.html");if(!a)return!1;expressfs.writeFileAndOpen(a,Builder.page.toHtml({wrap:!0}))};var Clone=new Tool("Clone");Clone.set("path","");Clone.import=function(){TextPrompt.open("Import a Project to this project","","import.space",function(a){$.post("/nudgepad.import",{space:a},function(a){Alerts.success("Imported files.")})})};Clone.on("ready",function(){$("#CloneDomain").val("copyof"+document.location.host);$("#CloneServer").val(Project.get("hostname"))});
...
Pages.editor.editScraps=function(){TextPrompt.open("",Pages.editor.openPage().toConciseString(),Pages.editor.filename.replace("html","space"),function(a){Pages.editor.pages.set(Pages.editor.filename,new Scraps.Page(a));Pages.editor.open(Pages.editor.filename)})};Pages.editor.open=function(a){Pages.editor.filename=a;if(!Pages.editor.pages.get(Pages.editor.filename))return!0;$("#PagesFilename").html(a);Pages.editor.render()};Pages.editor.openPage=function(){return Pages.editor.pages.get(Pages.editor.filename)};
