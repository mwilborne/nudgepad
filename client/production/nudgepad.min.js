...
Pages.Page.prototype.trash=function(){var a=this;expressfs.unlink(this.filename,function(){a.close()})};Pages.Page.prototype.toHtml=function(){return html_beautify((new Scraps.Page(this.toString())).toHtml({wrap:!0}),{"indent-size":2,"indent-char":" ","indent-inner-html":!0})};var Private=new Tool("Private");Private.on("open",function(){expressfs.readFile("nudgepad/private.space",function(a){$("#PrivateCode").val(a)})});
Private.save=function(){var a=$("#PrivateCode").val();expressfs.writeFile("nudgepad/private.space",a,function(a){Alerts.success("Saved. Please restart")})};var Redirect=new Tool("Redirect");Redirect.on("open",function(){expressfs.readFile("nudgepad/redirects.space",function(a){$("#RedirectCode").val(a)})});Redirect.save=function(){var a=$("#RedirectCode").val();expressfs.writeFile("nudgepad/redirects.space",a,function(a){Alerts.success("Saved. Please restart")})};var Server=new Tool("Server");
Server.editAppJs=function(){var a=$("#ServerSamplePackage").text();expressfs.create("app.js",a,function(){Launcher.open("Files");Files.openPath("");Files.edit("app.js")})};
...
var SQLite=new Tool("SQLite");SQLite.install=function(){};var Stats=new Tool("Stats");Stats.htmlPages=[];Stats.hits={};Stats.compute=function(){Stats.hits={};expressfs.readFile("nudgepad/requests.log.txt",function(a){a.split(/\n/g).forEach(function(a,c){var b=a.split(/ /g);if(!b[1])return!0;"/"===b[1]&&(b[1]="/index.html");var e=b[1].substr(1);Stats.hits[e]?Stats.hits[e].push(b[0]):Stats.hits[e]=[b[0]]});Stats.trigger("pages")})};
