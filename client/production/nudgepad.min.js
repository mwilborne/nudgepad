...
Designer.importUrl=function(a){$.post("/nudgepad.proxy",{url:a},function(c){var b=a.replace(/^https?\:\/\//,"");c=$.htmlToScraps(c);c=RelativeToAbsolute(c.toString(),a);Designer.menu.create(b,c.toString());Alerts.success("Imported "+a)})};Designer.importUrlPrompt=function(){var a=prompt("Enter a url to import","http://");if(!a)return!1;a.match(/^https?\:\/\//)||(a="http://"+a);Designer.importUrl(a)};
...
RelativeToAbsolute=function(a,c){c=c.replace(/\/$/,"")+"/";var b=new Space(a);b.each(function(a,b){b.get("href")&&!b.get("href").match(/^https?\:/i)&&b.set("href",c+b.get("href"));b.get("src")&&!b.get("src").match(/^https?\:/i)&&b.set("src",c+b.get("src"));b.get("scraps")&&b.set("scraps",RelativeToAbsolute(b.get("scraps"),c))});return b};Scrap.prototype.onedit="";
