...
Home.on("ready",function(){Home.renderMenu();$(window).on("resize",Home.heights)});Home.on("close",function(){$(window).off("resize",Home.heights)});var Insight=new Tool("Insight");Insight.permalink=function(a){return a?a.toLowerCase().replace(/[^a-z0-9- _\.]/gi,"").replace(/ /g,"-"):""};Insight.menu={};Insight.database;Insight.view=new Space;Insight.menu.create=function(){expressfs.createUntitledDir("nudgepad/insight",function(a){(new Insight.Database(a)).create(function(){Insight.menu.open(a)})})};
