...
Redirect.save=function(){var a=$("#RedirectCode").val();expressfs.writeFile("nudgepad/redirects.space",a,function(a){Alerts.success("Saved. Please restart")})};var Server=new Tool("Server");Server.editAppJs=function(){var a=$("#ServerSamplePackage").text();expressfs.create("app.js",a,function(){Launcher.open("Files");Files.openPath("");Files.edit("app.js")})};
