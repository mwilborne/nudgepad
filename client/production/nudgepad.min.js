...
e=parseFloat(e)||0}return e+y(a,b,d||(g?"border":"content"),c,f)+"px"}function U(a){var b=H,d=xb[a];return d||(d=V(a,b),"none"!==d&&d||(Ra=(Ra||k("<iframe frameborder='0' width='0' height='0'/>").css("cssText","display:block !important")).appendTo(b.documentElement),b=(Ra[0].contentWindow||Ra[0].contentDocument).document,b.write("<!doctype html><html><body>"),b.close(),d=V(a,b),Ra.detach()),xb[a]=d),d}function V(a,b){var d=k(b.createElement(a)).appendTo(b.body),c=k.css(d[0],"display");return d.remove(),
...
l.progress(l.opts.progress).done(l.opts.done,l.opts.complete).fail(l.opts.fail).always(l.opts.always)}function x(a,b){var d,c,e,f,g;for(d in a)if(c=k.camelCase(d),e=b[c],f=a[d],k.isArray(f)&&(e=f[1],f=a[d]=f[0]),d!==c&&(a[c]=f,delete a[d]),g=k.cssHooks[c],g&&"expand"in g)for(d in f=g.expand(f),delete a[c],f)d in a||(a[d]=f[d],b[d]=e);else b[c]=e}function G(a,b,d,c,e){return new G.prototype.init(a,b,d,c,e)}function J(a,b){var d,c={height:a},e=0;for(b=b?1:0;4>e;e+=2-b)d=Da[e],c["margin"+d]=c["padding"+
d]=a;return b&&(c.opacity=c.width=a),c}function u(a){return k.isWindow(a)?a:9===a.nodeType?a.defaultView||a.parentWindow:!1}var E,aa,R=typeof d,da=a.location,H=a.document,ma=H.documentElement,ja=a.jQuery,na=a.$,ha={},ka=[],va=ka.concat,ea=ka.push,A=ka.slice,Y=ka.indexOf,la=ha.toString,oa=ha.hasOwnProperty,pa="1.10.2".trim,k=function(a,b){return new k.fn.init(a,b,aa)},wa=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,ba=/\S+/g,Ta=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,La=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,
eb=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,qa=/^[\],:{}\s]*$/,Ua=/(?:^|:|,)(?:\s*\[)+/g,T=/\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g,Ma=/"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g,fb=/^-ms-/,Va=/-([\da-z])/gi,gb=function(a,b){return b.toUpperCase()},ia=function(a){(H.addEventListener||"load"===a.type||"complete"===H.readyState)&&(Wa(),k.ready())},Wa=function(){H.addEventListener?(H.removeEventListener("DOMContentLoaded",ia,!1),a.removeEventListener("load",ia,!1)):(H.detachEvent("onreadystatechange",
...
this.attr(e,b[e]);return this}if(f=H.getElementById(e[2]),f&&f.parentNode){if(f.id!==e[2])return c.find(a);this.length=1;this[0]=f}return this.context=H,this.selector=a,this}return a.nodeType?(this.context=this[0]=a,this.length=1,this):k.isFunction(a)?c.ready(a):(a.selector!==d&&(this.selector=a.selector,this.context=a.context),k.makeArray(a,this))},selector:"",length:0,toArray:function(){return A.call(this)},get:function(a){return null==a?this.toArray():0>a?this[this.length+a]:this[a]},pushStack:function(a){a=
k.merge(this.constructor(),a);return a.prevObject=this,a.context=this.context,a},each:function(a,b){return k.each(this,a,b)},ready:function(a){return k.ready.promise().done(a),this},slice:function(){return this.pushStack(A.apply(this,arguments))},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},eq:function(a){var b=this.length;a=+a+(0>a?b:0);return this.pushStack(0<=a&&b>a?[this[a]]:[])},map:function(a){return this.pushStack(k.map(this,function(b,d){return a.call(b,d,b)}))},
...
a:{},l[e]=k.extend(q,g,c)):c!==d&&(l[e]=c));return l};k.extend({expando:"jQuery"+("1.10.2"+Math.random()).replace(/\D/g,""),noConflict:function(b){return a.$===k&&(a.$=na),b&&a.jQuery===k&&(a.jQuery=ja),k},isReady:!1,readyWait:1,holdReady:function(a){a?k.readyWait++:k.ready(!0)},ready:function(a){if(!0===a?!--k.readyWait:!k.isReady){if(!H.body)return setTimeout(k.ready);k.isReady=!0;!0!==a&&0<--k.readyWait||(E.resolveWith(H,[k]),k.fn.trigger&&k(H).trigger("ready").off("ready"))}},isFunction:function(a){return"function"===
k.type(a)},isArray:Array.isArray||function(a){return"array"===k.type(a)},isWindow:function(a){return null!=a&&a==a.window},isNumeric:function(a){return!isNaN(parseFloat(a))&&isFinite(a)},type:function(a){return null==a?a+"":"object"==typeof a||"function"==typeof a?ha[la.call(a)]||"object":typeof a},isPlainObject:function(a){var b;if(!a||"object"!==k.type(a)||a.nodeType||k.isWindow(a))return!1;try{if(a.constructor&&!oa.call(a,"constructor")&&!oa.call(a.constructor.prototype,"isPrototypeOf"))return!1}catch(c){return!1}if(k.support.ownLast)for(b in a)return oa.call(a,
b);for(b in a);return b===d||oa.call(a,b)},isEmptyObject:function(a){for(var b in a)return!1;return!0},error:function(a){throw Error(a);},parseHTML:function(a,b,d){if(!a||"string"!=typeof a)return null;"boolean"==typeof b&&(d=b,b=!1);b=b||H;var c=eb.exec(a);d=!d&&[];return c?[b.createElement(c[1])]:(c=k.buildFragment([a],b,d),d&&k(d).remove(),k.merge([],c.childNodes))},parseJSON:function(b){return a.JSON&&a.JSON.parse?a.JSON.parse(b):null===b?b:"string"==typeof b&&(b=k.trim(b),b&&qa.test(b.replace(T,
...
b)})(b)},camelCase:function(a){return a.replace(fb,"ms-").replace(Va,gb)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toLowerCase()===b.toLowerCase()},each:function(a,b,d){var e,f=0,g=a.length,k=c(a);if(d)if(k)for(;g>f&&(e=b.apply(a[f],d),!1!==e);f++);else for(f in a){if(e=b.apply(a[f],d),!1===e)break}else if(k)for(;g>f&&(e=b.call(a[f],f,a[f]),!1!==e);f++);else for(f in a)if(e=b.call(a[f],f,a[f]),!1===e)break;return a},trim:pa&&!pa.call("\ufeff\u00a0")?function(a){return null==a?"":pa.call(a)}:
...
e=[],f=0,g=a.length;for(d=!!d;g>f;f++)c=!!b(a[f],f),d!==c&&e.push(a[f]);return e},map:function(a,b,d){var e,f=0,g=a.length,k=[];if(c(a))for(;g>f;f++)e=b(a[f],f,d),null!=e&&(k[k.length]=e);else for(f in a)e=b(a[f],f,d),null!=e&&(k[k.length]=e);return va.apply([],k)},guid:1,proxy:function(a,b){var c,e,f;return"string"==typeof b&&(f=a[b],b=a,a=f),k.isFunction(a)?(c=A.call(arguments,2),e=function(){return a.apply(b||this,c.concat(A.call(arguments)))},e.guid=a.guid=a.guid||k.guid++,e):d},access:function(a,
b,c,e,f,g,l){var h=0,n=a.length,q=null==c;if("object"===k.type(c))for(h in f=!0,c)k.access(a,b,h,c[h],!0,g,l);else if(e!==d&&(f=!0,k.isFunction(e)||(l=!0),q&&(l?(b.call(a,e),b=null):(q=b,b=function(a,b,d){return q.call(k(a),d)})),b))for(;n>h;h++)b(a[h],c,l?e:e.call(a[h],h,b(a[h],c)));return f?a:q?b.call(a):n?b(a[0],c):g},now:function(){return(new Date).getTime()},swap:function(a,b,d,c){var e,f={};for(e in b)f[e]=a.style[e],a.style[e]=b[e];d=d.apply(a,c||[]);for(e in b)a.style[e]=f[e];return d}});
k.ready.promise=function(b){if(!E)if(E=k.Deferred(),"complete"===H.readyState)setTimeout(k.ready);else if(H.addEventListener)H.addEventListener("DOMContentLoaded",ia,!1),a.addEventListener("load",ia,!1);else{H.attachEvent("onreadystatechange",ia);a.attachEvent("onload",ia);var d=!1;try{d=null==a.frameElement&&H.documentElement}catch(c){}d&&d.doScroll&&function Ca(){if(!k.isReady){try{d.doScroll("left")}catch(a){return setTimeout(Ca,50)}Wa();k.ready()}}()}return E.promise(b)};k.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),
function(a,b){ha["[object "+b+"]"]=b.toLowerCase()});aa=k(H);(function(a,b){function d(a,b,c,e){var z,f,g,k,l;if((b?b.ownerDocument||b:da)!==D&&G(b),b=b||D,c=c||[],!a||"string"!=typeof a)return c;if(1!==(k=b.nodeType)&&9!==k)return[];if(H&&!e){if(z=qa.exec(a))if(g=z[1])if(9===k){if(f=b.getElementById(g),!f||!f.parentNode)return c;if(f.id===g)return c.push(f),c}else{if(b.ownerDocument&&(f=b.ownerDocument.getElementById(g))&&K(b,f)&&f.id===g)return c.push(f),c}else{if(z[2])return ba.apply(c,b.getElementsByTagName(a)),
c;if((g=z[3])&&s.getElementsByClassName&&b.getElementsByClassName)return ba.apply(c,b.getElementsByClassName(g)),c}if(s.qsa&&(!C||!C.test(a))){if(f=z=P,g=b,l=9===k&&a,1===k&&"object"!==b.nodeName.toLowerCase()){k=m(a);(z=b.getAttribute("id"))?f=z.replace(sa,"\\$&"):b.setAttribute("id",f);f="[id='"+f+"'] ";for(g=k.length;g--;)k[g]=f+E(k[g]);g=ea.test(a)&&b.parentNode||b;l=k.join(",")}if(l)try{return ba.apply(c,g.querySelectorAll(l)),c}catch(h){}finally{z||b.removeAttribute("id")}}}var Q;a:{a=a.replace(X,
"$1");var ua,n;f=m(a);if(!e&&1===f.length){if(Q=f[0]=f[0].slice(0),2<Q.length&&"ID"===(ua=Q[0]).type&&s.getById&&9===b.nodeType&&H&&w.relative[Q[1].type]){if(b=(w.find.ID(ua.matches[0].replace(fa,ga),b)||[])[0],!b){Q=c;break a}a=a.slice(Q.shift().value.length)}for(k=Ha.needsContext.test(a)?0:Q.length;k--&&(ua=Q[k],!w.relative[z=ua.type]);)if((n=w.find[z])&&(e=n(ua.matches[0].replace(fa,ga),ea.test(Q[0].type)&&b.parentNode||b))){if(Q.splice(k,1),a=e.length&&E(Q),!a){Q=(ba.apply(c,e),c);break a}break}}Q=
(v(a,f)(e,b,!H,c,ea.test(a)),c)}return Q}function c(){function a(d,c){return b.push(d+=" ")>w.cacheLength&&delete a[b.shift()],a[d]=c}var b=[];return a}function e(a){return a[P]=!0,a}function f(a){var b=D.createElement("div");try{return!!a(b)}catch(d){return!1}finally{b.parentNode&&b.parentNode.removeChild(b)}}function g(a,b){for(var d=a.split("|"),c=a.length;c--;)w.attrHandle[d[c]]=b}function l(a,b){var d=b&&a,c=d&&1===a.nodeType&&1===b.nodeType&&(~b.sourceIndex||S)-(~a.sourceIndex||S);if(c)return c;
if(d)for(;d=d.nextSibling;)if(d===b)return-1;return a?1:-1}function h(a){return function(b){return"input"===b.nodeName.toLowerCase()&&b.type===a}}function n(a){return function(b){var d=b.nodeName.toLowerCase();return("input"===d||"button"===d)&&b.type===a}}function q(a){return e(function(b){return b=+b,e(function(d,c){for(var e,z=a([],d.length,b),f=z.length;f--;)d[e=z[f]]&&(d[e]=!(c[e]=d[e]))})})}function A(){}function m(a,b){var c,e,z,f,g,k,l;if(g=ma[a+" "])return b?0:g.slice(0);g=a;k=[];for(l=w.preFilter;g;){c&&
!(e=T.exec(g))||(e&&(g=g.slice(e[0].length)||g),k.push(z=[]));c=!1;(e=wa.exec(g))&&(c=e.shift(),z.push({value:c,type:e[0].replace(X," ")}),g=g.slice(c.length));for(f in w.filter)!(e=Ha[f].exec(g))||l[f]&&!(e=l[f](e))||(c=e.shift(),z.push({value:c,type:f,matches:e}),g=g.slice(c.length));if(!c)break}return b?g.length:g?d.error(a):ma(a,k).slice(0)}function E(a){for(var b=0,d=a.length,c="";d>b;b++)c+=a[b].value;return c}function p(a,b,d){var c=b.dir,e=d&&"parentNode"===c,z=N++;return b.first?function(b,
d,z){for(;b=b[c];)if(1===b.nodeType||e)return a(b,d,z)}:function(b,d,f){var g,k,l,h=U+" "+z;if(f)for(;b=b[c];){if((1===b.nodeType||e)&&a(b,d,f))return!0}else for(;b=b[c];)if(1===b.nodeType||e)if(l=b[P]||(b[P]={}),(k=l[c])&&k[0]===h){if(!0===(g=k[1])||g===t)return!0===g}else if(k=l[c]=[h],k[1]=a(b,d,f)||t,!0===k[1])return!0}}function u(a){return 1<a.length?function(b,d,c){for(var e=a.length;e--;)if(!a[e](b,d,c))return!1;return!0}:a[0]}function O(a,b,d,c,e){for(var z,f=[],g=0,k=a.length,l=null!=b;k>
g;g++)(z=a[g])&&(!d||d(z,c,e))&&(f.push(z),l&&b.push(g));return f}function J(a,b,c,z,f,g){return z&&!z[P]&&(z=J(z)),f&&!f[P]&&(f=J(f,g)),e(function(e,g,k,l){var h,Q,n=[],q=[],ta=g.length,A;if(!(A=e)){A=b||"*";for(var m=k.nodeType?[k]:k,Ca=[],E=0,p=m.length;p>E;E++)d(A,m[E],Ca);A=Ca}A=!a||!e&&b?A:O(A,n,a,k,l);m=c?f||(e?a:ta||z)?[]:g:A;if(c&&c(A,m,k,l),z)for(h=O(m,q),z(h,[],k,l),k=h.length;k--;)(Q=h[k])&&(m[q[k]]=!(A[q[k]]=Q));if(e){if(f||a){if(f){h=[];for(k=m.length;k--;)(Q=m[k])&&h.push(A[k]=Q);f(null,
m=[],h,l)}for(k=m.length;k--;)(Q=m[k])&&-1<(h=f?W.call(e,Q):n[k])&&(e[h]=!(g[h]=Q))}}else m=O(m===g?m.splice(ta,m.length):m),f?f(null,g,m,l):ba.apply(g,m)})}function I(a){var b,d,c,e=a.length,z=w.relative[a[0].type];d=z||w.relative[" "];for(var f=z?1:0,g=p(function(a){return a===b},d,!0),k=p(function(a){return-1<W.call(b,a)},d,!0),l=[function(a,d,c){return!z&&(c||d!==aa)||((b=d).nodeType?g(a,d,c):k(a,d,c))}];e>f;f++)if(d=w.relative[a[f].type])l=[p(u(l),d)];else{if(d=w.filter[a[f].type].apply(null,
a[f].matches),d[P]){for(c=++f;e>c&&!w.relative[a[c].type];c++);return J(1<f&&u(l),1<f&&E(a.slice(0,f-1).concat({value:" "===a[f-2].type?"*":""})).replace(X,"$1"),d,c>f&&I(a.slice(f,c)),e>c&&I(a=a.slice(c)),e>c&&E(a))}l.push(d)}return u(l)}function x(a,b){var c=0,z=0<b.length,f=0<a.length,g=function(e,g,k,l,h){var Q,n,q=[],ta=0,A="0",m=e&&[],E=null!=h,Ca=aa,p=e||f&&w.find.TAG("*",h&&g.parentNode||g),u=U+=null==Ca?1:Math.random()||0.1;for(E&&(aa=g!==D&&g,t=c);null!=(h=p[A]);A++){if(f&&h){for(Q=0;n=
a[Q++];)if(n(h,g,k)){l.push(h);break}E&&(U=u,t=++c)}z&&((h=!n&&h)&&ta--,e&&m.push(h))}if(ta+=A,z&&A!==ta){for(Q=0;n=b[Q++];)n(m,q,g,k);if(e){if(0<ta)for(;A--;)m[A]||q[A]||(q[A]=ca.call(l));q=O(q)}ba.apply(l,q);E&&!e&&0<q.length&&1<ta+b.length&&d.uniqueSort(l)}return E&&(U=u,aa=Ca),m};return z?e(g):g}var B,s,t,w,Y,r,v,aa,y,G,D,R,H,C,la,F,K,P="sizzle"+-new Date,da=a.document,U=0,N=0,L=c(),ma=c(),oa=c(),V=!1,M=function(a,b){return a===b?(V=!0,0):0},ja=typeof b,S=-2147483648,pa={}.hasOwnProperty,Z=[],
ca=Z.pop,kb=Z.push,ba=Z.push,na=Z.slice,W=Z.indexOf||function(a){for(var b=0,d=this.length;d>b;b++)if(this[b]===a)return b;return-1},ha="(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w#"),ib="\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)[\\x20\\t\\r\\n\\f]*(?:([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|("+ha+")|)|)[\\x20\\t\\r\\n\\f]*\\]",Ja=":((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|"+ib.replace(3,8)+")*)|.*)\\)|)",
...
"i"),bool:RegExp("^(?:checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)$","i"),needsContext:RegExp("^[\\x20\\t\\r\\n\\f]*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\([\\x20\\t\\r\\n\\f]*((?:-\\d)?\\d*)[\\x20\\t\\r\\n\\f]*\\)|)(?=[^-]|$)","i")},ia=/^[^{]+\{\s*\[native \w/,qa=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,ob=/^(?:input|select|textarea|button)$/i,ra=/^h\d$/i,sa=/'|\\/g,fa=/\\([\da-f]{1,6}[\x20\t\r\n\f]?|([\x20\t\r\n\f])|.)/ig,
ga=function(a,b,d){a="0x"+b-65536;return a!==a||d?b:0>a?String.fromCharCode(a+65536):String.fromCharCode(55296|a>>10,56320|1023&a)};try{ba.apply(Z=na.call(da.childNodes),da.childNodes),Z[da.childNodes.length].nodeType}catch(Ta){ba={apply:Z.length?function(a,b){kb.apply(a,na.call(b))}:function(a,b){for(var d=a.length,c=0;a[d++]=b[c++];);a.length=d-1}}}r=d.isXML=function(a){return(a=a&&(a.ownerDocument||a).documentElement)?"HTML"!==a.nodeName:!1};s=d.support={};G=d.setDocument=function(a){var d=a?a.ownerDocument||
a:da;a=d.defaultView;return d!==D&&9===d.nodeType&&d.documentElement?(D=d,R=d.documentElement,H=!r(d),a&&a.attachEvent&&a!==a.top&&a.attachEvent("onbeforeunload",function(){G()}),s.attributes=f(function(a){return a.className="i",!a.getAttribute("className")}),s.getElementsByTagName=f(function(a){return a.appendChild(d.createComment("")),!a.getElementsByTagName("*").length}),s.getElementsByClassName=f(function(a){return a.innerHTML="<div class='a'></div><div class='a i'></div>",a.firstChild.className=
"i",2===a.getElementsByClassName("i").length}),s.getById=f(function(a){return R.appendChild(a).id=P,!d.getElementsByName||!d.getElementsByName(P).length}),s.getById?(w.find.ID=function(a,b){if(typeof b.getElementById!==ja&&H){var d=b.getElementById(a);return d&&d.parentNode?[d]:[]}},w.filter.ID=function(a){var b=a.replace(fa,ga);return function(a){return a.getAttribute("id")===b}}):(delete w.find.ID,w.filter.ID=function(a){var b=a.replace(fa,ga);return function(a){return(a=typeof a.getAttributeNode!==
ja&&a.getAttributeNode("id"))&&a.value===b}}),w.find.TAG=s.getElementsByTagName?function(a,d){return typeof d.getElementsByTagName!==ja?d.getElementsByTagName(a):b}:function(a,b){var d,c=[],e=0,z=b.getElementsByTagName(a);if("*"===a){for(;d=z[e++];)1===d.nodeType&&c.push(d);return c}return z},w.find.CLASS=s.getElementsByClassName&&function(a,d){return typeof d.getElementsByClassName!==ja&&H?d.getElementsByClassName(a):b},la=[],C=[],(s.qsa=ia.test(d.querySelectorAll))&&(f(function(a){a.innerHTML="<select><option selected=''></option></select>";
...
C.push(":enabled",":disabled");a.querySelectorAll("*,:x");C.push(",.*:")})),(s.matchesSelector=ia.test(F=R.webkitMatchesSelector||R.mozMatchesSelector||R.oMatchesSelector||R.msMatchesSelector))&&f(function(a){s.disconnectedMatch=F.call(a,"div");F.call(a,"[s!='']:x");la.push("!=",Ja)}),C=C.length&&RegExp(C.join("|")),la=la.length&&RegExp(la.join("|")),K=ia.test(R.contains)||R.compareDocumentPosition?function(a,b){var d=9===a.nodeType?a.documentElement:a,c=b&&b.parentNode;return a===c||!(!c||1!==c.nodeType||
!(d.contains?d.contains(c):a.compareDocumentPosition&&16&a.compareDocumentPosition(c)))}:function(a,b){if(b)for(;b=b.parentNode;)if(b===a)return!0;return!1},M=R.compareDocumentPosition?function(a,b){if(a===b)return V=!0,0;var c=b.compareDocumentPosition&&a.compareDocumentPosition&&a.compareDocumentPosition(b);return c?1&c||!s.sortDetached&&b.compareDocumentPosition(a)===c?a===d||K(da,a)?-1:b===d||K(da,b)?1:y?W.call(y,a)-W.call(y,b):0:4&c?-1:1:a.compareDocumentPosition?-1:1}:function(a,b){var c,e=
0;c=a.parentNode;var z=b.parentNode,f=[a],g=[b];if(a===b)return V=!0,0;if(!c||!z)return a===d?-1:b===d?1:c?-1:z?1:y?W.call(y,a)-W.call(y,b):0;if(c===z)return l(a,b);for(c=a;c=c.parentNode;)f.unshift(c);for(c=b;c=c.parentNode;)g.unshift(c);for(;f[e]===g[e];)e++;return e?l(f[e],g[e]):f[e]===da?-1:g[e]===da?1:0},d):D};d.matches=function(a,b){return d(a,null,null,b)};d.matchesSelector=function(a,b){if((a.ownerDocument||a)!==D&&G(a),b=b.replace(ka,"='$1']"),s.matchesSelector&&H&&!(la&&la.test(b)||C&&C.test(b)))try{var c=
F.call(a,b);if(c||s.disconnectedMatch||a.document&&11!==a.document.nodeType)return c}catch(e){}return 0<d(b,D,null,[a]).length};d.contains=function(a,b){return(a.ownerDocument||a)!==D&&G(a),K(a,b)};d.attr=function(a,d){(a.ownerDocument||a)!==D&&G(a);var c=w.attrHandle[d.toLowerCase()],c=c&&pa.call(w.attrHandle,d.toLowerCase())?c(a,d,!H):b;return c===b?s.attributes||!H?a.getAttribute(d):(c=a.getAttributeNode(d))&&c.specified?c.value:null:c};d.error=function(a){throw Error("Syntax error, unrecognized expression: "+
a);};d.uniqueSort=function(a){var b,d=[],c=0,e=0;if(V=!s.detectDuplicates,y=!s.sortStable&&a.slice(0),a.sort(M),V){for(;b=a[e++];)b===a[e]&&(c=d.push(e));for(;c--;)a.splice(d[c],1)}return a};Y=d.getText=function(a){var b,d="",c=0;if(b=a.nodeType)if(1===b||9===b||11===b){if("string"==typeof a.textContent)return a.textContent;for(a=a.firstChild;a;a=a.nextSibling)d+=Y(a)}else{if(3===b||4===b)return a.nodeValue}else for(;b=a[c];c++)d+=Y(b);return d};w=d.selectors={cacheLength:50,createPseudo:e,match:Ha,
...
typeof a.className&&a.className||typeof a.getAttribute!==ja&&a.getAttribute("class")||"")})},ATTR:function(a,b,c){return function(e){e=d.attr(e,a);return null==e?"!="===b:b?(e+="","="===b?e===c:"!="===b?e!==c:"^="===b?c&&0===e.indexOf(c):"*="===b?c&&-1<e.indexOf(c):"$="===b?c&&e.slice(-c.length)===c:"~="===b?-1<(" "+e+" ").indexOf(c):"|="===b?e===c||e.slice(0,c.length+1)===c+"-":!1):!0}},CHILD:function(a,b,d,c,e){var z="nth"!==a.slice(0,3),f="last"!==a.slice(-4),g="of-type"===b;return 1===c&&0===
e?function(a){return!!a.parentNode}:function(b,d,k){var l,h,Q,n,ua;d=z!==f?"nextSibling":"previousSibling";var q=b.parentNode,ta=g&&b.nodeName.toLowerCase();k=!k&&!g;if(q){if(z){for(;d;){for(h=b;h=h[d];)if(g?h.nodeName.toLowerCase()===ta:1===h.nodeType)return!1;ua=d="only"===a&&!ua&&"nextSibling"}return!0}if(ua=[f?q.firstChild:q.lastChild],f&&k)for(k=q[P]||(q[P]={}),l=k[a]||[],n=l[0]===U&&l[1],Q=l[0]===U&&l[2],h=n&&q.childNodes[n];h=++n&&h&&h[d]||(Q=n=0)||ua.pop();){if(1===h.nodeType&&++Q&&h===b){k[a]=
[U,n,Q];break}}else if(k&&(l=(b[P]||(b[P]={}))[a])&&l[0]===U)Q=l[1];else for(;(h=++n&&h&&h[d]||(Q=n=0)||ua.pop())&&((g?h.nodeName.toLowerCase()!==ta:1!==h.nodeType)||!++Q||(k&&((h[P]||(h[P]={}))[a]=[U,Q]),h!==b)););return Q-=e,Q===c||0===Q%c&&0<=Q/c}}},PSEUDO:function(a,b){var c,z=w.pseudos[a]||w.setFilters[a.toLowerCase()]||d.error("unsupported pseudo: "+a);return z[P]?z(b):1<z.length?(c=[a,a,"",b],w.setFilters.hasOwnProperty(a.toLowerCase())?e(function(a,d){for(var c,e=z(a,b),f=e.length;f--;)c=
W.call(a,e[f]),a[c]=!(d[c]=e[f])}):function(a){return z(a,0,c)}):z}},pseudos:{not:e(function(a){var b=[],d=[],c=v(a.replace(X,"$1"));return c[P]?e(function(a,b,d,e){var z;d=c(a,null,e,[]);for(e=a.length;e--;)(z=d[e])&&(a[e]=!(b[e]=z))}):function(a,e,z){return b[0]=a,c(b,null,z,d),!d.pop()}}),has:e(function(a){return function(b){return 0<d(a,b).length}}),contains:e(function(a){return function(b){return-1<(b.textContent||b.innerText||Y(b)).indexOf(a)}}),lang:e(function(a){return va.test(a||"")||d.error("unsupported lang: "+
a),a=a.replace(fa,ga).toLowerCase(),function(b){var d;do if(d=H?b.lang:b.getAttribute("xml:lang")||b.getAttribute("lang"))return d=d.toLowerCase(),d===a||0===d.indexOf(a+"-");while((b=b.parentNode)&&1===b.nodeType);return!1}}),target:function(b){var d=a.location&&a.location.hash;return d&&d.slice(1)===b.id},root:function(a){return a===R},focus:function(a){return a===D.activeElement&&(!D.hasFocus||D.hasFocus())&&!!(a.type||a.href||~a.tabIndex)},enabled:function(a){return!1===a.disabled},disabled:function(a){return!0===
a.disabled},checked:function(a){var b=a.nodeName.toLowerCase();return"input"===b&&!!a.checked||"option"===b&&!!a.selected},selected:function(a){return a.parentNode&&a.parentNode.selectedIndex,!0===a.selected},empty:function(a){for(a=a.firstChild;a;a=a.nextSibling)if("@"<a.nodeName||3===a.nodeType||4===a.nodeType)return!1;return!0},parent:function(a){return!w.pseudos.empty(a)},header:function(a){return ra.test(a.nodeName)},input:function(a){return ob.test(a.nodeName)},button:function(a){var b=a.nodeName.toLowerCase();
...
b,d){for(d=0>d?d+b:d;b>++d;)a.push(d);return a})}};w.pseudos.nth=w.pseudos.eq;for(B in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})w.pseudos[B]=h(B);for(B in{submit:!0,reset:!0})w.pseudos[B]=n(B);A.prototype=w.filters=w.pseudos;w.setFilters=new A;v=d.compile=function(a,b){var d,c=[],e=[],z=oa[a+" "];if(!z){b||(b=m(a));for(d=b.length;d--;)z=I(b[d]),z[P]?c.push(z):e.push(z);z=oa(a,x(e,c))}return z};s.sortStable=P.split("").sort(M).join("")===P;s.detectDuplicates=V;G();s.sortDetached=f(function(a){return 1&
a.compareDocumentPosition(D.createElement("div"))});f(function(a){return a.innerHTML="<a href='#'></a>","#"===a.firstChild.getAttribute("href")})||g("type|href|height|width",function(a,d,c){return c?b:a.getAttribute(d,"type"===d.toLowerCase()?1:2)});s.attributes&&f(function(a){return a.innerHTML="<input/>",a.firstChild.setAttribute("value",""),""===a.firstChild.getAttribute("value")})||g("value",function(a,d,c){return c||"input"!==a.nodeName.toLowerCase()?b:a.defaultValue});f(function(a){return null==
...
g,l,h,n=[],q=!a.once&&[],A=function(b){e=a.memory&&b;f=!0;l=h||0;h=0;g=n.length;for(c=!0;n&&g>l;l++)if(!1===n[l].apply(b[0],b[1])&&a.stopOnFalse){e=!1;break}c=!1;n&&(q?q.length&&A(q.shift()):e?n=[]:m.disable())},m={add:function(){if(n){var b=n.length;(function Qb(b){k.each(b,function(b,d){var c=k.type(d);"function"===c?a.unique&&m.has(d)||n.push(d):d&&d.length&&"string"!==c&&Qb(d)})})(arguments);c?g=n.length:e&&(h=b,A(e))}return this},remove:function(){return n&&k.each(arguments,function(a,b){for(var d;-1<
(d=k.inArray(b,n,d));)n.splice(d,1),c&&(g>=d&&g--,l>=d&&l--)}),this},has:function(a){return a?-1<k.inArray(a,n):!(!n||!n.length)},empty:function(){return n=[],g=0,this},disable:function(){return n=q=e=d,this},disabled:function(){return!n},lock:function(){return q=d,e||m.disable(),this},locked:function(){return!q},fireWith:function(a,b){return!n||f&&!q||(b=b||[],b=[a,b.slice?b.slice():b],c?q.push(b):A(b)),this},fire:function(){return m.fireWith(this,arguments),this},fired:function(){return!!f}};return m};
k.extend({Deferred:function(a){var b=[["resolve","done",k.Callbacks("once memory"),"resolved"],["reject","fail",k.Callbacks("once memory"),"rejected"],["notify","progress",k.Callbacks("memory")]],d="pending",c={state:function(){return d},always:function(){return e.done(arguments).fail(arguments),this},then:function(){var a=arguments;return k.Deferred(function(d){k.each(b,function(b,z){var f=z[0],g=k.isFunction(a[b])&&a[b];e[z[1]](function(){var a=g&&g.apply(this,arguments);a&&k.isFunction(a.promise)?
a.promise().done(d.resolve).fail(d.reject).progress(d.notify):d[f+"With"](this===c?d.promise():this,g?[a]:arguments)})});a=null}).promise()},promise:function(a){return null!=a?k.extend(a,c):c}},e={};return c.pipe=c.then,k.each(b,function(a,z){var f=z[2],g=z[3];c[z[1]]=f.add;g&&f.add(function(){d=g},b[1^a][2].disable,b[2][2].lock);e[z[0]]=function(){return e[z[0]+"With"](this===e?c:this,arguments),this};e[z[0]+"With"]=f.fireWith}),c.promise(e),a&&a.call(e,e),e},when:function(a){var b=0,d=A.call(arguments),
c=d.length,e=1!==c||a&&k.isFunction(a.promise)?c:0,f=1===e?a:k.Deferred(),g=function(a,b,d){return function(c){b[a]=this;d[a]=1<arguments.length?A.call(arguments):c;d===l?f.notifyWith(b,d):--e||f.resolveWith(b,d)}},l,h,n;if(1<c)for(l=Array(c),h=Array(c),n=Array(c);c>b;b++)d[b]&&k.isFunction(d[b].promise)?d[b].promise().done(g(b,n,d)).fail(f.reject).progress(g(b,h,l)):--e;return e||f.resolveWith(n,d),f.promise()}});k.support=function(b){var d,c,e,f,g,l,h=H.createElement("div");if(h.setAttribute("className",
"t"),h.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",d=h.getElementsByTagName("*")||[],c=h.getElementsByTagName("a")[0],!c||!c.style||!d.length)return b;e=H.createElement("select");f=e.appendChild(H.createElement("option"));d=h.getElementsByTagName("input")[0];c.style.cssText="top:1px;float:left;opacity:.5";b.getSetAttribute="t"!==h.className;b.leadingWhitespace=3===h.firstChild.nodeType;b.tbody=!h.getElementsByTagName("tbody").length;b.htmlSerialize=!!h.getElementsByTagName("link").length;
b.style=/top/.test(c.getAttribute("style"));b.hrefNormalized="/a"===c.getAttribute("href");b.opacity=/^0.5/.test(c.style.opacity);b.cssFloat=!!c.style.cssFloat;b.checkOn=!!d.value;b.optSelected=f.selected;b.enctype=!!H.createElement("form").enctype;b.html5Clone="<:nav></:nav>"!==H.createElement("nav").cloneNode(!0).outerHTML;b.inlineBlockNeedsLayout=!1;b.shrinkWrapBlocks=!1;b.pixelPosition=!1;b.deleteExpando=!0;b.noCloneEvent=!0;b.reliableMarginRight=!0;b.boxSizingReliable=!0;d.checked=!0;b.noCloneChecked=
d.cloneNode(!0).checked;e.disabled=!0;b.optDisabled=!f.disabled;try{delete h.test}catch(n){b.deleteExpando=!1}d=H.createElement("input");d.setAttribute("value","");b.input=""===d.getAttribute("value");d.value="t";d.setAttribute("type","radio");b.radioValue="t"===d.value;d.setAttribute("checked","t");d.setAttribute("name","t");c=H.createDocumentFragment();c.appendChild(d);b.appendChecked=d.checked;b.checkClone=c.cloneNode(!0).cloneNode(!0).lastChild.checked;h.attachEvent&&(h.attachEvent("onclick",
function(){b.noCloneEvent=!1}),h.cloneNode(!0).click());for(l in{submit:!0,change:!0,focusin:!0})h.setAttribute(c="on"+l,"t"),b[l+"Bubbles"]=c in a||!1===h.attributes[c].expando;h.style.backgroundClip="content-box";h.cloneNode(!0).style.backgroundClip="";b.clearCloneStyle="content-box"===h.style.backgroundClip;for(l in k(b))break;return b.ownLast="0"!==l,k(function(){var d,c,e,f=H.getElementsByTagName("body")[0];f&&(d=H.createElement("div"),d.style.cssText="border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px",
...
d=h=e=c=null)}),d=e=c=f=c=d=null,b}({});var ga=/(?:\{[\s\S]*\}|\[[\s\S]*\])$/,bb=/([A-Z])/g;k.extend({cache:{},noData:{applet:!0,embed:!0,object:"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"},hasData:function(a){return a=a.nodeType?k.cache[a[k.expando]]:a[k.expando],!!a&&!l(a)},data:function(a,b,d){return e(a,b,d)},removeData:function(a,b){return g(a,b)},_data:function(a,b,d){return e(a,b,d,!0)},_removeData:function(a,b){return g(a,b,!0)},acceptData:function(a){if(a.nodeType&&1!==a.nodeType&&9!==a.nodeType)return!1;
...
add:function(a,b,c,e,f){var g,h,l,n,q,A,m,E,p,u;if(l=k._data(a)){c.handler&&(n=c,c=n.handler,f=n.selector);c.guid||(c.guid=k.guid++);(h=l.events)||(h=l.events={});(A=l.handle)||(A=l.handle=function(a){return typeof k===R||a&&k.event.triggered===a.type?d:k.event.dispatch.apply(A.elem,arguments)},A.elem=a);b=(b||"").match(ba)||[""];for(l=b.length;l--;)g=Ga.exec(b[l])||[],p=u=g[1],g=(g[2]||"").split(".").sort(),p&&(q=k.event.special[p]||{},p=(f?q.delegateType:q.bindType)||p,q=k.event.special[p]||{},
m=k.extend({type:p,origType:u,data:e,handler:c,guid:c.guid,selector:f,needsContext:f&&k.expr.match.needsContext.test(f),namespace:g.join(".")},n),(E=h[p])||(E=h[p]=[],E.delegateCount=0,q.setup&&!1!==q.setup.call(a,e,g,A)||(a.addEventListener?a.addEventListener(p,A,!1):a.attachEvent&&a.attachEvent("on"+p,A))),q.add&&(q.add.call(a,m),m.handler.guid||(m.handler.guid=c.guid)),f?E.splice(E.delegateCount++,0,m):E.push(m),k.event.global[p]=!0);a=null}},remove:function(a,b,d,c,e){var f,g,h,l,n,q,A,m,E,p,
u,O=k.hasData(a)&&k._data(a);if(O&&(q=O.events)){b=(b||"").match(ba)||[""];for(n=b.length;n--;)if(h=Ga.exec(b[n])||[],E=u=h[1],p=(h[2]||"").split(".").sort(),E){A=k.event.special[E]||{};E=(c?A.delegateType:A.bindType)||E;m=q[E]||[];h=h[2]&&RegExp("(^|\\.)"+p.join("\\.(?:.*\\.|)")+"(\\.|$)");for(l=f=m.length;f--;)g=m[f],!e&&u!==g.origType||d&&d.guid!==g.guid||h&&!h.test(g.namespace)||c&&c!==g.selector&&("**"!==c||!g.selector)||(m.splice(f,1),g.selector&&m.delegateCount--,A.remove&&A.remove.call(a,
g));l&&!m.length&&(A.teardown&&!1!==A.teardown.call(a,p,O.handle)||k.removeEvent(a,E,O.handle),delete q[E])}else for(E in q)k.event.remove(a,E+b[n],d,c,!0);k.isEmptyObject(q)&&(delete O.handle,k._removeData(a,"events"))}},trigger:function(b,c,e,f){var g,h,l,n,q,A,m=[e||H],E=oa.call(b,"type")?b.type:b;A=oa.call(b,"namespace")?b.namespace.split("."):[];if(l=g=e=e||H,3!==e.nodeType&&8!==e.nodeType&&!hb.test(E+k.event.triggered)&&(0<=E.indexOf(".")&&(A=E.split("."),E=A.shift(),A.sort()),h=0>E.indexOf(":")&&
"on"+E,b=b[k.expando]?b:new k.Event(E,"object"==typeof b&&b),b.isTrigger=f?2:3,b.namespace=A.join("."),b.namespace_re=b.namespace?RegExp("(^|\\.)"+A.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,b.result=d,b.target||(b.target=e),c=null==c?[b]:k.makeArray(c,[b]),q=k.event.special[E]||{},f||!q.trigger||!1!==q.trigger.apply(e,c))){if(!f&&!q.noBubble&&!k.isWindow(e)){n=q.delegateType||E;for(hb.test(n+E)||(l=l.parentNode);l;l=l.parentNode)m.push(l),g=l;g===(e.ownerDocument||H)&&m.push(g.defaultView||g.parentWindow||
a)}for(A=0;(l=m[A++])&&!b.isPropagationStopped();)b.type=1<A?n:q.bindType||E,(g=(k._data(l,"events")||{})[b.type]&&k._data(l,"handle"))&&g.apply(l,c),(g=h&&l[h])&&k.acceptData(l)&&g.apply&&!1===g.apply(l,c)&&b.preventDefault();if(b.type=E,!f&&!b.isDefaultPrevented()&&(!q._default||!1===q._default.apply(m.pop(),c))&&k.acceptData(e)&&h&&e[E]&&!k.isWindow(e)){(g=e[h])&&(e[h]=null);k.event.triggered=E;try{e[E]()}catch(p){}k.event.triggered=d;g&&(e[h]=g)}return b.result}},dispatch:function(a){a=k.event.fix(a);
var b,c,e,f,g,h=[],l=A.call(arguments);b=(k._data(this,"events")||{})[a.type]||[];var n=k.event.special[a.type]||{};if(l[0]=a,a.delegateTarget=this,!n.preDispatch||!1!==n.preDispatch.call(this,a)){h=k.event.handlers.call(this,a,b);for(b=0;(f=h[b++])&&!a.isPropagationStopped();)for(a.currentTarget=f.elem,g=0;(e=f.handlers[g++])&&!a.isImmediatePropagationStopped();)a.namespace_re&&!a.namespace_re.test(e.namespace)||(a.handleObj=e,a.data=e.data,c=((k.event.special[e.origType]||{}).handle||e.handler).apply(f.elem,
...
a.isTrigger||"radio"!==b.type&&"checkbox"!==b.type?a.handleObj.handler.apply(this,arguments):d},teardown:function(){return k.event.remove(this,"._change"),!fa.test(this.nodeName)}});k.support.focusinBubbles||k.each({focus:"focusin",blur:"focusout"},function(a,b){var c=0,d=function(a){k.event.simulate(b,a.target,k.event.fix(a),!0)};k.event.special[b]={setup:function(){0===c++&&H.addEventListener(a,d,!0)},teardown:function(){0===--c&&H.removeEventListener(a,d,!0)}}});k.fn.extend({on:function(a,b,c,
...
"i"),pb=/^\s+/,zb=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,Ab=/<([\w:]+)/,Bb=/<tbody/i,Rb=/<|&#?\w+;/,Sb=/<(?:script|style|link)/i,lb=/^(?:checkbox|radio)$/i,Tb=/checked\s*(?:[^=]|=\s*.checked.)/i,Cb=/^$|\/(?:java|ecma)script/i,Nb=/^true\/(.*)/,Ub=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,ra={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],area:[1,"<map>","</map>"],param:[1,"<object>","</object>"],thead:[1,"<table>","</table>"],
tr:[2,"<table><tbody>","</tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],_default:k.support.htmlSerialize?[0,"",""]:[1,"X<div>","</div>"]},qb=p(H).appendChild(H.createElement("div"));ra.optgroup=ra.option;ra.tbody=ra.tfoot=ra.colgroup=ra.caption=ra.thead;ra.th=ra.td;k.fn.extend({text:function(a){return k.access(this,function(a){return a===d?k.text(this):this.empty().append((this[0]&&this[0].ownerDocument||H).createTextNode(a))},
...
function(a){this.parentNode&&this.parentNode.insertBefore(a,this.nextSibling)})},remove:function(a,b){for(var c,d=a?k.filter(a,this):this,e=0;null!=(c=d[e]);e++)b||1!==c.nodeType||k.cleanData(B(c)),c.parentNode&&(b&&k.contains(c.ownerDocument,c)&&K(B(c,"script")),c.parentNode.removeChild(c));return this},empty:function(){for(var a,b=0;null!=(a=this[b]);b++){for(1===a.nodeType&&k.cleanData(B(a,!1));a.firstChild;)a.removeChild(a.firstChild);a.options&&k.nodeName(a,"select")&&(a.options.length=0)}return this},
clone:function(a,b){return a=null==a?!1:a,b=null==b?a:b,this.map(function(){return k.clone(this,a,b)})},html:function(a){return k.access(this,function(a){var b=this[0]||{},c=0,e=this.length;if(a===d)return 1===b.nodeType?b.innerHTML.replace(ob,""):d;if(!("string"!=typeof a||Sb.test(a)||!k.support.htmlSerialize&&yb.test(a)||!k.support.leadingWhitespace&&pb.test(a)||ra[(Ab.exec(a)||["",""])[1].toLowerCase()])){a=a.replace(zb,"<$1></$2>");try{for(;e>c;c++)b=this[c]||{},1===b.nodeType&&(k.cleanData(B(b,
!1)),b.innerHTML=a);b=0}catch(f){}}b&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(){var a=k.map(this,function(a){return[a.nextSibling,a.parentNode]}),b=0;return this.domManip(arguments,function(c){var d=a[b++],e=a[b++];e&&(d&&d.parentNode!==e&&(d=this.nextSibling),k(this).remove(),e.insertBefore(c,d))},!0),b?this:this.remove()},detach:function(a){return this.remove(a,!0)},domManip:function(a,b,c){a=va.apply([],a);var d,e,f,g,h=0,l=this.length,n=this,q=l-1,A=a[0],m=k.isFunction(A);
if(m||!(1>=l||"string"!=typeof A||k.support.checkClone)&&Tb.test(A))return this.each(function(d){var e=n.eq(d);m&&(a[0]=A.call(this,d,e.html()));e.domManip(a,b,c)});if(l&&(g=k.buildFragment(a,this[0].ownerDocument,!1,!c&&this),d=g.firstChild,1===g.childNodes.length&&(g=d),d)){f=k.map(B(g,"script"),v);for(e=f.length;l>h;h++)d=g,h!==q&&(d=k.clone(d,!0,!0),e&&k.merge(f,B(d,"script"))),b.call(this[h],d,h);if(e)for(g=f[f.length-1].ownerDocument,k.map(f,D),h=0;e>h;h++)d=f[h],Cb.test(d.type||"")&&!k._data(d,
...
a);if(k.support.html5Clone||k.isXMLDoc(a)||!yb.test("<"+a.nodeName+">")?f=a.cloneNode(!0):(qb.innerHTML=a.outerHTML,qb.removeChild(f=qb.firstChild)),!(k.support.noCloneEvent&&k.support.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||k.isXMLDoc(a)))for(d=B(f),h=B(a),g=0;null!=(e=h[g]);++g)if(d[g]){var n=d[g],q=void 0,A=void 0,m=void 0;if(1===n.nodeType){if(q=n.nodeName.toLowerCase(),!k.support.noCloneEvent&&n[k.expando]){m=k._data(n);for(A in m.events)k.removeEvent(n,A,m.handle);n.removeAttribute(k.expando)}"script"===
...
"script"),0<d.length&&K(d,!l&&B(a,"script")),f},buildFragment:function(a,b,c,d){for(var e,f,g,h,l,n,q,A=a.length,m=p(b),E=[],u=0;A>u;u++)if(f=a[u],f||0===f)if("object"===k.type(f))k.merge(E,f.nodeType?[f]:f);else if(Rb.test(f)){h=h||m.appendChild(b.createElement("div"));l=(Ab.exec(f)||["",""])[1].toLowerCase();q=ra[l]||ra._default;h.innerHTML=q[1]+f.replace(zb,"<$1></$2>")+q[2];for(e=q[0];e--;)h=h.lastChild;if(!k.support.leadingWhitespace&&pb.test(f)&&E.push(b.createTextNode(pb.exec(f)[0])),!k.support.tbody)for(e=
(f="table"!==l||Bb.test(f)?"<table>"!==q[1]||Bb.test(f)?0:h:h.firstChild)&&f.childNodes.length;e--;)k.nodeName(n=f.childNodes[e],"tbody")&&!n.childNodes.length&&f.removeChild(n);k.merge(E,h.childNodes);for(h.textContent="";h.firstChild;)h.removeChild(h.firstChild);h=m.lastChild}else E.push(b.createTextNode(f));h&&m.removeChild(h);k.support.appendChecked||k.grep(B(E,"input"),L);for(u=0;f=E[u++];)if((!d||-1===k.inArray(f,d))&&(g=k.contains(f.ownerDocument,f),h=B(m.appendChild(f),"script"),g&&K(h),c))for(e=
...
l.maxWidth=l.width=h,h=c.width,l.width=e,l.minWidth=f,l.maxWidth=g)),h}):H.documentElement.currentStyle&&(Ea=function(a){return a.currentStyle},Fa=function(a,b,c){var e,f,g;c=(c=c||Ea(a))?c[b]:d;var h=a.style;return null==c&&h&&h[b]&&(c=h[b]),cb.test(c)&&!Wb.test(b)&&(e=h.left,f=a.runtimeStyle,g=f&&f.left,g&&(f.left=a.currentStyle.left),h.left="fontSize"===b?"1em":c,c=h.pixelLeft+"px",h.left=e,g&&(f.left=g)),""===c?"auto":c});k.each(["height","width"],function(a,b){k.cssHooks[b]={get:function(a,c,
e){return c?0===a.offsetWidth&&Xb.test(k.css(a,"display"))?k.swap(a,Zb,function(){return S(a,b,e)}):S(a,b,e):d},set:function(a,c,d){var e=d&&Ea(a);return F(a,c,d?y(a,b,d,k.support.boxSizing&&"border-box"===k.css(a,"boxSizing",!1,e),e):0)}}});k.support.opacity||(k.cssHooks.opacity={get:function(a,b){return Vb.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?0.01*parseFloat(RegExp.$1)+"":b?"1":""},set:function(a,b){var c=a.style,d=a.currentStyle,e=k.isNumeric(b)?"alpha(opacity="+100*
...
delegate:function(a,b,c,d){return this.on(b,a,c,d)},undelegate:function(a,b,c){return 1===arguments.length?this.off(a,"**"):this.off(b,a||"**",c)}});var Ia,Ba,sb=k.now(),tb=/\?/,cc=/#.*$/,Gb=/([?&])_=[^&]*/,dc=/^(.*?):[ \t]*([^\r\n]*)\r?$/gm,ec=/^(?:GET|HEAD)$/,fc=/^\/\//,Hb=/^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/,Ib=k.fn.load,Jb={},mb={},Kb="*/".concat("*");try{Ba=da.href}catch(jc){Ba=H.createElement("a"),Ba.href="",Ba=Ba.href}Ia=Hb.exec(Ba.toLowerCase())||[];k.fn.load=function(a,b,c){if("string"!=
...
json:"responseJSON"},converters:{"* text":String,"text html":!0,"text json":k.parseJSON,"text xml":k.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(a,b){return b?M(M(a,k.ajaxSettings),b):M(k.ajaxSettings,a)},ajaxPrefilter:P(Jb),ajaxTransport:P(mb),ajax:function(a,b){function c(a,b,e,f){var A,J,z,I,w=b;if(2!==B){B=2;l&&clearTimeout(l);q=d;h=f||"";x.readyState=0<a?4:0;f=200<=a&&300>a||304===a;if(e){z=m;for(var t=x,Y,r,aa,v,D=z.contents,y=z.dataTypes;"*"===y[0];)y.shift(),r===d&&(r=z.mimeType||
t.getResponseHeader("Content-Type"));if(r)for(v in D)if(D[v]&&D[v].test(r)){y.unshift(v);break}if(y[0]in e)aa=y[0];else{for(v in e){if(!y[0]||z.converters[v+" "+y[0]]){aa=v;break}Y||(Y=v)}aa=aa||Y}z=aa?(aa!==y[0]&&y.unshift(aa),e[aa]):d}var G;a:{e=m;Y=z;r=x;aa=f;var R,H,C;z={};t=e.dataTypes.slice();if(t[1])for(R in e.converters)z[R.toLowerCase()]=e.converters[R];for(v=t.shift();v;)if(e.responseFields[v]&&(r[e.responseFields[v]]=Y),!C&&aa&&e.dataFilter&&(Y=e.dataFilter(Y,e.dataType)),C=v,v=t.shift())if("*"===
v)v=C;else if("*"!==C&&C!==v){if(R=z[C+" "+v]||z["* "+v],!R)for(G in z)if(H=G.split(" "),H[1]===v&&(R=z[C+" "+H[0]]||z["* "+H[0]])){!0===R?R=z[G]:!0!==z[G]&&(v=H[0],t.unshift(H[1]));break}if(!0!==R)if(R&&e["throws"])Y=R(Y);else try{Y=R(Y)}catch(la){G={state:"parsererror",error:R?la:"No conversion from "+C+" to "+v};break a}}G={state:"success",data:Y}}z=G;f?(m.ifModified&&(I=x.getResponseHeader("Last-Modified"),I&&(k.lastModified[g]=I),I=x.getResponseHeader("etag"),I&&(k.etag[g]=I)),204===a||"HEAD"===
m.type?w="nocontent":304===a?w="notmodified":(w=z.state,A=z.data,J=z.error,f=!J)):(J=w,(a||!w)&&(w="error",0>a&&(a=0)));x.status=a;x.statusText=(b||w)+"";f?u.resolveWith(E,[A,w,x]):u.rejectWith(E,[x,w,J]);x.statusCode(s);s=d;n&&p.trigger(f?"ajaxSuccess":"ajaxError",[x,m,f?A:J]);O.fireWith(E,[x,w]);n&&(p.trigger("ajaxComplete",[x,m]),--k.active||k.event.trigger("ajaxStop"))}}"object"==typeof a&&(b=a,a=d);b=b||{};var e,f,g,h,l,n,q,A,m=k.ajaxSetup({},b),E=m.context||m,p=m.context&&(E.nodeType||E.jquery)?
k(E):k.event,u=k.Deferred(),O=k.Callbacks("once memory"),s=m.statusCode||{},J={},I={},B=0,w="canceled",x={readyState:0,getResponseHeader:function(a){var b;if(2===B){if(!A)for(A={};b=dc.exec(h);)A[b[1].toLowerCase()]=b[2];b=A[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===B?h:null},setRequestHeader:function(a,b){var c=a.toLowerCase();return B||(a=I[c]=I[c]||a,J[a]=b),this},overrideMimeType:function(a){return B||(m.mimeType=a),this},statusCode:function(a){var b;
if(a)if(2>B)for(b in a)s[b]=[s[b],a[b]];else x.always(a[x.status]);return this},abort:function(a){a=a||w;return q&&q.abort(a),c(0,a),this}};if(u.promise(x).complete=O.add,x.success=x.done,x.error=x.fail,m.url=((a||m.url||Ba)+"").replace(cc,"").replace(fc,Ia[1]+"//"),m.type=b.method||b.type||m.method||m.type,m.dataTypes=k.trim(m.dataType||"*").toLowerCase().match(ba)||[""],null==m.crossDomain&&(e=Hb.exec(m.url.toLowerCase()),m.crossDomain=!(!e||e[1]===Ia[1]&&e[2]===Ia[2]&&(e[3]||("http:"===e[1]?"80":
"443"))===(Ia[3]||("http:"===Ia[1]?"80":"443")))),m.data&&m.processData&&"string"!=typeof m.data&&(m.data=k.param(m.data,m.traditional)),ca(Jb,m,b,x),2===B)return x;(n=m.global)&&0===k.active++&&k.event.trigger("ajaxStart");m.type=m.type.toUpperCase();m.hasContent=!ec.test(m.type);g=m.url;m.hasContent||(m.data&&(g=m.url+=(tb.test(g)?"&":"?")+m.data,delete m.data),!1===m.cache&&(m.url=Gb.test(g)?g.replace(Gb,"$1_="+sb++):g+(tb.test(g)?"&":"?")+"_="+sb++));m.ifModified&&(k.lastModified[g]&&x.setRequestHeader("If-Modified-Since",
k.lastModified[g]),k.etag[g]&&x.setRequestHeader("If-None-Match",k.etag[g]));(m.data&&m.hasContent&&!1!==m.contentType||b.contentType)&&x.setRequestHeader("Content-Type",m.contentType);x.setRequestHeader("Accept",m.dataTypes[0]&&m.accepts[m.dataTypes[0]]?m.accepts[m.dataTypes[0]]+("*"!==m.dataTypes[0]?", "+Kb+"; q=0.01":""):m.accepts["*"]);for(f in m.headers)x.setRequestHeader(f,m.headers[f]);if(m.beforeSend&&(!1===m.beforeSend.call(E,x,m)||2===B))return x.abort();w="abort";for(f in{success:1,error:1,
complete:1})x[f](m[f]);if(q=ca(mb,m,b,x)){x.readyState=1;n&&p.trigger("ajaxSend",[x,m]);m.async&&0<m.timeout&&(l=setTimeout(function(){x.abort("timeout")},m.timeout));try{B=1,q.send(J,c)}catch(t){if(!(2>B))throw t;c(-1,t)}}else c(-1,"No Transport");return x},getJSON:function(a,b,c){return k.get(a,b,c,"json")},getScript:function(a,b){return k.get(a,d,b,"script")}});k.each(["get","post"],function(a,b){k[b]=function(a,c,e,f){return k.isFunction(c)&&(f=f||e,e=c,c=d),k.ajax({url:a,type:b,dataType:f,data:c,
success:e})}});k.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/(?:java|ecma)script/},converters:{"text script":function(a){return k.globalEval(a),a}}});k.ajaxPrefilter("script",function(a){a.cache===d&&(a.cache=!1);a.crossDomain&&(a.type="GET",a.global=!1)});k.ajaxTransport("script",function(a){if(a.crossDomain){var b,c=H.head||k("head")[0]||H.documentElement;return{send:function(d,e){b=H.createElement("script");
...
d,g&&(l.onreadystatechange=k.noop,vb&&delete Pa[g]),e)4!==l.readyState&&l.abort();else{m={};h=l.status;n=l.getAllResponseHeaders();"string"==typeof l.responseText&&(m.text=l.responseText);try{q=l.statusText}catch(A){q=""}h||!b.isLocal||b.crossDomain?1223===h&&(h=204):h=m.text?200:404}}catch(E){e||f(-1,E)}m&&f(h,q,m,n)};b.async?4===l.readyState?setTimeout(c):(g=++gc,vb&&(Pa||(Pa={},k(a).unload(vb)),Pa[g]=c),l.onreadystatechange=c):c()},abort:function(){c&&c(d,!0)}}}});var Ka,jb,hc=/^(?:toggle|show|hide)$/,
Mb=RegExp("^(?:([+-])=|)("+wa+")([a-z%]*)$","i"),ic=/queueHooks$/,db=[function(a,b,c){var d,e,f,g,h,l=this,n={},m=a.style,A=a.nodeType&&C(a),E=k._data(a,"fxshow");c.queue||(g=k._queueHooks(a,"fx"),null==g.unqueued&&(g.unqueued=0,h=g.empty.fire,g.empty.fire=function(){g.unqueued||h()}),g.unqueued++,l.always(function(){l.always(function(){g.unqueued--;k.queue(a,"fx").length||g.empty.fire()})}));1===a.nodeType&&("height"in b||"width"in b)&&(c.overflow=[m.overflow,m.overflowX,m.overflowY],"inline"===
k.css(a,"display")&&"none"===k.css(a,"float")&&(k.support.inlineBlockNeedsLayout&&"inline"!==U(a.nodeName)?m.zoom=1:m.display="inline-block"));c.overflow&&(m.overflow="hidden",k.support.shrinkWrapBlocks||l.always(function(){m.overflow=c.overflow[0];m.overflowX=c.overflow[1];m.overflowY=c.overflow[2]}));for(d in b)(e=b[d],hc.exec(e))&&(delete b[d],f=f||"toggle"===e,e!==(A?"hide":"show"))&&(n[d]=E&&E[d]||k.style(a,d));if(!k.isEmptyObject(n))for(d in E?"hidden"in E&&(A=E.hidden):E=k._data(a,"fxshow",
{}),f&&(E.hidden=!A),A?k(a).show():l.done(function(){k(a).hide()}),l.done(function(){var b;k._removeData(a,"fxshow");for(b in n)k.style(a,b,n[b])}),n)b=q(A?E[d]:0,d,l),d in E||(E[d]=b.start,A&&(b.end=b.start,b.start="width"===d||"height"===d?1:0))}],Sa={"*":[function(a,b){var c=this.createTween(a,b),d=c.cur(),e=Mb.exec(b),f=e&&e[3]||(k.cssNumber[a]?"":"px"),g=(k.cssNumber[a]||"px"!==f&&+d)&&Mb.exec(k.css(c.elem,a)),h=1,l=20;if(g&&g[3]!==f){f=f||g[3];e=e||[];g=+d||1;do h=h||".5",g/=h,k.style(c.elem,
a,g+f);while(h!==(h=c.cur()/d)&&1!==h&&--l)}return e&&(g=c.start=+g||+d||0,c.unit=f,c.end=e[1]?g+(e[1]+1)*e[2]:+e[2]),c}]};k.Animation=k.extend(I,{tweener:function(a,b){k.isFunction(a)?(b=a,a=["*"]):a=a.split(" ");for(var c,d=0,e=a.length;e>d;d++)c=a[d],Sa[c]=Sa[c]||[],Sa[c].unshift(b)},prefilter:function(a,b){b?db.unshift(a):db.push(a)}});k.Tween=G;G.prototype={constructor:G,init:function(a,b,c,d,e,f){this.elem=a;this.prop=c;this.easing=e||"swing";this.options=b;this.start=this.now=this.cur();this.end=
d;this.unit=f||(k.cssNumber[c]?"":"px")},cur:function(){var a=G.propHooks[this.prop];return a&&a.get?a.get(this):G.propHooks._default.get(this)},run:function(a){var b,c=G.propHooks[this.prop];return this.pos=b=this.options.duration?k.easing[this.easing](a,this.options.duration*a,0,1,this.options.duration):a,this.now=(this.end-this.start)*b+this.start,this.options.step&&this.options.step.call(this.elem,this.now,this),c&&c.set?c.set(this):G.propHooks._default.set(this),this}};G.prototype.init.prototype=
...
k.each(["toggle","show","hide"],function(a,b){var c=k.fn[b];k.fn[b]=function(a,d,e){return null==a||"boolean"==typeof a?c.apply(this,arguments):this.animate(J(b,!0),a,d,e)}});k.fn.extend({fadeTo:function(a,b,c,d){return this.filter(C).css("opacity",0).show().end().animate({opacity:b},a,c,d)},animate:function(a,b,c,d){var e=k.isEmptyObject(a),f=k.speed(b,c,d);b=function(){var b=I(this,k.extend({},a),f);(e||k._data(this,"finish"))&&b.stop(!0)};return b.finish=b,e||!1===f.queue?this.each(b):this.queue(f.queue,
...
c=k._data(this),d=c[a+"queue"];b=c[a+"queueHooks"];var e=k.timers,f=d?d.length:0;c.finish=!0;k.queue(this,a,[]);b&&b.stop&&b.stop.call(this,!0);for(b=e.length;b--;)e[b].elem===this&&e[b].queue===a&&(e[b].anim.stop(!0),e.splice(b,1));for(b=0;f>b;b++)d[b]&&d[b].finish&&d[b].finish.call(this);delete c.finish})}});k.each({slideDown:J("show"),slideUp:J("hide"),slideToggle:J("toggle"),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(a,b){k.fn[a]=function(a,c,d){return this.animate(b,
...
swing:function(a){return 0.5-Math.cos(a*Math.PI)/2}};k.timers=[];k.fx=G.prototype.init;k.fx.tick=function(){var a,b=k.timers,c=0;for(Ka=k.now();b.length>c;c++)a=b[c],a()||b[c]!==a||b.splice(c--,1);b.length||k.fx.stop();Ka=d};k.fx.timer=function(a){a()&&k.timers.push(a)&&k.fx.start()};k.fx.interval=13;k.fx.start=function(){jb||(jb=setInterval(k.fx.tick,k.fx.interval))};k.fx.stop=function(){clearInterval(jb);jb=null};k.fx.speeds={slow:600,fast:200,_default:400};k.fx.step={};k.expr&&k.expr.filters&&
...
var AppendScript=function(a,d){var c=document.createElement("script");c.type="text/javascript";c.src=a;d&&(c.onload=d);document.getElementsByTagName("head")[0].appendChild(c)},csvToSpace=function(a,d){d=d||",";for(var c=RegExp("(\\"+d+'|\\r?\\n|\\r|^)(?:"([^"]*(?:""[^"]*)*)"|([^"\\'+d+"\\r\\n]*))","gi"),b=[[]],e=null;e=c.exec(a);){var g=e[1];g.length&&g!=d&&b.push([]);e=e[2]?e[2].replace(/""/g,'"'):e[3];b[b.length-1].push(e)}var f=b.shift(),f=f.map(function(a){return a.replace(/ /g,"")}),l=new Space;
b.forEach(function(a,b){var c=new Space;a.forEach(function(a,b){var d=f[b];a&&c.set(d,a)});l.append(b,c)});return l};
...
s=c.toLowerCase(),t={innerWidth:a.fn.innerWidth,innerHeight:a.fn.innerHeight,outerWidth:a.fn.outerWidth,outerHeight:a.fn.outerHeight};a.fn["inner"+c]=function(b){return b===d?t["inner"+c].call(this):this.each(function(){a(this).css(s,e(this,b)+"px")})};a.fn["outer"+c]=function(b,d){return"number"!=typeof b?t["outer"+c].call(this,b):this.each(function(){a(this).css(s,e(this,b,!0,d)+"px")})}});a.fn.addBack||(a.fn.addBack=function(a){return this.add(null==a?this.prevObject:this.prevObject.filter(a))});
...
(function(a,d){var c=0,b=Array.prototype.slice,e=a.cleanData;a.cleanData=function(b){for(var c,d=0;null!=(c=b[d]);d++)try{a(c).triggerHandler("remove")}catch(h){}e(b)};a.widget=function(b,c,e){var h,n,s,t,r={},p=b.split(".")[0];b=b.split(".")[1];h=p+"-"+b;e||(e=c,c=a.Widget);a.expr[":"][h.toLowerCase()]=function(b){return!!a.data(b,h)};a[p]=a[p]||{};n=a[p][b];s=a[p][b]=function(a,b){return this._createWidget?(arguments.length&&this._createWidget(a,b),d):new s(a,b)};a.extend(s,n,{version:e.version,
_proto:a.extend({},e),_childConstructors:[]});t=new c;t.options=a.widget.extend({},t.options);a.each(e,function(b,e){return a.isFunction(e)?(r[b]=function(){var a=function(){return c.prototype[b].apply(this,arguments)},d=function(a){return c.prototype[b].apply(this,a)};return function(){var b,c=this._super,f=this._superApply;return this._super=a,this._superApply=d,b=e.apply(this,arguments),this._super=c,this._superApply=f,b}}(),d):(r[b]=e,d)});s.prototype=a.widget.extend(t,{widgetEventPrefix:n?t.widgetEventPrefix:
b},r,{constructor:s,namespace:p,widgetName:b,widgetFullName:h});n?(a.each(n._childConstructors,function(b,c){var d=c.prototype;a.widget(d.namespace+"."+d.widgetName,s,c._proto)}),delete n._childConstructors):c._childConstructors.push(s);a.widget.bridge(b,s)};a.widget.extend=function(c){for(var e,l,h=b.call(arguments,1),n=0,s=h.length;s>n;n++)for(e in h[n])l=h[n][e],h[n].hasOwnProperty(e)&&l!==d&&(c[e]=a.isPlainObject(l)?a.isPlainObject(c[e])?a.widget.extend({},c[e],l):a.widget.extend({},l):l);return c};
a.widget.bridge=function(c,e){var l=e.prototype.widgetFullName||c;a.fn[c]=function(h){var n="string"==typeof h,s=b.call(arguments,1),t=this;return h=!n&&s.length?a.widget.extend.apply(null,[h].concat(s)):h,n?this.each(function(){var b,e=a.data(this,l);return e?a.isFunction(e[h])&&"_"!==h.charAt(0)?(b=e[h].apply(e,s),b!==e&&b!==d?(t=b&&b.jquery?t.pushStack(b.get()):b,!1):d):a.error("no such method '"+h+"' for "+c+" widget instance"):a.error("cannot call methods on "+c+" prior to initialization; attempted to call method '"+
h+"'")}):this.each(function(){var b=a.data(this,l);b?b.option(h||{})._init():a.data(this,l,new e(h,this))}),t}};a.Widget=function(){};a.Widget._childConstructors=[];a.Widget.prototype={widgetName:"widget",widgetEventPrefix:"",defaultElement:"<div>",options:{disabled:!1,create:null},_createWidget:function(b,d){d=a(d||this.defaultElement||this)[0];this.element=a(d);this.uuid=c++;this.eventNamespace="."+this.widgetName+this.uuid;this.options=a.widget.extend({},this.options,this._getCreateOptions(),b);
this.bindings=a();this.hoverable=a();this.focusable=a();d!==this&&(a.data(d,this.widgetFullName,this),this._on(!0,this.element,{remove:function(a){a.target===d&&this.destroy()}}),this.document=a(d.style?d.ownerDocument:d.document||d),this.window=a(this.document[0].defaultView||this.document[0].parentWindow));this._create();this._trigger("create",null,this._getCreateEventData());this._init()},_getCreateOptions:a.noop,_getCreateEventData:a.noop,_create:a.noop,_init:a.noop,destroy:function(){this._destroy();
this.element.unbind(this.eventNamespace).removeData(this.widgetName).removeData(this.widgetFullName).removeData(a.camelCase(this.widgetFullName));this.widget().unbind(this.eventNamespace).removeAttr("aria-disabled").removeClass(this.widgetFullName+"-disabled ui-state-disabled");this.bindings.unbind(this.eventNamespace);this.hoverable.removeClass("ui-state-hover");this.focusable.removeClass("ui-state-focus")},_destroy:a.noop,widget:function(){return this.element},option:function(b,c){var e,h,n,s=b;
if(0===arguments.length)return a.widget.extend({},this.options);if("string"==typeof b)if(s={},e=b.split("."),b=e.shift(),e.length){h=s[b]=a.widget.extend({},this.options[b]);for(n=0;e.length-1>n;n++)h[e[n]]=h[e[n]]||{},h=h[e[n]];if(b=e.pop(),c===d)return h[b]===d?null:h[b];h[b]=c}else{if(c===d)return this.options[b]===d?null:this.options[b];s[b]=c}return this._setOptions(s),this},_setOptions:function(a){for(var b in a)this._setOption(b,a[b]);return this},_setOption:function(a,b){return this.options[a]=
b,"disabled"===a&&(this.widget().toggleClass(this.widgetFullName+"-disabled ui-state-disabled",!!b).attr("aria-disabled",b),this.hoverable.removeClass("ui-state-hover"),this.focusable.removeClass("ui-state-focus")),this},enable:function(){return this._setOption("disabled",!1)},disable:function(){return this._setOption("disabled",!0)},_on:function(b,c,e){var h,n=this;"boolean"!=typeof b&&(e=c,c=b,b=!1);e?(c=h=a(c),this.bindings=this.bindings.add(c)):(e=c,c=this.element,h=this.widget());a.each(e,function(e,
l){function r(){return b||!0!==n.options.disabled&&!a(this).hasClass("ui-state-disabled")?("string"==typeof l?n[l]:l).apply(n,arguments):d}"string"!=typeof l&&(r.guid=l.guid=l.guid||r.guid||a.guid++);var p=e.match(/^(\w+)\s*(.*)$/),w=p[1]+n.eventNamespace;(p=p[2])?h.delegate(p,w,r):c.bind(w,r)})},_off:function(a,b){b=(b||"").split(" ").join(this.eventNamespace+" ")+this.eventNamespace;a.unbind(b).undelegate(b)},_delay:function(a,b){var c=this;return setTimeout(function(){return("string"==typeof a?
...
(function(a,d){function c(a,b,c){return[parseFloat(a[0])*(r.test(a[0])?b/100:1),parseFloat(a[1])*(r.test(a[1])?c/100:1)]}function b(b){var c=b[0];return 9===c.nodeType?{width:b.width(),height:b.height(),offset:{top:0,left:0}}:a.isWindow(c)?{width:b.width(),height:b.height(),offset:{top:b.scrollTop(),left:b.scrollLeft()}}:c.preventDefault?{width:0,height:0,offset:{top:c.pageY,left:c.pageX}}:{width:b.outerWidth(),height:b.outerHeight(),offset:b.offset()}}a.ui=a.ui||{};var e,g=Math.max,f=Math.abs,l=
Math.round,h=/left|center|right/,n=/top|center|bottom/,s=/[\+\-]\d+(\.[\d]+)?%?/,t=/^\w+/,r=/%$/,p=a.fn.position;a.position={scrollbarWidth:function(){if(e!==d)return e;var b,c,f=a("<div style='display:block;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>"),g=f.children()[0];return a("body").append(f),b=g.offsetWidth,f.css("overflow","scroll"),c=g.offsetWidth,b===c&&(c=f[0].clientWidth),f.remove(),e=b-c},getScrollInfo:function(b){var c=b.isWindow?"":b.element.css("overflow-x"),
...
function(d){if(!d||!d.of)return p.apply(this,arguments);d=a.extend({},d);var e,r,K,O,B,L,m=a(d.of),C=a.position.getWithinInfo(d.within),N=a.position.getScrollInfo(C),F=(d.collision||"flip").split(" "),y={};return L=b(m),m[0].preventDefault&&(d.at="left top"),r=L.width,K=L.height,O=L.offset,B=a.extend({},O),a.each(["my","at"],function(){var a,b,c=(d[this]||"").split(" ");1===c.length&&(c=h.test(c[0])?c.concat(["center"]):n.test(c[0])?["center"].concat(c):["center","center"]);c[0]=h.test(c[0])?c[0]:
"center";c[1]=n.test(c[1])?c[1]:"center";a=s.exec(c[0]);b=s.exec(c[1]);y[this]=[a?a[0]:0,b?b[0]:0];d[this]=[t.exec(c[0])[0],t.exec(c[1])[0]]}),1===F.length&&(F[1]=F[0]),"right"===d.at[0]?B.left+=r:"center"===d.at[0]&&(B.left+=r/2),"bottom"===d.at[1]?B.top+=K:"center"===d.at[1]&&(B.top+=K/2),e=c(y.at,r,K),B.left+=e[0],B.top+=e[1],this.each(function(){var b,h,n=a(this),p=n.outerWidth(),s=n.outerHeight(),t=parseInt(a.css(this,"marginLeft"),10)||0,L=parseInt(a.css(this,"marginTop"),10)||0,W=p+t+(parseInt(a.css(this,
"marginRight"),10)||0)+N.width,X=s+L+(parseInt(a.css(this,"marginBottom"),10)||0)+N.height,q=a.extend({},B),I=c(y.my,n.outerWidth(),n.outerHeight());"right"===d.my[0]?q.left-=p:"center"===d.my[0]&&(q.left-=p/2);"bottom"===d.my[1]?q.top-=s:"center"===d.my[1]&&(q.top-=s/2);q.left+=I[0];q.top+=I[1];a.support.offsetFractions||(q.left=l(q.left),q.top=l(q.top));b={marginLeft:t,marginTop:L};a.each(["left","top"],function(c,f){a.ui.position[F[c]]&&a.ui.position[F[c]][f](q,{targetWidth:r,targetHeight:K,elemWidth:p,
elemHeight:s,collisionPosition:b,collisionWidth:W,collisionHeight:X,offset:[e[0]+I[0],e[1]+I[1]],my:d.my,at:d.at,within:C,elem:n})});d.using&&(h=function(a){var b=O.left-q.left,c=b+r-p,e=O.top-q.top,h=e+K-s,l={target:{element:m,left:O.left,top:O.top,width:r,height:K},element:{element:n,left:q.left,top:q.top,width:p,height:s},horizontal:0>c?"left":0<b?"right":"center",vertical:0>h?"top":0<e?"bottom":"middle"};p>r&&r>f(b+c)&&(l.horizontal="center");s>K&&K>f(e+h)&&(l.vertical="middle");l.important=g(f(b),
f(c))>g(f(e),f(h))?"horizontal":"vertical";d.using.call(this,a,l)});n.offset(a.extend(q,{using:h}))})};a.ui.position={fit:{left:function(a,b){var c,d=b.within,e=d.isWindow?d.scrollLeft:d.offset.left,d=d.width,f=a.left-b.collisionPosition.marginLeft,h=e-f,l=f+b.collisionWidth-d-e;b.collisionWidth>d?0<h&&0>=l?(c=a.left+h+b.collisionWidth-d-e,a.left+=h-c):a.left=0<l&&0>=h?e:h>l?e+d-b.collisionWidth:e:0<h?a.left+=h:0<l?a.left-=l:a.left=g(a.left-f,a.left)},top:function(a,b){var c,d=b.within,d=d.isWindow?
...
"right"===b.my[0]?b.elemWidth:0,s="left"===b.at[0]?b.targetWidth:"right"===b.at[0]?-b.targetWidth:0,t=-2*b.offset[0];0>n?(c=a.left+p+s+t+b.collisionWidth-h-g,(0>c||f(n)>c)&&(a.left+=p+s+t)):0<l&&(d=a.left-b.collisionPosition.marginLeft+p+s+t-e,(0<d||l>f(d))&&(a.left+=p+s+t))},top:function(a,b){var c,d,e=b.within,g=e.offset.top+e.scrollTop,h=e.height,e=e.isWindow?e.scrollTop:e.offset.top,l=a.top-b.collisionPosition.marginTop,n=l-e,l=l+b.collisionHeight-h-e,p="top"===b.my[1]?-b.elemHeight:"bottom"===
b.my[1]?b.elemHeight:0,s="top"===b.at[1]?b.targetHeight:"bottom"===b.at[1]?-b.targetHeight:0,t=-2*b.offset[1];0>n?(d=a.top+p+s+t+b.collisionHeight-h-g,a.top+p+s+t>n&&(0>d||f(n)>d)&&(a.top+=p+s+t)):0<l&&(c=a.top-b.collisionPosition.marginTop+p+s+t-e,a.top+p+s+t>l&&(0<c||l>f(c))&&(a.top+=p+s+t))}},flipfit:{left:function(){a.ui.position.flip.left.apply(this,arguments);a.ui.position.fit.left.apply(this,arguments)},top:function(){a.ui.position.flip.top.apply(this,arguments);a.ui.position.fit.top.apply(this,
...
this.cssPosition?-this.scrollParent.scrollTop():this.offset.scroll.top)*b,left:c.left+this.offset.relative.left*b+this.offset.parent.left*b-("fixed"===this.cssPosition?-this.scrollParent.scrollLeft():this.offset.scroll.left)*b}},_generatePosition:function(d){var c,b,e,g,f=this.options,l="absolute"!==this.cssPosition||this.scrollParent[0]!==document&&a.contains(this.scrollParent[0],this.offsetParent[0])?this.scrollParent:this.offsetParent,h=d.pageX,n=d.pageY;return this.offset.scroll||(this.offset.scroll=
{top:l.scrollTop(),left:l.scrollLeft()}),this.originalPosition&&(this.containment&&(this.relative_container?(b=this.relative_container.offset(),c=[this.containment[0]+b.left,this.containment[1]+b.top,this.containment[2]+b.left,this.containment[3]+b.top]):c=this.containment,d.pageX-this.offset.click.left<c[0]&&(h=c[0]+this.offset.click.left),d.pageY-this.offset.click.top<c[1]&&(n=c[1]+this.offset.click.top),d.pageX-this.offset.click.left>c[2]&&(h=c[2]+this.offset.click.left),d.pageY-this.offset.click.top>
c[3]&&(n=c[3]+this.offset.click.top)),f.grid&&(e=f.grid[1]?this.originalPageY+Math.round((n-this.originalPageY)/f.grid[1])*f.grid[1]:this.originalPageY,n=c?e-this.offset.click.top>=c[1]||e-this.offset.click.top>c[3]?e:e-this.offset.click.top>=c[1]?e-f.grid[1]:e+f.grid[1]:e,g=f.grid[0]?this.originalPageX+Math.round((h-this.originalPageX)/f.grid[0])*f.grid[0]:this.originalPageX,h=c?g-this.offset.click.left>=c[0]||g-this.offset.click.left>c[2]?g:g-this.offset.click.left>=c[0]?g-f.grid[0]:g+f.grid[0]:
...
top:c.top,left:c.left})})},drag:function(d,c){var b,e,g,f,l,h,n,s,t,r,p=a(this).data("ui-draggable"),w=p.options,v=w.snapTolerance,D=c.offset.left,K=D+p.helperProportions.width,O=c.offset.top,B=O+p.helperProportions.height;for(t=p.snapElements.length-1;0<=t;t--)l=p.snapElements[t].left,h=l+p.snapElements[t].width,n=p.snapElements[t].top,s=n+p.snapElements[t].height,l-v>K||D>h+v||n-v>B||O>s+v||!a.contains(p.snapElements[t].item.ownerDocument,p.snapElements[t].item)?(p.snapElements[t].snapping&&p.options.snap.release&&
p.options.snap.release.call(p.element,d,a.extend(p._uiHash(),{snapItem:p.snapElements[t].item})),p.snapElements[t].snapping=!1):("inner"!==w.snapMode&&(b=v>=Math.abs(n-B),e=v>=Math.abs(s-O),g=v>=Math.abs(l-K),f=v>=Math.abs(h-D),b&&(c.position.top=p._convertPositionTo("relative",{top:n-p.helperProportions.height,left:0}).top-p.margins.top),e&&(c.position.top=p._convertPositionTo("relative",{top:s,left:0}).top-p.margins.top),g&&(c.position.left=p._convertPositionTo("relative",{top:0,left:l-p.helperProportions.width}).left-
p.margins.left),f&&(c.position.left=p._convertPositionTo("relative",{top:0,left:h}).left-p.margins.left)),r=b||e||g||f,"outer"!==w.snapMode&&(b=v>=Math.abs(n-O),e=v>=Math.abs(s-B),g=v>=Math.abs(l-D),f=v>=Math.abs(h-K),b&&(c.position.top=p._convertPositionTo("relative",{top:n,left:0}).top-p.margins.top),e&&(c.position.top=p._convertPositionTo("relative",{top:s-p.helperProportions.height,left:0}).top-p.margins.top),g&&(c.position.left=p._convertPositionTo("relative",{top:0,left:l}).left-p.margins.left),
f&&(c.position.left=p._convertPositionTo("relative",{top:0,left:h-p.helperProportions.width}).left-p.margins.left)),!p.snapElements[t].snapping&&(b||e||g||f||r)&&p.options.snap.snap&&p.options.snap.snap.call(p.element,d,a.extend(p._uiHash(),{snapItem:p.snapElements[t].item})),p.snapElements[t].snapping=b||e||g||f||r)}});a.ui.plugin.add("draggable","stack",{start:function(){var d,c=this.data("ui-draggable").options,c=a.makeArray(a(c.stack)).sort(function(b,c){return(parseInt(a(b).css("zIndex"),10)||
...
this.element):!1):!1},ui:function(a){return{draggable:a.currentItem||a.element,helper:a.helper,position:a.position,offset:a.positionAbs}}});a.ui.intersect=function(a,c,b){if(!c.offset)return!1;var e,g,f=(a.positionAbs||a.position.absolute).left,l=f+a.helperProportions.width,h=(a.positionAbs||a.position.absolute).top,n=h+a.helperProportions.height,s=c.offset.left,t=s+c.proportions.width,r=c.offset.top,p=r+c.proportions.height;switch(b){case "fit":return f>=s&&t>=l&&h>=r&&p>=n;case "intersect":return f+
a.helperProportions.width/2>s&&t>l-a.helperProportions.width/2&&h+a.helperProportions.height/2>r&&p>n-a.helperProportions.height/2;case "pointer":return e=(a.positionAbs||a.position.absolute).left+(a.clickOffset||a.offset.click).left,g=(a.positionAbs||a.position.absolute).top+(a.clickOffset||a.offset.click).top,g>r&&r+c.proportions.height>g&&e>s&&s+c.proportions.width>e;case "touch":return(h>=r&&p>=h||n>=r&&p>=n||r>h&&n>p)&&(f>=s&&t>=f||l>=s&&t>=l||s>f&&l>t);default:return!1}};a.ui.ddmanager={current:null,
droppables:{"default":[]},prepareOffsets:function(d,c){var b,e,g=a.ui.ddmanager.droppables[d.options.scope]||[],f=c?c.type:null,l=(d.currentItem||d.element).find(":data(ui-droppable)").addBack();b=0;a:for(;g.length>b;b++)if(!(g[b].options.disabled||d&&!g[b].accept.call(g[b].element[0],d.currentItem||d.element))){for(e=0;l.length>e;e++)if(l[e]===g[b].element[0]){g[b].proportions.height=0;continue a}g[b].visible="none"!==g[b].element.css("display");g[b].visible&&("mousedown"===f&&g[b]._activate.call(g[b],
...
this},_mouseCapture:function(b){var c,d,f=!1;for(c in this.handles)d=a(this.handles[c])[0],(d===b.target||a.contains(d,b.target))&&(f=!0);return!this.options.disabled&&f},_mouseStart:function(b){var c,g,f,l=this.options,h=this.element.position(),n=this.element;return this.resizing=!0,/absolute/.test(n.css("position"))?n.css({position:"absolute",top:n.css("top"),left:n.css("left")}):n.is(".ui-draggable")&&n.css({position:"absolute",top:h.top,left:h.left}),this._renderProxy(),c=d(this.helper.css("left")),
g=d(this.helper.css("top")),l.containment&&(c+=a(l.containment).scrollLeft()||0,g+=a(l.containment).scrollTop()||0),this.offset=this.helper.offset(),this.position={left:c,top:g},this.size=this._helper?{width:n.outerWidth(),height:n.outerHeight()}:{width:n.width(),height:n.height()},this.originalSize=this._helper?{width:n.outerWidth(),height:n.outerHeight()}:{width:n.width(),height:n.height()},this.originalPosition={left:c,top:g},this.sizeDiff={width:n.outerWidth()-n.width(),height:n.outerHeight()-
n.height()},this.originalMousePosition={left:b.pageX,top:b.pageY},this.aspectRatio="number"==typeof l.aspectRatio?l.aspectRatio:this.originalSize.width/this.originalSize.height||1,f=a(".ui-resizable-"+this.axis).css("cursor"),a("body").css("cursor","auto"===f?this.axis+"-resize":f),n.addClass("ui-resizable-resizing"),this._propagate("start",b),!0},_mouseDrag:function(b){var c,d=this.helper,f={},l=this.originalMousePosition,h=this.position.top,n=this.position.left,s=this.size.width,t=this.size.height,
r=b.pageX-l.left||0,l=b.pageY-l.top||0,p=this._change[this.axis];return p?(c=p.apply(this,[b,r,l]),this._updateVirtualBoundaries(b.shiftKey),(this._aspectRatio||b.shiftKey)&&(c=this._updateRatio(c,b)),c=this._respectSize(c,b),this._updateCache(c),this._propagate("resize",b),this.position.top!==h&&(f.top=this.position.top+"px"),this.position.left!==n&&(f.left=this.position.left+"px"),this.size.width!==s&&(f.width=this.size.width+"px"),this.size.height!==t&&(f.height=this.size.height+"px"),d.css(f),
!this._helper&&this._proportionallyResizeElements.length&&this._proportionallyResize(),a.isEmptyObject(f)||this._trigger("resize",b,this.ui()),!1):!1},_mouseStop:function(b){this.resizing=!1;var c,d,f,l,h,n,s,t=this.options;return this._helper&&(c=this._proportionallyResizeElements,d=c.length&&/textarea/i.test(c[0].nodeName),f=d&&a.ui.hasScroll(c[0],"left")?0:this.sizeDiff.height,l=d?0:this.sizeDiff.width,h={width:this.helper.width()-l,height:this.helper.height()-f},n=parseInt(this.element.css("left"),
10)+(this.position.left-this.originalPosition.left)||null,s=parseInt(this.element.css("top"),10)+(this.position.top-this.originalPosition.top)||null,t.animate||this.element.css(a.extend(h,{top:s,left:n})),this.helper.height(this.size.height),this.helper.width(this.size.width),this._helper&&!t.animate&&this._proportionallyResize()),a("body").css("cursor","auto"),this.element.removeClass("ui-resizable-resizing"),this._propagate("stop",b),this._helper&&this.helper.remove(),!1},_updateVirtualBoundaries:function(a){var d,
g,f,l,h;h=this.options;h={minWidth:c(h.minWidth)?h.minWidth:0,maxWidth:c(h.maxWidth)?h.maxWidth:1/0,minHeight:c(h.minHeight)?h.minHeight:0,maxHeight:c(h.maxHeight)?h.maxHeight:1/0};(this._aspectRatio||a)&&(d=h.minHeight*this.aspectRatio,f=h.minWidth/this.aspectRatio,g=h.maxHeight*this.aspectRatio,l=h.maxWidth/this.aspectRatio,d>h.minWidth&&(h.minWidth=d),f>h.minHeight&&(h.minHeight=f),h.maxWidth>g&&(h.maxWidth=g),h.maxHeight>l&&(h.maxHeight=l));this._vBoundaries=h},_updateCache:function(a){this.offset=
...
this._vBoundaries,g=this.axis,f=c(a.width)&&d.maxWidth&&d.maxWidth<a.width,l=c(a.height)&&d.maxHeight&&d.maxHeight<a.height,h=c(a.width)&&d.minWidth&&d.minWidth>a.width,n=c(a.height)&&d.minHeight&&d.minHeight>a.height,s=this.originalPosition.left+this.originalSize.width,t=this.position.top+this.size.height,r=/sw|nw|w/.test(g),g=/nw|ne|n/.test(g);return h&&(a.width=d.minWidth),n&&(a.height=d.minHeight),f&&(a.width=d.maxWidth),l&&(a.height=d.maxHeight),h&&r&&(a.left=s-d.minWidth),f&&r&&(a.left=s-d.maxWidth),
n&&g&&(a.top=t-d.minHeight),l&&g&&(a.top=t-d.maxHeight),a.width||a.height||a.left||!a.top?a.width||a.height||a.top||!a.left||(a.left=null):a.top=null,a},_proportionallyResize:function(){if(this._proportionallyResizeElements.length){var a,c,d,f,l,h=this.helper||this.element;for(a=0;this._proportionallyResizeElements.length>a;a++){if(l=this._proportionallyResizeElements[a],!this.borderDif)for(this.borderDif=[],d=[l.css("borderTopWidth"),l.css("borderRightWidth"),l.css("borderBottomWidth"),l.css("borderLeftWidth")],
f=[l.css("paddingTop"),l.css("paddingRight"),l.css("paddingBottom"),l.css("paddingLeft")],c=0;d.length>c;c++)this.borderDif[c]=(parseInt(d[c],10)||0)+(parseInt(f[c],10)||0);l.css({height:h.height()-this.borderDif[0]-this.borderDif[2]||0,width:h.width()-this.borderDif[1]-this.borderDif[3]||0})}}},_renderProxy:function(){var b=this.options;this.elementOffset=this.element.offset();this._helper?(this.helper=this.helper||a("<div style='overflow:hidden;'></div>"),this.helper.addClass(this._helper).css({width:this.element.outerWidth()-
...
"resize"!==b&&this._trigger(b,c,this.ui())},plugins:{},ui:function(){return{originalElement:this.originalElement,element:this.element,helper:this.helper,position:this.position,size:this.size,originalSize:this.originalSize,originalPosition:this.originalPosition}}});a.ui.plugin.add("resizable","animate",{stop:function(b){var c=a(this).data("ui-resizable"),d=c.options,f=c._proportionallyResizeElements,l=f.length&&/textarea/i.test(f[0].nodeName),h=l&&a.ui.hasScroll(f[0],"left")?0:c.sizeDiff.height,l=
{width:c.size.width-(l?0:c.sizeDiff.width),height:c.size.height-h},h=parseInt(c.element.css("left"),10)+(c.position.left-c.originalPosition.left)||null,n=parseInt(c.element.css("top"),10)+(c.position.top-c.originalPosition.top)||null;c.element.animate(a.extend(l,n&&h?{top:n,left:h}:{}),{duration:d.animateDuration,easing:d.animateEasing,step:function(){var d={width:parseInt(c.element.css("width"),10),height:parseInt(c.element.css("height"),10),top:parseInt(c.element.css("top"),10),left:parseInt(c.element.css("left"),
10)};f&&f.length&&a(f[0]).css({width:d.width,height:d.height});c._updateCache(d);c._propagate("resize",b)}})}});a.ui.plugin.add("resizable","containment",{start:function(){var b,c,g,f,l,h,n,s=a(this).data("ui-resizable"),t=s.element,r=s.options.containment;(t=r instanceof a?r.get(0):/parent/.test(r)?t.parent().get(0):r)&&(s.containerElement=a(t),/document/.test(r)||r===document?(s.containerOffset={left:0,top:0},s.containerPosition={left:0,top:0},s.parentData={element:a(document),left:0,top:0,width:a(document).width(),
height:a(document).height()||document.body.parentNode.scrollHeight}):(b=a(t),c=[],a(["Top","Right","Left","Bottom"]).each(function(a,f){c[a]=d(b.css("padding"+f))}),s.containerOffset=b.offset(),s.containerPosition=b.position(),s.containerSize={height:b.innerHeight()-c[3],width:b.innerWidth()-c[1]},g=s.containerOffset,f=s.containerSize.height,l=s.containerSize.width,h=a.ui.hasScroll(t,"left")?t.scrollWidth:l,n=a.ui.hasScroll(t)?t.scrollHeight:f,s.parentData={element:t,left:g.left,top:g.top,width:h,
height:n}))},resize:function(b){var c,d,f,l,h=a(this).data("ui-resizable");c=h.options;d=h.containerOffset;f=h.position;b=h._aspectRatio||b.shiftKey;l={top:0,left:0};var n=h.containerElement;n[0]!==document&&/static/.test(n.css("position"))&&(l=d);f.left<(h._helper?d.left:0)&&(h.size.width+=h._helper?h.position.left-d.left:h.position.left-l.left,b&&(h.size.height=h.size.width/h.aspectRatio),h.position.left=c.helper?d.left:0);f.top<(h._helper?d.top:0)&&(h.size.height+=h._helper?h.position.top-d.top:
h.position.top,b&&(h.size.width=h.size.height*h.aspectRatio),h.position.top=h._helper?d.top:0);h.offset.left=h.parentData.left+h.position.left;h.offset.top=h.parentData.top+h.position.top;c=Math.abs(h.offset.left-l.left+h.sizeDiff.width);d=Math.abs((h._helper?h.offset.top-l.top:h.offset.top-d.top)+h.sizeDiff.height);f=h.containerElement.get(0)===h.element.parent().get(0);l=/relative|absolute/.test(h.containerElement.css("position"));f&&l&&(c-=h.parentData.left);c+h.size.width>=h.parentData.width&&
(h.size.width=h.parentData.width-c,b&&(h.size.height=h.size.width/h.aspectRatio));d+h.size.height>=h.parentData.height&&(h.size.height=h.parentData.height-d,b&&(h.size.width=h.size.height*h.aspectRatio))},stop:function(){var b=a(this).data("ui-resizable"),c=b.options,d=b.containerOffset,f=b.containerPosition,l=b.containerElement,h=a(b.helper),n=h.offset(),s=h.outerWidth()-b.sizeDiff.width,h=h.outerHeight()-b.sizeDiff.height;b._helper&&!c.animate&&/relative/.test(l.css("position"))&&a(this).css({left:n.left-
f.left-d.left,width:s,height:h});b._helper&&!c.animate&&/static/.test(l.css("position"))&&a(this).css({left:n.left-f.left-d.left,width:s,height:h})}});a.ui.plugin.add("resizable","alsoResize",{start:function(){var b=a(this).data("ui-resizable").options,c=function(b){a(b).each(function(){var b=a(this);b.data("ui-resizable-alsoresize",{width:parseInt(b.width(),10),height:parseInt(b.height(),10),left:parseInt(b.css("left"),10),top:parseInt(b.css("top"),10)})})};"object"!=typeof b.alsoResize||b.alsoResize.parentNode?
c(b.alsoResize):b.alsoResize.length?(b.alsoResize=b.alsoResize[0],c(b.alsoResize)):a.each(b.alsoResize,function(a){c(a)})},resize:function(b,c){var d=a(this).data("ui-resizable"),f=d.options,l=d.originalSize,h=d.originalPosition,n={height:d.size.height-l.height||0,width:d.size.width-l.width||0,top:d.position.top-h.top||0,left:d.position.left-h.left||0},s=function(b,d){a(b).each(function(){var b=a(this),f=a(this).data("ui-resizable-alsoresize"),g={},h=d&&d.length?d:b.parents(c.originalElement[0]).length?
["width","height"]:["width","height","top","left"];a.each(h,function(a,b){var c=(f[b]||0)+(n[b]||0);c&&0<=c&&(g[b]=c||null)});b.css(g)})};"object"!=typeof f.alsoResize||f.alsoResize.nodeType?s(f.alsoResize):a.each(f.alsoResize,function(a,b){s(a,b)})},stop:function(){a(this).removeData("resizable-alsoresize")}});a.ui.plugin.add("resizable","ghost",{start:function(){var b=a(this).data("ui-resizable"),c=b.options,d=b.size;b.ghost=b.originalElement.clone();b.ghost.css({opacity:0.25,display:"block",position:"relative",
height:d.height,width:d.width,margin:0,left:0,top:0}).addClass("ui-resizable-ghost").addClass("string"==typeof c.ghost?c.ghost:"");b.ghost.appendTo(b.helper)},resize:function(){var b=a(this).data("ui-resizable");b.ghost&&b.ghost.css({position:"relative",height:b.size.height,width:b.size.width})},stop:function(){var b=a(this).data("ui-resizable");b.ghost&&b.helper&&b.helper.get(0).removeChild(b.ghost.get(0))}});a.ui.plugin.add("resizable","grid",{resize:function(){var b=a(this).data("ui-resizable"),
c=b.options,d=b.size,f=b.originalSize,l=b.originalPosition,h=b.axis,n="number"==typeof c.grid?[c.grid,c.grid]:c.grid,s=n[0]||1,t=n[1]||1,r=Math.round((d.width-f.width)/s)*s,d=Math.round((d.height-f.height)/t)*t,p=f.width+r,f=f.height+d,w=c.maxWidth&&p>c.maxWidth,v=c.maxHeight&&f>c.maxHeight,D=c.minWidth&&c.minWidth>p,K=c.minHeight&&c.minHeight>f;c.grid=n;D&&(p+=s);K&&(f+=t);w&&(p-=s);v&&(f-=t);/^(se|s|e)$/.test(h)?(b.size.width=p,b.size.height=f):/^(ne)$/.test(h)?(b.size.width=p,b.size.height=f,b.position.top=
l.top-d):/^(sw)$/.test(h)?(b.size.width=p,b.size.height=f,b.position.left=l.left-r):(b.size.width=p,b.size.height=f,b.position.top=l.top-d,b.position.left=l.left-r)}})})(jQuery);
...
!1):void 0}))},_mouseDrag:function(d){if(this.dragged=!0,!this.options.disabled){var c,b=this,e=this.options,g=this.opos[0],f=this.opos[1],l=d.pageX,h=d.pageY;return g>l&&(c=l,l=g,g=c),f>h&&(c=h,h=f,f=c),this.helper.css({left:g,top:f,width:l-g,height:h-f}),this.selectees.each(function(){var c=a.data(this,"selectable-item"),s=!1;c&&c.element!==b.element[0]&&("touch"===e.tolerance?s=!(c.left>l||g>c.right||c.top>h||f>c.bottom):"fit"===e.tolerance&&(s=c.left>g&&l>c.right&&c.top>f&&h>c.bottom),s?(c.selected&&
...
(a.ui.ddmanager.current=this),a.ui.ddmanager&&!b.dropBehaviour&&a.ui.ddmanager.prepareOffsets(this,c),this.dragging=!0,this.helper.addClass("ui-sortable-helper"),this._mouseDrag(c),!0},_mouseDrag:function(c){var b,d,g,f;b=this.options;var l=!1;this.position=this._generatePosition(c);this.positionAbs=this._convertPositionTo("absolute");this.lastPositionAbs||(this.lastPositionAbs=this.positionAbs);this.options.scroll&&(this.scrollParent[0]!==document&&"HTML"!==this.scrollParent[0].tagName?(this.overflowOffset.top+
this.scrollParent[0].offsetHeight-c.pageY<b.scrollSensitivity?this.scrollParent[0].scrollTop=l=this.scrollParent[0].scrollTop+b.scrollSpeed:c.pageY-this.overflowOffset.top<b.scrollSensitivity&&(this.scrollParent[0].scrollTop=l=this.scrollParent[0].scrollTop-b.scrollSpeed),this.overflowOffset.left+this.scrollParent[0].offsetWidth-c.pageX<b.scrollSensitivity?this.scrollParent[0].scrollLeft=l=this.scrollParent[0].scrollLeft+b.scrollSpeed:c.pageX-this.overflowOffset.left<b.scrollSensitivity&&(this.scrollParent[0].scrollLeft=
l=this.scrollParent[0].scrollLeft-b.scrollSpeed)):(c.pageY-a(document).scrollTop()<b.scrollSensitivity?l=a(document).scrollTop(a(document).scrollTop()-b.scrollSpeed):a(window).height()-(c.pageY-a(document).scrollTop())<b.scrollSensitivity&&(l=a(document).scrollTop(a(document).scrollTop()+b.scrollSpeed)),c.pageX-a(document).scrollLeft()<b.scrollSensitivity?l=a(document).scrollLeft(a(document).scrollLeft()-b.scrollSpeed):a(window).width()-(c.pageX-a(document).scrollLeft())<b.scrollSensitivity&&(l=a(document).scrollLeft(a(document).scrollLeft()+
b.scrollSpeed))),!1!==l&&a.ui.ddmanager&&!b.dropBehaviour&&a.ui.ddmanager.prepareOffsets(this,c));this.positionAbs=this._convertPositionTo("absolute");this.options.axis&&"y"===this.options.axis||(this.helper[0].style.left=this.position.left+"px");this.options.axis&&"x"===this.options.axis||(this.helper[0].style.top=this.position.top+"px");for(b=this.items.length-1;0<=b;b--)if(d=this.items[b],g=d.item[0],f=this._intersectsWithPointer(d),f&&d.instance===this.currentContainer&&g!==this.currentItem[0]&&
...
b){if(c){if(a.ui.ddmanager&&!this.options.dropBehaviour&&a.ui.ddmanager.drop(this,c),this.options.revert){var d=this,g=this.placeholder.offset(),f=this.options.axis,l={};f&&"x"!==f||(l.left=g.left-this.offset.parent.left-this.margins.left+(this.offsetParent[0]===document.body?0:this.offsetParent[0].scrollLeft));f&&"y"!==f||(l.top=g.top-this.offset.parent.top-this.margins.top+(this.offsetParent[0]===document.body?0:this.offsetParent[0].scrollTop));this.reverting=!0;a(this.helper).animate(l,parseInt(this.options.revert,
...
f=g+this.helperProportions.height,l=a.left,h=l+a.width,n=a.top,s=n+a.height,t=this.offset.click.top,r=this.offset.click.left,r="y"===this.options.axis||b+r>l&&h>b+r,t=("x"===this.options.axis||g+t>n&&s>g+t)&&r;return"pointer"===this.options.tolerance||this.options.forcePointerForContainers||"pointer"!==this.options.tolerance&&this.helperProportions[this.floating?"width":"height"]>a[this.floating?"width":"height"]?t:b+this.helperProportions.width/2>l&&h>d-this.helperProportions.width/2&&g+this.helperProportions.height/
2>n&&s>f-this.helperProportions.height/2},_intersectsWithPointer:function(a){var b="y"===this.options.axis||this.positionAbs.left+this.offset.click.left>a.left&&a.left+a.width>this.positionAbs.left+this.offset.click.left;a=("x"===this.options.axis||this.positionAbs.top+this.offset.click.top>a.top&&a.top+a.height>this.positionAbs.top+this.offset.click.top)&&b;var b=this._getDragVerticalDirection(),d=this._getDragHorizontalDirection();return a?this.floating?d&&"right"===d||"down"===b?2:1:b&&("down"===
...
this.positionAbs.top-this.lastPositionAbs.top;return 0!==a&&(0<a?"down":"up")},_getDragHorizontalDirection:function(){var a=this.positionAbs.left-this.lastPositionAbs.left;return 0!==a&&(0<a?"right":"left")},refresh:function(a){return this._refreshItems(a),this.refreshPositions(),this},_connectWith:function(){var a=this.options;return a.connectWith.constructor===String?[a.connectWith]:a.connectWith},_getItemsAsjQuery:function(c){var b,d,g,f=[],l=[],h=this._connectWith();if(h&&c)for(c=h.length-1;0<=
c;c--)for(d=a(h[c]),b=d.length-1;0<=b;b--)(g=a.data(d[b],this.widgetFullName))&&g!==this&&!g.options.disabled&&l.push([a.isFunction(g.options.items)?g.options.items.call(g.element):a(g.options.items,g.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),g]);l.push([a.isFunction(this.options.items)?this.options.items.call(this.element,null,{options:this.options,item:this.currentItem}):a(this.options.items,this.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),this]);
for(c=l.length-1;0<=c;c--)l[c][0].each(function(){f.push(this)});return a(f)},_removeCurrentsFromItems:function(){var c=this.currentItem.find(":data("+this.widgetName+"-item)");this.items=a.grep(this.items,function(a){for(var d=0;c.length>d;d++)if(c[d]===a.item[0])return!1;return!0})},_refreshItems:function(c){this.items=[];this.containers=[this];var b,d,g,f,l,h=this.items,n=[[a.isFunction(this.options.items)?this.options.items.call(this.element[0],c,{item:this.currentItem}):a(this.options.items,
this.element),this]];if((l=this._connectWith())&&this.ready)for(b=l.length-1;0<=b;b--)for(g=a(l[b]),d=g.length-1;0<=d;d--)(f=a.data(g[d],this.widgetFullName))&&f!==this&&!f.options.disabled&&(n.push([a.isFunction(f.options.items)?f.options.items.call(f.element[0],c,{item:this.currentItem}):a(f.options.items,f.element),f]),this.containers.push(f));for(b=n.length-1;0<=b;b--)for(c=n[b][1],g=n[b][0],d=0,l=g.length;l>d;d++)f=a(g[d]),f.data(this.widgetName+"-item",c),h.push({item:f,instance:c,width:0,height:0,
...
parseInt(c.currentItem.css("paddingTop")||0,10)-parseInt(c.currentItem.css("paddingBottom")||0,10)),f.width()||f.width(c.currentItem.innerWidth()-parseInt(c.currentItem.css("paddingLeft")||0,10)-parseInt(c.currentItem.css("paddingRight")||0,10)))}});c.placeholder=a(d.placeholder.element.call(c.element,c.currentItem));c.currentItem.after(c.placeholder);d.placeholder.update(c,c.placeholder)},_contactContainers:function(c){var b,e,g,f,l,h,n,s,t,r=e=null;for(b=this.containers.length-1;0<=b;b--)a.contains(this.currentItem[0],
this.containers[b].element[0])||(this._intersectsWith(this.containers[b].containerCache)?e&&a.contains(this.containers[b].element[0],e.element[0])||(e=this.containers[b],r=b):this.containers[b].containerCache.over&&(this.containers[b]._trigger("out",c,this._uiHash(this)),this.containers[b].containerCache.over=0));if(e)if(1===this.containers.length)this.containers[r].containerCache.over||(this.containers[r]._trigger("over",c,this._uiHash(this)),this.containers[r].containerCache.over=1);else{b=1E4;
g=null;f=(t=e.floating||d(this.currentItem))?"left":"top";l=t?"width":"height";h=this.positionAbs[f]+this.offset.click[f];for(e=this.items.length-1;0<=e;e--)a.contains(this.containers[r].element[0],this.items[e].item[0])&&this.items[e].item[0]!==this.currentItem[0]&&(!t||this.positionAbs.top+this.offset.click.top>this.items[e].top&&this.items[e].top+this.items[e].height>this.positionAbs.top+this.offset.click.top)&&(n=this.items[e].item.offset()[f],s=!1,Math.abs(n-h)>Math.abs(n+this.items[e][l]-h)&&
(s=!0,n+=this.items[e][l]),b>Math.abs(n-h)&&(b=Math.abs(n-h),g=this.items[e],this.direction=s?"up":"down"));(g||this.options.dropOnEmpty)&&this.currentContainer!==this.containers[r]&&(g?this._rearrange(c,g,null,!0):this._rearrange(c,null,this.containers[r].element,!0),this._trigger("change",c,this._uiHash()),this.containers[r]._trigger("change",c,this._uiHash(this)),this.currentContainer=this.containers[r],this.options.placeholder.update(this.currentContainer,this.placeholder),this.containers[r]._trigger("over",
...
d+this.offset.parent.left*d-("fixed"===this.cssPosition?-this.scrollParent.scrollLeft():f?0:g.scrollLeft())*d}},_generatePosition:function(c){var b,d,g=this.options,f=c.pageX,l=c.pageY,h="absolute"!==this.cssPosition||this.scrollParent[0]!==document&&a.contains(this.scrollParent[0],this.offsetParent[0])?this.scrollParent:this.offsetParent,n=/(html|body)/i.test(h[0].tagName);return"relative"!==this.cssPosition||this.scrollParent[0]!==document&&this.scrollParent[0]!==this.offsetParent[0]||(this.offset.relative=
...
d.extend({},r,a);c.callbacks={move:n(c.move,b),change:n(c.change,b),show:n(c.show,b),hide:n(c.hide,b),beforeShow:n(c.beforeShow,b)};return c}function g(g,l){function n(){T.toggleClass("sp-flat",u);T.toggleClass("sp-input-disabled",!J.showInput);T.toggleClass("sp-alpha-enabled",J.showAlpha);T.toggleClass("sp-buttons-disabled",!J.showButtons||u);T.toggleClass("sp-palette-disabled",!J.showPalette);T.toggleClass("sp-palette-only",J.showPaletteOnly);T.toggleClass("sp-initial-disabled",!J.showInitial);
T.addClass(J.className);x()}function m(b){if(E&&(b=tinycolor(b).toRgbString(),-1===d.inArray(b,ba)&&ba.push(b),aa&&a.localStorage))try{a.localStorage[aa]=ba.join(";")}catch(c){}}function r(){var a=[],b=ba,c={},d;if(J.showPalette){for(var e=0;e<wa.length;e++)for(var f=0;f<wa[e].length;f++)d=tinycolor(wa[e][f]).toRgbString(),c[d]=!0;for(e=0;e<b.length;e++)d=tinycolor(b[e]).toRgbString(),c.hasOwnProperty(d)||(a.push(b[e]),c[d]=!0)}return a.reverse().slice(0,J.maxSelectionSize)}function N(){var a=M(),
c=d.map(wa,function(c,d){return b(c,a,"sp-palette-row sp-palette-row-"+d)});ba&&c.push(b(r(),a,"sp-palette-row sp-palette-row-selection"));bb.html(c.join(""))}function F(){if(J.showInitial){var a=fa,c=M();xa.html(b([a,c],c,"sp-palette-row-initial"))}}function y(){0!==na&&0!==ja&&0!==ka||x();T.addClass(Ta)}function S(){T.removeClass(Ta)}function U(){var a=tinycolor(ga.val());a.ok?ca(a):ga.addClass("sp-validation-error")}function V(){ma?P():Z()}function Z(){if(ma)x();else if(!1!==da.beforeShow(M())){for(var b=
0;b<p.length;b++)p[b]&&p[b].hide();ma=!0;d(La).bind("click.spectrum",P);d(a).bind("resize.spectrum",H);Aa.addClass("sp-active");T.show();J.showPalette&&N();x();X();fa=M();F();da.show(fa)}}function P(b){b&&"click"==b.type&&2==b.button||(!ma||u)||(ma=!1,d(La).unbind("click.spectrum",P),d(a).unbind("resize.spectrum",H),Aa.removeClass("sp-active"),T.hide(),tinycolor.equals(M(),fa)||(hb&&"cancel"!==b?I(!0):ca(fa,!0)),da.hide(M()))}function ca(a,b){if(!tinycolor.equals(a,M())){var c=tinycolor(a),d=c.toHsv();
Y=d.h;la=d.s;oa=d.v;pa=d.a;X();b||(Oa=$a||c.format)}}function M(){return tinycolor.fromRatio({h:Y,s:la,v:oa,a:Math.round(100*pa)/100})}function W(){X();da.move(M())}function X(){ga.removeClass("sp-validation-error");q();var a=tinycolor({h:Y,s:"1.0",v:"1.0"});Ma.css("background-color",a.toHexString());a=Oa;1>pa&&("hex"===a||"name"===a)&&(a="rgb");var b=M(),c=b.toHexString(),d=b.toRgbString();v||1===b.alpha?sa.css("background-color",d):(sa.css("background-color","transparent"),sa.css("filter",b.toFilter()));
if(J.showAlpha){d=b.toRgb();d.a=0;var d=tinycolor(d).toRgbString(),e="linear-gradient(left, "+d+", "+c+")";w?ia.css("filter",tinycolor(d).toFilter({gradientType:1},c)):(ia.css("background","-webkit-"+e),ia.css("background","-moz-"+e),ia.css("background","-ms-"+e),ia.css("background",e))}J.showInput&&(1>pa&&("hex"===a||"name"===a)&&(a="rgb"),ga.val(b.toString(a)));J.showPalette&&N();F()}function q(){var a=la*ja,b=na-oa*na,a=Math.max(-ha,Math.min(ja-ha,a-ha)),b=Math.max(-ha,Math.min(na-ha,b-ha));fb.css({top:b,
left:a});Qa.css({left:pa*va-ea/2});gb.css({top:Y*ka-A})}function I(a){var b=M();Ya&&qa.val(b.toString(Oa)).change();var c=!tinycolor.equals(b,fa);fa=b;m(b);a&&c&&da.change(b)}function x(){ja=Ma.width();na=Ma.height();ha=fb.height();Va.width();ka=Va.height();A=gb.height();va=Wa.width();ea=Qa.width();u||T.offset(f(T,ya));q()}function G(){P();Ua=!0;qa.attr("disabled",!0);ya.addClass("sp-disabled")}var J=e(l,g),u=J.flat,E=J.showSelectionPalette,aa=J.localStorageKey,R=J.theme,da=J.callbacks,H=t(x,10),
ma=!1,ja=0,na=0,ha=0,ka=0,va=0,ea=0,A=0,Y=0,la=0,oa=0,pa=1,k=J.palette.slice(0),wa=d.isArray(k[0])?k:[k],ba=J.selectionPalette.slice(0),Ta="sp-dragging",La=g.ownerDocument,eb=La.body,qa=d(g),Ua=!1,T=d(K,La).addClass(R),Ma=T.find(".sp-color"),fb=T.find(".sp-dragger"),Va=T.find(".sp-hue"),gb=T.find(".sp-slider"),ia=T.find(".sp-alpha-inner"),Wa=T.find(".sp-alpha"),Qa=T.find(".sp-alpha-handle"),ga=T.find(".sp-input"),bb=T.find(".sp-palette"),xa=T.find(".sp-initial"),Xa=T.find(".sp-cancel"),Na=T.find(".sp-choose"),
Ya=qa.is("input"),Za=Ya&&!u,Aa=Za?d(D).addClass(R):d([]),ya=Za?Aa:qa,sa=Aa.find(".sp-preview-inner"),za=J.color||Ya&&qa.val(),fa=!1,$a=J.preferredFormat,Oa=$a,hb=!J.showButtons||J.clickoutFiresChange;(function(){function b(a){a.data&&a.data.ignore?(ca(d(this).data("color")),W()):(ca(d(this).data("color")),I(!0),W(),P());return!1}w&&T.find("*:not(input)").attr("unselectable","on");n();Za&&qa.hide().after(Aa);u?qa.after(T).hide():d(eb).append(T.hide());if(aa&&a.localStorage){try{var c=a.localStorage[aa].split(",#");
1<c.length&&(delete a.localStorage[aa],d.each(c,function(a,b){m(b)}))}catch(e){}try{ba=a.localStorage[aa].split(";")}catch(f){}}ya.bind("click.spectrum touchstart.spectrum",function(a){Ua||V();a.stopPropagation();d(a.target).is("input")||a.preventDefault()});(qa.is(":disabled")||!0===J.disabled)&&G();T.click(h);ga.change(U);ga.bind("paste",function(){setTimeout(U,1)});ga.keydown(function(a){13==a.keyCode&&U()});Xa.text(J.cancelText);Xa.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();
P("cancel")});Na.text(J.chooseText);Na.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();ga.hasClass("sp-validation-error")||(I(!0),P())});s(Wa,function(a,b,c){pa=a/va;c.shiftKey&&(pa=Math.round(10*pa)/10);W()});s(Va,function(a,b){Y=parseFloat(b/ka);W()},y,S);s(Ma,function(a,b){la=parseFloat(a/ja);oa=parseFloat((na-b)/na);W()},y,S);za?(ca(za),X(),Oa=$a||tinycolor(za).format,m(za)):X();u&&Z();c=w?"mousedown.spectrum":"click.spectrum touchstart.spectrum";bb.delegate(".sp-thumb-el",
c,b);xa.delegate(".sp-thumb-el:nth-child(1)",c,{ignore:!0},b)})();var Ga={show:Z,hide:P,toggle:V,reflow:x,option:function(a,b){if(a===c)return d.extend({},J);if(b===c)return J[a];J[a]=b;n()},enable:function(){Ua=!1;qa.attr("disabled",!1);ya.removeClass("sp-disabled")},disable:G,set:function(a){ca(a);I()},get:M,destroy:function(){qa.show();ya.unbind("click.spectrum touchstart.spectrum");T.remove();Aa.remove();p[Ga.id]=null},container:T};Ga.id=p.push(Ga)-1;return Ga}function f(a,b){var c=a.outerWidth(),
e=a.outerHeight(),f=b.outerHeight(),g=a[0].ownerDocument,h=g.documentElement,l=h.clientWidth+d(g).scrollLeft(),g=h.clientHeight+d(g).scrollTop(),h=b.offset();h.top+=f;h.left-=Math.min(h.left,h.left+c>l&&l>c?Math.abs(h.left+c-l):0);h.top-=Math.min(h.top,h.top+e>g&&g>e?Math.abs(e+f-0):0);return h}function l(){}function h(a){a.stopPropagation()}function n(a,b){var c=Array.prototype.slice,d=c.call(arguments,2);return function(){return a.apply(b,d.concat(c.call(arguments)))}}function s(b,c,e,f){function g(a){a.stopPropagation&&
a.stopPropagation();a.preventDefault&&a.preventDefault();a.returnValue=!1}function h(a){if(p){if(w&&9>document.documentMode&&!a.button)return l();var d=a.originalEvent.touches,e=d?d[0].pageY:a.pageY,d=Math.max(0,Math.min((d?d[0].pageX:a.pageX)-s.left,r)),e=Math.max(0,Math.min(e-s.top,t));D&&g(a);c.apply(b,[d,e,a])}}function l(){p&&(d(n).unbind(v),d(n.body).removeClass("sp-dragging"),f.apply(b,arguments));p=!1}c=c||function(){};e=e||function(){};f=f||function(){};var n=b.ownerDocument||document,p=
!1,s={},t=0,r=0,D="ontouchstart"in a,v={};v.selectstart=g;v.dragstart=g;v[D?"touchmove":"mousemove"]=h;v[D?"touchend":"mouseup"]=l;d(b).bind(D?"touchstart":"mousedown",function(a){(a.which?3==a.which:2==a.button)||p||!1===e.apply(b,arguments)||(p=!0,t=d(b).height(),r=d(b).width(),s=d(b).offset(),d(n).bind(v),d(n.body).addClass("sp-dragging"),D||h(a),g(a))})}function t(a,b,c){var d;return function(){var e=this,f=arguments,g=function(){d=null;a.apply(e,f)};c&&clearTimeout(d);if(c||!d)d=setTimeout(g,
b)}}var r={beforeShow:l,move:l,change:l,show:l,hide:l,color:!1,flat:!1,showInput:!0,showButtons:!1,clickoutFiresChange:!1,showInitial:!1,showPalette:!1,showPaletteOnly:!1,showSelectionPalette:!0,localStorageKey:!1,maxSelectionSize:7,cancelText:"cancel",chooseText:"choose",preferredFormat:!1,className:"",showAlpha:!1,theme:"sp-light",palette:["fff","000"],selectionPalette:[],disabled:!1},p=[],w=!!/msie/i.exec(a.navigator.userAgent),v=function(){var a=document.createElement("div").style;a.cssText="background-color:rgba(0,0,0,.5)";
return!!~(""+a.backgroundColor).indexOf("rgba")||!!~(""+a.backgroundColor).indexOf("hsla")}(),D="<div class='sp-replacer'><div class='sp-preview'><div class='sp-preview-inner'></div></div></div>",K=function(){var a="";if(w)for(var b=1;6>=b;b++)a+="<div class='sp-"+b+"'></div>";return["<div class='sp-container'><div class='sp-palette-container'><div class='sp-palette sp-thumb sp-cf'></div></div><div class='sp-picker-container'><div class='sp-top sp-cf'><div class='sp-fill'></div><div class='sp-top-inner'><div class='sp-color'><div class='sp-sat'><div class='sp-val'><div class='sp-dragger'></div></div></div></div><div class='sp-hue'><div class='sp-slider'></div>",
...
0));1>b.r&&(b.r=r(b.r));1>b.g&&(b.g=r(b.g));1>b.b&&(b.b=r(b.b));return{ok:f,format:a&&a.format||g,r:b.r,g:b.g,b:b.b,a:d}}function d(a,b,c){a=h(a,255);b=h(b,255);c=h(c,255);var e=w(a,b,c),f=D(a,b,c),g,l=(e+f)/2;if(e==f)g=f=0;else{var n=e-f,f=0.5<l?n/(2-e-f):n/(e+f);switch(e){case a:g=(b-c)/n+(b<c?6:0);break;case b:g=(c-a)/n+2;break;case c:g=(a-b)/n+4}g/=6}return{h:g,s:f,l:l}}function e(a,b,c){function d(a,b,c){0>c&&(c+=1);1<c&&(c-=1);return c<1/6?a+6*(b-a)*c:0.5>c?b:c<2/3?a+6*(b-a)*(2/3-c):a}a=h(a,
...
springgreen:"00ff7f",steelblue:"4682b4",tan:"d2b48c",teal:"008080",thistle:"d8bfd8",tomato:"ff6347",turquoise:"40e0d0",violet:"ee82ee",wheat:"f5deb3",white:"fff",whitesmoke:"f5f5f5",yellow:"ff0",yellowgreen:"9acd32"},x=b.hexNames=function(a){var b={},c;for(c in a)a.hasOwnProperty(c)&&(b[a[c]]=c);return b}(I),G={rgb:RegExp("rgb[\\s|\\(]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))\\s*\\)?"),rgba:RegExp("rgba[\\s|\\(]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))\\s*\\)?"),
...
65535>a.length)return Math.min.apply(Math,a);if(!b&&m.isEmpty(a))return 1/0;var d={computed:1/0,value:1/0};return C(a,function(a,e,f){e=b?b.call(c,a,e,f):a;e<d.computed&&(d={value:a,computed:e})}),d.value};m.shuffle=function(a){var b,c=0,d=[];return C(a,function(a){b=m.random(c++);d[c-1]=d[b];d[b]=a}),d};m.sample=function(a,b,c){return 2>arguments.length||c?a[m.random(a.length-1)]:m.shuffle(a).slice(0,Math.max(0,b))};var F=function(a){return m.isFunction(a)?a:function(b){return b[a]}};m.sortBy=function(a,
b,c){var d=F(b);return m.pluck(m.map(a,function(a,b,e){return{value:a,index:b,criteria:d.call(c,a,b,e)}}).sort(function(a,b){var c=a.criteria,d=b.criteria;if(c!==d){if(c>d||void 0===c)return 1;if(d>c||void 0===d)return-1}return a.index-b.index}),"value")};var y=function(a){return function(b,c,d){var e={},f=null==c?m.identity:F(c);return C(b,function(c,g){var h=f.call(d,c,g,b);a(e,h,c)}),e}};m.groupBy=y(function(a,b,c){(m.has(a,b)?a[b]:a[b]=[]).push(c)});m.indexBy=y(function(a,b,c){a[b]=c});m.countBy=
y(function(a,b){m.has(a,b)?a[b]++:a[b]=1});m.sortedIndex=function(a,b,c,d){c=null==c?m.identity:F(c);b=c.call(d,b);for(var e=0,f=a.length;f>e;){var g=e+f>>>1;c.call(d,a[g])<b?e=g+1:f=g}return e};m.toArray=function(a){return a?m.isArray(a)?f.call(a):a.length===+a.length?m.map(a,m.identity):m.values(a):[]};m.size=function(a){return null==a?0:a.length===+a.length?a.length:m.keys(a).length};m.first=m.head=m.take=function(a,b,c){return null==a?void 0:null==b||c?a[0]:f.call(a,0,b)};m.initial=function(a,
b,c){return f.call(a,0,a.length-(null==b||c?1:b))};m.last=function(a,b,c){return null==a?void 0:null==b||c?a[a.length-1]:f.call(a,Math.max(a.length-b,0))};m.rest=m.tail=m.drop=function(a,b,c){return f.call(a,null==b||c?1:b)};m.compact=function(a){return m.filter(a,m.identity)};var S=function(a,b,c){return b&&m.every(a,m.isArray)?l.apply(c,a):(C(a,function(a){m.isArray(a)||m.isArguments(a)?b?g.apply(c,a):S(a,b,c):c.push(a)}),c)};m.flatten=function(a,b){return S(a,b,[])};m.without=function(a){return m.difference(a,
f.call(arguments,1))};m.uniq=m.unique=function(a,b,c,d){m.isFunction(b)&&(d=c,c=b,b=!1);c=c?m.map(a,c,d):a;var e=[],f=[];return C(c,function(c,d){(b?d&&f[f.length-1]===c:m.contains(f,c))||(f.push(c),e.push(a[d]))}),e};m.union=function(){return m.uniq(m.flatten(arguments,!0))};m.intersection=function(a){var b=f.call(arguments,1);return m.filter(m.uniq(a),function(a){return m.every(b,function(b){return 0<=m.indexOf(b,a)})})};m.difference=function(a){var c=l.apply(b,f.call(arguments,1));return m.filter(a,
function(a){return!m.contains(c,a)})};m.zip=function(){for(var a=m.max(m.pluck(arguments,"length").concat(0)),b=Array(a),c=0;a>c;c++)b[c]=m.pluck(arguments,""+c);return b};m.object=function(a,b){if(null==a)return{};for(var c={},d=0,e=a.length;e>d;d++)b?c[a[d]]=b[d]:c[a[d][0]]=a[d][1];return c};m.indexOf=function(a,b,c){if(null==a)return-1;var d=0,e=a.length;if(c){if("number"!=typeof c)return d=m.sortedIndex(a,b),a[d]===b?d:-1;d=0>c?Math.max(0,e+c):c}if(K&&a.indexOf===K)return a.indexOf(b,c);for(;e>
d;d++)if(a[d]===b)return d;return-1};m.lastIndexOf=function(a,b,c){if(null==a)return-1;var d=null!=c;if(O&&a.lastIndexOf===O)return d?a.lastIndexOf(b,c):a.lastIndexOf(b);for(c=d?c:a.length;c--;)if(a[c]===b)return c;return-1};m.range=function(a,b,c){1>=arguments.length&&(b=a||0,a=0);c=arguments[2]||1;for(var d=Math.max(Math.ceil((b-a)/c),0),e=0,f=Array(d);d>e;)f[e++]=a,a+=c;return f};var U=function(){};m.bind=function(a,b){var c,d;if(L&&a.bind===L)return L.apply(a,f.call(arguments,1));if(!m.isFunction(a))throw new TypeError;
return c=f.call(arguments,2),d=function(){if(!(this instanceof d))return a.apply(b,c.concat(f.call(arguments)));U.prototype=a.prototype;var e=new U;U.prototype=null;var g=a.apply(e,c.concat(f.call(arguments)));return Object(g)===g?g:e}};m.partial=function(a){var b=f.call(arguments,1);return function(){return a.apply(this,b.concat(f.call(arguments)))}};m.bindAll=function(a){var b=f.call(arguments,1);if(0===b.length)throw Error("bindAll must be passed function names");return C(b,function(b){a[b]=m.bind(a[b],
a)}),a};m.memoize=function(a,b){var c={};return b||(b=m.identity),function(){var d=b.apply(this,arguments);return m.has(c,d)?c[d]:c[d]=a.apply(this,arguments)}};m.delay=function(a,b){var c=f.call(arguments,2);return setTimeout(function(){return a.apply(null,c)},b)};m.defer=function(a){return m.delay.apply(m,[a,1].concat(f.call(arguments,1)))};m.throttle=function(a,b,c){var d,e,f,g=null,h=0;c||(c={});var l=function(){h=!1===c.leading?0:new Date;g=null;f=a.apply(d,e)};return function(){var n=new Date;
...
m[b]=a[b];m.prototype[b]=function(){var a=[this._wrapped];g.apply(a,arguments);a=c.apply(m,a);return this._chain?m(a).chain():a}})};var ca=0;m.uniqueId=function(a){var b=++ca+"";return a?a+b:b};m.templateSettings={evaluate:/<%([\s\S]+?)%>/g,interpolate:/<%=([\s\S]+?)%>/g,escape:/<%-([\s\S]+?)%>/g};var M=/(.)^/,W={"'":"'","\\":"\\","\r":"r","\n":"n","\t":"t","\u2028":"u2028","\u2029":"u2029"},X=/\\|'|\r|\n|\t|\u2028|\u2029/g;m.template=function(a,b,c){var d;c=m.defaults({},c,m.templateSettings);var e=
...
(function(){function a(a,b){return"!"!==a[0][0]?'<a href="'+g(b.href)+'"'+(b.title?' title="'+g(b.title)+'"':"")+">"+p.lexer(a[1])+"</a>":'<img src="'+g(b.href)+'" alt="'+g(a[1])+'"'+(b.title?' title="'+g(b.title)+'"':"")+">"}function d(){return v=w.pop()}function c(){switch(v.type){case "space":return"";case "hr":return"<hr>\n";case "heading":return"<h"+v.depth+">"+p.lexer(v.text)+"</h"+v.depth+">\n";case "code":return D.highlight&&(v.code=D.highlight(v.text,v.lang),null!=v.code&&v.code!==v.text&&
...
"";"list_item_end"!==d().type;)a+=c();return"<li>"+a+"</li>\n";case "html":return D.sanitize?p.lexer(v.text):v.pre||D.pedantic?v.text:p.lexer(v.text);case "paragraph":return"<p>"+p.lexer(v.text)+"</p>\n";case "text":return"<p>"+b()+"</p>\n"}}function b(){for(var a=v.text,b;(b=w[w.length-1])&&"text"===b.type;)a+="\n"+d().text;return p.lexer(a)}function e(a){w=a.reverse();for(a="";d();)a+=c();v=w=null;return a}function g(a,b){return a.replace(b?/&/g:/&(?!#?\w+;)/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,
"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function f(a){for(var b="",c=a.length,d=0,e;d<c;d++)e=a.charCodeAt(d),0.5<Math.random()&&(e="x"+e.toString(16)),b+="&#"+e+";";return b}function l(){return"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|@)\\b"}function h(a,b){a=a.source;b=b||"";return function m(c,d){if(!c)return RegExp(a,b);a=a.replace(c,d.source||d);return m}}function n(){}function s(a,
b){t(b);return e(r.lexer(a))}function t(a){a||(a=K);D!==a&&(D=a,D.gfm?(r.fences=r.gfm.fences,r.paragraph=r.gfm.paragraph,p.text=p.gfm.text,p.url=p.gfm.url):(r.fences=r.normal.fences,r.paragraph=r.normal.paragraph,p.text=p.normal.text,p.url=p.normal.url),D.pedantic?(p.em=p.pedantic.em,p.strong=p.pedantic.strong):(p.em=p.normal.em,p.strong=p.normal.strong))}var r={newline:/^\n+/,code:/^( {4}[^\n]+\n*)+/,fences:n,hr:/^( *[-*_]){3,} *(?:\n+|$)/,heading:/^ *(#{1,6}) *([^\n]+?) *#* *(?:\n+|$)/,lheading:/^([^\n]+)\n *(=|-){3,} *\n*/,
blockquote:/^( *>[^\n]+(\n[^\n]+)*\n*)+/,list:/^( *)(bull) [^\0]+?(?:hr|\n{2,}(?! )(?!\1bull )\n*|\s*$)/,html:/^ *(?:comment|closed|closing) *(?:\n{2,}|\s*$)/,def:/^ *\[([^\]]+)\]: *([^\s]+)(?: +["(]([^\n]+)[")])? *(?:\n+|$)/,paragraph:/^([^\n]+\n?(?!body))+\n*/,text:/^[^\n]+/,bullet:/(?:[*+-]|\d+\.)/,item:/^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/};r.item=h(r.item,"gm")(/bull/g,r.bullet)();r.list=h(r.list)(/bull/g,r.bullet)("hr",/\n+(?=(?: *[-*_]){3,} *(?:\n+|$))/)();r.html=h(r.html)("comment",
/\x3c!--[^\0]*?--\x3e/)("closed",/<(tag)[^\0]+?<\/\1>/)("closing",/<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g,l())();r.paragraph=function(){var a=r.paragraph.source,b=[];(function m(a){a=r[a]?r[a].source:a;b.push(a.replace(/(^|[^\[])\^/g,"$1"));return m})("hr")("heading")("lheading")("blockquote")("<"+l())("def");return RegExp(a.replace("body",b.join("|")))}();r.normal={fences:r.fences,paragraph:r.paragraph};r.gfm={fences:/^ *(```|~~~) *(\w+)? *\n([^\0]+?)\s*\1 *(?:\n+|$)/,paragraph:/^/};r.gfm.paragraph=
h(r.paragraph)("(?!","(?!"+r.gfm.fences.source.replace(/(^|[^\[])\^/g,"$2")+"|")();r.lexer=function(a){var b=[];b.links={};a=a.replace(/\r\n|\r/g,"\n").replace(/\t/g,"    ");return r.token(a,b,!0)};r.token=function(a,b,c){a=a.replace(/^ +$/gm,"");for(var d,e,f,g,h,l;a;){if(f=r.newline.exec(a))a=a.substring(f[0].length),1<f[0].length&&b.push({type:"space"});if(f=r.code.exec(a))a=a.substring(f[0].length),f=f[0].replace(/^ {4}/gm,""),b.push({type:"code",text:D.pedantic?f:f.replace(/\n+$/,"")});else if(f=
...
b,c),b.push({type:"blockquote_end"});else if(f=r.list.exec(a)){a=a.substring(f[0].length);b.push({type:"list_start",ordered:isFinite(f[2])});f=f[0].match(r.item);d=!1;l=f.length;for(h=0;h<l;h++)g=f[h],e=g.length,g=g.replace(/^ *([*+-]|\d+\.) +/,""),~g.indexOf("\n ")&&(e-=g.length,g=D.pedantic?g.replace(/^ {1,4}/gm,""):g.replace(RegExp("^ {1,"+e+"}","gm"),"")),e=d||/\n\n(?!\s*$)/.test(g),h!==l-1&&(d="\n"===g[g.length-1],e||(e=d)),b.push({type:e?"loose_item_start":"list_item_start"}),r.token(g,b),b.push({type:"list_item_end"});
...
return c};var w,v;n.exec=n;var D,K;s.options=s.setOptions=function(a){K=a;t(a);return s};s.setOptions({gfm:!0,pedantic:!1,sanitize:!1,highlight:null});s.parser=function(a,b){t(b);return e(a)};s.lexer=function(a,b){t(b);return r.lexer(a)};s.parse=s;"undefined"!==typeof module?module.exports=s:this.marked=s}).call(function(){return this||("undefined"!==typeof window?window:global)}());
function NaturalSort(a,d){var c=/(^-?[0-9]+(\.?[0-9]*)[df]?e?[0-9]?$|^0x[0-9a-f]+$|[0-9]+)/gi,b=/(^[ ]*|[ ]*$)/g,e=/(^([\w ]+,?[\w ]+)?[\w ]+,?[\w ]+\d+:\d+(:\d+)?[\w ]?|^\d{1,4}[\/\-]\d{1,4}[\/\-]\d{1,4}|^\w+, \w+ \d+, \d{4})/,g=/^0x[0-9a-f]+$/i,f=/^0/,l=(NaturalSort.insensitive&&(""+a).toLowerCase()||""+a).replace(b,"")||"",h=(NaturalSort.insensitive&&(""+d).toLowerCase()||""+d).replace(b,"")||"",b=l.replace(c,"\x00$1\x00").replace(/\0$/,"").replace(/^\0/,"").split("\x00"),c=h.replace(c,"\x00$1\x00").replace(/\0$/,
"").replace(/^\0/,"").split("\x00"),l=parseInt(l.match(g))||1!=b.length&&l.match(e)&&Date.parse(l);if(e=parseInt(h.match(g))||l&&h.match(e)&&Date.parse(h)||null){if(l<e)return-1;if(l>e)return 1}l=0;for(h=Math.max(b.length,c.length);l<h;l++){e=!(b[l]||"").match(f)&&parseFloat(b[l])||b[l]||0;g=!(c[l]||"").match(f)&&parseFloat(c[l])||c[l]||0;if(isNaN(e)!==isNaN(g))return isNaN(e)?1:-1;typeof e!==typeof g&&(e+="",g+="");if(e<g)return-1;if(e>g)return 1}return 0}
...
(function(){(function(a,c){a.version="0.9.11";a.protocol=1;a.transports=[];a.j=[];a.sockets={};a.connect=function(b,e){var g=a.util.parseUri(b),f,l;c&&c.location&&(g.protocol=g.protocol||c.location.protocol.slice(0,-1),g.host=g.host||(c.document?c.document.domain:c.location.hostname),g.port=g.port||c.location.port);f=a.util.uniqueUri(g);var h={host:g.host,secure:"https"==g.protocol,port:g.port||("https"==g.protocol?443:80),query:g.query||""};a.util.merge(h,e);if(h["force new connection"]||!a.sockets[f])l=
new a.Socket(h);!h["force new connection"]&&l&&(a.sockets[f]=l);l=l||a.sockets[f];return l.of(1<g.path.length?g.path:"")}})("object"===typeof module?module.exports:this.io={},this);(function(a,c){var b=a.util={},e=/^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/,g="source protocol authority userInfo user password host port relative path directory file query anchor".split(" ");
...
b;b.prototype.on=function(a,b){this.$events||(this.$events={});this.$events[a]?c.util.isArray(this.$events[a])?this.$events[a].push(b):this.$events[a]=[this.$events[a],b]:this.$events[a]=b;return this};b.prototype.addListener=b.prototype.on;b.prototype.once=function(a,b){function c(){d.removeListener(a,c);b.apply(this,arguments)}var d=this;c.listener=b;this.on(a,c);return this};b.prototype.removeListener=function(a,b){if(this.$events&&this.$events[a]){var d=this.$events[a];if(c.util.isArray(d)){for(var l=
-1,h=0,n=d.length;h<n;h++)if(d[h]===b||d[h].listener&&d[h].listener===b){l=h;break}if(0>l)return this;d.splice(l,1);d.length||delete this.$events[a]}else(d===b||d.listener&&d.listener===b)&&delete this.$events[a]}return this};b.prototype.removeAllListeners=function(a){if(void 0===a)return this.$events={},this;this.$events&&this.$events[a]&&(this.$events[a]=null);return this};b.prototype.listeners=function(a){this.$events||(this.$events={});this.$events[a]||(this.$events[a]=[]);c.util.isArray(this.$events[a])||
(this.$events[a]=[this.$events[a]]);return this.$events[a]};b.prototype.emit=function(a){if(!this.$events)return!1;var b=this.$events[a];if(!b)return!1;var d=Array.prototype.slice.call(arguments,1);if("function"==typeof b)b.apply(this,d);else if(c.util.isArray(b))for(var b=b.slice(),l=0,h=b.length;l<h;l++)b[l].apply(this,d);else return!1;return!0}})("undefined"!=typeof io?io:module.exports,"undefined"!=typeof io?io:module.parent.exports);(function(a,c){function b(a){return 10>a?"0"+a:a}function e(a){h.lastIndex=
0;return h.test(a)?'"'+a.replace(h,function(a){var b=t[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function g(a,c){var d,f,h,l,t=n,L,m=c[a];m instanceof Date&&(m=isFinite(a.valueOf())?a.getUTCFullYear()+"-"+b(a.getUTCMonth()+1)+"-"+b(a.getUTCDate())+"T"+b(a.getUTCHours())+":"+b(a.getUTCMinutes())+":"+b(a.getUTCSeconds())+"Z":null);"function"===typeof r&&(m=r.call(c,a,m));switch(typeof m){case "string":return e(m);case "number":return isFinite(m)?
String(m):"null";case "boolean":case "null":return String(m);case "object":if(!m)return"null";n+=s;L=[];if("[object Array]"===Object.prototype.toString.apply(m)){l=m.length;for(d=0;d<l;d+=1)L[d]=g(d,m)||"null";h=0===L.length?"[]":n?"[\n"+n+L.join(",\n"+n)+"\n"+t+"]":"["+L.join(",")+"]";n=t;return h}if(r&&"object"===typeof r)for(l=r.length,d=0;d<l;d+=1)"string"===typeof r[d]&&(f=r[d],(h=g(f,m))&&L.push(e(f)+(n?": ":":")+h));else for(f in m)Object.prototype.hasOwnProperty.call(m,f)&&(h=g(f,m))&&L.push(e(f)+
(n?": ":":")+h);h=0===L.length?"{}":n?"{\n"+n+L.join(",\n"+n)+"\n"+t+"}":"{"+L.join(",")+"}";n=t;return h}}if(c&&c.parse)return a.JSON={parse:c.parse,stringify:c.stringify};var f=a.JSON={},l=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,h=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,n,s,t={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},
r;f.stringify=function(a,b,c){var d;s=n="";if("number"===typeof c)for(d=0;d<c;d+=1)s+=" ";else"string"===typeof c&&(s=c);if((r=b)&&"function"!==typeof b&&("object"!==typeof b||"number"!==typeof b.length))throw Error("JSON.stringify");return g("",{"":a})};f.parse=function(a,b){function c(a,d){var e,f,g=a[d];if(g&&"object"===typeof g)for(e in g)Object.prototype.hasOwnProperty.call(g,e)&&(f=c(g,e),void 0!==f?g[e]=f:delete g[e]);return b.call(a,d,g)}var d;a=String(a);l.lastIndex=0;l.test(a)&&(a=a.replace(l,
...
g=b.reasons=["transport not supported","client not handshaken","unauthorized"],f=b.advice=["reconnect"],l=c.JSON,h=c.util.indexOf;b.encodePacket=function(a){var b=h(e,a.type),c=a.id||"",d=a.endpoint||"",n=a.ack,v=null;switch(a.type){case "error":var D=a.reason?h(g,a.reason):"";a=a.advice?h(f,a.advice):"";if(""!==D||""!==a)v=D+(""!==a?"+"+a:"");break;case "message":""!==a.data&&(v=a.data);break;case "event":v={name:a.name};a.args&&a.args.length&&(v.args=a.args);v=l.stringify(v);break;case "json":v=
l.stringify(a.data);break;case "connect":a.qs&&(v=a.qs);break;case "ack":v=a.ackId+(a.args&&a.args.length?"+"+l.stringify(a.args):"")}b=[b,c+("data"==n?"+":""),d];null!==v&&void 0!==v&&b.push(v);return b.join(":")};b.encodePayload=function(a){var b="";if(1==a.length)return a[0];for(var c=0,d=a.length;c<d;c++)b+="\ufffd"+a[c].length+"\ufffd"+a[c];return b};var n=/([^:]+):([0-9]+)?(\+)?:([^:]+)?:?([\s\S]*)?/;b.decodePacket=function(a){var b=a.match(n);if(!b)return{};var c=b[2]||"";a=b[5]||"";var d=
{type:e[b[1]],endpoint:b[4]||""};c&&(d.id=c,d.ack=b[3]?"data":!0);switch(d.type){case "error":b=a.split("+");d.reason=g[b[0]]||"";d.advice=f[b[1]]||"";break;case "message":d.data=a||"";break;case "event":try{var h=l.parse(a);d.name=h.name;d.args=h.args}catch(v){}d.args=d.args||[];break;case "json":try{d.data=l.parse(a)}catch(D){}break;case "connect":d.qs=a||"";break;case "ack":if(b=a.match(/^([0-9]+)(\+)?(.*)/))if(d.ackId=b[1],d.args=[],b[3])try{d.args=b[3]?l.parse(b[3]):[]}catch(K){}}return d};b.decodePayload=
...
":"+e.port,e.resource,c.protocol,c.util.query(this.options.query,"t="+ +new Date)].join("/");if(this.isXDomain()&&!c.util.ua.hasCORS){var s=document.getElementsByTagName("script")[0],t=document.createElement("script");t.src=e+"&jsonp="+c.j.length;s.parentNode.insertBefore(t,s);c.j.push(function(a){b(a);t.parentNode.removeChild(t)})}else{var r=c.util.request();r.open("GET",e,!0);this.isXDomain()&&(r.withCredentials=!0);r.onreadystatechange=function(){if(4==r.readyState)if(r.onreadystatechange=g,200==
r.status)b(r.responseText);else if(403==r.status)d.onError(r.responseText);else d.connecting=!1,!d.reconnecting&&d.onError(r.responseText)};r.send(null)}};e.prototype.getTransport=function(a){a=a||this.transports;for(var b=0,d;d=a[b];b++)if(c.Transport[d]&&c.Transport[d].check(this)&&(!this.isXDomain()||c.Transport[d].xdomainCheck(this)))return new c.Transport[d](this,this.sessionid);return null};e.prototype.connect=function(a){if(this.connecting)return this;var b=this;b.connecting=!0;this.handshake(function(d,
e,g,t){function r(a){b.transport&&b.transport.clearTimeouts();b.transport=b.getTransport(a);if(!b.transport)return b.publish("connect_failed");b.transport.ready(b,function(){b.connecting=!0;b.publish("connecting",b.transport.name);b.transport.open();b.options["connect timeout"]&&(b.connectTimeoutTimer=setTimeout(function(){if(!b.connected&&(b.connecting=!1,b.options["try multiple transports"])){for(var a=b.transports;0<a.length&&a.splice(0,1)[0]!=b.transport.name;);a.length?r(a):b.publish("connect_failed")}},
b.options["connect timeout"]))})}b.sessionid=d;b.closeTimeout=1E3*g;b.heartbeatTimeout=1E3*e;b.transports||(b.transports=b.origTransports=t?c.util.intersect(t.split(","),b.options.transports):b.options.transports);b.setHeartbeatTimeout();r(b.transports);b.once("connect",function(){clearTimeout(b.connectTimeoutTimer);a&&"function"==typeof a&&a()})});return this};e.prototype.setHeartbeatTimeout=function(){clearTimeout(this.heartbeatTimeoutTimer);if(!this.transport||this.transport.heartbeats()){var a=
...
b)});return this};b.prototype.send=function(){var a=this,b=arguments;WebSocket.__addTask(function(){c.Transport.websocket.prototype.send.apply(a,b)});return this};b.prototype.close=function(){WebSocket.__tasks.length=0;c.Transport.websocket.prototype.close.call(this);return this};b.prototype.ready=function(a,d){function f(){var c=a.options,f=c["flash policy port"],s=["http"+(c.secure?"s":"")+":/",c.host+":"+c.port,c.resource,"static/flashsocket","WebSocketMain"+(a.isXDomain()?"Insecure":"")+".swf"];
b.loaded||("undefined"===typeof WEB_SOCKET_SWF_LOCATION&&(WEB_SOCKET_SWF_LOCATION=s.join("/")),843!==f&&WebSocket.loadFlashPolicyFile("xmlsocket://"+c.host+":"+f),WebSocket.__initialize(),b.loaded=!0);d.call(l)}var l=this;if(document.body)return f();c.util.load(f)};b.check=function(){return"undefined"!=typeof WebSocket&&"__initialize"in WebSocket&&a?10<=a.getFlashPlayerVersion().major:!1};b.xdomainCheck=function(){return!0};"undefined"!=typeof window&&(WEB_SOCKET_DISABLE_AUTO_INITIALIZATION=!0);c.transports.push("flashsocket")})("undefined"!=
typeof io?io.Transport:module.exports,"undefined"!=typeof io?io:module.parent.exports);if("undefined"!=typeof window)var a=function(){function d(){if(!q){try{var a=F.getElementsByTagName("body")[0].appendChild(F.createElement("span"));a.parentNode.removeChild(a)}catch(b){return}q=!0;for(var a=U.length,c=0;c<a;c++)U[c]()}}function c(a){q?a():U[U.length]=a}function b(a){if(typeof N.addEventListener!=B)N.addEventListener("load",a,!1);else if(typeof F.addEventListener!=B)F.addEventListener("load",a,!1);
else if(typeof N.attachEvent!=B)w(N,"onload",a);else if("function"==typeof N.onload){var b=N.onload;N.onload=function(){b();a()}}else N.onload=a}function e(){var a=F.getElementsByTagName("body")[0],b=F.createElement(L);b.setAttribute("type",m);var c=a.appendChild(b);if(c){var d=0;(function(){if(typeof c.GetVariable!=B){var e=c.GetVariable("$version");e&&(e=e.split(" ")[1].split(","),u.pv=[parseInt(e[0],10),parseInt(e[1],10),parseInt(e[2],10)])}else if(10>d){d++;setTimeout(arguments.callee,10);return}a.removeChild(b);
c=null;g()})()}else g()}function g(){var a=V.length;if(0<a)for(var b=0;b<a;b++){var c=V[b].id,d=V[b].callbackFn,e={success:!1,id:c};if(0<u.pv[0]){var g=p(c);if(g)if(!v(V[b].swfVersion)||u.wk&&312>u.wk)if(V[b].expressInstall&&l()){e={};e.data=V[b].expressInstall;e.width=g.getAttribute("width")||"0";e.height=g.getAttribute("height")||"0";g.getAttribute("class")&&(e.styleclass=g.getAttribute("class"));g.getAttribute("align")&&(e.align=g.getAttribute("align"));for(var m={},g=g.getElementsByTagName("param"),
s=g.length,t=0;t<s;t++)"movie"!=g[t].getAttribute("name").toLowerCase()&&(m[g[t].getAttribute("name")]=g[t].getAttribute("value"));h(e,m,c,d)}else n(g),d&&d(e);else K(c,!0),d&&(e.success=!0,e.ref=f(c),d(e))}else K(c,!0),d&&((c=f(c))&&typeof c.SetVariable!=B&&(e.success=!0,e.ref=c),d(e))}}function f(a){var b=null;(a=p(a))&&"OBJECT"==a.nodeName&&(typeof a.SetVariable!=B?b=a:(a=a.getElementsByTagName(L)[0])&&(b=a));return b}function l(){return!I&&v("6.0.65")&&(u.win||u.mac)&&!(u.wk&&312>u.wk)}function h(a,
b,c,d){I=!0;W=d||null;X={success:!1,id:c};var e=p(c);if(e){"OBJECT"==e.nodeName?(ca=s(e),M=null):(ca=e,M=c);a.id=C;if(typeof a.width==B||!/%$/.test(a.width)&&310>parseInt(a.width,10))a.width="310";if(typeof a.height==B||!/%$/.test(a.height)&&137>parseInt(a.height,10))a.height="137";F.title=F.title.slice(0,47)+" - Flash Player Installation";d=u.ie&&u.win?["Active"].concat("").join("X"):"PlugIn";d="MMredirectURL="+N.location.toString().replace(/&/g,"%26")+"&MMplayerType="+d+"&MMdoctitle="+F.title;b.flashvars=
typeof b.flashvars!=B?b.flashvars+("&"+d):d;u.ie&&(u.win&&4!=e.readyState)&&(d=F.createElement("div"),c+="SWFObjectNew",d.setAttribute("id",c),e.parentNode.insertBefore(d,e),e.style.display="none",function(){4==e.readyState?e.parentNode.removeChild(e):setTimeout(arguments.callee,10)}());t(a,b,c)}}function n(a){if(u.ie&&u.win&&4!=a.readyState){var b=F.createElement("div");a.parentNode.insertBefore(b,a);b.parentNode.replaceChild(s(a),b);a.style.display="none";(function(){4==a.readyState?a.parentNode.removeChild(a):
setTimeout(arguments.callee,10)})()}else a.parentNode.replaceChild(s(a),a)}function s(a){var b=F.createElement("div");if(u.win&&u.ie)b.innerHTML=a.innerHTML;else if(a=a.getElementsByTagName(L)[0])if(a=a.childNodes)for(var c=a.length,d=0;d<c;d++)1==a[d].nodeType&&"PARAM"==a[d].nodeName||8==a[d].nodeType||b.appendChild(a[d].cloneNode(!0));return b}function t(a,b,c){var d,e=p(c);if(u.wk&&312>u.wk)return d;if(e)if(typeof a.id==B&&(a.id=c),u.ie&&u.win){var f="",g;for(g in a)a[g]!=Object.prototype[g]&&
("data"==g.toLowerCase()?b.movie=a[g]:"styleclass"==g.toLowerCase()?f+=' class="'+a[g]+'"':"classid"!=g.toLowerCase()&&(f+=" "+g+'="'+a[g]+'"'));g="";for(var h in b)b[h]!=Object.prototype[h]&&(g+='<param name="'+h+'" value="'+b[h]+'" />');e.outerHTML='<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"'+f+">"+g+"</object>";Z[Z.length]=a.id;d=p(a.id)}else{h=F.createElement(L);h.setAttribute("type",m);for(var l in a)a[l]!=Object.prototype[l]&&("styleclass"==l.toLowerCase()?h.setAttribute("class",
a[l]):"classid"!=l.toLowerCase()&&h.setAttribute(l,a[l]));for(f in b)b[f]!=Object.prototype[f]&&"movie"!=f.toLowerCase()&&(a=h,g=f,l=b[f],c=F.createElement("param"),c.setAttribute("name",g),c.setAttribute("value",l),a.appendChild(c));e.parentNode.replaceChild(h,e);d=h}return d}function r(a){var b=p(a);b&&"OBJECT"==b.nodeName&&(u.ie&&u.win?(b.style.display="none",function(){if(4==b.readyState){var c=p(a);if(c){for(var d in c)"function"==typeof c[d]&&(c[d]=null);c.parentNode.removeChild(c)}}else setTimeout(arguments.callee,
10)}()):b.parentNode.removeChild(b))}function p(a){var b=null;try{b=F.getElementById(a)}catch(c){}return b}function w(a,b,c){a.attachEvent(b,c);P[P.length]=[a,b,c]}function v(a){var b=u.pv;a=a.split(".");a[0]=parseInt(a[0],10);a[1]=parseInt(a[1],10)||0;a[2]=parseInt(a[2],10)||0;return b[0]>a[0]||b[0]==a[0]&&b[1]>a[1]||b[0]==a[0]&&b[1]==a[1]&&b[2]>=a[2]?!0:!1}function D(a,b,c,d){if(!u.ie||!u.mac){var e=F.getElementsByTagName("head")[0];e&&(c=c&&"string"==typeof c?c:"screen",d&&(G=x=null),x&&G==c||
(d=F.createElement("style"),d.setAttribute("type","text/css"),d.setAttribute("media",c),x=e.appendChild(d),u.ie&&(u.win&&typeof F.styleSheets!=B&&0<F.styleSheets.length)&&(x=F.styleSheets[F.styleSheets.length-1]),G=c),u.ie&&u.win?x&&typeof x.addRule==L&&x.addRule(a,b):x&&typeof F.createTextNode!=B&&x.appendChild(F.createTextNode(a+" {"+b+"}")))}}function K(a,b){if(J){var c=b?"visible":"hidden";q&&p(a)?p(a).style.visibility=c:D("#"+a,"visibility:"+c)}}function O(a){return null!=/[\\\"<>\.;]/.exec(a)&&
typeof encodeURIComponent!=B?encodeURIComponent(a):a}var B="undefined",L="object",m="application/x-shockwave-flash",C="SWFObjectExprInst",N=window,F=document,y=navigator,S=!1,U=[function(){S?e():g()}],V=[],Z=[],P=[],ca,M,W,X,q=!1,I=!1,x,G,J=!0,u=function(){var a=typeof F.getElementById!=B&&typeof F.getElementsByTagName!=B&&typeof F.createElement!=B,b=y.userAgent.toLowerCase(),c=y.platform.toLowerCase(),d=c?/win/.test(c):/win/.test(b),c=c?/mac/.test(c):/mac/.test(b),b=/webkit/.test(b)?parseFloat(b.replace(/^.*webkit\/(\d+(\.\d+)?).*$/,
...
new (window[["Active"].concat("Object").join("X")])("ShockwaveFlash.ShockwaveFlash");h&&(g=h.GetVariable("$version"))&&(e=!0,g=g.split(" ")[1].split(","),f=[parseInt(g[0],10),parseInt(g[1],10),parseInt(g[2],10)])}catch(l){}return{w3:a,pv:f,wk:b,ie:e,win:d,mac:c}}();(function(){u.w3&&((typeof F.readyState!=B&&"complete"==F.readyState||typeof F.readyState==B&&(F.getElementsByTagName("body")[0]||F.body))&&d(),q||(typeof F.addEventListener!=B&&F.addEventListener("DOMContentLoaded",d,!1),u.ie&&u.win&&
(F.attachEvent("onreadystatechange",function(){"complete"==F.readyState&&(F.detachEvent("onreadystatechange",arguments.callee),d())}),N==top&&function(){if(!q){try{F.documentElement.doScroll("left")}catch(a){setTimeout(arguments.callee,0);return}d()}}()),u.wk&&function(){q||(/loaded|complete/.test(F.readyState)?d():setTimeout(arguments.callee,0))}(),b(d)))})();(function(){u.ie&&u.win&&window.attachEvent("onunload",function(){for(var b=P.length,c=0;c<b;c++)P[c][0].detachEvent(P[c][1],P[c][2]);b=Z.length;
for(c=0;c<b;c++)r(Z[c]);for(var d in u)u[d]=null;u=null;for(var e in a)a[e]=null;a=null})})();return{registerObject:function(a,b,c,d){if(u.w3&&a&&b){var e={};e.id=a;e.swfVersion=b;e.expressInstall=c;e.callbackFn=d;V[V.length]=e;K(a,!1)}else d&&d({success:!1,id:a})},getObjectById:function(a){if(u.w3)return f(a)},embedSWF:function(a,b,d,e,f,g,n,m,p,s){var r={success:!1,id:b};u.w3&&!(u.wk&&312>u.wk)&&a&&b&&d&&e&&f?(K(b,!1),c(function(){d+="";e+="";var c={};if(p&&typeof p===L)for(var A in p)c[A]=p[A];
c.data=a;c.width=d;c.height=e;A={};if(m&&typeof m===L)for(var Y in m)A[Y]=m[Y];if(n&&typeof n===L)for(var q in n)A.flashvars=typeof A.flashvars!=B?A.flashvars+("&"+q+"="+n[q]):q+"="+n[q];if(v(f))Y=t(c,A,b),c.id==b&&K(b,!0),r.success=!0,r.ref=Y;else{if(g&&l()){c.data=g;h(c,A,b,s);return}K(b,!0)}s&&s(r)})):s&&s(r)},switchOffAutoHideShow:function(){J=!1},ua:u,getFlashPlayerVersion:function(){return{major:u.pv[0],minor:u.pv[1],release:u.pv[2]}},hasFlashPlayerVersion:v,createSWF:function(a,b,c){if(u.w3)return t(a,
b,c)},showExpressInstall:function(a,b,c,d){u.w3&&l()&&h(a,b,c,d)},removeSWF:function(a){u.w3&&r(a)},createCSS:function(a,b,c,d){u.w3&&D(a,b,c,d)},addDomLoadEvent:c,addLoadEvent:b,getQueryParamValue:function(a){var b=F.location.search||F.location.hash;if(b){/\?/.test(b)&&(b=b.split("?")[1]);if(null==a)return O(b);for(var b=b.split("&"),c=0;c<b.length;c++)if(b[c].substring(0,b[c].indexOf("="))==a)return O(b[c].substring(b[c].indexOf("=")+1))}return""},expressInstallCallback:function(){if(I){var a=p(C);
a&&ca&&(a.parentNode.replaceChild(ca,a),M&&(K(M,!0),u.ie&&u.win&&(ca.style.display="block")),W&&W(X));I=!1}}}}();(function(){if("undefined"!=typeof window&&!window.WebSocket){var d=window.console;d&&d.log&&d.error||(d={log:function(){},error:function(){}});a.hasFlashPlayerVersion("10.0.0")?("file:"==location.protocol&&d.error("WARNING: web-socket-js doesn't work in file:///... URL unless you set Flash Security Settings properly. Open the page via Web server i.e. http://..."),WebSocket=function(a,
b,d,g,f){var l=this;l.__id=WebSocket.__nextId++;WebSocket.__instances[l.__id]=l;l.readyState=WebSocket.CONNECTING;l.bufferedAmount=0;l.__events={};b?"string"==typeof b&&(b=[b]):b=[];setTimeout(function(){WebSocket.__addTask(function(){WebSocket.__flash.create(l.__id,a,b,d||null,g||0,f||null)})},0)},WebSocket.prototype.send=function(a){if(this.readyState==WebSocket.CONNECTING)throw"INVALID_STATE_ERR: Web Socket connection has not been established";a=WebSocket.__flash.send(this.__id,encodeURIComponent(a));
...
"https":"http"};e.check=function(a,d){try{var e=c.util.request(d),g=b.XDomainRequest&&e instanceof XDomainRequest,s=a&&a.options&&a.options.secure?"https:":"http:",t=b.location&&s!=b.location.protocol;if(e&&(!g||!t))return!0}catch(r){}return!1};e.xdomainCheck=function(a){return e.check(a,!0)}})("undefined"!=typeof io?io.Transport:module.exports,"undefined"!=typeof io?io:module.parent.exports,this);(function(a,c){function b(a){c.Transport.XHR.apply(this,arguments)}a.htmlfile=b;c.util.inherit(b,c.Transport.XHR);
...
e.iframeId+'">')}catch(a){w=document.createElement("iframe"),w.name=e.iframeId}w.id=e.iframeId;e.form.appendChild(w);e.iframe=w}var e=this,g=c.util.query(this.socket.options.query,"t="+ +new Date+"&i="+this.index);if(!this.form){var t=document.createElement("form"),r=document.createElement("textarea"),p=this.iframeId="socketio_iframe_"+this.index,w;t.className="socketio";t.style.position="absolute";t.style.top="0px";t.style.left="0px";t.style.display="none";t.target=p;t.method="POST";t.setAttribute("accept-charset",
"utf-8");r.name="d";t.appendChild(r);document.body.appendChild(t);this.form=t;this.area=r}this.form.action=this.prepareUrl()+g;d();this.area.value=c.JSON.stringify(a);try{this.form.submit()}catch(v){}this.iframe.attachEvent?w.onreadystatechange=function(){"complete"==e.iframe.readyState&&b()}:this.iframe.onload=b;this.socket.setBuffer(!0)};e.prototype.get=function(){var a=this,b=document.createElement("script"),d=c.util.query(this.socket.options.query,"t="+ +new Date+"&i="+this.index);this.script&&
...
!function(a){function d(a,b){return function(c){return h(a.call(this,c),b)}}function c(a,b){return function(c){return this.lang().ordinal(a.call(this,c),b)}}function b(){}function e(a){f(this,a)}function g(a){var b=a.years||a.year||a.y||0,c=a.months||a.month||a.M||0,d=a.weeks||a.week||a.w||0,e=a.days||a.day||a.d||0,f=a.hours||a.hour||a.h||0,g=a.minutes||a.minute||a.m||0,h=a.seconds||a.second||a.s||0,l=a.milliseconds||a.millisecond||a.ms||0;this._input=a;this._milliseconds=l+1E3*h+6E4*g+36E5*f;this._days=
e+7*d;this._months=c+12*b;this._data={};this._bubble()}function f(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c]);return a}function l(a){return 0>a?Math.ceil(a):Math.floor(a)}function h(a,b){for(var c=a+"";c.length<b;)c="0"+c;return c}function n(a,b,c,d){var e,f,g=b._milliseconds,h=b._days;b=b._months;g&&a._d.setTime(+a._d+g*c);(h||b)&&(e=a.minute(),f=a.hour());h&&a.date(a.date()+h*c);b&&a.month(a.month()+b*c);g&&!d&&y.updateOffset(a);(h||b)&&(a.minute(e),a.hour(f))}function s(a,b){var c,d=Math.min(a.length,
b.length),e=Math.abs(a.length-b.length),f=0;for(c=0;d>c;c++)~~a[c]!==~~b[c]&&f++;return f+e}function t(a){return a?na[a]||a.toLowerCase().replace(/(.)s$/,"$1"):a}function r(a){if(!a)return y.fn._lang;if(!V[a]&&Z)try{require("./lang/"+a)}catch(b){return y.fn._lang}return V[a]}function p(a){var b,c,d=a.match(M);b=0;for(c=d.length;c>b;b++)d[b]=ea[d[b]]?ea[d[b]]:d[b].match(/\[.*\]/)?d[b].replace(/^\[|\]$/g,""):d[b].replace(/\\/g,"");return function(e){var f="";for(b=0;c>b;b++)f+=d[b]instanceof Function?
d[b].call(e,a):d[b];return f}}function w(a,b){function c(b){return a.lang().longDateFormat(b)||b}for(var d=5;d--&&W.test(b);)b=b.replace(W,c);return ha[b]||(ha[b]=p(b)),ha[b](a)}function v(a,b){switch(a){case "DDDD":return I;case "YYYY":return x;case "YYYYY":return G;case "S":case "SS":case "SSS":case "DDD":return q;case "MMM":case "MMMM":case "dd":case "ddd":case "dddd":return J;case "a":case "A":return r(b._l)._meridiemParse;case "X":return aa;case "Z":case "ZZ":return u;case "T":return E;case "MM":case "DD":case "YY":case "HH":case "hh":case "mm":case "ss":case "M":case "D":case "d":case "H":case "h":case "m":case "s":return X;
default:return RegExp(a.replace("\\",""))}}function D(a){a=((u.exec(a)||[])[0]+"").match(H)||["-",0,0];var b=+(60*a[1])+~~a[2];return"+"===a[0]?-b:b}function K(a){var b,c=[];if(!a._d){for(b=0;7>b;b++)a._a[b]=c[b]=null==a._a[b]?2===b?1:0:a._a[b];c[3]+=~~((a._tzm||0)/60);c[4]+=~~((a._tzm||0)%60);b=new Date(0);a._useUTC?(b.setUTCFullYear(c[0],c[1],c[2]),b.setUTCHours(c[3],c[4],c[5],c[6])):(b.setFullYear(c[0],c[1],c[2]),b.setHours(c[3],c[4],c[5],c[6]));a._d=b}}function O(a){var b,c,d=a._f.match(M),e=
a._i;a._a=[];for(b=0;b<d.length;b++)if((c=(v(d[b],a).exec(e)||[])[0])&&(e=e.slice(e.indexOf(c)+c.length)),ea[d[b]]){var f=a,g=void 0,h=f._a;switch(d[b]){case "M":case "MM":h[1]=null==c?0:~~c-1;break;case "MMM":case "MMMM":g=r(f._l).monthsParse(c);null!=g?h[1]=g:f._isValid=!1;break;case "D":case "DD":case "DDD":case "DDDD":null!=c&&(h[2]=~~c);break;case "YY":h[0]=~~c+(68<~~c?1900:2E3);break;case "YYYY":case "YYYYY":h[0]=~~c;break;case "a":case "A":f._isPm=r(f._l).isPM(c);break;case "H":case "HH":case "h":case "hh":h[3]=
~~c;break;case "m":case "mm":h[4]=~~c;break;case "s":case "ss":h[5]=~~c;break;case "S":case "SS":case "SSS":h[6]=~~(1E3*("0."+c));break;case "X":f._d=new Date(1E3*parseFloat(c));break;case "Z":case "ZZ":f._useUTC=!0,f._tzm=D(c)}null==c&&(f._isValid=!1)}e&&(a._il=e);a._isPm&&12>a._a[3]&&(a._a[3]+=12);!1===a._isPm&&12===a._a[3]&&(a._a[3]=0);K(a)}function B(a,b,c,d,e){return e.relativeTime(b||1,!!c,a,d)}function L(a,b,c){var d;b=c-b;c-=a.day();return c>b&&(c-=7),b-7>c&&(c+=7),d=y(a).add("d",c),{week:Math.ceil(d.dayOfYear()/
7),year:d.year()}}function m(b){var c=b._i,d=b._f;if(null===c||""===c)b=null;else{"string"==typeof c&&(b._i=c=r().preparse(c));if(y.isMoment(c))b=f({},c),b._d=new Date(+c._d);else if(d)if("[object Array]"===Object.prototype.toString.call(d)){var c=b,g,h,k,l=99;for(k=0;k<c._f.length;k++)g=f({},c),g._f=c._f[k],O(g),d=new e(g),g=s(g._a,d.toArray()),d._il&&(g+=d._il.length),l>g&&(l=g,h=d);f(c,h)}else O(b);else if(h=b,c=h._i,d=P.exec(c),c===a)h._d=new Date;else if(d)h._d=new Date(+d[1]);else if("string"==
...
function(){return this._data[a]}}function F(a,b){y.duration.fn["as"+a]=function(){return+this/b}}for(var y,S,U=Math.round,V={},Z="undefined"!=typeof module&&module.exports,P=/^\/?Date\((\-?\d+)/i,ca=/(\-)?(\d*)?\.?(\d+)\:(\d+)\:(\d+)\.?(\d{3})?/,M=/(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|SS?S?|X|zz?|ZZ?|.)/g,W=/(\[[^\[]*\])|(\\)?(LT|LL?L?L?|l{1,4})/g,X=/\d\d?/,q=/\d{1,3}/,I=/\d{3}/,x=/\d{1,4}/,G=/[+\-]?\d{1,6}/,
J=/[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i,u=/Z|[\+\-]\d\d:?\d\d/i,E=/T/i,aa=/[\+\-]?\d+(\.\d{1,3})?/,R=/^\s*\d{4}-\d\d-\d\d((T| )(\d\d(:\d\d(:\d\d(\.\d\d?\d?)?)?)?)?([\+\-]\d\d:?\d\d)?)?/,da=[["HH:mm:ss.S",/(T| )\d\d:\d\d:\d\d\.\d{1,3}/],["HH:mm:ss",/(T| )\d\d:\d\d:\d\d/],["HH:mm",/(T| )\d\d:\d\d/],["HH",/(T| )\d\d/]],H=/([\+\-]|\d\d)/gi,ma=["Date","Hours","Minutes","Seconds","Milliseconds"],ja={Milliseconds:1,Seconds:1E3,
Minutes:6E4,Hours:36E5,Days:864E5,Months:2592E6,Years:31536E6},na={ms:"millisecond",s:"second",m:"minute",h:"hour",d:"day",w:"week",M:"month",y:"year"},ha={},ka="DDD w W M D d".split(" "),va="MDHhmswW".split(""),ea={M:function(){return this.month()+1},MMM:function(a){return this.lang().monthsShort(this,a)},MMMM:function(a){return this.lang().months(this,a)},D:function(){return this.date()},DDD:function(){return this.dayOfYear()},d:function(){return this.day()},dd:function(a){return this.lang().weekdaysMin(this,
a)},ddd:function(a){return this.lang().weekdaysShort(this,a)},dddd:function(a){return this.lang().weekdays(this,a)},w:function(){return this.week()},W:function(){return this.isoWeek()},YY:function(){return h(this.year()%100,2)},YYYY:function(){return h(this.year(),4)},YYYYY:function(){return h(this.year(),5)},gg:function(){return h(this.weekYear()%100,2)},gggg:function(){return this.weekYear()},ggggg:function(){return h(this.weekYear(),5)},GG:function(){return h(this.isoWeekYear()%100,2)},GGGG:function(){return this.isoWeekYear()},
GGGGG:function(){return h(this.isoWeekYear(),5)},e:function(){return this.weekday()},E:function(){return this.isoWeekday()},a:function(){return this.lang().meridiem(this.hours(),this.minutes(),!0)},A:function(){return this.lang().meridiem(this.hours(),this.minutes(),!1)},H:function(){return this.hours()},h:function(){return this.hours()%12||12},m:function(){return this.minutes()},s:function(){return this.seconds()},S:function(){return~~(this.milliseconds()/100)},SS:function(){return h(~~(this.milliseconds()/
10),2)},SSS:function(){return h(this.milliseconds(),3)},Z:function(){var a=-this.zone(),b="+";return 0>a&&(a=-a,b="-"),b+h(~~(a/60),2)+":"+h(~~a%60,2)},ZZ:function(){var a=-this.zone(),b="+";return 0>a&&(a=-a,b="-"),b+h(~~(10*a/6),4)},z:function(){return this.zoneAbbr()},zz:function(){return this.zoneName()},X:function(){return this.unix()}};ka.length;)S=ka.pop(),ea[S+"o"]=c(ea[S],S);for(;va.length;)S=va.pop(),ea[S+S]=d(ea[S],2);ea.DDDD=d(ea.DDD,3);b.prototype={set:function(a){var b,c;for(c in a)b=
...
isValid:function(){return null==this._isValid&&(this._isValid=this._a?!s(this._a,(this._isUTC?y.utc(this._a):y(this._a)).toArray()):!isNaN(this._d.getTime())),!!this._isValid},utc:function(){return this.zone(0)},local:function(){return this.zone(0),this._isUTC=!1,this},format:function(a){a=w(this,a||y.defaultFormat);return this.lang().postformat(a)},add:function(a,b){var c;return c="string"==typeof a?y.duration(+b,a):y.duration(a,b),n(this,c,1),this},subtract:function(a,b){var c;return c="string"==
...
338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298],f=[1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225],g=Array(64),l,w,v,D,K,O,B,L,m,C,N,F;a[d>>5]|=128<<24-d%
32;a[(d+64>>9<<4)+15]=d;for(m=0;m<a.length;m+=16){l=f[0];w=f[1];v=f[2];D=f[3];K=f[4];O=f[5];B=f[6];L=f[7];for(C=0;64>C;C++)g[C]=16>C?a[C+m]:c(c(c(b(g[C-2],17)^b(g[C-2],19)^g[C-2]>>>10,g[C-7]),b(g[C-15],7)^b(g[C-15],18)^g[C-15]>>>3),g[C-16]),N=c(c(c(c(L,b(K,6)^b(K,11)^b(K,25)),K&O^~K&B),e[C]),g[C]),F=c(b(l,2)^b(l,13)^b(l,22),l&w^l&v^w&v),L=B,B=O,O=K,K=c(D,N),D=v,v=w,w=l,l=c(N,F);f[0]=c(l,f[0]);f[1]=c(w,f[1]);f[2]=c(v,f[2]);f[3]=c(D,f[3]);f[4]=c(K,f[4]);f[5]=c(O,f[5]);f[6]=c(B,f[6]);f[7]=c(L,f[7])}return f},
g=function(a){for(var b=[],c=(1<<d)-1,e=0;e<a.length*d;e+=d)b[e>>5]|=(a.charCodeAt(e/d)&c)<<24-e%32;return b},f=function(a){for(var b="",c=0;c<4*a.length;c++)b+="0123456789abcdef".charAt(a[c>>2]>>8*(3-c%4)+4&15)+"0123456789abcdef".charAt(a[c>>2]>>8*(3-c%4)&15);return b},l=function(b){return b="object"==typeof b?a(b).val():b.toString()};a.extend({sha256:function(a){a=l(a);return f(e(g(a),a.length*d))},sha256hmac:function(a,b){a=l(a);b=l(b);var c,t=a;c=b;var r=g(t);16<r.length&&(r=e(r,t.length*d));
for(var p=Array(16),t=Array(16),w=0;16>w;w++)p[w]=r[w]^909522486,t[w]=r[w]^1549556828;c=e(p.concat(g(c)),512+c.length*d);c=e(t.concat(c),768);return f(c)},sha256config:function(a){d=parseInt(a)||8}});a.fn.sha256=function(b){a.sha256config(b);b=l(a(this).val());b=a.sha256(b);a.sha256config(8);return b}})(jQuery);function Space(a){this._pairs=[];this.events={};this._load(a);return this}Space.version="0.5.4";Space.arrayDelete=function(a,d){return a.slice(0,d).concat(a.slice(d+1))};Space.isXPath=function(a){return a.match(/ /)};
...
Space.unionSingle=function(a,d){var c=new Space;if(!(d instanceof Space))return c;a.each(function(a,e){e instanceof Space&&(d._getValueByKey(a)&&d._getValueByKey(a)instanceof Space)&&c._setPair(a,Space.unionSingle(e,d._getValueByKey(a)));e===d._getValueByKey(a)&&c._setPair(a,e)});return c};Space.prototype.append=function(a,d){this._setPair(a,d);this.trigger("append",a,d);this.trigger("change");return this};Space.prototype._clear=function(){this._pairs=[];return this};
Space.prototype.clear=function(a){if(this.isEmpty())return this;this._clear();this.trigger("clear");a&&this._load(a);this.trigger("change");return this};Space.prototype.clone=function(){return new Space(this.toString())};Space.prototype.concat=function(a){"string"===typeof a&&(a=new Space(a));var d=this;a.each(function(a,b){d.append(a,b)});return this};Space.prototype.create=function(a,d){this._setPair(a,d);this.trigger("create",a,d);this.trigger("change");return this};
Space.prototype._delete=function(a){if(!a.toString().match(/ /)){a=this.indexOf(a);if(-1===a)return 0;this._deletePair(a);return 1}var d=a.split(/ /);a=d.pop();d=this.get(d.join(" "));return d instanceof Space?d._delete(a):0};Space.prototype["delete"]=function(a){this._delete(a)&&this.trigger("delete",a);this.trigger("change");return this};Space.prototype._deletePair=function(a){this._pairs.splice(a,1)};
Space.prototype.diff=function(a){var d=new Space;a instanceof Space||(a=new Space(a));this.each(function(b,c){var g=a._getValueByKey(b);if("undefined"===typeof g)return d._setPair(b,""),!0;if(typeof this._getValueByKey(b)!==typeof g)return"object"===typeof g?d._setPair(b,new Space(g)):this._getValueByKey(b)!=g&&d._setPair(b,g),!0;if("object"!==typeof this._getValueByKey(b))return this._getValueByKey(b)!=g&&d._setPair(b,g),!0;g=this._getValueByKey(b).diff(g);g.length()&&d._setPair(b,g)});var c=this;
a.each(function(b,e){if(c.has(b))return!0;if("object"!==typeof e)return d._setPair(b,e),!0;e instanceof Space?d._setPair(b,new Space(e)):d._setPair(b,new Space(a))});return d};
Space.prototype.diffOrder=function(a){a instanceof Space||(a=new Space(a));var d=new Space,c=this;a.each(function(a,e){if(!(e instanceof Space&&c._getValueByKey(a)instanceof Space))return!0;var g=c._getValueByKey(a).diffOrder(e);if(g.isEmpty())return!0;d._setPair(a,g)});if(a.tableOfContents()===this.tableOfContents())return d;a.each(function(a,c){d.has(a)||d._setPair(a,new Space)});return d};
Space.prototype.each=function(a){for(var d in this._pairs)if(!1===a.call(this,this._pairs[d][0],this._pairs[d][1],d))break;return this};Space.prototype.filter=function(a){var d=new Space,c;for(c in this._pairs)!0===a.call(this,this._pairs[c][0],this._pairs[c][1],c)&&d.append(this._pairs[c][0],this._pairs[c][1]);return d};
Space.prototype.find=function(a,d){var c=new Space;this.get(a)===d&&c.push(this);this.each(function(b,e){if(!(e instanceof Space))return!0;e.find(a,d).each(function(a,b){c.push(b)})});return c};Space.prototype.every=function(a){this.each(function(d,c,b){a.call(this,d,c,b);c instanceof Space&&c.every(a)});return this};Space.prototype.get=function(a){return this._getValueByString(a.toString())};
...
Space.prototype._getValueByIndex=function(a){0>a&&(a=this.length()+a);if(this._pairs[a])return this._pairs[a][1]};Space.prototype._getValueByKey=function(a){var d;this._pairs.forEach(function(c,b){if(c[0]===a)return d=c[1],!1});return d};Space.prototype._getKeyByIndex=function(a){0>a&&(a=this.length()+a);return this.getKeys()[a]};Space.prototype.getKeys=function(){var a=[];this._pairs.forEach(function(d,c){a.push(d[0])});return a};
...
Space.prototype._getValueBySpace=function(a){var d=new Space,c=this;a.each(function(b,e){var g=c._getValueByKey(b);if("undefined"===typeof g)return!0;if(!(a._getValueByKey(b)instanceof Space&&a._getValueByKey(b).length()))return d._setPair(b,g),!0;if(!(g instanceof Space))return!0;d._setPair(b,g._getValueBySpace(a._getValueByKey(b)))});return d};
Space.prototype.getTokens=function(a){for(var d=this.toString(),c="K",b="",e=1,g=0,f=0;f<d.length-1;f++){var l=d.substr(f,1);a&&console.log("map: %s; mode: %s; char: %s",b,c,l);0<g?(b+="E",g--):" "!==l&&"\n"!==l?("N"===c&&(c="K"),b+=c):" "===l?"V"===c?b+=c:"K"===c?(b+="S",c="V"):(e++,b+="N"):"K"===c?(c="N",e=1,b+="N"):"V"===c&&(d.substr(f+1,e)===Space.strRepeat(" ",e)?(b+="V",g=e):(c="N",e=1,b+="N"))}return b};
Space.prototype.getTokensConcise=function(){return this.getTokens().replace(/[^\w\s]|(.)(?=\1)/gi,"")};Space.prototype.has=function(a){return void 0!==this._getValueByKey(a)};Space.prototype.indexOf=function(a){return this.getKeys().indexOf(a)};Space.prototype.insert=function(a,d,c){this._setPair(a,d,c);return this};Space.prototype.isEmpty=function(){return 0===this.length()};
...
Space.prototype._load=function(a){if("string"===typeof a)return this._loadFromString(a);if(a instanceof Space){var d=this;a.each(function(a,b){d._setPair(a,b)});return this}for(var c in a)if(Object.prototype.hasOwnProperty.call(a,c)){var b=a[c];"object"===typeof b?this._setPair(c,new Space(b)):this._setPair(c,b)}};
Space.prototype._loadFromString=function(a){a=a.replace(/^[\n ]*/,"");a=a.replace(/\n\r/g,"\n").replace(/\r\n/g,"\n");a=a.replace(/\n\n+/,"\n");a=a.split(/\n(?! )/g);var d,c;for(c in a){var b=a[c];(d=b.match(/^([^ ]+)(\n|$)/))?this._setPair(d[1],new Space(b.substr(d[1].length).replace(/\n /g,"\n"))):(d=b.match(/^([^ ]+) /))&&this._setPair(d[1],b.substr(d[1].length+1).replace(/\n /g,"\n"))}return this};Space.prototype.next=function(a){a=this.indexOf(a)+1;return this._getKeyByIndex(a)};
...
Space.prototype._patch=function(a){a instanceof Space||(a=new Space(a));var d=this;a.each(function(a,b){if("string"===typeof b)return""===b?d._delete(a):d._setPair(a,b),!0;if("number"===typeof b)return d._setPair(a,b),!0;if(b instanceof Space&&!b.length())return d._delete(a),!0;if(d._getValueByKey(a)instanceof Space)return d._getValueByKey(a)._patch(b),!0;d._setPair(a,new Space(b))});return this};Space.prototype.patch=function(a){this._patch(a);this.trigger("patch",a);this.trigger("change");return this};
Space.prototype._patchOrder=function(a){a instanceof Space||(a=new Space(a));var d=this,c=this.clone();d._clear();a.each(function(a,e){d._setPair(a,c.get(a));e instanceof Space&&(e.length()&&c._getValueByKey(a)instanceof Space)&&d._getValueByKey(a)._patchOrder(e)});return this};Space.prototype.patchOrder=function(a){this._patchOrder(a);this.trigger("patchOrder",a);this.trigger("change");return this};
Space.prototype.pop=function(){if(!this.length())return null;var a=new Space,d=this._getKeyByIndex(-1),c=this._getValueByKey(d);a.set(d,c);this._delete(d);return a};Space.prototype.prepend=function(a,d){return this._setPair(a,d,0)};Space.prototype.prev=function(a){a=this.indexOf(a)-1;return this._getKeyByIndex(a)};Space.prototype.push=function(a){for(var d=this.length();this.get(d.toString());)d++;this._setPair(d.toString(),a);return this};
Space.prototype._rename=function(a,d){var c=this.indexOf(a);this._setPair(d,this._getValueByKey(a),c,!0);return this};Space.prototype.reload=function(a){this._pairs=[];this._load(a);this.trigger("reload");return this};Space.prototype.rename=function(a,d){this._rename(a,d);a!==d&&this.trigger("rename",a,d);this.trigger("change");return this};
Space.prototype.set=function(a,d,c){a=a.toString();Space.isXPath(a)?this._setByXPath(a,d):this.has(a)?this._setPair(a,d,this.indexOf(a),!0):this._setPair(a,d,c);this.trigger("set",a,d,c);this.trigger("change");return this};Space.prototype.setByIndexPath=function(a,d){if(!Space.isXPath(a)){var c=parseFloat(a);this.update(c,this._getKeyByIndex(c),d);return this}c=Space.pathBranch(a);c=this.getByIndexPath(c);if(!c)return this;var b=parseFloat(Space.pathLeaf(a));c.update(b,c._getKeyByIndex(b),d);return this};
Space.prototype._setByXPath=function(a,d){if(!a)return null;for(var c=a.toString().split(/ /g),b=this,e,g,f=0;f<c.length;f++){e=c[f];if(!(b._getValueByKey(e)instanceof Space)){var l;l=f===c.length-1?d:new Space;b.has(e)?(g=b.indexOf(e),b._setPair(e,l,g,!0)):b._setPair(e,l)}b=b.get(e)}return this};Space.prototype._setPair=function(a,d,c,b){a=a.toString();void 0===c?this._pairs.push([a,d]):b?this._pairs.splice(c,1,[a,d]):this._pairs.splice(c,0,[a,d])};
Space.prototype.shift=function(){if(!this.length())return null;var a=this._getKeyByIndex(0),d=new Space;d.set(a,this.get(a));this._delete(a);return d};Space.prototype.sort=function(a){this._pairs=this._pairs.sort(a);return this};Space.prototype.tableOfContents=function(){return this.getKeys().join(" ")};
...
Space.prototype.__transpose=function(a){var d="";this.each(function(c,b){var e=new Space(a.toString());e.every(function(a,c,d){b._getValueByKey(c)&&this._setPair(a,b._getValueByKey(c),d,!0)});d+=e.toString()});return new Space(d)};Space.prototype.trigger=function(a){if(!this.events[a])return!0;var d=Array.prototype.slice.call(arguments),c;for(c in this.events[a])this.events[a][c].apply(this,d.slice(1))};Space.prototype.update=function(a,d,c){this._setPair(d,c,a,!0);return this};
...
(function(a){function d(a){a=String(a);return a.charAt(0).toUpperCase()+a.slice(1)}function c(a,b){var c=-1,d=a.length;if(d==d>>>0)for(;++c<d;)b(a[c],c,a);else e(a,b)}function b(a){a=s(a);return/^(?:webOS|i(?:OS|P))/.test(a)?a:d(a)}function e(a,b){for(var c in a)f(a,c)&&b(a[c],c,a)}function g(a){return null==a?d(a):D.call(a).slice(8,-1)}function f(){f=function(a,b){var c=null!=a&&(a.constructor||Object).prototype;return!!c&&b in Object(a)&&!(b in c&&a[b]===c[b])};"Function"==g(m)?f=function(a,b){return null!=
a&&m.call(a,b)}:{}.__proto__==Object.prototype&&(f=function(a,b){var c=!1;null!=a&&(a=Object(a),a.__proto__=[a.__proto__,a.__proto__=null,c=b in a][0]);return c});return f.apply(this,arguments)}function l(a,b){var c=null!=a?typeof a[b]:"number";return!/^(?:boolean|number|string|undefined)$/.test(c)&&("object"==c?!!a[b]:!0)}function h(a){return String(a).replace(/([ -])(?!$)/g,"$1?")}function n(a,b){var d=null;c(a,function(c,e){d=b(d,c,e,a)});return d}function s(a){return String(a).replace(/^ +| +$/g,
"")}function t(c){function d(a){return n(a,function(a,d){var e=d.pattern||h(d);!a&&(a=RegExp("\\b"+e+" *\\d+[.\\w_]*","i").exec(c)||RegExp("\\b"+e+"(?:; *(?:[a-z]+[_-])?[a-z]+\\d+|[^ ();-]*)","i").exec(c))&&((a=String(d.label||a).split("/"))[1]&&!/[\d.]+/.test(a[0])&&(a[0]+=" "+a[1]),d=d.label||d,a=b(a[0].replace(RegExp(e,"i"),d).replace(RegExp("; *(?:"+d+"[_-])?","i")," ").replace(RegExp("("+d+")(\\w)","i"),"$1 $2")));return a})}function f(a){return n(a,function(a,b){return a||(RegExp(b+"(?:-[\\d.]+/|(?: for [\\w-]+)?[ /-])([\\d.]+[^ ();/_-]*)",
"i").exec(c)||0)[1]||null})}c||(c=S);var m,p=c,M=[],W=null,X=c==S,q=X&&N&&"function"==typeof N.version&&N.version(),I=function(a){return n(a,function(a,b){return a||RegExp("\\b"+(b.pattern||h(b))+"\\b","i").exec(c)&&(b.label||b)})}([{label:"WebKit",pattern:"AppleWebKit"},"iCab","Presto","NetFront","Tasman","Trident","KHTML","Gecko"]),x=function(a){return n(a,function(a,b){return a||RegExp("\\b"+(b.pattern||h(b))+"\\b","i").exec(c)&&(b.label||b)})}(["Adobe AIR","Arora","Avant Browser","Camino","Epiphany",
"Fennec","Flock","Galeon","GreenBrowser","iCab","Iceweasel","Iron","K-Meleon","Konqueror","Lunascape","Maxthon","Midori","Nook Browser","PhantomJS","Raven","Rekonq","RockMelt","SeaMonkey",{label:"Silk",pattern:"(?:Cloud9|Silk-Accelerated)"},"Sleipnir","SlimBrowser","Sunrise","Swiftfox","WebPositive","Opera Mini","Opera","Chrome",{label:"Chrome Mobile",pattern:"(?:CriOS|CrMo)"},{label:"Firefox",pattern:"(?:Firefox|Minefield)"},{label:"IE",pattern:"MSIE"},"Safari"]),G=d(["BlackBerry",{label:"Galaxy S",
pattern:"GT-I9000"},{label:"Galaxy S2",pattern:"GT-I9100"},"Google TV","iPad","iPod","iPhone","Kindle",{label:"Kindle Fire",pattern:"(?:Cloud9|Silk-Accelerated)"},"Nook","PlayBook","PlayStation Vita","TouchPad","Transformer","Xoom"]),J=function(a){return n(a,function(a,b,d){return a||(b[G]||b[0,/^[a-z]+(?: +[a-z]+\b)*/i.exec(G)]||RegExp("\\b"+(d.pattern||h(d))+"(?:\\b|\\w*\\d)","i").exec(c))&&(d.label||d)})}({Apple:{iPad:1,iPhone:1,iPod:1},Amazon:{Kindle:1,"Kindle Fire":1},Asus:{Transformer:1},"Barnes & Noble":{Nook:1},
BlackBerry:{PlayBook:1},Google:{"Google TV":1},HP:{TouchPad:1},LG:{},Motorola:{Xoom:1},Nokia:{},Samsung:{"Galaxy S":1,"Galaxy S2":1},Sony:{"PlayStation Vita":1}}),u=function(a){return n(a,function(a,d){var e=d.pattern||h(d);!a&&(a=RegExp("\\b"+e+"(?:/[\\d.]+|[ \\w.]*)","i").exec(c))&&(m={"6.2":"8","6.1":"Server 2008 R2 / 7","6.0":"Server 2008 / Vista","5.2":"Server 2003 / XP 64-bit","5.1":"XP","5.01":"2000 SP1","5.0":"2000","4.0":"NT","4.90":"ME"},/^Win/i.test(a)&&(m=m[0,/[\d.]+$/.exec(a)])&&(a="Windows "+
...
I&&(I=[I]);J&&!G&&(G=d([J]));if(m=/Google TV/.exec(G))G=m[0];/\bSimulator\b/i.test(c)&&(G=(G?G+" ":"")+"Simulator");if(/^iP/.test(G))x||(x="Safari"),u="iOS"+((m=/ OS ([\d_]+)/i.exec(c))?" "+m[1].replace(/_/g,"."):"");else if("Konqueror"==x&&!/buntu/i.test(u))u="Kubuntu";else if(J&&"Google"!=J&&/Chrome|Vita/.test(x+";"+G))x="Android Browser",u=/Android/.test(u)?u:"Android";else if(!x||(m=!/\bMinefield\b/i.test(c)&&/Firefox|Safari/.exec(x)))x&&(!G&&/[\/,]|^[^(]+?\)/.test(c.slice(c.indexOf(m+"/")+8)))&&
(x=null),(m=G||J||u)&&(G||J||/Android|Symbian OS|Tablet OS|webOS/.test(u))&&(x=/[a-z]+(?: Hat)?/i.exec(/Android/.test(u)?u:m)+" Browser");q||(q=f(["(?:Cloud9|CriOS|CrMo|Opera ?Mini|Raven|Silk(?!/[\\d.]+$))","Version",h(x),"(?:Firefox|Minefield|NetFront)"]));if("iCab"==I&&3<parseFloat(q))I=["WebKit"];else if(m=/Opera/.test(x)&&"Presto"||/\b(?:Midori|Nook|Safari)\b/i.test(c)&&"WebKit"||!I&&/\bMSIE\b/i.test(c)&&(/^Mac/.test(u)?"Tasman":"Trident"))I=[m];if(X){if(l(a,"global"))if(K&&(m=K.lang.System,p=
m.getProperty("os.arch"),u=u||m.getProperty("os.name")+" "+m.getProperty("os.version")),"object"==typeof exports&&exports)if(y==r&&"object"==typeof system&&(m=[system])[0]){u||(u=m[0].os||null);try{m[1]=require("ringo/engine").version,q=m[1].join("."),x="RingoJS"}catch(E){m[0].global==w&&(x="Narwhal")}}else"object"==typeof process&&(m=process)&&(x="Node.js",p=m.arch,u=m.platform,q=/[\d.]+/.exec(m.version)[0]);else"Environment"==g(a.environment)&&(x="Rhino");else"ScriptBridgingProxyObject"==g(m=a.runtime)?
(x="Adobe AIR",u=m.flash.system.Capabilities.os):"RuntimeObject"==g(m=a.phantom)?(x="PhantomJS",q=(m=m.version||null)&&m.major+"."+m.minor+"."+m.patch):"number"==typeof L.documentMode&&(m=/\bTrident\/(\d+)/i.exec(c))&&(q=[q,L.documentMode],(m=+m[1]+4)!=q[1]&&(M.push("IE "+q[1]+" mode"),I[1]="",q[1]=m),q="IE"==x?String(q[1].toFixed(1)):q[0]);u=u&&b(u)}q&&(m=/(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(q)||/(?:alpha|beta)(?: ?\d)?/i.exec(c+";"+(X&&C.appMinorVersion))||/\bMinefield\b/i.test(c)&&"a")&&
(W=/b/i.test(m)?"beta":"alpha",q=q.replace(RegExp(m+"\\+?$"),"")+("beta"==W?B:O)+(/\d+\+?/.exec(m)||""));"Fennec"==x?x="Firefox Mobile":"Maxthon"==x&&q?q=q.replace(/\.[\d.]+/,".x"):"Silk"==x?(/Mobi/i.test(c)||(u="Android",M.unshift("desktop mode")),/Accelerated *= *true/i.test(c)&&M.unshift("accelerated")):"IE"==x&&(m=(/; *(?:XBLWP|ZuneWP)(\d+)/i.exec(c)||0)[1])?(x+=" Mobile",u="Windows Phone OS "+m+".x",M.unshift("desktop mode")):"IE"!=x&&(!x||G||/Browser|Mobi/.test(x))||"Windows CE"!=u&&!/Mobi/i.test(c)?
"IE"==x&&X&&"object"==typeof external&&!external?M.unshift("platform preview"):/BlackBerry/.test(G)&&(m=(RegExp(G.replace(/ +/g," *")+"/([.\\d]+)","i").exec(c)||0)[1]||q)?(u="Device Software "+m,q=null):this!=e&&((X&&N||/Opera/.test(x)&&/\b(?:MSIE|Firefox)\b/i.test(c)||"Firefox"==x&&/OS X (?:\d+\.){2,}/.test(u)||"IE"==x&&(u&&!/^Win/.test(u)&&5.5<q||/Windows XP/.test(u)&&8<q||8==q&&!/Trident/.test(c)))&&!v.test(m=t.call(e,c.replace(v,"")+";"))&&m.name)&&(m="ing as "+m.name+((m=m.version)?" "+m:""),
v.test(x)?(/IE/.test(m)&&"Mac OS"==u&&(u=null),m="identify"+m):(m="mask"+m,x=F?b(F.replace(/([a-z])([A-Z])/g,"$1 $2")):"Opera",/IE/.test(m)&&(u=null),X||(q=null)),I=["Presto"],M.push(m)):x+=" Mobile";if(m=(/\bAppleWebKit\/([\d.]+\+?)/i.exec(c)||0)[1]){m=[parseFloat(m.replace(/\.(\d)$/,".0$1")),m];if("Safari"==x&&"+"==m[1].slice(-1))x="WebKit Nightly",W="alpha",q=m[1].slice(0,-1);else if(q==m[1]||q==(/\bSafari\/([\d.]+\+?)/i.exec(c)||0)[1])q=null;m=[m[0],(/\bChrome\/([\d.]+)/i.exec(c)||0)[1]];!X||
/internal|\n/i.test(D.toString())&&!m[1]?(I[1]="like Safari",m=(m=m[0],400>m?1:500>m?2:526>m?3:533>m?4:534>m?"4+":535>m?5:"5")):(I[1]="like Chrome",m=m[1]||(m=m[0],530>m?1:532>m?2:532.05>m?3:533>m?4:534.03>m?5:534.07>m?6:534.1>m?7:534.13>m?8:534.16>m?9:534.24>m?10:534.3>m?11:535.01>m?12:535.02>m?"13+":535.07>m?15:535.11>m?16:535.19>m?17:536.05>m?18:536.1>m?19:537.01>m?20:"21"));I[1]+=" "+(m+="number"==typeof m?".x":/[.+]/.test(m)?"":"+");"Safari"==x&&(!q||45<parseInt(q))&&(q=m)}"Opera"==x&&(m=/(?:zbov|zvav)$/.exec(u))?
(x+=" ",M.unshift("desktop mode"),"zvav"==m?(x+="Mini",q=null):x+="Mobile"):"Safari"==x&&/Chrome/.exec(I[1])&&(M.unshift("desktop mode"),x="Chrome Mobile",q=null,/Mac OS X/.test(u)?(J="Apple",u="iOS 4.3+"):u=null);q&&(0==q.indexOf(m=/[\d.]+$/.exec(u))&&-1<c.indexOf("/"+m+"-"))&&(u=s(u.replace(m,"")));I&&!/Avant|Nook/.test(x)&&(/Browser|Lunascape|Maxthon/.test(x)||/^(?:Adobe|Arora|Midori|Phantom|Rekonq|Rock|Sleipnir|Web)/.test(x)&&I[1])&&(m=I[I.length-1])&&M.push(m);M.length&&(M=["("+M.join("; ")+
")"]);J&&(G&&0>G.indexOf(J))&&M.push("on "+J);G&&M.push((/^on /.test(M[M.length-1])?"":"on ")+G);u&&(m=/ ([\d.+]+)$/.exec(u),u={architecture:32,family:m?u.replace(m[0],""):u,version:m?m[1]:null,toString:function(){var a=this.version;return this.family+(a?" "+a:"")+(64==this.architecture?" 64-bit":"")}});(m=/\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(p))&&!/\bi686\b/i.test(p)&&(u&&(u.architecture=64,u.family=u.family.replace(RegExp(" *"+m),"")),x&&(/WOW64/i.test(c)||X&&/\w(?:86|32)$/.test(C.cpuClass||
C.platform))&&M.unshift("32-bit"));c||(c=null);return{version:x&&q&&(M.unshift(q),q),name:x&&(M.unshift(x),x),os:u?(x&&!(u==String(u).split(" ")[0]&&(u==x.split(" ")[0]||G))&&M.push(G?"("+u+")":"on "+u),u):{architecture:null,family:null,version:null,toString:function(){return"null"}},description:M.length?M.join(" "):c,layout:I&&I[0],manufacturer:J,prerelease:W,product:G,ua:c,parse:t,toString:function(){return this.description||""}}}var r=a,p="object"==typeof exports&&exports,w="object"==typeof global&&
global&&(global==global.global?a=global:global),v=/Opera/,D={}.toString,K=/Java/.test(g(a.java))&&a.java,O=K?"a":"\u03b1",B=K?"b":"\u03b2",L=a.document||{},m={}.hasOwnProperty,C=a.navigator||{},N=a.operamini||a.opera,F=v.test(F=g(N))?F:N=null,y=this,S=C.userAgent||"";"function"==typeof define&&"object"==typeof define.amd&&define.amd?define(function(){return t()}):p?e(t(),function(a,b){p[b]=a}):a.platform=t()})(this);
...
$.htmlToScraps=function(a){var d=(new DOMParser).parseFromString(a,"text/html"),c=new Space;if(!a)return c;$("html",d).children().each(function(){if(!$(this).get(0).tagName)return!0;var a=$(this).get(0).tagName.toLowerCase(),b=$(this).toSpace();c.append(a,b)});var d=a.match(/\<head/),b=a.match(/\<body/);return d&&!b?c.delete("body"):d&&a.match(/\<body/)?c:d||b?!d&&b?c.delete("head"):c:(c.delete("head"),c.get("body"))};
var cssToObject=function(a,d){function c(a){var b=a.match(/\n/g);b&&(C+=b.length);b=a.lastIndexOf("\n");N=~b?a.length-b:N+a.length}function b(){var a={line:C,column:N};return d.position?function(b){b.position={start:a,end:{line:C,column:N}};h(/^\s*/);return b}:e}function e(a){h(/^\s*/);return a}function g(b){b=Error(b+" near line "+C+":"+N);b.line=C;b.column=N;b.source=a;throw b;}function f(){return h(/^{\s*/)}function l(){var b,c=[];h(/^\s*/);for(n(c);"}"!=a[0]&&(b=v()||(K()||D()||L("import")||L("charset")||
L("namespace")||B()||O())||m());)c.push(b),n(c);return c}function h(b){if(b=b.exec(a)){var d=b[0];c(d);a=a.slice(d.length);return b}}function n(a){var b;for(a=a||[];b=s();)a.push(b);return a}function s(){var d=b();if("/"==a[0]&&"*"==a[1]){for(var e=2;null!=a[e]&&("*"!=a[e]||"/"!=a[e+1]);)++e;var e=e+2,f=a.slice(2,e-2);N+=2;c(f);a=a.slice(e);N+=2;return d({type:"comment",comment:f})}}function t(){var a=h(/^([^{]+)/);if(a)return a[0].trim().split(/\s*,\s*/)}function r(){var a=b(),c=h(/^(\*?[-\w]+)\s*/);
if(c){c=c[0];if(!h(/^:\s*/))return g("property missing ':'");var d=h(/^((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^\)]*?\)|[^};])+)/);if(!d)return g("property missing value");a=a({type:"declaration",property:c,value:d[0].trim()});h(/^[;\s]*/);return a}}function p(){var a=[];if(!f())return g("missing '{'");n(a);for(var b;b=r();)a.push(b),n(a);return h(/^}/)?a:g("missing '}'")}function w(){for(var a,c=[],d=b();a=h(/^(from|to|\d+%|\.\d+%|\d+\.\d+%)\s*/);)c.push(a[1]),h(/^,\s*/);if(c.length)return d({type:"keyframe",
values:c,declarations:p()})}function v(){var a=b(),c=h(/^@([-\w]+)?keyframes */);if(c){var d=c[1],c=h(/^([-\w]+)\s*/);if(!c)return g("@keyframes missing name");c=c[1];if(!f())return g("@keyframes missing '{'");for(var e,l=n();e=w();)l.push(e),l=l.concat(n());return h(/^}/)?a({type:"keyframes",name:c,vendor:d,keyframes:l}):g("@keyframes missing '}'")}}function D(){var a=b(),c=h(/^@supports *([^{]+)/);if(c){c=c[1].trim();if(!f())return g("@supports missing '{'");var d=n().concat(l());return h(/^}/)?
a({type:"supports",supports:c,rules:d}):g("@supports missing '}'")}}function K(){var a=b(),c=h(/^@media *([^{]+)/);if(c){c=c[1].trim();if(!f())return g("@media missing '{'");var d=n().concat(l());return h(/^}/)?a({type:"media",media:c,rules:d}):g("@media missing '}'")}}function O(){var a=b();if(h(/^@page */)){var c=t()||[];if(!f())return g("@page missing '{'");for(var d=n(),e;e=r();)d.push(e),d=d.concat(n());return h(/^}/)?a({type:"page",selectors:c,declarations:d}):g("@page missing '}'")}}function B(){var a=
b(),c=h(/^@([-\w]+)?document *([^{]+)/);if(c){var d=(c[1]||"").trim(),c=c[2].trim();if(!f())return g("@document missing '{'");var e=n().concat(l());return h(/^}/)?a({type:"document",document:c,vendor:d,rules:e}):g("@document missing '}'")}}function L(a){var c=b(),d=h(RegExp("^@"+a+" *([^;\\n]+);"));if(d){var e={type:a};e[a]=d[1].trim();return c(e)}}function m(){var a=b(),c=t();if(c)return n(),a({type:"rule",selectors:c,declarations:p()})}d=d||{};var C=1,N=1;return{type:"stylesheet",stylesheet:{rules:l()}}},
cssToSpace=function(a){var d=new Space;(new Space(cssToObject(a))).get("stylesheet rules").each(function(a,b){if("rule"!==b.get("type"))return!0;var e="";b.get("selectors").each(function(a,b){e+=b});b.get("declarations").each(function(a,b){var c=b.get("property"),h=b.get("value");d.set(e+" "+c,h)})});return d};
(function(){function a(a,c,d,f){var l,h,n,s,t,r,p,w;c=c||{};void 0===c.wrap_line_length&&void 0!==c.max_char&&(c.wrap_line_length=c.max_char);h=parseInt(c.indent_size||4,10);n=c.indent_char||" ";t=c.brace_style||"collapse";s=0===c.wrap_line_length?32786:parseInt(c.wrap_line_length||250,10);r=c.unformatted||"a span bdo em strong dfn code samp kbd var cite abbr acronym q sub sup tt i b big small u s strike font ins del pre address dt h1 h2 h3 h4 h5 h6".split(" ");w=(p=c.preserve_newlines||!0,parseInt(c.max_preserve_newlines||
32786,10));l=new function(){this.pos=0;this.token="";this.current_mode="CONTENT";this.tags={parent:"parent1",parentcount:1,parent1:""};this.token_text=this.last_token=this.last_text=this.token_type=this.tag_type="";this.newlines=0;this.indent_content=!1;this.Utils={whitespace:["\n","\r","\t"," "],single_token:"br input link meta !doctype basefont base area hr wbr param img isindex ?xml embed ?php ? ?=".split(" "),extra_liners:["head","body","/html"],in_array:function(a,b){for(var c=0;c<b.length;c++)if(a===
...
function(){this.indent_level++};this.unindent=function(){0<this.indent_level&&this.indent_level--}};return this};for(l.printer(a,n,h,s,t);;){a=l.get_token();l.token_text=a[0];l.token_type=a[1];if("TK_EOF"===l.token_type)break;switch(l.token_type){case "TK_TAG_START":l.print_newline(!1,l.output);l.print_token(l.token_text);l.indent_content&&(l.indent(),l.indent_content=!1);l.current_mode="CONTENT";break;case "TK_TAG_STYLE":case "TK_TAG_SCRIPT":l.print_newline(!1,l.output);l.print_token(l.token_text);
l.current_mode="CONTENT";break;case "TK_TAG_END":"TK_CONTENT"===l.last_token&&""===l.last_text&&(a=l.token_text.match(/\w+/)[0],h=l.output[l.output.length-1].match(/<\s*(\w+)/),null!==h&&h[1]===a||l.print_newline(!1,l.output));l.print_token(l.token_text);l.current_mode="CONTENT";break;case "TK_TAG_SINGLE":(a=l.token_text.match(/^\s*<([a-z]+)/i))&&l.Utils.in_array(a[1],r)||l.print_newline(!1,l.output);l.print_token(l.token_text);l.current_mode="CONTENT";break;case "TK_CONTENT":l.print_token(l.token_text);
l.current_mode="TAG";break;case "TK_STYLE":case "TK_SCRIPT":if(""!==l.token_text){l.print_newline(!1,l.output);a=l.token_text;var v;n=1;"TK_SCRIPT"===l.token_type?v="function"===typeof d&&d:"TK_STYLE"===l.token_type&&(v="function"===typeof f&&f);"keep"===c.indent_scripts?n=0:"separate"===c.indent_scripts&&(n=-l.indent_level);h=l.get_full_indent(n);v?a=v(a.replace(/^\s*/,h),c):(s=a.match(/^\s*/)[0].match(/[^\n\r]*$/)[0].split(l.indent_string).length-1,n=l.get_full_indent(n-s),a=a.replace(/^\s*/,h).replace(/\r\n|\r|\n/g,
"\n"+n).replace(/\s+$/,""));a&&(l.print_token_raw(h+a.replace(/^\s+|\s+$/g,"")),l.print_newline(!1,l.output))}l.current_mode="TAG"}l.last_token=l.token_type;l.last_text=l.token_text}return l.output.join("")}if("function"===typeof define)define(["./beautify.js","./beautify-css.js"],function(b,c){return{html_beautify:function(d,f){return a(d,f,b,c)}}});else if("undefined"!==typeof exports){var d=require("./beautify.js").js_beautify,c=require("./beautify-css.js").css_beautify;exports.html_beautify=function(b,
...
var expressfs={prefix:"/",rootPath:"",appendFile:function(a,d,c){var b={};b.path=expressfs.rootPath+a;b.content=d;$.post(expressfs.prefix+"expressfs.appendFile",b,function(a){c&&c()})},cp:function(a,d,c){var b={};b.source=expressfs.rootPath+a;b.destination=expressfs.rootPath+d;$.post(expressfs.prefix+"expressfs.cp",b,c)},create:function(a,d,c){var b={};b.path=expressfs.rootPath+a;b.content=d||"";$.post(expressfs.prefix+"expressfs.create",b,c)},createUntitled:function(a,d,c,b){var e={};e.path=expressfs.rootPath+
a;e.extension=d;c&&(e.content=c);$.post(expressfs.prefix+"expressfs.createUntitled",e,b)},createUntitledDir:function(a,d){var c={};c.path=expressfs.rootPath+a;$.post(expressfs.prefix+"expressfs.createUntitledDir",c,d)},dirStats:function(a,d){var c={};c.path=expressfs.rootPath+a;c.path.match(/\/$/)||(c.path+="/");$.post(expressfs.prefix+"expressfs.dirStats",c).done(d).fail(d)},downloadDirectory:function(a,d,c){var b={};b.path=expressfs.rootPath+a;b.extension=d;b.path.match(/\/$/)||(b.path+="/");$.post(expressfs.prefix+
"expressfs.downloadDirectory",b).done(c).fail(c)},exists:function(a,d){var c={};c.path=expressfs.rootPath+a;$.post(expressfs.prefix+"expressfs.exists",c,function(a){a.match(/ does NOT exist/)?d(!1):d(!0)})},mkdir:function(a,d){var c={};c.path=expressfs.rootPath+a;$.post(expressfs.prefix+"expressfs.mkdir",c,function(a){d&&d()})},readdir:function(a,d){var c={};c.path=expressfs.rootPath+a;$.post(expressfs.prefix+"expressfs.readdir",c).done(function(a){d&&d(null,JSON.parse(a))}).fail(d)},readFile:function(a,
d){var c={};c.path=expressfs.rootPath+a;$.post(expressfs.prefix+"expressfs.readFile",c).done(d).fail(d)},rename:function(a,d,c){var b={};b.oldPath=expressfs.rootPath+a;b.newPath=expressfs.rootPath+d;if(!d)return console.log("No name provided");$.post(expressfs.prefix+"expressfs.rename",b,function(a){c&&c()})},rmdir:function(a,d){var c={};c.path=expressfs.rootPath+a;$.post(expressfs.prefix+"expressfs.rmdir",c,function(a){d&&d()})},unlink:function(a,d){var c={};c.path=expressfs.rootPath+a;$.post(expressfs.prefix+
"expressfs.unlink",c,function(a){d&&d()})},writeFile:function(a,d,c){var b={};b.path=expressfs.rootPath+a;b.content=d;$.post(expressfs.prefix+"expressfs.writeFile",b,function(a){c&&c()})},writeFileAndOpen:function(a,d,c,b){if(platform&&"Firefox"===platform.name)return expressfs.writeFile(a,d,function(){window.open(a,c);b&&b()}),!0;var e=$('<form target="'+c+'" method="post" action="'+expressfs.prefix+'expressfs.writeFile"></form>'),g=$('<input name="path">');g.val(expressfs.rootPath+a);var f=$('<textarea name="content"></textarea>');
f.val(d);d=$('<input name="redirect">');d.val(a+"?"+(new Date).getTime());e.append(g);e.append(f);e.append(d);e.submit()},writeFileBase64:function(a,d,c){var b={};b.path=expressfs.rootPath+a;b.content=d;b.encoding="base64";$.post(expressfs.prefix+"expressfs.writeFile",b,c)}},socketfs={rootPath:""};socketfs.files=new Space;socketfs.Watcher=function(a,d){this.filename=a;this.fn=d;return this};socketfs.Watcher.prototype.unwatch=function(a){socketfs.unwatch(this.filename,this.fn,a)};
socketfs.Tail=function(a,d){this.filename=a;this.fn=d;return this};socketfs.Tail.prototype.untail=function(a){socketfs.untail(this.filename,this.fn,a)};socketfs.connect=function(){socketfs.main(io.connect("/"))};socketfs.inspect=function(a){socketfs.socket.emit("inspect","get",a)};
...
socketfs.tail=function(a,d,c){filename=socketfs.rootPath+a;socketfs.files.get(filename+" tails")||socketfs.files.set(filename+" tails",new Space);socketfs.files.get(filename+" tails").push(d);c||(c=function(){});socketfs.socket.emit("tail",filename,c);return new socketfs.Tail(a,d)};
...
socketfs.watch=function(a,d,c){filename=socketfs.rootPath+a;socketfs.files.get(filename+" watches")||socketfs.files.set(filename+" watches",new Space);socketfs.files.get(filename+" watches").push(d);c||(c=function(){});socketfs.socket.emit("watch",filename,c);return new socketfs.Watcher(a,d)};function Tool(a){this.clear();this.events={};this.set("name",a);this._open=!1;Tool.tools.push(a);return this}Tool.tools=[];Tool.opened={};Tool.openedAt=null;Tool.openTool=null;Tool.prototype=new Space;
...
socketfs.rootPath="/nudgepad/projects/"+location.hostname+"/";expressfs.trash=function(a,d){expressfs.rename(a,"nudgepad/trash/"+a,d)};var nudgepad={isTesting:!1};window.name="nudgepad";var Query=ParseQueryString(),Cookie=parseCookie(document.cookie);nudgepad.projectPath="/nudgepad/projects/"+location.hostname+"/";nudgepad.status=new Space;
...
TextPrompt.close()},close:function(){$(".TextPrompt").remove();if(!TextPrompt.onclose)return null;TextPrompt.onclose();TextPrompt.onclose=null},open:function(a,d,c,b){$("body").append($("#TextPrompt").html());TextPrompt.callback=b;a=$("#TextPromptDimmer");a.on("tap mousedown click slide slidestart slideend mouseup",function(a){a.stopPropagation()});a.on("click",TextPrompt.close);a=Math.round(0.8*$(window).height());TextPrompt.useAce()?($("#TextPromptTextarea").parent().hide(),$("#AcePromptHolder").height(a),
a="text",c.match(/\.([^\.]+)$/)&&(a=c.match(/\.([^\.]+)$/)[1],"js"===a&&(a="javascript")),TextPrompt.editor=ace.edit("AcePrompt"),TextPrompt.editor.setTheme("ace/theme/monokai"),TextPrompt.editor.setShowPrintMargin(!1),TextPrompt.editor.getSession().setMode("ace/mode/"+a),TextPrompt.editor.setValue(d),TextPrompt.editor.focus(),TextPrompt.editor.clearSelection()):($("#TextPromptTextarea").on("tap mousedown click slide slidestart slideend mouseup",function(a){a.stopPropagation()}),$("#TextPromptTextarea").css("height",
a+"px"),$("#TextPromptTextarea").val(d).focus())},useAce:function(){return TextPrompt.ace},value:function(a){return a?TextPrompt.useAce()?TextPrompt.editor.setValue(a):$("#TextPromptTextarea").val(a):TextPrompt.useAce()?TextPrompt.editor.getValue():$("#TextPromptTextarea").val()}},Backup=new Tool("Backup");Backup.on("ready",function(){$("#BackupDownload").attr("href","/nudgepad.backup/"+document.location.host+".zip")});var Blog=new Tool("Blog");Blog.set("posts",new Space);Blog.active={};
Blog.active.filename=null;Blog.active.advanced=function(){var a=Blog.get("posts "+Blog.active.filename);TextPrompt.open("Advanced",a.toString(),Blog.active.filename,function(d){a.clear();a.patch(d);a.save();Blog.active.open(Blog.active.filename)})};Blog.active.close=function(){Blog.active.filename=null;$(".disableable").attr("disabled",!0)};Blog.active.delete=function(){var a=Blog.active.filename;Blog.active.close();Blog.get("posts "+a).trash();Blog.trigger("posts")};
...
Blog.Post.prototype.save=function(){expressfs.writeFile("nudgepad/posts/"+this._filename,this.toString(),function(){Alerts.success("Saved")})};Blog.Post.prototype.trash=function(){expressfs.unlink("nudgepad/posts/"+this._filename,function(){Alerts.success("Deleted")});Blog.delete("posts "+this._filename)};var Clone=new Tool("Clone");Clone.set("path","");Clone.import=function(){TextPrompt.open("Import a Project to this project","","import.space",function(a){$.post("/nudgepad.import",{space:a},function(a){Alerts.success("Imported files.")})})};
...
Crawler.parseResources=function(a,d,c,b){a.find("tag",c).each(function(a,c){var f=c.get(b);if(!f)return!0;f.match(/^https?\:\/\//)||(f=d.protocol+"//"+d.hostname+"/"+f);var l=document.createElement("a");l.href=f;if(l.hostname!==d.hostname)return!0;Crawler.resources.set(f,!0)})};
...
Fiddle.save=function(){var a=new Space;"A B C D E F".split(/ /g).forEach(function(d){var c=$("#"+d).val();c&&a.set("values "+d,c);(c=$(".FiddleCode[name="+d+"]").val())&&a.set("code "+d,c)});store.set("Fiddle",a.toString())};var Files=new Tool("Files");Files.dir="";Files.on("open",function(){Query.path&&(Files.dir=Query.path)});
Files.on("ready",function(){Files.refresh();Files.updateHidden();Files.watcher=socketfs.watch("",function(a){Files.set("files",new Space(a.content));Files.renderExplorer()},function(){})});Files.on("close",function(){Files.watcher&&Files.watcher.unwatch();Files.watcherEditor&&Files.watcherEditor.unwatch()});
Files.openPath=function(a){Files.dir=a;Files.renderExplorer();Files.watcher&&Files.watcher.unwatch();Files.watcher=socketfs.watch(a.trim().replace(/ /g,"/"),function(d){a.trim()?Files.get("files "+a.trim()).reload(d.content):Files.get("files").reload(d.content);Files.renderExplorer()},function(){})};Files.parseFilename=function(a){a=a.split(/( |\/)/g);return a[a.length-1]};
...
Files.newFile=function(){var a=prompt("Enter the filename");if(!a)return!1;expressfs.create(((Files.dir?Files.dir+" ":"")+a).replace(/ /g,"/"),"")};Files.newFolder=function(){var a=prompt("Enter the folder name");if(!a)return!1;expressfs.mkdir(((Files.dir?Files.dir+" ":"")+a).replace(/ /g,"/"))};
Files.renderExplorer=function(){var a=Files.get("files");if(!a)return!1;Files.dir&&(a=a.get(Files.dir));if(!a)return!1;var d='<table id="FilesExplorer">',d=d+'<tr class="FilesExplorerHeader"><td>Filename</td><td></td><td></td><td></td><td></td><td>Size</td><td>Age</td></tr>',c=Files.dir?Files.dir+" ":"",b=_.filter(a.getKeys(),function(b){return!a.get(b).get("timeSinceLastChange")}).sort(),e=_.filter(a.getKeys(),function(b){return a.get(b).get("timeSinceLastChange")}).sort();b.concat(e).forEach(function(b){if(!store.get("FilesShowHidden")&&
...
"</table>",g='<li><a class="cursor" onclick="Files.openPath(\'\')">'+document.location.host+"</a></li>";if(c){var f="";c.split(/ /g).forEach(function(a,b){g+='<li><a class="cursor" onclick="Files.openPath(\''+f+a+"')\">"+a+"</a></li>";f+=a+" "})}$("#FilesExplorerPath").html(g);$("#FilesExplorerHolder").html(d)};Files.refresh=function(){expressfs.dirStats("",function(a){Files.set("files",new Space(a));Files.renderExplorer()})};
...
$(document).on("click",".FilesExplorerRename",function(){var a=prompt("Rename this file",$(this).parent().attr("value"));if(!a)return!1;var d=Files.dir?Files.dir+" ":"";expressfs.rename($(this).parent().attr("path").replace(/ /g,"/"),(d+a).replace(/ /g,"/"))});
$(document).on("click",".FilesExplorerDuplicate",function(){var a=prompt("Duplicate this file",$(this).parent().attr("value"));if(!a)return!1;var d=Files.dir?Files.dir+" ":"";expressfs.cp($(this).parent().attr("path").replace(/ /g,"/"),(d+a).replace(/ /g,"/"))});
...
$(document).on("click",".FilesExplorerRemoveFolder",function(){var a=$(this).parent().attr("value");if(!event.metaKey&&!confirm("Are you sure you want to delete "+a+"?"))return!1;var d=$(this).parent().attr("path").replace(/ /g,"/");expressfs.rmdir(d,function(){Alerts.success(a+" deleted")})});$(document).on("click",".FilesExplorerFolderName",function(){Files.openPath($(this).parent().attr("path"))});Files.drop={};
...
"_"+d.get("secret")+"_n.jpg",f="http://farm"+d.get("farm")+".staticflickr.com/"+d.get("server")+"/"+d.get("id")+"_"+d.get("secret")+"_b.jpg";$("#photos").append('<img class="cursor" src="'+g+'" onclick="Flickr.download(\''+f+"')\"></a>");if(30<c)return!1})}).fail(function(){Alerts.error("Please try again");$("#photos").html("")})};Flickr.on("ready",function(){});var Forms=new Tool("Forms");Forms.menu={};Forms.menu.autopublish=!0;
Forms.menu.create=function(){var a=prompt("Enter a filename","form.html");if(!a)return!1;Forms.form=new Forms.Form(a);Forms.form.create()};Forms.filter=function(){"script"===this.div.tag&&(this.div.draft=!0);this.div.attr("data-index",this.index);this.div.addClass("Scrap")};Forms.menu.open=function(a){console.log("opening %s",a);Forms.form=new Forms.Form(a);Forms.form.open()};Forms.menu.openPrompt=function(){var a=prompt("Enter a filename");if(!a)return!1;Forms.menu.open(a)};
Forms.on("ready",function(){$(".draggable").draggable({revert:!0});$(".droppable").droppable({drop:function(a,d){var c=$(d.draggable).find("script").html().trim(),b=new Space($("#FormsSource").val());b.get("body form")?(b.get("body form").concat(c),$("#FormsSource").val(b.toString())):$("#FormsSource").val($("#FormsSource").val()+c+"\n");Forms.form.page.reload($("#FormsSource").val()).loadScraps();$(this).html(Forms.form.page.toHtml({wrap:!0,filter:Forms.filter}));Forms.menu.autopublish&&Forms.form.save()}});
$("#FormsSource").on("keyup",function(){Forms.form.page.reload($("#FormsSource").val()).loadScraps();$("#FormsStage").html(Forms.form.page.toHtml({wrap:!0,filter:Forms.filter}))});$("#FormsSource").on("blur",function(){Forms.menu.autopublish&&Forms.form.save()});$("#FormsStage").on("click","*",function(a){$(this).is("a")&&a.preventDefault();if($(this).find(".Scrap").length||!$(this).hasClass("Scrap")||!$(this).text().length)return!0;$(this).attr("contenteditable",!0);$(this).focus();a=$(this).attr("data-index");
Forms.form.page.reload($("#FormsSource").val()).loadScraps();var d=Forms.form.page.getByIndexPath(a);$(this).on("keyup",function(){var a=$(this).html();d.set("content",a);$("#FormsSource").val(Forms.form.page.toConciseString());Forms.form.page.trigger("reload")});$(this).on("blur",function(){$(this).removeAttr("contenteditable");var a=$(this).html();d.set("content",a);$("#FormsSource").val(Forms.form.page.toConciseString());Forms.form.page.trigger("reload");Forms.menu.autopublish&&Forms.form.save()})});
store.get("FormsFilename")&&Forms.menu.open(store.get("FormsFilename"))});Forms.Form=function(a){this.filename=a;this.page=new Scraps.Page};Forms.Form.prototype=new Space;Forms.Form.prototype.create=function(a){this.page=new Scraps.Page($("#FormsTemplate").text());var d=this;this.save(function(){d.open()})};Forms.Form.prototype.open=function(a){var d=this;expressfs.readFile(this.filename,function(a){d.page=new Scraps.Page($.htmlToScraps(a));d.render();store.set("FormsFilename",d.filename)})};
Forms.Form.prototype.publish=function(a){var d=html_beautify(this.page.toHtml({wrap:!0}),{"indent-size":2,"indent-char":" ","indent-inner-html":!0});expressfs.writeFileAndOpen(this.filename,d,a)};Forms.Form.prototype.render=function(a){$("#FormsStage").html(this.page.toHtml({filter:Forms.filter,wrap:!0}));$("#FormsSource").val(this.page.toConciseString());$("#FormsEditor").show()};
Forms.Form.prototype.save=function(a){var d=html_beautify(this.page.toHtml({wrap:!0}),{"indent-size":2,"indent-char":" ","indent-inner-html":!0});expressfs.writeFile(this.filename,d,a)};var Git=new Tool("Git");Git.gitignore="nudgepad/";Git.add=function(){var a=prompt("Enter the file paths to add",".");if(!a)return!1;Git.exec("git add "+a,function(){Alerts.success("Added");Git.status()})};Git.addOrigin=function(){var a=prompt("Enter origin URI");if(!a)return!1;Git.exec("git remote add origin "+a,function(){Alerts.success("Origin Updated")})};
Git.autocommit=function(){Git.exec('git add .; git commit -am "autocommit"',function(){console.log("changed committed...")})};Git.cloneRepo=function(){var a=prompt("Enter clone URI","https://github.com/");if(!a)return!1;Git.exec("git clone "+a+" temp; mv temp/* .; mv temp/.git .; rm -rf temp",function(){Alerts.success("Cloned")})};Git.commit=function(){var a=prompt("Enter your message");if(!a)return!1;Git.exec('git commit -am "'+a+'"',function(){Alerts.success("Commit Received")})};
...
Home.on("ready",function(){Home.renderMenu();$(window).on("resize",Home.heights)});Home.on("close",function(){$(window).off("resize",Home.heights)});var Insight=new Tool("Insight");Insight.menu={};Insight.database;Insight.menu.create=function(){expressfs.createUntitledDir("nudgepad/insight",function(a){Insight.menu.open(a)})};
Insight.menu.delete=function(){if(!confirm("Are you sure you want to delete the Database "+Insight.database+"?"))return!1;Insight.base.close();expressfs.rmdir("nudgepad/insight/"+Insight.database)};Insight.menu.open=function(a){Insight.database=a;Insight.base=new Insight.Database(a);Insight.base.open()};Insight.menu.openPrompt=function(){var a=prompt("Open a db","untitled");if(!a)return!1;Insight.menu.open(a)};
Insight.drawInit=function(){$(".InsightPlane").on("mousemove",function(a){if(!a.which)return!0;for(var d=0;300>d;d++){var c=Math.round(200*Math.random())*(0.5<Math.random()?1:-1),b=Math.round(200*Math.random())*(0.5<Math.random()?1:-1);Insight.insert(a.offsetX+c,a.offsetY+b,(new Date).getTime())}})};
Insight.refreshDBs=function(){expressfs.readdir("nudgepad/insight",function(a,d){if(a)return!0;$("#InsightDropdown").html("");d.forEach(function(a,b){var d=$('<option value="'+a+'">'+a+"</option>");a===Insight.database&&d.attr("selected",!0);$("#InsightDropdown").append(d)})})};
Insight.on("ready",function(){Insight.dbWatcher=socketfs.watch("nudgepad/insight",Insight.refreshDBs);Insight.refreshDBs();$(".InsightPlane").on("dblclick",function(a){var d=new Space,c=(new Date).getTime().toString(),d=new Insight.Record(c,Insight.database,d);d.x=a.offsetX;d.y=a.offsetY;Insight.base.set(c,d);d.render();d.save();d.edit()});$(".InsightPlane").on("click",".InsightRecord",function(){var a=$(this).attr("id"),a=Insight.base.get(a);$(".InsightTextarea").length&&$(".InsightTextarea").trigger("change");
a.edit()});$(".InsightPlane").on("click",".InsightEditor, .InsightRecord",function(a){a.stopPropagation()});$(".InsightPlane").on("dblclick",".InsightEditor, .InsightRecord",function(a){a.stopPropagation()});$(".InsightPlane").on("click",function(){$(".InsightEditor").remove()});store.get("InsightDatabase")&&Insight.menu.open(store.get("InsightDatabase"));$("#InsightDatabase").on("blur",function(){console.log("changing");Insight.base.rename($(this).text())});window.addEventListener("paste",Insight.onpaste,
!1)});Insight.on("close",function(){Insight.watcher&&Insight.watcher.unwatch();Insight.dbWatcher&&Insight.dbWatcher.unwatch();window.removeEventListener("paste",Insight.onpaste,!1)});Insight.Record=function(a,d,c){this.id=a;this.database=d;this.reload(c);this.x=_.random(0,$(".InsightPlane").width());this.y=_.random(0,$(".InsightPlane").height());return this};Insight.Record.prototype=new Space;
...
a.remove()});var g=this;d.val(this.toString());d.focus();d.on("change",function(){var b=d.val();a.remove();if((new Space(b)).toString()===g.toString())return!0;g.reload(new Space(b));g.save();g.render();Insight.base.insight()})};Insight.Record.prototype.element=function(){return $("#"+this.id)};Insight.dragIt=function(a){a.draggable({stop:function(){var a=$(this).attr("id"),c=$(this),a=Insight.base.get(a);a.y=c.position().top;a.x=c.position().left},start:function(){$(".InsightEditor").remove()}})};
Insight.Record.prototype.render=function(){var a=Insight.base.settings;$("#"+this.id).remove();var d=a.get("icon")||"location-arrow";this.get("icon")&&(d=this.get("icon"));var d=$('<i class="icon-'+d+'"></i>'),c=$('<div class="InsightRecord"></div>');d.css("font-size","14px");var b="";this.get("label")?b=this.get("label"):this.get("name")?b=this.get("name"):this.get("title")?b=this.get("title"):this.get("Title")?b=this.get("Title"):this.get("Name")?b=this.get("Name"):this.getByIndex(0)&&(b=this.getByIndex(0));
a.get("label")&&this.get(a.get("label"))&&(b=this.get(a.get("label")));a=$("<label>&nbsp;"+b+"</label>");a.prepend(d);c.append(a);c.attr("id",this.id);c.css({top:this.y+"px",left:this.x+"px"});$(".InsightPlane").append(c);Insight.dragIt(c);return this};Insight.Record.prototype.save=function(a){expressfs.writeFile("nudgepad/insight/"+this.database+"/"+this.id+".space",this.toString(),a)};Insight.Database=function(a){this.name=a;this.settings=new Space;return this};Insight.Database.prototype=new Space;
Insight.Database.prototype.close=function(){this.clear();$(".Insight").html("");$(".InsightPlane").hide();store.remove("InsightDatabase")};Insight.Database.prototype.create=function(){};Insight.Database.prototype.edit=function(){var a=this;TextPrompt.open("Edit Settings",this.settings.toString(),"settings.space",function(d){a.settings.reload(d);a.save();a.render();a.insight()})};
Insight.Database.prototype.editSource=function(){var a=this;TextPrompt.open("Edit Source",this.toString(),Insight.database+".space",function(d){a.diff(d).each(function(c,b){if(b)if(a.get(c))a.get(c).patch(b).save();else{var d=new Insight.Record(c,a.name);a.set(c,d);d.render();d.save()}else a.trash(c)});a.insight()})};Insight.Database.prototype.getPath=function(a){return"nudgepad/insight/"+(a?a:this.name)};
Insight.Database.prototype.insight=function(){view=this.settings;var a=this.getByIndex(0);if(!a)return!1;view.get("y")||view.set("y",a.getByIndex(0));view.get("x")||view.set("x",a.getByIndex(0));var d=view.get("y");if(!d)return!1;$(".InsightRecord").addClass("InsightRecordAnimate");var c=$(".InsightPlane").height()-20,b,e;this.each(function(a,c,f){a=parseFloat(c.get(d));"undefined"===typeof b&&(b=a);"undefined"===typeof e&&(e=a);b>a&&(b=a);e<a&&(e=a)});var g=e-b;this.each(function(a,e,f){a=e.element();
e=e.get(d);e=Math.round((parseFloat(e)-b)/g*c);e=c-e;a.css("top",e)});setTimeout("$('.InsightRecord').removeClass('InsightRecordAnimate')",1E3);$("#InsightYMax").html(e).show();var f=$("<select onblur=\"Insight.base.settings.set('y',$(this).val()); Insight.base.save(); Insight.base.insight()\"></select>"),l=a.getKeys();l.forEach(function(a,b){var c=$('<option value="'+a+'">'+a+"</option>");d===a&&c.attr("selected","true");f.append(c)});$("#InsightYLabel").html(f).show();$("#InsightYMin").html(b).show();
d=view.get("x");if(!d)return!1;$(".InsightRecord").addClass("InsightRecordAnimate");c=$(".InsightPlane").width()-100;e=b=void 0;this.each(function(a,c,f){a=parseFloat(c.get(d));"undefined"===typeof b&&(b=a);"undefined"===typeof e&&(e=a);b>a&&(b=a);e<a&&(e=a)});g=e-b;this.each(function(a,e,f){a=e.element();e=e.get(d);e=Math.round((parseFloat(e)-b)/g*c);a.css("left",e)});setTimeout("$('.InsightRecord').removeClass('InsightRecordAnimate')",1E3);$("#InsightXMax").html(e).show();f=$("<select onblur=\"Insight.base.settings.set('x',$(this).val()); Insight.base.save(); Insight.base.insight()\"></select>");
l=a.getKeys();l.forEach(function(a,b){var c=$('<option value="'+a+'">'+a+"</option>");d===a&&c.attr("selected","true");f.append(c)});$("#InsightXLabel").html(f).show();$("#InsightXMin").html(b).show()};
Insight.Database.prototype.open=function(){var a=this;expressfs.downloadDirectory(this.getPath(),"space",function(d){a.reload(d);a.get("settings.space")&&(a.settings.reload(a.get("settings.space")),a.delete("settings.space"));a.each(function(a,b,d){a=a.replace(/\.space/,"");b=new Insight.Record(a,this.name,b);this.update(d,a,b)});a.render();Insight.watcher=socketfs.watch("nudgepad/insight/"+a.name,function(c){(new Space(c.content)).each(function(b,c){if(!b.match(/\.space$/))return!0;var d=b.replace(/\.space/,
"");if(a.get(d)||"settings.space"===b)return!0;expressfs.readFile("nudgepad/insight/"+a.name+"/"+b,function(b){b=new Insight.Record(d,a.name,b);a.set(d,b);b.render()})})},function(){});$("#InsightDatabase").html(a.name);store.set("InsightDatabase",a.name);a.insight()})};Insight.Database.prototype.rename=function(a){expressfs.rename(this.getPath(),this.getPath(a),function(){Insight.menu.open(a)})};
Insight.Database.prototype.render=function(){$(".Insight").html("");this.each(function(a,d,c){d.render()});$(".InsightPlane").show()};Insight.Database.prototype.save=function(){expressfs.writeFile(this.getPath()+"/settings.space",this.settings.toString())};Insight.Database.prototype.trash=function(a){var d=this;expressfs.unlink("nudgepad/insight/"+this.name+"/"+a+".space",function(){d.delete(a);$("#"+a).fadeOut("fast",function(){$(this).remove();d.insight()})})};Insight.drop={};
Insight.drop.traverseFileTree=function(a,d){d=d||"";a.isFile?a.file(function(a){console.log("File:",d+a.name);Insight.drop.processFile(d,a)}):a.isDirectory&&a.createReader().readEntries(function(c){for(var b=0;b<c.length;b++)Insight.drop.traverseFileTree(c[b],d+a.name+"/")})};
Insight.drop.processFile=function(a,d){if(d.name.match(/\.space/)){var c=new FileReader;c.onload=function(a){a=new Space(a.target.result);var c=new Space(a);a=(new Date).getTime().toString();c=new Insight.Record(a,Insight.database,c);Insight.base.set(a,c);c.render();c.save()};c.onerror=function(a){console.log("error: %s",a)};c.readAsText(d)}d.name.match(/\.csv/)&&(c=new FileReader,c.onload=function(a){csvToSpace(a.target.result).each(function(a,b,c){b=new Space(b);b=new Insight.Record(a,Insight.database,
b);Insight.base.set(a,b);b.render();b.save()})},c.onerror=function(a){console.log("error: %s",a)},c.readAsText(d))};Insight.drop.ondrop=function(a){a.preventDefault();Insight.drop.event=a;a=a.dataTransfer.items;for(var d=0;d<a.length;d++){var c=a[d].webkitGetAsEntry();c&&Insight.drop.traverseFileTree(c)}};Insight.drop.ondragover=function(a){a.preventDefault()};Insight.on("close",function(){window.removeEventListener("dragover",Insight.drop.ondragover);window.removeEventListener("drop",Insight.drop.ondrop)});
Insight.on("open",function(){window.addEventListener("dragover",Insight.drop.ondragover,!1);window.addEventListener("drop",Insight.drop.ondrop,!1)});
Insight.onpaste=function(a){if($("input:focus, div:focus, textarea:focus, a:focus").length)return!0;var d=void 0;a.clipboardData&&a.clipboardData.getData&&(d=a.clipboardData.getData("text/plain"));(new Space(d)).each(function(a,b,d){b=new Space(b);b.set("id",a);b.set("order",d);a=(new Date).getTime().toString();d=new Insight.Record(a,Insight.database,b);Insight.base.set(a,d);d.render();d.save()})};var Labs=new Tool("Labs");
Labs.renderMenu=function(){$("#OpenTool #LabsContainer").html("");var a="Backup Blog Clone Crawler Fiddle Files Flickr Forms Git Pages Redirect Server Share Sketch Stats Team Templates Time".split(/ /g),d="rgb(26,134,214) rgb(36,65,112) rgb(231,189,44) rgb(171,193,199) rgb(224,54,52) rgb(71,41,54)".split(" "),c='<div class="row">',b;for(b in a){var e=window[a[b]];0<b&&0===b%3&&(c+='</div><div class="row">');var e=e.get("name"),g=ToolInfo.get(e.toLowerCase()),c=c+Labs.toButton(e,g.get("description"),
...
var isRectangleIntersectedByLine=function(a,d,c,b,e,g,f,l){var h=e,n=f;e>f&&(h=f,n=e);n>c&&(n=c);h<a&&(h=a);if(h>n)return!1;a=g;c=l;f-=e;1E-7<Math.abs(f)&&(l=(l-g)/f,e=g-l*e,a=l*h+e,c=l*n+e);a>c&&(h=c,c=a,a=h);c>b&&(c=b);a<d&&(a=d);return a>c?!1:!0};
$.fn.getElementsByLine=function(a,d,c,b){var e=[];$(this).each(function(){var g=$(this),f,l,h,n;f=g.offset().left;l=g.offset().left+g.outerWidth();h=g.offset().top;n=g.offset().top+g.outerHeight();isRectangleIntersectedByLine(f,h,l,n,a,d,c,b)&&e.push(g)});return e};var Pages=new Tool("Pages");Pages.editor={};Pages.editor.create=function(){expressfs.createUntitled("","html","",function(a){Pages.editor.open(a)})};
Pages.editor.rename=function(){var a=prompt("Enter a new name for the file",store.get("PagesFilename"));if(!a)return!0;expressfs.rename(store.get("PagesFilename"),a,function(d){Pages.editor.open(a)})};Pages.editor.duplicate=function(){var a=prompt("Enter a name for the file",Pages.filename);if(!a)return!0;expressfs.writeFile(a,Pages.page.toHtml());Pages.editor.open(a)};
Pages.editor.updateMenu=function(a){a=new Space(a);$(".openPage").remove();a.each(function(a,c){if(!a.match(/\.html?$/i))return!0;$("#PagesFileMenu").append('<li><a class="cursor openPage" onclick="Pages.editor.open(\''+a+"')\">"+a+"</a></li>")})};
Pages.on("ready",function(){$("#PagesStage").attr("src","");$("#PagesStage").on("load",function(){store.get("PagesFilename")&&Pages.editor.open(store.get("PagesFilename"))});expressfs.readdir("",function(a,d){var c="";d.forEach(function(a,d){c+=a+"\n"});Pages.editor.updateMenu(c)});Pages.dirWatcher=socketfs.watch("",function(a){Pages.editor.updateMenu(a.content)})});
Pages.on("close",function(){Events.shortcut.shortcuts={};Events.shortcut.disableShortcutsIfInputHasFocus=!0;Pages.watcher&&Pages.watcher.unwatch();Pages.dirWatcher&&Pages.dirWatcher.unwatch()});
Pages.editor.editHtml=function(){var a=Pages.page.toHtml();Events.shortcut.disableShortcutsIfInputHasFocus=!1;Events.shortcut.shortcuts["meta+s"]=function(){Pages.page.reload($.htmlToScraps(TextPrompt.value()));Pages.page.publish()};TextPrompt.open("",a,store.get("PagesFilename"),function(a){Pages.page.reload($.htmlToScraps(a));Pages.page.render();Events.shortcut.shortcuts={}})};
Pages.editor.editScraps=function(){Events.shortcut.disableShortcutsIfInputHasFocus=!1;Events.shortcut.shortcuts["meta+s"]=function(){Pages.page.reload(TextPrompt.value());Pages.page.publish()};TextPrompt.open("",Pages.page.toConciseString(),store.get("PagesFilename").replace("html","space"),function(a){Pages.page.reload(a);Pages.page.render();Events.shortcut.shortcuts={}})};Pages.editor.open=function(a){$("#PagesFilename").html(a);Pages.page=new Pages.Page(a);Pages.page.open()};
Pages.editor.trash=function(){Pages.page.trash()};Pages.Page=function(a){this.filename=a;return this};Pages.Page.prototype=new Space;Pages.Page.prototype.close=function(){$("#PagesStage").contents().find("body").html("");$("#PagesStage").css("visibility","hidden");$("#PagesFilename").html("Open")};
Pages.Page.prototype.open=function(a){var d=this;expressfs.readFile(this.filename,function(a){d.reload($.htmlToScraps(a));d.render();store.set("PagesFilename",d.filename);Pages.watcher=socketfs.watch(filename,function(a){Pages.page.reload($.htmlToScraps(a.content));Pages.page.render()})})};
...
Pages.Page.prototype.trash=function(){var a=this;expressfs.unlink(this.filename,function(){a.close()})};Pages.Page.prototype.toHtml=function(){return html_beautify((new Scraps.Page(this.toString())).toHtml({wrap:!0}),{"indent-size":2,"indent-char":" ","indent-inner-html":!0})};var Redirect=new Tool("Redirect");Redirect.on("open",function(){expressfs.readFile("nudgepad/redirects.space",function(a){$("#RedirectCode").val(a)})});
Redirect.save=function(){var a=$("#RedirectCode").val();expressfs.writeFile("nudgepad/redirects.space",a,function(a){Alerts.success("Saved. Please restart")})};var Server=new Tool("Server");Server.browsePackages=function(){expressfs.mkdir("nudgepad/packages",function(){Launcher.open("Files");Files.openPath("nudgepad packages")})};Server.newPackage=function(){var a=$("#ServerSamplePackage").text();expressfs.mkdir("nudgepad/packages",function(){expressfs.createUntitled("nudgepad/packages/","js",a,function(a){Server.browsePackages()})})};
...
d.focus()})};Server.refresh=function(){$.get("/nudgepad.status",{},function(a){$("#ServerStatusArea").text(a)});$.get("/nudgepad.logs",{},function(a){$("#ServerLogHolder").html($("<div/>").text(a).html());$("#ServerLogHolder").scrollTop($("#ServerLogHolder")[0].scrollHeight)})};$(document).on("ready",function(){$("#ServerConsoleInput").on("enterkey",Server.consoleSend)});
...
var SignaturePad=function(a){var d=function(b,c){var d=this,l=c||{};this.velocityFilterWeight=l.velocityFilterWeight||0.7;this.minWidth=l.minWidth||0.5;this.maxWidth=l.maxWidth||2.5;this.dotSize=l.dotSize||function(){return(this.minWidth+this.maxWidth)/2};this.penColor=l.penColor||"black";this.backgroundColor=l.backgroundColor||"rgba(0,0,0,0)";this._canvas=b;this._ctx=b.getContext("2d");this.clear();this._mouseButtonDown=!1;b.addEventListener("mousedown",function(a){1===a.which&&(d._mouseButtonDown=
...
function(a){var b=this._canvas.getBoundingClientRect();return new c(a.clientX-b.left,a.clientY-b.top)};d.prototype._addPoint=function(a){var c,d,l,h,n=this.points;n.push(a);2<n.length&&(3===n.length&&n.unshift(n[0]),h=this._calculateCurveControlPoints(n[0],n[1],n[2]),c=h.c2,h=this._calculateCurveControlPoints(n[1],n[2],n[3]),d=h.c1,l=new b(n[1],c,d,n[2]),this._addCurve(l),n.shift())};d.prototype._calculateCurveControlPoints=function(a,b,d){var l=a.x-b.x,h=a.y-b.y,n=b.x-d.x,s=b.y-d.y,t=(a.x+b.x)/2;
a=(a.y+b.y)/2;var r=(b.x+d.x)/2;d=(b.y+d.y)/2;l=Math.sqrt(l*l+h*h);n=Math.sqrt(n*n+s*s);s=n/(l+n);n=b.x-(r+(t-r)*s);b=b.y-(d+(a-d)*s);return{c1:new c(t+n,a+b),c2:new c(r+n,d+b)}};d.prototype._addCurve=function(a){var b,c;b=a.endPoint.velocityFrom(a.startPoint);b=this.velocityFilterWeight*b+(1-this.velocityFilterWeight)*this._lastVelocity;c=this._strokeWidth(b);this._drawCurve(a,this._lastWidth,c);this._lastVelocity=b;this._lastWidth=c};d.prototype._drawPoint=function(a,b,c){var d=this._ctx;d.moveTo(a,
b);d.arc(a,b,c,0,2*Math.PI,!1);this._isEmpty=!1};d.prototype._drawCurve=function(a,b,c){var d,h,n,s,t,r,p,w,v=this._ctx,D=c-b;c=Math.floor(a.length());v.beginPath();for(h=0;c>h;h++)d=h/c,n=d*d,s=n*d,t=1-d,r=t*t,p=r*t,w=p*a.startPoint.x,w+=3*r*d*a.control1.x,w+=3*t*n*a.control2.x,w+=s*a.endPoint.x,p*=a.startPoint.y,p+=3*r*d*a.control1.y,p+=3*t*n*a.control2.y,p+=s*a.endPoint.y,d=b+s*D,this._drawPoint(w,p,d);v.closePath();v.fill()};d.prototype._strokeWidth=function(a){return Math.max(this.maxWidth/(a+
1),this.minWidth)};var c=function(a,b,c){this.x=a;this.y=b;this.time=c||(new Date).getTime()};c.prototype.velocityFrom=function(a){return this.distanceTo(a)/(this.time-a.time)};c.prototype.distanceTo=function(a){return Math.sqrt(Math.pow(this.x-a.x,2)+Math.pow(this.y-a.y,2))};var b=function(a,b,c,d){this.startPoint=a;this.control1=b;this.control2=c;this.endPoint=d};return b.prototype.length=function(){var a,b,c,d,h,n,s,t=0;for(a=0;10>=a;a++)b=a/10,c=this._point(b,this.startPoint.x,this.control1.x,
this.control2.x,this.endPoint.x),b=this._point(b,this.startPoint.y,this.control1.y,this.control2.y,this.endPoint.y),0<a&&(n=c-d,s=b-h,t+=Math.sqrt(n*n+s*s)),d=c,h=b;return t},b.prototype._point=function(a,b,c,d,h){return b*(1-a)*(1-a)*(1-a)+3*c*(1-a)*(1-a)*a+3*d*(1-a)*a*a+h*a*a*a},d}(document),Sketch=new Tool("Sketch");
...
Team.loginLink=function(){expressfs.readFile("nudgepad/team/"+Cookie.email+".space",function(a){a=new Space(a);alert("Your login link:\nhttp://"+window.location.hostname+"/nudgepad.login?email="+Cookie.email+"&key="+a.get("key"))})};Team.refresh=function(){$("#TeamCurrent").html("");expressfs.downloadDirectory("nudgepad/team/",null,function(a){(new Space(a)).each(function(a,c){var b=a.replace(/\.space/,"");$("#TeamCurrent").append('<li><i class="icon-li icon-user"></i>'+b+"</li>")})})};
