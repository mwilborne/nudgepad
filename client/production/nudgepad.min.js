...
*/
(function(a,c){function b(a){var b=a.length,c=l.type(a);return l.isWindow(a)?!1:1===a.nodeType&&b?!0:"array"===c||"function"!==c&&(0===b||"number"==typeof b&&0<b&&b-1 in a)}function d(a){var b=Pa[a]={};return l.each(a.match(Z)||[],function(a,c){b[c]=!0}),b}function e(a,b,d,e){if(l.acceptData(a)){var f,h,k=l.expando,g="string"==typeof b,n=a.nodeType,m=n?l.cache:a,t=n?a[k]:a[k]&&k;if(t&&m[t]&&(e||m[t].data)||!g||d!==c)return t||(n?a[k]=t=W.pop()||l.guid++:t=k),m[t]||(m[t]={},n||(m[t].toJSON=l.noop)),
("object"==typeof b||"function"==typeof b)&&(e?m[t]=l.extend(m[t],b):m[t].data=l.extend(m[t].data,b)),f=m[t],e||(f.data||(f.data={}),f=f.data),d!==c&&(f[l.camelCase(b)]=d),g?(h=f[b],null==h&&(h=f[l.camelCase(b)])):h=f,h}}function k(a,b,c){if(l.acceptData(a)){var d,e,f,h=a.nodeType,k=h?l.cache:a,n=h?a[l.expando]:l.expando;if(k[n]){if(b&&(f=c?k[n]:k[n].data)){l.isArray(b)?b=b.concat(l.map(b,l.camelCase)):b in f?b=[b]:(b=l.camelCase(b),b=b in f?[b]:b.split(" "));d=0;for(e=b.length;e>d;d++)delete f[b[d]];
if(!(c?g:l.isEmptyObject)(f))return}(c||(delete k[n].data,g(k[n])))&&(h?l.cleanData([a],!0):l.support.deleteExpando||k!=k.window?delete k[n]:k[n]=null)}}}function h(a,b,d){if(d===c&&1===a.nodeType){var e="data-"+b.replace(Ua,"-$1").toLowerCase();if(d=a.getAttribute(e),"string"==typeof d){try{d="true"===d?!0:"false"===d?!1:"null"===d?null:+d+""===d?+d:ua.test(d)?l.parseJSON(d):d}catch(f){}l.data(a,b,d)}else d=c}return d}function g(a){for(var b in a)if(("data"!==b||!l.isEmptyObject(a[b]))&&"toJSON"!==
b)return!1;return!0}function f(){return!0}function m(){return!1}function q(a,b){do a=a[b];while(a&&1!==a.nodeType);return a}function u(a,b,c){if(b=b||0,l.isFunction(b))return l.grep(a,function(a,d){return!!b.call(a,d,a)===c});if(b.nodeType)return l.grep(a,function(a){return a===b===c});if("string"==typeof b){var d=l.grep(a,function(a){return 1===a.nodeType});if(Va.test(b))return l.filter(b,d,!c);b=l.filter(b,d)}return l.grep(a,function(a){return 0<=l.inArray(a,b)===c})}function s(a){var b=Wa.split("|");
a=a.createDocumentFragment();if(a.createElement)for(;b.length;)a.createElement(b.pop());return a}function n(a){var b=a.getAttributeNode("type");return a.type=(b&&b.specified)+"/"+a.type,a}function r(a){var b=Jb.exec(a.type);return b?a.type=b[1]:a.removeAttribute("type"),a}function v(a,b){for(var c,d=0;null!=(c=a[d]);d++)l._data(c,"globalEval",!b||l._data(b[d],"globalEval"))}function t(a,b){if(1===b.nodeType&&l.hasData(a)){var c,d,e;d=l._data(a);var f=l._data(b,d),h=d.events;if(h)for(c in delete f.handle,
f.events={},h)for(d=0,e=h[c].length;e>d;d++)l.event.add(b,c,h[c][d]);f.data&&(f.data=l.extend({},f.data))}}function z(a,b){var d,e,f=0,h=typeof a.getElementsByTagName!==Q?a.getElementsByTagName(b||"*"):typeof a.querySelectorAll!==Q?a.querySelectorAll(b||"*"):c;if(!h)for(h=[],d=a.childNodes||a;null!=(e=d[f]);f++)!b||l.nodeName(e,b)?h.push(e):l.merge(h,z(e,b));return b===c||b&&l.nodeName(a,b)?l.merge([a],h):h}function L(a){fb.test(a.type)&&(a.defaultChecked=a.checked)}function D(a,b){if(b in a)return b;
for(var c=b.charAt(0).toUpperCase()+b.slice(1),d=b,e=tb.length;e--;)if(b=tb[e]+c,b in a)return b;return d}function G(a,b){return a=b||a,"none"===l.css(a,"display")||!l.contains(a.ownerDocument,a)}function p(a,b){for(var c,d,e,f=[],h=0,k=a.length;k>h;h++)d=a[h],d.style&&(f[h]=l._data(d,"olddisplay"),c=d.style.display,b?(f[h]||"none"!==c||(d.style.display=""),""===d.style.display&&G(d)&&(f[h]=l._data(d,"olddisplay",J(d.nodeName)))):f[h]||(e=G(d),(c&&"none"!==c||!e)&&l._data(d,"olddisplay",e?c:l.css(d,
"display"))));for(h=0;k>h;h++)d=a[h],d.style&&(b&&"none"!==d.style.display&&""!==d.style.display||(d.style.display=b?f[h]||"":"none"));return a}function y(a,b,c){return(a=Kb.exec(b))?Math.max(0,a[1]-(c||0))+(a[2]||"px"):b}function I(a,b,c,d,e){b=c===(d?"border":"content")?4:"width"===b?1:0;for(var f=0;4>b;b+=2)"margin"===c&&(f+=l.css(a,c+va[b],!0,e)),d?("content"===c&&(f-=l.css(a,"padding"+va[b],!0,e)),"margin"!==c&&(f-=l.css(a,"border"+va[b]+"Width",!0,e))):(f+=l.css(a,"padding"+va[b],!0,e),"padding"!==
c&&(f+=l.css(a,"border"+va[b]+"Width",!0,e)));return f}function C(a,b,c){var d=!0,e="width"===b?a.offsetWidth:a.offsetHeight,f=wa(a),h=l.support.boxSizing&&"border-box"===l.css(a,"boxSizing",!1,f);if(0>=e||null==e){if(e=xa(a,b,f),(0>e||null==e)&&(e=a.style[b]),Xa.test(e))return e;d=h&&(l.support.boxSizingReliable||e===a.style[b]);e=parseFloat(e)||0}return e+I(a,b,c||(h?"border":"content"),d,f)+"px"}function J(a){var b=F,c=ub[a];return c||(c=aa(a,b),"none"!==c&&c||(Qa=(Qa||l("<iframe frameborder='0' width='0' height='0'/>").css("cssText",
"display:block !important")).appendTo(b.documentElement),b=(Qa[0].contentWindow||Qa[0].contentDocument).document,b.write("<!doctype html><html><body>"),b.close(),c=aa(a,b),Qa.detach()),ub[a]=c),c}function aa(a,b){var c=l(b.createElement(a)).appendTo(b.body),d=l.css(c[0],"display");return c.remove(),d}function O(a,b,c,d){var e;if(l.isArray(b))l.each(b,function(b,e){c||Lb.test(a)?d(a,e):O(a+"["+("object"==typeof e?b:"")+"]",e,c,d)});else if(c||"object"!==l.type(b))d(a,b);else for(e in b)O(a+"["+e+"]",
b[e],c,d)}function S(a){return function(b,c){"string"!=typeof b&&(c=b,b="*");var d,e=0,f=b.toLowerCase().match(Z)||[];if(l.isFunction(c))for(;d=f[e++];)"+"===d[0]?(d=d.slice(1)||"*",(a[d]=a[d]||[]).unshift(c)):(a[d]=a[d]||[]).push(c)}}function ca(a,b,d,e){function f(g){var n;return h[g]=!0,l.each(a[g]||[],function(a,N){var l=N(b,d,e);return"string"!=typeof l||k||h[l]?k?!(n=l):c:(b.dataTypes.unshift(l),f(l),!1)}),n}var h={},k=a===gb;return f(b.dataTypes[0])||!h["*"]&&f("*")}function M(a,b){var d,e,
f=l.ajaxSettings.flatOptions||{};for(e in b)b[e]!==c&&((f[e]?a:d||(d={}))[e]=b[e]);return d&&l.extend(!0,a,d),a}function T(){try{return new a.XMLHttpRequest}catch(b){}}function H(){return setTimeout(function(){Ea=c}),Ea=l.now()}function V(a,b){l.each(b,function(b,c){for(var d=(Ra[b]||[]).concat(Ra["*"]),e=0,l=d.length;l>e&&!d[e].call(a,b,c);e++);})}function R(a,b,c){var d,e=0,f=Ya.length,h=l.Deferred().always(function(){delete k.elem}),k=function(){if(d)return!1;for(var b=Ea||H(),b=Math.max(0,g.startTime+
g.duration-b),c=1-(b/g.duration||0),e=0,l=g.tweens.length;l>e;e++)g.tweens[e].run(c);return h.notifyWith(a,[g,c,b]),1>c&&l?b:(h.resolveWith(a,[g]),!1)},g=h.promise({elem:a,props:l.extend({},b),opts:l.extend(!0,{specialEasing:{}},c),originalProperties:b,originalOptions:c,startTime:Ea||H(),duration:c.duration,tweens:[],createTween:function(b,c){var d=l.Tween(a,g.opts,b,c,g.opts.specialEasing[b]||g.opts.easing);return g.tweens.push(d),d},stop:function(b){var c=0,e=b?g.tweens.length:0;if(d)return this;
for(d=!0;e>c;c++)g.tweens[c].run(1);return b?h.resolveWith(a,[g,b]):h.rejectWith(a,[g,b]),this}});c=g.props;for(w(c,g.opts.specialEasing);f>e;e++)if(b=Ya[e].call(g,a,c,g.opts))return b;return V(g,c),l.isFunction(g.opts.start)&&g.opts.start.call(a,g),l.fx.timer(l.extend(k,{elem:a,anim:g,queue:g.opts.queue})),g.progress(g.opts.progress).done(g.opts.done,g.opts.complete).fail(g.opts.fail).always(g.opts.always)}function w(a,b){var c,d,e,f,h;for(e in a)if(d=l.camelCase(e),f=b[d],c=a[e],l.isArray(c)&&(f=
c[1],c=a[e]=c[0]),e!==d&&(a[d]=c,delete a[e]),h=l.cssHooks[d],h&&"expand"in h)for(e in c=h.expand(c),delete a[d],c)e in a||(a[e]=c[e],b[e]=f);else b[d]=f}function E(a,b,c,d,e){return new E.prototype.init(a,b,c,d,e)}function B(a,b){var c,d={height:a},e=0;for(b=b?1:0;4>e;e+=2-b)c=va[e],d["margin"+c]=d["padding"+c]=a;return b&&(d.opacity=d.width=a),d}function K(a){return l.isWindow(a)?a:9===a.nodeType?a.defaultView||a.parentWindow:!1}var A,x,Q=typeof c,F=a.document,fa=a.location,da=a.jQuery,ea=a.$,ga=
{},W=[],X=W.concat,U=W.push,ha=W.slice,sa=W.indexOf,ya=ga.toString,ia=ga.hasOwnProperty,ja="1.9.1".trim,l=function(a,b){return new l.fn.init(a,b,x)},na=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,Z=/\S+/g,za=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,Fa=/^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/,oa=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,Za=/^[\],:{}\s]*$/,Ga=/(?:^|:|,)(?:\s*\[)+/g,hb=/\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g,la=/"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g,Sa=/^-ms-/,P=/-([\da-z])/gi,Ha=
function(a,b){return b.toUpperCase()},ba=function(a){(F.addEventListener||"load"===a.type||"complete"===F.readyState)&&(Ia(),l.ready())},Ia=function(){F.addEventListener?(F.removeEventListener("DOMContentLoaded",ba,!1),a.removeEventListener("load",ba,!1)):(F.detachEvent("onreadystatechange",ba),a.detachEvent("onload",ba))};l.fn=l.prototype={jquery:"1.9.1",constructor:l,init:function(a,b,d){var e,f;if(!a)return this;if("string"==typeof a){if(e="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&3<=a.length?
[null,a,null]:Fa.exec(a),!e||!e[1]&&b)return!b||b.jquery?(b||d).find(a):this.constructor(b).find(a);if(e[1]){if(b=b instanceof l?b[0]:b,l.merge(this,l.parseHTML(e[1],b&&b.nodeType?b.ownerDocument||b:F,!0)),oa.test(e[1])&&l.isPlainObject(b))for(e in b)l.isFunction(this[e])?this[e](b[e]):this.attr(e,b[e]);return this}if(f=F.getElementById(e[2]),f&&f.parentNode){if(f.id!==e[2])return d.find(a);this.length=1;this[0]=f}return this.context=F,this.selector=a,this}return a.nodeType?(this.context=this[0]=
a,this.length=1,this):l.isFunction(a)?d.ready(a):(a.selector!==c&&(this.selector=a.selector,this.context=a.context),l.makeArray(a,this))},selector:"",length:0,size:function(){return this.length},toArray:function(){return ha.call(this)},get:function(a){return null==a?this.toArray():0>a?this[this.length+a]:this[a]},pushStack:function(a){a=l.merge(this.constructor(),a);return a.prevObject=this,a.context=this.context,a},each:function(a,b){return l.each(this,a,b)},ready:function(a){return l.ready.promise().done(a),
this},slice:function(){return this.pushStack(ha.apply(this,arguments))},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},eq:function(a){var b=this.length;a=+a+(0>a?b:0);return this.pushStack(0<=a&&b>a?[this[a]]:[])},map:function(a){return this.pushStack(l.map(this,function(b,c){return a.call(b,c,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:U,sort:[].sort,splice:[].splice};l.fn.init.prototype=l.fn;l.extend=l.fn.extend=function(){var a,b,d,e,f,h,
k=arguments[0]||{},g=1,n=arguments.length,m=!1;"boolean"==typeof k&&(m=k,k=arguments[1]||{},g=2);"object"==typeof k||l.isFunction(k)||(k={});for(n===g&&(k=this,--g);n>g;g++)if(null!=(f=arguments[g]))for(e in f)a=k[e],d=f[e],k!==d&&(m&&d&&(l.isPlainObject(d)||(b=l.isArray(d)))?(b?(b=!1,h=a&&l.isArray(a)?a:[]):h=a&&l.isPlainObject(a)?a:{},k[e]=l.extend(m,h,d)):d!==c&&(k[e]=d));return k};l.extend({noConflict:function(b){return a.$===l&&(a.$=ea),b&&a.jQuery===l&&(a.jQuery=da),l},isReady:!1,readyWait:1,
holdReady:function(a){a?l.readyWait++:l.ready(!0)},ready:function(a){if(!0===a?!--l.readyWait:!l.isReady){if(!F.body)return setTimeout(l.ready);l.isReady=!0;!0!==a&&0<--l.readyWait||(A.resolveWith(F,[l]),l.fn.trigger&&l(F).trigger("ready").off("ready"))}},isFunction:function(a){return"function"===l.type(a)},isArray:Array.isArray||function(a){return"array"===l.type(a)},isWindow:function(a){return null!=a&&a==a.window},isNumeric:function(a){return!isNaN(parseFloat(a))&&isFinite(a)},type:function(a){return null==
a?a+"":"object"==typeof a||"function"==typeof a?ga[ya.call(a)]||"object":typeof a},isPlainObject:function(a){if(!a||"object"!==l.type(a)||a.nodeType||l.isWindow(a))return!1;try{if(a.constructor&&!ia.call(a,"constructor")&&!ia.call(a.constructor.prototype,"isPrototypeOf"))return!1}catch(b){return!1}for(var d in a);return d===c||ia.call(a,d)},isEmptyObject:function(a){for(var b in a)return!1;return!0},error:function(a){throw Error(a);},parseHTML:function(a,b,c){if(!a||"string"!=typeof a)return null;
"boolean"==typeof b&&(c=b,b=!1);b=b||F;var d=oa.exec(a);c=!c&&[];return d?[b.createElement(d[1])]:(d=l.buildFragment([a],b,c),c&&l(c).remove(),l.merge([],d.childNodes))},parseJSON:function(b){return a.JSON&&a.JSON.parse?a.JSON.parse(b):null===b?b:"string"==typeof b&&(b=l.trim(b),b&&Za.test(b.replace(hb,"@").replace(la,"]").replace(Ga,"")))?Function("return "+b)():(l.error("Invalid JSON: "+b),c)},parseXML:function(b){var d,e;if(!b||"string"!=typeof b)return null;try{a.DOMParser?(e=new DOMParser,d=
e.parseFromString(b,"text/xml")):(d=new ActiveXObject("Microsoft.XMLDOM"),d.async="false",d.loadXML(b))}catch(f){d=c}return d&&d.documentElement&&!d.getElementsByTagName("parsererror").length||l.error("Invalid XML: "+b),d},noop:function(){},globalEval:function(b){b&&l.trim(b)&&(a.execScript||function(b){a.eval.call(a,b)})(b)},camelCase:function(a){return a.replace(Sa,"ms-").replace(P,Ha)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toLowerCase()===b.toLowerCase()},each:function(a,c,d){var e,
l=0,f=a.length,h=b(a);if(d)if(h)for(;f>l&&(e=c.apply(a[l],d),!1!==e);l++);else for(l in a){if(e=c.apply(a[l],d),!1===e)break}else if(h)for(;f>l&&(e=c.call(a[l],l,a[l]),!1!==e);l++);else for(l in a)if(e=c.call(a[l],l,a[l]),!1===e)break;return a},trim:ja&&!ja.call("\ufeff\u00a0")?function(a){return null==a?"":ja.call(a)}:function(a){return null==a?"":(a+"").replace(za,"")},makeArray:function(a,c){var d=c||[];return null!=a&&(b(Object(a))?l.merge(d,"string"==typeof a?[a]:a):U.call(d,a)),d},inArray:function(a,
b,c){var d;if(b){if(sa)return sa.call(b,a,c);d=b.length;for(c=c?0>c?Math.max(0,d+c):c:0;d>c;c++)if(c in b&&b[c]===a)return c}return-1},merge:function(a,b){var d=b.length,e=a.length,l=0;if("number"==typeof d)for(;d>l;l++)a[e++]=b[l];else for(;b[l]!==c;)a[e++]=b[l++];return a.length=e,a},grep:function(a,b,c){var d,e=[],l=0,f=a.length;for(c=!!c;f>l;l++)d=!!b(a[l],l),c!==d&&e.push(a[l]);return e},map:function(a,c,d){var e,l=0,f=a.length,h=[];if(b(a))for(;f>l;l++)e=c(a[l],l,d),null!=e&&(h[h.length]=e);
else for(l in a)e=c(a[l],l,d),null!=e&&(h[h.length]=e);return X.apply([],h)},guid:1,proxy:function(a,b){var d,e,f;return"string"==typeof b&&(f=a[b],b=a,a=f),l.isFunction(a)?(d=ha.call(arguments,2),e=function(){return a.apply(b||this,d.concat(ha.call(arguments)))},e.guid=a.guid=a.guid||l.guid++,e):c},access:function(a,b,d,e,f,h,k){var g=0,n=a.length,m=null==d;if("object"===l.type(d))for(g in f=!0,d)l.access(a,b,g,d[g],!0,h,k);else if(e!==c&&(f=!0,l.isFunction(e)||(k=!0),m&&(k?(b.call(a,e),b=null):
(m=b,b=function(a,b,c){return m.call(l(a),c)})),b))for(;n>g;g++)b(a[g],d,k?e:e.call(a[g],g,b(a[g],d)));return f?a:m?b.call(a):n?b(a[0],d):h},now:function(){return(new Date).getTime()}});l.ready.promise=function(b){if(!A)if(A=l.Deferred(),"complete"===F.readyState)setTimeout(l.ready);else if(F.addEventListener)F.addEventListener("DOMContentLoaded",ba,!1),a.addEventListener("load",ba,!1);else{F.attachEvent("onreadystatechange",ba);a.attachEvent("onload",ba);var c=!1;try{c=null==a.frameElement&&F.documentElement}catch(d){}c&&
c.doScroll&&function Ib(){if(!l.isReady){try{c.doScroll("left")}catch(a){return setTimeout(Ib,50)}Ia();l.ready()}}()}return A.promise(b)};l.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(a,b){ga["[object "+b+"]"]=b.toLowerCase()});x=l(F);var Pa={};l.Callbacks=function(a){a="string"==typeof a?Pa[a]||d(a):l.extend({},a);var b,e,f,h,k,g,n=[],m=!a.once&&[],t=function(c){e=a.memory&&c;f=!0;k=g||0;g=0;h=n.length;for(b=!0;n&&h>k;k++)if(!1===n[k].apply(c[0],c[1])&&
a.stopOnFalse){e=!1;break}b=!1;n&&(m?m.length&&t(m.shift()):e?n=[]:v.disable())},v={add:function(){if(n){var c=n.length;(function Mb(b){l.each(b,function(b,c){var d=l.type(c);"function"===d?a.unique&&v.has(c)||n.push(c):c&&c.length&&"string"!==d&&Mb(c)})})(arguments);b?h=n.length:e&&(g=c,t(e))}return this},remove:function(){return n&&l.each(arguments,function(a,c){for(var d;-1<(d=l.inArray(c,n,d));)n.splice(d,1),b&&(h>=d&&h--,k>=d&&k--)}),this},has:function(a){return a?-1<l.inArray(a,n):!(!n||!n.length)},
empty:function(){return n=[],this},disable:function(){return n=m=e=c,this},disabled:function(){return!n},lock:function(){return m=c,e||v.disable(),this},locked:function(){return!m},fireWith:function(a,c){return c=c||[],c=[a,c.slice?c.slice():c],!n||f&&!m||(b?m.push(c):t(c)),this},fire:function(){return v.fireWith(this,arguments),this},fired:function(){return!!f}};return v};l.extend({Deferred:function(a){var b=[["resolve","done",l.Callbacks("once memory"),"resolved"],["reject","fail",l.Callbacks("once memory"),
"rejected"],["notify","progress",l.Callbacks("memory")]],c="pending",d={state:function(){return c},always:function(){return e.done(arguments).fail(arguments),this},then:function(){var a=arguments;return l.Deferred(function(c){l.each(b,function(b,N){var f=N[0],h=l.isFunction(a[b])&&a[b];e[N[1]](function(){var a=h&&h.apply(this,arguments);a&&l.isFunction(a.promise)?a.promise().done(c.resolve).fail(c.reject).progress(c.notify):c[f+"With"](this===d?c.promise():this,h?[a]:arguments)})});a=null}).promise()},
promise:function(a){return null!=a?l.extend(a,d):d}},e={};return d.pipe=d.then,l.each(b,function(a,N){var l=N[2],f=N[3];d[N[1]]=l.add;f&&l.add(function(){c=f},b[1^a][2].disable,b[2][2].lock);e[N[0]]=function(){return e[N[0]+"With"](this===e?d:this,arguments),this};e[N[0]+"With"]=l.fireWith}),d.promise(e),a&&a.call(e,e),e},when:function(a){var b=0,c=ha.call(arguments),d=c.length,e=1!==d||a&&l.isFunction(a.promise)?d:0,f=1===e?a:l.Deferred(),h=function(a,b,c){return function(d){b[a]=this;c[a]=1<arguments.length?
ha.call(arguments):d;c===k?f.notifyWith(b,c):--e||f.resolveWith(b,c)}},k,g,n;if(1<d)for(k=Array(d),g=Array(d),n=Array(d);d>b;b++)c[b]&&l.isFunction(c[b].promise)?c[b].promise().done(h(b,n,c)).fail(f.reject).progress(h(b,g,k)):--e;return e||f.resolveWith(n,c),f.promise()}});l.support=function(){var b,c,d,e,f,h,k,g=F.createElement("div");if(g.setAttribute("className","t"),g.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",c=g.getElementsByTagName("*"),d=g.getElementsByTagName("a")[0],
...
c.setAttribute("value","");b.input=""===c.getAttribute("value");c.value="t";c.setAttribute("type","radio");b.radioValue="t"===c.value;c.setAttribute("checked","t");c.setAttribute("name","t");d=F.createDocumentFragment();d.appendChild(c);b.appendChecked=c.checked;b.checkClone=d.cloneNode(!0).cloneNode(!0).lastChild.checked;g.attachEvent&&(g.attachEvent("onclick",function(){b.noCloneEvent=!1}),g.cloneNode(!0).click());for(k in{submit:!0,change:!0,focusin:!0})g.setAttribute(d="on"+k,"t"),b[k+"Bubbles"]=
d in a||!1===g.attributes[d].expando;return g.style.backgroundClip="content-box",g.cloneNode(!0).style.backgroundClip="",b.clearCloneStyle="content-box"===g.style.backgroundClip,l(function(){var c,d,e,l=F.getElementsByTagName("body")[0];l&&(c=F.createElement("div"),c.style.cssText="border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px",l.appendChild(c).appendChild(g),g.innerHTML="<table><tr><td></td><td>t</td></tr></table>",e=g.getElementsByTagName("td"),e[0].style.cssText=
"padding:0;margin:0;border:0;display:none",h=0===e[0].offsetHeight,e[0].style.display="",e[1].style.display="none",b.reliableHiddenOffsets=h&&0===e[0].offsetHeight,g.innerHTML="",g.style.cssText="box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;",b.boxSizing=4===g.offsetWidth,b.doesNotIncludeMarginInBodyOffset=1!==l.offsetTop,a.getComputedStyle&&(b.pixelPosition="1%"!==(a.getComputedStyle(g,
...
b.inlineBlockNeedsLayout=3===g.offsetWidth,g.style.display="block",g.innerHTML="<div></div>",g.firstChild.style.width="5px",b.shrinkWrapBlocks=3!==g.offsetWidth,b.inlineBlockNeedsLayout&&(l.style.zoom=1)),l.removeChild(c),g=null)}),c=e=d=f=d=c=null,b}();var ua=/(?:\{[\s\S]*\}|\[[\s\S]*\])$/,Ua=/([A-Z])/g;l.extend({cache:{},expando:"jQuery"+("1.9.1"+Math.random()).replace(/\D/g,""),noData:{embed:!0,object:"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000",applet:!0},hasData:function(a){return a=a.nodeType?
l.cache[a[l.expando]]:a[l.expando],!!a&&!g(a)},data:function(a,b,c){return e(a,b,c)},removeData:function(a,b){return k(a,b)},_data:function(a,b,c){return e(a,b,c,!0)},_removeData:function(a,b){return k(a,b,!0)},acceptData:function(a){if(a.nodeType&&1!==a.nodeType&&9!==a.nodeType)return!1;var b=a.nodeName&&l.noData[a.nodeName.toLowerCase()];return!b||!0!==b&&a.getAttribute("classid")===b}});l.fn.extend({data:function(a,b){var d,e,f=this[0],g=0,k=null;if(a===c){if(this.length&&(k=l.data(f),1===f.nodeType&&
!l._data(f,"parsedAttrs"))){for(d=f.attributes;d.length>g;g++)e=d[g].name,e.indexOf("data-")||(e=l.camelCase(e.slice(5)),h(f,e,k[e]));l._data(f,"parsedAttrs",!0)}return k}return"object"==typeof a?this.each(function(){l.data(this,a)}):l.access(this,function(b){return b===c?f?h(f,a,l.data(f,a)):null:(this.each(function(){l.data(this,a,b)}),c)},null,b,1<arguments.length,null,!0)},removeData:function(a){return this.each(function(){l.removeData(this,a)})}});l.extend({queue:function(a,b,d){var e;return a?
(b=(b||"fx")+"queue",e=l._data(a,b),d&&(!e||l.isArray(d)?e=l._data(a,b,l.makeArray(d)):e.push(d)),e||[]):c},dequeue:function(a,b){b=b||"fx";var c=l.queue(a,b),d=c.length,e=c.shift(),f=l._queueHooks(a,b),h=function(){l.dequeue(a,b)};"inprogress"===e&&(e=c.shift(),d--);(f.cur=e)&&("fx"===b&&c.unshift("inprogress"),delete f.stop,e.call(a,h,f));!d&&f&&f.empty.fire()},_queueHooks:function(a,b){var c=b+"queueHooks";return l._data(a,c)||l._data(a,c,{empty:l.Callbacks("once memory").add(function(){l._removeData(a,
b+"queue");l._removeData(a,c)})})}});l.fn.extend({queue:function(a,b){var d=2;return"string"!=typeof a&&(b=a,a="fx",d--),d>arguments.length?l.queue(this[0],a):b===c?this:this.each(function(){var c=l.queue(this,a,b);l._queueHooks(this,a);"fx"===a&&"inprogress"!==c[0]&&l.dequeue(this,a)})},dequeue:function(a){return this.each(function(){l.dequeue(this,a)})},delay:function(a,b){return a=l.fx?l.fx.speeds[a]||a:a,b=b||"fx",this.queue(b,function(b,c){var d=setTimeout(b,a);c.stop=function(){clearTimeout(d)}})},
clearQueue:function(a){return this.queue(a||"fx",[])},promise:function(a,b){var d,e=1,f=l.Deferred(),h=this,g=this.length,k=function(){--e||f.resolveWith(h,[h])};"string"!=typeof a&&(b=a,a=c);for(a=a||"fx";g--;)(d=l._data(h[g],a+"queueHooks"))&&d.empty&&(e++,d.empty.add(k));return k(),f.promise(b)}});var pa,ma,Ja=/[\t\r\n]/g,$a=/\r/g,ab=/^(?:input|select|textarea|button|object)$/i,bb=/^(?:a|area)$/i,Ka=/^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i,
Aa=/^(?:checked|selected)$/i,ka=l.support.getSetAttribute,qa=l.support.input;l.fn.extend({attr:function(a,b){return l.access(this,l.attr,a,b,1<arguments.length)},removeAttr:function(a){return this.each(function(){l.removeAttr(this,a)})},prop:function(a,b){return l.access(this,l.prop,a,b,1<arguments.length)},removeProp:function(a){return a=l.propFix[a]||a,this.each(function(){try{this[a]=c,delete this[a]}catch(b){}})},addClass:function(a){var b,c,d,e,f,h=0,g=this.length;b="string"==typeof a&&a;if(l.isFunction(a))return this.each(function(b){l(this).addClass(a.call(this,
b,this.className))});if(b)for(b=(a||"").match(Z)||[];g>h;h++)if(c=this[h],d=1===c.nodeType&&(c.className?(" "+c.className+" ").replace(Ja," "):" ")){for(f=0;e=b[f++];)0>d.indexOf(" "+e+" ")&&(d+=e+" ");c.className=l.trim(d)}return this},removeClass:function(a){var b,c,d,e,f,h=0,g=this.length;b=0===arguments.length||"string"==typeof a&&a;if(l.isFunction(a))return this.each(function(b){l(this).removeClass(a.call(this,b,this.className))});if(b)for(b=(a||"").match(Z)||[];g>h;h++)if(c=this[h],d=1===c.nodeType&&
(c.className?(" "+c.className+" ").replace(Ja," "):"")){for(f=0;e=b[f++];)for(;0<=d.indexOf(" "+e+" ");)d=d.replace(" "+e+" "," ");c.className=a?l.trim(d):""}return this},toggleClass:function(a,b){var c=typeof a,d="boolean"==typeof b;return l.isFunction(a)?this.each(function(c){l(this).toggleClass(a.call(this,c,this.className,b),b)}):this.each(function(){if("string"===c)for(var e,f=0,h=l(this),g=b,k=a.match(Z)||[];e=k[f++];)g=d?g:!h.hasClass(e),h[g?"addClass":"removeClass"](e);else(c===Q||"boolean"===
c)&&(this.className&&l._data(this,"__className__",this.className),this.className=this.className||!1===a?"":l._data(this,"__className__")||"")})},hasClass:function(a){a=" "+a+" ";for(var b=0,c=this.length;c>b;b++)if(1===this[b].nodeType&&0<=(" "+this[b].className+" ").replace(Ja," ").indexOf(a))return!0;return!1},val:function(a){var b,d,e,f=this[0];if(arguments.length)return e=l.isFunction(a),this.each(function(b){var f,h=l(this);1===this.nodeType&&(f=e?a.call(this,b,h.val()):a,null==f?f="":"number"==
typeof f?f+="":l.isArray(f)&&(f=l.map(f,function(a){return null==a?"":a+""})),d=l.valHooks[this.type]||l.valHooks[this.nodeName.toLowerCase()],d&&"set"in d&&d.set(this,f,"value")!==c||(this.value=f))});if(f)return d=l.valHooks[f.type]||l.valHooks[f.nodeName.toLowerCase()],d&&"get"in d&&(b=d.get(f,"value"))!==c?b:(b=f.value,"string"==typeof b?b.replace($a,""):null==b?"":b)}});l.extend({valHooks:{option:{get:function(a){var b=a.attributes.value;return!b||b.specified?a.value:a.text}},select:{get:function(a){for(var b,
c=a.options,d=a.selectedIndex,e="select-one"===a.type||0>d,f=e?null:[],h=e?d+1:c.length,g=0>d?h:e?d:0;h>g;g++)if(b=c[g],!(!b.selected&&g!==d||(l.support.optDisabled?b.disabled:null!==b.getAttribute("disabled"))||b.parentNode.disabled&&l.nodeName(b.parentNode,"optgroup"))){if(a=l(b).val(),e)return a;f.push(a)}return f},set:function(a,b){var c=l.makeArray(b);return l(a).find("option").each(function(){this.selected=0<=l.inArray(l(this).val(),c)}),c.length||(a.selectedIndex=-1),c}}},attr:function(a,b,
d){var e,f,h,g=a.nodeType;if(a&&3!==g&&8!==g&&2!==g)return typeof a.getAttribute===Q?l.prop(a,b,d):(f=1!==g||!l.isXMLDoc(a),f&&(b=b.toLowerCase(),e=l.attrHooks[b]||(Ka.test(b)?ma:pa)),d===c?e&&f&&"get"in e&&null!==(h=e.get(a,b))?h:(typeof a.getAttribute!==Q&&(h=a.getAttribute(b)),null==h?c:h):null!==d?e&&f&&"set"in e&&(h=e.set(a,d,b))!==c?h:(a.setAttribute(b,d+""),d):(l.removeAttr(a,b),c))},removeAttr:function(a,b){var c,d,e=0,f=b&&b.match(Z);if(f&&1===a.nodeType)for(;c=f[e++];)d=l.propFix[c]||c,
Ka.test(c)?!ka&&Aa.test(c)?a[l.camelCase("default-"+c)]=a[d]=!1:a[d]=!1:l.attr(a,c,""),a.removeAttribute(ka?c:d)},attrHooks:{type:{set:function(a,b){if(!l.support.radioValue&&"radio"===b&&l.nodeName(a,"input")){var c=a.value;return a.setAttribute("type",b),c&&(a.value=c),b}}}},propFix:{tabindex:"tabIndex",readonly:"readOnly","for":"htmlFor","class":"className",maxlength:"maxLength",cellspacing:"cellSpacing",cellpadding:"cellPadding",rowspan:"rowSpan",colspan:"colSpan",usemap:"useMap",frameborder:"frameBorder",
contenteditable:"contentEditable"},prop:function(a,b,d){var e,f,h,g=a.nodeType;if(a&&3!==g&&8!==g&&2!==g)return h=1!==g||!l.isXMLDoc(a),h&&(b=l.propFix[b]||b,f=l.propHooks[b]),d!==c?f&&"set"in f&&(e=f.set(a,d,b))!==c?e:a[b]=d:f&&"get"in f&&null!==(e=f.get(a,b))?e:a[b]},propHooks:{tabIndex:{get:function(a){var b=a.getAttributeNode("tabindex");return b&&b.specified?parseInt(b.value,10):ab.test(a.nodeName)||bb.test(a.nodeName)&&a.href?0:c}}}});ma={get:function(a,b){var d=l.prop(a,b),e="boolean"==typeof d&&
a.getAttribute(b);return(d="boolean"==typeof d?qa&&ka?null!=e:Aa.test(b)?a[l.camelCase("default-"+b)]:!!e:a.getAttributeNode(b))&&!1!==d.value?b.toLowerCase():c},set:function(a,b,c){return!1===b?l.removeAttr(a,c):qa&&ka||!Aa.test(c)?a.setAttribute(!ka&&l.propFix[c]||c,c):a[l.camelCase("default-"+c)]=a[c]=!0,c}};qa&&ka||(l.attrHooks.value={get:function(a,b){var d=a.getAttributeNode(b);return l.nodeName(a,"input")?a.defaultValue:d&&d.specified?d.value:c},set:function(a,b,d){return l.nodeName(a,"input")?
(a.defaultValue=b,c):pa&&pa.set(a,b,d)}});ka||(pa=l.valHooks.button={get:function(a,b){var d=a.getAttributeNode(b);return d&&("id"===b||"name"===b||"coords"===b?""!==d.value:d.specified)?d.value:c},set:function(a,b,d){var e=a.getAttributeNode(d);return e||a.setAttributeNode(e=a.ownerDocument.createAttribute(d)),e.value=b+="","value"===d||b===a.getAttribute(d)?b:c}},l.attrHooks.contenteditable={get:pa.get,set:function(a,b,c){pa.set(a,""===b?!1:b,c)}},l.each(["width","height"],function(a,b){l.attrHooks[b]=
l.extend(l.attrHooks[b],{set:function(a,d){return""===d?(a.setAttribute(b,"auto"),d):c}})}));l.support.hrefNormalized||(l.each(["href","src","width","height"],function(a,b){l.attrHooks[b]=l.extend(l.attrHooks[b],{get:function(a){a=a.getAttribute(b,2);return null==a?c:a}})}),l.each(["href","src"],function(a,b){l.propHooks[b]={get:function(a){return a.getAttribute(b,4)}}}));l.support.style||(l.attrHooks.style={get:function(a){return a.style.cssText||c},set:function(a,b){return a.style.cssText=b+""}});
l.support.optSelected||(l.propHooks.selected=l.extend(l.propHooks.selected,{get:function(a){a=a.parentNode;return a&&(a.selectedIndex,a.parentNode&&a.parentNode.selectedIndex),null}}));l.support.enctype||(l.propFix.enctype="encoding");l.support.checkOn||l.each(["radio","checkbox"],function(){l.valHooks[this]={get:function(a){return null===a.getAttribute("value")?"on":a.value}}});l.each(["radio","checkbox"],function(){l.valHooks[this]=l.extend(l.valHooks[this],{set:function(a,b){return l.isArray(b)?
a.checked=0<=l.inArray(l(a).val(),b):c}})});var Ba=/^(?:input|select|textarea)$/i,La=/^key/,ra=/^(?:mouse|contextmenu)|click/,Ma=/^(?:focusinfocus|focusoutblur)$/,Ca=/^([^.]*)(?:\.(.+)|)$/;l.event={global:{},add:function(a,b,d,e,f){var h,g,k,n,m,t,v,r,w;if(k=l._data(a)){d.handler&&(n=d,d=n.handler,f=n.selector);d.guid||(d.guid=l.guid++);(g=k.events)||(g=k.events={});(m=k.handle)||(m=k.handle=function(a){return typeof l===Q||a&&l.event.triggered===a.type?c:l.event.dispatch.apply(m.elem,arguments)},
m.elem=a);b=(b||"").match(Z)||[""];for(k=b.length;k--;)h=Ca.exec(b[k])||[],r=t=h[1],w=(h[2]||"").split(".").sort(),h=l.event.special[r]||{},r=(f?h.delegateType:h.bindType)||r,h=l.event.special[r]||{},t=l.extend({type:r,origType:t,data:e,handler:d,guid:d.guid,selector:f,needsContext:f&&l.expr.match.needsContext.test(f),namespace:w.join(".")},n),(v=g[r])||(v=g[r]=[],v.delegateCount=0,h.setup&&!1!==h.setup.call(a,e,w,m)||(a.addEventListener?a.addEventListener(r,m,!1):a.attachEvent&&a.attachEvent("on"+
r,m))),h.add&&(h.add.call(a,t),t.handler.guid||(t.handler.guid=d.guid)),f?v.splice(v.delegateCount++,0,t):v.push(t),l.event.global[r]=!0;a=null}},remove:function(a,b,c,d,e){var f,h,g,k,n,m,t,v,r,w,L,p=l.hasData(a)&&l._data(a);if(p&&(m=p.events)){b=(b||"").match(Z)||[""];for(n=b.length;n--;)if(g=Ca.exec(b[n])||[],r=L=g[1],w=(g[2]||"").split(".").sort(),r){t=l.event.special[r]||{};r=(d?t.delegateType:t.bindType)||r;v=m[r]||[];g=g[2]&&RegExp("(^|\\.)"+w.join("\\.(?:.*\\.|)")+"(\\.|$)");for(k=f=v.length;f--;)h=
v[f],!e&&L!==h.origType||c&&c.guid!==h.guid||g&&!g.test(h.namespace)||d&&d!==h.selector&&("**"!==d||!h.selector)||(v.splice(f,1),h.selector&&v.delegateCount--,t.remove&&t.remove.call(a,h));k&&!v.length&&(t.teardown&&!1!==t.teardown.call(a,w,p.handle)||l.removeEvent(a,r,p.handle),delete m[r])}else for(r in m)l.event.remove(a,r+b[n],c,d,!0);l.isEmptyObject(m)&&(delete p.handle,l._removeData(a,"events"))}},trigger:function(b,d,e,f){var h,g,k,n,m,t,v=[e||F],r=ia.call(b,"type")?b.type:b;t=ia.call(b,"namespace")?
b.namespace.split("."):[];if(k=h=e=e||F,3!==e.nodeType&&8!==e.nodeType&&!Ma.test(r+l.event.triggered)&&(0<=r.indexOf(".")&&(t=r.split("."),r=t.shift(),t.sort()),g=0>r.indexOf(":")&&"on"+r,b=b[l.expando]?b:new l.Event(r,"object"==typeof b&&b),b.isTrigger=!0,b.namespace=t.join("."),b.namespace_re=b.namespace?RegExp("(^|\\.)"+t.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,b.result=c,b.target||(b.target=e),d=null==d?[b]:l.makeArray(d,[b]),m=l.event.special[r]||{},f||!m.trigger||!1!==m.trigger.apply(e,d))){if(!f&&
!m.noBubble&&!l.isWindow(e)){n=m.delegateType||r;for(Ma.test(n+r)||(k=k.parentNode);k;k=k.parentNode)v.push(k),h=k;h===(e.ownerDocument||F)&&v.push(h.defaultView||h.parentWindow||a)}for(t=0;(k=v[t++])&&!b.isPropagationStopped();)b.type=1<t?n:m.bindType||r,(h=(l._data(k,"events")||{})[b.type]&&l._data(k,"handle"))&&h.apply(k,d),(h=g&&k[g])&&l.acceptData(k)&&h.apply&&!1===h.apply(k,d)&&b.preventDefault();if(b.type=r,!(f||b.isDefaultPrevented()||m._default&&!1!==m._default.apply(e.ownerDocument,d)||
"click"===r&&l.nodeName(e,"a")||!l.acceptData(e)||!g||!e[r]||l.isWindow(e))){(h=e[g])&&(e[g]=null);l.event.triggered=r;try{e[r]()}catch(w){}l.event.triggered=c;h&&(e[g]=h)}return b.result}},dispatch:function(a){a=l.event.fix(a);var b,d,e,f,h,g=[],k=ha.call(arguments);b=(l._data(this,"events")||{})[a.type]||[];var n=l.event.special[a.type]||{};if(k[0]=a,a.delegateTarget=this,!n.preDispatch||!1!==n.preDispatch.call(this,a)){g=l.event.handlers.call(this,a,b);for(b=0;(f=g[b++])&&!a.isPropagationStopped();)for(a.currentTarget=
f.elem,h=0;(e=f.handlers[h++])&&!a.isImmediatePropagationStopped();)a.namespace_re&&!a.namespace_re.test(e.namespace)||(a.handleObj=e,a.data=e.data,d=((l.event.special[e.origType]||{}).handle||e.handler).apply(f.elem,k),d===c||!1!==(a.result=d)||(a.preventDefault(),a.stopPropagation()));return n.postDispatch&&n.postDispatch.call(this,a),a.result}},handlers:function(a,b){var d,e,f,h,g=[],k=b.delegateCount,n=a.target;if(k&&n.nodeType&&(!a.button||"click"!==a.type))for(;n!=this;n=n.parentNode||this)if(1===
n.nodeType&&(!0!==n.disabled||"click"!==a.type)){f=[];for(h=0;k>h;h++)e=b[h],d=e.selector+" ",f[d]===c&&(f[d]=e.needsContext?0<=l(d,this).index(n):l.find(d,this,null,[n]).length),f[d]&&f.push(e);f.length&&g.push({elem:n,handlers:f})}return b.length>k&&g.push({elem:this,handlers:b.slice(k)}),g},fix:function(a){if(a[l.expando])return a;var b,c,d;b=a.type;var e=a,f=this.fixHooks[b];f||(this.fixHooks[b]=f=ra.test(b)?this.mouseHooks:La.test(b)?this.keyHooks:{});d=f.props?this.props.concat(f.props):this.props;
a=new l.Event(e);for(b=d.length;b--;)c=d[b],a[c]=e[c];return a.target||(a.target=e.srcElement||F),3===a.target.nodeType&&(a.target=a.target.parentNode),a.metaKey=!!a.metaKey,f.filter?f.filter(a,e):a},props:"altKey bubbles cancelable ctrlKey currentTarget eventPhase metaKey relatedTarget shiftKey target timeStamp view which".split(" "),fixHooks:{},keyHooks:{props:["char","charCode","key","keyCode"],filter:function(a,b){return null==a.which&&(a.which=null!=b.charCode?b.charCode:b.keyCode),a}},mouseHooks:{props:"button buttons clientX clientY fromElement offsetX offsetY pageX pageY screenX screenY toElement".split(" "),
filter:function(a,b){var d,e,f,h=b.button,l=b.fromElement;return null==a.pageX&&null!=b.clientX&&(e=a.target.ownerDocument||F,f=e.documentElement,d=e.body,a.pageX=b.clientX+(f&&f.scrollLeft||d&&d.scrollLeft||0)-(f&&f.clientLeft||d&&d.clientLeft||0),a.pageY=b.clientY+(f&&f.scrollTop||d&&d.scrollTop||0)-(f&&f.clientTop||d&&d.clientTop||0)),!a.relatedTarget&&l&&(a.relatedTarget=l===a.target?b.toElement:l),a.which||h===c||(a.which=1&h?1:2&h?3:4&h?2:0),a}},special:{load:{noBubble:!0},click:{trigger:function(){return l.nodeName(this,
"input")&&"checkbox"===this.type&&this.click?(this.click(),!1):c}},focus:{trigger:function(){if(this!==F.activeElement&&this.focus)try{return this.focus(),!1}catch(a){}},delegateType:"focusin"},blur:{trigger:function(){return this===F.activeElement&&this.blur?(this.blur(),!1):c},delegateType:"focusout"},beforeunload:{postDispatch:function(a){a.result!==c&&(a.originalEvent.returnValue=a.result)}}},simulate:function(a,b,c,d){a=l.extend(new l.Event,c,{type:a,isSimulated:!0,originalEvent:{}});d?l.event.trigger(a,
null,b):l.event.dispatch.call(b,a);a.isDefaultPrevented()&&c.preventDefault()}};l.removeEvent=F.removeEventListener?function(a,b,c){a.removeEventListener&&a.removeEventListener(b,c,!1)}:function(a,b,c){b="on"+b;a.detachEvent&&(typeof a[b]===Q&&(a[b]=null),a.detachEvent(b,c))};l.Event=function(a,b){return this instanceof l.Event?(a&&a.type?(this.originalEvent=a,this.type=a.type,this.isDefaultPrevented=a.defaultPrevented||!1===a.returnValue||a.getPreventDefault&&a.getPreventDefault()?f:m):this.type=
a,b&&l.extend(this,b),this.timeStamp=a&&a.timeStamp||l.now(),this[l.expando]=!0,c):new l.Event(a,b)};l.Event.prototype={isDefaultPrevented:m,isPropagationStopped:m,isImmediatePropagationStopped:m,preventDefault:function(){var a=this.originalEvent;this.isDefaultPrevented=f;a&&(a.preventDefault?a.preventDefault():a.returnValue=!1)},stopPropagation:function(){var a=this.originalEvent;this.isPropagationStopped=f;a&&(a.stopPropagation&&a.stopPropagation(),a.cancelBubble=!0)},stopImmediatePropagation:function(){this.isImmediatePropagationStopped=
f;this.stopPropagation()}};l.each({mouseenter:"mouseover",mouseleave:"mouseout"},function(a,b){l.event.special[a]={delegateType:b,bindType:b,handle:function(a){var c,d=a.relatedTarget,e=a.handleObj;return(!d||d!==this&&!l.contains(this,d))&&(a.type=e.origType,c=e.handler.apply(this,arguments),a.type=b),c}}});l.support.submitBubbles||(l.event.special.submit={setup:function(){return l.nodeName(this,"form")?!1:(l.event.add(this,"click._submit keypress._submit",function(a){a=a.target;(a=l.nodeName(a,
"input")||l.nodeName(a,"button")?a.form:c)&&!l._data(a,"submitBubbles")&&(l.event.add(a,"submit._submit",function(a){a._submit_bubble=!0}),l._data(a,"submitBubbles",!0))}),c)},postDispatch:function(a){a._submit_bubble&&(delete a._submit_bubble,this.parentNode&&!a.isTrigger&&l.event.simulate("submit",this.parentNode,a,!0))},teardown:function(){return l.nodeName(this,"form")?!1:(l.event.remove(this,"._submit"),c)}});l.support.changeBubbles||(l.event.special.change={setup:function(){return Ba.test(this.nodeName)?
(("checkbox"===this.type||"radio"===this.type)&&(l.event.add(this,"propertychange._change",function(a){"checked"===a.originalEvent.propertyName&&(this._just_changed=!0)}),l.event.add(this,"click._change",function(a){this._just_changed&&!a.isTrigger&&(this._just_changed=!1);l.event.simulate("change",this,a,!0)})),!1):(l.event.add(this,"beforeactivate._change",function(a){a=a.target;Ba.test(a.nodeName)&&!l._data(a,"changeBubbles")&&(l.event.add(a,"change._change",function(a){!this.parentNode||a.isSimulated||
a.isTrigger||l.event.simulate("change",this.parentNode,a,!0)}),l._data(a,"changeBubbles",!0))}),c)},handle:function(a){var b=a.target;return this!==b||a.isSimulated||a.isTrigger||"radio"!==b.type&&"checkbox"!==b.type?a.handleObj.handler.apply(this,arguments):c},teardown:function(){return l.event.remove(this,"._change"),!Ba.test(this.nodeName)}});l.support.focusinBubbles||l.each({focus:"focusin",blur:"focusout"},function(a,b){var c=0,d=function(a){l.event.simulate(b,a.target,l.event.fix(a),!0)};l.event.special[b]=
{setup:function(){0===c++&&F.addEventListener(a,d,!0)},teardown:function(){0===--c&&F.removeEventListener(a,d,!0)}}});l.fn.extend({on:function(a,b,d,e,f){var h,g;if("object"==typeof a){"string"!=typeof b&&(d=d||b,b=c);for(h in a)this.on(h,b,d,a[h],f);return this}if(null==d&&null==e?(e=b,d=b=c):null==e&&("string"==typeof b?(e=d,d=c):(e=d,d=b,b=c)),!1===e)e=m;else if(!e)return this;return 1===f&&(g=e,e=function(a){return l().off(a),g.apply(this,arguments)},e.guid=g.guid||(g.guid=l.guid++)),this.each(function(){l.event.add(this,
a,e,d,b)})},one:function(a,b,c,d){return this.on(a,b,c,d,1)},off:function(a,b,d){var e,f;if(a&&a.preventDefault&&a.handleObj)return e=a.handleObj,l(a.delegateTarget).off(e.namespace?e.origType+"."+e.namespace:e.origType,e.selector,e.handler),this;if("object"==typeof a){for(f in a)this.off(f,b,a[f]);return this}return(!1===b||"function"==typeof b)&&(d=b,b=c),!1===d&&(d=m),this.each(function(){l.event.remove(this,a,d,b)})},bind:function(a,b,c){return this.on(a,null,b,c)},unbind:function(a,b){return this.off(a,
null,b)},delegate:function(a,b,c,d){return this.on(b,a,c,d)},undelegate:function(a,b,c){return 1===arguments.length?this.off(a,"**"):this.off(b,a||"**",c)},trigger:function(a,b){return this.each(function(){l.event.trigger(a,b,this)})},triggerHandler:function(a,b){var d=this[0];return d?l.event.trigger(a,b,d,!0):c}});(function(a,b){function c(a){return Wa.test(a+"")}function d(){var a,b=[];return a=function(c,d){return b.push(c+=" ")>A.cacheLength&&delete a[b.shift()],a[c]=d}}function e(a){return a[J]=
!0,a}function f(a){var b=s.createElement("div");try{return a(b)}catch(c){return!1}finally{}}function h(a,b,c,d){var e,f,l,g,k;if((b?b.ownerDocument||b:da)!==s&&y(b),b=b||s,c=c||[],!a||"string"!=typeof a)return c;if(1!==(g=b.nodeType)&&9!==g)return[];if(!C&&!d){if(e=za.exec(a))if(l=e[1])if(9===g){if(f=b.getElementById(l),!f||!f.parentNode)return c;if(f.id===l)return c.push(f),c}else{if(b.ownerDocument&&(f=b.ownerDocument.getElementById(l))&&fa(b,f)&&f.id===l)return c.push(f),c}else{if(e[2])return ja.apply(c,
T.call(b.getElementsByTagName(a),0)),c;if((l=e[3])&&O.getByClassName&&b.getElementsByClassName)return ja.apply(c,T.call(b.getElementsByClassName(l),0)),c}if(O.qsa&&!M.test(a)){if(e=!0,f=J,l=b,k=9===g&&a,1===g&&"object"!==b.nodeName.toLowerCase()){g=t(a);(e=b.getAttribute("id"))?f=e.replace(db,"\\$&"):b.setAttribute("id",f);f="[id='"+f+"'] ";for(l=g.length;l--;)g[l]=f+v(g[l]);l=P.test(a)&&b.parentNode||b;k=g.join(",")}if(k)try{return ja.apply(c,T.call(l.querySelectorAll(k),0)),c}catch(n){}finally{e||
...
T.call(d,0)),c);break a}break}}m=(u(a,f)(d,b,C,c,P.test(a)),c)}return m}function g(a,b){var c=b&&a,d=c&&(~b.sourceIndex||ya)-(~a.sourceIndex||ya);if(d)return d;if(c)for(;c=c.nextSibling;)if(c===b)return-1;return a?1:-1}function k(a){return function(b){return"input"===b.nodeName.toLowerCase()&&b.type===a}}function n(a){return function(b){var c=b.nodeName.toLowerCase();return("input"===c||"button"===c)&&b.type===a}}function m(a){return e(function(b){return b=+b,e(function(c,d){for(var e,f=a([],c.length,
b),h=f.length;h--;)c[e=f[h]]&&(c[e]=!(d[e]=c[e]))})})}function t(a,b){var c,d,e,f,l,g,k;if(l=S[a+" "])return b?0:l.slice(0);l=a;g=[];for(k=A.preFilter;l;){c&&!(d=Z.exec(l))||(d&&(l=l.slice(d[0].length)||l),g.push(e=[]));c=!1;(d=cb.exec(l))&&(c=d.shift(),e.push({value:c,type:d[0].replace(V," ")}),l=l.slice(c.length));for(f in A.filter)!(d=R[f].exec(l))||k[f]&&!(d=k[f](d))||(c=d.shift(),e.push({value:c,type:f,matches:d}),l=l.slice(c.length));if(!c)break}return b?l.length:l?h.error(a):S(a,g).slice(0)}
function v(a){for(var b=0,c=a.length,d="";c>b;b++)d+=a[b].value;return d}function r(a,b,c){var d=b.dir,e=c&&"parentNode"===d,f=sa++;return b.first?function(b,c,f){for(;b=b[d];)if(1===b.nodeType||e)return a(b,c,f)}:function(b,c,h){var l,g,k,n=ea+" "+f;if(h)for(;b=b[d];){if((1===b.nodeType||e)&&a(b,c,h))return!0}else for(;b=b[d];)if(1===b.nodeType||e)if(k=b[J]||(b[J]={}),(g=k[d])&&g[0]===n){if(!0===(l=g[1])||l===q)return!0===l}else if(g=k[d]=[n],g[1]=a(b,c,h)||q,!0===g[1])return!0}}function w(a){return 1<
a.length?function(b,c,d){for(var e=a.length;e--;)if(!a[e](b,c,d))return!1;return!0}:a[0]}function L(a,b,c,d,e){for(var f,h=[],l=0,g=a.length,k=null!=b;g>l;l++)(f=a[l])&&(!c||c(f,d,e))&&(h.push(f),k&&b.push(l));return h}function p(a,b,c,d,f,l){return d&&!d[J]&&(d=p(d)),f&&!f[J]&&(f=p(f,l)),e(function(e,l,g,k){var n,m,N=[],t=[],v=l.length,r;if(!(r=e)){r=b||"*";for(var w=g.nodeType?[g]:g,p=[],D=0,z=w.length;z>D;D++)h(r,w[D],p);r=p}r=!a||!e&&b?r:L(r,N,a,g,k);w=c?f||(e?a:v||d)?[]:l:r;if(c&&c(r,w,g,k),
d)for(n=L(w,t),d(n,[],g,k),g=n.length;g--;)(m=n[g])&&(w[t[g]]=!(r[t[g]]=m));if(e){if(f||a){if(f){n=[];for(g=w.length;g--;)(m=w[g])&&n.push(r[g]=m);f(null,w=[],n,k)}for(g=w.length;g--;)(m=w[g])&&-1<(n=f?ca.call(e,m):N[g])&&(e[n]=!(l[n]=m))}}else w=L(w===l?w.splice(v,w.length):w),f?f(null,l,w,k):ja.apply(l,w)})}function D(a){var b,c,d,e=a.length,f=A.relative[a[0].type];c=f||A.relative[" "];for(var h=f?1:0,l=r(function(a){return a===b},c,!0),g=r(function(a){return-1<ca.call(b,a)},c,!0),k=[function(a,
c,d){return!f&&(d||c!==F)||((b=c).nodeType?l(a,c,d):g(a,c,d))}];e>h;h++)if(c=A.relative[a[h].type])k=[r(w(k),c)];else{if(c=A.filter[a[h].type].apply(null,a[h].matches),c[J]){for(d=++h;e>d&&!A.relative[a[d].type];d++);return p(1<h&&w(k),1<h&&v(a.slice(0,h-1)).replace(V,"$1"),c,d>h&&D(a.slice(h,d)),e>d&&D(a=a.slice(d)),e>d&&v(a))}k.push(c)}return w(k)}function z(a,b){var c=0,d=0<b.length,f=0<a.length,l=function(e,l,g,k,n){var m,N,t=[],r=0,v="0",w=e&&[],p=null!=n,D=F,z=e||f&&A.find.TAG("*",n&&l.parentNode||
l),sb=ea+=null==D?1:Math.random()||0.1;for(p&&(F=l!==s&&l,q=c);null!=(n=z[v]);v++){if(f&&n){for(m=0;N=a[m++];)if(N(n,l,g)){k.push(n);break}p&&(ea=sb,q=++c)}d&&((n=!N&&n)&&r--,e&&w.push(n))}if(r+=v,d&&v!==r){for(m=0;N=b[m++];)N(w,t,l,g);if(e){if(0<r)for(;v--;)w[v]||t[v]||(t[v]=aa.call(k));t=L(t)}ja.apply(k,t);p&&!e&&0<t.length&&1<r+b.length&&h.uniqueSort(k)}return p&&(ea=sb,F=D),w};return d?e(l):l}function x(){}var Q,q,A,U,E,u,B,F,y,s,G,C,M,K,I,fa,ha,J="sizzle"+-new Date,da=a.document,O={},ea=0,sa=
...
1)}return a};U=h.getText=function(a){var b,c="",d=0;if(b=a.nodeType)if(1===b||9===b||11===b){if("string"==typeof a.textContent)return a.textContent;for(a=a.firstChild;a;a=a.nextSibling)c+=U(a)}else{if(3===b||4===b)return a.nodeValue}else for(;b=a[d];d++)c+=U(b);return c};A=h.selectors={cacheLength:50,createPseudo:e,match:R,find:{},relative:{">":{dir:"parentNode",first:!0}," ":{dir:"parentNode"},"+":{dir:"previousSibling",first:!0},"~":{dir:"previousSibling"}},preFilter:{ATTR:function(a){return a[1]=
a[1].replace(Y,ba),a[3]=(a[4]||a[5]||"").replace(Y,ba),"~="===a[2]&&(a[3]=" "+a[3]+" "),a.slice(0,4)},CHILD:function(a){return a[1]=a[1].toLowerCase(),"nth"===a[1].slice(0,3)?(a[3]||h.error(a[0]),a[4]=+(a[4]?a[5]+(a[6]||1):2*("even"===a[3]||"odd"===a[3])),a[5]=+(a[7]+a[8]||"odd"===a[3])):a[3]&&h.error(a[0]),a},PSEUDO:function(a){var b,c=!a[5]&&a[2];return R.CHILD.test(a[0])?null:(a[4]?a[2]=a[4]:c&&kb.test(c)&&(b=t(c,!0))&&(b=c.indexOf(")",c.length-b)-c.length)&&(a[0]=a[0].slice(0,b),a[2]=c.slice(0,
b)),a.slice(0,3))}},filter:{TAG:function(a){return"*"===a?function(){return!0}:(a=a.replace(Y,ba).toLowerCase(),function(b){return b.nodeName&&b.nodeName.toLowerCase()===a})},CLASS:function(a){var b=ga[a+" "];return b||(b=RegExp("(^|[\\x20\\t\\r\\n\\f])"+a+"([\\x20\\t\\r\\n\\f]|$)"))&&ga(a,function(a){return b.test(a.className||typeof a.getAttribute!==W&&a.getAttribute("class")||"")})},ATTR:function(a,b,c){return function(d){d=h.attr(d,a);return null==d?"!="===b:b?(d+="","="===b?d===c:"!="===b?d!==
c:"^="===b?c&&0===d.indexOf(c):"*="===b?c&&-1<d.indexOf(c):"$="===b?c&&d.slice(-c.length)===c:"~="===b?-1<(" "+d+" ").indexOf(c):"|="===b?d===c||d.slice(0,c.length+1)===c+"-":!1):!0}},CHILD:function(a,b,c,d,e){var f="nth"!==a.slice(0,3),h="last"!==a.slice(-4),l="of-type"===b;return 1===d&&0===e?function(a){return!!a.parentNode}:function(b,c,g){var k,n,m,N,t;c=f!==h?"nextSibling":"previousSibling";var r=b.parentNode,v=l&&b.nodeName.toLowerCase();g=!g&&!l;if(r){if(f){for(;c;){for(n=b;n=n[c];)if(l?n.nodeName.toLowerCase()===
v:1===n.nodeType)return!1;t=c="only"===a&&!t&&"nextSibling"}return!0}if(t=[h?r.firstChild:r.lastChild],h&&g)for(g=r[J]||(r[J]={}),k=g[a]||[],N=k[0]===ea&&k[1],m=k[0]===ea&&k[2],n=N&&r.childNodes[N];n=++N&&n&&n[c]||(m=N=0)||t.pop();){if(1===n.nodeType&&++m&&n===b){g[a]=[ea,N,m];break}}else if(g&&(k=(b[J]||(b[J]={}))[a])&&k[0]===ea)m=k[1];else for(;(n=++N&&n&&n[c]||(m=N=0)||t.pop())&&((l?n.nodeName.toLowerCase()!==v:1!==n.nodeType)||!++m||(g&&((n[J]||(n[J]={}))[a]=[ea,m]),n!==b)););return m-=e,m===
d||0===m%d&&0<=m/d}}},PSEUDO:function(a,b){var c,d=A.pseudos[a]||A.setFilters[a.toLowerCase()]||h.error("unsupported pseudo: "+a);return d[J]?d(b):1<d.length?(c=[a,a,"",b],A.setFilters.hasOwnProperty(a.toLowerCase())?e(function(a,c){for(var e,f=d(a,b),l=f.length;l--;)e=ca.call(a,f[l]),a[e]=!(c[e]=f[l])}):function(a){return d(a,0,c)}):d}},pseudos:{not:e(function(a){var b=[],c=[],d=u(a.replace(V,"$1"));return d[J]?e(function(a,b,c,e){var f;c=d(a,null,e,[]);for(e=a.length;e--;)(f=c[e])&&(a[e]=!(b[e]=
f))}):function(a,e,f){return b[0]=a,d(b,null,f,c),!c.pop()}}),has:e(function(a){return function(b){return 0<h(a,b).length}}),contains:e(function(a){return function(b){return-1<(b.textContent||b.innerText||U(b)).indexOf(a)}}),lang:e(function(a){return na.test(a||"")||h.error("unsupported lang: "+a),a=a.replace(Y,ba).toLowerCase(),function(b){var c;do if(c=C?b.getAttribute("xml:lang")||b.getAttribute("lang"):b.lang)return c=c.toLowerCase(),c===a||0===c.indexOf(a+"-");while((b=b.parentNode)&&1===b.nodeType);
...
a.type)},first:m(function(){return[0]}),last:m(function(a,b){return[b-1]}),eq:m(function(a,b,c){return[0>c?c+b:c]}),even:m(function(a,b){for(var c=0;b>c;c+=2)a.push(c);return a}),odd:m(function(a,b){for(var c=1;b>c;c+=2)a.push(c);return a}),lt:m(function(a,b,c){for(b=0>c?c+b:c;0<=--b;)a.push(b);return a}),gt:m(function(a,b,c){for(c=0>c?c+b:c;b>++c;)a.push(c);return a})}};for(Q in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})A.pseudos[Q]=k(Q);for(Q in{submit:!0,reset:!0})A.pseudos[Q]=n(Q);u=
h.compile=function(a,b){var c,d=[],e=[],f=H[a+" "];if(!f){b||(b=t(a));for(c=b.length;c--;)f=D(b[c]),f[J]?d.push(f):e.push(f);f=H(a,z(e,d))}return f};A.pseudos.nth=A.pseudos.eq;A.filters=x.prototype=A.pseudos;A.setFilters=new x;y();h.attr=l.attr;l.find=h;l.expr=h.selectors;l.expr[":"]=l.expr.pseudos;l.unique=h.uniqueSort;l.text=h.getText;l.isXMLDoc=h.isXML;l.contains=h.contains})(a);var ib=/Until$/,Na=/^(?:parents|prev(?:Until|All))/,Va=/^.[^:#\[\.,]*$/,cb=l.expr.match.needsContext,jb={children:!0,
contents:!0,next:!0,prev:!0};l.fn.extend({find:function(a){var b,c,d,e=this.length;if("string"!=typeof a)return d=this,this.pushStack(l(a).filter(function(){for(b=0;e>b;b++)if(l.contains(d[b],this))return!0}));c=[];for(b=0;e>b;b++)l.find(a,this[b],c);return c=this.pushStack(1<e?l.unique(c):c),c.selector=(this.selector?this.selector+" ":"")+a,c},has:function(a){var b,c=l(a,this),d=c.length;return this.filter(function(){for(b=0;d>b;b++)if(l.contains(this,c[b]))return!0})},not:function(a){return this.pushStack(u(this,
a,!1))},filter:function(a){return this.pushStack(u(this,a,!0))},is:function(a){return!!a&&("string"==typeof a?cb.test(a)?0<=l(a,this.context).index(this[0]):0<l.filter(a,this).length:0<this.filter(a).length)},closest:function(a,b){for(var c,d=0,e=this.length,f=[],h=cb.test(a)||"string"!=typeof a?l(a,b||this.context):0;e>d;d++)for(c=this[d];c&&c.ownerDocument&&c!==b&&11!==c.nodeType;){if(h?-1<h.index(c):l.find.matchesSelector(c,a)){f.push(c);break}c=c.parentNode}return this.pushStack(1<f.length?l.unique(f):
f)},index:function(a){return a?"string"==typeof a?l.inArray(this[0],l(a)):l.inArray(a.jquery?a[0]:a,this):this[0]&&this[0].parentNode?this.first().prevAll().length:-1},add:function(a,b){var c="string"==typeof a?l(a,b):l.makeArray(a&&a.nodeType?[a]:a),c=l.merge(this.get(),c);return this.pushStack(l.unique(c))},addBack:function(a){return this.add(null==a?this.prevObject:this.prevObject.filter(a))}});l.fn.andSelf=l.fn.addBack;l.each({parent:function(a){return(a=a.parentNode)&&11!==a.nodeType?a:null},
parents:function(a){return l.dir(a,"parentNode")},parentsUntil:function(a,b,c){return l.dir(a,"parentNode",c)},next:function(a){return q(a,"nextSibling")},prev:function(a){return q(a,"previousSibling")},nextAll:function(a){return l.dir(a,"nextSibling")},prevAll:function(a){return l.dir(a,"previousSibling")},nextUntil:function(a,b,c){return l.dir(a,"nextSibling",c)},prevUntil:function(a,b,c){return l.dir(a,"previousSibling",c)},siblings:function(a){return l.sibling((a.parentNode||{}).firstChild,a)},
children:function(a){return l.sibling(a.firstChild)},contents:function(a){return l.nodeName(a,"iframe")?a.contentDocument||a.contentWindow.document:l.merge([],a.childNodes)}},function(a,b){l.fn[a]=function(c,d){var e=l.map(this,b,c);return ib.test(a)||(d=c),d&&"string"==typeof d&&(e=l.filter(d,e)),e=1<this.length&&!jb[a]?l.unique(e):e,1<this.length&&Na.test(a)&&(e=e.reverse()),this.pushStack(e)}});l.extend({filter:function(a,b,c){return c&&(a=":not("+a+")"),1===b.length?l.find.matchesSelector(b[0],
a)?[b[0]]:[]:l.find.matches(a,b)},dir:function(a,b,d){var e=[];for(a=a[b];a&&9!==a.nodeType&&(d===c||1!==a.nodeType||!l(a).is(d));)1===a.nodeType&&e.push(a),a=a[b];return e},sibling:function(a,b){for(var c=[];a;a=a.nextSibling)1===a.nodeType&&a!==b&&c.push(a);return c}});var Wa="abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",kb=/ jQuery\d+="(?:null|\d+)"/g,db=RegExp("<(?:"+Wa+")[\\s/>]","i"),
...
this.nodeType&&9!==this.nodeType||this.insertBefore(a,this.firstChild)})},before:function(){return this.domManip(arguments,!1,function(a){this.parentNode&&this.parentNode.insertBefore(a,this)})},after:function(){return this.domManip(arguments,!1,function(a){this.parentNode&&this.parentNode.insertBefore(a,this.nextSibling)})},remove:function(a,b){for(var c,d=0;null!=(c=this[d]);d++)(!a||0<l.filter(a,[c]).length)&&(b||1!==c.nodeType||l.cleanData(z(c)),c.parentNode&&(b&&l.contains(c.ownerDocument,c)&&
v(z(c,"script")),c.parentNode.removeChild(c)));return this},empty:function(){for(var a,b=0;null!=(a=this[b]);b++){for(1===a.nodeType&&l.cleanData(z(a,!1));a.firstChild;)a.removeChild(a.firstChild);a.options&&l.nodeName(a,"select")&&(a.options.length=0)}return this},clone:function(a,b){return a=null==a?!1:a,b=null==b?a:b,this.map(function(){return l.clone(this,a,b)})},html:function(a){return l.access(this,function(a){var b=this[0]||{},d=0,e=this.length;if(a===c)return 1===b.nodeType?b.innerHTML.replace(kb,
""):c;if(!("string"!=typeof a||Ob.test(a)||!l.support.htmlSerialize&&db.test(a)||!l.support.leadingWhitespace&&lb.test(a)||Y[(wb.exec(a)||["",""])[1].toLowerCase()])){a=a.replace(vb,"<$1></$2>");try{for(;e>d;d++)b=this[d]||{},1===b.nodeType&&(l.cleanData(z(b,!1)),b.innerHTML=a);b=0}catch(f){}}b&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(a){return l.isFunction(a)||"string"==typeof a||(a=l(a).not(this).detach()),this.domManip([a],!0,function(a){var b=this.nextSibling,c=
this.parentNode;c&&(l(this).remove(),c.insertBefore(a,b))})},detach:function(a){return this.remove(a,!0)},domManip:function(a,b,d){a=X.apply([],a);var e,f,h,g,k=0,m=this.length,t=this,v=m-1,w=a[0],L=l.isFunction(w);if(L||!(1>=m||"string"!=typeof w||l.support.checkClone)&&Pb.test(w))return this.each(function(e){var f=t.eq(e);L&&(a[0]=w.call(this,e,b?f.html():c));f.domManip(a,b,d)});if(m&&(g=l.buildFragment(a,this[0].ownerDocument,!1,this),e=g.firstChild,1===g.childNodes.length&&(g=e),e)){b=b&&l.nodeName(e,
"tr");h=l.map(z(g,"script"),n);for(f=h.length;m>k;k++)e=g,k!==v&&(e=l.clone(e,!0,!0),f&&l.merge(h,z(e,"script"))),d.call(b&&l.nodeName(this[k],"table")?this[k].getElementsByTagName("tbody")[0]||this[k].appendChild(this[k].ownerDocument.createElement("tbody")):this[k],e,k);if(f)for(g=h[h.length-1].ownerDocument,l.map(h,r),k=0;f>k;k++)e=h[k],yb.test(e.type||"")&&!l._data(e,"globalEval")&&l.contains(g,e)&&(e.src?l.ajax({url:e.src,type:"GET",dataType:"script",async:!1,global:!1,"throws":!0}):l.globalEval((e.text||
e.textContent||e.innerHTML||"").replace(Qb,"")));g=e=null}return this}});l.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){l.fn[a]=function(a){for(var c=0,d=[],e=l(a),f=e.length-1;f>=c;c++)a=c===f?this:this.clone(!0),l(e[c])[b](a),U.apply(d,a.get());return this.pushStack(d)}});l.extend({clone:function(a,b,c){var d,e,f,h,g,k=l.contains(a.ownerDocument,a);if(l.support.html5Clone||l.isXMLDoc(a)||!db.test("<"+a.nodeName+">")?
f=a.cloneNode(!0):(mb.innerHTML=a.outerHTML,mb.removeChild(f=mb.firstChild)),!(l.support.noCloneEvent&&l.support.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||l.isXMLDoc(a)))for(d=z(f),g=z(a),h=0;null!=(e=g[h]);++h)if(d[h]){var m=d[h],w=void 0,L=void 0,p=void 0;if(1===m.nodeType){if(w=m.nodeName.toLowerCase(),!l.support.noCloneEvent&&m[l.expando]){p=l._data(m);for(L in p.events)l.removeEvent(m,L,p.handle);m.removeAttribute(l.expando)}"script"===w&&m.text!==e.text?(n(m).text=e.text,r(m)):"object"===
w?(m.parentNode&&(m.outerHTML=e.outerHTML),l.support.html5Clone&&e.innerHTML&&!l.trim(m.innerHTML)&&(m.innerHTML=e.innerHTML)):"input"===w&&fb.test(e.type)?(m.defaultChecked=m.checked=e.checked,m.value!==e.value&&(m.value=e.value)):"option"===w?m.defaultSelected=m.selected=e.defaultSelected:("input"===w||"textarea"===w)&&(m.defaultValue=e.defaultValue)}}if(b)if(c)for(g=g||z(a),d=d||z(f),h=0;null!=(e=g[h]);h++)t(e,d[h]);else t(a,f);return d=z(f,"script"),0<d.length&&v(d,!k&&z(a,"script")),f},buildFragment:function(a,
b,c,d){for(var e,f,h,g,k,n,m,t=a.length,r=s(b),w=[],p=0;t>p;p++)if(f=a[p],f||0===f)if("object"===l.type(f))l.merge(w,f.nodeType?[f]:f);else if(Nb.test(f)){g=g||r.appendChild(b.createElement("div"));k=(wb.exec(f)||["",""])[1].toLowerCase();m=Y[k]||Y._default;g.innerHTML=m[1]+f.replace(vb,"<$1></$2>")+m[2];for(e=m[0];e--;)g=g.lastChild;if(!l.support.leadingWhitespace&&lb.test(f)&&w.push(b.createTextNode(lb.exec(f)[0])),!l.support.tbody)for(e=(f="table"!==k||xb.test(f)?"<table>"!==m[1]||xb.test(f)?0:
g:g.firstChild)&&f.childNodes.length;e--;)l.nodeName(n=f.childNodes[e],"tbody")&&!n.childNodes.length&&f.removeChild(n);l.merge(w,g.childNodes);for(g.textContent="";g.firstChild;)g.removeChild(g.firstChild);g=r.lastChild}else w.push(b.createTextNode(f));g&&r.removeChild(g);l.support.appendChecked||l.grep(z(w,"input"),L);for(p=0;f=w[p++];)if((!d||-1===l.inArray(f,d))&&(h=l.contains(f.ownerDocument,f),g=z(r.appendChild(f),"script"),h&&v(g),c))for(e=0;f=g[e++];)yb.test(f.type||"")&&c.push(f);return r},
cleanData:function(a,b){for(var c,d,e,f,h=0,g=l.expando,k=l.cache,n=l.support.deleteExpando,m=l.event.special;null!=(c=a[h]);h++)if((b||l.acceptData(c))&&(e=c[g],f=e&&k[e])){if(f.events)for(d in f.events)m[d]?l.event.remove(c,d):l.removeEvent(c,d,f.handle);k[e]&&(delete k[e],n?delete c[g]:typeof c.removeAttribute!==Q?c.removeAttribute(g):c[g]=null,W.push(e))}}});var Qa,wa,xa,nb=/alpha\([^)]*\)/i,Rb=/opacity\s*=\s*([^)]*)/,Sb=/^(top|right|bottom|left)$/,Tb=/^(none|table(?!-c[ea]).+)/,zb=/^margin/,
Kb=RegExp("^("+na+")(.*)$","i"),Xa=RegExp("^("+na+")(?!px)[a-z%]+$","i"),Ub=RegExp("^([+-])=("+na+")","i"),ub={BODY:"block"},Vb={position:"absolute",visibility:"hidden",display:"block"},Ab={letterSpacing:0,fontWeight:400},va=["Top","Right","Bottom","Left"],tb=["Webkit","O","Moz","ms"];l.fn.extend({css:function(a,b){return l.access(this,function(a,b,d){var e,f={},h=0;if(l.isArray(b)){e=wa(a);for(d=b.length;d>h;h++)f[b[h]]=l.css(a,b[h],!1,e);return f}return d!==c?l.style(a,b,d):l.css(a,b)},a,b,1<arguments.length)},
show:function(){return p(this,!0)},hide:function(){return p(this)},toggle:function(a){var b="boolean"==typeof a;return this.each(function(){(b?a:G(this))?l(this).show():l(this).hide()})}});l.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=xa(a,"opacity");return""===c?"1":c}}}},cssNumber:{columnCount:!0,fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":l.support.cssFloat?"cssFloat":"styleFloat"},style:function(a,b,d,e){if(a&&3!==
a.nodeType&&8!==a.nodeType&&a.style){var f,h,g,k=l.camelCase(b),n=a.style;if(b=l.cssProps[k]||(l.cssProps[k]=D(n,k)),g=l.cssHooks[b]||l.cssHooks[k],d===c)return g&&"get"in g&&(f=g.get(a,!1,e))!==c?f:n[b];if(h=typeof d,"string"===h&&(f=Ub.exec(d))&&(d=(f[1]+1)*f[2]+parseFloat(l.css(a,b)),h="number"),!(null==d||"number"===h&&isNaN(d)||("number"!==h||l.cssNumber[k]||(d+="px"),l.support.clearCloneStyle||""!==d||0!==b.indexOf("background")||(n[b]="inherit"),g&&"set"in g&&(d=g.set(a,d,e))===c)))try{n[b]=
d}catch(m){}}},css:function(a,b,d,e){var f,h,g,k=l.camelCase(b);return b=l.cssProps[k]||(l.cssProps[k]=D(a.style,k)),g=l.cssHooks[b]||l.cssHooks[k],g&&"get"in g&&(h=g.get(a,!0,d)),h===c&&(h=xa(a,b,e)),"normal"===h&&b in Ab&&(h=Ab[b]),""===d||d?(f=parseFloat(h),!0===d||l.isNumeric(f)?f||0:h):h},swap:function(a,b,c,d){var e,f={};for(e in b)f[e]=a.style[e],a.style[e]=b[e];c=c.apply(a,d||[]);for(e in b)a.style[e]=f[e];return c}});a.getComputedStyle?(wa=function(b){return a.getComputedStyle(b,null)},xa=
function(a,b,d){var e,f,h,g=(d=d||wa(a))?d.getPropertyValue(b)||d[b]:c,k=a.style;return d&&(""!==g||l.contains(a.ownerDocument,a)||(g=l.style(a,b)),Xa.test(g)&&zb.test(b)&&(e=k.width,f=k.minWidth,h=k.maxWidth,k.minWidth=k.maxWidth=k.width=g,g=d.width,k.width=e,k.minWidth=f,k.maxWidth=h)),g}):F.documentElement.currentStyle&&(wa=function(a){return a.currentStyle},xa=function(a,b,d){var e,f,h;d=(d=d||wa(a))?d[b]:c;var g=a.style;return null==d&&g&&g[b]&&(d=g[b]),Xa.test(d)&&!Sb.test(b)&&(e=g.left,f=a.runtimeStyle,
h=f&&f.left,h&&(f.left=a.currentStyle.left),g.left="fontSize"===b?"1em":d,d=g.pixelLeft+"px",g.left=e,h&&(f.left=h)),""===d?"auto":d});l.each(["height","width"],function(a,b){l.cssHooks[b]={get:function(a,d,e){return d?0===a.offsetWidth&&Tb.test(l.css(a,"display"))?l.swap(a,Vb,function(){return C(a,b,e)}):C(a,b,e):c},set:function(a,c,d){var e=d&&wa(a);return y(a,c,d?I(a,b,d,l.support.boxSizing&&"border-box"===l.css(a,"boxSizing",!1,e),e):0)}}});l.support.opacity||(l.cssHooks.opacity={get:function(a,
b){return Rb.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?0.01*parseFloat(RegExp.$1)+"":b?"1":""},set:function(a,b){var c=a.style,d=a.currentStyle,e=l.isNumeric(b)?"alpha(opacity="+100*b+")":"",f=d&&d.filter||c.filter||"";c.zoom=1;(1<=b||""===b)&&""===l.trim(f.replace(nb,""))&&c.removeAttribute&&(c.removeAttribute("filter"),""===b||d&&!d.filter)||(c.filter=nb.test(f)?f.replace(nb,e):f+" "+e)}});l(function(){l.support.reliableMarginRight||(l.cssHooks.marginRight={get:function(a,
b){return b?l.swap(a,{display:"inline-block"},xa,[a,"marginRight"]):c}});!l.support.pixelPosition&&l.fn.position&&l.each(["top","left"],function(a,b){l.cssHooks[b]={get:function(a,d){return d?(d=xa(a,b),Xa.test(d)?l(a).position()[b]+"px":d):c}}})});l.expr&&l.expr.filters&&(l.expr.filters.hidden=function(a){return 0>=a.offsetWidth&&0>=a.offsetHeight||!l.support.reliableHiddenOffsets&&"none"===(a.style&&a.style.display||l.css(a,"display"))},l.expr.filters.visible=function(a){return!l.expr.filters.hidden(a)});
l.each({margin:"",padding:"",border:"Width"},function(a,b){l.cssHooks[a+b]={expand:function(c){var d=0,e={};for(c="string"==typeof c?c.split(" "):[c];4>d;d++)e[a+va[d]+b]=c[d]||c[d-2]||c[0];return e}};zb.test(a)||(l.cssHooks[a+b].set=y)});var Wb=/%20/g,Lb=/\[\]$/,Bb=/\r?\n/g,Xb=/^(?:submit|button|image|reset|file)$/i,Yb=/^(?:input|select|textarea|keygen)/i;l.fn.extend({serialize:function(){return l.param(this.serializeArray())},serializeArray:function(){return this.map(function(){var a=l.prop(this,
"elements");return a?l.makeArray(a):this}).filter(function(){var a=this.type;return this.name&&!l(this).is(":disabled")&&Yb.test(this.nodeName)&&!Xb.test(a)&&(this.checked||!fb.test(a))}).map(function(a,b){var c=l(this).val();return null==c?null:l.isArray(c)?l.map(c,function(a){return{name:b.name,value:a.replace(Bb,"\r\n")}}):{name:b.name,value:c.replace(Bb,"\r\n")}}).get()}});l.param=function(a,b){var d,e=[],f=function(a,b){b=l.isFunction(b)?b():null==b?"":b;e[e.length]=encodeURIComponent(a)+"="+
encodeURIComponent(b)};if(b===c&&(b=l.ajaxSettings&&l.ajaxSettings.traditional),l.isArray(a)||a.jquery&&!l.isPlainObject(a))l.each(a,function(){f(this.name,this.value)});else for(d in a)O(d,a[d],b,f);return e.join("&").replace(Wb,"+")};l.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "),function(a,b){l.fn[b]=function(a,c){return 0<
arguments.length?this.on(b,null,a,c):this.trigger(b)}});l.fn.hover=function(a,b){return this.mouseenter(a).mouseleave(b||a)};var Da,ta,ob=l.now(),pb=/\?/,Zb=/#.*$/,Cb=/([?&])_=[^&]*/,$b=/^(.*?):[ \t]*([^\r\n]*)\r?$/gm,ac=/^(?:GET|HEAD)$/,bc=/^\/\//,Db=/^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/,Eb=l.fn.load,Fb={},gb={},Gb="*/".concat("*");try{ta=fa.href}catch(gc){ta=F.createElement("a"),ta.href="",ta=ta.href}Da=Db.exec(ta.toLowerCase())||[];l.fn.load=function(a,b,d){if("string"!=typeof a&&Eb)return Eb.apply(this,
arguments);var e,f,h,g=this,k=a.indexOf(" ");return 0<=k&&(e=a.slice(k,a.length),a=a.slice(0,k)),l.isFunction(b)?(d=b,b=c):b&&"object"==typeof b&&(h="POST"),0<g.length&&l.ajax({url:a,type:h,dataType:"html",data:b}).done(function(a){f=arguments;g.html(e?l("<div>").append(l.parseHTML(a)).find(e):a)}).complete(d&&function(a,b){g.each(d,f||[a.responseText,b,a])}),this};l.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(a,b){l.fn[b]=function(a){return this.on(b,
a)}});l.each(["get","post"],function(a,b){l[b]=function(a,d,e,f){return l.isFunction(d)&&(f=f||e,e=d,d=c),l.ajax({url:a,type:b,dataType:f,data:d,success:e})}});l.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:ta,type:"GET",isLocal:/^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(Da[1]),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",accepts:{"*":Gb,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},
contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":l.parseJSON,"text xml":l.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(a,b){return b?M(M(a,l.ajaxSettings),b):M(l.ajaxSettings,a)},ajaxPrefilter:S(Fb),ajaxTransport:S(gb),ajax:function(a,b){function d(a,b,e,f){var t,z,A,Q,U,E=b;if(2!==x){x=2;k&&clearTimeout(k);m=c;g=f||"";q.readyState=0<a?4:0;if(e){Q=r;f=q;var B,u,F,N,s=Q.contents,
y=Q.dataTypes,G=Q.responseFields;for(N in G)N in e&&(f[G[N]]=e[N]);for(;"*"===y[0];)y.shift(),u===c&&(u=Q.mimeType||f.getResponseHeader("Content-Type"));if(u)for(N in s)if(s[N]&&s[N].test(u)){y.unshift(N);break}if(y[0]in e)F=y[0];else{for(N in e){if(!y[0]||Q.converters[N+" "+y[0]]){F=N;break}B||(B=N)}F=F||B}Q=F?(F!==y[0]&&y.unshift(F),e[F]):c}if(200<=a&&300>a||304===a)if(r.ifModified&&(U=q.getResponseHeader("Last-Modified"),U&&(l.lastModified[h]=U),U=q.getResponseHeader("etag"),U&&(l.etag[h]=U)),
...
{state:"parsererror",error:M?fa:"No conversion from "+B+" to "+z};break a}}B=z}C={state:"success",data:t}}t=C;E=t.state;z=t.data;A=t.error;t=!A}else A=E,(a||!E)&&(E="error",0>a&&(a=0));q.status=a;q.statusText=(b||E)+"";t?L.resolveWith(v,[z,E,q]):L.rejectWith(v,[q,E,A]);q.statusCode(D);D=c;n&&w.trigger(t?"ajaxSuccess":"ajaxError",[q,r,t?z:A]);p.fireWith(v,[q,E]);n&&(w.trigger("ajaxComplete",[q,r]),--l.active||l.event.trigger("ajaxStop"))}}"object"==typeof a&&(b=a,a=c);b=b||{};var e,f,h,g,k,n,m,t,r=
l.ajaxSetup({},b),v=r.context||r,w=r.context&&(v.nodeType||v.jquery)?l(v):l.event,L=l.Deferred(),p=l.Callbacks("once memory"),D=r.statusCode||{},z={},A={},x=0,Q="canceled",q={readyState:0,getResponseHeader:function(a){var b;if(2===x){if(!t)for(t={};b=$b.exec(g);)t[b[1].toLowerCase()]=b[2];b=t[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===x?g:null},setRequestHeader:function(a,b){var c=a.toLowerCase();return x||(a=A[c]=A[c]||a,z[a]=b),this},overrideMimeType:function(a){return x||
(r.mimeType=a),this},statusCode:function(a){var b;if(a)if(2>x)for(b in a)D[b]=[D[b],a[b]];else q.always(a[q.status]);return this},abort:function(a){a=a||Q;return m&&m.abort(a),d(0,a),this}};if(L.promise(q).complete=p.add,q.success=q.done,q.error=q.fail,r.url=((a||r.url||ta)+"").replace(Zb,"").replace(bc,Da[1]+"//"),r.type=b.method||b.type||r.method||r.type,r.dataTypes=l.trim(r.dataType||"*").toLowerCase().match(Z)||[""],null==r.crossDomain&&(e=Db.exec(r.url.toLowerCase()),r.crossDomain=!(!e||e[1]===
Da[1]&&e[2]===Da[2]&&(e[3]||("http:"===e[1]?80:443))==(Da[3]||("http:"===Da[1]?80:443)))),r.data&&r.processData&&"string"!=typeof r.data&&(r.data=l.param(r.data,r.traditional)),ca(Fb,r,b,q),2===x)return q;(n=r.global)&&0===l.active++&&l.event.trigger("ajaxStart");r.type=r.type.toUpperCase();r.hasContent=!ac.test(r.type);h=r.url;r.hasContent||(r.data&&(h=r.url+=(pb.test(h)?"&":"?")+r.data,delete r.data),!1===r.cache&&(r.url=Cb.test(h)?h.replace(Cb,"$1_="+ob++):h+(pb.test(h)?"&":"?")+"_="+ob++));r.ifModified&&
(l.lastModified[h]&&q.setRequestHeader("If-Modified-Since",l.lastModified[h]),l.etag[h]&&q.setRequestHeader("If-None-Match",l.etag[h]));(r.data&&r.hasContent&&!1!==r.contentType||b.contentType)&&q.setRequestHeader("Content-Type",r.contentType);q.setRequestHeader("Accept",r.dataTypes[0]&&r.accepts[r.dataTypes[0]]?r.accepts[r.dataTypes[0]]+("*"!==r.dataTypes[0]?", "+Gb+"; q=0.01":""):r.accepts["*"]);for(f in r.headers)q.setRequestHeader(f,r.headers[f]);if(r.beforeSend&&(!1===r.beforeSend.call(v,q,r)||
2===x))return q.abort();Q="abort";for(f in{success:1,error:1,complete:1})q[f](r[f]);if(m=ca(gb,r,b,q)){q.readyState=1;n&&w.trigger("ajaxSend",[q,r]);r.async&&0<r.timeout&&(k=setTimeout(function(){q.abort("timeout")},r.timeout));try{x=1,m.send(z,d)}catch(U){if(!(2>x))throw U;d(-1,U)}}else d(-1,"No Transport");return q},getScript:function(a,b){return l.get(a,c,b,"script")},getJSON:function(a,b,c){return l.get(a,b,c,"json")}});l.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},
contents:{script:/(?:java|ecma)script/},converters:{"text script":function(a){return l.globalEval(a),a}}});l.ajaxPrefilter("script",function(a){a.cache===c&&(a.cache=!1);a.crossDomain&&(a.type="GET",a.global=!1)});l.ajaxTransport("script",function(a){if(a.crossDomain){var b,d=F.head||l("head")[0]||F.documentElement;return{send:function(c,e){b=F.createElement("script");b.async=!0;a.scriptCharset&&(b.charset=a.scriptCharset);b.src=a.url;b.onload=b.onreadystatechange=function(a,c){(c||!b.readyState||
/loaded|complete/.test(b.readyState))&&(b.onload=b.onreadystatechange=null,b.parentNode&&b.parentNode.removeChild(b),b=null,c||e(200,"success"))};d.insertBefore(b,d.firstChild)},abort:function(){b&&b.onload(c,!0)}}}});var Hb=[],qb=/(=)\?(?=&|$)|\?\?/;l.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var a=Hb.pop()||l.expando+"_"+ob++;return this[a]=!0,a}});l.ajaxPrefilter("json jsonp",function(b,d,e){var f,h,g,k=!1!==b.jsonp&&(qb.test(b.url)?"url":"string"==typeof b.data&&!(b.contentType||"").indexOf("application/x-www-form-urlencoded")&&
qb.test(b.data)&&"data");return k||"jsonp"===b.dataTypes[0]?(f=b.jsonpCallback=l.isFunction(b.jsonpCallback)?b.jsonpCallback():b.jsonpCallback,k?b[k]=b[k].replace(qb,"$1"+f):!1!==b.jsonp&&(b.url+=(pb.test(b.url)?"&":"?")+b.jsonp+"="+f),b.converters["script json"]=function(){return g||l.error(f+" was not called"),g[0]},b.dataTypes[0]="json",h=a[f],a[f]=function(){g=arguments},e.always(function(){a[f]=h;b[f]&&(b.jsonpCallback=d.jsonpCallback,Hb.push(f));g&&l.isFunction(h)&&h(g[0]);g=h=c}),"script"):
c});var Oa,Ta,cc=0,rb=a.ActiveXObject&&function(){for(var a in Oa)Oa[a](c,!0)};l.ajaxSettings.xhr=a.ActiveXObject?function(){var b;if(!(b=!this.isLocal&&T()))a:{try{b=new a.ActiveXObject("Microsoft.XMLHTTP");break a}catch(c){}b=void 0}return b}:T;Ta=l.ajaxSettings.xhr();l.support.cors=!!Ta&&"withCredentials"in Ta;(Ta=l.support.ajax=!!Ta)&&l.ajaxTransport(function(b){if(!b.crossDomain||l.support.cors){var d;return{send:function(e,f){var h,g,k=b.xhr();if(b.username?k.open(b.type,b.url,b.async,b.username,
b.password):k.open(b.type,b.url,b.async),b.xhrFields)for(g in b.xhrFields)k[g]=b.xhrFields[g];b.mimeType&&k.overrideMimeType&&k.overrideMimeType(b.mimeType);b.crossDomain||e["X-Requested-With"]||(e["X-Requested-With"]="XMLHttpRequest");try{for(g in e)k.setRequestHeader(g,e[g])}catch(n){}k.send(b.hasContent&&b.data||null);d=function(a,e){var g,n,m,r;try{if(d&&(e||4===k.readyState))if(d=c,h&&(k.onreadystatechange=l.noop,rb&&delete Oa[h]),e)4!==k.readyState&&k.abort();else{r={};g=k.status;n=k.getAllResponseHeaders();
"string"==typeof k.responseText&&(r.text=k.responseText);try{m=k.statusText}catch(t){m=""}g||!b.isLocal||b.crossDomain?1223===g&&(g=204):g=r.text?200:404}}catch(v){e||f(-1,v)}r&&f(g,m,r,n)};b.async?4===k.readyState?setTimeout(d):(h=++cc,rb&&(Oa||(Oa={},l(a).unload(rb)),Oa[h]=d),k.onreadystatechange=d):d()},abort:function(){d&&d(c,!0)}}}});var Ea,eb,dc=/^(?:toggle|show|hide)$/,ec=RegExp("^(?:([+-])=|)("+na+")([a-z%]*)$","i"),fc=/queueHooks$/,Ya=[function(a,b,c){var d,e,f,h,g,k,n=this,m=a.style,r={},
t=[],v=a.nodeType&&G(a);c.queue||(g=l._queueHooks(a,"fx"),null==g.unqueued&&(g.unqueued=0,k=g.empty.fire,g.empty.fire=function(){g.unqueued||k()}),g.unqueued++,n.always(function(){n.always(function(){g.unqueued--;l.queue(a,"fx").length||g.empty.fire()})}));1===a.nodeType&&("height"in b||"width"in b)&&(c.overflow=[m.overflow,m.overflowX,m.overflowY],"inline"===l.css(a,"display")&&"none"===l.css(a,"float")&&(l.support.inlineBlockNeedsLayout&&"inline"!==J(a.nodeName)?m.zoom=1:m.display="inline-block"));
c.overflow&&(m.overflow="hidden",l.support.shrinkWrapBlocks||n.always(function(){m.overflow=c.overflow[0];m.overflowX=c.overflow[1];m.overflowY=c.overflow[2]}));for(e in b)(f=b[e],dc.exec(f))&&(delete b[e],d=d||"toggle"===f,f!==(v?"hide":"show"))&&t.push(e);if(b=t.length)for(f=l._data(a,"fxshow")||l._data(a,"fxshow",{}),("hidden"in f)&&(v=f.hidden),d&&(f.hidden=!v),v?l(a).show():n.done(function(){l(a).hide()}),n.done(function(){var b;l._removeData(a,"fxshow");for(b in r)l.style(a,b,r[b])}),e=0;b>
e;e++)d=t[e],h=n.createTween(d,v?f[d]:0),r[d]=f[d]||l.style(a,d),d in f||(f[d]=h.start,v&&(h.end=h.start,h.start="width"===d||"height"===d?1:0))}],Ra={"*":[function(a,b){var c,d,e=this.createTween(a,b),f=ec.exec(b),h=e.cur(),g=+h||0,k=1,n=20;if(f){if(c=+f[2],d=f[3]||(l.cssNumber[a]?"":"px"),"px"!==d&&g){g=l.css(e.elem,a,!0)||c||1;do k=k||".5",g/=k,l.style(e.elem,a,g+d);while(k!==(k=e.cur()/h)&&1!==k&&--n)}e.unit=d;e.start=g;e.end=f[1]?g+(f[1]+1)*c:c}return e}]};l.Animation=l.extend(R,{tweener:function(a,
b){l.isFunction(a)?(b=a,a=["*"]):a=a.split(" ");for(var c,d=0,e=a.length;e>d;d++)c=a[d],Ra[c]=Ra[c]||[],Ra[c].unshift(b)},prefilter:function(a,b){b?Ya.unshift(a):Ya.push(a)}});l.Tween=E;E.prototype={constructor:E,init:function(a,b,c,d,e,f){this.elem=a;this.prop=c;this.easing=e||"swing";this.options=b;this.start=this.now=this.cur();this.end=d;this.unit=f||(l.cssNumber[c]?"":"px")},cur:function(){var a=E.propHooks[this.prop];return a&&a.get?a.get(this):E.propHooks._default.get(this)},run:function(a){var b,
c=E.propHooks[this.prop];return this.pos=b=this.options.duration?l.easing[this.easing](a,this.options.duration*a,0,1,this.options.duration):a,this.now=(this.end-this.start)*b+this.start,this.options.step&&this.options.step.call(this.elem,this.now,this),c&&c.set?c.set(this):E.propHooks._default.set(this),this}};E.prototype.init.prototype=E.prototype;E.propHooks={_default:{get:function(a){var b;return null==a.elem[a.prop]||a.elem.style&&null!=a.elem.style[a.prop]?(b=l.css(a.elem,a.prop,""),b&&"auto"!==
b?b:0):a.elem[a.prop]},set:function(a){l.fx.step[a.prop]?l.fx.step[a.prop](a):a.elem.style&&(null!=a.elem.style[l.cssProps[a.prop]]||l.cssHooks[a.prop])?l.style(a.elem,a.prop,a.now+a.unit):a.elem[a.prop]=a.now}}};E.propHooks.scrollTop=E.propHooks.scrollLeft={set:function(a){a.elem.nodeType&&a.elem.parentNode&&(a.elem[a.prop]=a.now)}};l.each(["toggle","show","hide"],function(a,b){var c=l.fn[b];l.fn[b]=function(a,d,e){return null==a||"boolean"==typeof a?c.apply(this,arguments):this.animate(B(b,!0),
a,d,e)}});l.fn.extend({fadeTo:function(a,b,c,d){return this.filter(G).css("opacity",0).show().end().animate({opacity:b},a,c,d)},animate:function(a,b,c,d){var e=l.isEmptyObject(a),f=l.speed(b,c,d),h=function(){var b=R(this,l.extend({},a),f);h.finish=function(){b.stop(!0)};(e||l._data(this,"finish"))&&b.stop(!0)};return h.finish=h,e||!1===f.queue?this.each(h):this.queue(f.queue,h)},stop:function(a,b,d){var e=function(a){var b=a.stop;delete a.stop;b(d)};return"string"!=typeof a&&(d=b,b=a,a=c),b&&!1!==
a&&this.queue(a||"fx",[]),this.each(function(){var b=!0,c=null!=a&&a+"queueHooks",f=l.timers,h=l._data(this);if(c)h[c]&&h[c].stop&&e(h[c]);else for(c in h)h[c]&&h[c].stop&&fc.test(c)&&e(h[c]);for(c=f.length;c--;)f[c].elem!==this||null!=a&&f[c].queue!==a||(f[c].anim.stop(d),b=!1,f.splice(c,1));!b&&d||l.dequeue(this,a)})},finish:function(a){return!1!==a&&(a=a||"fx"),this.each(function(){var b,c=l._data(this),d=c[a+"queue"];b=c[a+"queueHooks"];var e=l.timers,f=d?d.length:0;c.finish=!0;l.queue(this,a,
[]);b&&b.cur&&b.cur.finish&&b.cur.finish.call(this);for(b=e.length;b--;)e[b].elem===this&&e[b].queue===a&&(e[b].anim.stop(!0),e.splice(b,1));for(b=0;f>b;b++)d[b]&&d[b].finish&&d[b].finish.call(this);delete c.finish})}});l.each({slideDown:B("show"),slideUp:B("hide"),slideToggle:B("toggle"),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(a,b){l.fn[a]=function(a,c,d){return this.animate(b,a,c,d)}});l.speed=function(a,b,c){var d=a&&"object"==typeof a?l.extend({},
a):{complete:c||!c&&b||l.isFunction(a)&&a,duration:a,easing:c&&b||b&&!l.isFunction(b)&&b};return d.duration=l.fx.off?0:"number"==typeof d.duration?d.duration:d.duration in l.fx.speeds?l.fx.speeds[d.duration]:l.fx.speeds._default,(null==d.queue||!0===d.queue)&&(d.queue="fx"),d.old=d.complete,d.complete=function(){l.isFunction(d.old)&&d.old.call(this);d.queue&&l.dequeue(this,d.queue)},d};l.easing={linear:function(a){return a},swing:function(a){return 0.5-Math.cos(a*Math.PI)/2}};l.timers=[];l.fx=E.prototype.init;
l.fx.tick=function(){var a,b=l.timers,d=0;for(Ea=l.now();b.length>d;d++)a=b[d],a()||b[d]!==a||b.splice(d--,1);b.length||l.fx.stop();Ea=c};l.fx.timer=function(a){a()&&l.timers.push(a)&&l.fx.start()};l.fx.interval=13;l.fx.start=function(){eb||(eb=setInterval(l.fx.tick,l.fx.interval))};l.fx.stop=function(){clearInterval(eb);eb=null};l.fx.speeds={slow:600,fast:200,_default:400};l.fx.step={};l.expr&&l.expr.filters&&(l.expr.filters.animated=function(a){return l.grep(l.timers,function(b){return a===b.elem}).length});
l.fn.offset=function(a){if(arguments.length)return a===c?this:this.each(function(b){l.offset.setOffset(this,a,b)});var b,d,e={top:0,left:0},f=this[0],h=f&&f.ownerDocument;if(h)return b=h.documentElement,l.contains(b,f)?(typeof f.getBoundingClientRect!==Q&&(e=f.getBoundingClientRect()),d=K(h),{top:e.top+(d.pageYOffset||b.scrollTop)-(b.clientTop||0),left:e.left+(d.pageXOffset||b.scrollLeft)-(b.clientLeft||0)}):e};l.offset={setOffset:function(a,b,c){var d=l.css(a,"position");"static"===d&&(a.style.position=
"relative");var e=l(a),f=e.offset(),h=l.css(a,"top"),g=l.css(a,"left"),k={},n={},m,r;("absolute"===d||"fixed"===d)&&-1<l.inArray("auto",[h,g])?(n=e.position(),m=n.top,r=n.left):(m=parseFloat(h)||0,r=parseFloat(g)||0);l.isFunction(b)&&(b=b.call(a,c,f));null!=b.top&&(k.top=b.top-f.top+m);null!=b.left&&(k.left=b.left-f.left+r);"using"in b?b.using.call(a,k):e.css(k)}};l.fn.extend({position:function(){if(this[0]){var a,b,c={top:0,left:0},d=this[0];return"fixed"===l.css(d,"position")?b=d.getBoundingClientRect():
(a=this.offsetParent(),b=this.offset(),l.nodeName(a[0],"html")||(c=a.offset()),c.top+=l.css(a[0],"borderTopWidth",!0),c.left+=l.css(a[0],"borderLeftWidth",!0)),{top:b.top-c.top-l.css(d,"marginTop",!0),left:b.left-c.left-l.css(d,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var a=this.offsetParent||F.documentElement;a&&!l.nodeName(a,"html")&&"static"===l.css(a,"position");)a=a.offsetParent;return a||F.documentElement})}});l.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},
function(a,b){var d=/Y/.test(b);l.fn[a]=function(e){return l.access(this,function(a,e,f){var h=K(a);return f===c?h?b in h?h[b]:h.document.documentElement[e]:a[e]:(h?h.scrollTo(d?l(h).scrollLeft():f,d?f:l(h).scrollTop()):a[e]=f,c)},a,e,arguments.length,null)}});l.each({Height:"height",Width:"width"},function(a,b){l.each({padding:"inner"+a,content:b,"":"outer"+a},function(d,e){l.fn[e]=function(e,f){var h=arguments.length&&(d||"boolean"!=typeof e),g=d||(!0===e||!0===f?"margin":"border");return l.access(this,
function(b,d,e){var f;return l.isWindow(b)?b.document.documentElement["client"+a]:9===b.nodeType?(f=b.documentElement,Math.max(b.body["scroll"+a],f["scroll"+a],b.body["offset"+a],f["offset"+a],f["client"+a])):e===c?l.css(b,d,g):l.style(b,d,e,g)},b,h?e:c,h,null)}})});a.jQuery=a.$=l;"function"==typeof define&&define.amd&&define.amd.jQuery&&define("jquery",[],function(){return l})})(window);
...
(function(a,c){function b(b,c){var e,k,q,u=b.nodeName.toLowerCase();return"area"===u?(e=b.parentNode,k=e.name,b.href&&k&&"map"===e.nodeName.toLowerCase()?(q=a("img[usemap=#"+k+"]")[0],!!q&&d(q)):!1):(/input|select|textarea|button|object/.test(u)?!b.disabled:"a"===u?b.href||c:c)&&d(b)}function d(b){return a.expr.filters.visible(b)&&!a(b).parents().addBack().filter(function(){return"hidden"===a.css(this,"visibility")}).length}var e=0,k=/^ui-id-\d+$/;a.ui=a.ui||{};a.extend(a.ui,{version:"1.10.3",keyCode:{BACKSPACE:8,
...
e;for(b=a(this[0]);b.length&&b[0]!==document;){if(d=b.css("position"),("absolute"===d||"relative"===d||"fixed"===d)&&(e=parseInt(b.css("zIndex"),10),!isNaN(e)&&0!==e))return e;b=b.parent()}}return 0},uniqueId:function(){return this.each(function(){this.id||(this.id="ui-id-"+ ++e)})},removeUniqueId:function(){return this.each(function(){k.test(this.id)&&a(this).removeAttr("id")})}});a.extend(a.expr[":"],{data:a.expr.createPseudo?a.expr.createPseudo(function(b){return function(c){return!!a.data(c,b)}}):
function(b,c,d){return!!a.data(b,d[3])},focusable:function(c){return b(c,!isNaN(a.attr(c,"tabindex")))},tabbable:function(c){var d=a.attr(c,"tabindex"),e=isNaN(d);return(e||0<=d)&&b(c,!e)}});a("<a>").outerWidth(1).jquery||a.each(["Width","Height"],function(b,d){function e(b,c,d,f){return a.each(k,function(){c-=parseFloat(a.css(b,"padding"+this))||0;d&&(c-=parseFloat(a.css(b,"border"+this+"Width"))||0);f&&(c-=parseFloat(a.css(b,"margin"+this))||0)}),c}var k="Width"===d?["Left","Right"]:["Top","Bottom"],
...
elemHeight:q,collisionPosition:d,collisionWidth:G,collisionHeight:R,offset:[e[0]+E[0],e[1]+E[1]],my:c.my,at:c.at,within:y,elem:n})});c.using&&(f=function(a){var b=L.left-w.left,d=b+t-m,e=L.top-w.top,f=e+z-q,g={target:{element:p,left:L.left,top:L.top,width:t,height:z},element:{element:n,left:w.left,top:w.top,width:m,height:q},horizontal:0>d?"left":0<b?"right":"center",vertical:0>f?"top":0<e?"bottom":"middle"};m>t&&t>h(b+d)&&(g.horizontal="center");q>z&&z>h(e+f)&&(g.vertical="middle");g.important=k(h(b),
h(d))>k(h(e),h(f))?"horizontal":"vertical";c.using.call(this,a,g)});n.offset(a.extend(w,{using:f}))})};a.ui.position={fit:{left:function(a,b){var c,d=b.within,e=d.isWindow?d.scrollLeft:d.offset.left,d=d.width,f=a.left-b.collisionPosition.marginLeft,g=e-f,h=f+b.collisionWidth-d-e;b.collisionWidth>d?0<g&&0>=h?(c=a.left+g+b.collisionWidth-d-e,a.left+=g-c):a.left=0<h&&0>=g?e:g>h?e+d-b.collisionWidth:e:0<g?a.left+=g:0<h?a.left-=h:a.left=k(a.left-f,a.left)},top:function(a,b){var c,d=b.within,d=d.isWindow?
d.scrollTop:d.offset.top,e=b.within.height,f=a.top-b.collisionPosition.marginTop,g=d-f,h=f+b.collisionHeight-e-d;b.collisionHeight>e?0<g&&0>=h?(c=a.top+g+b.collisionHeight-e-d,a.top+=g-c):a.top=0<h&&0>=g?d:g>h?d+e-b.collisionHeight:d:0<g?a.top+=g:0<h?a.top-=h:a.top=k(a.top-f,a.top)}},flip:{left:function(a,b){var c,d,e=b.within,f=e.offset.left+e.scrollLeft,g=e.width,e=e.isWindow?e.scrollLeft:e.offset.left,k=a.left-b.collisionPosition.marginLeft,n=k-e,k=k+b.collisionWidth-g-e,m="left"===b.my[0]?-b.elemWidth:
"right"===b.my[0]?b.elemWidth:0,q="left"===b.at[0]?b.targetWidth:"right"===b.at[0]?-b.targetWidth:0,u=-2*b.offset[0];0>n?(c=a.left+m+q+u+b.collisionWidth-g-f,(0>c||h(n)>c)&&(a.left+=m+q+u)):0<k&&(d=a.left-b.collisionPosition.marginLeft+m+q+u-e,(0<d||k>h(d))&&(a.left+=m+q+u))},top:function(a,b){var c,d,e=b.within,f=e.offset.top+e.scrollTop,g=e.height,e=e.isWindow?e.scrollTop:e.offset.top,k=a.top-b.collisionPosition.marginTop,n=k-e,k=k+b.collisionHeight-g-e,m="top"===b.my[1]?-b.elemHeight:"bottom"===
b.my[1]?b.elemHeight:0,q="top"===b.at[1]?b.targetHeight:"bottom"===b.at[1]?-b.targetHeight:0,u=-2*b.offset[1];0>n?(d=a.top+m+q+u+b.collisionHeight-g-f,a.top+m+q+u>n&&(0>d||h(n)>d)&&(a.top+=m+q+u)):0<k&&(c=a.top-b.collisionPosition.marginTop+m+q+u-e,a.top+m+q+u>k&&(0<c||k>h(c))&&(a.top+=m+q+u))}},flipfit:{left:function(){a.ui.position.flip.left.apply(this,arguments);a.ui.position.fit.left.apply(this,arguments)},top:function(){a.ui.position.flip.top.apply(this,arguments);a.ui.position.fit.top.apply(this,
...
b[3]&&(m=b[3]+this.offset.click.top)),h.grid&&(e=h.grid[1]?this.originalPageY+Math.round((m-this.originalPageY)/h.grid[1])*h.grid[1]:this.originalPageY,m=b?e-this.offset.click.top>=b[1]||e-this.offset.click.top>b[3]?e:e-this.offset.click.top>=b[1]?e-h.grid[1]:e+h.grid[1]:e,k=h.grid[0]?this.originalPageX+Math.round((f-this.originalPageX)/h.grid[0])*h.grid[0]:this.originalPageX,f=b?k-this.offset.click.left>=b[0]||k-this.offset.click.left>b[2]?k:k-this.offset.click.left>=b[0]?k-h.grid[0]:k+h.grid[0]:
k)),{top:m-this.offset.click.top-this.offset.relative.top-this.offset.parent.top+("fixed"===this.cssPosition?-this.scrollParent.scrollTop():this.offset.scroll.top),left:f-this.offset.click.left-this.offset.relative.left-this.offset.parent.left+("fixed"===this.cssPosition?-this.scrollParent.scrollLeft():this.offset.scroll.left)}},_clear:function(){this.helper.removeClass("ui-draggable-dragging");this.helper[0]===this.element[0]||this.cancelHelperRemoval||this.helper.remove();this.helper=null;this.cancelHelperRemoval=
...
top:e.top,left:e.left})})},drag:function(c,b){var d,e,k,h,g,f,m,q,u,s,n=a(this).data("ui-draggable"),r=n.options,v=r.snapTolerance,t=b.offset.left,z=t+n.helperProportions.width,L=b.offset.top,D=L+n.helperProportions.height;for(u=n.snapElements.length-1;0<=u;u--)g=n.snapElements[u].left,f=g+n.snapElements[u].width,m=n.snapElements[u].top,q=m+n.snapElements[u].height,g-v>z||t>f+v||m-v>D||L>q+v||!a.contains(n.snapElements[u].item.ownerDocument,n.snapElements[u].item)?(n.snapElements[u].snapping&&n.options.snap.release&&
n.options.snap.release.call(n.element,c,a.extend(n._uiHash(),{snapItem:n.snapElements[u].item})),n.snapElements[u].snapping=!1):("inner"!==r.snapMode&&(d=v>=Math.abs(m-D),e=v>=Math.abs(q-L),k=v>=Math.abs(g-z),h=v>=Math.abs(f-t),d&&(b.position.top=n._convertPositionTo("relative",{top:m-n.helperProportions.height,left:0}).top-n.margins.top),e&&(b.position.top=n._convertPositionTo("relative",{top:q,left:0}).top-n.margins.top),k&&(b.position.left=n._convertPositionTo("relative",{top:0,left:g-n.helperProportions.width}).left-
n.margins.left),h&&(b.position.left=n._convertPositionTo("relative",{top:0,left:f}).left-n.margins.left)),s=d||e||k||h,"outer"!==r.snapMode&&(d=v>=Math.abs(m-L),e=v>=Math.abs(q-D),k=v>=Math.abs(g-t),h=v>=Math.abs(f-z),d&&(b.position.top=n._convertPositionTo("relative",{top:m,left:0}).top-n.margins.top),e&&(b.position.top=n._convertPositionTo("relative",{top:q-n.helperProportions.height,left:0}).top-n.margins.top),k&&(b.position.left=n._convertPositionTo("relative",{top:0,left:g}).left-n.margins.left),
h&&(b.position.left=n._convertPositionTo("relative",{top:0,left:f-n.helperProportions.width}).left-n.margins.left)),!n.snapElements[u].snapping&&(d||e||k||h||s)&&n.options.snap.snap&&n.options.snap.snap.call(n.element,c,a.extend(n._uiHash(),{snapItem:n.snapElements[u].item})),n.snapElements[u].snapping=d||e||k||h||s)}});a.ui.plugin.add("draggable","stack",{start:function(){var c,b=this.data("ui-draggable").options,b=a.makeArray(a(b.stack)).sort(function(b,c){return(parseInt(a(b).css("zIndex"),10)||
...
this},_mouseCapture:function(b){var c,k,h=!1;for(c in this.handles)k=a(this.handles[c])[0],(k===b.target||a.contains(k,b.target))&&(h=!0);return!this.options.disabled&&h},_mouseStart:function(b){var e,k,h,g=this.options,f=this.element.position(),m=this.element;return this.resizing=!0,/absolute/.test(m.css("position"))?m.css({position:"absolute",top:m.css("top"),left:m.css("left")}):m.is(".ui-draggable")&&m.css({position:"absolute",top:f.top,left:f.left}),this._renderProxy(),e=c(this.helper.css("left")),
k=c(this.helper.css("top")),g.containment&&(e+=a(g.containment).scrollLeft()||0,k+=a(g.containment).scrollTop()||0),this.offset=this.helper.offset(),this.position={left:e,top:k},this.size=this._helper?{width:m.outerWidth(),height:m.outerHeight()}:{width:m.width(),height:m.height()},this.originalSize=this._helper?{width:m.outerWidth(),height:m.outerHeight()}:{width:m.width(),height:m.height()},this.originalPosition={left:e,top:k},this.sizeDiff={width:m.outerWidth()-m.width(),height:m.outerHeight()-
m.height()},this.originalMousePosition={left:b.pageX,top:b.pageY},this.aspectRatio="number"==typeof g.aspectRatio?g.aspectRatio:this.originalSize.width/this.originalSize.height||1,h=a(".ui-resizable-"+this.axis).css("cursor"),a("body").css("cursor","auto"===h?this.axis+"-resize":h),m.addClass("ui-resizable-resizing"),this._propagate("start",b),!0},_mouseDrag:function(b){var c,k=this.helper,h={},g=this.originalMousePosition,f=this.position.top,m=this.position.left,q=this.size.width,u=this.size.height,
s=b.pageX-g.left||0,g=b.pageY-g.top||0,n=this._change[this.axis];return n?(c=n.apply(this,[b,s,g]),this._updateVirtualBoundaries(b.shiftKey),(this._aspectRatio||b.shiftKey)&&(c=this._updateRatio(c,b)),c=this._respectSize(c,b),this._updateCache(c),this._propagate("resize",b),this.position.top!==f&&(h.top=this.position.top+"px"),this.position.left!==m&&(h.left=this.position.left+"px"),this.size.width!==q&&(h.width=this.size.width+"px"),this.size.height!==u&&(h.height=this.size.height+"px"),k.css(h),
!this._helper&&this._proportionallyResizeElements.length&&this._proportionallyResize(),a.isEmptyObject(h)||this._trigger("resize",b,this.ui()),!1):!1},_mouseStop:function(b){this.resizing=!1;var c,k,h,g,f,m,q,u=this.options;return this._helper&&(c=this._proportionallyResizeElements,k=c.length&&/textarea/i.test(c[0].nodeName),h=k&&a.ui.hasScroll(c[0],"left")?0:this.sizeDiff.height,g=k?0:this.sizeDiff.width,f={width:this.helper.width()-g,height:this.helper.height()-h},m=parseInt(this.element.css("left"),
...
(f.size.width=f.parentData.width-c,b&&(f.size.height=f.size.width/f.aspectRatio));k+f.size.height>=f.parentData.height&&(f.size.height=f.parentData.height-k,b&&(f.size.width=f.size.height*f.aspectRatio))},stop:function(){var b=a(this).data("ui-resizable"),c=b.options,k=b.containerOffset,h=b.containerPosition,g=b.containerElement,f=a(b.helper),m=f.offset(),q=f.outerWidth()-b.sizeDiff.width,f=f.outerHeight()-b.sizeDiff.height;b._helper&&!c.animate&&/relative/.test(g.css("position"))&&a(this).css({left:m.left-
h.left-k.left,width:q,height:f});b._helper&&!c.animate&&/static/.test(g.css("position"))&&a(this).css({left:m.left-h.left-k.left,width:q,height:f})}});a.ui.plugin.add("resizable","alsoResize",{start:function(){var b=a(this).data("ui-resizable").options,c=function(b){a(b).each(function(){var b=a(this);b.data("ui-resizable-alsoresize",{width:parseInt(b.width(),10),height:parseInt(b.height(),10),left:parseInt(b.css("left"),10),top:parseInt(b.css("top"),10)})})};"object"!=typeof b.alsoResize||b.alsoResize.parentNode?
c(b.alsoResize):b.alsoResize.length?(b.alsoResize=b.alsoResize[0],c(b.alsoResize)):a.each(b.alsoResize,function(a){c(a)})},resize:function(b,c){var k=a(this).data("ui-resizable"),h=k.options,g=k.originalSize,f=k.originalPosition,m={height:k.size.height-g.height||0,width:k.size.width-g.width||0,top:k.position.top-f.top||0,left:k.position.left-f.left||0},q=function(b,d){a(b).each(function(){var b=a(this),f=a(this).data("ui-resizable-alsoresize"),g={},h=d&&d.length?d:b.parents(c.originalElement[0]).length?
["width","height"]:["width","height","top","left"];a.each(h,function(a,b){var c=(f[b]||0)+(m[b]||0);c&&0<=c&&(g[b]=c||null)});b.css(g)})};"object"!=typeof h.alsoResize||h.alsoResize.nodeType?q(h.alsoResize):a.each(h.alsoResize,function(a,b){q(a,b)})},stop:function(){a(this).removeData("resizable-alsoresize")}});a.ui.plugin.add("resizable","ghost",{start:function(){var b=a(this).data("ui-resizable"),c=b.options,k=b.size;b.ghost=b.originalElement.clone();b.ghost.css({opacity:0.25,display:"block",position:"relative",
height:k.height,width:k.width,margin:0,left:0,top:0}).addClass("ui-resizable-ghost").addClass("string"==typeof c.ghost?c.ghost:"");b.ghost.appendTo(b.helper)},resize:function(){var b=a(this).data("ui-resizable");b.ghost&&b.ghost.css({position:"relative",height:b.size.height,width:b.size.width})},stop:function(){var b=a(this).data("ui-resizable");b.ghost&&b.helper&&b.helper.get(0).removeChild(b.ghost.get(0))}});a.ui.plugin.add("resizable","grid",{resize:function(){var b=a(this).data("ui-resizable"),
c=b.options,k=b.size,h=b.originalSize,g=b.originalPosition,f=b.axis,m="number"==typeof c.grid?[c.grid,c.grid]:c.grid,q=m[0]||1,u=m[1]||1,s=Math.round((k.width-h.width)/q)*q,k=Math.round((k.height-h.height)/u)*u,n=h.width+s,h=h.height+k,r=c.maxWidth&&n>c.maxWidth,v=c.maxHeight&&h>c.maxHeight,t=c.minWidth&&c.minWidth>n,z=c.minHeight&&c.minHeight>h;c.grid=m;t&&(n+=q);z&&(h+=u);r&&(n-=q);v&&(h-=u);/^(se|s|e)$/.test(f)?(b.size.width=n,b.size.height=h):/^(ne)$/.test(f)?(b.size.width=n,b.size.height=h,b.position.top=
g.top-k):/^(sw)$/.test(f)?(b.size.width=n,b.size.height=h,b.position.left=g.left-s):(b.size.width=n,b.size.height=h,b.position.top=g.top-k,b.position.left=g.left-s)}})})(jQuery);
...
!1):void 0}))},_mouseDrag:function(c){if(this.dragged=!0,!this.options.disabled){var b,d=this,e=this.options,k=this.opos[0],h=this.opos[1],g=c.pageX,f=c.pageY;return k>g&&(b=g,g=k,k=b),h>f&&(b=f,f=h,h=b),this.helper.css({left:k,top:h,width:g-k,height:f-h}),this.selectees.each(function(){var b=a.data(this,"selectable-item"),q=!1;b&&b.element!==d.element[0]&&("touch"===e.tolerance?q=!(b.left>g||k>b.right||b.top>f||h>b.bottom):"fit"===e.tolerance&&(q=b.left>k&&g>b.right&&b.top>h&&f>b.bottom),q?(b.selected&&
...
h=k+this.helperProportions.height,g=a.left,f=g+a.width,m=a.top,q=m+a.height,u=this.offset.click.top,s=this.offset.click.left,s="y"===this.options.axis||c+s>g&&f>c+s,u=("x"===this.options.axis||k+u>m&&q>k+u)&&s;return"pointer"===this.options.tolerance||this.options.forcePointerForContainers||"pointer"!==this.options.tolerance&&this.helperProportions[this.floating?"width":"height"]>a[this.floating?"width":"height"]?u:c+this.helperProportions.width/2>g&&f>e-this.helperProportions.width/2&&k+this.helperProportions.height/
2>m&&q>h-this.helperProportions.height/2},_intersectsWithPointer:function(a){var c="y"===this.options.axis||this.positionAbs.left+this.offset.click.left>a.left&&a.left+a.width>this.positionAbs.left+this.offset.click.left;a=("x"===this.options.axis||this.positionAbs.top+this.offset.click.top>a.top&&a.top+a.height>this.positionAbs.top+this.offset.click.top)&&c;var c=this._getDragVerticalDirection(),e=this._getDragHorizontalDirection();return a?this.floating?e&&"right"===e||"down"===c?2:1:c&&("down"===
...
for(b=g.length-1;0<=b;b--)g[b][0].each(function(){h.push(this)});return a(h)},_removeCurrentsFromItems:function(){var b=this.currentItem.find(":data("+this.widgetName+"-item)");this.items=a.grep(this.items,function(a){for(var c=0;b.length>c;c++)if(b[c]===a.item[0])return!1;return!0})},_refreshItems:function(b){this.items=[];this.containers=[this];var c,e,k,h,g,f=this.items,m=[[a.isFunction(this.options.items)?this.options.items.call(this.element[0],b,{item:this.currentItem}):a(this.options.items,
this.element),this]];if((g=this._connectWith())&&this.ready)for(c=g.length-1;0<=c;c--)for(k=a(g[c]),e=k.length-1;0<=e;e--)(h=a.data(k[e],this.widgetFullName))&&h!==this&&!h.options.disabled&&(m.push([a.isFunction(h.options.items)?h.options.items.call(h.element[0],b,{item:this.currentItem}):a(h.options.items,h.element),h]),this.containers.push(h));for(c=m.length-1;0<=c;c--)for(b=m[c][1],k=m[c][0],e=0,g=k.length;g>e;e++)h=a(k[e]),h.data(this.widgetName+"-item",b),f.push({item:h,instance:b,width:0,height:0,
...
k=null;h=(u=e.floating||c(this.currentItem))?"left":"top";g=u?"width":"height";f=this.positionAbs[h]+this.offset.click[h];for(e=this.items.length-1;0<=e;e--)a.contains(this.containers[s].element[0],this.items[e].item[0])&&this.items[e].item[0]!==this.currentItem[0]&&(!u||this.positionAbs.top+this.offset.click.top>this.items[e].top&&this.items[e].top+this.items[e].height>this.positionAbs.top+this.offset.click.top)&&(m=this.items[e].item.offset()[h],q=!1,Math.abs(m-f)>Math.abs(m+this.items[e][g]-f)&&
(q=!0,m+=this.items[e][g]),d>Math.abs(m-f)&&(d=Math.abs(m-f),k=this.items[e],this.direction=q?"up":"down"));(k||this.options.dropOnEmpty)&&this.currentContainer!==this.containers[s]&&(k?this._rearrange(b,k,null,!0):this._rearrange(b,null,this.containers[s].element,!0),this._trigger("change",b,this._uiHash()),this.containers[s]._trigger("change",b,this._uiHash(this)),this.currentContainer=this.containers[s],this.options.placeholder.update(this.currentContainer,this.placeholder),this.containers[s]._trigger("over",
...
e+this.offset.parent.left*e-("fixed"===this.cssPosition?-this.scrollParent.scrollLeft():h?0:k.scrollLeft())*e}},_generatePosition:function(b){var c,e,k=this.options,h=b.pageX,g=b.pageY,f="absolute"!==this.cssPosition||this.scrollParent[0]!==document&&a.contains(this.scrollParent[0],this.offsetParent[0])?this.scrollParent:this.offsetParent,m=/(html|body)/i.test(f[0].tagName);return"relative"!==this.cssPosition||this.scrollParent[0]!==document&&this.scrollParent[0]!==this.offsetParent[0]||(this.offset.relative=
...
f="horizontal"==k?"width":"height",k="horizontal"==k?"left":"top",m=g-h;0<=m?b.css(f,m).css(k,h):b.css(k,g).css(f,-m)}}},ValidateEmail=function(a){return/\S+@\S+\.\S+/.test(a)},ParseQueryString=function(){for(var a={},c,b=/\+/g,d=/([^&=]+)=?([^&]*)/g,e=window.location.search.substring(1);c=d.exec(e);)a[decodeURIComponent(c[1].replace(b," "))]=decodeURIComponent(c[2].replace(b," "));return a},Permalink=function(a){return a?a.toLowerCase().replace(/[^a-z0-9- _\.]/gi,"").replace(/ /g,"_"):""};
...
(function(a,c,b){function d(a,b,c){for(var d=[],e=0;e<a.length;e++){var f=tinycolor(a[e]),g=0.5>f.toHsl().l?"sp-thumb-el sp-thumb-dark":"sp-thumb-el sp-thumb-light",g=g+(tinycolor.equals(b,a[e])?" sp-thumb-active":""),h=v?"background-color:"+f.toRgbString():"filter:"+f.toFilter();d.push('<span title="'+f.toRgbString()+'" data-color="'+f.toRgbString()+'" class="'+g+'"><span class="sp-thumb-inner" style="'+h+';" /></span>')}return"<div class='sp-cf "+c+"'>"+d.join("")+"</div>"}function e(a,b){var d=
c.extend({},s,a);d.callbacks={move:m(d.move,b),change:m(d.change,b),show:m(d.show,b),hide:m(d.hide,b),beforeShow:m(d.beforeShow,b)};return d}function k(g,k){function m(){P.toggleClass("sp-flat",x);P.toggleClass("sp-input-disabled",!A.showInput);P.toggleClass("sp-alpha-enabled",A.showAlpha);P.toggleClass("sp-buttons-disabled",!A.showButtons||x);P.toggleClass("sp-palette-disabled",!A.showPalette);P.toggleClass("sp-palette-only",A.showPaletteOnly);P.toggleClass("sp-initial-disabled",!A.showInitial);
...
q?"rgb("+v(n)+", "+v(m)+", "+v(r)+")":"rgba("+v(n)+", "+v(m)+", "+v(r)+", "+q+")"},toName:function(){return B[g(n,m,r)]||!1},toFilter:function(a,c){var d=g(n,m,r,!0),e=d,f=Math.round(255*w(q)).toString(16),h=f,t=a&&a.gradientType?"GradientType = 1, ":"";c&&(h=b(c),e=h.toHex(),h=Math.round(255*w(h.alpha)).toString(16));return"progid:DXImageTransform.Microsoft.gradient("+t+"startColorstr=#"+k(f)+d+",endColorstr=#"+k(h)+e+")"},toString:function(a){a=a||this.format;var b=!1;"rgb"===a&&(b=this.toRgbString());
"hex"===a&&(b=this.toHexString());"hex6"===a&&(b=this.toHexString(!0));"name"===a&&(b=this.toName());"hsl"===a&&(b=this.toHslString());"hsv"===a&&(b=this.toHsvString());return b||this.toHexString(!0)}}}function c(a){var b={r:0,g:0,b:0},d=1,f=!1,g=!1;if("string"==typeof a)a:{a=a.replace(n,"").replace(m,"").toLowerCase();var k=!1;if(E[a])a=E[a],k=!0;else if("transparent"==a){a={r:0,g:0,b:0,a:0};break a}var t;a=(t=s.rgb.exec(a))?{r:t[1],g:t[2],b:t[3]}:(t=s.rgba.exec(a))?{r:t[1],g:t[2],b:t[3],a:t[4]}:
(t=s.hsl.exec(a))?{h:t[1],s:t[2],l:t[3]}:(t=s.hsla.exec(a))?{h:t[1],s:t[2],l:t[3],a:t[4]}:(t=s.hsv.exec(a))?{h:t[1],s:t[2],v:t[3]}:(t=s.hex6.exec(a))?{r:parseInt(t[1],16),g:parseInt(t[2],16),b:parseInt(t[3],16),format:k?"name":"hex"}:(t=s.hex3.exec(a))?{r:parseInt(t[1]+""+t[1],16),g:parseInt(t[2]+""+t[2],16),b:parseInt(t[3]+""+t[3],16),format:k?"name":"hex"}:!1}if("object"==typeof a){if(a.hasOwnProperty("r")&&a.hasOwnProperty("g")&&a.hasOwnProperty("b"))b={r:255*h(a.r,255),g:255*h(a.g,255),b:255*
h(a.b,255)},f=!0,g="rgb";else if(a.hasOwnProperty("h")&&a.hasOwnProperty("s")&&a.hasOwnProperty("v")){var g=a.h,k=a.s,b=a.v,g=6*h(g,360),k=h(k,100),b=h(b,100),f=r.floor(g),w=g-f,g=b*(1-k);t=b*(1-w*k);k=b*(1-(1-w)*k);f%=6;b={r:255*[b,t,g,g,k,b][f],g:255*[k,b,b,t,g,g][f],b:255*[g,g,k,b,b,t][f]};f=!0;g="hsv"}else a.hasOwnProperty("h")&&(a.hasOwnProperty("s")&&a.hasOwnProperty("l"))&&(b=e(a.h,a.s,a.l),f=!0,g="hsl");a.hasOwnProperty("a")&&(d=a.a)}b.r=q(255,z(b.r,0));b.g=q(255,z(b.g,0));b.b=q(255,z(b.b,
0));1>b.r&&(b.r=v(b.r));1>b.g&&(b.g=v(b.g));1>b.b&&(b.b=v(b.b));return{ok:f,format:a&&a.format||g,r:b.r,g:b.g,b:b.b,a:d}}function d(a,b,c){a=h(a,255);b=h(b,255);c=h(c,255);var e=z(a,b,c),f=q(a,b,c),g,k=(e+f)/2;if(e==f)g=f=0;else{var n=e-f,f=0.5<k?n/(2-e-f):n/(e+f);switch(e){case a:g=(b-c)/n+(b<c?6:0);break;case b:g=(c-a)/n+2;break;case c:g=(a-b)/n+4}g/=6}return{h:g,s:f,l:k}}function e(a,b,c){function d(a,b,c){0>c&&(c+=1);1<c&&(c-=1);return c<1/6?a+6*(b-a)*c:0.5>c?b:c<2/3?a+6*(b-a)*(2/3-c):a}a=h(a,
360);b=h(b,100);c=h(c,100);if(0===b)c=b=a=c;else{var f=0.5>c?c*(1+b):c+b-c*b,g=2*c-f;c=d(g,f,a+1/3);b=d(g,f,a);a=d(g,f,a-1/3)}return{r:255*c,g:255*b,b:255*a}}function f(a,b,c){a=h(a,255);b=h(b,255);c=h(c,255);var d=z(a,b,c),e=q(a,b,c),g,k=d-e;if(d==e)g=0;else{switch(d){case a:g=(b-c)/k+(b<c?6:0);break;case b:g=(c-a)/k+2;break;case c:g=(a-b)/k+4}g/=6}return{h:g,s:0===d?0:k/d,v:d}}function g(a,b,c,d){a=[k(v(a).toString(16)),k(v(b).toString(16)),k(v(c).toString(16))];return d||a[0].charAt(0)!=a[0].charAt(1)||
a[1].charAt(0)!=a[1].charAt(1)||a[2].charAt(0)!=a[2].charAt(1)?a.join(""):a[0].charAt(0)+a[1].charAt(0)+a[2].charAt(0)}function h(a,b){"string"==typeof a&&(-1!=a.indexOf(".")&&1===w(a))&&(a="100%");var c="string"===typeof a&&-1!=a.indexOf("%");a=q(b,z(0,w(a)));c&&(a*=b/100);return 1E-6>r.abs(a-b)?1:1<=a?a%b/w(b):a}function k(a){return 1==a.length?"0"+a:""+a}var n=/^[\s,#]+/,m=/\s+$/,t=0,r=Math,v=r.round,q=r.min,z=r.max,u=r.random,w=a.parseFloat;b.fromRatio=function(a){if("object"==typeof a)for(var c in a)1===
...
c.source&&b.global==c.global&&b.multiline==c.multiline&&b.ignoreCase==c.ignoreCase}if("object"!=typeof b||"object"!=typeof c)return!1;for(var g=d.length;g--;)if(d[g]==b)return!0;d.push(b);var g=0,h=!0;if("[object Array]"==e){if(g=b.length,h=g==c.length)for(;g--&&(h=g in b==g in c&&a(b[g],c[g],d)););}else{if("constructor"in b!="constructor"in c||b.constructor!=c.constructor)return!1;for(var k in b)if(p.has(b,k)&&(g++,!(h=p.has(c,k)&&a(b[k],c[k],d))))break;if(h){for(k in c)if(p.has(c,k)&&!g--)break;
h=!g}}d.pop();return h}var c=this,b=c._,d={},e=Array.prototype,k=Object.prototype,h=e.slice,g=e.unshift,f=k.toString,m=k.hasOwnProperty,q=e.forEach,u=e.map,s=e.reduce,n=e.reduceRight,r=e.filter,v=e.every,t=e.some,z=e.indexOf,L=e.lastIndexOf,k=Array.isArray,D=Object.keys,G=Function.prototype.bind,p=function(a){return new H(a)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=p),exports._=p):c._=p;p.VERSION="1.3.3";var y=p.each=p.forEach=function(a,
...
var I=p.some=p.any=function(a,b,c){b||(b=p.identity);var e=!1;if(null==a)return e;if(t&&a.some===t)return a.some(b,c);y(a,function(a,f,g){if(e||(e=b.call(c,a,f,g)))return d});return!!e};p.include=p.contains=function(a,b){var c=!1;return null==a?c:z&&a.indexOf===z?-1!=a.indexOf(b):c=I(a,function(a){return a===b})};p.invoke=function(a,b){var c=h.call(arguments,2);return p.map(a,function(a){return(p.isFunction(b)?b||a:a[b]).apply(a,c)})};p.pluck=function(a,b){return p.map(a,function(a){return a[b]})};
...
return c};p.sortedIndex=function(a,b,c){c||(c=p.identity);for(var d=0,e=a.length;d<e;){var f=d+e>>1;c(a[f])<c(b)?d=f+1:e=f}return d};p.toArray=function(a){return a?p.isArray(a)||p.isArguments(a)?h.call(a):a.toArray&&p.isFunction(a.toArray)?a.toArray():p.values(a):[]};p.size=function(a){return p.isArray(a)?a.length:p.keys(a).length};p.first=p.head=p.take=function(a,b,c){return null==b||c?a[0]:h.call(a,0,b)};p.initial=function(a,b,c){return h.call(a,0,a.length-(null==b||c?1:b))};p.last=function(a,b,
c){return null==b||c?a[a.length-1]:h.call(a,Math.max(a.length-b,0))};p.rest=p.tail=function(a,b,c){return h.call(a,null==b||c?1:b)};p.compact=function(a){return p.filter(a,function(a){return!!a})};p.flatten=function(a,b){return p.reduce(a,function(a,c){if(p.isArray(c))return a.concat(b?c:p.flatten(c));a[a.length]=c;return a},[])};p.without=function(a){return p.difference(a,h.call(arguments,1))};p.uniq=p.unique=function(a,b,c){c=c?p.map(a,c):a;var d=[];3>a.length&&(b=!0);p.reduce(c,function(c,e,f){(b?
p.last(c)===e&&c.length:p.include(c,e))||(c.push(e),d.push(a[f]));return c},[]);return d};p.union=function(){return p.uniq(p.flatten(arguments,!0))};p.intersection=p.intersect=function(a){var b=h.call(arguments,1);return p.filter(p.uniq(a),function(a){return p.every(b,function(b){return 0<=p.indexOf(b,a)})})};p.difference=function(a){var b=p.flatten(h.call(arguments,1),!0);return p.filter(a,function(a){return!p.include(b,a)})};p.zip=function(){for(var a=h.call(arguments),b=p.max(p.pluck(a,"length")),
...
Math.max(Math.ceil((b-a)/c),0),e=0,f=Array(d);e<d;)f[e++]=a,a+=c;return f};var C=function(){};p.bind=function(a,b){var c,d;if(a.bind===G&&G)return G.apply(a,h.call(arguments,1));if(!p.isFunction(a))throw new TypeError;d=h.call(arguments,2);return c=function(){if(!(this instanceof c))return a.apply(b,d.concat(h.call(arguments)));C.prototype=a.prototype;var e=new C,f=a.apply(e,d.concat(h.call(arguments)));return Object(f)===f?f:e}};p.bindAll=function(a){var b=h.call(arguments,1);0==b.length&&(b=p.functions(a));
y(b,function(b){a[b]=p.bind(a[b],a)});return a};p.memoize=function(a,b){var c={};b||(b=p.identity);return function(){var d=b.apply(this,arguments);return p.has(c,d)?c[d]:c[d]=a.apply(this,arguments)}};p.delay=function(a,b){var c=h.call(arguments,2);return setTimeout(function(){return a.apply(null,c)},b)};p.defer=function(a){return p.delay.apply(p,[a,1].concat(h.call(arguments,1)))};p.throttle=function(a,b){var c,d,e,f,g,h,k=p.debounce(function(){g=f=!1},b);return function(){c=this;d=arguments;e||
(e=setTimeout(function(){e=null;g&&a.apply(c,d);k()},b));f?g=!0:h=a.apply(c,d);k();f=!0;return h}};p.debounce=function(a,b,c){var d;return function(){var e=this,f=arguments;c&&!d&&a.apply(e,f);clearTimeout(d);d=setTimeout(function(){d=null;c||a.apply(e,f)},b)}};p.once=function(a){var b=!1,c;return function(){if(b)return c;b=!0;return c=a.apply(this,arguments)}};p.wrap=function(a,b){return function(){var c=[a].concat(h.call(arguments,0));return b.apply(this,c)}};p.compose=function(){var a=arguments;
return function(){for(var b=arguments,c=a.length-1;0<=c;c--)b=[a[c].apply(this,b)];return b[0]}};p.after=function(a,b){return 0>=a?b():function(){if(1>--a)return b.apply(this,arguments)}};p.keys=D||function(a){if(a!==Object(a))throw new TypeError("Invalid object");var b=[],c;for(c in a)p.has(a,c)&&(b[b.length]=c);return b};p.values=function(a){return p.map(a,p.identity)};p.functions=p.methods=function(a){var b=[],c;for(c in a)p.isFunction(a[c])&&b.push(c);return b.sort()};p.extend=function(a){y(h.call(arguments,
1),function(b){for(var c in b)a[c]=b[c]});return a};p.pick=function(a){var b={};y(p.flatten(h.call(arguments,1)),function(c){c in a&&(b[c]=a[c])});return b};p.defaults=function(a){y(h.call(arguments,1),function(b){for(var c in b)null==a[c]&&(a[c]=b[c])});return a};p.clone=function(a){return p.isObject(a)?p.isArray(a)?a.slice():p.extend({},a):a};p.tap=function(a,b){b(a);return a};p.isEqual=function(b,c){return a(b,c,[])};p.isEmpty=function(a){if(null==a)return!0;if(p.isArray(a)||p.isString(a))return 0===
a.length;for(var b in a)if(p.has(a,b))return!1;return!0};p.isElement=function(a){return!(!a||1!=a.nodeType)};p.isArray=k||function(a){return"[object Array]"==f.call(a)};p.isObject=function(a){return a===Object(a)};p.isArguments=function(a){return"[object Arguments]"==f.call(a)};p.isArguments(arguments)||(p.isArguments=function(a){return!(!a||!p.has(a,"callee"))});p.isFunction=function(a){return"[object Function]"==f.call(a)};p.isString=function(a){return"[object String]"==f.call(a)};p.isNumber=function(a){return"[object Number]"==
...
f(s.paragraph)("(?!","(?!"+s.gfm.fences.source.replace(/(^|[^\[])\^/g,"$2")+"|")();s.lexer=function(a){var b=[];b.links={};a=a.replace(/\r\n|\r/g,"\n").replace(/\t/g,"    ");return s.token(a,b,!0)};s.token=function(a,b,c){a=a.replace(/^ +$/gm,"");for(var d,e,f,g,h,k;a;){if(f=s.newline.exec(a))a=a.substring(f[0].length),1<f[0].length&&b.push({type:"space"});if(f=s.code.exec(a))a=a.substring(f[0].length),f=f[0].replace(/^ {4}/gm,""),b.push({type:"code",text:t.pedantic?f:f.replace(/\n+$/,"")});else if(f=
...
0;return f.test(a)?'"'+a.replace(f,function(a){var b=u[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function k(a,b){var c,f,g,h,u=m,G,p=b[a];p instanceof Date&&(p=isFinite(a.valueOf())?a.getUTCFullYear()+"-"+d(a.getUTCMonth()+1)+"-"+d(a.getUTCDate())+"T"+d(a.getUTCHours())+":"+d(a.getUTCMinutes())+":"+d(a.getUTCSeconds())+"Z":null);"function"===typeof s&&(p=s.call(b,a,p));switch(typeof p){case "string":return e(p);case "number":return isFinite(p)?
String(p):"null";case "boolean":case "null":return String(p);case "object":if(!p)return"null";m+=q;G=[];if("[object Array]"===Object.prototype.toString.apply(p)){h=p.length;for(c=0;c<h;c+=1)G[c]=k(c,p)||"null";g=0===G.length?"[]":m?"[\n"+m+G.join(",\n"+m)+"\n"+u+"]":"["+G.join(",")+"]";m=u;return g}if(s&&"object"===typeof s)for(h=s.length,c=0;c<h;c+=1)"string"===typeof s[c]&&(f=s[c],(g=k(f,p))&&G.push(e(f)+(m?": ":":")+g));else for(f in p)Object.prototype.hasOwnProperty.call(p,f)&&(g=k(f,p))&&G.push(e(f)+
(m?": ":":")+g);g=0===G.length?"{}":m?"{\n"+m+G.join(",\n"+m)+"\n"+u+"}":"{"+G.join(",")+"}";m=u;return g}}if(b&&b.parse)return a.JSON={parse:b.parse,stringify:b.stringify};var h=a.JSON={},g=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,f=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,m,q,u={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},
s;h.stringify=function(a,b,c){var d;q=m="";if("number"===typeof c)for(d=0;d<c;d+=1)q+=" ";else"string"===typeof c&&(q=c);if((s=b)&&"function"!==typeof b&&("object"!==typeof b||"number"!==typeof b.length))throw Error("JSON.stringify");return k("",{"":a})};h.parse=function(a,b){function c(a,d){var e,f,g=a[d];if(g&&"object"===typeof g)for(e in g)Object.prototype.hasOwnProperty.call(g,e)&&(f=c(g,e),void 0!==f?g[e]=f:delete g[e]);return b.call(a,d,g)}var d;a=String(a);g.lastIndex=0;g.test(a)&&(a=a.replace(g,
...
k=d.reasons=["transport not supported","client not handshaken","unauthorized"],h=d.advice=["reconnect"],g=b.JSON,f=b.util.indexOf;d.encodePacket=function(a){var b=f(e,a.type),c=a.id||"",d=a.endpoint||"",m=a.ack,v=null;switch(a.type){case "error":var t=a.reason?f(k,a.reason):"";a=a.advice?f(h,a.advice):"";if(""!==t||""!==a)v=t+(""!==a?"+"+a:"");break;case "message":""!==a.data&&(v=a.data);break;case "event":v={name:a.name};a.args&&a.args.length&&(v.args=a.args);v=g.stringify(v);break;case "json":v=
...
{type:e[b[1]],endpoint:b[4]||""};c&&(d.id=c,d.ack=b[3]?"data":!0);switch(d.type){case "error":b=a.split("+");d.reason=k[b[0]]||"";d.advice=h[b[1]]||"";break;case "message":d.data=a||"";break;case "event":try{var f=g.parse(a);d.name=f.name;d.args=f.args}catch(v){}d.args=d.args||[];break;case "json":try{d.data=g.parse(a)}catch(t){}break;case "connect":d.qs=a||"";break;case "ack":if(b=a.match(/^([0-9]+)(\+)?(.*)/))if(d.ackId=b[1],d.args=[],b[3])try{d.args=b[3]?g.parse(b[3]):[]}catch(z){}}return d};d.decodePayload=
...
e,k,u){function s(a){c.transport&&c.transport.clearTimeouts();c.transport=c.getTransport(a);if(!c.transport)return c.publish("connect_failed");c.transport.ready(c,function(){c.connecting=!0;c.publish("connecting",c.transport.name);c.transport.open();c.options["connect timeout"]&&(c.connectTimeoutTimer=setTimeout(function(){if(!c.connected&&(c.connecting=!1,c.options["try multiple transports"])){for(var a=c.transports;0<a.length&&a.splice(0,1)[0]!=c.transport.name;);a.length?s(a):c.publish("connect_failed")}},
...
c)});return this};d.prototype.send=function(){var a=this,c=arguments;WebSocket.__addTask(function(){b.Transport.websocket.prototype.send.apply(a,c)});return this};d.prototype.close=function(){WebSocket.__tasks.length=0;b.Transport.websocket.prototype.close.call(this);return this};d.prototype.ready=function(a,c){function h(){var b=a.options,h=b["flash policy port"],q=["http"+(b.secure?"s":"")+":/",b.host+":"+b.port,b.resource,"static/flashsocket","WebSocketMain"+(a.isXDomain()?"Insecure":"")+".swf"];
d.loaded||("undefined"===typeof WEB_SOCKET_SWF_LOCATION&&(WEB_SOCKET_SWF_LOCATION=q.join("/")),843!==h&&WebSocket.loadFlashPolicyFile("xmlsocket://"+b.host+":"+h),WebSocket.__initialize(),d.loaded=!0);c.call(g)}var g=this;if(document.body)return h();b.util.load(h)};d.check=function(){return"undefined"!=typeof WebSocket&&"__initialize"in WebSocket&&a?10<=a.getFlashPlayerVersion().major:!1};d.xdomainCheck=function(){return!0};"undefined"!=typeof window&&(WEB_SOCKET_DISABLE_AUTO_INITIALIZATION=!0);b.transports.push("flashsocket")})("undefined"!=
...
c=null;k()})()}else k()}function k(){var a=S.length;if(0<a)for(var b=0;b<a;b++){var c=S[b].id,d=S[b].callbackFn,e={success:!1,id:c};if(0<x.pv[0]){var k=n(c);if(k)if(!v(S[b].swfVersion)||x.wk&&312>x.wk)if(S[b].expressInstall&&g()){e={};e.data=S[b].expressInstall;e.width=k.getAttribute("width")||"0";e.height=k.getAttribute("height")||"0";k.getAttribute("class")&&(e.styleclass=k.getAttribute("class"));k.getAttribute("align")&&(e.align=k.getAttribute("align"));for(var t={},k=k.getElementsByTagName("param"),
r=k.length,p=0;p<r;p++)"movie"!=k[p].getAttribute("name").toLowerCase()&&(t[k[p].getAttribute("name")]=k[p].getAttribute("value"));f(e,t,c,d)}else m(k),d&&d(e);else z(c,!0),d&&(e.success=!0,e.ref=h(c),d(e))}else z(c,!0),d&&((c=h(c))&&typeof c.SetVariable!=D&&(e.success=!0,e.ref=c),d(e))}}function h(a){var b=null;(a=n(a))&&"OBJECT"==a.nodeName&&(typeof a.SetVariable!=D?b=a:(a=a.getElementsByTagName(G)[0])&&(b=a));return b}function g(){return!E&&v("6.0.65")&&(x.win||x.mac)&&!(x.wk&&312>x.wk)}function f(a,
...
new (window[["Active"].concat("Object").join("X")])("ShockwaveFlash.ShockwaveFlash");h&&(g=h.GetVariable("$version"))&&(e=!0,g=g.split(" ")[1].split(","),f=[parseInt(g[0],10),parseInt(g[1],10),parseInt(g[2],10)])}catch(k){}return{w3:a,pv:f,wk:b,ie:e,win:d,mac:c}}();(function(){x.w3&&((typeof C.readyState!=D&&"complete"==C.readyState||typeof C.readyState==D&&(C.getElementsByTagName("body")[0]||C.body))&&c(),w||(typeof C.addEventListener!=D&&C.addEventListener("DOMContentLoaded",c,!1),x.ie&&x.win&&
...
for(c=0;c<b;c++)s(ca[c]);for(var d in x)x[d]=null;x=null;for(var e in a)a[e]=null;a=null})})();return{registerObject:function(a,b,c,d){if(x.w3&&a&&b){var e={};e.id=a;e.swfVersion=b;e.expressInstall=c;e.callbackFn=d;S[S.length]=e;z(a,!1)}else d&&d({success:!1,id:a})},getObjectById:function(a){if(x.w3)return h(a)},embedSWF:function(a,c,d,e,h,k,n,m,t,r){var p={success:!1,id:c};x.w3&&!(x.wk&&312>x.wk)&&a&&c&&d&&e&&h?(z(c,!1),b(function(){d+="";e+="";var b={};if(t&&typeof t===G)for(var q in t)b[q]=t[q];
b.data=a;b.width=d;b.height=e;q={};if(m&&typeof m===G)for(var s in m)q[s]=m[s];if(n&&typeof n===G)for(var l in n)q.flashvars=typeof q.flashvars!=D?q.flashvars+("&"+l+"="+n[l]):l+"="+n[l];if(v(h))s=u(b,q,c),b.id==c&&z(c,!0),p.success=!0,p.ref=s;else{if(k&&g()){b.data=k;f(b,q,c,r);return}z(c,!0)}r&&r(p)})):r&&r(p)},switchOffAutoHideShow:function(){A=!1},ua:x,getFlashPlayerVersion:function(){return{major:x.pv[0],minor:x.pv[1],release:x.pv[2]}},hasFlashPlayerVersion:v,createSWF:function(a,b,c){if(x.w3)return u(a,
...
"https":"http"};e.check=function(a,c){try{var e=b.util.request(c),k=d.XDomainRequest&&e instanceof XDomainRequest,q=a&&a.options&&a.options.secure?"https:":"http:",u=d.location&&q!=d.location.protocol;if(e&&(!k||!u))return!0}catch(s){}return!1};e.xdomainCheck=function(a){return e.check(a,!0)}})("undefined"!=typeof io?io.Transport:module.exports,"undefined"!=typeof io?io:module.parent.exports,this);(function(a,b){function d(a){b.Transport.XHR.apply(this,arguments)}a.htmlfile=d;b.util.inherit(d,b.Transport.XHR);
...
e.iframeId+'">')}catch(a){r=document.createElement("iframe"),r.name=e.iframeId}r.id=e.iframeId;e.form.appendChild(r);e.iframe=r}var e=this,k=b.util.query(this.socket.options.query,"t="+ +new Date+"&i="+this.index);if(!this.form){var u=document.createElement("form"),s=document.createElement("textarea"),n=this.iframeId="socketio_iframe_"+this.index,r;u.className="socketio";u.style.position="absolute";u.style.top="0px";u.style.left="0px";u.style.display="none";u.target=n;u.method="POST";u.setAttribute("accept-charset",
"utf-8");s.name="d";u.appendChild(s);document.body.appendChild(u);this.form=u;this.area=s}this.form.action=this.prepareUrl()+k;d();this.area.value=b.JSON.stringify(a);try{this.form.submit()}catch(v){}this.iframe.attachEvent?r.onreadystatechange=function(){"complete"==e.iframe.readyState&&c()}:this.iframe.onload=c;this.socket.setBuffer(!0)};e.prototype.get=function(){var a=this,c=document.createElement("script"),d=b.util.query(this.socket.options.query,"t="+ +new Date+"&i="+this.index);this.script&&
...
a+1E3*n+6E4*k+36E5*g;this._days=f+7*e;this._months=d+12*c;b.milliseconds=a%1E3;n+=h(a/1E3);b.seconds=n%60;k+=h(n/60);b.minutes=k%60;g+=h(k/60);b.hours=g%24;f+=h(g/24);f+=7*e;b.days=f%30;d+=h(f/30);b.months=d%12;c+=h(d/12);b.years=c;this._lang=!1}function h(a){return 0>a?Math.ceil(a):Math.floor(a)}function g(a,b){for(var c=a+"";c.length<b;)c="0"+c;return c}function f(a,b,c){var d=b._milliseconds,e=b._days;b=b._months;var f;d&&a._d.setTime(+a+d*c);e&&a.date(a.date()+e*c);b&&(f=a.date(),a.date(1).month(a.month()+
...
3);y=function(b,c){if(null===b||""===b)return null;var d;if(y.isMoment(b))d=new e(new Date(+b._d),b._isUTC,b._lang);else{if(c)if(m(c)){var f=b.match(H)||[],g,h=99,l,k;for(l=0;l<c.length;l++)k=z(b,c[l]),g=v(new e(k),c[l]).match(H)||[],g=q(f,g),g<h&&(h=g,d=k)}else d=z(b,c);else if(d=ca.exec(b),b===a)d=new Date;else if(d)d=new Date(+d[1]);else if(b instanceof Date)d=b;else if(m(b))d=u(b);else if("string"==typeof b)if(d="YYYY-MM-DDT",x.exec(b)){for(f=0;4>f;f++)if(Q[f][1].exec(b)){d+=Q[f][0];break}d=K.exec(b)?
z(b,d+" Z"):z(b,d)}else d=new Date(b);else d=new Date(b);d=new e(d)}return d};y.utc=function(a,b){return m(a)?new e(u(a,!0),!0):("string"==typeof a&&!K.exec(a)&&(a+=" +0000",b&&(b+=" Z")),y(a,b).utc())};y.unix=function(a){return y(1E3*a)};y.duration=function(a,b){var c=y.isDuration(a),d="number"==typeof a,e=c?a._data:d?{}:a,f;return d&&(b?e[b]=a:e.milliseconds=a),f=new k(e),c&&(f._lang=a._lang),f};y.humanizeDuration=function(a,b,c){return y.duration(a,!0===b?null:b).humanize(!0===b?!0:c)};y.version=
"1.7.2";y.defaultFormat="YYYY-MM-DDTHH:mm:ssZ";y.lang=function(a,b){var c;if(!a)return aa;!b&&J[a]||s(a,b);if(J[a]){for(c=0;c<S.length;c++)y[S[c]]=J[a][S[c]];y.monthsParse=J[a].monthsParse;aa=a}};y.langData=n;y.isMoment=function(a){return a instanceof e};y.isDuration=function(a){return a instanceof k};y.lang("en",{months:"January February March April May June July August September October November December".split(" "),monthsShort:"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),weekdays:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),
...
return f(this,c,-1),this},diff:function(a,b,c){a=this._isUTC?y(a).utc():y(a).local();var d=6E4*(this.zone()-a.zone()),d=this._d-a._d-d,e=this.year()-a.year(),f=this.month()-a.month();a=this.date()-a.date();var g;return"months"===b?g=12*e+f+a/30:"years"===b?g=e+(f+a/30)/12:g="seconds"===b?d/1E3:"minutes"===b?d/6E4:"hours"===b?d/36E5:"days"===b?d/864E5:"weeks"===b?d/6048E5:d,c?g:I(g)},from:function(a,b){return y.duration(this.diff(a)).lang(this._lang).humanize(!b)},fromNow:function(a){return this.from(y(),
...
daysInMonth:function(){return y.utc([this.year(),this.month()+1,0]).date()},lang:function(b){return b===a?n(this):(this._lang=b,this)}};for(C=0;C<fa.length;C++)D(fa[C].toLowerCase(),fa[C]);D("year","FullYear");y.duration.fn=k.prototype={weeks:function(){return h(this.days()/7)},valueOf:function(){return this._milliseconds+864E5*this._days+2592E6*this._months},humanize:function(a){var b=+this,c=this.lang().relativeTime,d;d=!a;var e=this.lang(),f=I(Math.abs(b)/1E3),g=I(f/60),h=I(g/60),k=I(h/24),n=I(k/
365),f=45>f&&["s",f]||1===g&&["m"]||45>g&&["mm",g]||1===h&&["h"]||22>h&&["hh",h]||1===k&&["d"]||25>=k&&["dd",k]||45>=k&&["M"]||345>k&&["MM",I(k/30)]||1===n&&["y"]||["yy",n];d=(f[2]=d,f[3]=0<b,f[4]=e,L.apply({},f));b=0>=b?c.past:c.future;return a&&("function"==typeof b?d=b(d):d=b.replace(/%s/i,d)),d},lang:y.fn.lang};for(C in da)da.hasOwnProperty(C)&&(p(C,da[C]),G(C.toLowerCase()));p("Weeks",6048E5);O&&(module.exports=y);"undefined"==typeof ender&&(this.moment=y);"function"==typeof define&&define.amd&&
...
338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298],g=[1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225],h=Array(64),k,r,v,t,z,L,D,G,p,y,I,C;a[c>>5]|=128<<24-c%
32;a[(c+64>>9<<4)+15]=c;for(p=0;p<a.length;p+=16){k=g[0];r=g[1];v=g[2];t=g[3];z=g[4];L=g[5];D=g[6];G=g[7];for(y=0;64>y;y++)h[y]=16>y?a[y+p]:b(b(b(d(h[y-2],17)^d(h[y-2],19)^h[y-2]>>>10,h[y-7]),d(h[y-15],7)^d(h[y-15],18)^h[y-15]>>>3),h[y-16]),I=b(b(b(b(G,d(z,6)^d(z,11)^d(z,25)),z&L^~z&D),e[y]),h[y]),C=b(d(k,2)^d(k,13)^d(k,22),k&r^k&v^r&v),G=D,D=L,L=z,z=b(t,I),t=v,v=r,r=k,k=b(I,C);g[0]=b(k,g[0]);g[1]=b(r,g[1]);g[2]=b(v,g[2]);g[3]=b(t,g[3]);g[4]=b(z,g[4]);g[5]=b(L,g[5]);g[6]=b(D,g[6]);g[7]=b(G,g[7])}return g},
k=function(a){for(var b=[],d=(1<<c)-1,e=0;e<a.length*c;e+=c)b[e>>5]|=(a.charCodeAt(e/c)&d)<<24-e%32;return b},h=function(a){for(var b="",c=0;c<4*a.length;c++)b+="0123456789abcdef".charAt(a[c>>2]>>8*(3-c%4)+4&15)+"0123456789abcdef".charAt(a[c>>2]>>8*(3-c%4)&15);return b},g=function(b){return b="object"==typeof b?a(b).val():b.toString()};a.extend({sha256:function(a){a=g(a);return h(e(k(a),a.length*c))},sha256hmac:function(a,b){a=g(a);b=g(b);var d,u=a;d=b;var s=k(u);16<s.length&&(s=e(s,u.length*c));
for(var n=Array(16),u=Array(16),r=0;16>r;r++)n[r]=s[r]^909522486,u[r]=s[r]^1549556828;d=e(n.concat(k(d)),512+d.length*c);d=e(u.concat(d),768);return h(d)},sha256config:function(a){c=parseInt(a)||8}});a.fn.sha256=function(b){a.sha256config(b);b=g(a(this).val());b=a.sha256(b);a.sha256config(8);return b}})(jQuery);function Space(a){this.keys=[];this.values={};this.events={};this._load(a);return this}Space.pathBranch=function(a){a=a.split(/ /g);if(2>a.length)return"";a.pop();return a.join(" ")};
...
Space.prototype.prev=function(a){a=this.keys.indexOf(a)-1;return 0<=a?this.keys[a]:this.keys[this.keys.length-1]};Space.prototype._rename=function(a,c){this.values[c]=this.values[a];delete this.values[a];this.keys[this.keys.indexOf(a)]=c;return this};Space.prototype.rename=function(a,c){var b=Space.pathBranch(a),d=Space.pathLeaf(a),e=c,k=this;b&&(k=this.get(b),e=c.substr(b.length+1));k._rename(d,e);a!==c&&this.trigger("rename",a,c);this.trigger("change");return this};
...
(function(a){function c(a){a=String(a);return a.charAt(0).toUpperCase()+a.slice(1)}function b(a,b){var c=-1,d=a.length;if(d==d>>>0)for(;++c<d;)b(a[c],c,a);else e(a,b)}function d(a){a=q(a);return/^(?:webOS|i(?:OS|P))/.test(a)?a:c(a)}function e(a,b){for(var c in a)h(a,c)&&b(a[c],c,a)}function k(a){return null==a?c(a):t.call(a).slice(8,-1)}function h(){h=function(a,b){var c=null!=a&&(a.constructor||Object).prototype;return!!c&&b in Object(a)&&!(b in c&&a[b]===c[b])};"Function"==k(p)?h=function(a,b){return null!=
...
(B=null),(n=K||A||x)&&(K||A||/Android|Symbian OS|Tablet OS|webOS/.test(x))&&(B=/[a-z]+(?: Hat)?/i.exec(/Android/.test(x)?x:n)+" Browser");w||(w=h(["(?:Cloud9|CriOS|CrMo|Opera ?Mini|Raven|Silk(?!/[\\d.]+$))","Version",f(B),"(?:Firefox|Minefield|NetFront)"]));if("iCab"==E&&3<parseFloat(w))E=["WebKit"];else if(n=/Opera/.test(B)&&"Presto"||/\b(?:Midori|Nook|Safari)\b/i.test(b)&&"WebKit"||!E&&/\bMSIE\b/i.test(b)&&(/^Mac/.test(x)?"Tasman":"Trident"))E=[n];if(R){if(g(a,"global"))if(z&&(n=z.lang.System,p=
n.getProperty("os.arch"),x=x||n.getProperty("os.name")+" "+n.getProperty("os.version")),"object"==typeof exports&&exports)if(J==s&&"object"==typeof system&&(n=[system])[0]){x||(x=n[0].os||null);try{n[1]=require("ringo/engine").version,w=n[1].join("."),B="RingoJS"}catch(Q){n[0].global==r&&(B="Narwhal")}}else"object"==typeof process&&(n=process)&&(B="Node.js",p=n.arch,x=n.platform,w=/[\d.]+/.exec(n.version)[0]);else"Environment"==k(a.environment)&&(B="Rhino");else"ScriptBridgingProxyObject"==k(n=a.runtime)?
(B="Adobe AIR",x=n.flash.system.Capabilities.os):"RuntimeObject"==k(n=a.phantom)?(B="PhantomJS",w=(n=n.version||null)&&n.major+"."+n.minor+"."+n.patch):"number"==typeof G.documentMode&&(n=/\bTrident\/(\d+)/i.exec(b))&&(w=[w,G.documentMode],(n=+n[1]+4)!=w[1]&&(H.push("IE "+w[1]+" mode"),E[1]="",w[1]=n),w="IE"==B?String(w[1].toFixed(1)):w[0]);x=x&&d(x)}w&&(n=/(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(w)||/(?:alpha|beta)(?: ?\d)?/i.exec(b+";"+(R&&y.appMinorVersion))||/\bMinefield\b/i.test(b)&&"a")&&
...
global&&(global==global.global?a=global:global),v=/Opera/,t={}.toString,z=/Java/.test(k(a.java))&&a.java,L=z?"a":"\u03b1",D=z?"b":"\u03b2",G=a.document||{},p={}.hasOwnProperty,y=a.navigator||{},I=a.operamini||a.opera,C=v.test(C=k(I))?C:I=null,J=this,aa=y.userAgent||"";"function"==typeof define&&"object"==typeof define.amd&&define.amd?define(function(){return u()}):n?e(u(),function(a,b){n[b]=a}):a.platform=u()})(this);
...
var cssToObject=function(a,c){function b(a){var b=a.match(/\n/g);b&&(y+=b.length);b=a.lastIndexOf("\n");I=~b?a.length-b:I+a.length}function d(){var a={line:y,column:I};return c.position?function(b){b.position={start:a,end:{line:y,column:I}};f(/^\s*/);return b}:e}function e(a){f(/^\s*/);return a}function k(b){b=Error(b+" near line "+y+":"+I);b.line=y;b.column=I;b.source=a;throw b;}function h(){return f(/^{\s*/)}function g(){var b,c=[];f(/^\s*/);for(m(c);"}"!=a[0]&&(b=v()||(z()||t()||G("import")||G("charset")||
...
if(b){b=b[0];if(!f(/^:\s*/))return k("property missing ':'");var c=f(/^((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^\)]*?\)|[^};])+)/);if(!c)return k("property missing value");a=a({type:"declaration",property:b,value:c[0].trim()});f(/^[;\s]*/);return a}}function n(){var a=[];if(!h())return k("missing '{'");m(a);for(var b;b=s();)a.push(b),m(a);return f(/^}/)?a:k("missing '}'")}function r(){for(var a,b=[],c=d();a=f(/^(from|to|\d+%|\.\d+%|\d+\.\d+%)\s*/);)b.push(a[1]),f(/^,\s*/);if(b.length)return c({type:"keyframe",
values:b,declarations:n()})}function v(){var a=d(),b=f(/^@([-\w]+)?keyframes */);if(b){var c=b[1],b=f(/^([-\w]+)\s*/);if(!b)return k("@keyframes missing name");b=b[1];if(!h())return k("@keyframes missing '{'");for(var e,g=m();e=r();)g.push(e),g=g.concat(m());return f(/^}/)?a({type:"keyframes",name:b,vendor:c,keyframes:g}):k("@keyframes missing '}'")}}function t(){var a=d(),b=f(/^@supports *([^{]+)/);if(b){b=b[1].trim();if(!h())return k("@supports missing '{'");var c=m().concat(g());return f(/^}/)?
a({type:"supports",supports:b,rules:c}):k("@supports missing '}'")}}function z(){var a=d(),b=f(/^@media *([^{]+)/);if(b){b=b[1].trim();if(!h())return k("@media missing '{'");var c=m().concat(g());return f(/^}/)?a({type:"media",media:b,rules:c}):k("@media missing '}'")}}function L(){var a=d();if(f(/^@page */)){var b=u()||[];if(!h())return k("@page missing '{'");for(var c=m(),e;e=s();)c.push(e),c=c.concat(m());return f(/^}/)?a({type:"page",selectors:b,declarations:c}):k("@page missing '}'")}}function D(){var a=
d(),b=f(/^@([-\w]+)?document *([^{]+)/);if(b){var c=(b[1]||"").trim(),b=b[2].trim();if(!h())return k("@document missing '{'");var e=m().concat(g());return f(/^}/)?a({type:"document",document:b,vendor:c,rules:e}):k("@document missing '}'")}}function G(a){var b=d(),c=f(RegExp("^@"+a+" *([^;\\n]+);"));if(c){var e={type:a};e[a]=c[1].trim();return b(e)}}function p(){var a=d(),b=u();if(b)return m(),a({type:"rule",selectors:b,declarations:n()})}c=c||{};var y=1,I=1;return{type:"stylesheet",stylesheet:{rules:g()}}},
...
g.current_mode="TAG";break;case "TK_STYLE":case "TK_SCRIPT":if(""!==g.token_text){g.print_newline(!1,g.output);a=g.token_text;var v;m=1;"TK_SCRIPT"===g.token_type?v="function"===typeof c&&c:"TK_STYLE"===g.token_type&&(v="function"===typeof h&&h);"keep"===b.indent_scripts?m=0:"separate"===b.indent_scripts&&(m=-g.indent_level);f=g.get_full_indent(m);v?a=v(a.replace(/^\s*/,f),b):(q=a.match(/^\s*/)[0].match(/[^\n\r]*$/)[0].split(g.indent_string).length-1,m=g.get_full_indent(m-q),a=a.replace(/^\s*/,f).replace(/\r\n|\r|\n/g,
...
b){for(var c=-1,d=this.moduleCount-1,e=7,g=0,h=this.moduleCount-1;0<h;h-=2)for(6==h&&h--;;){for(var k=0;2>k;k++)if(null==this.modules[d][h-k]){var m=!1;g<a.length&&(m=1==(a[g]>>>e&1));f.getMask(b,d,h-k)&&(m=!m);this.modules[d][h-k]=m;e--; -1==e&&(g++,e=7)}d+=c;if(0>d||this.moduleCount<=d){d-=c;c=-c;break}}}};c.PAD0=236;c.PAD1=17;c.createData=function(a,b,g){b=d.getRSBlocks(a,b);for(var h=new e,k=0;k<g.length;k++){var m=g[k];h.put(m.mode,4);h.put(m.getLength(),f.getLengthInBits(m.mode,a));m.write(h)}for(k=
a=0;k<b.length;k++)a+=b[k].dataCount;if(h.getLengthInBits()>8*a)throw Error("code length overflow. ("+h.getLengthInBits()+">"+8*a+")");for(h.getLengthInBits()+4<=8*a&&h.put(0,4);0!=h.getLengthInBits()%8;)h.putBit(!1);for(;!(h.getLengthInBits()>=8*a);){h.put(c.PAD0,8);if(h.getLengthInBits()>=8*a)break;h.put(c.PAD1,8)}return c.createBytes(h,b)};c.createBytes=function(a,c){for(var d=0,e=0,g=0,h=Array(c.length),k=Array(c.length),m=0;m<c.length;m++){var p=c[m].dataCount,q=c[m].totalCount-p,e=Math.max(e,
p),g=Math.max(g,q);h[m]=Array(p);for(var s=0;s<h[m].length;s++)h[m][s]=255&a.buffer[s+d];d+=p;s=f.getErrorCorrectPolynomial(q);p=(new b(h[m],s.getLength()-1)).mod(s);k[m]=Array(s.getLength()-1);for(s=0;s<k[m].length;s++)q=s+p.getLength()-k[m].length,k[m][s]=0<=q?p.get(q):0}for(s=m=0;s<c.length;s++)m+=c[s].totalCount;d=Array(m);for(s=p=0;s<e;s++)for(m=0;m<c.length;m++)s<h[m].length&&(d[p++]=h[m][s]);for(s=0;s<g;s++)for(m=0;m<c.length;m++)s<k[m].length&&(d[p++]=k[m][s]);return d};for(var h={MODE_NUMBER:1,
...
Grid.prototype.getDelta=function(a){this.eraseSnaplines();var c={},b=[],d=[],e;for(e in a){var k=a[e],h;for(h in this.points)if(this.points.hasOwnProperty(h)){var g=this.points[h],f=g.x-k.x,m=g.y-k.y;c.x||(c.x=f,c.y=m);Math.abs(f)<=Math.abs(c.x)&&(c.x=f,b=[k,g]);Math.abs(m)<=Math.abs(c.y)&&(c.y=m,d=[k,g])}}a=Math.abs(c.x)<this.radius;e=Math.abs(c.y)<this.radius;a||(c.x=0);e||(c.y=0);a&&(b[0]={x:b[0].x+c.x,y:b[0].y+c.y},this.drawSnapline(b[0],b[1]));e&&(d[0]={x:d[0].x+c.x,y:d[0].y+c.y},this.drawSnapline(d[0],
...
Designer.importUrl=function(a){$.post("/nudgepad.proxy",{url:a},function(c){var b=a.replace(/^https?\:\/\//,"");c=$.htmlToScraps(c);c=Designer.relativeToAbsolute(c.toString(),a);Designer.menu.create(b,c.toString());Alerts.success("Imported "+a)})};Designer.importUrlPrompt=function(){var a=prompt("Enter a url to import","http://");if(!a)return!1;a.match(/^https?\:\/\//)||(a="http://"+a);Designer.importUrl(a)};
...
$(this).parent().offset().top,f=Designer.StretchHandle.getLength(e,k,h,g,"center"!=b,"middle"!=c),h=a.scrap(),g=h.get("style width")||a.css("width"),m=h.get("style height")||a.css("height");"center"!==b&&(h.set("style left",(0<=f.x?e:f.x+e)+"px"),g=a.outerWidth()-a.width(),g=Math.abs(f.x)-g,g=Designer.StretchHandle.isWidthPercentage?Math.round(100*g/a.parent().width())+"%":g+"px",h.set("style width",g));d?(c=parseFloat(h.get("style width"))/Designer.StretchHandle.originalWidth,h.set("style height",
Math.round(Designer.StretchHandle.originalHeight*c)+"px")):"middle"!=c&&(0<=f.y?h.set("style top",k+"px"):h.set("style top",f.y+k+"px"),c=a.outerHeight(!0)-a.height(),m=Math.abs(f.y)-c,c=a.parent().height()||$(window).height(),m=Designer.StretchHandle.isHeightPercentage?Math.round(100*m/c)+"%":m+"px",h.set("style height",m));a.css(h.values.style.values);c="W "+g+"<br> H "+m;$("#DesignerDimensions").css({left:10+a.offset().left+a.outerWidth(),top:-10+a.offset().top+Math.round(a.outerHeight(!0)/2)}).html(c);
...
e.on("tap",function(){$("div").removeClass("selectedEditorOption");$(this).addClass("selectedEditorOption");n.hide();q.hide();k.show();return!1});b.append(e);e=$('<div class="editorOption">Text</div>');e.on("tap",function(){$("div").removeClass("selectedEditorOption");$(this).addClass("selectedEditorOption");k.hide();n.hide();a.get("style")&&n.val(a.get("style"));q.show();return!1});b.append(e);e=$('<div class="editorOption">Code</div>');e.on("tap",function(){$("div").removeClass("selectedEditorOption");
$(this).addClass("selectedEditorOption");k.hide();q.hide();a.get("style")&&n.val(a.get("style"));n.show();return!1});b.append(e);var k=$('<div id="blockContainer"></div>');d.append(k);var h=Designer.stage.selection.elements().css("background-color"),b=$('<div class="colorBackground"><input type="text" class="colorPicker"></div>');k.append(b);b=$('<div class="editorButton"><img src="/nudgepad/public/images/dup_lt.png"></div>');b.on("click",function(){Designer.stage.selection.duplicate()});k.append(b);
b=$('<div class="editorButton"><img src="/nudgepad/public/images/lock_lt.png"></div>');b.on("tap",function(){Designer.stage.selection.patch("locked true");r.trigger("click");return!1});k.append(b);var g=$('<select id="nudgepadLinkSelect"></select>'),b=$("<option>No link</option>");b.on("click",function(){Designer.stage.selection.patch("href ")});g.append(b);_.each(Project.values.pages.values,function(a,b){var c=$('<option value="'+b+'">'+ToProperCase(b)+"</option>");c.on("click",function(){Designer.stage.selection.patch("tag a\nhref "+
...
Layout.splitHorizontal=function(){$(".selected").append('<div class="LayoutCell" style="height: 50%;"></div><div class="LayoutCell" style="height: 50%;"></div>')};var isRectangleIntersectedByLine=function(a,c,b,d,e,k,h,g){var f=e,m=h;e>h&&(f=h,m=e);m>b&&(m=b);f<a&&(f=a);if(f>m)return!1;a=k;b=g;h-=e;1E-7<Math.abs(h)&&(g=(g-k)/h,e=k-g*e,a=g*f+e,b=g*m+e);a>b&&(f=b,b=a,a=f);b>d&&(b=d);a<c&&(a=c);return a>b?!1:!0};
$.fn.getElementsByLine=function(a,c,b,d){var e=[];$(this).each(function(){var k=$(this),h,g,f,m;h=k.offset().left;g=k.offset().left+k.outerWidth();f=k.offset().top;m=k.offset().top+k.outerHeight();isRectangleIntersectedByLine(h,f,g,m,a,c,b,d)&&e.push(k)});return e};var Move=new Tool("Move");Move.set("path","");Move.set("description","Move or copy your project to a new domain.");
