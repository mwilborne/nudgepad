...
for(var p=Array(16),t=Array(16),w=0;16>w;w++)p[w]=s[w]^909522486,t[w]=s[w]^1549556828;c=e(p.concat(f(c)),512+c.length*d);c=e(t.concat(c),768);return g(c)},sha256config:function(a){d=parseInt(a)||8}});a.fn.sha256=function(b){a.sha256config(b);b=h(a(this).val());b=a.sha256(b);a.sha256config(8);return b}})(jQuery);function Space(a){this._pairs=[];this.events={};this._load(a);return this}Space.version="0.8.0";Space.arrayDelete=function(a,d){return a.slice(0,d).concat(a.slice(d+1))};Space.isXPath=function(a){return a.match(/ /)};
Space.pathBranch=function(a){a=a.split(/ /g);if(2>a.length)return"";a.pop();return a.join(" ")};Space.pathLeaf=function(a){var d=a.split(/ /g);return 2>d.length?a:d[d.length-1]};Space.strRepeat=function(a,d){for(var c="",b=0;b<d;b++)c+=a;return c};Space.union=function(){for(var a=Space.unionSingle(arguments[0],arguments[1]),d=0;d<arguments.length&&(1===d||(a=Space.unionSingle(a,arguments[d]),a.length()));d++);return a};
Space.unionSingle=function(a,d){var c=new Space;if(!(d instanceof Space))return c;a.each(function(a,e){e instanceof Space&&(d._getValueByProperty(a)&&d._getValueByProperty(a)instanceof Space)&&c._setPair(a,Space.unionSingle(e,d._getValueByProperty(a)));e===d._getValueByProperty(a)&&c._setPair(a,e)});return c};Space.prototype.append=function(a,d){this._setPair(a,d);this.trigger("append",a,d);this.trigger("change");return this};Space.prototype._clear=function(){this._pairs=[];return this};
...
Space.prototype._delete=function(a){return"number"===typeof a?this._deleteByIndex(a):a.toString().match(/ /)?this._deleteByXPath(a):this._deleteByProperty(a)};Space.prototype._deleteByIndex=function(a){if(void 0===this._pairs[a])return 0;this._pairs.splice(a,1);return 1};Space.prototype._deleteByProperty=function(a){a=this.indexOf(a);if(-1===a)return 0;this._deleteByIndex(a);return 1};
Space.prototype._deleteByXPath=function(a){var d=a.split(/ /);a=d.pop();d=this.get(d.join(" "));return d instanceof Space?d._delete(a):0};Space.prototype["delete"]=function(a){this._delete(a)&&this.trigger("delete",a);this.trigger("change");return this};
Space.prototype.diff=function(a){var d=new Space;a instanceof Space||(a=new Space(a));this.each(function(b,c){var f=a._getValueByProperty(b);if("undefined"===typeof f)return d._setPair(b,""),!0;if(typeof this._getValueByProperty(b)!==typeof f)return"object"===typeof f?d._setPair(b,new Space(f)):this._getValueByProperty(b)!=f&&d._setPair(b,f),!0;if("object"!==typeof this._getValueByProperty(b))return this._getValueByProperty(b)!=f&&d._setPair(b,f),!0;f=this._getValueByProperty(b).diff(f);f.length()&&
d._setPair(b,f)});var c=this;a.each(function(b,e){if(c.has(b))return!0;if("object"!==typeof e)return d._setPair(b,e),!0;e instanceof Space?d._setPair(b,new Space(e)):d._setPair(b,new Space(a))});return d};
Space.prototype.diffOrder=function(a){a instanceof Space||(a=new Space(a));var d=new Space,c=this;a.each(function(a,e){if(!(e instanceof Space&&c._getValueByProperty(a)instanceof Space))return!0;var f=c._getValueByProperty(a).diffOrder(e);if(f.isEmpty())return!0;d._setPair(a,f)});if(a.tableOfContents()===this.tableOfContents())return d;a.each(function(a,c){d.has(a)||d._setPair(a,new Space)});return d};
Space.prototype.each=function(a){for(var d=0;d<this._pairs.length&&!1!==a.call(this,this._pairs[d][0],this._pairs[d][1],d);d++);return this};Space.prototype.filter=function(a){for(var d=new Space,c=0;c<this._pairs.length;c++)!0===a.call(this,this._pairs[c][0],this._pairs[c][1],c)&&d.append(this._pairs[c][0],this._pairs[c][1]);return d};
Space.prototype.find=function(a,d){var c=new Space;this.get(a)===d&&c.push(this);this.each(function(b,e){if(!(e instanceof Space))return!0;e.find(a,d).each(function(a,b){c.push(b)})});return c};Space.prototype.first=function(){return this.length()?(new Space).set(this._pairs[0][0],this._pairs[0][1]):new Space};Space.prototype.firstProperty=function(){return this.length()?this._pairs[0][0]:null};Space.prototype.firstValue=function(){return this.length()?this._pairs[0][1]:null};
Space.prototype.every=function(a){this.each(function(d,c,b){a.call(this,d,c,b);c instanceof Space&&c.every(a)});return this};Space.prototype.get=function(a){return this._getValueByString(a.toString())};Space.prototype.getAll=function(a){var d=new Space;this.each(function(c,b){if(c!==a)return!0;d.append(c,b)});return d};Space.prototype.getByIndex=function(a){return this._getValueByIndex(a)};
Space.prototype.getByIndexPath=function(a){a=a.split(/ /g);var d=parseFloat(a.shift());return 0===a.length?this._getValueByIndex(d):this._getValueByIndex(d).getByIndexPath(a.join(" "))};Space.prototype.getBySpace=function(a){return this._getValueBySpace(a)};
Space.prototype.getCud=function(a){var d=new Space("created\nupdated\ndeleted\n");a instanceof Space||(a=new Space(a));var c=this;a.each(function(a,e){void 0===c.get(a)?d.set("created "+a,e):c.get(a)!==e&&d.set("updated "+a,e)});this.each(function(b,c){void 0===a.get(b)&&d.set("deleted "+b,new Space)});return d};Space.prototype._getValueByIndex=function(a){0>a&&(a=this.length()+a);if(this._pairs[a])return this._pairs[a][1]};
Space.prototype._getValueByProperty=function(a){var d;this._pairs.forEach(function(c,b){if(c[0]===a)return d=c[1],!1});return d};Space.prototype._getPropertyByIndex=function(a){0>a&&(a=this.length()+a);return this.getProperties()[a]};Space.prototype.getProperties=function(){var a=[];this._pairs.forEach(function(d,c){a.push(d[0])});return a};
Space.prototype._getValueByString=function(a){if(a){if(!a.match(/ /))return this._getValueByProperty(a);a=a.split(/ /g);var d=a.shift();if(this.has(d)&&this._getValueByProperty(d)instanceof Space)return this._getValueByProperty(d).get(a.join(" "))}};
Space.prototype._getValueBySpace=function(a){var d=new Space,c=this;a.each(function(b,e){var f=c._getValueByProperty(b);if("undefined"===typeof f)return!0;if(!(a._getValueByProperty(b)instanceof Space&&a._getValueByProperty(b).length()))return d._setPair(b,f),!0;if(!(f instanceof Space))return!0;d._setPair(b,f._getValueBySpace(a._getValueByProperty(b)))});return d};
...
Space.prototype.getTokensConcise=function(){return this.getTokens().replace(/[^\w\s]|(.)(?=\1)/gi,"")};Space.prototype.has=function(a){return void 0!==this._getValueByProperty(a)};Space.prototype.__height=function(){return this.toString().match(/\n/g).length};Space.prototype.indexOf=function(a){return this.getProperties().indexOf(a)};Space.prototype.insert=function(a,d,c){this._setPair(a,d,c);return this};Space.prototype.isEmpty=function(){return 0===this.length()};
Space.prototype.isASet=function(){var a=!0,d={};this.each(function(c,b){if(d[c])return a=!1;d[c]=!0;if(b instanceof Space)return b.isASet()?!0:a=!1});return a};Space.prototype._typeCount=function(){var a=this.length();this.each(function(d,c){c instanceof Space&&(a+=c._typeCount())});return a};Space.prototype.last=function(){if(!this.length())return new Space;var a=this.length()-1;return(new Space).set(this._pairs[a][0],this._pairs[a][1])};
Space.prototype.lastProperty=function(){if(!this.length())return null;var a=this.length()-1;return this._pairs[a][0]};Space.prototype.lastValue=function(){if(!this.length())return null;var a=this.length()-1;return this._pairs[a][1]};Space.prototype.length=function(){return this.getProperties().length};
Space.prototype._load=function(a){if("string"===typeof a)return this._loadFromString(a);if(a instanceof Space){var d=this;a.each(function(a,b){d._setPair(a,b)});return this}a instanceof Array?this._loadFromArray(a):this._loadFromObject(a)};Space.prototype._loadFromArray=function(a){for(var d in a){var c=a[d];"object"===typeof c?this._setPair("item",new Space(c)):this._setPair("item",c)}};
Space.prototype._loadFromObject=function(a){for(var d in a)if(Object.prototype.hasOwnProperty.call(a,d)){var c=a[d];"object"===typeof c?this._setPair(d,new Space(c)):this._setPair(d,c)}};
...
Space.prototype._patch=function(a){a instanceof Space||(a=new Space(a));var d=this;a.each(function(a,b){if("string"===typeof b)return""===b?d._delete(a):d._setPair(a,b),!0;if("number"===typeof b)return d._setPair(a,b),!0;if(b instanceof Space&&!b.length())return d._delete(a),!0;if(d._getValueByProperty(a)instanceof Space)return d._getValueByProperty(a)._patch(b),!0;d._setPair(a,new Space(b))});return this};
Space.prototype.patch=function(a){this._patch(a);this.trigger("patch",a);this.trigger("change");return this};Space.prototype._patchOrder=function(a){a instanceof Space||(a=new Space(a));var d=this,c=this.clone();d._clear();a.each(function(a,e){d._setPair(a,c.get(a));e instanceof Space&&(e.length()&&c._getValueByProperty(a)instanceof Space)&&d._getValueByProperty(a)._patchOrder(e)});return this};
Space.prototype.patchOrder=function(a){this._patchOrder(a);this.trigger("patchOrder",a);this.trigger("change");return this};Space.prototype.pop=function(){if(!this.length())return null;var a=new Space,d=this._getPropertyByIndex(-1),c=this._getValueByProperty(d);a.set(d,c);this._delete(d);return a};Space.prototype.prepend=function(a,d){return this._setPair(a,d,0)};Space.prototype.prev=function(a){a=this.indexOf(a)-1;return this._getPropertyByIndex(a)};
Space.prototype.push=function(a){for(var d=this.length();this.get(d.toString());)d++;this._setPair(d.toString(),a);return this};Space.prototype._rename=function(a,d){var c=this.indexOf(a);this._setPair(d,this._getValueByProperty(a),c,!0);return this};Space.prototype.reload=function(a){this._pairs=[];this._load(a);this.trigger("reload");return this};Space.prototype.rename=function(a,d){this._rename(a,d);a!==d&&this.trigger("rename",a,d);this.trigger("change");return this};
Space.prototype.set=function(a,d,c){a=a.toString();Space.isXPath(a)?this._setByXPath(a,d):this.has(a)?this._setPair(a,d,this.indexOf(a),!0):this._setPair(a,d,c);this.trigger("set",a,d,c);this.trigger("change");return this};
Space.prototype.setByIndexPath=function(a,d){if(!Space.isXPath(a)){var c=parseFloat(a);this.update(c,this._getPropertyByIndex(c),d);return this}c=Space.pathBranch(a);c=this.getByIndexPath(c);if(!c)return this;var b=parseFloat(Space.pathLeaf(a));c.update(b,c._getPropertyByIndex(b),d);return this};
Space.prototype._setByXPath=function(a,d){if(!a)return null;for(var c=a.toString().split(/ /g),b=this,e,f,g=0;g<c.length;g++){e=c[g];if((f=g===c.length-1)||!(b._getValueByProperty(e)instanceof Space)){var h;h=f?d:new Space;b.has(e)?(f=b.indexOf(e),b._setPair(e,h,f,!0)):b._setPair(e,h)}b=b.get(e)}return this};Space.prototype._setPair=function(a,d,c,b){a=a.toString();void 0===c?this._pairs.push([a,d]):b?this._pairs.splice(c,1,[a,d]):this._pairs.splice(c,0,[a,d])};
Space.prototype.shift=function(){if(!this.length())return null;var a=this._getPropertyByIndex(0),d=new Space;d.set(a,this.get(a));this._delete(a);return d};Space.prototype.sort=function(a){this._pairs=this._pairs.sort(a);return this};Space.prototype.tableOfContents=function(){return this.getProperties().join(" ")};
Space.prototype.toBinary=function(){for(var a="",d=this.toString(),c=0;c<d.length;c++){for(var b=parseFloat(d.substr(c,1).charCodeAt(0)).toString(2);8>b.length;)b="0"+b;a+=b}return a.replace(/0/g,"-").replace(/1/g,"|")};Space.prototype.toBinaryMatrixString=function(){var a="";this.toDecimalMatrix().forEach(function(d,c){d.forEach(function(b,c){for(var d=b.toString(2);8>d.length;)d="0"+d;a+=d});a+="\n"});return a};
Space.prototype.toDecimalMatrix=function(){for(var a=this.__width(),d=this.toString().replace(/\n$/,"").split(/\n/g),c=[],b=0;b<d.length;b++){for(var e=d[b],f=[],g=e.length,h=0;h<a;h++)h<g?f.push(e.substr(h,1).charCodeAt(0)):f.push(0);c.push(f)}return c};Space.prototype.toDecimalMatrixString=function(){var a="";this.toDecimalMatrix().forEach(function(d,c){var b="";d.forEach(function(c,d){a+=b;a=10>c?a+("00"+c):9<c&&100>c?a+("0"+c):a+c;b=" "});a+="\n"});return a};
Space.prototype.toggle=function(a,d,c){this.get(a)===d?this.set(a,c):this.set(a,d);return this};Space.prototype.toJavascript=function(a){var d="new Space('"+this.toString().replace(/\n/g,"\\n").replace(/\'/g,"\\'")+"')";return a?d.replace(/\\n/g,"\\n\\\n"):d};Space.prototype.toJSON=function(){return JSON.stringify(this.toObject())};Space.prototype.toObject=function(){var a={};this.each(function(d,c){a[d]=c instanceof Space?c.toObject():c});return a};
Space.prototype.toQueryString=function(){var a="",d="";this.each(function(c,b){a+=d+encodeURIComponent(c)+"="+encodeURIComponent(b);d="&"});return a};Space.prototype.toShapes=function(a){a=a||0;var d="V\n";this.each(function(c,b){if("undefined"===typeof b)return d+="\n",!0;d+=Space.strRepeat(" ",a)+"O";d=b instanceof Space?d+b.toShapes(a+1):"object"===typeof b?d+(new Space(b)).toShapes(a+1):""===b.toString()?d+" \n":d+"[]\n"});return d};
...
Files.renderExplorer=function(){var a=Files.get("files");if(!a)return!1;Files.dir&&(a=a.get(Files.dir));if(!a)return!1;var d='<table id="FilesExplorer">',d=d+'<tr class="FilesExplorerHeader"><td>Filename</td><td></td><td></td><td></td><td></td><td>Size</td><td>Age</td></tr>',c=Files.dir?Files.dir+" ":"",b=_.filter(a.getProperties(),function(b){return!a.get(b).get("timeSinceLastChange")}).sort(),e=_.filter(a.getProperties(),function(b){return a.get(b).get("timeSinceLastChange")}).sort();b.concat(e).forEach(function(b){if(!store.get("FilesShowHidden")&&
