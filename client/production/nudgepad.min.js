...
Fiddle.save=function(){var a=new Space;"A B C D E F".split(/ /g).forEach(function(d){var c=$("#"+d).val();c&&a.set("values "+d,c);(c=$(".FiddleCode[name="+d+"]").val())&&a.set("code "+d,c)});store.set("Fiddle",a.toString())};var Files=new Tool("Files");Files.set("path","");Files.on("ready",function(){Files.refresh();Files.updateHidden()});Files.on("set",function(a){"path"===a&&Files.renderExplorer()});
Files.toggleHidden=function(){store.get("FilesShowHidden")?store.remove("FilesShowHidden"):store.set("FilesShowHidden","true");Files.refresh();Files.updateHidden()};Files.updateHidden=function(){$("#FilesHiddenToggle").html("");store.get("FilesShowHidden")&&$("#FilesHiddenToggle").append("&#10003; ");$("#FilesHiddenToggle").append("Show Hidden Files")};Files.isImage=function(a){return a.match(/\.png|jpeg|jpg|gif$/i)?!0:!1};
