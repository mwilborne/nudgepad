...
fs.writeFileSync(publicPath + 'nudgepad.dev.css', code.css, 'utf8')

// Build concatenated js file to be used for minifiy
fs.writeFileSync(publicPath + 'nudgepad.dev.js', code.js, 'utf8')
...
buildHtml(publicPath + 'nudgepad.dev.html', corePath + '/nudgepad.dev.html')
buildHtml(publicPath + 'nudgepad.min.html', corePath + '/nudgepad.min.html')
